...
// Android-note: this is a copy of DecimalFormat_ICU58 for Android internal use only (b/68143370).
// Since ICU 59 changed the behaviour of DecimalFormat with regard to parsing this copy was created
// for use in java.text.DecimalFormat to keep the behavior of that class consistent with earlier
// releases. This is a short-term solution until the new ICU DecimalFormat is configurable enough
// to come close enough to ICU 58 behavior for us to continue using it in java.text.DecimalFormat.
// This class is a copy of DecimalFormat_ICU58 of the tests directory with applicable patches and
// renamed to indicate the internal-only characteristic of this class.
 ...
 * BigDecimal} documentation for a description of the modes.  Rounding
...
public class DecimalFormat_ICU58_Android extends NumberFormat {
     ...
     * @stable ICU 4.2
     */
    public DecimalFormat_ICU58_Android(String pattern, DecimalFormatSymbols symbols, CurrencyPluralInfo infoInput,
                         int style) {
    ...
    private StringBuffer format(double number, StringBuffer result, FieldPosition fieldPosition,
        ...
        if (useExponentialNotation && precision > 0 && number != 0.0 && roundingMode != BigDecimal.ROUND_HALF_EVEN) {
           ...
           number = DecimalFormat_ICU58_Android.round(number, roundingInc, roundingIncReciprocal, roundingMode, isNegative);
        }
    ...
    private void subformatFixed(StringBuffer result,
        ...
        if (fieldPosition.getField() == NumberFormat.INTEGER_FIELD ||
                fieldPosition.getFieldAttribute() == Field.INTEGER) {
    ...
    private boolean parseForCurrency(String text, ParsePosition parsePosition,
        ...
        DigitList_Android tmpDigitList = new DigitList_Android();
        boolean found;
        if (style == NumberFormat.PLURALCURRENCYSTYLE) {
        ...
        for (AffixForCurrency affix : affixPatternsForCurrency) {
            ...
            tmpDigitList = new DigitList_Android();
...
//            0xFF07, 0xFF07).freeze();
    ...
    private final boolean subparse(
        String text, ParsePosition parsePosition, DigitList_Android digits,
        ...
        if (text.regionMatches(position, symbols.getInfinity(), 0,
            ...
            while (position < text.length()) {
                ...
                if (text.regionMatches(true, position, exponentSep, 0, exponentSepStrLen)) {
                    ...
                    DigitList_Android exponentDigits = new DigitList_Android();
   ...
   /**
    ...
    public Object clone() {
        try {
            ...
            other.digitList = new DigitList_Android(); // fix for JB#5358
            if (currencyPluralInfo != null) {
    ...
    */
    ...
    private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
        ...
        digitList = new DigitList_Android();
