...
include $(CLEAR_VARS)
LOCAL_MODULE := SourceSansPro-Regular.ttf
...
include $(CLEAR_VARS)
LOCAL_MODULE := SourceSansPro-Italic.ttf
LOCAL_SRC_FILES := $(LOCAL_MODULE)
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_PATH := $(TARGET_OUT)/fonts
...
include $(CLEAR_VARS)
LOCAL_MODULE := SourceSansPro-SemiBold.ttf
LOCAL_SRC_FILES := $(LOCAL_MODULE)
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_PATH := $(TARGET_OUT)/fonts
...
include $(CLEAR_VARS)
LOCAL_MODULE := SourceSansPro-SemiBoldItalic.ttf
LOCAL_SRC_FILES := $(LOCAL_MODULE)
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_PATH := $(TARGET_OUT)/fonts
