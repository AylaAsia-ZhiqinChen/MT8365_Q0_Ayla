/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/SCRATCH/arcjenkins/custom-ru20-arcgnu2/workspace/arc_gnu_toolchain_release/gcc/gcc/config/arc/arc.md'.  */
...
extern int compact_hreg_operand (rtx, machine_mode);
...
extern int ge_lt_comparison_operator (rtx, machine_mode);
...
extern int _1_2_3_operand (rtx, machine_mode);
...
extern int accl_operand (rtx, machine_mode);
