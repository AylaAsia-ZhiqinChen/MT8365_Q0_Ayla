...
#define MASK_NO_LRA (1U << 12)
#define MASK_MIXED_CODE_SET (1U << 13)
#define MASK_MULMAC_32BY16_SET (1U << 14)
#define MASK_MUL64_SET (1U << 15)
#define MASK_NEW_REGS (1U << 16)
#define MASK_NO_BRCC_SET (1U << 17)
#define MASK_NO_COND_EXEC (1U << 18)
#define MASK_DPFP_DISABLE_LRSR (1U << 19)
#define MASK_NO_MILLICODE_THUNK_SET (1U << 20)
#define MASK_NOMPY_SET (1U << 21)
#define MASK_VOLATILE_CACHE_SET (1U << 22)
#define MASK_NORM_SET (1U << 23)
#define MASK_RF16 (1U << 24)
#define MASK_NO_SDATA_SET (1U << 25)
#define MASK_SIMD_SET (1U << 26)
#define MASK_0 (1U << 27)
#define MASK_SPFP_COMPACT_SET (1U << 28)
#define MASK_SPFP_FAST_SET (1U << 29)
#define MASK_SWAP_SET (1U << 30)
...
#define TARGET_NO_LRA ((target_flags & MASK_NO_LRA) != 0)
#define TARGET_NO_LRA_P(target_flags) (((target_flags) & MASK_NO_LRA) != 0)
...
#define TARGET_NEW_REGS ((target_flags & MASK_NEW_REGS) != 0)
#define TARGET_NEW_REGS_P(target_flags) (((target_flags) & MASK_NEW_REGS) != 0)
...
enum opt_code
{
  ...
  OPT_mA6 = 1153,                            /* -mA6 */
  OPT_mA7 = 1154,                            /* -mA7 */
  OPT_mARC600 = 1155,                        /* -mARC600 */
  OPT_mARC601 = 1156,                        /* -mARC601 */
  OPT_mARC700 = 1157,                        /* -mARC700 */
  OPT_mEA = 1158,                            /* -mEA */
  OPT_mRcq = 1159,                           /* -mRcq */
  OPT_mRcw = 1160,                           /* -mRcw */
  OPT_malign_call = 1161,                    /* -malign-call */
  OPT_mannotate_align = 1162,                /* -mannotate-align */
  OPT_marclinux = 1163,                      /* -marclinux */
  OPT_marclinux_prof = 1164,                 /* -marclinux_prof */
  OPT_margonaut = 1165,                      /* -margonaut */
  OPT_matomic = 1166,                        /* -matomic */
  OPT_mauto_modify_reg = 1167,               /* -mauto-modify-reg */
  OPT_mbarrel_shifter = 1168,                /* -mbarrel-shifter */
  OPT_mbbit_peephole = 1169,                 /* -mbbit-peephole */
  OPT_mbig_endian = 1170,                    /* -mbig-endian */
  OPT_mbitops = 1171,                        /* -mbitops */
  OPT_mcase_vector_pcrel = 1172,             /* -mcase-vector-pcrel */
  OPT_mcmem = 1173,                          /* -mcmem */
  OPT_mcode_density = 1174,                  /* -mcode-density */
  OPT_mcompact_casesi = 1175,                /* -mcompact-casesi */
  OPT_mcpu_ = 1176,                          /* -mcpu= */
  OPT_mcrc = 1177,                           /* -mcrc */
  OPT_mdiv_rem = 1178,                       /* -mdiv-rem */
  OPT_mdpfp = 1179,                          /* -mdpfp */
  OPT_mdpfp_compact = 1180,                  /* -mdpfp-compact */
  OPT_mdpfp_fast = 1181,                     /* -mdpfp-fast */
  OPT_mdsp_packa = 1182,                     /* -mdsp-packa */
  OPT_mdvbf = 1183,                          /* -mdvbf */
  OPT_mea = 1184,                            /* -mea */
  OPT_mearly_cbranchsi = 1185,               /* -mearly-cbranchsi */
  OPT_mexpand_adddi = 1186,                  /* -mexpand-adddi */
  OPT_mfpu_ = 1187,                          /* -mfpu= */
  OPT_mindexed_loads = 1188,                 /* -mindexed-loads */
  OPT_mirq_ctrl_saved_ = 1189,               /* -mirq-ctrl-saved= */
  OPT_misize = 1190,                         /* -misize */
  OPT_mjli_always = 1191,                    /* -mjli-always */
  OPT_mlittle_endian = 1192,                 /* -mlittle-endian */
  OPT_mll64 = 1193,                          /* -mll64 */
  OPT_mlock = 1194,                          /* -mlock */
  OPT_mlong_calls = 1195,                    /* -mlong-calls */
  OPT_mlpc_width_ = 1196,                    /* -mlpc-width= */
  OPT_mlra = 1197,                           /* -mlra */
  OPT_mlra_priority_compact = 1198,          /* -mlra-priority-compact */
  OPT_mlra_priority_noncompact = 1199,       /* -mlra-priority-noncompact */
  OPT_mlra_priority_none = 1200,             /* -mlra-priority-none */
  OPT_mmac_24 = 1201,                        /* -mmac-24 */
  OPT_mmac_d16 = 1202,                       /* -mmac-d16 */
  OPT_mmedium_calls = 1203,                  /* -mmedium-calls */
  OPT_mmixed_code = 1204,                    /* -mmixed-code */
  OPT_mmpy_option_ = 1205,                   /* -mmpy-option= */
  OPT_mmul32x16 = 1206,                      /* -mmul32x16 */
  OPT_mmul64 = 1207,                         /* -mmul64 */
  OPT_mmultcost_ = 1208,                     /* -mmultcost= */
  OPT_mnew_regs = 1209,                      /* -mnew-regs */
  OPT_mno_brcc = 1210,                       /* -mno-brcc */
  OPT_mno_cond_exec = 1211,                  /* -mno-cond-exec */
  OPT_mno_dpfp_lrsr = 1212,                  /* -mno-dpfp-lrsr */
  OPT_mno_millicode = 1213,                  /* -mno-millicode */
  OPT_mno_mpy = 1214,                        /* -mno-mpy */
  OPT_mno_volatile_cache = 1215,             /* -mno-volatile-cache */
  OPT_mnorm = 1216,                          /* -mnorm */
  OPT_mq_class = 1217,                       /* -mq-class */
  OPT_mrf16 = 1218,                          /* -mrf16 */
  OPT_mrgf_banked_regs_ = 1219,              /* -mrgf-banked-regs= */
  OPT_mrtsc = 1220,                          /* -mrtsc */
  OPT_msdata = 1221,                         /* -msdata */
  OPT_msimd = 1222,                          /* -msimd */
  OPT_msize_level_ = 1223,                   /* -msize-level= */
  OPT_msoft_float = 1224,                    /* -msoft-float */
  OPT_mspfp = 1225,                          /* -mspfp */
  OPT_mspfp_compact = 1226,                  /* -mspfp-compact */
  OPT_mspfp_fast = 1227,                     /* -mspfp-fast */
  OPT_mswap = 1228,                          /* -mswap */
  OPT_mswape = 1229,                         /* -mswape */
  OPT_mtelephony = 1230,                     /* -mtelephony */
  OPT_mtp_regno_ = 1231,                     /* -mtp-regno= */
  OPT_mtp_regno_none = 1232,                 /* -mtp-regno=none */
  OPT_mtune_ = 1233,                         /* -mtune= */
  OPT_multcost_ = 1234,                      /* -multcost= */
  OPT_munalign_prob_threshold_ = 1235,       /* -munalign-prob-threshold= */
  OPT_munaligned_access = 1236,              /* -munaligned-access */
  OPT_mvolatile_cache = 1237,                /* -mvolatile-cache */
  OPT_mxy = 1238,                            /* -mxy */
  OPT_n = 1239,                              /* -n */
