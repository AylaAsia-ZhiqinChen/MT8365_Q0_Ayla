...
#ifndef AUX_INCLUDE_AUX_AUX_GRALLOC2_H_
#define AUX_INCLUDE_AUX_AUX_GRALLOC2_H_
...
class AuxGralloc2Mapper : public AuxGrallocMapper {
 public:
    static void preload();
 ...
 private:
    ...
    sp<android::hardware::graphics::mapper::V2_1::IMapper> mMapperV2_1;
};

#endif  // AUX_INCLUDE_AUX_AUX_GRALLOC2_H_
