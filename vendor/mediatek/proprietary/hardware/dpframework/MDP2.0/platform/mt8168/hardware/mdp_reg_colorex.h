...
#define COLOREX_COLOR_BASE      (0x1400F000)
#define COLOREX_CCORR_BASE      (0x14010000)
#define COLOREX_AAL_BASE        (0x14011000)
#define COLOREX_GAMMA_BASE      (0x14012000)
#define COLOREX_DITHER_BASE     (0x14013000)
