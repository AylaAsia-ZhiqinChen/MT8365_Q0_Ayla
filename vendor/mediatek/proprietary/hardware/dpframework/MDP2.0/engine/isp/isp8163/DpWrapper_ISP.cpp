...
{
    // Set ISP frame done
    MM_REG_WRITE_MASK(command, ISP_BASE_HW + offsetof(isp_reg_t, CAM_CTL_PIX_ID_SET), 0x00800000, 0x00800000);
    MM_REG_POLL_MASK(command,  ISP_BASE_HW + offsetof(isp_reg_t, CAM_CTL_PIX_ID), 0x00800000, 0x00800000);
...
DP_STATUS_ENUM DpWrapper_ISP::onDumpTileInfo()
{
    ...
    for (index = 0; index < m_pTileFunc->used_func_no; index++)
    {
        ...
        if (TILE_FUNC_IMGI_ID == pFunc->func_num)
        {
            DPLOGD("tIMGI: ");
        }
        else if (TILE_FUNC_BPC_2D_ID == pFunc->func_num)
        {
            DPLOGD("tBPC: ");
        }
     /*
        else if (TILE_FUNC_G2C_ID == pFunc->func_num)
        {
            DPLOGD("tG2C: ");
        }
        */
     /*
        else if (TILE_FUNC_C42_ID == pFunc->func_num)
        {
            DPLOGD("tC42: ");
        }*/
     /*
        else if (TILE_FUNC_SL2C_ID == pFunc->func_num)
        {
            DPLOGD("tSL2C: ");
        }
        */
        else if (TILE_FUNC_LSC_ID == pFunc->func_num)
        {
            DPLOGD("tLSC: ");
        }
        else if (TILE_FUNC_CFA_ID == pFunc->func_num)
        {
            DPLOGD("tCFA: ");
        }
        else if (TILE_FUNC_LCE_ID == pFunc->func_num)
        {
            DPLOGD("tLCE: ");
        }
        else if (TILE_FUNC_NBC_ID == pFunc->func_num)
        {
            DPLOGD("tNBC: ");
        }
        else if (TILE_FUNC_SEEE_ID == pFunc->func_num)
        {
            DPLOGD("tSEEE: ");
        }
        else if (TILE_FUNC_SL2_ID == pFunc->func_num)
        {
            DPLOGD("tSL2: ");
        }
        else if (TILE_FUNC_CDRZ_ID == pFunc->func_num)
        {
            DPLOGD("tCDRZ: ");
        }
        else if (TILE_FUNC_IMG2O_ID == pFunc->func_num)
        {
            DPLOGD("tIMG2O: ");
        }
        /*
        else if (TILE_FUNC_IMG3O_ID == pFunc->func_num)
        {
            DPLOGD("tIMG3O: ");
        }
        */
        else if (TILE_FUNC_MDP_CROP_ID == pFunc->func_num)
        {
            DPLOGD("tMDP_CROP: ");
        }
        else if (TILE_FUNC_LSCI_ID == pFunc->func_num)
        {
            DPLOGD("tLSCI: ");
        }
        /*
        else if (TILE_FUNC_SRZ1_ID == pFunc->func_num)
        {
            DPLOGD("tSRZ1: ");
        }
        */
        /*
        else if (TILE_FUNC_FE_ID == pFunc->func_num)
        {
            DPLOGD("tFE: ");
        }
        */
        /*
        else if (TILE_FUNC_FEO_ID == pFunc->func_num)
        {
            DPLOGD("tFEO: ");
        }
        */
        /*
        else if (TILE_FUNC_MIX2_ID == pFunc->func_num)
        {
            DPLOGD("tMIX2: ");
        }
        */
        /*
        else if (TILE_FUNC_VIPI_ID == pFunc->func_num)
        {
             DPLOGD("tVIPI: ");
        }
        */
        ...
        DPLOGD("%d, %d, %d, %d, %d, %d, %d, %d\n", pFunc->in_pos_xs, pFunc->in_pos_xe, pFunc->out_pos_xs, pFunc->out_pos_xe, pFunc->in_pos_ys, pFunc->in_pos_ye, pFunc->out_pos_ys, pFunc->out_pos_ye);
    }
...
#if !CONFIG_FOR_VERIFY_FPGA
    result = tile_copy_config_by_platform(p_tile_param, &m_ISPConfig, NULL);
