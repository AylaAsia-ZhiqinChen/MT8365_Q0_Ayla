...
DP_STATUS_ENUM DpWrapper_WPE::onInitEngine(DpCommand &command)
{
    ...
    if (m_ISPConfig.top.wpe_mdpcrop_en)
    {
        ...
        // Bit  31: MDP_DL_ASYNC_RX
        MM_REG_WRITE(command, MMSYS_SW1_RST_B,     0x0, 0x80000000);
        MM_REG_WRITE(command, MMSYS_SW1_RST_B, 1 << 31, 0x80000000);
    }
