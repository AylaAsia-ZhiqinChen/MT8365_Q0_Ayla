...
*   None
*****************************************************************************/
void Gyro_init_calibration( MPE_SENSOR_DATA bias, MPE_SENSOR_DATA slope, MPE_SENSOR_DATA intercept);
...
*   success(0) or fail(-1)
*****************************************************************************/
int Gyro_run_calibration(int dt, int data_count, MPE_SENSOR_DATA * raw_data_input, MPE_SENSOR_DATA * calibrated_data_output, int *calibrate_acc, float temperature );
int Gyro_get_calibration_parameter(float *bias, int *accu, float *slope, float *intercept );
