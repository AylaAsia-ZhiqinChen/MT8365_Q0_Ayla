...
#ifndef _WAKEUPSET_SENSOR_H_
#define _WAKEUPSET_SENSOR_H_
...
class WakeUpSetSensor : public SensorBase {
private:
...
protected:
    ...
    int reportData(int handle, struct sensors_event_t *data);

public:
            WakeUpSetSensor();
    virtual ~WakeUpSetSensor();
