...
#ifndef _MTK_INTERFACE_H_

#define _MTK_INTERFACE_H_

#include "BaseInterface.h"

class MtkInterface : public BaseInterface {
public:
    static MtkInterface *getInstance();
    virtual ~MtkInterface();
...
protected:
    MtkInterface();
    MtkInterface(const MtkInterface& other);
    MtkInterface& operator = (const MtkInterface& other);

private:
    static MtkInterface *MtkInterfaceInstance;
    int64_t accLastTimeStamp;
    int64_t gyroLastTimeStamp;
};
