...
public:
   ...
   bool setDstBufSize(JUINT32 size, JUINT32 size1, JUINT32 size2){ fDstBufSize = size; 
    ...
    void setDstAddr(JUINT32 dstAddr, JUINT32 dstAddr1, JUINT32 dstAddr2) { fDstBufAddr = dstAddr;  
   ...
   void setDstHandler(unsigned long handle){ fDstHandle = handle ; }
    ...
    JINT32 TileInit();
    bool getSrcBuffer(JUINT32 *pSrcBuf, JUINT32 *pSrcBufStride, JUINT32 *tBufRowNum );
...
private:
    ...
    JUINT32 fPreferMode ; 
    JUINT32 fDstBufAddr ;
    JUINT32 fDstBufAddr1 ;
    JUINT32 fDstBufAddr2 ;
