...
//#include "../../gdma/inc/img_cdp_pipe.h"
/*******************************************************************************
*
********************************************************************************/
#ifndef JUINT32
...
public:
    ...
    enum ColorFormat {
        ...
        kYVU420_3PLANE_Format,    // YV12, YVU 420 3 plane
        kYUV_FORMAT_SIZE
    };
    ...
    bool setDecType(JUINT32 decType){ if( decType == IMG_DEC_TYPE_WEBP ){
