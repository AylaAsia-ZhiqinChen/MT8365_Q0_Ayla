...
public:
    ...
    bool setEncSize(JUINT32 width, JUINT32 height, EncFormat encformat, bool bOnePlane) ;
    ...
    */
    ...
    void setSrcSecHandle(JUINT32 SrcLumaHandle, JUINT32 SrcChromaHandle);

    void setDstSecHandle(JUINT32 DstHandle);

    void SetSrcBufHeight(JUINT32 SrcBufHeight);
...
private:
    ...
    bool fIsSecure;
    JUINT32 fSrcLumaHandle;
    JUINT32 fSrcChromaHandle;
    JUINT32 fDstHandle;
