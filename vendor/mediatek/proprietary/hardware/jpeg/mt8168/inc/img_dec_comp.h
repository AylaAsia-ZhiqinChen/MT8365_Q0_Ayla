...
public:
    ...
    virtual JUINT32 getMcuInRow() { return 0; }      //{ return fMcuInRow; }
    ...
    // out VA
    virtual void setDstAddr0(unsigned char *dstAddr, unsigned char *dstAddr1, unsigned char *dstAddr2){ return ; }
          //{ fDecOutBufAddr0[0] = dstAddr; fDecOutBufAddr0[1] = dstAddr1; fDecOutBufAddr0[2] = dstAddr2;
          //            fDstAddr = (unsigned char *)dstAddr; }
    
    virtual void setDstAddr1(unsigned char *dstAddr, unsigned char *dstAddr1, unsigned char *dstAddr2) { return ; }
    ...
    virtual bool setCmdqMode(JUINT32 enable){ return false; } //default not support cmdq mode

    virtual bool getCmdqMode(void){ return false; } //default not support cmdq mode
