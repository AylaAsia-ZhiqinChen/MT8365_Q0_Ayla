...
ifeq ($(MTK_PLATFORM),$(filter $(MTK_PLATFORM),MT6752 MT8168))
...
LOCAL_C_INCLUDES:= \
  ...
  $(TOP)/$(MTK_PATH_SOURCE)/hardware/jpeg/mt8168/jpegsec \
...
LOCAL_SHARED_LIBRARIES += libJpgEncSec
...
LOCAL_EXPORT_C_INCLUDE_DIRS := \
  ...
  $(TOP)/$(MTK_PATH_SOURCE)/hardware/jpeg/mt8168
