...
// TODO: yxz for h264 hybrid
/* /< VH264EncCodecDrvWaitISR definition for SW/hybrid codec */
#define  SP5_VH264EncCodecWaitISR                     VH264EncCodecDrvWaitISR
/* /< VH264EncCodecDrvLockHW definition for SW/hybrid codec */
#define  SP5_VH264EncCodecLockHW                      VH264EncCodecDrvLockHW
/* /< VH264EncCodecDrvUnLockHW  definition for SW/hybrid codec */
#define  SP5_VH264EncCodecUnLockHW                    VH264EncCodecDrvUnLockHW
// TODO: yxz for h264 hybrid
 ...
 *   int, return 1 if success, return 0 if failed
 */
int SP5_VH264EncCodecWaitISR(VCODEC_OAL_ISR_T *prParam);


/**
 * @par Function
 *   SP5_VH264EncCodecLockHW
 * @par Description
 *   The single/multiple instance usage function, to allow using HW
 * @param
 *   prParam            [IN/OUT] The structure contains used info for Lock HW
 ...
 *   int, return 1 if success, return 0 if failed
 */
int SP5_VH264EncCodecLockHW(VCODEC_OAL_HW_LOCK_T *prParam);


/**
 * @par Function
 *   SP5_VH264EncCodecUnLockHW
 * @par Description
 *   The single/multiple instance usage function, to release HW for another instance
 * @param
 *   prParam            [IN/OUT] The structure contains used info for unLock HW
 ...
 *   int, return 1 if success, return 0 if failed
 */
int SP5_VH264EncCodecUnLockHW(VCODEC_OAL_HW_LOCK_T *prParam);
