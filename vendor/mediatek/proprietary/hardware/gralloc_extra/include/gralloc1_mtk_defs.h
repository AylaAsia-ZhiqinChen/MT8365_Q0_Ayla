...
enum {
    ...
    GRALLOC1_USAGE_NO_COMPRESS          = GRALLOC1_PRODUCER_USAGE_PRIVATE_3,
    GRALLOC1_USAGE_COMPRESS             = GRALLOC1_PRODUCER_USAGE_PRIVATE_8,
    GRALLOC1_USAGE_SMVR                 = GRALLOC1_PRODUCER_USAGE_PRIVATE_1,
    GRALLOC1_USAGE_SECURE_CAMERA        = (GRALLOC1_PRODUCER_USAGE_PROTECTED | GRALLOC1_PRODUCER_USAGE_PRIVATE_2), /* MTK secure usage */
