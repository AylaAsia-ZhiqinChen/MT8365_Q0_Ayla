...
typedef enum MTK_WARP_COLOR_SPACE_ENUM
{
    MTK_WARP_COLOR_SPACE_YUV_NOT_SET=1,/* set to BT601_REDUCE as default */
    MTK_WARP_COLOR_SPACE_YUV_BT601_NARROW,
    MTK_WARP_COLOR_SPACE_YUV_BT601_FULL,
    MTK_WARP_COLOR_SPACE_YUV_BT709_NARROW
}MTK_WARP_COLOR_SPACE_ENUM;
...
typedef struct WarpImageExtInfo : WarpImageInfo
{
        ...
        MTK_WARP_COLOR_SPACE_ENUM source_color_domain;
}WarpImageExtInfo;
...
class MTKWarpExt {
public:
    static MTKWarpExt* createInstance(DrvWarpObject_e eobject);
    virtual void   destroyInstance(MTKWarpExt* obj) = 0;
...
class AppWarpTmp : public MTKWarpExt {
public:
    //
    static MTKWarpExt* getInstance();
    virtual void destroyInstance(MTKWarpExt* obj);
    //
    AppWarpTmp() {};
    virtual ~AppWarpTmp() {};
};
