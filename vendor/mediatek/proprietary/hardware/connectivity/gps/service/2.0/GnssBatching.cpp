...
sp<V2_0::IGnssBatchingCallback> GnssBatching::sGnssBatchingCbIface = nullptr;
...
void GnssBatching::acquireWakelockCb() {
    V2_0::implementation::Gnss::acquireWakelockFused();
}

void GnssBatching::releaseWakelockCb() {
    V2_0::implementation::Gnss::releaseWakelockFused();
}
