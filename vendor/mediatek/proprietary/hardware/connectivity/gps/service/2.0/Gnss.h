...
class Gnss : public IGnss {
  public:
    ...
    sp<V2_0::IGnssConfiguration> getExtensionGnssConfiguration_2_0_common();
 ...
 private:
    ...
    sp<V2_0::implementation::GnssMeasurement> mGnssMeasurement = nullptr;
    ...
    sp<measurement_corrections::V1_0::implementation::GnssMeasurementCorrections>
    ...
    sp<V2_0::implementation::GnssConfiguration> mGnssConfig = nullptr;
