...
#undef LOG_TAG
#endif
#define LOG_TAG "AudioALSACaptureDataClientSoundTrigger"
 ...
 *                     Implementation
 *============================================================================*/
AudioALSACaptureDataClientSoundTrigger::AudioALSACaptureDataClientSoundTrigger(
    ...
    ret = pthread_create(&hProcessThread, NULL,
                         AudioALSACaptureDataClientSoundTrigger::processThread,
                         (void *)this);
    ASSERT(ret == 0);
...
uint32_t AudioALSACaptureDataClientSoundTrigger::copyCaptureDataToClient(RingBuf pcm_read_buf) {
...
bool AudioALSACaptureDataClientSoundTrigger::getPcmStatus(void) {
    return (mCaptureDataProvider->getPcmStatus() == NO_ERROR);
}

void *AudioALSACaptureDataClientSoundTrigger::processThread(void *arg) {
    char thread_name[128] = {0};

    AudioALSACaptureDataClientSoundTrigger *client = NULL;
    ...
    client = static_cast<AudioALSACaptureDataClientSoundTrigger *>(arg);
...
ssize_t AudioALSACaptureDataClientSoundTrigger::read(void *buffer, ssize_t bytes) {
...
bool AudioALSACaptureDataClientSoundTrigger::IsLowLatencyCapture(void) {
...
int AudioALSACaptureDataClientSoundTrigger::getCapturePosition(int64_t *frames, int64_t *time) {
...
bool AudioALSACaptureDataClientSoundTrigger::IsNeedApplyVolume() {
    bool ret = false;
...
status_t AudioALSACaptureDataClientSoundTrigger::ApplyVolume(void *Buffer, uint32_t BufferSize) {
...
// Raw buffer +++
status_t AudioALSACaptureDataClientSoundTrigger::initRawBuffer(void)
{
...
status_t AudioALSACaptureDataClientSoundTrigger::deInitRawBuffer(void)
{
...
status_t AudioALSACaptureDataClientSoundTrigger::initBliSrcPre(int src_rates, int dst_rates)
{
...
status_t AudioALSACaptureDataClientSoundTrigger::deinitBliSrcPre()
{
...
status_t AudioALSACaptureDataClientSoundTrigger::doBliSrcPre(void *pInBuffer, uint32_t inBytes, void *pOutBuffer, uint32_t *pOutBytes)
{
    if (mBliSrcPre != NULL) {
...
//User Process +++
status_t AudioALSACaptureDataClientSoundTrigger::initDataProcess(void)
{
    int ret = 0;
...
status_t AudioALSACaptureDataClientSoundTrigger::deInitDataProcess(void)
{
    /* process uninit */
...
status_t AudioALSACaptureDataClientSoundTrigger::initBliSrcPost(int src_rates, int dst_rates)
{
    SRC_PCM_FORMAT src_pcm_format = SRC_IN_END;
...
status_t AudioALSACaptureDataClientSoundTrigger::deInitBliSrcPost()
{
    // deinit BLI SRC if need
    if (mBliSrcPost != NULL) {
        mBliSrcPost->close();
...
status_t AudioALSACaptureDataClientSoundTrigger::doBliSrcPost(void *pInBuffer, uint32_t inBytes, void *pOutBuffer, uint32_t *pOutBytes)
{
    if (mBliSrcPost != NULL) {
        uint32_t sizeIn = inBytes;
        uint32_t sizeOut = *pOutBytes;
...
// Processed buffer +++
status_t AudioALSACaptureDataClientSoundTrigger::initProcessedBuffer(void)
{
...
status_t AudioALSACaptureDataClientSoundTrigger::deInitProcessedBuffer(void)
{
    AUDIO_FREE_POINTER(mProcessedDataBuf.base);
    if (mNeedChannelCvt)
...
//Android Native Preprocess effect +++
void AudioALSACaptureDataClientSoundTrigger::CheckNativeEffect(void) {
...
uint32_t AudioALSACaptureDataClientSoundTrigger::NativePreprocess(void *buffer, uint32_t bytes) {
...
uint32_t AudioALSACaptureDataClientSoundTrigger::ApplyChannelRemix(char *src_buf, uint32_t src_size,
...
uint32_t AudioALSACaptureDataClientSoundTrigger::TransferFormat(char *src_buf, uint32_t src_size, char *dst_buf, uint32_t *pdst_size)
{
    //TODO
    *pdst_size = src_size;
    return 0;
...
void AudioALSACaptureDataClientSoundTrigger::handleLockTimeout() {
