...
LOCAL_MODULE := android.hardware.audio@4.0-impl-mediatek
...
LOCAL_MODULE := android.hardware.audio@4.0-service-mediatek
LOCAL_INIT_RC := android.hardware.audio@4.0-service-mediatek.rc
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_OWNER := mtk
LOCAL_MODULE_RELATIVE_PATH := hw
LOCAL_SRC_FILES := \
