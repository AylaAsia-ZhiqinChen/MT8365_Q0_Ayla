...
#define GED_BRIDGE_IO_GPU_HINT_TO_CPU       GED_IOWR(GED_BRIDGE_COMMAND_GPU_HINT_TO_CPU)
#define GED_BRIDGE_IO_HINT_FORCE_MDP        GED_IOWR(GED_BRIDGE_COMMAND_HINT_FORCE_MDP)
 ...
 ******************************************************************************/
typedef struct GED_BRIDGE_IN_HINT_FORCE_MDP_TAG {
	int32_t i32BridgeFD;
	int32_t hint; /* 1: Do MDP, 0: No MDP, -1: No overwrite */
} GED_BRIDGE_IN_HINT_FORCE_MDP;

typedef struct GED_BRIDGE_OUT_HINT_FORCE_MDP_TAG {
	GED_ERROR eError;
	int32_t mdp_flag; /* 1: Do MDP, 0: No MDP */
} GED_BRIDGE_OUT_HINT_FORCE_MDP;
