...
#ifndef GPUD_INCLUDE_GPUD_GPUD_GRALLOC3_H_
#define GPUD_INCLUDE_GPUD_GPUD_GRALLOC3_H_
...
class GPUDGralloc3Mapper : public GPUDGrallocMapper {
 public:
    GPUDGralloc3Mapper();
...
#endif  // GPUD_INCLUDE_GPUD_GPUD_GRALLOC3_H_
