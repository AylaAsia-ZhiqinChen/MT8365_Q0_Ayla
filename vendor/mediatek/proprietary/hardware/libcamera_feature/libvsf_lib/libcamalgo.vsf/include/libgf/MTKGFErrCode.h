...
#ifndef _MTK_GF_ERRCODE_H
#define _MTK_GF_ERRCODE_H
...
#define MODULE_MTK_GF (0) // Temp value

#define MTK_GF_OKCODE(errid)         OKCODE(MODULE_MTK_GF, errid)
#define MTK_GF_ERRCODE(errid)        ERRCODE(MODULE_MTK_GF, errid)


// Detection error code
#define S_GF_OK                  MTK_GF_OKCODE(0x0000)

#define E_GF_NEED_OVER_WRITE     MTK_GF_ERRCODE(0x0001)
#define E_GF_NULL_OBJECT         MTK_GF_ERRCODE(0x0002)
#define E_GF_WRONG_STATE         MTK_GF_ERRCODE(0x0003)
#define E_GF_WRONG_CMD_ID        MTK_GF_ERRCODE(0x0004)
#define E_GF_WRONG_CMD_PARAM     MTK_GF_ERRCODE(0x0005)
#define E_GF_INSUFF_WORK_BUF     MTK_GF_ERRCODE(0x0006)
#define E_GF_WRONG_IMAGE_FMT     MTK_GF_ERRCODE(0x0007)
#define E_GF_ILLEGAL_CONFIG      MTK_GF_ERRCODE(0x0008)
#define E_GF_RECTIFY_FAIL        MTK_GF_ERRCODE(0x0009)
#define E_GF_ILLEGAL_CORE_NUM    MTK_GF_ERRCODE(0x000A)
#define E_GF_NULL_FILE_POINTER   MTK_GF_ERRCODE(0x000B)
#define E_GF_MDP_FAIL            MTK_GF_ERRCODE(0x000C)
#define E_GF_INVALID_PARAM       MTK_GF_ERRCODE(0x000C)

#define E_GF_ERR                 MTK_GF_ERRCODE(0x0100)
