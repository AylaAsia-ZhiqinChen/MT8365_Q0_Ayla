...
typedef enum
{
    MTKFACEBEAUTY_IMAGE_YUV422 =0,
    MTKFACEBEAUTY_IMAGE_YV12,
...
struct MTKFaceBeautyProcInfo
{
    ...
    MINT32 ExtremeMode; //1: enable, 0: disable
    MINT32 PMode; //1: enable, 0: disable(decrease memory usage)
};
