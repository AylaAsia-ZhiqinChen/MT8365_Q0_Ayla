...
#ifndef _MTK_ABF_ERRCODE_H_
#define _MTK_ABF_ERRCODE_H_
...
#define MODULE_MTK_ABF (0) // Temp value

#define MTK_ABF_OKCODE(errid)         OKCODE(MODULE_MTK_ABF, errid)
#define MTK_ABF_ERRCODE(errid)        ERRCODE(MODULE_MTK_ABF, errid)


// Detection error code
#define S_ABF_OK                  MTK_ABF_OKCODE(0x0000)

#define E_ABF_NEED_OVER_WRITE     MTK_ABF_ERRCODE(0x0001)
#define E_ABF_NULL_OBJECT         MTK_ABF_ERRCODE(0x0002)
#define E_ABF_WRONG_STATE         MTK_ABF_ERRCODE(0x0003)
#define E_ABF_WRONG_CMD_ID        MTK_ABF_ERRCODE(0x0004)
#define E_ABF_WRONG_CMD_PARAM     MTK_ABF_ERRCODE(0x0005)
#define E_ABF_INSUFF_WORK_BUF     MTK_ABF_ERRCODE(0x0006)
#define E_ABF_WRONG_IMAGE_FMT     MTK_ABF_ERRCODE(0x0007)
#define E_ABF_ILLEGAL_CONFIG      MTK_ABF_ERRCODE(0x0008)
#define E_ABF_ILLEGAL_CORE_NUM    MTK_ABF_ERRCODE(0x0009)
#define E_ABF_NULL_FILE_POINTER   MTK_ABF_ERRCODE(0x000A)
#define E_ABF_MET_INIT_FAIL       MTK_ABF_ERRCODE(0x000B)

#define E_ABF_ERR                 MTK_ABF_ERRCODE(0x0100)
