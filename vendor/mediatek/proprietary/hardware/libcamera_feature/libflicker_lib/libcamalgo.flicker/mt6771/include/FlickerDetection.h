...
FLICKER_STATUS detectFlicker_SW_SONY(const MINT32 *C_list0, const MINT32 *C_list1, const MINT32 n_win_h,  const MINT32 n_win_w, const MINT32 win_wd, const MINT32 win_ht,
                                const MINT32 cur_freq, const flkSensorInfo sensor_info, flkEISVector eis_vec, const flkAEInfo ae_info,  MINT32 *AF_stat);
...
void flicker_init_SONY(int line, int column_length, int win_width, double read_freq);
