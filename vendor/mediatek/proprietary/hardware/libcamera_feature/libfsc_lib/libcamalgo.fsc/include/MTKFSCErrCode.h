...
#ifndef _MTK_FSC_ERRCODE_H
#define _MTK_FSC_ERRCODE_H
...
#define MODULE_MTK_FSC (0) // Temp value

#define MTK_FSC_OKCODE(errid)         OKCODE(MODULE_MTK_FSC, errid)
#define MTK_FSC_ERRCODE(errid)        ERRCODE(MODULE_MTK_FSC, errid)


// Detection error code
#define S_FSC_OK                  MTK_FSC_OKCODE(0x0000)

#define E_FSC_NEED_OVER_WRITE     MTK_FSC_ERRCODE(0x0001)
#define E_FSC_NULL_OBJECT         MTK_FSC_ERRCODE(0x0002)
#define E_FSC_WRONG_STATE         MTK_FSC_ERRCODE(0x0003)
#define E_FSC_WRONG_CMD_ID        MTK_FSC_ERRCODE(0x0004)
#define E_FSC_WRONG_CMD_PARAM     MTK_FSC_ERRCODE(0x0005)
#define E_FSC_INSUFF_WORK_BUF     MTK_FSC_ERRCODE(0x0006)
#define E_FSC_EGL_CONFIG          MTK_FSC_ERRCODE(0x0006)

#define E_FSC_ERR                 MTK_FSC_ERRCODE(0x0100)
