...
*/
    ...
    {RIL_REQUEST_SIGNAL_STRENGTH, dispatchVoid, responseRilSignalStrength_1_2},
    ...
    {RIL_REQUEST_SET_LINK_CAPACITY_REPORTING_CRITERIA, dispatchLinkCapacityReportingCriteria, responseVoid},
