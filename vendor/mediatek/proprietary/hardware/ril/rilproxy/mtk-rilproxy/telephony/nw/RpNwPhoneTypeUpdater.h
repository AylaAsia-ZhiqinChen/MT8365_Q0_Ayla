...
private:
    ...
    void updatePsType(RfxNwServiceState serviceState);
    ...
    const char *radioTechToString(int radioTech);

    bool needUpdatePsTypeForCapChange(RfxNwServiceState curSS,
            int oldCap, int newCap);

    void onRadioCapabilityChanged(RfxStatusKeyEnum key,
            RfxVariant oldValue, RfxVariant newValue);
