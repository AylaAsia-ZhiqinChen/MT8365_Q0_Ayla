...
#ifndef __RP_IR_LWGSTATUSLISTENER_H__
#define __RP_IR_LWGSTATUSLISTENER_H__
...
class RpIrLwgStatusListener : public RfxController, public IRpIrNwControllerListener {
    RFX_DECLARE_CLASS(RpIrLwgStatusListener);

public:
    RpIrLwgStatusListener();
    RpIrLwgStatusListener(RpIrStrategyCommon *rpIrStrategyCommon, RpIrController *rpIrController);
    virtual ~RpIrLwgStatusListener() {}
...
private:
    ...
    void startLwgNewSearchRound();
};

#endif /* __RP_IR_LWGSTATUSLISTENER_H__ */
