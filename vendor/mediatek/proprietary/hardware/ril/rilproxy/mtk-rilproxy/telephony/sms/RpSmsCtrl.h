...
#ifndef __RP_SMS_CTRL_H__
#define __RP_SMS_CTRL_H__
 ...
 *****************************************************************************/
class RpSmsCtrl : public RpSmsCtrlBase {
    // Required: declare this class
    RFX_DECLARE_CLASS(RpSmsCtrl);
...
private:
    bool isCdmaDualModeSimCard(void);

private:
    RpGsmSmsCtrl *mGsmSmsCtrl;
    RpCdmaSmsCtrl *mCdmaSmsCtrl;
    Vector<int> mImsSmsRefIdVector; //only store ims sms reference id
};

#endif /* __RP_SMS_CTRL_H__ */
