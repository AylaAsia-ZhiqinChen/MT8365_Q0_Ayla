...
#ifndef __RP_EMBMS_SESSION_INFO_H__
#define __RP_EMBMS_SESSION_INFO_H__
...
public:
    RpEmbmsSessionInfo();
    virtual ~RpEmbmsSessionInfo();
    void dump();
    void copy(RpEmbmsSessionInfo& src);
public:
...
#endif /* __RP_EMBMS_SESSION_INFO_H__ */
