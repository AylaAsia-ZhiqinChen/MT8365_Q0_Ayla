...
#ifndef __RP_GSM_NW_RAT_SWITCH_HANDLER__
#define __RP_GSM_NW_RAT_SWITCH_HANDLER__
...
/*
 * Class RpGsmNwRatSwitchHandler,
 * implement the general behaviors of gsm nw rat switch for GSM mode.
 */
class RpGsmNwRatSwitchHandler: public RpBaseNwRatSwitchHandler {
RFX_DECLARE_CLASS(RpGsmNwRatSwitchHandler); // Required: declare this class

public:
    RpGsmNwRatSwitchHandler();
    RpGsmNwRatSwitchHandler(RpNwRatController* nwRatController);
    virtual ~RpGsmNwRatSwitchHandler();
...
public:
    ...
    void doNwRatSwitch(ModemSettings mdSettings,
...
private:
    ModemSettings mMdSettings;
    sp<RfxAction> mAction;
};

#endif /* __Gsm_NW_RAT_SWITCH_HANDLER__ */
