...
RFX_IMPLEMENT_CLASS("RfxSampleController", RfxSampleController, RfxController);


void RfxSampleController::onInit() {
    RfxController::onInit();  // Required: invoke super class implementation

    getStatusManager()->registerStatusChanged(RFX_STATUS_KEY_CARD_TYPE,
        RfxStatusChangeCallback(this, &RfxSampleController::onCardTypeChanged));
    ...
    m_hello_controller = (RfxHelloController *)findController(RFX_OBJ_CLASS_INFO(RfxHelloController));
}

void RfxSampleController::onCardTypeChanged(RfxStatusKeyEnum key,
