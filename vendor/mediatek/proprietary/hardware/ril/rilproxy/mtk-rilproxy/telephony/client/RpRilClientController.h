...
#ifndef __RP_RIL_CLIENT_CONTROLLER_H__
#define __RP_RIL_CLIENT_CONTROLLER_H__
...
class RpRilClientController : public RfxController {
    RFX_DECLARE_CLASS(RpRilClientController);

public:

    RpRilClientController();
    virtual ~RpRilClientController();
    static int queryFileDescriptor(int clientId);
    static RilClient* findClientWithId(int clientId);
    static bool onClientRequestComplete(int slotId, int token, RIL_Errno e,
