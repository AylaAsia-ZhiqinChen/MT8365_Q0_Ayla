...
class RfxHelloController;
/*****************************************************************************
 * Class RfxController
 *****************************************************************************/

class RfxSampleController : public RfxController {
    RFX_DECLARE_CLASS(RfxSampleController);  // Required: declare this class

public:
    RfxSampleController() {}

    virtual ~RfxSampleController() {}
...
private:
    wp<RfxHelloController> m_hello_controller;
};
