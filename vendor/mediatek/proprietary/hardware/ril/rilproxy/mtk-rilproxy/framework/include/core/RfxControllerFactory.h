...
private:
    ...
    static const RfxCreateControllerFuncptr s_slot_controllers[];
    static const RfxCreateControllerFuncptr s_non_slot_controllers[];
    static const RfxCreateControllerFuncptr s_pre_non_slot_controllers[];
};
