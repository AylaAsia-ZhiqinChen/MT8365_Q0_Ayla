...
#-----------------------------------------------------------
#
LOCAL_SRC_FILES += TimestampSyncDataUpdater.cpp
LOCAL_SRC_FILES += MasterCamSyncDataUpdater.cpp
LOCAL_SRC_FILES += ActiveSyncDataUpdater.cpp
LOCAL_SRC_FILES += PhysicalMetaSyncDataUpdater.cpp
LOCAL_SRC_FILES += SyncQueue.cpp
LOCAL_SRC_FILES += SyncHelper.cpp
...
LOCAL_MODULE := libmtkcam_synchelper
