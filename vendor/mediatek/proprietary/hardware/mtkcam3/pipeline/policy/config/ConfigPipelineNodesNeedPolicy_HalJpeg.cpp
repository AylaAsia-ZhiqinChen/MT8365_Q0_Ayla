...
/* Copyright Statement:
 *
 * This softwares software/firmware and related documentation ("MediaTek Software") are
...
#define LOG_TAG "mtkcam-ConfigPipelineNodesNeedPolicy-HalJpeg"
...
makePolicy_Configuration_PipelineNodesNeed_HalJpeg(FunctionType_Configuration_PipelineNodesNeedPolicy f)
{
    auto p = [](
        FunctionType_Configuration_PipelineNodesNeedPolicy fDecoratedPolicy,
        ...
        if ( pOut->needP2CaptureNode ) {
            MY_LOGI("Enabled: needJpegNode=1");
            pOut->needJpegNode = true;
        }
