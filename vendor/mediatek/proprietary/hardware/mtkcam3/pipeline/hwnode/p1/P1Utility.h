...
public:
                            ...
                            , mSecType(secType)
                        {
                            ...
                            //
                            if (amountBasis <= amountMax) { // WaterMark=0 : no buffer keeping in this pool
    ...
    : public virtual android::RefBase
{
    ...
    public:
                        ...
                        , mvpStage()
                        {
                            ...
                            MY_LOGI2("StageNum(%zu)", mvpStage.size());
                            //MY_LOGD0("---");
                        };
...
public:
    ...
    enum CheckPoint
    {
        ...
        CP_OP_START_ISP_CFG_BGN,
        CP_OP_START_ISP_CFG_END,
        CP_OP_START_ISP_START_BGN,
        CP_OP_START_ISP_START_END,
        ...
        CP_OP_STOP_ISP_STOP_BGN,
        CP_OP_STOP_ISP_STOP_END,
...
private:
    ...
    Note mNotes[CP_MAX] = {
        ...
        { CP_OP_START_ISP_CFG_BGN, "OpStart.ISPCfg+++",
            {"", "", "", ""}},

        { CP_OP_START_ISP_CFG_END, "OpStart.ISPCfg---",
            {"", "", "", ""}},

        { CP_OP_START_ISP_START_BGN, "OpStart.ISPStart+++",
            {"", "", "", ""}},

        { CP_OP_START_ISP_START_END, "OpStart.ISPStart---",
            {"", "", "", ""}},
        ...
        { CP_OP_STOP_ISP_STOP_BGN, "OpStop.ISPStop+++",
            {"", "", "", ""}},

        { CP_OP_STOP_ISP_STOP_END, "OpStop.ISPStop---",
            {"", "", "", ""}},
