 ...
 *
 ******************************************************************************/
#define MY_LOGV(fmt, arg...)        CAM_LOGV("[%s], %d, %" PRIdPTR ": " fmt, __FUNCTION__,mOpenId,mNodeId, ##arg)
#define MY_LOGD(fmt, arg...)        CAM_LOGD("[%s], %d, %" PRIdPTR ": " fmt, __FUNCTION__,mOpenId,mNodeId, ##arg)
#define MY_LOGI(fmt, arg...)        CAM_LOGI("[%s], %d, %" PRIdPTR ": " fmt, __FUNCTION__,mOpenId,mNodeId, ##arg)
#define MY_LOGW(fmt, arg...)        CAM_LOGW("[%s], %d, %" PRIdPTR ": " fmt, __FUNCTION__,mOpenId,mNodeId, ##arg)
#define MY_LOGE(fmt, arg...)        CAM_LOGE("[%s], %d, %" PRIdPTR ": " fmt, __FUNCTION__,mOpenId,mNodeId, ##arg)
#define MY_LOGA(fmt, arg...)        CAM_LOGA("[%s], %d, %" PRIdPTR ": " fmt, __FUNCTION__,mOpenId,mNodeId, ##arg)
#define MY_LOGF(fmt, arg...)        CAM_LOGF("[%s], %d, %" PRIdPTR ": " fmt, __FUNCTION__,mOpenId,mNodeId, ##arg)
//
