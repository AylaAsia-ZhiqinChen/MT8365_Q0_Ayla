...
#-----------------------------------------------------------
LOCAL_SRC_FILES += PipelineModelManagerImpl.cpp
LOCAL_SRC_FILES += PipelineModelImpl.cpp
...
#
LOCAL_CFLAGS += -DLOG_TAG='"mtkcam-pipelinemodel"'
#
...
#
LOCAL_SHARED_LIBRARIES += libmtkcam_pipelinemodel_session
LOCAL_SHARED_LIBRARIES += libmtkcam_pipelinemodel_adapter
LOCAL_SHARED_LIBRARIES += libmtkcam_pipelinemodel_capture
LOCAL_SHARED_LIBRARIES += libmtkcam.logicalmodule
# StereoSettingProvider
LOCAL_SHARED_LIBRARIES += libfeature.stereo.provider
#
LOCAL_SHARED_LIBRARIES += libmtkcam_ulog

#-----------------------------------------------------------
LOCAL_MODULE := libmtkcam_pipelinemodel
