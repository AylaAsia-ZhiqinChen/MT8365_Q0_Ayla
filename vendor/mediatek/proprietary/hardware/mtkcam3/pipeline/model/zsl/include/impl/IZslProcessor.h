...
#ifndef _MTK_HARDWARE_MTKCAM_PIPELINE_MODEL_ZSL_INCLUDE_IMPL_IZSLPROCESSOR_H_
#define _MTK_HARDWARE_MTKCAM_PIPELINE_MODEL_ZSL_INCLUDE_IMPL_IZSLPROCESSOR_H_
...
public:
    ...
    virtual auto    configure(ZslConfigParams const& in) -> int                 = 0;
    ...
    virtual auto    submitZslRequest(
                        ZslRequestParams&& in
                    ) -> std::vector<FrameBuildersOfOneRequest>                 = 0;
     ...
     */
    virtual auto    hasZslPendingRequest() const -> bool                        = 0;
     ...
     *
     */
    virtual auto    flush() -> std::vector<FrameBuildersOfOneRequest>           = 0;
...
#endif  //_MTK_HARDWARE_MTKCAM_PIPELINE_MODEL_ZSL_INCLUDE_IMPL_IZSLPROCESSOR_H_
