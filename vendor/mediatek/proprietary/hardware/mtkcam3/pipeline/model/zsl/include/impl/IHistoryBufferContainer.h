...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:   //// definition.
    typedef android::DefaultKeyedVector<StreamId_T, android::sp<IImageStreamBuffer> >
                                        ImageSet_T;
    ...
    struct BufferSet_T {
        ...
        MetaSet_T       vMetaSet;
        uint32_t        mRefFrameNo = 0;
        bool            bKeep = true;     // release this HBS after canceling back to HBC
    };
