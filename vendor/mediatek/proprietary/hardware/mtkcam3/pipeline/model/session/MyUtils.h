...
#ifndef _MTK_HARDWARE_MTKCAM_PIPELINE_MODEL_SESSION_MYUTILS_H_
#define _MTK_HARDWARE_MTKCAM_PIPELINE_MODEL_SESSION_MYUTILS_H_
...
#define MY_DEBUG(level, fmt, arg...) \
    do { \
        CAM_ULOGM##level("[%s::%s] " fmt, mSessionName.c_str(), __FUNCTION__, ##arg); \
        mDebugInfo.pDebugPrinter->printFormatLine(#level" [%s::%s] " fmt, mSessionName.c_str(), __FUNCTION__, ##arg); \
    } while(0)

#define MY_WARN(level, fmt, arg...) \
    do { \
        CAM_ULOGM##level("[%s::%s] " fmt, mSessionName.c_str(), __FUNCTION__, ##arg); \
        mDebugInfo.pWarningPrinter->printFormatLine(#level" [%s::%s] " fmt, mSessionName.c_str(), __FUNCTION__, ##arg); \
    } while(0)

#define MY_ERROR(level, fmt, arg...) \
    do { \
        CAM_LOG##level("[%s::%s] " fmt, mSessionName.c_str(), __FUNCTION__, ##arg); \
        mDebugInfo.pErrorPrinter->printFormatLine(#level" [%s::%s] " fmt, mSessionName.c_str(), __FUNCTION__, ##arg); \
    } while(0)
 ...
 *
 ******************************************************************************/
#endif  //_MTK_HARDWARE_MTKCAM_PIPELINE_MODEL_SESSION_MYUTILS_H_
