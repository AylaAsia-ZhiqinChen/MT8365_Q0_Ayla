...
#-----------------------------------------------------------
LOCAL_SRC_FILES += CaptureInFlightRequest.cpp
LOCAL_SRC_FILES += NextCaptureListener.cpp
LOCAL_SRC_FILES += AppRaw16Reprocessor.cpp
...
#-----------------------------------------------------------
LOCAL_MODULE := libmtkcam_pipelinemodel_capture
