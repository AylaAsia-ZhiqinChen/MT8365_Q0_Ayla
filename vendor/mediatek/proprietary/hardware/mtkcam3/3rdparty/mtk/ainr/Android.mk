...
#-----------------------------------------------------------
LOCAL_SRC_FILES += AINRProcImpl.cpp
LOCAL_SRC_FILES += AinrCtrler.cpp
LOCAL_SRC_FILES += AINR_HDRPlugin.cpp
#-----------------------------------------------------------
LOCAL_C_INCLUDES += $(MTKCAM_C_INCLUDES)
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam3/include $(MTK_PATH_SOURCE)/hardware/mtkcam/include
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam3/feature/ainr/core/inc
...
#-----------------------------------------------------------
LOCAL_MODULE := libmtkcam.plugin.ainr
