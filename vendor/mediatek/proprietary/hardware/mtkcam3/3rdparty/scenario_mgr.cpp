...
)
{
    ...
    if (!scenarioHint.isIspHidl) {
        ...
        ret &= customer_get_capture_scenario(scenario,
                                             ...
                                             scenarioHint,
                                             pAppMetadata) ||
               mtk_get_capture_scenario(scenario,
                                        scenarioFeatures,
                                        scenarioConfig,
                                        scenarioHint,
                                        pAppMetadata);
        ...
        ret &= customer_get_isp_hidl_capture_scenario(scenario,
                                             ...
                                             scenarioHint,
                                             pAppMetadata) ||
               mtk_get_isp_hidl_capture_scenario(scenario,
                                        scenarioFeatures,
                                        scenarioConfig,
                                        scenarioHint,
                                        pAppMetadata);
    ...
    ret &= mtk_update_capture_feature_combination(scenarioFeatures, pAppMetadata);
...
)
{
    return customer_get_streaming_scenario(scenario,
                                         ...
                                         scenarioHint,
                                         pAppMetadata) ||
           mtk_get_streaming_scenario(scenario,
                                      scenarioFeatures,
                                      scenarioConfig,
                                      scenarioHint,
                                      pAppMetadata);
