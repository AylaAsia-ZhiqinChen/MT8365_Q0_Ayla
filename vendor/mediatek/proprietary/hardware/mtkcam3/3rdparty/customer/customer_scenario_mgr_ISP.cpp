...
#define USE_CUSTOMER_ISP_HIDL_SCENARIO_MGR 0
...
#define TP_FEATURE_COMBINATION_SINGLE_FULL         (NO_FEATURE_NORMAL | MTK_FEATURE_DCE| MTK_FEATURE_DRE| MTK_FEATURE_HFG| MTK_FEATURE_DSDN| MTK_FEATURE_NR| MTK_FEATURE_CZ)
#define TP_FEATURE_COMBINATION_AINR_FULL           (MTK_FEATURE_AINR  | MTK_FEATURE_DCE| MTK_FEATURE_DRE| MTK_FEATURE_HFG| MTK_FEATURE_DSDN| MTK_FEATURE_NR| MTK_FEATURE_CZ)
#define TP_FEATURE_COMBINATION_MFNR_FULL           (MTK_FEATURE_MFNR  | MTK_FEATURE_DRE| MTK_FEATURE_HFG| MTK_FEATURE_CZ)

// single frame in
#define TP_FEATURE_COMBINATION_SINGLE_RAW_TO_YUV   (NO_FEATURE_NORMAL | MTK_FEATURE_DCE| MTK_FEATURE_DRE| MTK_FEATURE_HFG| MTK_FEATURE_DSDN| MTK_FEATURE_NR| MTK_FEATURE_CZ)
#define TP_FEATURE_COMBINATION_SINGLE_RAW_TO_JPEG  (NO_FEATURE_NORMAL | MTK_FEATURE_DCE| MTK_FEATURE_DRE| MTK_FEATURE_HFG| MTK_FEATURE_DSDN| MTK_FEATURE_NR| MTK_FEATURE_CZ)
#define TP_FEATURE_COMBINATION_SINGLE_YUV_TO_YUV   (NO_FEATURE_NORMAL) // image transform and crop/resize only
#define TP_FEATURE_COMBINATION_SINGLE_YUV_TO_JPEG  (NO_FEATURE_NORMAL) // encode yuv to jpeg only.
// multiple frame in
#define TP_FEATURE_COMBINATION_AINR_RAW_TO_RAW     (MTK_FEATURE_AINR)  // output AINR RAW only
#define TP_FEATURE_COMBINATION_AINR_RAW_TO_YUV     (MTK_FEATURE_AINR  | MTK_FEATURE_DCE| MTK_FEATURE_DRE| MTK_FEATURE_HFG| MTK_FEATURE_NR| MTK_FEATURE_CZ)
#define TP_FEATURE_COMBINATION_AINR_RAW_TO_JPEG    (MTK_FEATURE_AINR  | MTK_FEATURE_DCE| MTK_FEATURE_DRE| MTK_FEATURE_HFG| MTK_FEATURE_NR| MTK_FEATURE_CZ)
#define TP_FEATURE_COMBINATION_MFNR_RAW_TO_YUV     (MTK_FEATURE_MFNR  | MTK_FEATURE_DRE| MTK_FEATURE_HFG| MTK_FEATURE_NR| MTK_FEATURE_CZ)
#define TP_FEATURE_COMBINATION_MFNR_RAW_TO_JPEG    (MTK_FEATURE_MFNR  | MTK_FEATURE_DRE| MTK_FEATURE_HFG| MTK_FEATURE_NR| MTK_FEATURE_CZ)
...
bool gForceCustomerIspHidlScenarioMgr = ::property_get_int32("vendor.debug.isphidl.customer.scenario.force", USE_CUSTOMER_ISP_HIDL_SCENARIO_MGR);
...
{
    {
        ...
        ADD_CAMERA_FEATURE_SET(MTK_FEATURE_AINR,     TP_FEATURE_COMBINATION_AINR_FULL)
        ADD_CAMERA_FEATURE_SET(MTK_FEATURE_MFNR,     TP_FEATURE_COMBINATION_MFNR_FULL)
        ADD_CAMERA_FEATURE_SET(NO_FEATURE_NORMAL,    TP_FEATURE_COMBINATION_SINGLE_FULL)
        CAMERA_SCENARIO_END
        //
        CAMERA_SCENARIO_START(MTK_ISP_HIDL_SCENARIO_CAPTURE_SINGLE_RAW_TO_YUV) // encode single raw to yuv
        ADD_CAMERA_FEATURE_SET(NO_FEATURE_NORMAL,    TP_FEATURE_COMBINATION_SINGLE_RAW_TO_YUV)
        CAMERA_SCENARIO_END
        //
        CAMERA_SCENARIO_START(MTK_ISP_HIDL_SCENARIO_CAPTURE_SINGLE_RAW_TO_JPEG) // encode single raw to yuv and encode to jepg
        ADD_CAMERA_FEATURE_SET(NO_FEATURE_NORMAL,    TP_FEATURE_COMBINATION_SINGLE_RAW_TO_JPEG)
        CAMERA_SCENARIO_END
        //
        CAMERA_SCENARIO_START(MTK_ISP_HIDL_SCENARIO_CAPTURE_SINGLE_YUV_TO_YUV) // single yuv reprocessing
        ADD_CAMERA_FEATURE_SET(NO_FEATURE_NORMAL,    TP_FEATURE_COMBINATION_SINGLE_YUV_TO_YUV)
        CAMERA_SCENARIO_END
        //
        CAMERA_SCENARIO_START(MTK_ISP_HIDL_SCENARIO_CAPTURE_SINGLE_YUV_TO_JPEG) // encode single yuv to jpeg
        ADD_CAMERA_FEATURE_SET(NO_FEATURE_NORMAL,    TP_FEATURE_COMBINATION_SINGLE_YUV_TO_JPEG)
        CAMERA_SCENARIO_END
        //
        CAMERA_SCENARIO_START(MTK_ISP_HIDL_SCENARIO_CAPTURE_MULTIPLE_RAW_TO_RAW) // multiframe raw to single raw
        ADD_CAMERA_FEATURE_SET(MTK_FEATURE_AINR,     TP_FEATURE_COMBINATION_AINR_RAW_TO_RAW)
        CAMERA_SCENARIO_END
        //
        CAMERA_SCENARIO_START(MTK_ISP_HIDL_SCENARIO_CAPTURE_MULTIPLE_RAW_TO_YUV) // multiframe raw to single yuv
        ADD_CAMERA_FEATURE_SET(MTK_FEATURE_AINR,     TP_FEATURE_COMBINATION_AINR_RAW_TO_YUV)
        ADD_CAMERA_FEATURE_SET(MTK_FEATURE_MFNR,     TP_FEATURE_COMBINATION_MFNR_RAW_TO_YUV)
        CAMERA_SCENARIO_END
        //
        CAMERA_SCENARIO_START(MTK_ISP_HIDL_SCENARIO_CAPTURE_MULTIPLE_RAW_TO_JPEG) // multiframe raw to jpeg
        ADD_CAMERA_FEATURE_SET(MTK_FEATURE_AINR,     TP_FEATURE_COMBINATION_AINR_RAW_TO_JPEG)
        ADD_CAMERA_FEATURE_SET(MTK_FEATURE_MFNR,     TP_FEATURE_COMBINATION_MFNR_RAW_TO_JPEG)
        CAMERA_SCENARIO_END
        //
        // streaming
        // reserved
...
{
    if( !gForceCustomerIspHidlScenarioMgr ) {
        MY_LOGD("not support: USE_CUSTOMER_ISP_HIDL_SCENARIO_MGR(%d), set forced(%d))", USE_CUSTOMER_ISP_HIDL_SCENARIO_MGR, gForceCustomerIspHidlScenarioMgr);
        return false;
    }
