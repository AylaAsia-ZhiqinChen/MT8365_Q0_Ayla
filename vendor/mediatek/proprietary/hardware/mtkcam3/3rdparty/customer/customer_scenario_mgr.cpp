...
#define TP_FEATURE_COMBINATION_SINGLE          (NO_FEATURE_NORMAL   | MTK_FEATURE_NR| MTK_FEATURE_ABF| MTK_FEATURE_CZ| MTK_FEATURE_DRE| MTK_FEATURE_HFG| MTK_FEATURE_DCE| TP_FEATURE_FB | MTK_FEATURE_DSDN)
...
#define TP_FEATURE_COMBINATION_ISP_HIDL_SOURCE_COMMON  (NO_FEATURE_NORMAL | MTK_FEATURE_NR| MTK_FEATURE_CZ| MTK_FEATURE_DRE| MTK_FEATURE_HFG| MTK_FEATURE_DCE| MTK_FEATURE_DSDN)
#define TP_FEATURE_COMBINATION_ISP_HIDL_SOURCE_MFNR    (MTK_FEATURE_MFNR  | MTK_FEATURE_NR| MTK_FEATURE_CZ| MTK_FEATURE_DRE| MTK_FEATURE_HFG| MTK_FEATURE_DCE)
#define TP_FEATURE_COMBINATION_ISP_HIDL_SOURCE_AINR    (MTK_FEATURE_AINR  | MTK_FEATURE_NR| MTK_FEATURE_CZ| MTK_FEATURE_DRE| MTK_FEATURE_HFG| MTK_FEATURE_DCE)
...
// TODO: add scenario/feature set for camera scenario by customer
...
{
    {
        ...
        CAMERA_SCENARIO_END
        //
        CAMERA_SCENARIO_START(MTK_CAMERA_SCENARIO_CAPTURE_DNG_OPAQUE_RAW_ONLY)
        ADD_CAMERA_FEATURE_SET(NO_FEATURE_NORMAL, NO_FEATURE_NORMAL)
        CAMERA_SCENARIO_END
        //
        ...
        ADD_CAMERA_FEATURE_SET(NO_FEATURE_NORMAL, TP_FEATURE_COMBINATION_ISP_HIDL_SOURCE_COMMON)
        CAMERA_SCENARIO_END
        //
        CAMERA_SCENARIO_START(MTK_CAMERA_SCENARIO_CAPTURE_REQUEST_FRAME_FOR_ISP_HIDL_RAW)
        ADD_CAMERA_FEATURE_SET(MTK_FEATURE_AINR,  TP_FEATURE_COMBINATION_ISP_HIDL_SOURCE_AINR)
        ADD_CAMERA_FEATURE_SET(MTK_FEATURE_MFNR,  TP_FEATURE_COMBINATION_ISP_HIDL_SOURCE_MFNR)
        ADD_CAMERA_FEATURE_SET(NO_FEATURE_NORMAL, TP_FEATURE_COMBINATION_ISP_HIDL_SOURCE_COMMON)
        CAMERA_SCENARIO_END
        //
        // streaming
...
) -> bool
{
    ...
    else if (scenarioHint.isRawOnlyRequest) {
        MY_LOGD("request dng or opaque raw only");
        scenario = MTK_CAMERA_SCENARIO_CAPTURE_DNG_OPAQUE_RAW_ONLY;
    }
...
) -> bool
{
    ...
    auto scenarioFeaturesMap = gCustomerScenarioFeaturesMaps[0];
...
bool customer_get_streaming_config(
    int32_t /*scenario*/,
    const ScenarioFeatures &scenarioFeatures __unused,
    StreamingScenarioConfig &scenarioConfig,
    const ScenarioHint &scenarioHint,
    const IMetadata */*pAppMetadata*/
)
{
    (void)scenarioFeatures;
...
)
{
    ...
    return customer_get_capture_scenario(scenario, scenarioHint, pAppMetadata) &&
           ...
           customer_get_features_table_by_scenario(scenario, scenarioFeatures);
}
