...
struct StereoArea {
    ...
    inline StereoArea &apply4Align(bool keepContent=false, bool centerContent=true)  { return applyNAlign(E_4_ALIGN,  keepContent, centerContent); }
    ...
    inline StereoArea &apply4AlignRounding(bool keepContent=false, bool centerContent=true)  { return applyNAlignRounding(E_4_ALIGN,  keepContent, centerContent); }
    ...
    inline StereoArea &apply4AlignToWidth(bool keepContent=true, bool centerContent=true)  { return applyNAlignToWidth(E_4_ALIGN, keepContent, centerContent); }
    ...
    inline StereoArea &apply4AlignToHeight(bool keepContent=true, bool centerContent=true)  { return applyNAlignToHeight(E_4_ALIGN, keepContent, centerContent); }
