...
public:
     ...
     */
    bool getPass1ActiveArrayCrop(ENUM_STEREO_SENSOR sensor, NSCam::MRect &cropRect, bool isCropNeeded=true);
     ...
     */
    NSCam::MSize thirdPartyDepthmapSize(ENUM_STEREO_RATIO ratio, ENUM_STEREO_SCENARIO senario=eSTEREO_SCENARIO_PREVIEW) const;
     ...
     */
    bool getDualcamP2IMGOYuvCropResizeInfo(const int SENSOR_INDEX, NSCam::MRect &cropRect, NSCam::MSize &targetSize);

public:
    //For updating sizes when user update logical device ID
...
private:
    ...
    NSCam::MSize            __imgoYuvSize[2] = { MSIZE_ZERO, MSIZE_ZERO };  //[0]: main1 [1]: main2
    NSCam::MSize            __rrzoYuvSize[2] = { MSIZE_ZERO, MSIZE_ZERO };  //[0]: main1 [1]: main2
    ...
    std::map<MUINT32, NSCam::MRect> __activeCropMap;
