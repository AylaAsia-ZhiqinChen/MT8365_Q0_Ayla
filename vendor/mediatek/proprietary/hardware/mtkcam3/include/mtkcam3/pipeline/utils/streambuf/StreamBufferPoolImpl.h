...
#ifndef _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_PIPELINE_UTILS_STREAMBUF_STREAMBUFFERPOOLIMPL_H_
#define _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_PIPELINE_UTILS_STREAMBUF_STREAMBUFFERPOOLIMPL_H_
//
#include <atomic>
#include <string>
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
private:
    std::string const                   mPoolName;
    std::string const                   mSystraceName_acquireFromPool;
    std::string const                   mSystraceName_releaseToPool;

protected:
    mutable android::Mutex              mLock;
    MUINT32                             muToAllocCnt = 0;
    std::atomic_int32_t                 miAvailableCount{0};
...
#endif  //_MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_PIPELINE_UTILS_STREAMBUF_STREAMBUFFERPOOLIMPL_H_
