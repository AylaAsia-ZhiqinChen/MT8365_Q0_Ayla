...
public:     ////                            Definitions.
    ...
    using NodeId_T = NSCam::v3::pipeline::NodeId_T;         //Node Id
...
public:     ////                            Attributes.
     ...
     */
    virtual android::Vector<NodeObj_T>                getRootNode() const             = 0;

    /**
     * Get the root node set
     *
     * @return
     *      a node set which indicates root node ids.
     */
    virtual NodeSet                                   getRootNodeSet() const          = 0;
