...
#ifndef _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_PIPELINE_POLICY_IFACEDETECTIONINTENTPOLICY_H_
#define _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_PIPELINE_POLICY_IFACEDETECTIONINTENTPOLICY_H_
//
#include "types.h"
...
using FunctionType_FaceDetectionIntentPolicy
    = std::function<int(
        fdintent::RequestOutputParams& /*out*/,
...
#endif  //_MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_PIPELINE_POLICY_IFACEDETECTIONINTENTPOLICY_H_
