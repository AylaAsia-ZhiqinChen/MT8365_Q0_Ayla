...
#include <mtkcam3/pipeline/stream/IUsersManager.h>
...
protected:  ////                        Operations.
    ...
    MVOID                               dumpStateLocked(android::Printer& printer) const;
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  [Bg service] data members
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
private:
    android::String8                    mCallerName;
    mutable android::Mutex              mWaitUserStatusLock;
    mutable android::Condition          mWaitUserStatusCond;
    bool                                mbNeedWaitReleaseStatus = false;
