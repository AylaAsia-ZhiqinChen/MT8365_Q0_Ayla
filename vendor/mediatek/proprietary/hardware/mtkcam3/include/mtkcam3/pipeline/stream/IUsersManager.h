...
public:     ////                        Operations.
    ...
    /**
     * Check to see whether it's active or not.
     * It's "NOT" active before finishUserSetup() or after reset().
     *
     * @return
     *      ture if active; otherwise false.
     */
...
public:     ////                        Operations.
    ...
    /**
     * [Bg service] use to wait all user release.
     */
    virtual MERROR                      waitUserReleaseStatus(
                                                std::string caller) = 0;

    /**
     * [Bg service] use to check all producer release or pre-release.
     */
    virtual MERROR                      haveAllProducerUsersReleasedOrPreReleased(
                                        ) const = 0;

    /**
     * [Bg service] use to check all user release or pre-release.
     */
    virtual MERROR                      haveAllUsersReleasedOrPreReleased(
                                        ) const = 0;
};
