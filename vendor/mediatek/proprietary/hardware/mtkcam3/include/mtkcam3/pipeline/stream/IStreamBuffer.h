...
#ifndef _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_PIPELINE_STREAM_ISTREAMBUFFER_H_
#define _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_PIPELINE_STREAM_ISTREAMBUFFER_H_
//
...
public:     ////    Configuration.
    virtual auto    setUsersManager(android::sp<IUsersManager> arg) -> MVOID= 0;

public:     ////    Attributes.
    virtual auto    getMagicName() const -> char const* { return "";/*not implement*/ }
    virtual auto    getMagicHandle() const -> void* { return nullptr;/*not implement*/ }
...
{
public:     ////    Operations.
    virtual auto    releaseBuffer() -> MVOID {}

    /**
     * Replace the current stream info with a given stream info.
     */
    virtual auto    replaceStreamInfo(
                        android::sp<IImageStreamInfo> pNewStreamInfo
                    ) -> MVOID { (void)pNewStreamInfo;/*not implement*/ }
...
#endif  //_MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_PIPELINE_STREAM_ISTREAMBUFFER_H_
