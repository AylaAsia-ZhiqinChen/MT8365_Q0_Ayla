...
int main()
{
    ...
    ALOGI("VPU HAL Server is starting..., MTKCAM_MMSDK_SUPPORT(%d)", MTKCAM_MMSDK_SUPPORT);
...

    {
        ...
        registerPassthroughServiceImplementation<IMtkVpuClient>("internal/0" /*"internal" for binderized mode*/);
#endif
    }
// #ifdef MTKCAM_BGSERVICE_SUPPORT
        // using ::vendor::mediatek::hardware::camera::bgservice::V1_0::IBGService;
        // using vendor::mediatek::hardware::camera::bgservice::V1_0::implementation::BGService;
        // using android::sp;
        // using android::status_t;
        //registerPassthroughServiceImplementation<IBGService>("internal/0" /*"internal" for binderized mode*/);
        // no need to support Passthrough
        // sp<IBGService> pBGService = new BGService();
        // status_t status = pBGService->registerAsService();
        // ALOGI("Camera BGService registerAsService, status=%d", status);
// #endif
//     }
