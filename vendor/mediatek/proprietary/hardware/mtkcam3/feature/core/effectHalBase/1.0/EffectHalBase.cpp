...
#include <mtkcam3/feature/effectHalBase/EffectHalBase.h>
 ...
 *
 ******************************************************************************/
#define FUNCTION_LOG_START      CAM_ULOGMD("[%s] - E. , mState=%d, this=%p", __FUNCTION__, mState, this)
#define FUNCTION_LOG_END        CAM_ULOGMD("[%s] - X. , mState=%d", __FUNCTION__, mState)
#define aaa 1
