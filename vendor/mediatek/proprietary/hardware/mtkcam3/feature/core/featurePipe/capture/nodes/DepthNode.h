...
#ifndef _MTK_CAMERA_CAPTURE_FEATURE_PIPE_DEPTH_NODE_H_
#define _MTK_CAMERA_CAPTURE_FEATURE_PIPE_DEPTH_NODE_H_
...
/**
 * @brief DepthNode Node of the CaptureFeaturePipe
 */
class DepthNode final: public CaptureFeatureNode,
                       public NSPipelinePlugin::DepthPlugin::RequestCallback
{
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  CaptureFeatureNode Public Type Alias.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
    using Plugin            = NSPipelinePlugin::DepthPlugin;
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
    DepthNode(NodeID_T nodeId, const char* name, MINT32 policy = SCHED_NORMAL, MINT32 priority = DEFAULT_CAMTHREAD_PRIORITY);

    ~DepthNode() override;

//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  DepthPlugin::RequestCallback Public Operations.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
private:
    MVOID preprocess(ProviderPtr& providerPtr, RequestPtr& pipeRequestPtr);
...
private:
    ...
    struct ProviderInfo
    {
        ...
        std::vector<MINT>   mSupportInputFmts;
        InitJob             mInitJob;
    };
...
#endif // _MTK_CAMERA_CAPTURE_FEATURE_PIPE_DEPTH_NODE_H_
