...
private:
    ...
    MBOOL _copyBufferIntoRequestWithCrop(
                    IImageBuffer* pSrcBuffer,
                    sp<DepthMapEffectRequest> pRequest,
                    DepthMapBufferID bufferID);
    /**
    ...
    */
    ...
    /**
     * @brief wait for n3d finish
     * @param [in] pRequest
     * @return
     * - MTRUE indicates success.
     * - MFALSE indicates failure.
    */
    MBOOL waitForN3DFinish(sp<DepthMapEffectRequest> pRequest);
...
public:
    ...
    //
    KeyedVector<MUINT32, MBOOL> mvN3DReadyReq;
    Mutex mLock;
