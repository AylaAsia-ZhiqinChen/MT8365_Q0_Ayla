...
#ifndef _MTK_CAMERA_CAPTURE_FEATURE_PIPE_FD_NODE_H_
#define _MTK_CAMERA_CAPTURE_FEATURE_PIPE_FD_NODE_H_
...
{
public:
    FDNode(NodeID_T nid, const char *name, MINT32 policy = SCHED_NORMAL, MINT32 priority = DEFAULT_CAMTHREAD_PRIORITY);
    virtual ~FDNode();
...
#endif // _MTK_CAMERA_CAPTURE_FEATURE_PIPE_FD_NODE_H_
