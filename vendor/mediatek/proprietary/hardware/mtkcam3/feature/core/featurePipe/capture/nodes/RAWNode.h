...
#ifndef _MTK_CAMERA_CAPTURE_FEATURE_PIPE_RAW_NODE_H_
#define _MTK_CAMERA_CAPTURE_FEATURE_PIPE_RAW_NODE_H_
...
{
public:
    RAWNode(NodeID_T nid, const char *name, MINT32 policy = SCHED_NORMAL, MINT32 priority = DEFAULT_CAMTHREAD_PRIORITY);
    virtual ~RAWNode();
...
private:
    ...
    typedef NSCam::NSPipelinePlugin::RawPlugin::RequestCallback::Ptr RequestCallbackPtr;
...
#endif // _MTK_CAMERA_CAPTURE_FEATURE_PIPE_RAW_NODE_H_
