...
protected:
     ...
     */
    // Main2
    virtual MBOOL prepareQParamStage0_Main2(
                                int iFrameNum,
                                MINT32 iModuleTrans,
                                QParams& rQParam);
    virtual MBOOL prepareQParamStage1_Main2(int iFrameNum, QParams& rQParam);
    virtual MBOOL prepareQParamStage2_Main2(int iFrameNum, QParams& rQParam);
    // Main1
    virtual MBOOL prepareQParamStage0_Main1(
                        int iFrameNum,
                        MINT32 iModuleTrans,
                        QParams& rQParam);
    virtual MBOOL prepareQParamStage1_Main1(int iFrameNum, QParams& rQParam);
    ...
    /**
     * @brief setup the FE/FM tuning buffer for capture
     */
    MVOID setupFMTuningInfo_cap(NSCam::NSIoPipe::FMInfo& fmInfo, MUINT iFrameID);
    /**
    ...
    */
    ...
    virtual MBOOL prepareQParamsTemplate_CAPTURE(
                        ...
                        QParams& rQParam);
    //
    virtual MBOOL prepareQParam_frame0_cap(MINT32 iModuleTrans, QParams& rQParam);
    virtual MBOOL prepareQParam_frame1_cap(MINT32 iModuleTrans, QParams& rQParam);
    virtual MBOOL prepareQParam_frame2_cap(QParams& rQParam);
    virtual MBOOL prepareQParam_frame3_cap(QParams& rQParam);
    virtual MBOOL prepareQParam_frame4_cap(QParams& rQParam);
    virtual MBOOL prepareQParam_frame5_cap(QParams& rQParam);
    virtual MBOOL prepareQParam_frame6_9_cap(QParams& rQParam);

    // buildQParam for capture scenario
    virtual MBOOL buildQParam_frame0_cap(
                    DepthMapRequestPtr& rpRequest, const Stereo3ATuningRes& tuningResult,
                    QParamTemplateFiller& rQFiller);
    virtual MBOOL buildQParam_frame1_cap(
                    DepthMapRequestPtr& rpRequest, const Stereo3ATuningRes& tuningResult,
                    QParamTemplateFiller& rQFiller);
    virtual MBOOL buildQParam_frame2_cap(
                    DepthMapRequestPtr& rpRequest, const Stereo3ATuningRes& tuningResult,
                    QParamTemplateFiller& rQFiller);
    virtual MBOOL buildQParam_frame3_cap(
                    DepthMapRequestPtr& rpRequest, const Stereo3ATuningRes& tuningResult,
                    QParamTemplateFiller& rQFiller);
    virtual MBOOL buildQParam_frame4_cap(
                    DepthMapRequestPtr& rpRequest, const Stereo3ATuningRes& tuningResult,
                    QParamTemplateFiller& rQFiller);
    virtual MBOOL buildQParam_frame5_cap(
                    DepthMapRequestPtr& rpRequest, const Stereo3ATuningRes& tuningResult,
                    QParamTemplateFiller& rQFiller);
    virtual MBOOL buildQParam_frame6to9_cap(
                    DepthMapRequestPtr& rpRequest, const Stereo3ATuningRes& tuningResult,
                    QParamTemplateFiller& rQFiller);
...
protected:
    ...
    KeyedVector<MUINT, NSCam::NSIoPipe::FMInfo> mFMTuningBufferMap_cap;
