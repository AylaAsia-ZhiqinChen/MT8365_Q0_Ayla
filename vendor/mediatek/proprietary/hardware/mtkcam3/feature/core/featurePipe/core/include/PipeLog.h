...
#undef FP_LOG
#define FP_LOG(lv, fmt, arg...) CAM_ULOGM##lv("[%s]" fmt, __FUNCTION__, ##arg)

#undef FS_LOG
#define FS_LOG(lv, s, fmt, arg...) CAM_ULOGM##lv("[%s] %s:" fmt, __FUNCTION__, ::NSCam::Feature::getLogStr(s),  ##arg)
...
#define MY_LOGF(fmt, arg...)        FP_DO(CAM_ULOGM_FATAL("[%s]" fmt, __FUNCTION__, ##arg))
