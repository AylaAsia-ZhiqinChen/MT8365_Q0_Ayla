...
private:
    ...
    MBOOL processEIS30(const RequestPtr &request, EIS_HAL_CONFIG_DATA &config, const RSCResult &rsc);
    ...
    MBOOL handleWarpResult(const RequestPtr &request, const WarpController &controller);
    MBOOL handleQDataWarpResult(const RequestPtr &request, const ImgBuffer &recordWarp,
