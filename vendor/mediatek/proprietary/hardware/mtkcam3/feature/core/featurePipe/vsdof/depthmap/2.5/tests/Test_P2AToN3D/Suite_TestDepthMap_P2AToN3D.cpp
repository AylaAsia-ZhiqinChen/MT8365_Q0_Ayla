...
#define TEST_REQ_TYPE eSTATE_CAPTURE
#define EIS_ON 0
...
//void test()
{
    ...
    // create pipe nodes
    P2AFMNode *pP2AFMNode = new P2AFMNode("P2AFMNode", eDPETHMAP_PIPE_NODEID_P2AFM, config);
    ...
    depthInfo.mpDepthBuffer = pBuffPoolMgr->request(BID_WMF_OUT_DMW, eBUFFER_POOL_SCENARIO_RECORD);
    pStorage->push_back(depthInfo);

    MY_LOGD("Connect Nodes...");
    // connect data
    CONNECT_DATA_AND_SETUPDUMP(pP2AFMNode, pN3DNode, P2A_TO_N3D_FEFM_CCin);
    CONNECT_DATA_AND_SETUPDUMP(pP2AFMNode, pCallbackUTNode, P2A_OUT_MV_F);
    CONNECT_DATA_AND_SETUPDUMP(pP2AFMNode, pCallbackUTNode, P2A_OUT_FD);
    CONNECT_DATA_AND_SETUPDUMP(pP2AFMNode, pCallbackUTNode, P2A_OUT_MV_F_CAP);
    CONNECT_DATA_AND_SETUPDUMP(pP2AFMNode, pCallbackUTNode, P2A_OUT_YUV_DONE);
    CONNECT_DATA_AND_SETUPDUMP(pP2AFMNode, pCallbackUTNode, P2A_TO_OCC_MY_S);
    CONNECT_DATA_AND_SETUPDUMP(pP2AFMNode, pCallbackUTNode, DEPTHMAP_META_OUT);
    CONNECT_DATA_AND_SETUPDUMP(pP2AFMNode, pCallbackUTNode, P2A_TO_FD_IMG);
    CONNECT_DATA_AND_SETUPDUMP(pP2AFMNode, pCallbackUTNode, P2A_TO_GF_DMW_MYS);

    CONNECT_DATA_AND_SETUPDUMP(pN3DNode, pCallbackUTNode, N3D_TO_DPE_MVSV_MASK);
    CONNECT_DATA_AND_SETUPDUMP(pN3DNode, pCallbackUTNode, N3D_TO_OCC_LDC);
    ...
    SETUP_DUMP(pP2AFMNode, TO_DUMP_RAWS);
    SETUP_DUMP(pP2AFMNode, TO_DUMP_BUFFERS);
    ...
    if(TEST_REQ_TYPE == eSTATE_NORMAL)
    {
        ...
        {
            vWaitDataID.push_back(P2A_TO_GF_DMW_MYS);
        }
        else
        {
...
//void test()
{
    ...
    // connect data
    CONNECT_DATA_AND_SETUPDUMP(pP2AFMNode, pN3DNode, P2A_TO_N3D_FEFM_CCin);
    CONNECT_DATA_AND_SETUPDUMP(pP2AFMNode, pP2ABayerNode, BAYER_ENQUE);
