...
#ifndef _MTK_CAMERA_STREAMING_FEATURE_PIPE_NULL_NODE_H_
#define _MTK_CAMERA_STREAMING_FEATURE_PIPE_NULL_NODE_H_
...
#endif // _MTK_CAMERA_STREAMING_FEATURE_PIPE_NULL_NODE_H_
