...
private:
    MVOID prepareDIPParams(Feature::P2Util::DIPParams &param, WPEEnqueData &data, const WarpParam &warpParam);
...
private:
    ...
    MVOID setBasic(Feature::P2Util::DIPFrameParams &fparam, WPEEnqueData &data);
    MVOID setInBuffer(Feature::P2Util::DIPFrameParams &fparam, WPEEnqueData &data);
    MVOID setMDPParam(Feature::P2Util::DIPParams &param, Feature::P2Util::DIPFrameParams &fparam, WPEEnqueData &data);
    MVOID setWPEDIPParams(Feature::P2Util::DIPFrameParams &fparam, WPEEnqueData &data);
