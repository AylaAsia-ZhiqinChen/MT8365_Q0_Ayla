...
public:
    ...
    QParamTemplateGenerator& addOutput(PortID portID, MINT32 transform=0, EPortCapbility cap=EPortCapbility_None);
...
public:
    ...
    QParamTemplateFiller& setOutputTransform(MUINT frameID, PortID portID, MINT32 transform);
    ...
    QParamTemplateFiller& setExpectedEndTime(MUINT frameID);
    /**
