...
// bufferID inside the DataID : P2A_TO_N3D_NOFEFM_RECT1
DepthMapBufferID bufIDs_P2A_TO_N3D_NOFEFM_RECT1[] =
{
...
// bufferID inside the DataID : P2A_TO_N3D_NOFEFM_RECT2
...
DepthMapBufferID bufIDs_HWOCC_TO_WMF_NOC[] =
{
    BID_OCC_OUT_NOC, BID_P2A_OUT_MY_S,
    // end with this
    BID_INVALID
};
...
DepthMapBufferID bufIDs_HWOCC_OUT_3RD_NOC[] =
{
    BID_OCC_OUT_NOC,
    // end with this
    BID_INVALID
...
{
    BID_WMF_OUT_DMW, BID_WMF_HOLEFILL_INTERNAL,
    // end with this
    BID_INVALID
};
...
{
    BID_P2A_OUT_MY_S, BID_P2A_OUT_FDIMG,
    BID_P2A_OUT_INTERNAL_FD,
    // end with this
    BID_INVALID
};

DepthMapBufferID bufIDs_P2A_OUT_DMBG[] =
{
    BID_GF_OUT_DMBG, BID_GF_OUT_DEPTH,
    // end with this
    BID_INVALID
};
...
{
    BID_GF_INTERNAL_DMBG, BID_GF_INTERNAL_DEPTHMAP,
    // end with this
    BID_INVALID
};
...
DepthMapBufferID bufIDs_GF_OUT_DEPTHMAP[] =
{
    GF_OUT_DEPTHMAP,
    // end with this
    BID_INVALID
...
DataIDToBIDMap getDataIDToBIDMap()
{
    ...
    ADD_TO_DBIDMAP(P2A_TO_N3D_NOFEFM_RECT1);
    ADD_TO_DBIDMAP(P2A_TO_N3D_NOFEFM_RECT2);
    ADD_TO_DBIDMAP(P2A_TO_FD_IMG);
    ADD_TO_DBIDMAP(P2A_TO_OCC_MY_S);
    ADD_TO_DBIDMAP_SEC(P2A_TO_OCC_MY_S, P2A_TO_HWOCC_MY_S);
    ADD_TO_DBIDMAP(N3D_TO_DPE_MVSV_MASK);
    ADD_TO_DBIDMAP_SEC(DPE_TO_OCC_MVSV_DMP_CFM, DPE_TO_HWOCC_MVSV_DMP);
    ADD_TO_DBIDMAP(OCC_TO_WMF_OMYSN);
    ADD_TO_DBIDMAP(HWOCC_TO_WMF_NOC);
    ...
    ADD_TO_DBIDMAP(HWOCC_OUT_3RD_NOC);

    ADD_TO_DBIDMAP(GF_OUT_DEPTHMAP);
