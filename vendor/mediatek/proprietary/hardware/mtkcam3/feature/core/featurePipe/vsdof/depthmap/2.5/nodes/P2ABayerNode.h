...
/**
 * @class P2ABayerNode
 * @brief Node class for P2AFM Bayer pass
 */
class P2ABayerNode
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
protected:
    virtual MBOOL getIsForegroundNode() override { return MTRUE; };
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
private:
    ...
    /**
     * @brief handle the on-going data finish
     * @param [in] iReqID finished request id
     * @return
     * - MTRUE indicates success.
     * - MFALSE indicates failure.
     */
    MBOOL onHandleOnGoingReqDataReady(MUINT32 iReqID);
     ...
     * - MFALSE indicates failure.
     */
    MBOOL _copyBufferIntoRequestAndSetReady(
