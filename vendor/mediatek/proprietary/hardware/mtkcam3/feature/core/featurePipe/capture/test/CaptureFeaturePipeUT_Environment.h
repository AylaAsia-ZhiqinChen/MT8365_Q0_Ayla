...
#ifndef _MTK_CAMERA_CAPTURE_FEATURE_PIPE_MYENVIRONMENT_H_
#define _MTK_CAMERA_CAPTURE_FEATURE_PIPE_MYENVIRONMENT_H_
...
#endif // _MTK_CAMERA_CAPTURE_FEATURE_PIPE_MYENVIRONMENT_H_
