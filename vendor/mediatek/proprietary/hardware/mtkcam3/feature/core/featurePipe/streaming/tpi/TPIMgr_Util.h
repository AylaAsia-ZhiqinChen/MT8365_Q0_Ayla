...
#ifndef _MTK_CAMERA_STREAMING_FEATURE_PIPE_TPI_MGR_UTIL_H_
#define _MTK_CAMERA_STREAMING_FEATURE_PIPE_TPI_MGR_UTIL_H_
...
#endif // _MTK_CAMERA_STREAMING_FEATURE_PIPE_TPI_MGR_UTIL_H_
