...
public:
    ...
    struct P2ABufferSize : public BaseBufferSize
    {
        ...
        MSize mCCIN_SIZE_MAIN1;
        MSize mCCIN_SIZE_MAIN2;
        // crop info
...
public:
    ...
    virtual const OCCBufferSize& getOCC(ENUM_STEREO_SCENARIO scen) = 0;
    virtual const WMFBufferSize& getWMF(ENUM_STEREO_SCENARIO scen) = 0;
