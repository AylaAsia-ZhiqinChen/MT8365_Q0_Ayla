...
public:
    ...
    /**
     * @brief Manully specify the externel smart graphic image buffer as output buffer
     *        from src node to out node
     * @param [in] srcNodeID src node id
     * @param [in] bufferID smImgBuf's buffer id
     * @param [in] outNodeID output node id
     * @param [in] smImgBuf the smart graphic image buffer
     * @return
     * - MTRUE indicates success.
     * - MFALSE indicates failure.
     */
    ...
    virtual MBOOL getEnquedSmartBuffer(
                            DepthMapPipeNodeID,
                            DepthMapBufferID,
                            SmartFatImageBuffer&) {return MFALSE;}
    virtual MBOOL getEnquedSmartBuffer(
                            DepthMapPipeNodeID,
                            DepthMapBufferID,
