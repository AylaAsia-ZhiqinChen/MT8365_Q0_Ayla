...
const NodeBufferSetting preview_buffer_config[] =
{
    ...
    {BID_P2A_IN_LCSO1, eBUFFER_IOTYPE_INPUT},
    {BID_P2A_IN_LCSO2, eBUFFER_IOTYPE_INPUT},
    // output
    {BID_P2A_OUT_MV_F, eBUFFER_IOTYPE_OUTPUT},
    {BID_P2A_OUT_FDIMG, eBUFFER_IOTYPE_OUTPUT},
    {BID_GF_OUT_DMBG, eBUFFER_IOTYPE_OUTPUT},
    {BID_P2A_OUT_TUNING_MAIN1, eBUFFER_IOTYPE_OUTPUT},
    {BID_P2A_OUT_DEPTHMAP, eBUFFER_IOTYPE_OUTPUT},
...
const NodeBufferSetting capture_buffer_config[] =
{
    ...
    {BID_P2A_IN_LCSO2, eBUFFER_IOTYPE_INPUT},
    // output
    {BID_P2A_OUT_MV_F_CAP, eBUFFER_IOTYPE_OUTPUT},
    {BID_N3D_OUT_LDC, eBUFFER_IOTYPE_OUTPUT},
    {BID_GF_OUT_DMBG, eBUFFER_IOTYPE_OUTPUT},
    {BID_GF_OUT_DEPTH_WRAPPER, eBUFFER_IOTYPE_OUTPUT},
    {BID_N3D_OUT_DEPTH_DBG, eBUFFER_IOTYPE_OUTPUT},
    {BID_FD_OUT_EXTRADATA, eBUFFER_IOTYPE_OUTPUT},
    {BID_P2A_OUT_POSTVIEW, eBUFFER_IOTYPE_OUTPUT},
...
const NodeBufferSetting metadata_config[] =
{
    ...
    {BID_META_IN_APP_QUEUED, eBUFFER_IOTYPE_INPUT},
    {BID_META_IN_HAL_MAIN1_QUEUED, eBUFFER_IOTYPE_INPUT},
    {BID_META_IN_HAL_MAIN2_QUEUED, eBUFFER_IOTYPE_INPUT},
    {BID_META_OUT_APP, eBUFFER_IOTYPE_OUTPUT},
    {BID_META_OUT_HAL, eBUFFER_IOTYPE_OUTPUT},
    {BID_META_OUT_APP_QUEUED, eBUFFER_IOTYPE_OUTPUT},
    {BID_META_OUT_HAL_QUEUED, eBUFFER_IOTYPE_OUTPUT},
