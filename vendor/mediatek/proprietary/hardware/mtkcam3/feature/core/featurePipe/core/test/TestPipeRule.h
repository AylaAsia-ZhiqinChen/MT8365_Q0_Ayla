...
#define NODE_B_DELAY_NS 5 * FPIPE_NS_PER_MS
#define NODE_C_DELAY_NS 10 * FPIPE_NS_PER_MS
#define NODE_D_DELAY_NS 8 * FPIPE_NS_PER_MS
...
#define TEST_WAIT_PERIOD_NS 100 * FPIPE_NS_PER_MS
