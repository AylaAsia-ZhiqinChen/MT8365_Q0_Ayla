...
#ifndef _MTK_CAMERA_CAPTURE_FEATURE_PIPE_BOKEH_NODE_H_
#define _MTK_CAMERA_CAPTURE_FEATURE_PIPE_BOKEH_NODE_H_
...
/**
 * @brief BokehNode Node of the CaptureFeaturePipe
 */
class BokehNode final: public CaptureFeatureNode,
                       public NSPipelinePlugin::BokehPlugin::RequestCallback
{
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  CaptureFeatureNode Public Type Alias.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
    using Plugin            = NSPipelinePlugin::BokehPlugin;
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
    BokehNode(NodeID_T nodeId, const char* name, MINT32 policy = SCHED_NORMAL, MINT32 priority = DEFAULT_CAMTHREAD_PRIORITY);

    ~BokehNode() override;

//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  BokehPlugin::RequestCallback Public Operations.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
...
#endif // _MTK_CAMERA_CAPTURE_FEATURE_PIPE_BOKEH_NODE_H_
