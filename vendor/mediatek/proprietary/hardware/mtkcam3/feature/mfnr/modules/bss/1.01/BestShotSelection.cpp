...
#define MY_LOGV(fmt, arg...)        mfllLogV("[%s] " fmt, __func__, ##arg)
#define MY_LOGD(fmt, arg...)        mfllLogD("[%s] " fmt, __func__, ##arg)
#define MY_LOGI(fmt, arg...)        mfllLogI("[%s] " fmt, __func__, ##arg)
#define MY_LOGW(fmt, arg...)        mfllLogW("[%s] " fmt, __func__, ##arg)
#define MY_LOGE(fmt, arg...)        mfllLogE("[%s] " fmt, __func__, ##arg)
#define MY_LOGA(fmt, arg...)        mfllLogA("[%s] " fmt, __func__, ##arg)
#define MY_LOGF(fmt, arg...)        mfllLogF("[%s] " fmt, __func__, ##arg)
...
//	MUINT32 grad;
    ...
    MY_LOGD("[best_shot_stats] w/h(%d,%d), roi w/h/x/y(%d,%d,%d,%d) scale/th0/th1/ths(%d,%d,%d,%d)"
            , inWidth, inHeight
