...
public:
    ...
    enum MfllErr queueSourceRrzoImage(sp<IMfllImageBuffer>& img) override;
...
private:
    ...
    sp<IMfllImageBuffer>    dequeRrzoRaw(void);
    ...
    /* mutex/cond for RRZO */
    mutable pthread_mutex_t m_mutexRrzo;
    mutable pthread_cond_t m_condRrzo;
    vector< sp<IMfllImageBuffer> > m_vRrzo;
