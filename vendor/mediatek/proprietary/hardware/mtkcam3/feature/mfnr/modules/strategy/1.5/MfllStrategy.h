...
private:
    ...
    std::atomic<bool>       m_mtkAisInited;
    std::shared_ptr<MTKAis> m_mtkAis;
    const char *m_nvramChunkMfnr;
    const char *m_nvramChunkMfnrTh;
    int m_captureFrameNum;
    int m_blendFrameNum;
    int m_isFullSizeMc;

    std::shared_future<int> m_futureWorkingBuffer;
    sp<IMfllImageBuffer> m_imgWorkingBuf;
