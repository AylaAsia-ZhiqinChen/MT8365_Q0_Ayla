 ...
 */
#ifndef __MFLLCORE3_H__
#define __MFLLCORE3_H__
...
class MfllCore3 : public MfllCore
{
public:
    MfllCore3(void);
    virtual ~MfllCore3(void) = default;
...
public:
    ...
    virtual enum MfllErr        do_Blending(void* void_index)               override;
    virtual enum MfllErr        do_EncodeYuvGolden(JOB_VOID)                override;
    virtual enum MfllErr        do_Mixing(JOB_VOID)                         override;
