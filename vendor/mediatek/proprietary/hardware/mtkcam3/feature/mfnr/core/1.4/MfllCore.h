...
public:
    ...
    sp<IMfllImageBuffer> m_imgYuvMixedWorking; // for mixing stage by working buffer
    ...
    sp<IMfllImageBuffer> *m_ptrImgYuvMixedWorking; // indicates to mixing YUV by working buffer
