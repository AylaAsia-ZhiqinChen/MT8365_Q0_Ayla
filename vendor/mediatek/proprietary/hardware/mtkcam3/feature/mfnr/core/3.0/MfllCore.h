...
public:
    ...
    std::atomic<bool> m_bDoMemcDownScale;
...
public:
    ...
    virtual void setDownscaleInfo(bool downscale_enabled, int /*downscale_ratio*/, int downscale_dividend = 0, int downscale_divisor = 0)
                 {
                     m_bDoDownscale = (downscale_dividend != downscale_divisor);
                     m_bDoMemcDownScale = downscale_enabled;
                     m_downscaleDividend = downscale_dividend;
                     m_downscaleDivisor = downscale_divisor;
    ...
    virtual bool isMemcDownscale(void) { return m_bDoMemcDownScale.load(); }
    virtual int  getDownscaleDividend(void) { return m_downscaleDividend.load(); }
    virtual int  getDownscaleDivisor(void) { return m_downscaleDivisor.load(); }
