                          ...
                          N3D_HAL_OUTPUT_WPE &n3dOutput)
{
    ...
    // __setN3DParams(n3dParams, n3dOutput);
    CHECK_BUFFER(n3dOutput.warpMapMain2[0], "n3dOutput.warpMapMain2[0]");
    CHECK_BUFFER(n3dOutput.warpMapMain2[1], "n3dOutput.warpMapMain2[1]");
    CHECK_BUFFER(n3dOutput.warpMapMain2[0]->getImageBufferHeap()->getHWBuffer(), "n3dOutput.warpMapMain2[0]->getImageBufferHeap()->getHWBuffer()");
    CHECK_BUFFER(n3dOutput.warpMapMain2[1]->getImageBufferHeap()->getHWBuffer(), "n3dOutput.warpMapMain2[1]->getImageBufferHeap()->getHWBuffer()");
