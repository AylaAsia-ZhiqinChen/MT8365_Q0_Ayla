...
/**
 * @file DualFeatureRequest.h
 * @brief Base class for dual feature requests
 */

#ifndef _MTK_CAMERA_FEATURE_INTERFACE_DUAL_FEATURE_REQUEST_COMMON_H_
#define _MTK_CAMERA_FEATURE_INTERFACE_DUAL_FEATURE_REQUEST_COMMON_H_
...
/**
 * @class DualFeatureRequest
 * @brief request for dual feature
 */
class DualFeatureRequest : public IDualFeatureRequest
{
public:
/**
     * @brief create a new DualFeatureRequest
     ...
     */
    static sp<DualFeatureRequest> createInstance(
                                                MUINT32 _reqNo = 0,
...
protected:
    DualFeatureRequest(
        ...
        MVOID* _tag = NULL);
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  DualFeatureRequest Public Operations.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  DualFeatureRequest Private Operations.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
private:
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  DualFeatureRequest Protected member.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
protected:
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  DualFeatureRequest Private member.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
private:
};
