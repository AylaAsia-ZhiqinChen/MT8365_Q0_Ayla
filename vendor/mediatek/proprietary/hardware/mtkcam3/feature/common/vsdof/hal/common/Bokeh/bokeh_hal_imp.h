...
private:
    ...
    MUINT32                     __logicalDeviceID = StereoSettingProvider::getLogicalDeviceID();
    ENUM_ROTATION               __moduleRotation = StereoSettingProvider::getModuleRotation(__logicalDeviceID);
