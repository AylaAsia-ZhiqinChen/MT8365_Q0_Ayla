...
#undef LOG_TAG
#endif
#define LOG_TAG "StereoTuningProvider_SW_AIDEPTH"
...
SW_AIDEPTHTuning::SW_AIDEPTHTuning(json &tuningJson)
{
    _init(tuningJson);
}

SW_AIDEPTHTuning::~SW_AIDEPTHTuning()
{
}

bool
SW_AIDEPTHTuning::retrieveTuningParams(TuningQuery_T &query)
{
...
void
SW_AIDEPTHTuning::_initDefaultValues()
{
}

void
SW_AIDEPTHTuning::log(FastLogger &logger, bool inJSON)
{
    if(inJSON) {
...
void
SW_AIDEPTHTuning::_loadValuesFromDocument(const json& aidepthValues)
{
    const char *TUNING_PREFIX = "aidepth.";
