 ...
 ************************************************************************************************/
#ifndef PASS2A_P_CROP_SIZE_PROVIDER_H_
#define PASS2A_P_CROP_SIZE_PROVIDER_H_

#include "pass2_size_provider_base.h"
#include <stereo_crop_util.h>

class Pass2A_P_Crop_SizeProvider: public Pass2SizeProviderBase<Pass2A_P_Crop_SizeProvider>
{
public:
    friend class Pass2SizeProviderBase<Pass2A_P_Crop_SizeProvider>;
    ...
    virtual StereoArea getWDMAArea( ENUM_STEREO_SCENARIO eScenario ) const  {
            ...
            eSTEREO_SCENARIO_CAPTURE == eScenario )
        {
            ...
            if(!StereoSettingProvider::is3rdParty()) {
                CropUtil::cropStereoAreaByFOV(area,
...
protected:
    Pass2A_P_Crop_SizeProvider() {}
    virtual ~Pass2A_P_Crop_SizeProvider() {}
private:
