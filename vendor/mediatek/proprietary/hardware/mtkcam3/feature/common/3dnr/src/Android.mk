...
#-----------------------------------------------------------
LOCAL_SRC_FILES += 3dnr_defs.cpp
LOCAL_SRC_FILES += 3dnr_hal.cpp
LOCAL_SRC_FILES += 3dnr_hal_base.cpp
LOCAL_SRC_FILES += util_3dnr.cpp
LOCAL_SRC_FILES += lmv_state.cpp
LOCAL_SRC_FILES += lmv_state_uni.cpp
LOCAL_SRC_FILES += lmv_state_dummy.cpp
...
# "BRM Header" rule
LOCAL_SHARED_LIBRARIES += libcamalgo.3dnr
#-----------------------------------------------------------
