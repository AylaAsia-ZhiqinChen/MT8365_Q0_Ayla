...
LOCAL_SHARED_LIBRARIES_64 := libc++ liblog libcutils lib3a.awb lib3a.log libcamalgo.utility
...
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_TAGS := optional
LOCAL_SHARED_LIBRARIES := libc++ liblog libcutils lib3a.awb lib3a.log libcamalgo.utility
LOCAL_EXPORT_C_INCLUDE_DIRS := $(LOCAL_PATH)/include
LOCAL_MULTILIB := 32
