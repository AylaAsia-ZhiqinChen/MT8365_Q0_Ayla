...
typedef struct
{
    MUINT32 u4RAvg : 18, u4RRes : 4, u4RCnt : 10; // lowbit --> u4RAvg: 12
    MUINT32 u4GAvg : 18, u4GRes : 4, u4GCnt : 10; // lowbit --> u4RAvg: 12
    MUINT32 u4BAvg : 18, u4BRes : 4, u4BCnt : 10; // lowbit --> u4RAvg: 12
    MUINT32 u4RSum : 28, u4RRes2 : 4;             // lowbit --> u4RAvg: 22
    MUINT32 u4GSum : 28, u4GRes2 : 4;             // lowbit --> u4RAvg: 22
    MUINT32 u4BSum : 28, u4LightSrc : 4;          // lowbit --> u4RAvg: 22
    MUINT32 u4AeStat1, u4AeStat2;
}AWB_HW_STAT_T;
...
typedef struct
{
    ...
    MINT32 i4HdrSupportEn;

    // Linear mode select
    MINT32 i4StatMode; // Output format select 1: Linear mode, 0: non-linear mode
