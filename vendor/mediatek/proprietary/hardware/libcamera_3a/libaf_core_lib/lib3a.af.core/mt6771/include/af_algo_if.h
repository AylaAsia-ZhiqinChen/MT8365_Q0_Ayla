...
public:
    ...
    /**
     * @brief This function is used for AF init lens pos compensation. Using g-sensor info to adjust the init lens dac.
     * @param [in] a_i4TargetPos: lens position which to be updated.
     * @param [in] acce[3] and scale: g-sensor info such as the param of function "setAcceSensorInfo"
     */
    virtual void    updatePosturedPos(MINT32 &a_i4TargetPos, MINT32 acce[3], MUINT32 scale) = 0;    // 20180329
