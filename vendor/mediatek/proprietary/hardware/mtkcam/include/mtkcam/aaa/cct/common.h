...
#ifndef _CCT_COMMON_H_
#define _CCT_COMMON_H_
...
{
    ACDK_CAM_NONE           = 0,
    ACDK_CAM_SENSOR_ID_NONE,
    ACDK_CAM_MAIN_SENSOR_ID_OK,
    ACDK_CAM_SUB_SENSOR_ID_OK,
    ACDK_CAM_PASS1_OK,
    ACDK_CAM_PASS1_FAIL,
    ACDK_CAM_OK,
    ACDK_CAM_ERROR,
...
typedef struct ImageBufInfo_S
{
    ...
    MUINT32 bufXSizeByte;
    MUINT32 bufStrideByte;

public:
    ImageBufInfo_S(): bufXSizeByte(0), bufStrideByte(0), eImgType(PURE_RAW10_TYPE) {}
