...
#ifndef _MTK_HARDWARE_INCLUDE_MTKCAM_V3_SYNCHELPER_ISYNCHELPERBASE_H_
#define _MTK_HARDWARE_INCLUDE_MTKCAM_V3_SYNCHELPER_ISYNCHELPERBASE_H_
    ...
    : public virtual android::RefBase
{
    ...
    virtual status_t syncEnqHW(SyncParam &SyncParam) = 0;
    virtual status_t syncResultCheck(SyncParam &SyncParam) = 0;

    static android::sp<ISyncHelperBase> createInstance();
};
/******************************************************************************
 *
 ******************************************************************************/
