...
public:     ////                    Definitions.
    ...
    struct BufPlane {
        ...
        /**
         * The size to allocate a color plane large than current format for reusable, in bytes.
         */
...
public:     ////                    Attributes.
    ...
    /**
     * Update image stream info.
     */
    virtual MERROR                  updateStreamInfo(const android::sp<IImageStreamInfo>& pStreamInfo) = 0;
};
