...
#ifndef _MTK_HARDWARE_INCLUDE_MTKCAM_V3_HWNODE_DUALFEATURENODE_H_
#define _MTK_HARDWARE_INCLUDE_MTKCAM_V3_HWNODE_DUALFEATURENODE_H_
//
...
public:     ////                    Definitions.
    ...
    struct  ConfigParams
    {
        ConfigParams()
            : pInAppMeta(nullptr)
            , pInAppRetMeta(nullptr)
            , pInHalMeta(nullptr)
            , pOutAppMeta(nullptr)
            , pOutHalMeta(nullptr)
            , pInResizedRaw(nullptr)
            , pInLcsoRaw(nullptr)
            , pOutFDImage(nullptr)
            , iDualCamMode(-1)
        {};
...
public:     ////                    Operations.
    ...
    static android::sp<DualFeatureNode>      createInstance();
...
#endif  //_MTK_HARDWARE_INCLUDE_MTKCAM_V3_HWNODE_DUALFEATURENODE_H_
