...
#ifndef _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_PIPELINE_STREAM_ISTREAMBUFFERSET_H_
#define _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_PIPELINE_STREAM_ISTREAMBUFFERSET_H_
//
...
#endif  //_MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_PIPELINE_STREAM_ISTREAMBUFFERSET_H_
