...
#ifndef _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_HWNODE_DUALYUVNODE_
#define _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_HWNODE_DUALYUVNODE_
//
...
namespace v3 {
/******************************************************************************
 * DualYUVNode is used to produce YUV image.
 ******************************************************************************/
class DualYUVNode
...
public:     ////                    Definitions.
    ...
    struct  ConfigParams
    {
         ...
         */
        android::sp<IImageStreamInfo> pOutHalImageMainImg;
        /**
         ...
         */
        android::sp<IImageStreamInfo> pOutHalImageFD;

        /**
         * A pointer to MainImage_Cap stream info.
         */
        android::sp<IImageStreamInfo> pOutHalImageMainImg_Cap;

        /**
         * A pointer to MainImage_Cap stream info.
         */
        android::sp<IImageStreamInfo> pOutHalImageMain2Img_Cap;
...
public:     ////                    Operations.
    ...
    static android::sp<DualYUVNode>   createInstance();
...
#endif  //_MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_HWNODE_DUALYUVNODE_
