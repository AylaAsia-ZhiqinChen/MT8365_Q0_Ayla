...
public:     ////                    Operations.
    ...
    virtual status_t                setParameters(String8 const &params) = 0;
    ...
    virtual void                    getDualZoomInfo(int *Main2ID, int *Supported) const = 0;
    virtual uint32_t                getZoomRatio(int id = -1) const = 0;
    ...
    virtual bool                    getRecordLikely() const = 0;
    ...
    virtual String8                 getStaticVhdrMode() const = 0;
    ...
    virtual bool                    getDualZoomSupported() const = 0;
    virtual uint32_t                getCustomHint() const = 0;
    ...
    virtual void                    setRecordLikely(bool Recording) = 0;
    ...
    virtual void                    getExposureTime(int *exptime) const = 0;
    virtual void                    getIsoSpeed(int *exptime) const = 0;
    virtual bool                    getManualCap() const = 0;
    virtual bool                    getDynamicSwitchSensorMode() const = 0;
    virtual bool                    getHighFpsCapture() const = 0;
    virtual bool                    getNonSlowmotionPreviewLimitMaxFps(int *fps) const = 0;
    virtual bool                    getLowLightCaptureUsePreviewMode() const = 0;

public:
    /**
     * \brief Get capture size of bokeh image (VSDoF/Stereo Capture feature)
     * \details App will set this size and stereo middleware can use this API to get capture size
     *
     * \param width Width of the capture size
     * \param height Height of the capture size
     */
    virtual void                    getBokehPictureSize(int &width, int &height) const = 0;
...
public:     ////                    Utility.
    ...
    virtual bool                    isSetParametersChangeNothing()           = 0;
