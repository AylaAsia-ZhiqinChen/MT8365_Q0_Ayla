...
#ifndef _MTK_CAMERA_THIRDPARTY_IPOSTPROC_CALLBACK_H_
#define _MTK_CAMERA_THIRDPARTY_IPOSTPROC_CALLBACK_H_
// Module header file
...
#endif  //  _MTK_CAMERA_THIRDPARTY_IPOSTPROC_CALLBACK_H_
