 ...
 */
#ifndef _MTK_HARDWARE_INCLUDE_MTKCAM_LEGACYPIPELINE_BOKEH_POST_PROCESSOR_PIPELINE_DATA_H_
#define _MTK_HARDWARE_INCLUDE_MTKCAM_LEGACYPIPELINE_BOKEH_POST_PROCESSOR_PIPELINE_DATA_H_
...
//
namespace BokehPostProcessorData
{
namespace full
{
static const struct MetaStreamManager::metadata_info_setting gBokehMetaTbl_full[] =
{
    // Hal
    ...
    // End
    {"", 0, 0, 0, 0, eStreamType_META_APP},
};
//
static struct ImageStreamManager::image_stream_info_pool_setting gBokehImgTbl_full[] =
{
    // APP
...
//
static const MINT32 gBokehConnectSetting_full[] =
{
...
#endif  //_MTK_HARDWARE_INCLUDE_MTKCAM_LEGACYPIPELINE_BOKEH_POST_PROCESSOR_PIPELINE_DATA_H_