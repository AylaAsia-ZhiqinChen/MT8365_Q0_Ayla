 ...
 */
#ifndef _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_BMDENOISE_EFFECT_HAL_H_
#define _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_BMDENOISE_EFFECT_HAL_H_
...
using NSCam::NSCamFeature::NSFeaturePipe::IBMDeNoisePipe;

class BMDeNoiseEffectHal : public EffectHalBase
{
public:
    BMDeNoiseEffectHal();
    virtual ~BMDeNoiseEffectHal();
...
private:
    ...
    sp<IBMDeNoisePipe> mpBMDeNoisePipe;
    MBOOL mbReadyToPush;
    Mutex mOpLock;
    MINT32 miLogLevel;
};
