...
* Define Value
*********************************************************************/
#define EFSC_FSC_ENABLED(x)         (((x) & (EFSC_MODE_MASK_FSC_EN)) ? MTRUE : MFALSE)
#define EFSC_SUBPIXEL_ENABLED(x)    (((x) & (EFSC_MODE_MASK_SUBPIXEL_EN)) ? MTRUE : MFALSE)
#define EFSC_DEBUG_ENABLED(x)       (((x) & (EFSC_MODE_MASK_DEBUG_LEVEL)) ? MTRUE : MFALSE)
...
#define FSC_MAX_WAIT_COUNT          10
#define FSC_WAIT_INTERVAL           3

#define FSC_SUBPIXEL_ENABLE_PROPERTY            "vendor.debug.fsc.subpixel.enable"
#define FSC_VMDP_MAXCROP_PROPERTY               "vendor.debug.fsc.vmdp.maxcrop"
