...
void lcenr_srz_settings(int rrz_in_wd, int rrz_in_ht, int rrz_out_wd, int rrz_out_ht, int rrz_xoff, int rrz_yoff, int rrz_crop_in_wd, int rrz_crop_in_ht, int lce_full_slm_wd, int lce_full_slm_ht,
                unsigned int &srz_in_wd, unsigned int &srz_in_ht, unsigned long &srz_in_crop_wd, unsigned long &srz_in_crop_ht, unsigned int &srz_out_wd, unsigned int &srz_out_ht, unsigned int &srz_crop_x, unsigned int &srz_crop_y, unsigned int &srz_crop_floatx, unsigned int &srz_crop_floaty)
{
    ...
    srz_crop_floatx = (unsigned int)(tmp_crop_x & 0x7FFFFFFF);
    srz_crop_floaty = (unsigned int)(tmp_crop_y & 0x7FFFFFFF);
}
...
void calculateLCENRConfig(LCENR_IN_PARAMS in, LCENR_OUT_PARAMS &out)
{
    if( in.resized )
    {
        lcenr_srz_settings(
