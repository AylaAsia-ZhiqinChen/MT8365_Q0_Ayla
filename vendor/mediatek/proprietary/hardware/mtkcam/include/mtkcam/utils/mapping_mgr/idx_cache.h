...
public:
    ...
    MUINT16 query(EModule_T eMod, IDXCACHE_STAGE eStage, IDXCACHE_VALTYPE eType, CAM_IDX_QRY_COMB& sQry, const char *caller, IDXCACHE_QRYMODE eMode = IDXCACHE_QRYMODE_NORMAL);
    ...
    MVOID setLogEnable();
    MVOID setCacheValid(EModule_T eMod, IDXCACHE_STAGE eStage, MBOOL enabled, IDXCACHE_VALTYPE eType = IDXCACHE_VALTYPE_CURRENT);
private:
    ...
    IDXCACHE_VAL_T      m_cacheIdxBase[IDXCACHE_STAGE_NUM][EModule_NUM];
