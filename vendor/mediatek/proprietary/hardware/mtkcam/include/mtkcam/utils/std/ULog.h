...
#define __ULOG_MAYBE_UNUSED__ __attribute__((unused))
#else
#define __ulog_unlikely(_cond) (_cond)
#define __ULOG_MAYBE_UNUSED__
#endif
...
#define CAM_ULOG_APILIFE(_module) NSCam::Utils::ULog::ULogFuncLife __ulog_func_life__( \
    NSCam::Utils::ULog::getULogModuleId(_module), __CAM_ULOG_TAG__, NSCam::Utils::ULog::API_ENTER, __func__)

#define CAM_ULOG_APILIFE_ARGS(_module, _args...) NSCam::Utils::ULog::ULogFuncLife __ulog_func_life__( \
    NSCam::Utils::ULog::getULogModuleId(_module), __CAM_ULOG_TAG__, NSCam::Utils::ULog::API_ENTER, __func__, ##_args)
...
#define CAM_ULOG_APILIFE_ALWAYS(_module) NSCam::Utils::ULog::ULogFuncLife __ulog_func_life__( \
    NSCam::Utils::ULog::getULogModuleId(_module), NSCam::Utils::ULog::ULogFuncLife::Always(), __CAM_ULOG_TAG__, \
...
#define CAM_ULOG_FUNCLIFE(_module) NSCam::Utils::ULog::ULogFuncLife __ulog_func_life__( \
    NSCam::Utils::ULog::getULogModuleId(_module), __CAM_ULOG_TAG__, NSCam::Utils::ULog::FUNCTION_ENTER, __func__)

#define CAM_ULOG_FUNCLIFE_ARGS(_module, _args...) NSCam::Utils::ULog::ULogFuncLife __ulog_func_life__( \
    NSCam::Utils::ULog::getULogModuleId(_module), __CAM_ULOG_TAG__, NSCam::Utils::ULog::FUNCTION_ENTER, __func__, ##_args)

#define CAM_ULOG_FUNCLIFE_IF(_module, _cond) NSCam::Utils::ULog::ULogFuncLife __ulog_func_life__( \
    NSCam::Utils::ULog::getULogModuleId(_module), (_cond), __CAM_ULOG_TAG__, NSCam::Utils::ULog::FUNCTION_ENTER, __func__)
...
#define CAM_ULOG_FUNCLIFE_GUARD(_module, _warnMs...) NSCam::Utils::ULog::ULogFuncLifeGuard __ulog_func_life__( \
    NSCam::Utils::ULog::getULogModuleId(_module), __CAM_ULOG_TAG__, NSCam::Utils::ULog::FUNCTION_ENTER, \
...
#define CAM_ULOG_TAGLIFE(_module, _literalTag) NSCam::Utils::ULog::ULogFuncLife __ulog_tag_life__( \
    NSCam::Utils::ULog::getULogModuleId(_module), __CAM_ULOG_TAG__, NSCam::Utils::ULog::SUBROUTINE_ENTER, \
...
#define CAM_ULOG_TAGLIFE_IF(_module, _literalTag, _cond) NSCam::Utils::ULog::ULogFuncLife __ulog_tag_life__( \
    NSCam::Utils::ULog::getULogModuleId(_module), (_cond), __CAM_ULOG_TAG__, NSCam::Utils::ULog::SUBROUTINE_ENTER, \
    __ulogMustBeStringLiteral(_literalTag))
...
#define CAM_ULOG_DTAG_BEGIN(_module, _condEval, _fmt, _args...) { \
    ...
    NSCam::Utils::ULog::ULogFuncLife __ulog_func_life__( \
        NSCam::Utils::ULog::getULogModuleId(_module), (_cond), __CAM_ULOG_TAG__, NSCam::Utils::ULog::SUBROUTINE_ENTER, _dtagBuffer);
...
#define CAM_ULOG_DETAILS_FILE(_uModuleId, _detailsType, _fmt, _args...) \
    do { \
        ...
        NSCam::Utils::ULog::ULogger::logNormalDetails(_uModuleId, __CAM_ULOG_TAG__, _detailsType, _buffer, _contentLen); \
    } while (0)
    // For statistics
    // size_t _contentLen = ::snprintf(_buffer, sizeof(_buffer), "U%x %s " _fmt, _uModuleId, __FILE__, ##_args);


#define CAM_ULOG_TIMEBOMB_CREATE(_module, _serial, _dispatchKey, _warnMs, _abortMs, _maxAbortBound...) \
    NSCam::Utils::ULog::ULogTimeBombSerial::create(NSCam::Utils::ULog::ULogTimeBomb::please_use_CAM_ULOG_TIMEBOMB_CREATE(), \
        NSCam::Utils::ULog::getULogModuleId(_module), _serial, \
        _dispatchKey, _warnMs, _abortMs, ##_maxAbortBound)

#define CAM_ULOG_TIMEBOMB_VERBOSE_CREATE(_module, _dispatchKey, _warnMs, _abortMs, _maxAbortBound, _fmt, _args...) \
    NSCam::Utils::ULog::ULogTimeBombVerbose::create(NSCam::Utils::ULog::ULogTimeBomb::please_use_CAM_ULOG_TIMEBOMB_CREATE(), \
        NSCam::Utils::ULog::getULogModuleId(_module), \
        _dispatchKey, _warnMs, _abortMs, _maxAbortBound, _fmt, ##_args)


// Print only if exceeds the _warnMs
// Usually used to detect performance issue. For hang issues, please use _GUARD series.
// [Optional] others: options, keyValue
#define CAM_ULOG_TAG_OVERTIME(_module, _routineTag, _warnMs, _others...) \
    NSCam::Utils::ULog::ULogRoutineOvertime __ulog_routine_overtime__( \
        NSCam::Utils::ULog::ULogRoutineOvertime::please_use_CAM_ULOG_TAG_OVERTIME(), NSCam::Utils::ULog::getULogModuleId(_module), \
        __CAM_ULOG_TAG__, __ulogMustBeStringLiteral(_routineTag), _warnMs, ##_others)

#define CAM_ULOG_TAG_OVERTIME_BEGIN(_args...) { CAM_ULOG_TAG_OVERTIME(##_args);

#define CAM_ULOG_TAG_OVERTIME_END() }

#define CAM_ULOG_TAG_OVERTIMEF(_module, _routineTag, _warnMs, _options, _logBufSize, _fmt, _args...) \
    char _ulog_buffer[_logBufSize]; \
    ::snprintf(_ulog_buffer, _logBufSize, _fmt, ##_args); \
    _ulog_buffer[_logBufSize - 1] = '\0'; \
    NSCam::Utils::ULog::ULogRoutineOvertime __ulog_routine_overtime__( \
        NSCam::Utils::ULog::ULogRoutineOvertime::please_use_CAM_ULOG_TAG_OVERTIMEF(), NSCam::Utils::ULog::getULogModuleId(_module), \
        __CAM_ULOG_TAG__, __ulogMustBeStringLiteral(_routineTag), _ulog_buffer, _warnMs, _options)

#define CAM_ULOG_TAG_OVERTIMEF_BEGIN(_args...) { CAM_ULOG_TAG_OVERTIMEF(##_args);

#define CAM_ULOG_TAG_OVERTIMEF_END() }
...
#define CAM_ULOG_ASSERT(_module, _cond, _fmt, _args...) \
    do { if (__ulog_unlikely(!(_cond))) { CAM_ULOG_FATAL(_module, _fmt, ##_args); } } while (0)
...
#define CAM_ULOGM_TAG_OVERTIME(_args...) CAM_ULOG_TAG_OVERTIME(__ULOG_MODULE_ID, ##_args)
#define CAM_ULOGM_TAG_OVERTIME_BEGIN(_args...) CAM_ULOG_TAG_OVERTIME_BEGIN(__ULOG_MODULE_ID, ##_args)
#define CAM_ULOGM_TAG_OVERTIME_END() CAM_ULOG_TAG_OVERTIME_END()
#define CAM_ULOGM_TAG_OVERTIMEF(_args...) CAM_ULOG_TAG_OVERTIMEF(__ULOG_MODULE_ID, ##_args)
#define CAM_ULOGM_TAG_OVERTIMEF_BEGIN(_args...) CAM_ULOG_TAG_OVERTIMEF_BEGIN(__ULOG_MODULE_ID, ##_args)
#define CAM_ULOGM_TAG_OVERTIMEF_END() CAM_ULOG_TAG_OVERTIMEF_END()
