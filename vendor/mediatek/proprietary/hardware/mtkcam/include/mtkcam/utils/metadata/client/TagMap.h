 ...
 ******************************************************************************/
 ...
 #define ADD_ALL_MEMBERS \
     ...
     _IMP_TAGCONVERT_(    ANDROID_CONTROL_AF_SCENE_CHANGE,    MTK_CONTROL_AF_SCENE_CHANGE)\
     ...
     _IMP_TAGCONVERT_(    ANDROID_LENS_POSE_REFERENCE,    MTK_LENS_POSE_REFERENCE)\
     _IMP_TAGCONVERT_(    ANDROID_LENS_DISTORTION,    MTK_LENS_DISTORTION)\
     ...
     _IMP_TAGCONVERT_(    ANDROID_REQUEST_AVAILABLE_SESSION_KEYS,    MTK_REQUEST_AVAILABLE_SESSION_KEYS)\
     _IMP_TAGCONVERT_(    ANDROID_REQUEST_AVAILABLE_PHYSICAL_CAMERA_REQUEST_KEYS,    MTK_REQUEST_AVAILABLE_PHYSICAL_CAMERA_REQUEST_KEYS)\
     _IMP_TAGCONVERT_(    ANDROID_REQUEST_CHARACTERISTIC_KEYS_NEEDING_PERMISSION,    MTK_REQUEST_CHARACTERISTIC_KEYS_NEEDING_PERMISSION)\
     ...
     _IMP_TAGCONVERT_(    ANDROID_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS,    MTK_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS)\
     _IMP_TAGCONVERT_(    ANDROID_SCALER_AVAILABLE_RECOMMENDED_INPUT_OUTPUT_FORMATS_MAP,    MTK_SCALER_AVAILABLE_RECOMMENDED_INPUT_OUTPUT_FORMATS_MAP)\
     ...
     _IMP_TAGCONVERT_(    ANDROID_SENSOR_ORIENTATION,    MTK_SENSOR_ORIENTATION)\
     ...
     _IMP_TAGCONVERT_(    ANDROID_STATISTICS_OIS_DATA_MODE ,    MTK_STATISTICS_OIS_DATA_MODE)\
     _IMP_TAGCONVERT_(    ANDROID_STATISTICS_OIS_TIMESTAMPS ,    MTK_STATISTICS_OIS_TIMESTAMPS)\
     _IMP_TAGCONVERT_(    ANDROID_STATISTICS_OIS_X_SHIFTS ,    MTK_STATISTICS_OIS_X_SHIFTS)\
     _IMP_TAGCONVERT_(    ANDROID_STATISTICS_OIS_Y_SHIFTS ,    MTK_STATISTICS_OIS_Y_SHIFTS)\
     ...
     _IMP_TAGCONVERT_(    ANDROID_STATISTICS_INFO_AVAILABLE_OIS_DATA_MODES,    MTK_STATISTICS_INFO_AVAILABLE_OIS_DATA_MODES)\
     ...
     _IMP_TAGCONVERT_(    ANDROID_INFO_VERSION,    MTK_INFO_VERSION)\
     _IMP_TAGCONVERT_(    ANDROID_INFO_SUPPORTED_BUFFER_MANAGEMENT_VERSION,    MTK_INFO_SUPPORTED_BUFFER_MANAGEMENT_VERSION)\
     ...
     _IMP_TAGCONVERT_(    ANDROID_DEPTH_AVAILABLE_RECOMMENDED_DEPTH_STREAM_CONFIGURATIONS,    MTK_DEPTH_AVAILABLE_RECOMMENDED_DEPTH_STREAM_CONFIGURATIONS)\
     _IMP_TAGCONVERT_(    ANDROID_DEPTH_AVAILABLE_DYNAMIC_DEPTH_STREAM_CONFIGURATIONS,    MTK_DEPTH_AVAILABLE_DYNAMIC_DEPTH_STREAM_CONFIGURATIONS)\
     _IMP_TAGCONVERT_(    ANDROID_DEPTH_AVAILABLE_DYNAMIC_DEPTH_MIN_FRAME_DURATIONS,    MTK_DEPTH_AVAILABLE_DYNAMIC_DEPTH_MIN_FRAME_DURATIONS)\
     _IMP_TAGCONVERT_(    ANDROID_DEPTH_AVAILABLE_DYNAMIC_DEPTH_STALL_DURATIONS,    MTK_DEPTH_AVAILABLE_DYNAMIC_DEPTH_STALL_DURATIONS)\
     _IMP_TAGCONVERT_(    ANDROID_LOGICAL_MULTI_CAMERA_PHYSICAL_IDS,    MTK_LOGICAL_MULTI_CAMERA_PHYSICAL_IDS)\
     _IMP_TAGCONVERT_(    ANDROID_LOGICAL_MULTI_CAMERA_SENSOR_SYNC_TYPE,    MTK_LOGICAL_MULTI_CAMERA_SENSOR_SYNC_TYPE)\
     _IMP_TAGCONVERT_(    ANDROID_LOGICAL_MULTI_CAMERA_ACTIVE_PHYSICAL_ID,  MTK_LOGICAL_MULTI_CAMERA_ACTIVE_PHYSICAL_ID)\
     _IMP_TAGCONVERT_(    ANDROID_DISTORTION_CORRECTION_MODE,  MTK_DISTORTION_CORRECTION_MODE)\
     _IMP_TAGCONVERT_(    ANDROID_DISTORTION_CORRECTION_AVAILABLE_MODES,  MTK_DISTORTION_CORRECTION_AVAILABLE_MODES)\
     _IMP_TAGCONVERT_(    ANDROID_HEIC_AVAILABLE_HEIC_STREAM_CONFIGURATIONS,  MTK_HEIC_AVAILABLE_HEIC_STREAM_CONFIGURATIONS)\
     _IMP_TAGCONVERT_(    ANDROID_HEIC_AVAILABLE_HEIC_MIN_FRAME_DURATIONS,  MTK_HEIC_AVAILABLE_HEIC_MIN_FRAME_DURATIONS)\
     _IMP_TAGCONVERT_(    ANDROID_HEIC_AVAILABLE_HEIC_STALL_DURATIONS,  MTK_HEIC_AVAILABLE_HEIC_STALL_DURATIONS)\
     _IMP_TAGCONVERT_(    ANDROID_HEIC_INFO_SUPPORTED,  MTK_HEIC_INFO_SUPPORTED)\
     _IMP_TAGCONVERT_(    ANDROID_HEIC_INFO_MAX_JPEG_APP_SEGMENTS_COUNT,  MTK_HEIC_INFO_MAX_JPEG_APP_SEGMENTS_COUNT)\
