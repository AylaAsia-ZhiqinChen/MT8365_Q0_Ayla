...
#ifndef _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_RSC_IHalRscPipe_H_
#define _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_RSC_IHalRscPipe_H_
//
 ...
 *
 * @param[in] mRSCConfigVec: a vector of input requests.
 *
 ******************************************************************************/
struct  RSCParams
{
    typedef MVOID                   (*PFN_CALLBACK_T)(RSCParams& rParams);
    PFN_CALLBACK_T                  mpfnCallback;
    vector<RSCConfig>              mRSCConfigVec;
    MVOID*                          mpCookie;
    RSCParams()    //HW Default value
...
#if 0
    virtual MUINT32                   getDMAStride(RSCDMAPort dmaport, RSCIMGIFORMAT fmt, MUINT32 subSamWidth)                                    = 0;
#endif
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Attributes.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
#endif  //_MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_RSC_IHalRscPipe_H_
