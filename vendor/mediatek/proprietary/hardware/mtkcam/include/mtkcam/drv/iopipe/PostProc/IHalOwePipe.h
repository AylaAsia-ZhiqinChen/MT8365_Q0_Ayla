...
#ifndef _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_OWE_IHalOwePipe_H_
#define _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_OWE_IHalOwePipe_H_
//
 ...
 *
 * @param[in] mvOWEReq: a vector of input requests.
 *
 ******************************************************************************/
struct  OCCParams
{
    typedef MVOID                   (*PFN_CALLBACK_T)(OCCParams& rParams);
    PFN_CALLBACK_T                  mpfnCallback;
    std::vector<OCCConfig>          mOCCConfigVec;
    MVOID*                          mpCookie;
    OCCParams()     //HW Default value
...
struct  WMFEParams
{
    ...
    PFN_CALLBACK_T                  mpfnCallback;
    std::vector<OWMFEConfig>         mWMFEConfigVec;
    MVOID*                          mpCookie;
 ...
 * @details
 * The data path will be Mem --> OWE --> Mem.
 *
 ******************************************************************************/
class IHalOwePipe
{
...
#if 0
    virtual MUINT32                   getDMAStride(OWEDMAPort dmaport, OWEIMGIFORMAT fmt, MUINT32 subSamWidth)                                    = 0;
#endif
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Attributes.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
#endif  //_MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_OWE_IHalOwePipe_H_
