...
#ifndef _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_GEPF_IHalGepfPipe_H_
#define _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_GEPF_IHalGepfPipe_H_
//
 ...
 *
 * @param[in] mGEPFConfigVec: a vector of input requests.
 *
 ******************************************************************************/
struct  GEPFParams
{
    typedef MVOID                   (*PFN_CALLBACK_T)(GEPFParams& rParams);
    PFN_CALLBACK_T                  mpfnCallback;
    vector<GEPFConfig>              mGEPFConfigVec;
    MVOID*                          mpCookie;
    GEPFParams()    //HW Default value
...
#if 0
    virtual MUINT32                   getDMAStride(GEPFDMAPort dmaport, GEPFIMGIFORMAT fmt, MUINT32 subSamWidth)                                    = 0;
#endif
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Attributes.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
#endif  //_MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_GEPF_IHalGepfPipe_H_
