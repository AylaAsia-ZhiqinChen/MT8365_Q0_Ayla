...
#ifndef _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_WPE_IHalWpePipeDef_H_
#define _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_WPE_IHalWpePipeDef_H_
//
...
struct  WPEParams
{
    typedef MVOID                   (*PFN_CALLBACK_T)(WPEParams& rParams);
    PFN_CALLBACK_T                  mpfnCallback;
    //vector<WPE_Config>               mWPEConfigVec;
    MVOID*                          mpCookie;
    WPEParams()    //HW Default value
 ...
 * @details
 * The data path will be Mem --> WPE --> Mem.
 *
 ******************************************************************************/
class IHalWpePipe
{
...
public:     ////                    Instantiation.
     ...
     */
    virtual MBOOL                   init(MUINT32 secTag =0)                                      = 0;
...
#if 0
    virtual MUINT32                   getDMAStride(WPEDMAPort dmaport, WPEIMGIFORMAT fmt, MUINT32 subSamWidth)                                    = 0;
#endif
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Attributes.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
#endif  //_MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_WPE_IHalWpePipeDef_H_
