...
typedef enum
{
    ...
    MTK_VIDEO_FACE_BEAUTY_CAPTURE,
} MTK_VIDEO_FACE_BEAUTY_SCENARIO;

typedef struct
{
    MINT32 cFB_EYETH; //eye enlargement confidence thread threshold, 0~10
    MINT32 Sat_shift; //saturation, -10~10
    MINT32 GlobalColor; //0:Local, 1:Global
    MINT32 SmoothLevel;
    MINT32 BrightLevel;
    MINT32 RuddyLevel;
...
typedef struct
{
    ...
    MUINT16  FDWidth;
    MUINT16  FDHeight;
    MTK_VIDEO_FACE_BEAUTY_SCENARIO   scenario;
