...
enum MfllErr MfllCore2::releaseBuffer(const enum MfllBuffer& s, int index /* = 0 */)
{
...
sp<IMfllImageBuffer> MfllCore2::retrieveBuffer(const enum MfllBuffer& s, int index /* = 0 */)
{
    MfllErr err = MfllErr_Ok;
...
enum MfllErr MfllCore2::do_Init(const MfllConfig_t& cfg)
{
    mfllLogD("MfllCore2: %s", __FUNCTION__);
    return MfllCore::do_Init(cfg);
}


enum MfllErr MfllCore2::do_AllocMemcWorking(void* void_index)
{
...
enum MfllErr MfllCore2::do_MotionEstimation(void* void_index)
{
...
enum MfllErr MfllCore2::do_MotionCompensation(void* void_index)
{
    unsigned int index = (unsigned int)(long)void_index;
...
enum MfllErr MfllCore2::do_Blending(void *void_index)
{
    const unsigned int index = (unsigned int)(long)void_index;
    enum MfllErr err = MfllErr_Ok;
...
unsigned int MfllCore2::getVersion()
{
    return MFLL_MAKE_REVISION(ver_major, ver_minor, ver_featured);
}


std::string MfllCore2::getVersionString()
{
