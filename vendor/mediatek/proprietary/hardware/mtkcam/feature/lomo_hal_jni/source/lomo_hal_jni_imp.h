...
#include "mtkcam/feature/lomo_hal_jni/lomo_hal_jni.h"
...
*/
class LomoHalJniImp : public LomoHalJni , public android::RefBase
{
    public :
...
/*        virtual MINT32 AllocLomoDstGraphBuffer(MUINT32 Number, \
        ...
        */
        MVOID LomoDequeTrigger();//(QParams& rParams);

        MVOID LomoDequeCallBackDone();//(QParams& rParams);
    ...
    private :
        ...
        sem_t mDequeDoneSem;
        sem_t mDequeSemEnd;
        MUINT32 LomoApplyTuningSetting(MUINT32 caseNum, void *pIspPhyReg)  ;
