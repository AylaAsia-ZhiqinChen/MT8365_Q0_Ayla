...
#define BWDN_UNPACK_PROPERTY    "vendor.STEREO.bwdn_unpack"
#define BWDN_DUMP_PROPERTY      "vendor.STEREO.bwdn_dump"

#define BWDN_HAL_INIT_CORE      "vendor.STEREO.bwdn_hal_init.core"   //1~10
#define BWDN_HAL_INIT_ACC       "vendor.STEREO.bwdn_hal_init.acc"    //1, 2, 4, 8
#define BWDN_HAL_INIT_CONV      "vendor.STEREO.bwdn_hal_init.conv"   //0.503900 0.413200 0.564100 (example, 3 floats)
#define BWDN_HAL_INIT_SPLIT     "vendor.STEREO.bwdn_hal_init.split"  //336 (example)
...
struct BWDN_HAL_PARAMS
{
    ...
    AHardwareBuffer* monoProcessedRaw   = nullptr;
    AHardwareBuffer* bayerProcessedRaw  = nullptr;
    AHardwareBuffer* bayerW             = nullptr;
    AHardwareBuffer* depth              = nullptr;    //disparity from Main to Auxi
