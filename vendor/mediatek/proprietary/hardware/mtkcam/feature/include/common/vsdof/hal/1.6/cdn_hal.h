...
public:
    ...
    /**
     * \brief to start perfServ control for CDN hal
     * \details to start perfServ control for CDN hal
     *
     * \return True if success
     */
    virtual void CDNHALPerfStart() = 0;

    /**
     * \brief to end perfServ control for CDN hal
     * \details to end perfServ control for CDN hal
     *
     * \return True if success
     */
    virtual void CDNHALPerfEnd() = 0;
