...
public:
    ...
    /**
     * \brief Get the range for input images to apply margin
     * \details The data in the boundary will set to 0
     *
     * \param top Margin of top
     * \param left Margin of left
     * \param bottom Margin of bottom
     * \param right Margin of right
     * \return true if success
     */
    static bool getDPEInputMargin(MUINT32 &top, MUINT32 &left, MUINT32 &bottom, MUINT32 &right);
     ...
     * \return true if success
     */
    static bool getWPEInputMargin(MUINT32 &top, MUINT32 &left, MUINT32 &bottom, MUINT32 &right);
    ...
    /**
     * \brief Get ADP tuning params
     *
     * \param tuningParams ADP tuning params
     * \return true of success
     */
    static bool getADPTuningInfo(std::vector<std::pair<std::string, int>> &tuningParams);
#endif
};
