...
struct HWFEFM_DATA
{
    MUINT16 *geoDataMain1[MAX_GEO_LEVEL]       = {NULL}; //FE
    MUINT16 *geoDataMain2[MAX_GEO_LEVEL]       = {NULL}; //FE
    MUINT16 *geoDataLeftToRight[MAX_GEO_LEVEL] = {NULL}; //FM
    MUINT16 *geoDataRightToLeft[MAX_GEO_LEVEL] = {NULL}; //FM
};

struct SWFEFM_DATA
{
    MUINT8* geoSrcImgMain1[MAX_GEO_LEVEL] = {NULL};
    MUINT8* geoSrcImgMain2[MAX_GEO_LEVEL] = {NULL};
};
...
struct N3D_HAL_PARAM_COMMON
{
    ...
    NSCam::IImageBuffer *rectifyImgMain1 = NULL;    //warp_src_addr_main
...
struct N3D_HAL_OUTPUT
{
    ...
    MUINT8 *maskMain1                    = NULL;
    MUINT8 *ldcMain1                     = NULL;

    NSCam::IImageBuffer *rectifyImgMain2 = NULL;
    MUINT8 *maskMain2                    = NULL;
...
{
    NSCam::IImageBuffer *rectifyGBMain2 = NULL;     //YV12
