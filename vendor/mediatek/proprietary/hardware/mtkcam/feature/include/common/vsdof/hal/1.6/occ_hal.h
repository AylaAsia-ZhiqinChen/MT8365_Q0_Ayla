...
struct OCC_HAL_PARAMS
{
    ...
    MUINT8                  *ldcMain1             = NULL;   //8-bit, output of N3D HAL
    MUINT8                  *confidenceMap        = NULL;   //8-bit, output of DPE
    MFLOAT                  cOffset               = 0.0f;
...
struct OCC_HAL_OUTPUT
{
    ...
    MUINT8 *depthMap                   = NULL;  //Y only    DMH
    MUINT8 *occMap                     = NULL;  //Y only
    MUINT8 *nocMap                     = NULL;  //Y only
};
