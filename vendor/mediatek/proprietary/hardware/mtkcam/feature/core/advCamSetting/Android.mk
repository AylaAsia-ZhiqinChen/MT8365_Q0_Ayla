...
LOCAL_SRC_FILES += AdvCamSettingMgr_Imp.cpp
LOCAL_SRC_FILES += AdvCamSettingMgr_ImpHDR.cpp
LOCAL_SRC_FILES += AdvCamSettingMgr_Imp3DNR.cpp
LOCAL_SRC_FILES += AdvCamSettingMgr_ImpEIS.cpp
LOCAL_SRC_FILES += AdvCamSettingMgr_ImpCustom.cpp
...
#-----------------------------------------------------------
LOCAL_MODULE := libmtkcam.adv_setting
