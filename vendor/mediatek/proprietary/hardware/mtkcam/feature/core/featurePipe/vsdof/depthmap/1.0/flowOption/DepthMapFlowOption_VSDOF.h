...
#include "./qparams/BayerBayerQTemplateProvider.h"
#include "./qparams/BayerMonoQTemplateProvider.h"
#include "./qparams/YuvQTemplateProvider.h"
...
, public BayerBayerQTemplateProvider
, public YuvQTemplateProvider
{
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Instantiation.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
    typedef BayerBayerQTemplateProvider TemplateProvider;
...
public:
    ...
    // default not bypass P2AFM
    virtual MBOOL needBypassP2AFM(sp<DepthMapEffectRequest>) ;
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
