...
{
public:
    static android::sp<IStopWatchCollection> createInstant(const std::string& name, MUINT32 requestID);
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Instantiation.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
...
public:
    ...
    virtual MVOID                       beginStopWatch(const std::string& name, MVOID* cookie)              = 0;
    virtual MVOID                       endStopWatch(MVOID* cookie)                                         = 0;
