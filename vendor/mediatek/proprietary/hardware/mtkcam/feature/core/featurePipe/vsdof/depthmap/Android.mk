...
VER2_PLATFORMS := mt6799 mt6757 mt6765
VER2_PLATFORMS := mt6799 mt6757
VER2_5_PLATFORMS := mt6765
VER3_PLATFORMS := mt6771
DEPTHMAP_VER := ""
...
ifneq ("",$(DEPTHMAP_VER))
    include $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/feature/core/featurePipe/vsdof/depthmap/$(DEPTHMAP_VER)/Android.mk
endif
################################################################################
#
################################################################################