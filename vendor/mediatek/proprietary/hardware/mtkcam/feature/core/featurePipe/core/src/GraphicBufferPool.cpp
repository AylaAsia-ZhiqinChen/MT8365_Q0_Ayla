...
MBOOL GraphicBufferPool::init(MUINT32 width, MUINT32 height, android_pixel_format_t format, MUINT32 usage, NativeBufferWrapper::ColorSpace color)
{
  TRACE_FUNC_ENTER();
...
MBOOL GraphicBufferPool::initConfig(MUINT32 width, MUINT32 height, android_pixel_format_t format, MUINT32 usage, NativeBufferWrapper::ColorSpace color)
{
  TRACE_FUNC_ENTER();
  MBOOL ret = MFALSE;
