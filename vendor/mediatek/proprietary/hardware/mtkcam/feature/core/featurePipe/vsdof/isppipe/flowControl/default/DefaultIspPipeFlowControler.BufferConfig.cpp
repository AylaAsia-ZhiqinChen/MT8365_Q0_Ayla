...
getDataIDToBIDMap()
{
    ...
    ADD_TO_DBIDMAP(P2A_TO_TP_YUV_DATA);
    ADD_TO_DBIDMAP(TP_TO_MDP_BOKEHYUV);
    ADD_TO_DBIDMAP(TP_TO_MDP_PVYUV);
    ADD_TO_DBIDMAP(MDP_OUT_THUMBNAIL);
    ADD_TO_DBIDMAP(MDP_OUT_YUVS);
