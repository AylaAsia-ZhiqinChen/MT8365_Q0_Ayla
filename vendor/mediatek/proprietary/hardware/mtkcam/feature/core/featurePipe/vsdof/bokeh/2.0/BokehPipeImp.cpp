...
BokehPipeImp::BokehPipeImp(MINT32 openSensorIndex, MINT32 runPath)
  : CamPipe<BokehPipeNode>("BokehPipe"),
    ...
    mSWFilterNode("SWFilterNode", &mCamGraph, openSensorIndex),
...
buildSWBokehPath()
{
    this->connectData(P2B_MDP_REQUEST, P2B_MDP_REQUEST, mSWFilterNode, mMDPNode);
    this->connectData(MDP_OUT, MDP_OUT, mMDPNode, this);
    this->setRootNode(&mSWFilterNode);
}
//************************************************************************
void
BokehPipeImp::
