...
#define PIPE_CLASS_TAG "IDualCamMFPipe"
...
sp<IDualCamMFPipe>
IDualCamMFPipe::createInstance(MINT32 iSensorIdx_Main1, MINT32 iSensorIdx_Main2, DualCamMFType type)
{
	switch(type){
		case DualCamMFType::TYPE_DCMF_3rdParty:
		case DualCamMFType::TYPE_DCMF_3rdParty_HDR:
			return new DualCamMFPipe(iSensorIdx_Main1);
		default:
