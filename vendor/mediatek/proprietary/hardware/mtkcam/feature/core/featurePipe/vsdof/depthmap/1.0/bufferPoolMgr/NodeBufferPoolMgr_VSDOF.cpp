...
uninit()
{
    ...
    ImageBufferPool::destroy(mDSMVYImgBufPool);
    //----------------------N3D section--------------------------------//
...
initP2ABufferPool()
{
    ...
    CREATE_IMGBUF_POOL(mDSMVYImgBufPool, "mDSMVYImgBufPool", rP2AFM_VR.mMYS_SIZE, eImgFmt_Y8,
                        ImageBufferPool::USAGE_HW_AND_SW, MTRUE);
    ...
    ALLOCATE_BUFFER_POOL(mDSMVYImgBufPool, VSDOF_WORKING_BUF_SET);
    // MY_S(when capture) + BID_OCC_OUT_DS_MVY -> 2 times
    ALLOCATE_BUFFER_POOL(mDSMVYImgBufPool_CAP, 2 * VSDOF_WORKING_BUF_SET);
...
initOCCBufferPool()
{
    ...
    // DMH
    CREATE_IMGBUF_POOL(mDMHImgBufPool, "DMHImgBufPool", rOCCSize.mDMH_SIZE,
                                        eImgFmt_Y8, usage, MTRUE);
    ...
    // DMH
    CREATE_IMGBUF_POOL(mDMHImgBufPool_CAP, "mDMHImgBufPool_CAP", rOCCSize_CAP.mDMH_SIZE,
                                        eImgFmt_Y8, usage, MTRUE);
    ALLOCATE_BUFFER_POOL(mDMHImgBufPool_CAP, VSDOF_WORKING_BUF_SET);
...
buildImageBufferPoolMap()
{
    ...
    if(mNodeBitSet.test(eDPETHMAP_PIPE_NODEID_OCC))
    {
        ...
        ScenarioToImgBufPoolMap DMHImgBufMap;
        DMHImgBufMap.add(eBUFFER_POOL_SCENARIO_PREVIEW, mDMHImgBufPool);
        DMHImgBufMap.add(eBUFFER_POOL_SCENARIO_RECORD,  mDMHImgBufPool);
        DMHImgBufMap.add(eBUFFER_POOL_SCENARIO_CAPTURE, mDMHImgBufPool_CAP);
        mBIDtoImgBufPoolMap_Scenario.add(BID_OCC_OUT_DMH, DMHImgBufMap);
        // CROP MV_Y
        ScenarioToImgBufPoolMap DSMVYImgBufMap;
        DSMVYImgBufMap.add(eBUFFER_POOL_SCENARIO_PREVIEW, mDSMVYImgBufPool);
        DSMVYImgBufMap.add(eBUFFER_POOL_SCENARIO_RECORD, mDSMVYImgBufPool);
