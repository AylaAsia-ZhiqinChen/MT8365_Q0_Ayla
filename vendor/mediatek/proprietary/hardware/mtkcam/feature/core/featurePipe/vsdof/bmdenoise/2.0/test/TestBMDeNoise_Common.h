...
IImageBufferAllocator::ImgParam getImgParam_out_YUV();
IImageBufferAllocator::ImgParam getImgParam_out_Thumb();
...
public:
    ...
    static Vector<sp<PipeRequest> > vDoneReqVec;

public:
    static MVOID CB(MVOID* tag, android::String8 status, sp<PipeRequest> &request);
