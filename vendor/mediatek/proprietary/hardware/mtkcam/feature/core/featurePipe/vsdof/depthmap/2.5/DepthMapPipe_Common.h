...
const int VSDOF_DEPTH_P2FRAME_SIZE = 10 + 2; // P2AFM + P2ABayer
...
// ======== public id section start ==========
    ...
    BID_P2A_OUT_DEPTHMAP = PBID_OUT_HAL_DEPTHMAP,
    ...
    BID_P2A_OUT_TUNING_MAIN1 = PBID_OUT_TUNING_BUF,
...
const DepthMapBufferID INPUT_METADATA_PBID_LIST[] = {PBID_IN_APP_META, PBID_IN_HAL_META_MAIN1, PBID_IN_HAL_META_MAIN2};
