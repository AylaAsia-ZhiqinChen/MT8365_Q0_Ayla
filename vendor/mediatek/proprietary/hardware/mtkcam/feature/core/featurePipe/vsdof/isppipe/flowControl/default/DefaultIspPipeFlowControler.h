...
#ifndef _MTK_CAMERA_FEATURE_PIPE_THIRD_PARTY_DEFAULT_ISPPIPE_FLOW_CONTROLER_H_
#define _MTK_CAMERA_FEATURE_PIPE_THIRD_PARTY_DEFAULT_ISPPIPE_FLOW_CONTROLER_H_
...
********************************************************************************/
/**
 * @class DefaultIspPipeFlowControler
 * @brief the default flow control for IspPipe
 */
class DefaultIspPipeFlowControler final: public IspPipeControlerBase
{
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  DefaultIspPipeFlowControler Public Operator
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
    DefaultIspPipeFlowControler(const IspPipeSetting& setting, const IspPipeOption& option)
    : IspPipeControlerBase("Default", setting, option)
    {
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  DefaultIspPipeFlowControler private inner class
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
private:
    /**
    ...
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    //  DefaultIspPipeFlowControler Private Operator
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    private:
