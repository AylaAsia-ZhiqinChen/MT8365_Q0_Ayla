...
#include "./flowOption/DepthMapFlowOption_BMVSDOF.h"
// Local header file
...
)
{
        ...
        pPipeOption->mFeatureMode == eDEPTHNODE_MODE_VSDOF)
    {
        ...
        pPipeOption->mFeatureMode == eDEPTHNODE_MODE_VSDOF)
    {
        MY_LOGD("create DepthMapFlowOption_BMVSDOF, mbEnableLCE:%d", pPipeOption->mbEnableLCE);
        rpFlowOption = new DepthMapFlowOption_BMVSDOF(pSetting, pPipeOption, pStorage);
        return rpFlowOption->init();
    }
    ...
    sp<BaseBufferPoolMgr>& rPoolMgr)
{
        ...
        pPipeOption->mFeatureMode == eDEPTHNODE_MODE_VSDOF)
    {
        ...
        if(pFlowOption->queryPipeNodeBitSet(nodeBitSet))
        {
            ...
            rPoolMgr = new NodeBufferPoolMgr_VSDOF(nodeBitSet, pPipeOption);
            return MTRUE;
        }
    }
