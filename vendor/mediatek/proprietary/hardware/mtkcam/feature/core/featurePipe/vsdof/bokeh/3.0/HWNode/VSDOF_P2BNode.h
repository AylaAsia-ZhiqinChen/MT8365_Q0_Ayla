...
class VSDOF_P2BNode : public BokehPipeNode
{
    ...
    private:
         ...
         * @param frameParam frameParam store tuning setting include in/out port and image buffer setting and tuning buffer.
        ...
        MBOOL isMetadataBuffer(const MUINT32 bufDataType);
        //
        ...
        MVOID outputDepthMapAndAddDebugInfo(
                    ...
                    IImageBuffer* depthMap,
                    IImageBuffer* displayResult);
        MVOID drawMagicID(IMetadata* pHalMeta, IImageBuffer* pBuf);
        //
    private:
        ...
        // Draw magic number for debug use
