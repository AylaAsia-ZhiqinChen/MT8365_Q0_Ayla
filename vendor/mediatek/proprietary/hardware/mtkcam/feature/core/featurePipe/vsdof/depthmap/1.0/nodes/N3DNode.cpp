...
onThreadStart()
{
    ...
    // create N3DHAL instance - Preview/Record  when not denoise only mode
...
)
{
    ...
    IImageBuffer *pCCIn1Buf = nullptr, *pCCIn2Buf = nullptr, *pRectIn1Buf = nullptr, *pRectIn2Buf = nullptr;
    // get
...
prepareFEFMData(sp<BaseBufferHandler>& pBufferHandler, HWFEFM_DATA& rFefmData)
{
    ...
    IImageBuffer *pFe1boBuf = nullptr, *pFe2boBuf = nullptr, *pFe1coBuf = nullptr, *pFe2coBuf = nullptr;
    IImageBuffer *pFmboLRBuf = nullptr, *pFmboRLBuf = nullptr, *pFmcoLRBuf = nullptr, *pFmcoRLBuf = nullptr;
