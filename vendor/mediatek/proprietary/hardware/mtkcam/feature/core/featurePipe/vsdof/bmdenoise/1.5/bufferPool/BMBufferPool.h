...
class BMBufferPool
{
    public:
         ...
         *-the pointer indicates success; nullptr indidcated failed
         */
        android::sp<mfll::IMfllImageBuffer> getMfllBuffer(BMDeNoiseBufferID bufID);
    ...
    private:
        ...
        // mfll buffers
        KeyedVector< BMDeNoiseBufferID, BufferConfig > mvMfllBufConfig;
        // KeyedVector< BMDeNoiseBufferID, MfllBufferWrapper > mvMfllBufSets;
