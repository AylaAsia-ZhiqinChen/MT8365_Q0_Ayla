...
onThreadStart()
{
    CAM_TRACE_NAME("P2ANode::onThreadStart");
    VSDOF_INIT_LOG("+");
    // Create NormalStream
    VSDOF_LOGD("NormalStream create instance: idx=%d", miSensorIdx_Main1);
    CAM_TRACE_BEGIN("P2ANode::NormalStream::createInstance+init");
    ...
    // 3A: create instance
    // UT does not test 3A
    CAM_TRACE_BEGIN("P2ANode::create_3A_instance");
    #ifndef GTEST
...
onThreadStop()
{
    CAM_TRACE_NAME("P2ANode::onThreadStop");
    VSDOF_INIT_LOG("+");
    cleanUp();
    VSDOF_INIT_LOG("-");
    return MTRUE;
...
{
    CAM_TRACE_NAME("P2ANode::applyISPTuning");
...
onThreadLoop()
{
    ...
    CAM_TRACE_NAME("P2ANode::onThreadLoop");
    ...
    // enque
    CAM_TRACE_BEGIN("P2ANode::NormalStream::enque");
...
{
    CAM_TRACE_NAME("P2ANode::handleP2Done");
