 ...
 */
#ifndef _MTK_CAMERA_VSDOF_BMDENOISE_FEATURE_PIPE_MONO_PRE_PROCESS_NODE_H_
#define _MTK_CAMERA_VSDOF_BMDENOISE_FEATURE_PIPE_MONO_PRE_PROCESS_NODE_H_
...
class MonoPreProcessNode : public BMDeNoisePipeNode
{
    public:
        MonoPreProcessNode() = delete;
        MonoPreProcessNode(const char *name, Graph_T *graph, MINT32 openId);
        virtual ~MonoPreProcessNode();
    ...
    private:
        ...
        // image processes
        MBOOL doMonoToYUV(ImgInfoMapPtr imgInfo);
        MVOID onMonoToYUVDone(EnquedBufPool* pEnqueData);
...
#endif // _MTK_CAMERA_VSDOF_BMDENOISE_FEATURE_PIPE_MONO_PRE_PROCESS_NODE_H_