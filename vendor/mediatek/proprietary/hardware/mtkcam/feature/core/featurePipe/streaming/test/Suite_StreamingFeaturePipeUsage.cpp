...
TEST(StreamingFeaturePipeUsage, USAGE_FULL_AND_EIS22) {
    ...
    EIS_MODE_ENABLE_EIS_22(hint.mEISInfo.mMode);
    ...
    EXPECT_EQ(MTRUE,  pipeUsage.supportMDPNode());
    ...
    EXPECT_EQ(MFALSE, pipeUsage.supportYUVIn());

    EXPECT_EQ(MTRUE,  pipeUsage.supportEIS_22());
    EXPECT_EQ(MFALSE, pipeUsage.supportEIS_25());
    EXPECT_EQ(MFALSE, pipeUsage.supportEIS_30());
    EXPECT_EQ(MFALSE, pipeUsage.supportEIS_Q());
    EXPECT_EQ(MFALSE, pipeUsage.supportFEFM());
    ...
    EXPECT_EQ(MFALSE, pipeUsage.supportVFB());
...
TEST(StreamingFeaturePipeUsage, USAGE_FULL_AND_EIS25) {
    ...
    MUINT32 sensorIdx = 0;
    IStreamingFeaturePipe::UsageHint hint(IStreamingFeaturePipe::USAGE_FULL, size);
    EIS_MODE_ENABLE_EIS_25(hint.mEISInfo.mMode);
    EIS_MODE_ENABLE_EIS_GYRO(hint.mEISInfo.mMode);
    EIS_MODE_ENABLE_EIS_QUEUE(hint.mEISInfo.mMode);
    EIS_MODE_ENABLE_EIS_IMAGE(hint.mEISInfo.mMode);
    hint.mEISInfo.mQueueSize = 25;
    hint.mEISInfo.mStartFrame = 20;
    hint.m3DNRMode = NR3D::E3DNR_MODE_MASK_UI_SUPPORT;
    StreamingFeaturePipeUsage pipeUsage(hint, sensorIdx);
    ...
    EXPECT_EQ(MFALSE, pipeUsage.supportEIS_22());
    EXPECT_EQ(MTRUE,  pipeUsage.supportEIS_25());
    EXPECT_EQ(MFALSE, pipeUsage.supportEIS_30());
    EXPECT_EQ(MTRUE,  pipeUsage.supportEIS_Q());
    EXPECT_EQ(MTRUE,  pipeUsage.supportFEFM());
...
TEST(StreamingFeaturePipeUsage, USAGE_FULL_AND_EIS30_rgwt) {
    ...
    MUINT32 sensorIdx = 0;
    IStreamingFeaturePipe::UsageHint hint(IStreamingFeaturePipe::USAGE_FULL, size);
    EIS_MODE_ENABLE_EIS_30(hint.mEISInfo.mMode);
    EIS_MODE_ENABLE_EIS_GYRO(hint.mEISInfo.mMode);
    EIS_MODE_ENABLE_EIS_QUEUE(hint.mEISInfo.mMode);
    EIS_MODE_ENABLE_EIS_IMAGE(hint.mEISInfo.mMode);
    EIS_MODE_ENABLE_EIS_DEJELLO(hint.mEISInfo.mMode);
    hint.mEISInfo.mQueueSize = 25;
    hint.mEISInfo.mStartFrame = 20;
    hint.m3DNRMode = NR3D::E3DNR_MODE_MASK_UI_SUPPORT;
    StreamingFeaturePipeUsage pipeUsage(hint, sensorIdx);
    ...
    EXPECT_EQ(MFALSE, pipeUsage.supportEIS_22());
    EXPECT_EQ(MFALSE, pipeUsage.supportEIS_25());
    EXPECT_EQ(MTRUE,  pipeUsage.supportEIS_30());
    EXPECT_EQ(MTRUE,  pipeUsage.supportEIS_Q());
    EXPECT_EQ(MFALSE, pipeUsage.supportFEFM());
...
TEST(StreamingFeaturePipeUsage, USAGE_FULL_AND_NO_EIS) {
    ...
    EXPECT_EQ(MFALSE,  pipeUsage.supportMDPNode());
    EXPECT_EQ(MFALSE,  pipeUsage.supportRSCNode());
