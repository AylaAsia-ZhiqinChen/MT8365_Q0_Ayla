...
processWPE(ImgInfoMapPtr pInfoMap)
{
    ...
    // data dump
    this->doDataDump(smBuf_MV_Y->mImageBuffer.get(), BID_WPE_OUT_MV_Y, pRequest->getRequestNo());
    this->doDataDump(smBuf_SV_Y->mImageBuffer.get(), BID_WPE_OUT_SV_Y, pRequest->getRequestNo());
    this->doDataDump(smBuf_MASK_S->mImageBuffer.get(), BID_WPE_OUT_MASK_S, pRequest->getRequestNo());
