 ...
 */
#ifndef _MTK_CAMERA_VSDOF_DCMF_FEATURE_PIPE_VENDOR_NODE_H_
#define _MTK_CAMERA_VSDOF_DCMF_FEATURE_PIPE_VENDOR_NODE_H_
...
class VendorNode : public DualCamMFPipeNode
{
    public:
        VendorNode() = delete;
        VendorNode(const char *name, Graph_T *graph, MINT32 openId);
        virtual ~VendorNode();
    ...
    private:
        ...
        MBOOL doVendorJob(list<PipeRequestPtr>& rvToDoRequests);
