...
#include <vector>
#include <vsdof/bokeh/3.0/bokeh_common.h>
...
MBOOL setupReqMetadata(EffectRequestPtr pRequest);
MBOOL pushRequestMetadata(EffectRequestPtr pRequest, const BokehNodeBufferSetting& setting, IMetadata* pMetaBuf);
