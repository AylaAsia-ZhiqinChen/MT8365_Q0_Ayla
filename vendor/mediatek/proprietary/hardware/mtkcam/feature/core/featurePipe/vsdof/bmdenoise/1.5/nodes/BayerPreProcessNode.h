 ...
 */
#ifndef _MTK_CAMERA_VSDOF_BMDENOISE_FEATURE_PIPE_BAYER_PRE_PROCESS_NODE_H_
#define _MTK_CAMERA_VSDOF_BMDENOISE_FEATURE_PIPE_BAYER_PRE_PROCESS_NODE_H_
...
class BayerPreProcessNode : public BMDeNoisePipeNode
{
    public:
        BayerPreProcessNode() = delete;
        BayerPreProcessNode(const char *name, Graph_T *graph, MINT32 openId);
        virtual ~BayerPreProcessNode();
...
#endif // _MTK_CAMERA_VSDOF_BMDENOISE_FEATURE_PIPE_BAYER_PRE_PROCESS_NODE_H_