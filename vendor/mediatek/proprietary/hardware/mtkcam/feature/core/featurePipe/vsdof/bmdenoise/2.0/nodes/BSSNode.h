...
class BSSNode : public BMDeNoisePipeNode
{
    ...
    */
    ...
    static const int MF_BSS_CLIP_TH0 = 20;
    static const int MF_BSS_CLIP_TH1 = 100;
    static const int MF_BSS_ZERO = 10;
    ...
    private:
        ...
        MVOID   updateBSSProcInfo(MSize srcSize, BSS_PARAM_STRUCT& bss_param, BSS_INPUT_DATA_G& bss_data);
