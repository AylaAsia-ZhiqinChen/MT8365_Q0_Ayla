...
#ifndef _MTK_CAMERA_FEATURE_PIPE_BWDNOISE_HR_PIPE_H_
#define _MTK_CAMERA_FEATURE_PIPE_BWDNOISE_HR_PIPE_H_
...
#include "nodes/RootHRNode.h"
#include "nodes/BayerPreProcessNode.h"
#include "nodes/MonoPreProcessNode.h"
...
********************************************************************************/
/**
 * @class BMDeNoiseHRPipe
 * @brief This is the feature pipe of multi-frame high-resolution(MFHR)
 */
class BMDeNoiseHRPipe
...
public:
// Constructor
BMDeNoiseHRPipe(MINT32 openSensorIndex);
// Copy constructor
// Create instance
// Destr instance

// destructor
virtual ~BMDeNoiseHRPipe();
...
public:
    ...
    MVOID sync();
    BMDeNoiseFeatureType getPipeFeatureType() { return BMDeNoiseFeatureType::TYPE_MFHR; }
...
RootHRNode                  mRootHRNode;
BayerPreProcessNode         mBayerPreProcessNode;
MonoPreProcessNode          mMonoPreProcessNode;
BSSNode                     mBSSNode;
P2AFMNode                   mP2AFMNode;
BMN3DNode                   mBMN3DNode;
FusionNode                  mFusionNode;
MFNRNode                    mMFNRNode;
SWNRNode                    mSWNRNode;
