...
protected:
    ...
    void dumpASDInputImage(void *src, MUINT16 width, MUINT16 height, MUINT32 count);

private:
    // for ASD algorithm
    MTKAsd*                         mpMTKAsdObj;
    ASD_INIT_INFO                   mMyAsdInitInfo;
    ASD_SCD_SET_ENV_INFO_STRUCT     mMyAsdEnvInfo;
    ASD_DECIDER_REF_STRUCT          mMyDeciderEnvInfo;
    ASD_DECIDER_TUNING_PARA_STRUCT  mMyDeciderTuningInfo;   // tuning parameters
    //
    MINT32                          mHalASDDumpOPT;
    MINT32                          mCount;
    MINT32                          mScaleFactor;
};
