...
class Preview_16_9_Rear_Rotate90_BM_VSDoF : public StereoSizeProviderUTBase
{
public:
    Preview_16_9_Rear_Rotate90_BM_VSDoF() : StereoSizeProviderUTBase() { init(); }

    virtual ~Preview_16_9_Rear_Rotate90_BM_VSDoF() {}
...
//  PASS 1
//=============================================================================
TEST_F(Preview_16_9_Rear_Rotate90_BM_VSDoF, TEST)
{
    if(ignoreTest()) {
    ...
    // PASS2A-2
    MYEXPECT_EQ(pass2SizeInfo[PASS2A_2].areaWDMA,           StereoArea(272, 240));
    ...
    // PASS2A'-2
    MYEXPECT_EQ(pass2SizeInfo[PASS2A_P_2].areaWDMA,         StereoArea(408, 360));   //(136x240) * 1.5
