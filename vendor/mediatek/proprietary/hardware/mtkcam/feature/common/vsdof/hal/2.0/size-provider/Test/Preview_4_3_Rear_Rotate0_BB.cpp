...
class Preview_4_3_Rear_Rotate0_BB : public StereoSizeProviderUTBase
{
public:
    Preview_4_3_Rear_Rotate0_BB() : StereoSizeProviderUTBase() { init(); }

    virtual ~Preview_4_3_Rear_Rotate0_BB() {}
...
//  PASS 1
//=============================================================================
TEST_F(Preview_4_3_Rear_Rotate0_BB, TEST)
{
    if(ignoreTest()) {
    ...
    // PASS2A-2
    MYEXPECT_EQ(pass2SizeInfo[PASS2A_2].areaWDMA,           StereoArea(208, 156));
    ...
    // PASS2A'-2
    MYEXPECT_EQ(pass2SizeInfo[PASS2A_P_2].areaWDMA,         StereoArea(312, 234));   //208x160 * 1.5
    MYEXPECT_EQ(pass2SizeInfo[PASS2A_P_2].areaIMG2O,        StereoArea(504, 376));   //416x312 * 1.2, 8-align
