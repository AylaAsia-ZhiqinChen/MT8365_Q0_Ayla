    ...
    for(MUINT32 i = 0; i < __curResultInfo.numOfBuffer; i++) {
        ...
        if(OCC_BUFFER_TYPE_DS == __curResultInfo.bufferInfo[i].type) {
            ...
            if(occHalOutput.depthMap) {
                ...
                ::memcpy(occHalOutput.depthMap, __curResultInfo.bufferInfo[i].planeAddr0, szResult.w*szResult.h);
            } else {
            ...
            if(occHalOutput.occMap) {
                ...
                ::memcpy(occHalOutput.occMap, __curResultInfo.bufferInfo[i].planeAddr0, szResult.w*szResult.h);
            } else {
            ...
            if(occHalOutput.nocMap) {
                ...
                ::memcpy(occHalOutput.nocMap, __curResultInfo.bufferInfo[i].planeAddr0, szResult.w*szResult.h);
            } else {
