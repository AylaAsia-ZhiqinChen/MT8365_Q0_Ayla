...
class Preview_16_9_Front_Rotate90_BB : public StereoSizeProviderUTBase
{
public:
    Preview_16_9_Front_Rotate90_BB() : StereoSizeProviderUTBase() { init(); }

    virtual ~Preview_16_9_Front_Rotate90_BB() {}
...
//  PASS 1
//=============================================================================
TEST_F(Preview_16_9_Front_Rotate90_BB, TEST)
{
    if(ignoreTest()) {
    ...
    // PASS2A-2
    MYEXPECT_EQ(pass2SizeInfo[PASS2A_2].areaWDMA,           StereoArea(136, 240));
    ...
    // PASS2A'-2
    MYEXPECT_EQ(pass2SizeInfo[PASS2A_P_2].areaWDMA,         StereoArea(204, 360));   //(136x240) * 1.5
