...
class Capture_16_9_Front_Rotate90_BB : public StereoSizeProviderUTBase
{
public:
    Capture_16_9_Front_Rotate90_BB() : StereoSizeProviderUTBase() { init(); }

    virtual ~Capture_16_9_Front_Rotate90_BB() {}
...
//  PASS 1
//=============================================================================
TEST_F(Capture_16_9_Front_Rotate90_BB, TEST)
{
    if(ignoreTest()) {
    ...
    MYEXPECT_EQ( tgCropRect[1],     MRect(MPoint(0, 243),   MSize(2592, 1458)) );
