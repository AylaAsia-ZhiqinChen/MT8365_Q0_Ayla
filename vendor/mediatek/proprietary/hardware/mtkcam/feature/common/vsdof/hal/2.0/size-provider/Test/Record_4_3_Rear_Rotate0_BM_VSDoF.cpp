...
class Record_4_3_Rear_Rotate0_BM_VSDoF : public StereoSizeProviderUTBase
{
public:
    Record_4_3_Rear_Rotate0_BM_VSDoF() : StereoSizeProviderUTBase() { init(); }

    virtual ~Record_4_3_Rear_Rotate0_BM_VSDoF() {}
...
//  PASS 1
//=============================================================================
TEST_F(Record_4_3_Rear_Rotate0_BM_VSDoF, TEST)
{
    if(ignoreTest()) {
    ...
    // PASS2A-2
    MYEXPECT_EQ(pass2SizeInfo[PASS2A_2].areaWDMA,           StereoArea(512, 186));
    ...
    // PASS2A'-2
    MYEXPECT_EQ(pass2SizeInfo[PASS2A_P_2].areaWDMA,         StereoArea(768, 280));   //PASS2A_2.areaWDMA * 1.5
