...
#define PROPERTY_WARP_MAP_ONLY  STEREO_PROPERTY_PREFIX"n3d_wpe"

enum ENUM_N3D_WARP_HW
{
    E_N3D_WARP_GPU,
    E_N3D_WARP_CPU,
    E_N3D_WARP_WPE,
};
#define N3D_WARP_HW ((StereoSettingProvider::isActiveStereo()) ? E_N3D_WARP_WPE : E_N3D_WARP_GPU)
...
{
public:
    N3D_HAL_KERNEL(N3D_HAL_INIT_PARAM &n3dInitParam);
...
private:
    bool __initGraphicBuffers(N3D_HAL_INIT_PARAM &n3dInitParam);
...
private:
    ...
    const bool              __DISABLE_GPU;

    const bool              __RUN_N3D;
    ...
    N3D_HAL_INIT_PARAM                     __n3dInitParam;
