...
private:
    ...
    //dump.cpp
    void    __dumpInitData();
    void    __dumpExtraData(json &extraDataJson);
...
private:
    ...
    sp<IImageBuffer>            __workingBufImg;
    MSize                       __viewSize[2];      //0 for 0/180, 1 for 90/270
    ENUM_ROTATION               __capOrientation;
    ENUM_ROTATION               __depthRotation;
    ...
    NSCam::TuningUtils::FILE_DUMP_NAMING_HINT *__dumpHint = NULL;
};

//NOTICE: property has 31 characters limitation
#define LOG_PERPERTY    PROPERTY_ENABLE_LOG".hal.bokeh"     //vendor.STEREO.log.hal.bokeh
#define DUMP_PERPERTY   PROPERTY_ENABLE_DUMP".hal.bokeh"    //vendor.STEREO.dump.hal.bokeh
