...
{
public:
    SW_BOKEHTuning(Value &document, SW_REFOCUSTuning *refocusTuning);
...
private:
    SW_REFOCUSTuning *__refocusTuning;
    TUNING_PAIR_LIST_T __mergedTuning;

    TUNING_PAIR_LIST_T __bokehTuning;
