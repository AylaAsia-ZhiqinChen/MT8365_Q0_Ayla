...
class Capture_4_3_Rear_Rotate0_BM_VSDoF : public StereoSizeProviderUTBase
{
public:
    Capture_4_3_Rear_Rotate0_BM_VSDoF() : StereoSizeProviderUTBase() { init(); }

    virtual ~Capture_4_3_Rear_Rotate0_BM_VSDoF() {}
...
//  PASS 1
//=============================================================================
TEST_F(Capture_4_3_Rear_Rotate0_BM_VSDoF, TEST)
{
    if(ignoreTest()) {
    ...
    //=============================================================================
    //N3D Output
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_MV_Y, eSTEREO_SCENARIO_CAPTURE),      StereoArea(464, 162, 48, 6, 24, 3));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_SV_Y, eSTEREO_SCENARIO_CAPTURE),      StereoArea(464, 162, 48, 6, 24, 3));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_MASK_S_Y, eSTEREO_SCENARIO_CAPTURE),  StereoArea(464, 162, 48, 6, 24, 3));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_LDC, eSTEREO_SCENARIO_CAPTURE),       StereoArea(232, 162, 24, 6, 12, 3));
    ...
    //DPE Output
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_DMP_H, eSTEREO_SCENARIO_CAPTURE),     StereoArea(464, 162, 48, 6, 24, 3));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_CFM_H, eSTEREO_SCENARIO_CAPTURE),     StereoArea(464, 162, 48, 6, 24, 3));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_RESPO, eSTEREO_SCENARIO_CAPTURE),     StereoArea(464, 162, 48, 6, 24, 3));

    //OCC Output
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_MY_S, eSTEREO_SCENARIO_CAPTURE),      StereoArea(208, 156));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_DMH, eSTEREO_SCENARIO_CAPTURE),       StereoArea(208, 156));

    //WMF Output
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_DMW, eSTEREO_SCENARIO_CAPTURE),       StereoArea(208, 156));

    //GF Output
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_DMG, eSTEREO_SCENARIO_CAPTURE),       StereoArea(208, 156));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_DMBG, eSTEREO_SCENARIO_CAPTURE),      StereoArea(208, 156));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_DEPTH_MAP, eSTEREO_SCENARIO_CAPTURE), StereoArea(416, 312));
}
