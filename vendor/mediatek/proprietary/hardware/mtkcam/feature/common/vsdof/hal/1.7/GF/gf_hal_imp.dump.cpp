...
GF_HAL_IMP::__dumpInitInfo()
{
    ...
    if(__initDumpSize < 1) {
        snprintf(__dumpInitData,
                ...
                "    \"gfMode\": %d\n"
                "}",
                __initInfo.inputWidth,
                __initInfo.inputHeight,
                __initInfo.outputWidth,
                __initInfo.outputHeight,
                __initInfo.workingBuffSize,
                __initInfo.gfMode
                );
...
GF_HAL_IMP::__dumpProcInfo()
{
    ...
    snprintf(__dumpProcData,
            ...
            "    }\n"
            "}",
            __procInfo.touchTrigger,
            __procInfo.touchX,
            __procInfo.touchY,
            __procInfo.depthValue,
            __procInfo.dof,
            __procInfo.clearRange,
            __procInfo.cOffset,
            __procInfo.fb,
            __procInfo.dacInfo.min,
            __procInfo.dacInfo.max,
            __procInfo.dacInfo.cur,
            __procInfo.fdInfo.isFd,
            __procInfo.fdInfo.ratio,
            __procInfo.afInfo.afType,
            __procInfo.afInfo.x1,
...
GF_HAL_IMP::__dumpWorkingBuffer()
{
    ...
    fwrite(__initInfo.workingBuffAddr, 1, __initInfo.workingBuffSize, fp);
    fflush(fp);
    fclose(fp);
}
