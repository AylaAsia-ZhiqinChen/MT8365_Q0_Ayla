...
public:
    ...
    virtual void CDNHALPerfStart();

    virtual void CDNHALPerfEnd();
protected:

private:
    void    __setParams(CDN_HAL_PARAMS &param);
    void    __setImages(CDN_HAL_PARAMS &param, CDN_HAL_IO &io);
