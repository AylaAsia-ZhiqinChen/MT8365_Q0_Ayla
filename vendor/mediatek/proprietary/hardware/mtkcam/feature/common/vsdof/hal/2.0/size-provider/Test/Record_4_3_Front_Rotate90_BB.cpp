...
class Record_4_3_Front_Rotate90_BB : public StereoSizeProviderUTBase
{
public:
    Record_4_3_Front_Rotate90_BB() : StereoSizeProviderUTBase() { init(); }

    virtual ~Record_4_3_Front_Rotate90_BB() {}
...
//  PASS 1
//=============================================================================
TEST_F(Record_4_3_Front_Rotate90_BB, TEST)
{
    if(ignoreTest()) {
    ...
    // PASS2A-2
    MYEXPECT_EQ(pass2SizeInfo[PASS2A_2].areaWDMA,           StereoArea(192, 250));   //(156x208) * 1.2
    ...
    // PASS2A'-2
    MYEXPECT_EQ(pass2SizeInfo[PASS2A_P_2].areaWDMA,         StereoArea(288, 376));   //(156x208) * 1.5 * 1.2
