...
class Record_16_9_Rear_Rotate0_BB : public StereoSizeProviderUTBase
{
public:
    Record_16_9_Rear_Rotate0_BB() : StereoSizeProviderUTBase() { init(); }
...
TEST_F(Record_16_9_Rear_Rotate0_BB, TEST)
{
    ...
    // PASS2A-2
    MYEXPECT_EQ(pass2SizeInfo[PASS2A_2].areaWDMA,           StereoArea(288, 162));
    ...
    // PASS2A'-2
    MYEXPECT_EQ(pass2SizeInfo[PASS2A_P_2].areaWDMA,         StereoArea(432, 244));   //(288x162) * 1.5
