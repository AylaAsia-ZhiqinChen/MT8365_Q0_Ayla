...
public:
    ...
    StereoSensorConbinationSetting_T *getSensorCombinationSetting(SensorUID_T uidMain1, SensorUID_T uidMain2);
...
private:
    ...
    vector<StereoSensorSetting_T>               __sensorSettings;
    vector<StereoSensorConbinationSetting_T>    __sensorCombinationSettings;
};
