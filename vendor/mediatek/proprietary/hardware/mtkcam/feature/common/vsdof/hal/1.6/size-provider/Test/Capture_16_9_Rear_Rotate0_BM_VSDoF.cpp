...
class Capture_16_9_Rear_Rotate0_BM_VSDoF : public StereoSizeProviderUTBase
{
public:
    Capture_16_9_Rear_Rotate0_BM_VSDoF() : StereoSizeProviderUTBase() { init(); }

    virtual ~Capture_16_9_Rear_Rotate0_BM_VSDoF() {}
...
//  PASS 1
//=============================================================================
TEST_F(Capture_16_9_Rear_Rotate0_BM_VSDoF, TEST)
{
    if(ignoreTest()) {
    ...
    //=============================================================================
    //N3D Output
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_MV_Y, eSTEREO_SCENARIO_CAPTURE),      StereoArea(544, 144, 64, 8, 32, 4));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_MASK_M_Y, eSTEREO_SCENARIO_CAPTURE),  StereoArea(544, 144, 64, 8, 32, 4));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_SV_Y, eSTEREO_SCENARIO_CAPTURE),      StereoArea(544, 144, 64, 8, 32, 4));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_MASK_S_Y, eSTEREO_SCENARIO_CAPTURE),  StereoArea(544, 144, 64, 8, 32, 4));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_LDC, eSTEREO_SCENARIO_CAPTURE),       StereoArea(272, 144, 32, 8, 16, 4));
    ...
    //DPE Output
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_DMP_H, eSTEREO_SCENARIO_CAPTURE),     StereoArea(544, 144, 64, 8, 32, 4));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_CFM_H, eSTEREO_SCENARIO_CAPTURE),     StereoArea(544, 144, 64, 8, 32, 4));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_RESPO, eSTEREO_SCENARIO_CAPTURE),     StereoArea(544, 144, 64, 8, 32, 4));

    //OCC Output
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_MY_S, eSTEREO_SCENARIO_CAPTURE),      StereoArea(240, 136));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_DMH, eSTEREO_SCENARIO_CAPTURE),       StereoArea(240, 136));

    //WMF Output
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_DMW, eSTEREO_SCENARIO_CAPTURE),       StereoArea(240, 136));

    //GF Output
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_DMG, eSTEREO_SCENARIO_CAPTURE),       StereoArea(240, 136));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_DMBG, eSTEREO_SCENARIO_CAPTURE),      StereoArea(240, 136));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_DEPTH_MAP, eSTEREO_SCENARIO_CAPTURE), StereoArea(480, 272));
}
