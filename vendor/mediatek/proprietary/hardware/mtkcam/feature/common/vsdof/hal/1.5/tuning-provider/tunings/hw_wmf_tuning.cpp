...
HW_WMFTuning::_initDefaultValues()
{
    ...
    __ctrls[E_HOLE_FILLING_ROUND_1].WmfeHorzScOrd   = WMFE_HORZ_RIGHT2LEFT;
    ...
    __ctrls[E_HOLE_FILLING_ROUND_2].WmfeHorzScOrd   = WMFE_HORZ_LEFT2RIGHT;
...
HW_WMFTuning::_initDocument()
{
    ...
    for(int i = 0; i < TOTAL_WMF_ROUND; i++) {
        ...
        AddTuning("WmfeHorzScOrd", ctrl->WmfeHorzScOrd);
        AddTuning("WmfeVertScOrd", ctrl->WmfeVertScOrd);
...
HW_WMFTuning::_loadValuesFromDocument()
{
    ...
    for(SizeType i = 0; i < wmfValues.Size(); i++) {
        ...
        ctrl->WmfeFilterSize  = static_cast<WMFEFILTERSIZE>(tuningValues["WmfeFilterSize"].GetInt());
        ctrl->Wmfe_Dpnd_En    = tuningValues["Wmfe_Dpnd_En"].GetInt();
        ctrl->Wmfe_Mask_En    = tuningValues["Wmfe_Mask_En"].GetInt();
        ctrl->WmfeHorzScOrd   = static_cast<WMFEHORZSCANORDER>(tuningValues["WmfeHorzScOrd"].GetInt());
        ctrl->WmfeVertScOrd   = static_cast<WMFEVERTSCANORDER>(tuningValues["WmfeVertScOrd"].GetInt());
