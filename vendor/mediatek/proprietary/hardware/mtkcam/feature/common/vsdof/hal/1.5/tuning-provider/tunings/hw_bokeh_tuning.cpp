...
HW_BOKEHTuning::retrieveTuningParams(TuningQuery_T &query)
{
    ...
    if(__bokehMap.find(strength) != __bokehMap.end()) {
        ...
        bokehInfo->DIP_X_NBC2_ANR2_CON1.Bits.NBC2_ANR2_MODE     = queryResult->DIP_X_NBC2_ANR2_CON1.Bits.NBC2_ANR2_MODE;
        bokehInfo->DIP_X_NBC2_ANR2_CON1.Bits.NBC2_ANR2_ENC      = queryResult->DIP_X_NBC2_ANR2_CON1.Bits.NBC2_ANR2_ENC;
        // bokehInfo->DIP_X_NBC2_ANR2_CON1.Bits.ANR2_LCE_LINK = queryResult->DIP_X_NBC2_ANR2_CON1.Bits.ANR2_LCE_LINK;
        bokehInfo->DIP_X_NBC2_BOK_CON.Bits.NBC2_BOK_MODE        = queryResult->DIP_X_NBC2_BOK_CON.Bits.NBC2_BOK_MODE;
        ...
        bokehInfo->DIP_X_NBC2_BOK_RSV1.Bits.NBC2_BOK_RSV1       = queryResult->DIP_X_NBC2_BOK_RSV1.Bits.NBC2_BOK_RSV1;
    } else {
...
{
    {
        ...
        bokehInfo->DIP_X_NBC2_ANR2_CON1.Bits.NBC2_ANR2_MODE      = 1;
        bokehInfo->DIP_X_NBC2_ANR2_CON1.Bits.NBC2_ANR2_ENC       = 1;
        // bokehInfo->DIP_X_NBC2_ANR2_CON1.Bits.ANR2_LCE_LINK  = 0;  //Must be 0

        bokehInfo->DIP_X_NBC2_BOK_CON.Bits.NBC2_BOK_MODE         = 0;  //Should be 0
        ...
        bokehInfo->DIP_X_NBC2_BOK_RSV1.Bits.NBC2_BOK_RSV1        = 0;
    }
...
HW_BOKEHTuning::log(FastLogger &logger, bool inJSON)
{
    ...
    for (HW_BOKEH_MAP_T::iterator it = __bokehMap.begin(); it != __bokehMap.end(); ++it) {
        ...
        .FastLogD("DIP_X_NBC2_ANR2_CON1.Bits.NBC2_ANR2_MODE:     %d", bokehInfo->DIP_X_NBC2_ANR2_CON1.Bits.NBC2_ANR2_MODE)
        .FastLogD("DIP_X_NBC2_ANR2_CON1.Bits.NBC2_ANR2_ENC:      %d", bokehInfo->DIP_X_NBC2_ANR2_CON1.Bits.NBC2_ANR2_ENC)
        // .FastLogD("DIP_X_NBC2_ANR2_CON1.Bits.ANR2_LCE_LINK: %d", bokehInfo->DIP_X_NBC2_ANR2_CON1.Bits.ANR2_LCE_LINK)

        .FastLogD("DIP_X_NBC2_BOK_CON.Bits.NBC2_BOK_MODE:        %d", bokehInfo->DIP_X_NBC2_BOK_CON.Bits.NBC2_BOK_MODE)
        ...
        .FastLogD("DIP_X_NBC2_BOK_RSV1.Bits.NBC2_BOK_RSV1:       %d", bokehInfo->DIP_X_NBC2_BOK_RSV1.Bits.NBC2_BOK_RSV1)
        .FastLogD("---------------------------------------");
    }
...
HW_BOKEHTuning::_initDocument()
{
    ...
    //            "DIP_X_NBC2_ANR2_CON1.Bits.NBC2_ANR2_MODE": 0,
    //            "DIP_X_NBC2_ANR2_CON1.Bits.NBC2_ANR2_ENC": 0,
    //            ...
    //            "DIP_X_NBC2_BOK_OFF.Bits.NBC2_BOK_YOFF": 0,
    //            "DIP_X_NBC2_BOK_RSV1.Bits.NBC2_BOK_RSV1": 0
    //         }
    //     },
    //     ...
    // ]
    ...
    for (HW_BOKEH_MAP_T::iterator it=__bokehMap.begin(); it!=__bokehMap.end(); ++it) {
        ...
        AddTuning("DIP_X_NBC2_ANR2_CON1.Bits.NBC2_ANR2_MODE", bokehInfo->DIP_X_NBC2_ANR2_CON1.Bits.NBC2_ANR2_MODE);
        AddTuning("DIP_X_NBC2_ANR2_CON1.Bits.NBC2_ANR2_ENC", bokehInfo->DIP_X_NBC2_ANR2_CON1.Bits.NBC2_ANR2_ENC);
        // AddTuning("DIP_X_NBC2_ANR2_CON1.Bits.ANR2_LCE_LINK", bokehInfo->DIP_X_NBC2_ANR2_CON1.Bits.ANR2_LCE_LINK);
        AddTuning("DIP_X_NBC2_BOK_CON.Bits.NBC2_BOK_MODE", bokehInfo->DIP_X_NBC2_BOK_CON.Bits.NBC2_BOK_MODE);
        ...
        AddTuning("DIP_X_NBC2_BOK_RSV1.Bits.NBC2_BOK_RSV1", bokehInfo->DIP_X_NBC2_BOK_RSV1.Bits.NBC2_BOK_RSV1);
...
HW_BOKEHTuning::_loadValuesFromDocument()
{
    ...
    for(SizeType i = 0; i < feValues.Size(); i++) {
        ...
        bokehInfo->DIP_X_NBC2_ANR2_CON1.Bits.NBC2_ANR2_MODE     = tuningValues["DIP_X_NBC2_ANR2_CON1.Bits.NBC2_ANR2_MODE"].GetInt();
        bokehInfo->DIP_X_NBC2_ANR2_CON1.Bits.NBC2_ANR2_ENC      = tuningValues["DIP_X_NBC2_ANR2_CON1.Bits.NBC2_ANR2_ENC"].GetInt();
        // bokehInfo->DIP_X_NBC2_ANR2_CON1.Bits.ANR2_LCE_LINK = tuningValues["DIP_X_NBC2_ANR2_CON1.Bits.ANR2_LCE_LINK"].GetInt();
        bokehInfo->DIP_X_NBC2_BOK_CON.Bits.NBC2_BOK_MODE        = tuningValues["DIP_X_NBC2_BOK_CON.Bits.NBC2_BOK_MODE"].GetInt();
        ...
        bokehInfo->DIP_X_NBC2_BOK_RSV1.Bits.NBC2_BOK_RSV1       = tuningValues["DIP_X_NBC2_BOK_RSV1.Bits.NBC2_BOK_RSV1"].GetInt();
    }
}
