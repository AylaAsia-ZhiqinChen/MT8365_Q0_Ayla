...
class Preview_4_3_Rear_Rotate90_BM_VSDoF : public StereoSizeProviderUTBase
{
public:
    Preview_4_3_Rear_Rotate90_BM_VSDoF() : StereoSizeProviderUTBase() { init(); }

    virtual ~Preview_4_3_Rear_Rotate90_BM_VSDoF() {}
...
//  PASS 1
//=============================================================================
TEST_F(Preview_4_3_Rear_Rotate90_BM_VSDoF, TEST)
{
    if(ignoreTest()) {
