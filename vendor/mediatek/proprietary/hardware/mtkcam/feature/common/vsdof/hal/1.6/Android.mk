...
ifeq ($(MTK_CAM_VSDOF_SUPPORT), yes)
	...
	#FEFM
	LOCAL_SHARED_LIBRARIES += libcamalgo.fefm
	LOCAL_WHOLE_STATIC_LIBRARIES += libfeature.vsdof.hal.swfefm_setting_provider
...
ifeq ($(MTK_CAM_STEREO_DENOISE_SUPPORT), yes)
	LOCAL_WHOLE_STATIC_LIBRARIES += libfeature.vsdof.hal.bwdn
