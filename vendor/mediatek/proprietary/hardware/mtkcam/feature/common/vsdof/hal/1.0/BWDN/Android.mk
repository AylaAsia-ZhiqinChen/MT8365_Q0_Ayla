...
#-----------------------------------------------------------
LOCAL_SRC_FILES += bwdn_hal_imp.cpp
LOCAL_SRC_FILES += bwdn_hal_imp.dump.cpp
LOCAL_SRC_FILES += bwdn_hal_imp.log.cpp
...
LOCAL_C_INCLUDES += \
    ...
    $(TOP)/vendor/mediatek/proprietary/hardware/libcamera_feature/libbwdn_lib/$(PLATFORM)/include \
    $(TOP)/vendor/mediatek/proprietary/hardware/perfservice/perfservicenative
...
#-----------------------------------------------------------
LOCAL_MODULE := libfeature.vsdof.hal.bwdn
