...
#include "tunings/sw_fefm_tuning.h"
#endif
...
StereoTuningProviderKernel::init()
{
    ...
    if (loadDocument.HasMember(sensorCombinationKey)) {
        ...
        MY_LOGW("Combination %s does not exist, init tuning parameters using whole document", SENSOR_COMBINATION_KEY);
    ...
    __tuningHolderMap[E_TUNING_SW_FEFM]     = new SW_FEFMTuning(document);
#endif
