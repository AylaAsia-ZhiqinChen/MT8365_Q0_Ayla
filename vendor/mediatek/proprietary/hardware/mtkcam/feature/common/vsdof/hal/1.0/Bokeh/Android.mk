...
#-----------------------------------------------------------
LOCAL_SRC_FILES += bokeh_hal_imp.cpp
LOCAL_SRC_FILES += bokeh_hal_imp.log.cpp
LOCAL_SRC_FILES += bokeh_hal_imp.dump.cpp

#-----------------------------------------------------------
LOCAL_C_INCLUDES += \
    $(VSDOF_COMMON_INC) \
    $(TOP)/vendor/mediatek/proprietary/hardware/libcamera_feature/librefocus_lib/$(PLATFORM)/include \
	$(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/feature/include/common/vsdof/hal/
...
#-----------------------------------------------------------
LOCAL_MODULE := libfeature.vsdof.hal.bokeh
