...
CDN_HAL_IMP::__logImages()
{
    ...
    MY_LOGD("output:[%p][%p][%p]", __runtimeImages.output[0], __runtimeImages.output[1], __runtimeImages.output[2]);
    MY_LOGD("======================");
}