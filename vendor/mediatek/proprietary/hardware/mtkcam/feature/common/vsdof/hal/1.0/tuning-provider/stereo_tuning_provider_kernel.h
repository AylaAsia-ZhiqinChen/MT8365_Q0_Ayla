...
private:
    void __saveTuningToFile(Document &document);
    bool __loadTuningFromFile(Document &document);
...
private:
    ...
    //Align order of ENUM_STEREO_SENSOR_PROFILE
    const char *PROFILE_NAMES[TOTAL_STEREO_SENSOR_PROFILE] = { "Unknown", "Rear+Rear", "Front+Front", "Rear+Front" };
};
