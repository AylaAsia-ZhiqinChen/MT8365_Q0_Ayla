...
dumpMap() const
{
    RWLock::AutoRLock _l(mRWLock);
    //
    MY_LOGD("Consumer Map: size(%zu) used(%d) released(%d) prereleased(%d) releasedstilluse(%d)",
            mConsumerMap.size(),
    ...
    //
    MY_LOGD("Producer Map: size(%zu) used(%d) released(%d) prereleased(%d) releasedstilluse(%d)",
            mProducerMap.size(),
