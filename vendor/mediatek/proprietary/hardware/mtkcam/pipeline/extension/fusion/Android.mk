...
# -----------------------------------------------------------------------------
# To build libcam.extension.fusion if only if (MTKCAM_HAVE_DUAL_ZOOM_FUSION_SUPPORT > 0)
# -----------------------------------------------------------------------------
ifneq ($(strip $(MTKCAM_HAVE_DUAL_ZOOM_SUPPORT)),0)
ifneq ($(strip $(MTKCAM_HAVE_DUAL_ZOOM_FUSION_SUPPORT)),0)

# -----------------------------------------------------------------------------
# Source code
# -----------------------------------------------------------------------------
LOCAL_SRC_FILES += controller/BaseFusionCtrler.cpp
LOCAL_SRC_FILES += controller/FusionCtrler.cpp
LOCAL_SRC_FILES += FusionVendorImp.cpp
...
# -----------------------------------------------------------------------------
LOCAL_MODULE := libcam.extension.fusion
