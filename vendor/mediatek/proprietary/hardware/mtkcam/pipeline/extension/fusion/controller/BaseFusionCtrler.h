 ...
 */
#ifndef _MTK_HARDWARE_PIPELINE_EXTENSION_BASE_FUSION_CTRLER_H_
#define _MTK_HARDWARE_PIPELINE_EXTENSION_BASE_FUSION_CTRLER_H_
...
class BaseFusionCtrler : public BaseController
{
        // this class is not allow to instantiate.
    protected:
        BaseFusionCtrler(MINT32 mode);
        BaseFusionCtrler(const BaseFusionCtrler&) = delete;
        BaseFusionCtrler(BaseFusionCtrler&) = delete;
    public:
        ~BaseFusionCtrler();
    ...
    public:
        ...
        //  @note                   This method is thread-safe.
        virtual void            enqueFrame(MINT32 openId, ReqFrameSP frame);
...
#endif // _MTK_HARDWARE_PIPELINE_EXTENSION_BASE_FUSION_CTRLER_H_