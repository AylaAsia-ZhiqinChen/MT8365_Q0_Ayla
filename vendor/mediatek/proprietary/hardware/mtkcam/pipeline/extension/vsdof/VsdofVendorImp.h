 ...
 */
#ifndef _MTK_HARDWARE_MTKCAM_PIPELINE_EXTENSION_VSDOF_VENDOR_IMP_H_
#define _MTK_HARDWARE_MTKCAM_PIPELINE_EXTENSION_VSDOF_VENDOR_IMP_H_
...
//
#include "controller/BaseVsdofCtrler.h"
...
// class VsdofVendorImp.
class VsdofVendorImp
    : public virtual VsdofVendor // implement VsdofVendor
    , public virtual BaseVendor // use the implementations from BaseVendor
{
    ...
    protected:
        ...
        void SetStreamMap(  MINT32 openId,
                                   const InputInfo& in,
                                   std::shared_ptr<BaseVsdofCtrler> ctrler);
        // dump frame info
        void DumpFrameInfo( MINT32 const openId,
                                    BufferParam bufParam);
    ...
    protected:
        ...
        ControllerContainer<BaseVsdofCtrler>*   getCtrlerContainer(CTRLER u);
        ...
        std::shared_ptr<BaseVsdofCtrler> getCtrler(CTRLER u, MINT32 mode);
        ...
        //  @param u                Selection of the container.
        //  @return                 Controller instance.
        std::shared_ptr<BaseVsdofCtrler> getCtrler(MUINT32 requestNo, CTRLER u);

        // Take the controller from the beginning of the container. If the container
        // is empty, this method returns NULL.
        //  @param u                Selection of the container.
        //  @return                 Controller instance.
        std::shared_ptr<BaseVsdofCtrler> takeCtrler(CTRLER u);
    ...
    public:
        ...
        static
        ControllerContainer<BaseVsdofCtrler> sUnusedCtrlers; // everyone may want push un-used controller
        ControllerContainer<BaseVsdofCtrler> mUsedCtrlers;
    ...
    public:
        ...
        VsdofVendorImp(const VsdofVendorImp&) = delete;
        VsdofVendorImp(VsdofVendorImp&&) = delete;

        virtual ~VsdofVendorImp();

        // **************** local usage ****************
    public:
        // static
        static wp<VsdofVendor> mThis;
...
#endif // _MTK_HARDWARE_MTKCAM_PIPELINE_EXTENSION_VSDOF_VENDOR_IMP_H_
