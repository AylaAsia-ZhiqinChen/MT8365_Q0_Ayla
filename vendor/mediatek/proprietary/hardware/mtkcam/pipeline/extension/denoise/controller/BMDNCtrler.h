 ...
 */
#ifndef _MTK_HARDWARE_PIPELINE_EXTENSION_BMDNCTRLER_H_
#define _MTK_HARDWARE_PIPELINE_EXTENSION_BMDNCTRLER_H_
...
//
// ----------------------------------------------------------------------------
class BMDNCtrler : public BaseDNCtrler
{
...
//
// ----------------------------------------------------------------------------
class BMDNListenerImp : public NSCamFeature::NSFeaturePipe::IBMDeNoisePipeCB
{
public:
    BMDNListenerImp(BMDNCtrler* ctrler) : pCtrler(ctrler)
    {
    }
    virtual ~BMDNListenerImp()
    {
    }
    status_t onEvent(
                    NSCamFeature::NSFeaturePipe::IBMDeNoisePipeCB::EventId eventType,
...
private:
    BMDNCtrler* pCtrler = nullptr;
};
};
};
#endif // _MTK_HARDWARE_PIPELINE_EXTENSION_BMDNCTRLER_H_