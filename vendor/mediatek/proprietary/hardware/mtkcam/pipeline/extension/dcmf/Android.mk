...
# -----------------------------------------------------------------------------
# To build libcam.extension.denoise if only if (MTKCAM_HAVE_MTKSTEREO_SUPPORT > 0)
# -----------------------------------------------------------------------------
...
# Source code
# -----------------------------------------------------------------------------
LOCAL_SRC_FILES += controller/BaseDCCtrler.cpp
LOCAL_SRC_FILES += controller/DCMFCtrler.cpp
LOCAL_SRC_FILES += DCMFImp.cpp
...
#LOCAL_C_INCLUDES += $(TOP)/system/core/liblog/include
...
# -----------------------------------------------------------------------------
LOCAL_MODULE := libcam.extension.dcmf
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_OWNER := mtk
LOCAL_MODULE_TAGS := optional
include $(MTK_STATIC_LIBRARY)

endif # MTKCAM_HAVE_MTKSTEREO_SUPPORT
