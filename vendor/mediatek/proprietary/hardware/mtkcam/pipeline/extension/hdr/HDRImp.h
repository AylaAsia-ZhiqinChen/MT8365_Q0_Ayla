 ...
 */
#ifndef _MTK_HARDWARE_MTKCAM_PIPELINE_EXTENSION_HDR_IMP_H_
#define _MTK_HARDWARE_MTKCAM_PIPELINE_EXTENSION_HDR_IMP_H_
...
// class HDRVendorImp.
class HDRVendorImp
    : public virtual HDRVendor // implement HDRVendor
...
public:
    ...
    HDRVendorImp(const HDRVendorImp&) = delete;
    HDRVendorImp(HDRVendorImp&&) = delete;

    virtual ~HDRVendorImp();
};

} // namespace plugin
} // namespace NSCam
#endif // _MTK_HARDWARE_MTKCAM_PIPELINE_EXTENSION_HDR_IMP_H_
