...
# -----------------------------------------------------------------------------
# To build libcam.extension.mfnr if only if (MTKCAM_HAVE_MFB_SUPPORT > 0)
# -----------------------------------------------------------------------------
...
# Source code
# -----------------------------------------------------------------------------
LOCAL_SRC_FILES += MFNRVendorFactory.cpp
LOCAL_SRC_FILES += MFNRImp.cpp
LOCAL_SRC_FILES += controller/MFNRCtrler.cpp
LOCAL_SRC_FILES += controller/MFNRCtrler_v1.6.cpp
...
# -----------------------------------------------------------------------------
LOCAL_MODULE := libcam.extension.mfnr
