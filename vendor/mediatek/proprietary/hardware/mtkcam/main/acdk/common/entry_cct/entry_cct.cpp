...
#define MODULE_PATH "libmtkcam_cct.so"
}
...
CctIF_Init(MINT32 dev)
{
    ...
    //
    MY_LOGD("CctIF_Init:dev(%d), %p", dev, pfnEntry);
...
CctIF_ACDK_Open()
{
    //  entry type / entry name
    typedef MBOOL (*pfnEntry_T)();
    char const szEntrySymbol[] = "CctIF_ACDK_Open";
    //
    pfnEntry_T pfnEntry = (pfnEntry_T)::getModuleEntry(szEntrySymbol);
    if  ( ! pfnEntry )
    {
...
CctIF_ACDK_Close()
{
    //  entry type / entry name
    typedef MBOOL (*pfnEntry_T)();
    char const szEntrySymbol[] = "CctIF_ACDK_Close";
    //
    pfnEntry_T pfnEntry = (pfnEntry_T)::getModuleEntry(szEntrySymbol);
    if  ( ! pfnEntry )
    {
...
CctIF_ACDK_Init()
{
    //  entry type / entry name
    typedef MBOOL (*pfnEntry_T)();
    char const szEntrySymbol[] = "CctIF_ACDK_Init";
    //
    pfnEntry_T pfnEntry = (pfnEntry_T)::getModuleEntry(szEntrySymbol);
    if  ( ! pfnEntry )
    {
...
CctIF_ACDK_DeInit()
{
    //  entry type / entry name
    typedef MBOOL (*pfnEntry_T)();
    char const szEntrySymbol[] = "CctIF_ACDK_DeInit";
    //
    pfnEntry_T pfnEntry = (pfnEntry_T)::getModuleEntry(szEntrySymbol);
    if  ( ! pfnEntry )
    {
 ...
 ******************************************************************************/
MBOOL
CctIF_ACDK_IOControl(MUINT32 a_u4Ioctl, ACDK_FEATURE_INFO_STRUCT *a_prAcdkFeatureInfo)
{
    //  entry type / entry name
    typedef MBOOL (*pfnEntry_T)(MUINT32, ACDK_FEATURE_INFO_STRUCT*);
    char const szEntrySymbol[] = "CctIF_ACDK_IOControl";
    //
    pfnEntry_T pfnEntry = (pfnEntry_T)::getModuleEntry(szEntrySymbol);
    if  ( ! pfnEntry )
    {
