...
namespace NSACDK
{
    /**
       ...
       */
    typedef enum _ACDK_BYPASS_FLAG {
        ACDK_BYPASS_NONE        = 0x00,
        ACDK_BYPASS_PURE_P2     = 0x02,
        ACDK_BYPASS_SURFACEVIEW = 0x04
    } ACDK_BYPASS_FLAG;
    class AcdkBase
    {
    public:
        ...
        /**                       
              ...
              */
        static AcdkBase* createInstance(ACDK_BYPASS_FLAG bypassFlags = ACDK_BYPASS_NONE);
