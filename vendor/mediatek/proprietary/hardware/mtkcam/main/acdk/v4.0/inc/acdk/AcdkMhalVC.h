...
#ifndef _ACDKMHALVC_H_
#define _ACDKMHALVC_H_
...
namespace NSAcdkMhal
{
    /**
       ...
       */
    class AcdkMhalVC : public AcdkMhalBase {
    public :
        ...
        /**
                   *@brief AcdkMhalVC constructor
                 */
        AcdkMhalVC();

        /**
                   *@brief AcdkMhalVC destructor
                 */
        ~AcdkMhalVC() {};

        /**
                   *@brief Destory AcdkMhalVC Object
                 */
