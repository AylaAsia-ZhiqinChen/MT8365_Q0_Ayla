        ...
        MUINT32 const orientation)
{
    ...
    ACDK_LOGD_DYN(g_overlayDebug,"phyAddr  = 0x%zx", phyAddr);
    ACDK_LOGD_DYN(g_overlayDebug,"virtAddr = 0x%zx", virtAddr);
...
MINT32 surfaceView::refresh()
{
    ...
    if(g_overlayFlag == 0)
    {
        ...
        ACDK_LOGD_DYN(g_overlayDebug,"src VA(0x%zx), PA(0x%zx)",(MUINTPTR)mLayerInfo[0].src_base_addr,(MUINTPTR)mLayerInfo[0].src_phy_addr );
    ...
    else
    {
        ...
        ACDK_LOGD_DYN(g_overlayDebug,"use mmap");
        ACDK_LOGD_DYN(g_overlayDebug,"src VA(0x%zx), size(%u)",(MUINTPTR)mLayerInfo[0].src_base_addr,mLayerInfo[0].src_width * mLayerInfo[0].src_height * 2);
