...
#@TODO add to projectConfig.mk
#ifeq ($(MTK_CAM_VPUCLIENT_SUPPORT), yes)

#-----------------------------------------------------------
LOCAL_SRC_FILES += VpuClient.cpp
#LOCAL_SRC_FILES += VpuClientTemp.cpp	#@TODO remove this
...
#
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/interfaces/camera/vpuhidl/2.0/
#-----------------------------------------------------------
...
#
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#this section is for test only, you should remove it
# vpu_data_wpp.h
...
#-----------------------------------------------------------
LOCAL_MODULE := vendor.mediatek.hardware.camera.vpuclient@2.0-impl
...
#endif # ifneq ($(MTK_CAM_MMSDK_SUPPORT), yes) end
