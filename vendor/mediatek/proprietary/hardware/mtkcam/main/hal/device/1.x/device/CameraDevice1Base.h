...
protected:  ////
    ...
    sp<android::IParamsManagerV3>            mpParamsMgrV3;
    ...
    CpuCtrl*                                 mpCpuCtrl;
    CpuCtrl*                                 mpPreferIdleCpuCtrl;
    sp<NSCam::IPlugProcessing>               mpPlugProcess;
    //
    MBOOL                                    mbCheckThread = MFALSE;
    std::future<NSCam::MERROR>               mFuture;
    ////
...
protected:
    ...
    virtual void       startPreviewImp();
    void               setDeviceCallback(const sp<ICameraDeviceCallback>& callback);
    MBOOL              runCheckThread(){ return mbCheckThread;}
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     */
    virtual status_t                onSetParameters(const char* /*params*/) {return android::OK;}
...
private:
    ...
    struct CameraMemory : public camera_memory_t {
        MemoryId mId;
        sp<CameraDevice1Base> mDevice = nullptr;
    };
