...
public:
  ...
  MBOOL backup(MINT32 const i4SensorDev);
   ...
   MBOOL CallBackAwb(MINT32 i4SensorDev, MVOID* pIn, MVOID* pOut);
    MBOOL getAWBCalibrationStatus(MINT32 i4SensorDev, calibration_status_t& i8AwbStatus);
    MBOOL getAWBSourceRGB(MINT32 i4SensorDev, MUINT16& u2AwbSource1R, MUINT16& u2AwbSource1Gr, MUINT16& u2AwbSource1Gb, MUINT16& u2AwbSource1B);
    MBOOL getAWBSourceGoldenRGB(MINT32 i4SensorDev, MUINT16& u2AwbSource1GoldenR, MUINT16& u2AwbSource1GoldenGr, MUINT16& u2AwbSource1GoldenGb, MUINT16& u2AwbSource1GoldenB);
    MBOOL getAWBSourceRatio(MINT32 i4SensorDev, MFLOAT& fAwbSource1RG, MFLOAT& fAwbSource1BG, MFLOAT& fAwbSource1GRGB);
