...
prepare_Frameless_Shading()
{
    ...
    CAM_LOGD("[%s] mode %d, profile %d", __FUNCTION__, getOperMode(), m_rIspCamInfo.rMapping_Info.eIspProfile);


    //m_pLscMgr->setOnOff(MTRUE);
    //m_pLscMgr->setSensorMode(m_rIspCamInfo.eSensorMode, EOperMode_Meta == getOperMode());
