...
{
public:
    static GmaMgr* createInstance(ESensorDev_T const eSensorDev, ISP_NVRAM_TONEMAP_PARAM_T* pIspNvramGmaPara);
...
private:
    ...
    ISP_NVRAM_TONEMAP_PARAM_T* m_pIspNvramGmaPara;
    MTKGma* m_pGmaAlgo;
    ...
    MTK_GMA_DUALCAM_SYNC_INFO_T mGMASyncInfo;
    AE_INFO_T mAEInfo;
    MBOOL mbAEStable;
    MINT32 mLogEn;
    MINT32 mAlgoEn;
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:     ////
    GmaMgr(ESensorDev_T const eSensorDev, ISP_NVRAM_TONEMAP_PARAM_T* pIspNvramGmaPara);
