...
public:
        ...
        , m_u4StartAddr(REG_ADDR_P1(CAM_AFO_XSIZE))
    {
        ...
        INIT_REG_INFO_ADDR_P1(CAM_PDO_XSIZE);
        INIT_REG_INFO_ADDR_P1(CAM_PDO_YSIZE);
        INIT_REG_INFO_ADDR_P1(CAM_PDO_STRIDE);
        INIT_REG_INFO_ADDR_P1(CAM_PBN_TYPE);
        INIT_REG_INFO_ADDR_P1(CAM_PBN_LST);

        INIT_REG_INFO_ADDR_P1(CAM_PDE_TBLI1);
        INIT_REG_INFO_ADDR_P1(CAM_PDE_CTL);
        INIT_REG_INFO_ADDR_P1(CAM_PDI_BASE_ADDR);
        INIT_REG_INFO_ADDR_P1(CAM_PDI_XSIZE);
        INIT_REG_INFO_ADDR_P1(CAM_PDI_YSIZE);
