...
{
public:
    static LceMgr* createInstance(ESensorDev_T const eSensorDev, ISP_NVRAM_TONEMAP_PARAM_T* pIspNvramTonePara);
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:     ////
    LceMgr(ESensorDev_T const eSensorDev, ISP_NVRAM_TONEMAP_PARAM_T* pIspNvramTonePara);
...
public:
    ...
    MVOID getLCE_Gain_EXIF(MUINT8 &rLVH, MUINT8 &rDRH)
    {
        rLVH = mOutExif.i4LVIdx_H;
        rDRH = mOutExif.i4DRIdx_H;
    }
