...
#define MY_INST NS3Av3::INST_T<ISP_MGR_DCES_T>
...
{
    ISP_MGR_MODULE_GET_INSTANCE(DCES);
}
...
apply_P2(MUINT8 SubModuleIndex, const RAWIspCamInfo& rRawIspCamInfo, dip_x_reg_t* pReg)
{
    ...
    {
        case EDCES_D1:
            ISP_WRITE_ENABLE_BITS(pReg, DIPCTL_D1A_DIPCTL_YUV_EN1, DIPCTL_DCES_D1_EN, bEnable);
            break;
        default:
