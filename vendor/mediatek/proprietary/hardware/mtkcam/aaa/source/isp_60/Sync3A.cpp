...
syncAwbMain(const StatisticBufInfo* pMasterSttBuf, const StatisticBufInfo* pSlaveSttBuf)
{
    ...
    pResultPoolMaster = IResultPool::getInstance(i4Master);
    ...
    pResultPoolSlave = IResultPool::getInstance(i4Slave);
...
syncCCUAeSetting(MINT32 i4MasterIdx, MINT32 i4SlaveIdx, MINT32 i4MasterDev, MINT32 i4SlaveDev)
{
    if (m_pCcuCtrl3ASync && m_pCcuCtrl3ASync->isSupport3ASync())
    {
        ...
        CAM_LOGD("[%s] CCU_SYNC_DBG MSG_TO_CCU_SYNC_AE_SETTING", __FUNCTION__);
    ...
    if (!(i4Param & E_SYNC3A_DO_SW_SYNC))
    {
                ...
                (i4Sensor == m_i4Master && bIsHwSync) )
        {
            ...
            if (bIsHwSync && (m_i4AeSchedule == 1)) // AE calculation frame
            {
                ...
                IAeMgr::getInstance().getAEInfo(m_i4Master, AEPerframeInfoMain);
                IAeMgr::getInstance().getAEInfo(m_i4Slave, AEPerframeInfoMain2);
                AAASensorMgr::getInstance().updateStereoFrameSyncFps(m_i4Master, m_i4Slave, AEPerframeInfoMain.rAEISPInfo.u8P1Exposuretime_ns / 1000, AEPerframeInfoMain2.rAEISPInfo.u8P1Exposuretime_ns / 1000);
            }
        }
        if (i4Sensor == m_i4Master)
        {
