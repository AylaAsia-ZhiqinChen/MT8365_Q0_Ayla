...
////////////////////////////////////////////////////////////////////////////////
// cct_imgtool.cpp  $Revision$
////////////////////////////////////////////////////////////////////////////////

//! \file  cct_imgtool.cpp
//! \brief
#define LOG_TAG "cctsvr_imgtool"
...
//!
/////////////////////////////////////////////////////////////////////////
VOID CctImgTool::vUnPackRawImg(MUINT8 *a_pPackedImgBuf, MUINT8 *a_pUnPackedImgBuf,  MUINT32 a_u4ImgSize, MUINT32 a_u4Width, MUINT32 a_u4Height, MUINT8 a_bitdepth)
{
    ...
    if( (width * height * bitdepth)/8 != a_u4ImgSize ){
        stride = a_u4ImgSize / height;
        ACDK_LOGD("Derive Packed Raw Stride=%d. Packed Size=%d. Tight Packed Size=%d, (w=%d, h=%d, b=%d)", stride, a_u4ImgSize, ((width * height * bitdepth)/8), width, height, bitdepth);
    }
    else if(bitdepth == 10) {
...
//!
/////////////////////////////////////////////////////////////////////////
MRESULT CctImgTool::mrAnalyzeRAWInfo(MUINT8 *a_pUnPackedImgBuf,
                                                                          UINT32 a_u4ImgWidth,
...
//
/////////////////////////////////////////////////////////////////////////
MRESULT CctImgTool::mrAnalyzeRAWImage(MUINT8 *a_pUnPackedImgBuf,
                                      UINT32 a_u4ImgWidth,
                                      UINT32 a_u4ImgHeight,
                                      eRAW_ColorOrder a_eColorOrder,
                                      const ROIRect &a_strROI,
                                      ACDK_CDVT_RAW_ANALYSIS_RESULT_T &a_rRAWAnalysisResult)
{
    ...
    ACDK_LOGD(" CctImgTool::mrAnalyzeRAWImage() \n");
...
//!
/////////////////////////////////////////////////////////////////////////
MRESULT CctImgTool::mrAnalyzeYInfo(MUINT8 *a_puImgBuf, UINT32 a_u4ImgWidth, UINT32 a_u4ImgHeight, const ROIRect &a_strROI, UINT32 &a_pu4Avg, UINT32 &a_pu4Std)
{
    UINT64 u8Sum = 0;
...
//!
/////////////////////////////////////////////////////////////////////////
MRESULT CctImgTool::mrCalcMedian(MUINT8 *a_pUnPackedImgBuf,
                                                                UINT32 a_u4ImgWidth,
                                                                UINT32 a_u4ImgHeight,
                                                                eRAW_ColorOrder a_eColorOrder,
                                                                const ROIRect &a_strROI,
...
//!
/////////////////////////////////////////////////////////////////////////
VOID CctImgTool::vExtractPackedRawROI(MUINT8 *a_pSrcPackedImgBuf, MUINT8 *a_pDestPackedImgBuf, UINT32 a_u4ImgWidth, UINT32 a_u4ImgHeight, UINT32 a_u4SrcBytesPerLine, UINT32 a_u4DestBytesPerLine, const ROIRect &a_strROI)
{
...
//!
/////////////////////////////////////////////////////////////////////////
VOID CctImgTool::vExtractUnPackedRawROI(MUINT8 *a_pSrcUnPackedImgBuf, MUINT8 *a_pDestUnPackedImgBuf, UINT32 a_u4ImgWidth, UINT32 a_u4ImgHeight, const ROIRect &a_strROI)
{
