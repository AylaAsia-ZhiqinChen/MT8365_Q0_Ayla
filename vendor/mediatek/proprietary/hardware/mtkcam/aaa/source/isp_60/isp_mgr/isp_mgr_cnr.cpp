 ...
 * NEITHER DOES MEDIATEK PROVIDE ANY WARRANTY WHATSOEVER WITH RESPECCR TO THE
 ...
 * CUMULATIVE LIABILITY WITH RESPECCR TO THE MEDIATEK SOFTWARE RELEASED HEREUNDER WILL BE,
 ...
 *     WHATSOEVER WITH RESPECCR TO THE SOFTWARE OF ANY THIRD PARTY WHICH MAY BE USED BY,
 ...
 *     RESPECCR TO THE MEDIATEK SOFTWARE RELEASED HEREUNDER WILL BE, AT MEDIATEK'S OPTION,
TO REVISE OR REPLACE THE MEDIATEK SOFTWARE AT ISSUE, OR REFUND ANY SOFTWARE LICENSE
 *     FEES OR SERVICE CHARGE PAID BY BUYER TO MEDIATEK FOR SUCH MEDIATEK SOFTWARE AT ISSUE.
 *
 *     THE TRANSACCRION CONTEMPLATED HEREUNDER SHALL BE CONSTRUED IN ACCORDANCE WITH THE LAWS
 *     OF THE STATE OF CALIFORNIA, USA, EXCLUDING ITS CONFLICCR OF LAWS PRINCIPLES.
 ************************************************************************************************/
...
#define MY_INST NS3Av3::INST_T<ISP_MGR_CNR_T>
...
put(MUINT8 SubModuleIndex, ISP_NVRAM_CNR_CNR_T const& rParam)
{
    ...
    //PUT_REG_INFO_MULTI(SubModuleIndex, CNR_RSV1,           rsv1);
    //PUT_REG_INFO_MULTI(SubModuleIndex, CNR_RSV2,           rsv2);
...
get(MUINT8 SubModuleIndex, ISP_NVRAM_CNR_CNR_T& rParam)
{
    ...
    //GET_REG_INFO_MULTI(SubModuleIndex, CNR_RSV1,           rsv1);
    //GET_REG_INFO_MULTI(SubModuleIndex, CNR_RSV2,           rsv2);
...
put(MUINT8 SubModuleIndex, ISP_NVRAM_CNR_ABF_T const& rParam)
{
    ...
    //PUT_REG_INFO_MULTI(SubModuleIndex, ABF_RSV1,            rsv1);
...
get(MUINT8 SubModuleIndex, ISP_NVRAM_CNR_ABF_T& rParam)
{
    ...
    //GET_REG_INFO_MULTI(SubModuleIndex, ABF_RSV1,            rsv1);
...
ISP_MGR_CNR_T&
ISP_MGR_CNR_T::
put(MUINT8 SubModuleIndex, ISP_NVRAM_CNR_BOK_T const& rParam)
{
    PUT_REG_INFO_MULTI(SubModuleIndex, BOK_TUN,             tun);
...
ISP_MGR_CNR_T&
ISP_MGR_CNR_T::
get(MUINT8 SubModuleIndex, ISP_NVRAM_CNR_BOK_T& rParam)
{
    GET_REG_INFO_MULTI(SubModuleIndex, BOK_TUN,             tun);
