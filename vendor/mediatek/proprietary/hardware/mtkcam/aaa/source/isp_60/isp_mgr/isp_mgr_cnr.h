...
private:
    ...
    enum
    {
        ...
        //ERegInfo_ABF_RSV1,
        // BOK
        //ERegInfo_BOK_TUN,  //BOK should be from N3D Flow
        ERegInfo_NUM
    };
...
public:
    ISP_MGR_CNR(MUINT32 const eSensorDev)
        ...
        ,m_bCCTABFEnable(MTRUE)
    {
        ...
        //INIT_CNR_ADDR(CNR_RSV1);
        //INIT_CNR_ADDR(CNR_RSV2);
        ...
        //INIT_CNR_ADDR(ABF_RSV1);
        // BOK
        //INIT_CNR_ADDR(BOK_TUN);
