...
#define MY_INST NS3Av3::INST_T<ISP_MGR_MOBC_T>
...
#if 0
template<>
ISP_MGR_MOBC_DEV<ESensorDev_Main> ISP_MGR_MOBC_DEV<ESensorDev_Main>::singleton;

template<>
ISP_MGR_MOBC_DEV<ESensorDev_MainSecond> ISP_MGR_MOBC_DEV<ESensorDev_MainSecond>::singleton;

template<>
ISP_MGR_MOBC_DEV<ESensorDev_MainThird> ISP_MGR_MOBC_DEV<ESensorDev_MainThird>::singleton;

template<>
ISP_MGR_MOBC_DEV<ESensorDev_Sub> ISP_MGR_MOBC_DEV<ESensorDev_Sub>::singleton;

template<>
ISP_MGR_MOBC_DEV<ESensorDev_SubSecond> ISP_MGR_MOBC_DEV<ESensorDev_SubSecond>::singleton;


template <MUINT32 const eSensorDev>
ISP_MGR_MOBC_DEV<eSensorDev> ISP_MGR_MOBC_DEV<eSensorDev>::singleton;
#endif
...
{
    PUT_REG_INFO_MULTI(SubModuleIndex, OFFST0,               offset_r);
    PUT_REG_INFO_MULTI(SubModuleIndex, OFFST1,              offset_gr);
    PUT_REG_INFO_MULTI(SubModuleIndex, OFFST2,              offset_gb);
    PUT_REG_INFO_MULTI(SubModuleIndex, OFFST3,               offset_b);
...
{
    GET_REG_INFO_MULTI(SubModuleIndex, OFFST0,               offset_r);
    GET_REG_INFO_MULTI(SubModuleIndex, OFFST1,              offset_gr);
    GET_REG_INFO_MULTI(SubModuleIndex, OFFST2,              offset_gb);
    GET_REG_INFO_MULTI(SubModuleIndex, OFFST3,               offset_b);
