...
#ifndef _MTK_PLATFORM_HARDWARE_MTKCAM_AAA_FAKEDRV_CAMSVSTATPIPE_H_
#define _MTK_PLATFORM_HARDWARE_MTKCAM_AAA_FAKEDRV_CAMSVSTATPIPE_H_
...
// CamsvStatisticPipe Member Function
public:
...
public:
    ...
    mutable Mutex               mThreadIdleLock;

    static Mutex                SPipeGLock; // StatisticPipe Global Lock
    static CamsvStatisticPipe*       pCamsvStatisticPipe[MAX_SENSOR_CNT];
