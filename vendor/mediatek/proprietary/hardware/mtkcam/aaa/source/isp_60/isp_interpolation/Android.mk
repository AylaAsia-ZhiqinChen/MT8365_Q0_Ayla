...
LOCAL_C_INCLUDES += \
	...
	$(TOP)/$(MTK_PATH_SOURCE)/hardware/libcamera_ext/lib/libutility/utilSystem \
    $(TOP)/$(MTK_PATH_SOURCE)/hardware/libcamera_3a/libawb_core_lib/$(TARGET_BOARD_PLATFORM)/include \

LOCAL_C_INCLUDES += \
    $(MTK_PATH_SOURCE)/hardware/libcamera_3a/libflash_lib/$(TARGET_BOARD_PLATFORM)/include \
  	$(TOP)/$(MTK_PATH_SOURCE)/hardware/libcamera_ext/lib/libutility/utilSystem \
    $(MTK_PATH_SOURCE)/hardware/mtkcam/include/mtkcam/def \
    $(MTK_PATH_COMMON)/hal/inc/custom/aaa  \
...
LOCAL_SHARED_LIBRARIES := \
    libcutils \
    liblog
LOCAL_SHARED_LIBRARIES += libcamalgo.utility libcamalgo.ispfeature
#For AE
