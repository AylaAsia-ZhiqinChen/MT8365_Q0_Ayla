...
{
public:
    static LceMgr* createInstance(MUINT32 const eSensorDev, ISP_NVRAM_TONEMAP_PARAM_T* pIspNvramTonePara);
...
private:
    ...
    MTK_LCE_DUALCAM_SYNC_INFO_T mLCESyncInfo;
    ISP_NVRAM_TONEMAP_PARAM_T* m_pIspNvramTonePara;
    AE_ISP_INFO_T mLast_AEInfo;
    MINT32 mLogEn;
    MINT32 mAlgoEn;
    MUINT16 m_PrvIdx;
    MUINT16 m_PrvGGMIdx;
    MINT32 mLast_DRINDEX_L;
    MINT32 mLast_DRINDEX_H;
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:     ////
    LceMgr(MUINT32 const eSensorDev, ISP_NVRAM_TONEMAP_PARAM_T* pIspNvramTonePara);
...
public:
    ...
    MVOID getLastDCE_IDX_Info(MINT32& rDRINDEX_L, MINT32& rDRINDEX_H){
        rDRINDEX_L = mLast_DRINDEX_L;
        rDRINDEX_H = mLast_DRINDEX_H;
    };
