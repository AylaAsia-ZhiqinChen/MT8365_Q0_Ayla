...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  MOBC (simplication of OBC) for RawC
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

#define INIT_MOBC_ADDR(reg)\
    INIT_REG_INFO_ADDR_P1_MULTI(EMOBC_R2 ,reg, MOBC_R2_MOBC_)
//INIT_REG_INFO_ADDR_P1_MULTI(EMOBC_R3 ,reg, MOBC_R3_MOBC_)
...
public:
    enum
    {
        EMOBC_R2, //Normal //Raw C only
        //EMOBC_R3, //for HDR Fus //Raw C only
        ESubModule_NUM
    };
private:
    MBOOL m_bEnable[ESubModule_NUM];
    MBOOL m_bCCTEnable; //only support R2
...
public:
    ISP_MGR_MOBC(MUINT32 const eSensorDev)
