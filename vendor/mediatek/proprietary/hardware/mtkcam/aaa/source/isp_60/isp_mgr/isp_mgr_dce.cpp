...
#define MY_INST NS3Av3::INST_T<ISP_MGR_DCE_T>
static std::array<MY_INST, SENSOR_IDX_MAX> gMultiton;

#if defined(HAVE_AEE_FEATURE)
#include <aee.h>
#define AEE_ASSERT_DCE(String) \
          do { \
...
put(MUINT8 SubModuleIndex, ISP_NVRAM_DCE_T const& rParam)
{
    ...
    //PUT_REG_INFO_MULTI(SubModuleIndex, V_Y_CH_0,    v_y_ch_0);
    //PUT_REG_INFO_MULTI(SubModuleIndex, V_Y_CH_1,    v_y_ch_1);
    //PUT_REG_INFO_MULTI(SubModuleIndex, DCE_CONF,    dce_conf);
...
get(MUINT8 SubModuleIndex, ISP_NVRAM_DCE_T & rParam)
{
    ...
    //GET_REG_INFO_MULTI(SubModuleIndex, V_Y_CH_0,    v_y_ch_0);
    //GET_REG_INFO_MULTI(SubModuleIndex, V_Y_CH_1,    v_y_ch_1);
    //GET_REG_INFO_MULTI(SubModuleIndex, DCE_CONF,    dce_conf);
