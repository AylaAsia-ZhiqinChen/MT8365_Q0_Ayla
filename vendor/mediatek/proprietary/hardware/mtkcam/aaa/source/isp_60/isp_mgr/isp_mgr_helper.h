...
//YNR
BIND_ISP_TYPES(ISP_NVRAM_YNRS_T,    ISP_MGR_YNRS_T);
BIND_ISP_TYPES(ISP_NVRAM_YNRS_LUT_T,ISP_MGR_YNRS_T);
...
MVOID
getIspHWArray(MUINT32 const eSensorDev, ISP_XXX_T& rParam)
{
...
template <class ISP_XXX_T>
MVOID
putIspHWArray(MUINT32 const eSensorDev, ISP_XXX_T const& rParam)
{
    typedef typename ISPType2Type<ISP_XXX_T>::type ISP_MGR_T;
