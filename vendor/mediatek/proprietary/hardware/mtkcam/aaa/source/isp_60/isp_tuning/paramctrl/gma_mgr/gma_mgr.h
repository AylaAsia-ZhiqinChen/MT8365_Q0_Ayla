...
{
public:
    static GmaMgr* createInstance(MUINT32 const eSensorDev, ISP_NVRAM_GMA_STRUCT_T* pIspNvramGmaPara);
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:     ////
    GmaMgr(MUINT32 const eSensorDev, ISP_NVRAM_GMA_STRUCT_T* pIspNvramGmaPara);
