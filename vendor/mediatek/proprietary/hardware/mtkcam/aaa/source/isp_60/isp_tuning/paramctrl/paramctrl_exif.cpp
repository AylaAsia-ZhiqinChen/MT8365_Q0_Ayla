...
getDebugInfoP1(NSIspExifDebug::IspExifDebugInfo_T& rDebugInfo, MBOOL const /*fgReadFromHW*/) const
{
    ...
    setIspIdx(rTags, M_P1_TargetSize,      m_rIspCamInfo.rMapping_Info.eSize);
    ...
    setIspIdx(rTags, M_P1_Custom_00,       m_rIspCamInfo.rMapping_Info.eCustom_00);
    setIspIdx(rTags, M_P1_Custom_01,       m_rIspCamInfo.rMapping_Info.eCustom_01);
    ...
    setIspIdx(rTags, UPPER_LV_IDX_P1,    m_rIspCamInfo.eIdx_LV_U);
    setIspIdx(rTags, LOWER_LV_IDX_P1,    m_rIspCamInfo.eIdx_LV_L);
    ...
    setIspIdx(rTags, SensorTG, m_eSensorTG);
    setIspIdx(rTags, P1_Path, m_ERawPath);

    //Size Info
    setIspIdx(rTags, TG_Size_W_P1YUV,       m_rIspCamInfo.rCropRzInfo.sTGout.w);
    setIspIdx(rTags, TG_Size_H_P1YUV,       m_rIspCamInfo.rCropRzInfo.sTGout.h);
    setIspIdx(rTags, FBinOnOff_P1YUV,       m_rIspCamInfo.rCropRzInfo.fgFBinOnOff);
    setIspIdx(rTags, RRZ_In_Size_W_P1YUV,   m_rIspCamInfo.rCropRzInfo.sRRZin.w);
    setIspIdx(rTags, RRZ_In_Size_H_P1YUV,   m_rIspCamInfo.rCropRzInfo.sRRZin.h);

    //AE Info
    setIspIdx(rTags, AE_INFO_EXP_TIME_P1, m_rIspCamInfo.rAEInfo.u8P1Exposuretime_ns/1000);
    setIspIdx(rTags, AE_INFO_SEN_GAIN_P1, m_rIspCamInfo.rAEInfo.u4P1SensorGain);
    setIspIdx(rTags, AE_INFO_ISP_GAIN_P1, m_rIspCamInfo.rAEInfo.u4P1DGNGain);
    setIspIdx(rTags, AE_INFO_REAL_ISO_P1, m_rIspCamInfo.rAEInfo.u4P1RealISOValue);
    setIspIdx(rTags, AE_INFO_GAIN_x100_P1, m_rIspCamInfo.rAEInfo.u4P1Gain_x100);
    ...
    setIspIdx(rTags, AWB_INFO_WB_GAIN_R_P1,      m_rIspCamInfo.rAWBInfo.rRPG.i4R);
    setIspIdx(rTags, AWB_INFO_WB_GAIN_G_P1,      m_rIspCamInfo.rAWBInfo.rRPG.i4G);
    setIspIdx(rTags, AWB_INFO_WB_GAIN_B_P1,      m_rIspCamInfo.rAWBInfo.rRPG.i4B);
    ...
    // YNRS
    setIspIdx(rTags, IDX_YNRS_LOWER_P1, m_rIdxCache.getCacheValue(EModule_YNRS, IDXCACHE_STAGE_P1, IDXCACHE_VALTYPE_LOWERISO));
    setIspIdx(rTags, IDX_YNRS_UPPER_P1, m_rIdxCache.getCacheValue(EModule_YNRS, IDXCACHE_STAGE_P1, IDXCACHE_VALTYPE_UPPERISO));
    // YNRS_TBL
    setIspIdx(rTags, IDX_YNRS_TBL_LOWER_P1, m_rIdxCache.getCacheValue(EModule_YNR_TBL, IDXCACHE_STAGE_P1, IDXCACHE_VALTYPE_LOWERISO));
    setIspIdx(rTags, IDX_YNRS_TBL_UPPER_P1, m_rIdxCache.getCacheValue(EModule_YNR_TBL, IDXCACHE_STAGE_P1, IDXCACHE_VALTYPE_UPPERISO));
...
getDebugInfoP2(const NSIspTuning::ISP_INFO_T& rIspInfo, NSIspExifDebug::IspExifDebugInfo_T& rDebugInfo, const void* pRegBuf, const void* pMfbBuf ) const
{
    ...
    else
    {
        if (u4RegCnt_start != P2_START_ADDR_COUNT)
                CAM_LOGD_IF(m_bDebugEnable,"[%s()] u4RegCnt_start(%d), P2_START_ADDR_COUNT(%d)",
...
MERROR_ENUM
Paramctrl::
setHLRDebugInfo4CCU(MBOOL Enable, ISP_NVRAM_HLR_T const HLR, NSIspExifDebug::IspExifDebugInfo_T& rDbgIspInfo)
{
    rDbgIspInfo.debugInfo.tags[CCU_HLR_Enable].u4Val = Enable;
...
MERROR_ENUM
Paramctrl::
setLTMnLTMSDebugInfo4CCU(MBOOL Enable, ISP_NVRAM_LTM_T const LTM_R1, ISP_NVRAM_LTM_T const LTM_R2, ISP_NVRAM_LTMS_T const LTMS, NSIspExifDebug::IspExifDebugInfo_T& rDbgIspInfo)
{
    rDbgIspInfo.debugInfo.tags[CCU_LTM_Enable].u4Val = Enable;
