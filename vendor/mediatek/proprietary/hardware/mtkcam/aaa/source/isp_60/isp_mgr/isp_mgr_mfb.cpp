...
put(MUINT8 SubModuleIndex, ISP_NVRAM_MFB_T const& rParam)
{
    ...
    //PUT_REG_INFO_MULTI(SubModuleIndex, LL_CON2,             ll_con2);
    //PUT_REG_INFO_MULTI(SubModuleIndex, LL_CON3,             ll_con3);
    //PUT_REG_INFO_MULTI(SubModuleIndex, LL_CON4,             ll_con4);
    //PUT_REG_INFO_MULTI(SubModuleIndex, EDGE,                edge);
    //PUT_REG_INFO_MULTI(SubModuleIndex, LL_CON5,             ll_con5);
    //PUT_REG_INFO_MULTI(SubModuleIndex, LL_CON6,             ll_con6);
    //PUT_REG_INFO_MULTI(SubModuleIndex, LL_CON7,             ll_con7);
    //PUT_REG_INFO_MULTI(SubModuleIndex, LL_CON8,             ll_con8);
    //PUT_REG_INFO_MULTI(SubModuleIndex, LL_CON9,             ll_con9);
...
get(MUINT8 SubModuleIndex, ISP_NVRAM_MFB_T & rParam)
{
    ...
    //GET_REG_INFO_MULTI(SubModuleIndex, LL_CON2,             ll_con2);
    //GET_REG_INFO_MULTI(SubModuleIndex, LL_CON3,             ll_con3);
    //GET_REG_INFO_MULTI(SubModuleIndex, LL_CON4,             ll_con4);
    //GET_REG_INFO_MULTI(SubModuleIndex, EDGE,                edge);
    //GET_REG_INFO_MULTI(SubModuleIndex, LL_CON5,             ll_con5);
    //GET_REG_INFO_MULTI(SubModuleIndex, LL_CON6,             ll_con6);
    //GET_REG_INFO_MULTI(SubModuleIndex, LL_CON7,             ll_con7);
    //GET_REG_INFO_MULTI(SubModuleIndex, LL_CON8,             ll_con8);
    //GET_REG_INFO_MULTI(SubModuleIndex, LL_CON9,             ll_con9);
