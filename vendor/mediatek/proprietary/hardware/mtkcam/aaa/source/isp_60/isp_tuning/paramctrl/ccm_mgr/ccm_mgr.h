...
{
public:
    static CcmMgr* createInstance(MUINT32 const eSensorDev, ISP_NVRAM_COLOR_TABLE_STRUCT& rNewColor, IspTuningCustom* pIspTuningCustom);
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:     ////
    CcmMgr(MUINT32 const eSensorDev, ISP_NVRAM_COLOR_TABLE_STRUCT &rNewColor, IspTuningCustom* pIspTuningCustom)
