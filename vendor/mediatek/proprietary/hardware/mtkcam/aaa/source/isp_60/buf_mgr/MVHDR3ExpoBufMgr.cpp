    ...
    , m_bAbort(MFALSE)
{
    ...
    m_pCamsvSttPipeAEY = ICamsvStatisticPipe::createInstance(m_i4SensorIdx, LOG_TAG, VC_3HDR_Y);
    m_pCamsvSttPipeAEHist = ICamsvStatisticPipe::createInstance(m_i4SensorIdx, LOG_TAG, VC_3HDR_AE);
    m_pCamsvSttPipeAEEmbData = ICamsvStatisticPipe::createInstance(m_i4SensorIdx, LOG_TAG, VC_3HDR_EMBEDDED);
}
