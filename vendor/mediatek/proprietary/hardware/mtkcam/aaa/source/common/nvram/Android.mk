...
$(info Yang MTKCAM_AAA_PLATFORM = $(MTKCAM_AAA_PLATFORM))

#ifeq ($(MTKCAM_AAA_PLATFORM), isp_50, isp_60)
ifneq (,$(filter $(strip $(MTKCAM_AAA_PLATFORM)), isp_50 isp_60 isp_6s))

LOCAL_SRC_FILES += nvbuf_util.cpp
LOCAL_SRC_FILES += nvram_drv.cpp

$(info Yang1 MTKCAM_AAA_PLATFORM = $(MTKCAM_AAA_PLATFORM))
$(info TARGET_BOARD_PLATFORM = $(TARGET_BOARD_PLATFORM))

#ifeq ($(strip $(TARGET_BOARD_PLATFORM)),mt6775)
#ifeq ( 1, 1 )
#LOCAL_SRC_FILES += ../../isp_50/nvram/nvram_drv_dep.cpp
#LOCAL_SRC_FILES += ../../isp_50/nvram/nvbuf_util_dep.cpp

#else
$(info Yang2 MTKCAM_AAA_PLATFORM = $(MTKCAM_AAA_PLATFORM))
ifeq ($(strip $(MTK_CAM_SW_VERSION)),ver2)
LOCAL_SRC_FILES += ../../$(MTKCAM_AAA_PLATFORM)p/nvram/nvram_drv_dep.cpp
else
LOCAL_SRC_FILES += ../../$(MTKCAM_AAA_PLATFORM)/nvram/nvram_drv_dep.cpp
endif

ifeq ($(strip $(MTK_CAM_SW_VERSION)),ver2)
LOCAL_SRC_FILES += ../../$(MTKCAM_AAA_PLATFORM)p/nvram/nvbuf_util_dep.cpp
else
LOCAL_SRC_FILES += ../../$(MTKCAM_AAA_PLATFORM)/nvram/nvbuf_util_dep.cpp
endif
...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/include
#ifeq ($(strip $(TARGET_BOARD_PLATFORM)),mt6775)
#LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/aaa/source/isp_50/nvram/
#else
ifeq ($(strip $(MTK_CAM_SW_VERSION)),ver2)
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/aaa/source/$(MTKCAM_AAA_PLATFORM)p/nvram/
else
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/aaa/source/$(MTKCAM_AAA_PLATFORM)/nvram/
endif
#endif
...
LOCAL_CFLAGS += -DNVRAM_MODULE_IMP=1
LOCAL_CFLAGS += -DNVRAM_MODULE_EN=1
...
#-----------------------------------------------------------
LOCAL_MODULE := libcam.hal3a.v3.nvram.50
