...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MCUDrv* MCUDrv::getInstance(MINT32 const eSensorDev)
{
    switch (eSensorDev)
    {
    case NSIspTuning::ESensorDev_Main: //  Main Sensor
        return  MCUDrvDev<NSIspTuning::ESensorDev_Main>::getInstance();
    case NSIspTuning::ESensorDev_MainSecond: //  Main Second Sensor
        return  MCUDrvDev<NSIspTuning::ESensorDev_MainSecond>::getInstance();
    case NSIspTuning::ESensorDev_MainThird: //  Main Third Sensor
        return  MCUDrvDev<NSIspTuning::ESensorDev_MainThird>::getInstance();
    case NSIspTuning::ESensorDev_Sub: //  Sub Sensor
        return  MCUDrvDev<NSIspTuning::ESensorDev_Sub>::getInstance();
    case NSIspTuning::ESensorDev_SubSecond: //  Sub Second Sensor
        return  MCUDrvDev<NSIspTuning::ESensorDev_SubSecond>::getInstance();
    default:
