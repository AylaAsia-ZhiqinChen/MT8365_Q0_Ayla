...
MBOOL HAL3A_POLICY_MAIN_FLASH_ONOFF(MINT32 i4SensorDev __unused, Param_T const &rParam, FlashPolicy_T const &rFlashPolicy){
...
MBOOL HAL3A_POLICY_LAMP_FLASH_ONOFF(MINT32 i4SensorDev __unused, Param_T const &rParam, FlashPolicy_T const &rFlashPolicy){
    MBOOL bResult = MFALSE;
...
MBOOL HAL3A_POLICY_TORCH_ONOFF(MINT32 i4SensorDev __unused, Param_T const &rParam, FlashPolicy_T const &rFlashPolicy){
    MBOOL bResult = MFALSE;

    bResult = (((rParam.u4AeMode == MTK_CONTROL_AE_MODE_OFF)||(rParam.u4AeMode == MTK_CONTROL_AE_MODE_ON))
