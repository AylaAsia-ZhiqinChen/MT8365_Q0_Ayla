...
//drv
extern unsigned long const g_u4NvramDataSize[CAMERA_DATA_TYPE_NUM];

#define MAX_FILE_PATH_LEN 100
#define MAX_FILE_PRE_PATH_LEN 64

extern char gCreateDir[MAX_FILE_PATH_LEN];
extern char gFilePath[CAMERA_DATA_TYPE_NUM][MAX_FILE_PRE_PATH_LEN];
