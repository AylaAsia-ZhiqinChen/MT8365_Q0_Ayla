...
public:
    Entry();
    Entry(const std::string strUserName, const E_PARTIAL_RESULT_OF_MODULE_T ModuleEnum);
    virtual ~Entry();
...
public:
     ...
     */
    virtual MVOID        write(const MVOID* pData);
     ...
     * @brief Free buffer
     */
    virtual MVOID        free(const E_PARTIAL_RESULT_OF_MODULE_T ModuleEnum);
