...
public:
    ...
    virtual MBOOL           setConfig(ILscTable::Config rCfg) = 0;
...
setConfig(ILscTable::Config rCfg)
{
    ...
    rBufCfg.i4ImgWd = rCfg.i4ImgWd;
    rBufCfg.i4ImgHt = rCfg.i4ImgHt;
    rBufCfg.i4BlkX  = rCfg.rCfgBlk.i4BlkX;
    rBufCfg.i4BlkY  = rCfg.rCfgBlk.i4BlkY;
    rBufCfg.i4BlkW  = rCfg.rCfgBlk.i4BlkW;
    rBufCfg.i4BlkH  = rCfg.rCfgBlk.i4BlkH;
    rBufCfg.i4BlkLastW = rCfg.rCfgBlk.i4BlkLastW;
    rBufCfg.i4BlkLastH = rCfg.rCfgBlk.i4BlkLastH;

    return setConfig(rBufCfg);
}
