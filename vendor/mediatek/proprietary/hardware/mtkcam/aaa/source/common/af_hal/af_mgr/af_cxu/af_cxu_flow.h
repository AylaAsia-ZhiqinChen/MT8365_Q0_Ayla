 ...
 */
#ifndef _IAfCxU_FLOW_H_
#define _IAfCxU_FLOW_H_
...
/////===== config =====/////.
// To convert AF_CONFIG_T to AFResultConfig_T, and AF_CONFIG_T could be also updated if HwConstraint exists.
MINT32 CxUFlow_AFConfig(AF_CONFIG_T *a_sAFConfig, AFRESULT_ISPREG_T *p_sAFResultConfig);
// To check if HwConstraint from AF_CONFIG_T exists and resetROI if it does.
