...
private:
    ...
    const char MCU_DRV_NAME[4][32] = {"/dev/MAINAF", "/dev/MAIN2AF", "/dev/SUBAF", "/dev/SUB2AF"};
...
public:
    static MCUDrv* getInstance(MINT32 const eSensorDev);
...
class MCUDrvDev : public MCUDrv
{
public:
    static MCUDrv* getInstance()
    {
        static MCUDrvDev<eSensorDev> singleton;
        return &singleton;
    }

    virtual MVOID destroyInstance() {}

    MCUDrvDev() : MCUDrv(eSensorDev) {}
