...
public:
     ...
     */
    virtual MINT32                  updateCapacity(const MUINT32& u4Capacity, const MINT32& i4SubsampleCount) = 0;
     ...
     */
    virtual RESULT_CFG_T            getResultCFG(const MINT32& i4ReqMagic) = 0;
     ...
     */
    virtual MVOID                   updateHistory(const MINT32& i4ReqMagic, const MINT32& Size) = 0;
     ...
     */
    virtual MBOOL                   updateResultCFG(const RESULT_CFG_T& rResultCfg) = 0;
     ...
     */
    virtual AllResult_T*            getAllResult(const MINT32& i4ReqMagic) = 0;
     ...
     * @param [out] return result which is all of 3A result. Or return NULL.
     */
    virtual AllResult_T*            getAllResultCur(const MINT32& i4SttMagic) = 0;

    /**
     * @brief get all of 3A result. Avoid getCur function getting fail.
     *  Use i4ReqMagic 0 to get.
     */
    virtual AllResult_T*            getAllResultLastCur(const MINT32& i4ReqMagic) = 0;
     ...
     * @param [out] return result which is all of 3A result. Or return NULL.
     */
    virtual AllResult_T*            getAllResultByPresetKey(MINT32 i4PreSetKey) = 0;
     ...
     */
    virtual MINT32                  updateAllResult(std::string strUserName, const MINT32& i4ReqMagic, const AllResult_T* pData) = 0;
     ...
     */
    virtual AllMetaResult_T*        getMetadata(const MINT32& i4ReqMagic) = 0;
     ...
     * @param [out] return false or true
     */
    virtual MINT32                  isValidate(const MINT32& i4ReqMagic, const E_PARTIAL_RESULT_OF_MODULE_T& eModule) = 0;
     ...
     * @param [out] return false or true
     */
    virtual MINT32                  isValidateCur(const MINT32& i4SttMagic, const E_PARTIAL_RESULT_OF_MODULE_T& eModule) = 0;
     ...
     * @param [out] return false or true;
     */
    virtual MBOOL                   updateEarlyCB(const MINT32& i4ReqMagic, const EARLY_CALL_BACK& rEarlyCB) = 0;
     ...
     */
    virtual EARLY_CALL_BACK*        getEarlyCB(const MINT32& i4ReqMagic) = 0;
     ...
     */
    virtual MVOID                   updateLastInfo(const LastInfo_T& vLastInfo) = 0;
     ...
     */
    virtual MBOOL                   overWriteToMetadata4CCUAndTG(const MINT32& i4ReqMagic) = 0;
