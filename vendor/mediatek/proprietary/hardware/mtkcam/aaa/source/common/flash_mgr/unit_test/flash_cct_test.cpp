...
void testCctNv()
{
	...
	createDir("/data/vendor/flash/flashdata");
//-----------------------------------------------
LogInfo("testCctNv line=%d",__LINE__);
	...
	if(e!=0) LogErr("testCctNv");
	writeNvram(defNv, "/data/vendor/flash/flashdata/flashNv1_def.bin");
	writeNvram(testNv, "/data/vendor/flash/flashdata/flashNv1_test.bin");
//-----------------------------------------------
LogInfo("testCctNv line=%d",__LINE__);
	*goldenNv = *defNv;
	...
	if(e!=0) LogErr("testCctNv");
	writeNvram(testNv, "/data/vendor/flash/flashdata/flashNv2.bin");
//-----------------------------------------------
LogInfo("testCctNv line=%d",__LINE__);
	*goldenNv = *defNv;
	...
	e = checkTwoMem(goldenNv, testNv, NvSz);
	if(e!=0) LogErr("testCctNv");
	writeNvram(goldenNv, "/data/vendor/flash/flashdata/flashNv3_golden.bin");
	writeNvram(testNv, "/data/vendor/flash/flashdata/flashNv3_test.bin");
//-----------------------------------------------
LogInfo("testCctNv line=%d",__LINE__);
	*goldenNv = *defNv;
	...
	e = pFl->cctSetNvdata(goldenNv, NvSz, 0, 0, &realSize);
	if(e!=0) LogErr("testCctNv");
	char s[]="/data/vendor/flash/flashdata/nvtest.bin";
	...
	e = checkTwoMem(goldenNv, testNv, NvSz);
	if(e!=0) LogErr("testCctNv");
	writeNvram(testNv, "/data/vendor/flash/flashdata/flashNv4.bin");
...
/*
	...
	e = pFl->cctWriteNvram(0, 0, 0, 0, &realSize);
	if(e!=0) LogErr("testCctNv");
	char s5[]="/data/vendor/flash/flashdata/flashNv5-w.bin";
	e = pFl->cctNvdataToFile(s5, 0, 0, 0, &realSize);
	if(e!=0) LogErr("testCctNv");
	*/
	writeNvram(goldenNv, "/data/vendor/flash/flashdata/flashNv5-golden.bin");
    NvramToAcdk(goldenNv, nv2);
    writeAcdkNvram(nv2, "/data/vendor/flash/flashdata/flashNv5-goldenAcdk.bin");
    unsigned char *pMem;
...
//writeNvram(testNv, "/data/vendor/flash/flashdata/flashNv5-1.bin");
	...
	writeAcdkNvram(nv3, "/data/vendor/flash/flashdata/flashNv5-test.bin");
	delete []nv2;
	delete []nv3;
