...
#define MY_INST NS3Av3::INST_T<DebugUtil>
...
{
   auto i4SensorIdx = NS3Av3::mapSensorDevToIdx(static_cast<MINT32>(i4SensorDevId));
    ...
    std::call_once(rSingleton.onceFlag, [&] {
        rSingleton.instance = std::make_unique<DebugUtil>(i4SensorDevId);
    } );
