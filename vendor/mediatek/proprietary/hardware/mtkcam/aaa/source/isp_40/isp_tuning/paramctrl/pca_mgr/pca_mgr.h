...
{
public:
    static PcaMgr* createInstance(ESensorDev_T const eSensorDev, ISP_NVRAM_COLOR_STRUCT& rIspColor);
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:     ////
    PcaMgr(ESensorDev_T const eSensorDev, ISP_NVRAM_COLOR_STRUCT& rIspColor)
        : m_u4ChangeCount(1)
        , m_u4Idx(0)
        , m_rIspPca     (rIspColor)
