...
createInstance(ESensorDev_T const eSensorDev, MINT32 i4SensorIdx)
{
    ...
    case ESensorDev_MainThird: //  Main Third Sensor
        static LscMgrDefault singleton_mainthird(ESensorDev_MainThird, i4SensorIdx);
        _pLscMain3 = &singleton_mainthird;
        LSC_LOG_END("ESensorDev_MainThird(%p), i4SensorIdx(%d)", _pLscMain3, i4SensorIdx);
        return _pLscMain3;
    }
}
