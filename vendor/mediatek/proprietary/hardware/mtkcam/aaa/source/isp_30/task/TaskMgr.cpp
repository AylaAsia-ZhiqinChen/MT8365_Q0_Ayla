    ...
    switch(eCmd)
    {
        ...
        case ECmd_PrecaptureStart:
            ...
            if (i4FlashFlow == 0){
                ...
                if(rOpt.fgLampflashCond && !isSkipFlash()){
        ...
        case ECmd_TouchAEStart:
            ...
            if( rOpt.fgLampflashCond && (rOpt.bCustEnableFlash || (!rOpt.bCustEnableFlash && rOpt.bStrobeBVTrigger))) {
                vecTaskEnum.push_back(TASK_ENUM_3A_FLASH_FRONT);
                vecTaskEnum.push_back(TASK_ENUM_3A_FLASH_BACK);
            }
            vecTaskEnum.push_back(TASK_ENUM_3A_TOUCH);
            ...
            if(m_v3ATaskQueue.size())
            {
                ...
                if(taskList.size())
                {
                    ...
                    for(it = taskList.begin(); it != taskList.end(); it++)
                    {
                        ...
                        {
                            m_i4LastPreFlashCloseMagic = m_rTask3AData.i4RequestMagic;
