...
class FLKOBufMgr : public NS3Av3::IBufMgr
{
    public:
        ...
        FLKOBufMgr(MINT32 i4SensorDev, MINT32 i4SensorIdx, STT_CFG_INFO_T const sttInfo);
        virtual ~FLKOBufMgr();
        ...
        virtual MVOID reset(){};
        MINT32 dequeueHw(BufInfo_T &rDQBuf, BufInfo_T &rLastBuf);
        MINT32 enqueueHw(BufInfo_T &rDQBuf);
