...
public:
    ...
    MVOID
    setEnable_NSL2A(MBOOL bEnable)
    {
        reinterpret_cast<ISP_CAM_CTL_EN_P2_T*>(REG_INFO_VALUE_PTR(CAM_CTL_EN_P2))->NSL2A_EN = bEnable;
    }

    MVOID
    setEnable_SL2C(MBOOL bEnable)
    {
        reinterpret_cast<ISP_CAM_CTL_EN_P2_T*>(REG_INFO_VALUE_PTR(CAM_CTL_EN_P2))->SL2C_EN = bEnable;
    }
