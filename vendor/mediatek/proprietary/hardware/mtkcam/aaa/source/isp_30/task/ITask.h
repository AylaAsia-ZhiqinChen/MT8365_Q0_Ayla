...
public :
     ...
     */
    static ITask* create(TASK_ENUM rEnum, MINT32 const i4SensorDev, ECmd_T eCmd);
...
{
public:
    static Task3APreview* create(MINT32 const i4SensorDev);
    virtual MVOID destroy() = 0;
...
{
public:
    static Task3ATouch* create(MINT32 const i4SensorDev);
    virtual MVOID destroy() = 0;
    virtual ~Task3ATouch(){}
...
{
public:
    static Task3APrecapture* create(MINT32 const i4SensorDev);
    virtual MVOID destroy() = 0;
...
{
public:
    static Task3AFlash* create(MINT32 const i4SensorDev);
    virtual MVOID destroy() = 0;
    virtual ~Task3AFlash(){}
...
{
public:
    static Task3AFlashFront* create(MINT32 const i4SensorDev);
    virtual MVOID destroy() = 0;
...
{
public:
    static Task3AFlashBack* create(MINT32 const i4SensorDev);
    virtual MVOID destroy() = 0;
...
{
public:
    static Task3ACapture* create(MINT32 const i4SensorDev);
    virtual MVOID destroy() = 0;
...
{
public:
    static TaskAFNormal* create(MINT32 const i4SensorDev);
    virtual MVOID destroy() = 0;
...
{
public:
    static TaskAFTrigger* create(MINT32 const i4SensorDev);
    virtual MVOID destroy() = 0;
...
{
public:
    static TaskSync2A* create(MINT32 const i4SensorDev);
    virtual MVOID destroy() = 0;
    virtual ~TaskSync2A(){}
...
{
public:
    static TaskSyncAF* create(MINT32 const i4SensorDev);
    virtual MVOID destroy() = 0;
    virtual ~TaskSyncAF(){}
