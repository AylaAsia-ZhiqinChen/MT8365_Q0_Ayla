...
MBOOL ISP_MGR_AWB_STAT_CONFIG_T::config(AWB_STAT_CONFIG_T& rAWBStatConfig, MBOOL bHBIN2Enable, int imgW, int imgH, int blkW, int blkH, MINT32 i4SensorIndex)
{
	...
	CAM_LOGD("exrAWBStatConfig: i4WindowOrigin(X,Y)=(%d,%d) i4WindowSize(X,Y)=(%d,%d) i4WindowPitch(X,Y)=(%d,%d) i4WindowNum(X,Y)=(%d,%d) i4PreGain(R,G,B)=(%d,%d,%d) i4PreGainLimit(R,G,B)=(%d,%d,%d) i4LowThreshold(R,G,B)=(%d,%d,%d) i4HighThreshold(R,G,B)=(%d,%d,%d) i4PixelCount(R,G,B)=(%d,%d,%d) i4ErrorThreshold=%d i4ErrorShiftBits=%d i4Cos=%d i4Sin=%d \n", 
		   (int)rAWBStatConfig.i4WindowOriginX, (int)rAWBStatConfig.i4WindowOriginY, (int)rAWBStatConfig.i4WindowSizeX, (int)rAWBStatConfig.i4WindowSizeY, (int)rAWBStatConfig.i4WindowPitchX , (int)rAWBStatConfig.i4WindowPitchY,
		   (int)rAWBStatConfig.i4WindowNumX, (int)rAWBStatConfig.i4WindowNumY, (int)rAWBStatConfig.i4PreGainR, (int)rAWBStatConfig.i4PreGainG, (int)rAWBStatConfig.i4PreGainB,
		   (int)rAWBStatConfig.i4PreGainLimitR, (int)rAWBStatConfig.i4PreGainLimitG, (int)rAWBStatConfig.i4PreGainLimitB,
		   (int)rAWBStatConfig.i4LowThresholdR, (int)rAWBStatConfig.i4LowThresholdG, (int)rAWBStatConfig.i4LowThresholdB, (int)rAWBStatConfig.i4HighThresholdR,(int)rAWBStatConfig.i4HighThresholdG, (int)rAWBStatConfig.i4HighThresholdB,
		   (int)rAWBStatConfig.i4PixelCountR, (int)rAWBStatConfig.i4PixelCountG, (int)rAWBStatConfig.i4PixelCountB, (int)rAWBStatConfig.i4ErrorThreshold, (int)rAWBStatConfig.i4ErrorShiftBits,
		   (int)rAWBStatConfig.i4Cos,(int)rAWBStatConfig.i4Sin);

    CAM_LOGD("exrAWBStatConfig.i4AWBXY_WIN(L,R,D,U) : [0]=(%d,%d,%d,%d) [1]=(%d,%d,%d,%d) [2]=(%d,%d,%d,%d) [3]=(%d,%d,%d,%d) [4]=(%d,%d,%d,%d) [5]=(%d,%d,%d,%d) [6]=(%d,%d,%d,%d) [7]=(%d,%d,%d,%d) [8]=(%d,%d,%d,%d) [9]=(%d,%d,%d,%d) \n",
