                          ...
                          int version)
{
    ...
    if(a_eSensorType == DUAL_CAMERA_MAIN_SENSOR || a_eSensorType == DUAL_CAMERA_SUB_SENSOR  || a_eSensorType == DUAL_CAMERA_SUB_2_SENSOR
        || a_eSensorType == DUAL_CAMERA_MAIN_SECOND_SENSOR || a_eSensorType == DUAL_CAMERA_MAIN_3_SENSOR)
       ;
    else
    {
