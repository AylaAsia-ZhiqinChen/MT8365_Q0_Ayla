...
doPvAWB(MINT32 i4SensorDev, MINT32 i4FrameCount, MBOOL bAEStable, MINT32 i4SceneLV, MVOID *pAWBStatBuf, MBOOL bApplyToHW)
{
    ...
    if (i4SensorDev & ESensorDev_MainThird)
        ret_main3 = AwbMgr::getInstance(ESensorDev_MainThird).doPvAWB(i4FrameCount, bAEStable, i4SceneLV, pAWBStatBuf, bApplyToHW);
...
MBOOL
IAwbMgr::
doCapFlashAWBDisplay(MINT32 i4SensorDev)
{
    MBOOL ret_main, ret_sub, ret_main2, ret_sub2, ret_main3, bApplyToHW;
    ret_main = ret_sub = ret_main2 = ret_sub2 = ret_main3 = bApplyToHW = MTRUE;
