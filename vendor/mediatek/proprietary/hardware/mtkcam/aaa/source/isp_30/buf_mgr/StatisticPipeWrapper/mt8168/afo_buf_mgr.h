...
private:    ////    Disallowed.
    ...
    IAFOBufMgrWrapper(IAFOBufMgrWrapper const&);
    //  Copy-assignment operator is disallowed.
    IAFOBufMgrWrapper& operator=(IAFOBufMgrWrapper const&);
...
public:
     ...
     * @brief get instance
     */
    static IAFOBufMgrWrapper& getInstance()
    {
        static IAFOBufMgrWrapper singleton;
        return singleton;
    }
    /**
     * @brief init function
    ...
    MBOOL dequePipe(MINT32 const i4SensorDev);
    BufInfo_T* dequeSwPipe(MINT32 const i4SensorDev);
    MBOOL enquePipe(MINT32 const i4SensorDev);
    MBOOL abortDeque(MINT32 const i4SensorDev);
};
