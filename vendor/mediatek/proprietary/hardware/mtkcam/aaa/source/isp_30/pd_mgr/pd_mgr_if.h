...
#include "ae_param.h" /* AETarget mode */
...
public:
     ...
     */
    MRESULT getPDInfoForSttCtrl(MINT32 sensorDev, MINT32 sensorIdx, MINT32 sensorMode, MUINT32 &oPDOSizeW, MUINT32 &oPDOSizeH, FEATURE_PDAF_STATUS &oPDAFStatus, const ConfigInfo_T& rConfigInfo);
    /**
