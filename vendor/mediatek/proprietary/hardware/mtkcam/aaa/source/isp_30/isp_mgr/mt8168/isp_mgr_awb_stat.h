...
protected:
    ISP_MGR_AWB_STAT_CONFIG(ESensorDev_T const eSensorDev, ESensorTG_T const eSensorTG = ESensorTG_1)
        ...
        , m_i4SensorIndex(0)
    {
        ...
        INIT_REG_INFO_ADDR(CAM_AWB_SPARE);
#if 0
        INIT_REG_INFO_ADDR(CAM_AWB_MOTION_THR);
        //RWB
        INIT_REG_INFO_ADDR(CAM_AWB_RC_CNV_0);
        INIT_REG_INFO_ADDR(CAM_AWB_RC_CNV_1);
        INIT_REG_INFO_ADDR(CAM_AWB_RC_CNV_2);
        INIT_REG_INFO_ADDR(CAM_AWB_RC_CNV_3);
        INIT_REG_INFO_ADDR(CAM_AWB_RC_CNV_4);
        // PSO
        INIT_REG_INFO_ADDR(CAM_PS_AWB_WIN_ORG);
        INIT_REG_INFO_ADDR(CAM_PS_AWB_WIN_SIZE);
        INIT_REG_INFO_ADDR(CAM_PS_AWB_WIN_PIT);
        INIT_REG_INFO_ADDR(CAM_PS_AWB_WIN_NUM);
        INIT_REG_INFO_ADDR(CAM_PS_AWB_PIXEL_CNT0);
        INIT_REG_INFO_ADDR(CAM_PS_AWB_PIXEL_CNT1);
        INIT_REG_INFO_ADDR(CAM_PS_AWB_PIXEL_CNT2);
        INIT_REG_INFO_ADDR(CAM_PS_AWB_PIXEL_CNT3);
#endif
...
public: //    Interfaces
    MBOOL config(AWB_STAT_CONFIG_T& rAWBStatConfig, MBOOL bHBIN2Enable, int imgW, int imgH, int blkW, int blkH, MINT32 i4SensorIndex);
    ...
    MBOOL reconfig( MVOID* /*pDBinInfo*/, MVOID* /*pOutRegCfg*/){return MTRUE;};
    MBOOL Cbreconfig(AWB_STAT_CONFIG_T& /*rAWBStatConfig*/, AWB_OUTPUT_T& /*m_rAWBOutput*/, MUINT32 /*m_i4FlareGain*/, MUINT32 /*m_i4FlareOffset*/, MVOID* /*pDBinInfo*/, MVOID* /*pOutRegCfg*/){return MTRUE;};
