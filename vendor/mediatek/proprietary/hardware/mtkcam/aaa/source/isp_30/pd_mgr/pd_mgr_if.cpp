...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MRESULT IPDMgr::getPDInfoForSttCtrl(MINT32 sensorDev, MINT32 sensorIdx, MINT32 sensorMode, MUINT32 &oPDOSizeW, MUINT32 &oPDOSizeH, FEATURE_PDAF_STATUS &oPDAFStatus, const ConfigInfo_T& rConfigInfo)
{
    return PDMgr::getInstance(sensorDev).getPDInfoForSttCtrl(sensorIdx, sensorMode, oPDOSizeW, oPDOSizeH, oPDAFStatus, rConfigInfo);
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
