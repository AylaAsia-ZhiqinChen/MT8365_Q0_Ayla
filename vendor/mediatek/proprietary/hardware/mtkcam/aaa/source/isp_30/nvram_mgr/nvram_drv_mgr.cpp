...
init(MINT32 const i4SensorDev)
{
    ...
    case ESensorDev_MainThird:
        m_eSensorEnum = DUAL_CAMERA_MAIN_3_SENSOR;
        pIHalSensorList->querySensorStaticInfo(SENSOR_DEV_MAIN_3, &rSensorStaticInfo);
           m_u4SensorID = rSensorStaticInfo.sensorDevID;
        break;
	case ESensorDev_SubSecond:
        m_eSensorEnum = DUAL_CAMERA_SUB_2_SENSOR;
        pIHalSensorList->querySensorStaticInfo(SENSOR_DEV_SUB_2, &rSensorStaticInfo);
           m_u4SensorID = rSensorStaticInfo.sensorDevID;
        break;
