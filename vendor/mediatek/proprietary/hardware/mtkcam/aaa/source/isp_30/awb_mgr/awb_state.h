...
struct InactiveAuto : public IAwbState
{
    ...
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBModeNotAuto>);
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBModeAuto>) {
        CAM_LOGD("[InactiveAuto::sendIntent]<eIntent_AWBModeAuto>");
        return this;
    }
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBScan>);
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBScanFinished>);
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBLockOn>);
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBLockOff>) {
        CAM_LOGD("[InactiveAuto::sendIntent]<eIntent_AWBLockOff>");
        return this;
    }
};
...
struct Searching : public IAwbState
{
    ...
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBModeNotAuto>);
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBModeAuto>) {
        CAM_LOGD("[Searching::sendIntent]<eIntent_AWBModeAuto>");
        return this;
    }
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBScan>) {
        CAM_LOGD("[Searching::sendIntent]<eIntent_AWBScan>");
        return this;
    }
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBScanFinished>);
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBLockOn>);
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBLockOff>) {
        CAM_LOGD("[Searching::sendIntent]<eIntent_AWBLockOff>");
        return this;
    }
};
...
struct Converged : public IAwbState
{
    ...
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBModeNotAuto>);
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBModeAuto>) {
        CAM_LOGD("[Converged::sendIntent]<eIntent_AWBModeAuto>");
        return this;
    }
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBScan>);
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBScanFinished>) {
        //CAM_LOGD("[Converged::sendIntent]<eIntent_AWBScanFinished>");
        return this;
    }
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBLockOn>);
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBLockOff>) {
        CAM_LOGD("[Converged::sendIntent]<eIntent_AWBLockOff>");
        return this;
    }   
};
...
struct Locked : public IAwbState
{
    ...
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBModeNotAuto>);
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBModeAuto>) {
        CAM_LOGD("[Locked::sendIntent]<eIntent_AWBModeAuto>");
        return this;
    }
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBScan>) {
        CAM_LOGD("[Locked::sendIntent]<eIntent_AWBScan>");
        return this;
    }
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBScanFinished>) {
        CAM_LOGD("[Locked::sendIntent]<eIntent_AWBScanFinished>");
        return this;
    }
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBLockOn>) {
        CAM_LOGD("[Locked::sendIntent]<eIntent_AWBLockOn>");
        return this;
    }
    virtual IAwbState*  sendIntent(intent2type<eIntent_AWBLockOff>);   
};
...
public:
    ...
    AwbStateMgr(MINT32 i4SensorDev) 
    : m_Lock(),
    ...
    MBOOL reset(EAWBState_T eInitAWBState)
    {
        if ((eInitAWBState < eState_Begin) || (eInitAWBState > eState_Num)) {
            CAM_LOGE("Unsupport AWB state: %d", eInitAWBState);
            return MFALSE;
        }
