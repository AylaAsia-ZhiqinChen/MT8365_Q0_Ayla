 ...
 ************************************************************************************************/
#ifndef _FLKO_BUF_MGR_H_
#define _FLKO_BUF_MGR_H_
...
private:    ////    Disallowed.
    ...
    IFLKOBufMgrWrapper(IFLKOBufMgrWrapper const&);
    //  Copy-assignment operator is disallowed.
    IFLKOBufMgrWrapper& operator=(IFLKOBufMgrWrapper const&);
...
public:
     ...
     * @brief get instance
     */
    static IFLKOBufMgrWrapper& getInstance()
    {
        static IFLKOBufMgrWrapper singleton;
        return singleton;
    }
    /**
     * @brief init function
    ...
    MBOOL initPipe(MINT32 const i4SensorDev, MINT32 const i4SensorIdx, MINT32 const i4TGInfo);     // create Buffer
    MBOOL uninitPipe(MINT32 const i4SensorDev);
    MBOOL startPipe(MINT32 const i4SensorDev);
    MBOOL stopPipe(MINT32 const i4SensorDev);
    MBOOL dequePipe(MINT32 const i4SensorDev, BufInfo_T& rBufInfo);
    MBOOL enquePipe(MINT32 const i4SensorDev, BufInfo_T& rBufInfo);
