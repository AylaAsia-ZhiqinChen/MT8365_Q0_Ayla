...
protected:
    ISP_MGR_EE(ESensorDev_T const eSensorDev)
...
class ISP_MGR_EE_DEV : public ISP_MGR_EE_T
{
public:
    static
    ISP_MGR_EE_T&
    getInstance()
    {
        static ISP_MGR_EE_DEV<eSensorDev> singleton;
        return singleton;
    }
    virtual MVOID destroyInstance() {}

    ISP_MGR_EE_DEV()
        : ISP_MGR_EE_T(eSensorDev)
    {}

    virtual ~ISP_MGR_EE_DEV() {}
