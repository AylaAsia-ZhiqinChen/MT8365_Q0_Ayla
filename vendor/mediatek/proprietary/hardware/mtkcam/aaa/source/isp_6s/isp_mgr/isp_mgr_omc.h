 ...
 ************************************************************************************************/
#ifndef _ISP_MGR_OMC_H_
#define _ISP_MGR_OMC_H_

//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// OMC
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

#define INIT_OMC_ADDR(reg)\
    INIT_REG_INFO_ADDR_MSS_MULTI(EOMC_D1, reg, MSS_D1A_OMC_OMC_);\

typedef class ISP_MGR_OMC : public ISP_MGR_BASE_T
{
    typedef ISP_MGR_OMC    MyType;
public:
    enum
    {
        EOMC_D1,
...
protected:
    ISP_MGR_OMC(ESensorDev_T const eSensorDev)
...
*/
    ...
    MBOOL apply_MSS(MUINT8 SubModuleIndex, const RAWIspCamInfo& rRawIspCamInfo, mss_reg_t* pReg);

} ISP_MGR_OMC_T;

template <ESensorDev_T const eSensorDev>
class ISP_MGR_OMC_DEV : public ISP_MGR_OMC_T
{
public:
    static
    ISP_MGR_OMC_T&
    getInstance()
    {
        static ISP_MGR_OMC_DEV<eSensorDev> singleton;
        return singleton;
    }
    virtual MVOID destroyInstance() {}

    ISP_MGR_OMC_DEV()
        : ISP_MGR_OMC_T(eSensorDev)
    {}

    virtual ~ISP_MGR_OMC_DEV() {}
