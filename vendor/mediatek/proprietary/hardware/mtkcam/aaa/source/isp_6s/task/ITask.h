...
//#include <af_mgr/af_mgr_if_param.h>
...
struct TaskInfo
{
    ...
    MINT32 i4Group;    // TASK_GROUP
    MBOOL  bSequenceGroup;
...
public :
     ...
     */
    static ITask* create(TASK_ENUM rEnum, MINT32 const i4SensorDev, MINT32 i4Prioirty = -1);
