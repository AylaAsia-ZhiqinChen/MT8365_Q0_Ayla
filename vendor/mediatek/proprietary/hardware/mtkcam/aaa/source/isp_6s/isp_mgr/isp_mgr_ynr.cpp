...
put(MUINT8 SubModuleIndex, ISP_NVRAM_YNR_T const& rParam)
{
    ...
    PUT_REG_INFO_MULTI(SubModuleIndex, CATH,                      cath);
    PUT_REG_INFO_MULTI(SubModuleIndex, SM_EDGE,                   sm_edge);
    PUT_REG_INFO_MULTI(SubModuleIndex, YNLM,                      ynlm);
    PUT_REG_INFO_MULTI(SubModuleIndex, YIMP,                      yimp);
...
get(MUINT8 SubModuleIndex, ISP_NVRAM_YNR_T& rParam)
{
    ...
    GET_REG_INFO_MULTI(SubModuleIndex, CATH,                      cath);
    GET_REG_INFO_MULTI(SubModuleIndex, SM_EDGE,                   sm_edge);
    GET_REG_INFO_MULTI(SubModuleIndex, YNLM,                      ynlm);
    GET_REG_INFO_MULTI(SubModuleIndex, YIMP,                      yimp);
    return (*this);
}
template <>
ISP_MGR_YNR_T&
