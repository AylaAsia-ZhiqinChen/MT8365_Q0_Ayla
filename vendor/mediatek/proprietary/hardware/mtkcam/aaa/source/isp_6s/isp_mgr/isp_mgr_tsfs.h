 ...
 ************************************************************************************************/
#ifndef _ISP_MGR_TSFS_H_
#define _ISP_MGR_TSFS_H_
...
#define INIT_TSFS_ADDR(reg)\
    INIT_REG_INFO_ADDR_P1_MULTI(ETSFS_R1, reg, TSFS_R1_);\

typedef class ISP_MGR_TSFS : public ISP_MGR_BASE_T
{
    typedef ISP_MGR_TSFS    MyType;
public:
    enum
    {
        ETSFS_R1,
...
protected:
    ISP_MGR_TSFS(ESensorDev_T const eSensorDev)
        ...
        , m_bCCTEnable(MTRUE)
    {
        ...
        INIT_TSFS_ADDR(TSFS_ORG);
        INIT_TSFS_ADDR(TSFS_SIZE);
        INIT_TSFS_ADDR(TSFS_PIT);
        INIT_TSFS_ADDR(TSFS_NUM);
        INIT_TSFS_ADDR(TSFS_PC0);
        INIT_TSFS_ADDR(TSFS_PC1);
        INIT_TSFS_ADDR(TSFS_PC2);
    }

    virtual ~ISP_MGR_TSFS() {}
...
class ISP_MGR_TSFS_DEV : public ISP_MGR_TSFS_T
{
public:
    static
    ISP_MGR_TSFS_T&
    getInstance()
    {
        static ISP_MGR_TSFS_DEV<eSensorDev> singleton;
        return singleton;
    }
    virtual MVOID destroyInstance() {}

    ISP_MGR_TSFS_DEV()
        : ISP_MGR_TSFS_T(eSensorDev)
    {}

    virtual ~ISP_MGR_TSFS_DEV() {}
