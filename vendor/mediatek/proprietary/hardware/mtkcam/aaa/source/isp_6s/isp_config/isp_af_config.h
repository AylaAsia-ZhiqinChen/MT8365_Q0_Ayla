...
#include <stdio.h>
#include <string.h>
#include <af_cxu/af_cxu_param.h>

using namespace NS3Av3;
using namespace std;

typedef struct AFResultConfig_t : public NS3Av3::ResultPoolBase_T
{
    AFRESULT_ISPREG_T afIspRegInfo;
#ifndef __PLATFORM__
    AFResultConfig_t()
    {
        afIspRegInfo.enableAFHw = 0;
        afIspRegInfo.isApplied  = 0;
        afIspRegInfo.configNum  = 0;

        ::memset(afIspRegInfo.rAFRegInfo, 0, EAFRegInfo_NUM*sizeof(AFRegInfo_T));
    }
    ...
    {
        this->afIspRegInfo.enableAFHw = o.afIspRegInfo.enableAFHw;
        this->afIspRegInfo.isApplied  = o.afIspRegInfo.isApplied;
        this->afIspRegInfo.configNum  = o.afIspRegInfo.configNum;

        ::memcpy(this->afIspRegInfo.rAFRegInfo, o.afIspRegInfo.rAFRegInfo, EAFRegInfo_NUM*sizeof(AFRegInfo_T));
        return *this;
    }
    ...
    // Get Id
    virtual int getId() const override { return E_AF_CONFIGRESULTTOISP; }
