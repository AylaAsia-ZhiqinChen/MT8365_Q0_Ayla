...
RELATIVE_PATH_MTKCAM_3A := ../
RELATIVE_PATH_MTKCAM_3A_COMMON  := ../../common

#-----------------------------------------------------------

LOCAL_SRC_FILES += AeSetting/IAeSetting.cpp
LOCAL_SRC_FILES += AeSetting/AeSettingCCU.cpp
LOCAL_SRC_FILES += AeSetting/AeSettingCPU.cpp
LOCAL_SRC_FILES += AeSetting/AeSettingDefault.cpp
LOCAL_SRC_FILES += AeSetting/AeSettingVHDR.cpp
LOCAL_SRC_FILES += AeFlow/IAeFlow.cpp
LOCAL_SRC_FILES += AeFlow/AeFlowCCU.cpp
LOCAL_SRC_FILES += AeFlow/AeFlowCPU.cpp
LOCAL_SRC_FILES += AeFlow/AeFlowDefault.cpp
LOCAL_SRC_FILES += AeFlow/AeFlowCustom.cpp
LOCAL_SRC_FILES += ae_mgr.cpp
LOCAL_SRC_FILES += ae_mgr_ctrl.cpp
LOCAL_SRC_FILES += ae_mgr_pline.cpp
LOCAL_SRC_FILES += ae_mgr_flow.cpp
LOCAL_SRC_FILES += ae_mgr_setting.cpp
LOCAL_SRC_FILES += ae_cct_feature.cpp
LOCAL_SRC_FILES += ae_mgr_if.cpp
LOCAL_SRC_FILES += isp_ae_config.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A)/sensor_mgr/aaa_sensor_mgr.cpp
...
LOCAL_MODULE := libcam.hal3a.v3.ae
