...
protected:
    ISP_MGR_HLR(ESensorDev_T const eSensorDev)
...
class ISP_MGR_HLR_DEV : public ISP_MGR_HLR_T
{
public:
    static
    ISP_MGR_HLR_T&
    getInstance()
    {
        static ISP_MGR_HLR_DEV<eSensorDev> singleton;
        return singleton;
    }
    virtual MVOID destroyInstance() {}

    ISP_MGR_HLR_DEV()
        : ISP_MGR_HLR_T(eSensorDev)
    {}

    virtual ~ISP_MGR_HLR_DEV() {}
