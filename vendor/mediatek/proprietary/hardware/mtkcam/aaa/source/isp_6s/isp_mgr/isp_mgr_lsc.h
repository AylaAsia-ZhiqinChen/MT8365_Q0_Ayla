...
#define INIT_LSC_ADDR(reg)\
    ...
    INIT_REG_INFO_ADDR_P2_MULTI(ELSC_D1 ,reg, LSC_D1A_LSC_)

#define INIT_LSCI_ADDR(reg)\
    INIT_REG_INFO_ADDR_P1_MULTI(ELSCI_R1 ,reg, LSCI_R1_LSCI_);\
    INIT_REG_INFO_ADDR_P2_MULTI(EIMGCI_D1 ,reg, IMGCI_D1A_IMGCI_)
...
public:
    enum
    {
        ...
        ELSC_D1,             //Pass2 Normal
        EIMGCI_D1=ELSC_D1,   //Pass2 shading table
        ESubModule_NUM
    };
...
public: // Interfaces.
    ...
    MBOOL configTSFS_Size_V1(MUINT8 SubModuleIndex, const TSFS_INFO_STRUCT &rTsfsConfig);
