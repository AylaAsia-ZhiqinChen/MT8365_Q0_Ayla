...
#define INIT_FLC_ADDR(reg)\
    INIT_REG_INFO_ADDR_P1_MULTI(EFLC_R1, reg, FLC_R1_FLC_);\
    INIT_REG_INFO_ADDR_P2_MULTI(EFLC_D1, reg, FLC_D1A_FLC_);\
...
protected:
        ...
        , m_bCCTEnable(MTRUE)
    {
        ...
        INIT_FLC_ADDR(OFST_RB);
        INIT_FLC_ADDR(OFST_G);
        INIT_FLC_ADDR(GN_RB);
        INIT_FLC_ADDR(GN_G);
    }
...
class ISP_MGR_FLC_DEV : public ISP_MGR_FLC_T
{
public:
    static
    ISP_MGR_FLC_T&
    getInstance()
    {
        static ISP_MGR_FLC_DEV<eSensorDev> singleton;
        return singleton;
    }
    virtual MVOID destroyInstance() {}

    ISP_MGR_FLC_DEV()
        : ISP_MGR_FLC_T(eSensorDev)
    {}

    virtual ~ISP_MGR_FLC_DEV() {}
