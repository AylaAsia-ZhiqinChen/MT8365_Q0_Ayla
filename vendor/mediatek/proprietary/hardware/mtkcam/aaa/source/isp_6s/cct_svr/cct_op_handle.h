...
private:
    ...
    MVOID   setIspOnOff_LDNR(MBOOL const fgOn);
    ...
    //!
    /////////////////////////////////////////////////////////////////////////
    MRESULT TakePicture(MUINT32 a_i4SensorMode, eACDK_CAP_FORMAT type, MINT32 expTime);
