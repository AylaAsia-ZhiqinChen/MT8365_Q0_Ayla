...
enum
{
    ERegInfo_AA_R1_AA_AWB_STAT_EN, //isp6s
    ...
    ERegInfo_AA_R1_AA_AWB_HDR_SUPPORT_EN, //isp6s
    ERegInfo_AA_R1_AA_AWB_STAT_MODE,  //RegInfo_AA_R1_AA_AWB_RGBSUM_OUTPUT_ENABLE,
