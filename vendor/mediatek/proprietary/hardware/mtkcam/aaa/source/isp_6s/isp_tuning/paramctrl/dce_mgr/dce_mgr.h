...
{
public:
    static DceMgr* createInstance(ESensorDev_T const eSensorDev, ISP_NVRAM_DCE_TUNING_PARAM_T* pIspNvramDcePara);
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:     ////
    DceMgr(ESensorDev_T const eSensorDev, ISP_NVRAM_DCE_TUNING_PARAM_T* pIspNvramDcePara);
...
public:
    ...
    MVOID getLastDCES_Info(DCE2DCES_INFO_T& rDCES_Info)
    {
        rDCES_Info = m_DCES_Info;
    }
