...
protected:
    ISP_MGR_DGN(ESensorDev_T const eSensorDev)
...
class ISP_MGR_DGN_DEV : public ISP_MGR_DGN_T
{
public:
    static
    ISP_MGR_DGN_T&
    getInstance()
    {
        static ISP_MGR_DGN_DEV<eSensorDev> singleton;
        return singleton;
    }
    virtual MVOID destroyInstance() {}

    ISP_MGR_DGN_DEV()
        : ISP_MGR_DGN_T(eSensorDev)
    {}

    virtual ~ISP_MGR_DGN_DEV() {}
