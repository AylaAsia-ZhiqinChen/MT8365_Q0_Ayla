...
protected:
    ISP_MGR_WB(ESensorDev_T const eSensorDev)
...
class ISP_MGR_WB_DEV : public ISP_MGR_WB_T
{
public:
    static
    ISP_MGR_WB_T&
    getInstance()
    {
        static ISP_MGR_WB_DEV<eSensorDev> singleton;
        return singleton;
    }
    virtual MVOID destroyInstance() {}

    ISP_MGR_WB_DEV()
        : ISP_MGR_WB_T(eSensorDev)
    {}

    virtual ~ISP_MGR_WB_DEV() {}
