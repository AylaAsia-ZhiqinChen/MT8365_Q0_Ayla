...
//_AA_R1_REG_AA_AWB_STAT_EN
    REG_AA_R1_AA_AWB_STAT_EN reg_awb_StatEn;
    reg_awb_StatEn.Raw = 0;
    reg_awb_StatEn.Bits.AA_AWB_STAT_EN = a_sAWBConfig->i4StatEnable;
    REG_AWB_INFO(AA_R1_AA_AWB_STAT_EN, (MUINT32)reg_awb_StatEn.Raw);
    CAM_LOGD("[%s][AA_R1_AA_AWB_STAT_EN] AWBStatEn: %d \n", __FUNCTION__,reg_awb_StatEn.Bits.AA_AWB_STAT_EN);
...
// AA_R1_AA_AWB_HDR_SUPPORT_EN
    REG_AA_R1_AA_AWB_HDR_SUPPORT_EN reg_awb_hdr_support_enable;
    reg_awb_hdr_support_enable.Raw = 0;
    reg_awb_hdr_support_enable.Bits.AA_AWB_HDR_SUPPORT_EN = a_sAWBConfig->i4HdrSupportEn;
    REG_AWB_INFO(AA_R1_AA_AWB_HDR_SUPPORT_EN, (MUINT32)reg_awb_hdr_support_enable.Raw);
    CAM_LOGD("[%s][AA_R1_AWB_HDR_SUPPORT_EN] HDR support enable: %d \n", __FUNCTION__,reg_awb_hdr_support_enable.Bits.AA_AWB_HDR_SUPPORT_EN);

// REG_AA_R1_AA_AWB_STAT_MODE
    REG_AA_R1_AA_AWB_STAT_MODE reg_awb_stat_mode;
    reg_awb_stat_mode.Raw = 0;
    reg_awb_stat_mode.Bits.AA_AWB_STAT_MODE = a_sAWBConfig->i4StatMode;
    REG_AWB_INFO(AA_R1_AA_AWB_STAT_MODE, (MUINT32)reg_awb_stat_mode.Raw);
    CAM_LOGD("[%s][AA_R1_AA_AWB_STAT_MODE] Stat mode: %d \n", __FUNCTION__,reg_awb_stat_mode.Bits.AA_AWB_STAT_MODE);
