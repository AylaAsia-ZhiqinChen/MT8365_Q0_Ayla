...
{
public:
    static CcmMgr* createInstance(ESensorDev_T const eSensorDev, ISP_NVRAM_COLOR_TABLE_STRUCT& rNewColor, IspTuningCustom* pIspTuningCustom);
...
private:
    ISP_NVRAM_COLOR_TABLE_STRUCT& m_rIspCCMInput;
    ISP_NVRAM_CCM_T m_rCCMOutput;
    ESensorDev_T m_eSensorDev;
    ISP_NVRAM_COLOR_TABLE_STRUCT& m_rISPMultiCCM;
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:     ////
    CcmMgr(ESensorDev_T const eSensorDev, ISP_NVRAM_COLOR_TABLE_STRUCT &rNewColor, IspTuningCustom* pIspTuningCustom)
        : m_rIspCCMInput   (rNewColor)
        , m_rCCMOutput (rNewColor.CCM[0].CCM_Reg[0])
        , m_eSensorDev  (eSensorDev)
        , m_rISPMultiCCM (rNewColor)
