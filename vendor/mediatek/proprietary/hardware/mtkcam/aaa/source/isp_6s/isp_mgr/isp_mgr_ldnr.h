...
protected:
    ISP_MGR_LDNR(ESensorDev_T const eSensorDev)
...
class ISP_MGR_LDNR_DEV : public ISP_MGR_LDNR_T
{
public:
    static
    ISP_MGR_LDNR_T&
    getInstance()
    {
        static ISP_MGR_LDNR_DEV<eSensorDev> singleton;
        return singleton;
    }
    virtual MVOID destroyInstance() {}

    ISP_MGR_LDNR_DEV()
        : ISP_MGR_LDNR_T(eSensorDev)
    {}

    virtual ~ISP_MGR_LDNR_DEV() {}
