...
private:
	...
	FEATURE_NVRAM_AD_NR_T m_ADNR[ESubModule_NUM];
...
public: // Interfaces.
    ...
    MVOID adaptive_NR3D_setting(MUINT8 SubModuleIndex, const RAWIspCamInfo& rRawIspCamInfos,  dip_a_reg_t* pReg);
	MVOID set_ADNR_param(MUINT8 SubModuleIndex, FEATURE_NVRAM_AD_NR_T const& rParam);
