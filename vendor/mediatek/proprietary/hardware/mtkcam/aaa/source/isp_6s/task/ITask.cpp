...
ITask*
ITask::create(TASK_ENUM rEnum, MINT32 const i4SensorDev, MINT32 i4Priority)
{
    ITask* pObj = NULL;
    switch(rEnum)
    {
        ...
        case TASK_ENUM_3A_PRECAPTURE:
            ...
            pObj->m_rTaskInfo.i4Type     = TASK_TYPE_3A;
            pObj->m_rTaskInfo.i4Group    = TASK_GROUP_FLASH;
            pObj->m_rTaskInfo.bSequenceGroup = MTRUE;
            break;
        ...
        case TASK_ENUM_3A_CAPTURE:
            ...
            pObj->m_rTaskInfo.i4Type     = TASK_TYPE_3A;
            pObj->m_rTaskInfo.i4Group    = TASK_GROUP_CAPTURE;
            break;
