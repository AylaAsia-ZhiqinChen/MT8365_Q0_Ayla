...
public:
    static
    CcmMgr*
    getInstance(ISP_NVRAM_COLOR_TABLE_STRUCT& rNewColor, IspTuningCustom* pIspTuningCustom)
    {
        static CcmMgrDev<eSensorDev> singleton(rNewColor, pIspTuningCustom);
        return &singleton;
    }
    virtual MVOID destroyInstance() {}

    CcmMgrDev(ISP_NVRAM_COLOR_TABLE_STRUCT& rNewColor, IspTuningCustom* pIspTuningCustom)
        : CcmMgr(eSensorDev, rNewColor, pIspTuningCustom)
    {}
...
#define INSTANTIATE(_dev_id) \
    case _dev_id: return  CcmMgrDev<_dev_id>::getInstance(rNewColor, pIspTuningCustom)
