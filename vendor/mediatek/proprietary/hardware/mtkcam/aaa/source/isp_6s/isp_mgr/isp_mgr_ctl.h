...
private:
    ...
    enum
    {
        ERegInfo_MRAWCTL_M1AMRAWCTL_EN,
...
//==========OBC Pass1==========
    ...
    MVOID
    setEnable_MOBC_M1(MBOOL bEnable)
    {
        reinterpret_cast<ISP_MRAWCTL_EN_T*>(REG_INFO_VALUE_PTR(MRAWCTL_M1AMRAWCTL_EN))->MRAWCTL_MOBC_M1_EN = bEnable;
    }
    MVOID
...
//==========SLK Pass1==========
    ...
    {
        reinterpret_cast<ISP_CAMCTL_EN2_T*>(REG_INFO_VALUE_PTR(CAMCTL_R1_CAMCTL_EN2))->CAMCTL_SLK_R1_EN = bEnable;
    }
...
//==========CCM Pass1==========
    ...
    {
        reinterpret_cast<ISP_CAMCTL_EN3_T*>(REG_INFO_VALUE_PTR(CAMCTL_R1_CAMCTL_EN3))->CAMCTL_CCM_R1_EN = bEnable;
    }
...
//==========GGM Pass1==========
    ...
    {
        reinterpret_cast<ISP_CAMCTL_EN3_T*>(REG_INFO_VALUE_PTR(CAMCTL_R1_CAMCTL_EN3))->CAMCTL_GGM_R1_EN = bEnable;
    }
    MVOID
...
//==========G2C Pass1==========
    ...
    {
        reinterpret_cast<ISP_CAMCTL_EN3_T*>(REG_INFO_VALUE_PTR(CAMCTL_R1_CAMCTL_EN3))->CAMCTL_G2C_R1_EN = bEnable;
    }
    MVOID
...
class ISP_MGR_CAMCTL_DEV : public ISP_MGR_CAMCTL_T
{
public:
    static
    ISP_MGR_CAMCTL_T&
    getInstance()
    {
        static ISP_MGR_CAMCTL_DEV<eSensorDev> singleton;
        return singleton;
    }
    virtual MVOID destroyInstance() {}

    ISP_MGR_CAMCTL_DEV()
        : ISP_MGR_CAMCTL_T(eSensorDev)
    {}

    virtual ~ISP_MGR_CAMCTL_DEV() {}
...
protected:
    ISP_MGR_DIPCTL(ESensorDev_T const eSensorDev)
        : ISP_MGR_BASE_T(m_rIspRegInfo, ERegInfo_NUM, eSensorDev)
    {
        ::memset(m_rIspRegInfo, 0, sizeof(RegInfo_T)*ERegInfo_NUM);
...
public: // Interfaces.
    ...
    template <class ISP_xxx_T>
    MBOOL get(ISP_xxx_T & rParam, const dip_a_reg_t* pReg) const;

    MBOOL apply(const RAWIspCamInfo& rRawIspCamInfo, dip_a_reg_t* pReg);
} ISP_MGR_DIPCTL_T;

template <ESensorDev_T const eSensorDev>
class ISP_MGR_DIPCTL_DEV : public ISP_MGR_DIPCTL_T
{
public:
    static
    ISP_MGR_DIPCTL_T&
    getInstance()
    {
        static ISP_MGR_DIPCTL_DEV<eSensorDev> singleton;
        return singleton;
    }
    virtual MVOID destroyInstance() {}

    ISP_MGR_DIPCTL_DEV()
        : ISP_MGR_DIPCTL_T(eSensorDev)
    {}

    virtual ~ISP_MGR_DIPCTL_DEV() {}
