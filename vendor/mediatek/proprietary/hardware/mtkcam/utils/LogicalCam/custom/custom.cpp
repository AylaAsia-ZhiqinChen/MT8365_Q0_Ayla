...
#define LOG_TAG "MtkCam/LogicalDeviceMetadataHelper"
//
...
showCustInfo()
{
#if defined(MY_CUST_LOGICAL_DEVICE_VERSION_LOGICAL)
    MY_LOGD("MY_CUST_LOGICAL_DEVICE_VERSION_LOGICAL=\"%s\"", MY_CUST_LOGICAL_DEVICE_VERSION_LOGICAL);
#endif
#if defined(MY_CUST_LOGICAL_DEVICE_FTABLE_FILE_LIST_LOGICAL)
    MY_LOGD("MY_CUST_LOGICAL_DEVICE_FTABLE_FILE_LIST_LOGICAL=\"%s\"", MY_CUST_LOGICAL_DEVICE_FTABLE_FILE_LIST_LOGICAL);
#endif
#if defined(MY_CUST_LOGICAL_DEVICE_FTABLE_FINAL_FILE_LOGICAL)
    MY_LOGD("MY_CUST_LOGICAL_DEVICE_FTABLE_FINAL_FILE_LOGICAL=\"%s\"", MY_CUST_LOGICAL_DEVICE_FTABLE_FINAL_FILE_LOGICAL);
#endif
}
};  //  namespace NSLogicalDeviceMetadataHelper
};  //  namespace NSCam
