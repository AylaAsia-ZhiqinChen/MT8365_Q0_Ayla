...
#define LOG_TAG "MtkCam/HwUtils/PlugProcessingBasic"
//
#include <PlugProcessing/PlugProcessingBasic.h>
...
PLUGPROCESSING_CLASSNAME(MUINT32 id)
{
    ...
    //mspDlFunc = new DlFunc("", mOpenID, mLogLevel); // set DlFunc if need
    //
