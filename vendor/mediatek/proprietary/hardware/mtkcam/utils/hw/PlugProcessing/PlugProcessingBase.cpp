...
//
#include <PlugProcessing/PlugProcessingBase.h>
#include <PlugProcessing/PlugProcessingUtils.h>
...
PlugStaticInfo::dump() const{
     CAM_ULOGMI("PlugStaticInfo:");
     CAM_ULOGMI("\teep_buf_size:%zu",eep_buf_size);
} 

void
PlugInitParam::dump() const{
     CAM_ULOGMI("PlugInitParam:");
     CAM_ULOGMI("\topenId: %d",openId);
     CAM_ULOGMI("\timg_w: %zu",img_w);
     CAM_ULOGMI("\timg_h: %zu",img_h);
     CAM_ULOGMI("\teep_buf_size: %zu eep_buf_addr: %p",eep_buf_size, eep_buf_addr);
}

void
PlugProcessingParam::dump() const{
     CAM_ULOGMI("PlugProcessingParam:");
     CAM_ULOGMI("\tpattern: %d",pattern);
     CAM_ULOGMI("\tbayer_order: %d",bayer_order);
     CAM_ULOGMI("\tsrc_buf_fd: %d",src_buf_fd);
     CAM_ULOGMI("\tdst_buf_fd: %d",dst_buf_fd);
     CAM_ULOGMI("\timg_w: %zu",img_w);
     CAM_ULOGMI("\timg_h: %zu",img_h);
     CAM_ULOGMI("\tsrc_buf_size: %d",src_buf_size);
     CAM_ULOGMI("\tdst_buf_size: %d",dst_buf_size);
}
#endif
