...
remove(int32_t deviceId)
{
    ...
    META_LOGD("[%zd] deviceId:%d removed", index, deviceId);
    return index;
}

int32_t
convertId(int32_t SensorId)
{
 ...
 ******************************************************************************/
IMetadataProvider*
valueForByDeviceId(int32_t deviceId)
{
 ...
 ******************************************************************************/
IMetadataProvider*
valueFor(int32_t sensorId)
{
    RWLock::AutoRLock _l(gRWLock);
    sp<IMetadataProvider> p = gMap.valueFor(convertId(sensorId));
    return  p.get();
}
 ...
 ******************************************************************************/
ssize_t
indexOfKey(int32_t sensorId)
{
    RWLock::AutoRLock _l(gRWLock);
    return  gMap.indexOfKey(convertId(sensorId));
}
