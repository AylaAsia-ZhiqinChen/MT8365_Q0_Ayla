 ...
 *
 ******************************************************************************/
#define MY_LOGV(fmt, arg...)        META_LOGV(fmt, ##arg)
#define MY_LOGD(fmt, arg...)        META_LOGD(fmt, ##arg)
#define MY_LOGI(fmt, arg...)        META_LOGI(fmt, ##arg)
#define MY_LOGW(fmt, arg...)        META_LOGW(fmt, ##arg)
#define MY_LOGE(fmt, arg...)        META_LOGE(fmt, ##arg)
#define MY_LOGF(fmt, arg...)        META_FATAL(fmt, ##arg)
//
