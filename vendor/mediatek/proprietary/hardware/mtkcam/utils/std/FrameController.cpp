    ...
    , mbFrameControlAdj(false)
{
    ...
    MY_LOGI("- miLogLevel(%d), max delay(%lld), max sleep(%lld ns), min sleep(%lld us), adj sleep(%lld ns)"
            , miLogLevel, (long long)mnFrameMaxPlusDelay, (long long)mnFrameMaxSleep, (long long)mnFrameMinSleep, (long long)mnAdjSleepTime);
}
        ...
        case 1:
            {
                ...
                if(mAverageCount == 5)
                {
                    ...
                    MY_LOGD("mAverageDisplayTime(%lld)",(long long)mAverageDisplayTime);
                }
            }
            break;
        case 2:
            {
                ...
                MY_LOGD("currentDisplayDelay(%lld),mAverageDisplayTime(%lld)",(long long)currentDisplayDelay,(long long)mAverageDisplayTime);
                if(currentDisplayDelay<=mAverageDisplayTime)
                {
                    ...
                    MY_LOGI("FirstFrameDelay(%lld)ms",(long long)miFirstDelayTime);
        ...
        case 3:
            {
                ...
                if(!mbFrameControlReset)
                {
                    ...
                    MY_LOG_ID((2<=miLogLevel),"off:ct(%lld),cft(%lld),cddt(%lld),oddt(%lld),nddt(%lld),max(%lld),min(%lld),fi(%lld),ti(%lld),stc(%d),st(%lld us)",
                                                (long long)currentTime,(long long)currentFrameTime,(long long)currentDisplayDelayAfterSleep,
                                                (long long)mnOldDisplayDelayTime,(long long)mnNewDisplayDelayTime, (long long)mnMaxAdjDisplay, (long long)mnMinAdjDisplay,
                                                (long long)mnFrameInterval,(long long)mnTimeInterval,mbFrameControlAdj,(long long)sleepus);
                    if (mnWaitTime >=  mnFrameMaxSleep)
                    {
                        ...
                        MY_LOGW("ct(%lld),cft(%lld),lft(%lld),cddt(%lld),nddt(%lld),fi(%lld),ti(%lld)",
                                                (long long)currentTime,(long long)currentFrameTime,(long long)lastFrameTimeBK,(long long)(currentDisplayDelay+(sleepus*1000)),
                                                (long long)mnNewDisplayDelayTime,(long long)mnFrameInterval,(long long)mnTimeInterval);
                    }
                }
                else
                {
                    MY_LOG_ID((2<=miLogLevel)," on:ct(%lld),cft(%lld),cddt(%lld),oddt(%lld),fi(%lld),ti(%lld)",
                                                (long long)currentTime, (long long)currentFrameTime, (long long)currentDisplayDelay,
                                                (long long)mnOldDisplayDelayTime,(long long)mnFrameInterval, (long long)mnTimeInterval);
