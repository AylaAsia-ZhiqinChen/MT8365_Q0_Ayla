...
Test_ImageBufferAllocator()
{
    ...
    //// raw pointer
    {
        ...
        //
        MY_CHECK(buffer_size==pImgBuf_jpeg->getBitstreamSize(), "%zu", pImgBuf_jpeg->getBitstreamSize());
        ...
        MY_CHECK(720000==pImgBuf_jpeg->getBitstreamSize(), "%zu", pImgBuf_jpeg->getBitstreamSize());
