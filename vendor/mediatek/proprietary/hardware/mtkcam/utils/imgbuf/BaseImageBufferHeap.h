...
private:
    ...
    // Because we only have few IDs currently. Use a simple array will be more economical
    // and efficient than a complicated data structure, e.g. KeyedVector<> or std::map<>
    ImageDescItem                   mImageDesc[eIMAGE_DESC_ID_MAX];
};
