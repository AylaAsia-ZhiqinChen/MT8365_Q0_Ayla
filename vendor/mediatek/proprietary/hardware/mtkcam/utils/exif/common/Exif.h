...
public:     ////                        Operations.
    virtual unsigned int exifApp1Make(exifImageInfo_t *pexifImgInfo, exifAPP1Info_t *pexifAPP1Info, unsigned int *pretSize, MBOOL enableSOI = MTRUE);
    virtual unsigned int exifAppnMake(unsigned int appn, unsigned char *paddr, unsigned char *pdata, unsigned int dataSize, unsigned int *pretSize, unsigned int defaultSize);
...
public:     //// exif_ifdlist.cpp
    ...
    virtual unsigned int ifdListNodeInfoGet(unsigned short ifdType, unsigned short tagId, ifdNode_t **pnode, MUINTPTR *pbufAddr);
...
public:     //// exif_misc.cpp
    virtual unsigned short  mySwap16(unsigned short x);
    virtual unsigned int    mySwap32(unsigned int x);
    virtual unsigned short  mySwap16ByOrder(unsigned short order, unsigned short x);
    virtual unsigned int    mySwap32ByOrder(unsigned short order, unsigned int x);
