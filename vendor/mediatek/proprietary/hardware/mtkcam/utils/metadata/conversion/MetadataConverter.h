...
public:  ////
    ...
    MBOOL                       convertFromHidl(const void* src/*const ::android::hardware::hidl_vec<uint8_t>* */, IMetadata& dst);
    MBOOL                       convertToHidl(const IMetadata& src, void* dst/*::android::hardware::hidl_vec<uint8_t>* */);
...
private:
    ...
    static status_t             resizeIfNeeded(camera_metadata* &pBuffer,
                                               ...
                                               size_t extraData);
#endif
    inline static status_t      update(camera_metadata* &mBuffer,
                                       MUINT32 tag, const void *data,
                                       MUINT32 data_count);


    MVOID                       print(const IMetadata &rMetadata, const MUINT32 tag, const MUINT32 type, const String8& str) const;
};
