...
)
{
    ...
    case IFD0_TAG_IMGDESC:
        ...
        pifd->count = 0x20;
        strncpy((char *) pdata , "Unknown Image Title            ",pifd->count);
    ...
    case IFD0_TAG_MAKE:
        ...
        pifd->valoff = plist->valBufPos;
        pifd->count = 0x20;
        strncpy((char *) pdata , "Unknown Manufacturer Name", pifd->count);
        plist->valBufPos += pifd->count;
        pdata += pifd->count;
        break;
    case IFD0_TAG_MODEL:
        ...
        pifd->valoff = plist->valBufPos;
        pifd->count = 0x20;
        strncpy((char *) pdata , "Unknown Model Name ", pifd->count);
        plist->valBufPos += pifd->count;
        pdata += pifd->count;
        break;
    ...
    case IFD0_TAG_SOFTWARE:
        ...
        pifd->count = 32;
        pifd->valoff = plist->valBufPos;
        strncpy((char *) pdata , "MediaTek Camera Application", pifd->count);
        plist->valBufPos += pifd->count;
        pdata += pifd->count;
        break;
    case IFD0_TAG_DATETIME:
        ...
        pifd->count = 20;
        pifd->valoff = plist->valBufPos;
        strncpy((char *) pdata , "2002:01:24 17:35:30", pifd->count); /* get date/time from RTC */
        plist->valBufPos += pifd->count;
        pdata += pifd->count;
        break;
...
)
{
    ...
    case EXIF_TAG_DATETIMEDITI:
        ...
        #else
        strncpy((char *) pdata , "2002:01:24 17:35:30", pifd->count);
        #endif
        plist->valBufPos += pifd->count;
        pdata += pifd->count;
        break;
...
)
{
    ...
    case ITOP_TAG_ITOPINDEX:
        pifd->type = IFD_DATATYPE_ASCII;
        pifd->count = 4;
        strncpy((char *)&pifd->valoff, "R98", pifd->count);/* JPEG thumbnail compress */
        break;
