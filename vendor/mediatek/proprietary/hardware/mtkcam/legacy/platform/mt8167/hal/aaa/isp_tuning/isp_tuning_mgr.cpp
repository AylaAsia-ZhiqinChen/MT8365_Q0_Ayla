...
MBOOL IspTuningMgr::setTonemapCurve_Red(MFLOAT *p_in_red, MFLOAT *p_out_red, MINT32 *pCurvePointNum)
{
    ...
    if (m_i4SensorDev & ESensorDev_Main) {
        if (m_pParamctrl_Main) {
            MERROR_ENUM ret = m_pParamctrl_Main->setTonemapCurve_Red(p_in_red, p_out_red, pCurvePointNum);
            return ((ret == MERR_OK) ? MTRUE : MFALSE);
        }
        else {
            MY_ERR("m_pParamctrl_Main is NULL");
            return MFALSE;
        ...
        if (m_pParamctrl_Sub) {
            MERROR_ENUM ret = m_pParamctrl_Sub->setTonemapCurve_Red(p_in_red, p_out_red, pCurvePointNum);
            return ((ret == MERR_OK) ? MTRUE : MFALSE);
        }
        else {
            MY_ERR("m_pParamctrl_Sub is NULL");
        ...
        if (m_pParamctrl_Main2) {
            MERROR_ENUM ret = m_pParamctrl_Main2->setTonemapCurve_Red(p_in_red, p_out_red, pCurvePointNum);
            return ((ret == MERR_OK) ? MTRUE : MFALSE);
        }
        else {
            MY_ERR("m_pParamctrl_Main2 is NULL");
...
MBOOL IspTuningMgr::setTonemapCurve_Green(MFLOAT *p_in_green, MFLOAT *p_out_green, MINT32 *pCurvePointNum)
{
    ...
    if (m_i4SensorDev & ESensorDev_Main) {
        if (m_pParamctrl_Main) {
            MERROR_ENUM ret = m_pParamctrl_Main->setTonemapCurve_Green(p_in_green, p_out_green, pCurvePointNum);
            return ((ret == MERR_OK) ? MTRUE : MFALSE);
        }
        else {
            MY_ERR("m_pParamctrl_Main is NULL");
        ...
        if (m_pParamctrl_Sub) {
            MERROR_ENUM ret = m_pParamctrl_Sub->setTonemapCurve_Green(p_in_green, p_out_green, pCurvePointNum);
            return ((ret == MERR_OK) ? MTRUE : MFALSE);
        }
        else {
            MY_ERR("m_pParamctrl_Sub is NULL");
        ...
        if (m_pParamctrl_Main2) {
            MERROR_ENUM ret = m_pParamctrl_Main2->setTonemapCurve_Green(p_in_green, p_out_green, pCurvePointNum);
            return ((ret == MERR_OK) ? MTRUE : MFALSE);
        }
        else {
            MY_ERR("m_pParamctrl_Main2 is NULL");
...
MBOOL IspTuningMgr::setTonemapCurve_Blue(MFLOAT *p_in_blue, MFLOAT *p_out_blue, MINT32 *pCurvePointNum)
{
    ...
    if (m_i4SensorDev & ESensorDev_Main) {
        if (m_pParamctrl_Main) {
            MERROR_ENUM ret = m_pParamctrl_Main->setTonemapCurve_Blue(p_in_blue, p_out_blue, pCurvePointNum);
            return ((ret == MERR_OK) ? MTRUE : MFALSE);
        }
        else {
            MY_ERR("m_pParamctrl_Main is NULL");
        ...
        if (m_pParamctrl_Sub) {
            MERROR_ENUM ret = m_pParamctrl_Sub->setTonemapCurve_Blue(p_in_blue, p_out_blue, pCurvePointNum);
            return ((ret == MERR_OK) ? MTRUE : MFALSE);
        }
        else {
            MY_ERR("m_pParamctrl_Sub is NULL");
        ...
        if (m_pParamctrl_Main2) {
            MERROR_ENUM ret = m_pParamctrl_Main2->setTonemapCurve_Blue(p_in_blue, p_out_blue, pCurvePointNum);
            return ((ret == MERR_OK) ? MTRUE : MFALSE);
        }
        else {
            MY_ERR("m_pParamctrl_Main2 is NULL");
