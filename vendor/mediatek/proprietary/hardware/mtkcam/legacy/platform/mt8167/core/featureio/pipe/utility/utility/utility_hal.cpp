      ...
      , MUINT32 & u4EncSize)
{
    ...
    // (0). debug
    CAM_LOGD("[createJpegImg] - rSrcImgBufInfo.u4BufVA=0x%lx", (unsigned long)rSrcBufInfo.u4BufVA);
                  ...
                  , MUINT32     quality)
{
    ...
    *pImageInfo = srcBuff.virtAddr;
    CAM_LOGD("[createPanoJpegImg] out addr 0x%lx", (unsigned long)srcBuff.virtAddr);
