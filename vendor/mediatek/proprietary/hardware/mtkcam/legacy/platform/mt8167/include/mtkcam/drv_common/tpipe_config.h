...
#define MAX_TILE_TOT_NUM (2400)
#define MAX_ISP_DUMP_HEX_PER_TILE (36)
#define MAX_ISP_TILE_TDR_HEX_NUM (MAX_TILE_TOT_NUM*MAX_ISP_DUMP_HEX_PER_TILE)
...
typedef struct ISP_TPIPE_DESCRIPTOR_STRUCT
{
    ...
    unsigned int *tdr_disable_flag;//bryan
    unsigned int *last_irq_flag;//bryan
