...
MBOOL TdriMgrImp::init(void)
{
    ...
    if(mInitCount == 0) {
        ...
        for(i=TPIPE_DRV_CQ01;i<=TPIPE_DRV_CQ02;i++) {
            unsigned long descArray=0;
            unsigned long descNum=0;
            unsigned long ctlEn1=0;
            unsigned long ctlEn2=0;
            unsigned long ctlDma=0;
            ...
            if(i == TPIPE_DRV_CQ01) {
                ...
                tdriMgrInfo[i].pDescriptorArray =(unsigned int*) ((MUINTPTR)descArray);
                tdriMgrInfo[i].pDesriptorNum = (unsigned int*)((MUINTPTR)descNum);
                tdriMgrInfo[i].pTopCtlEn1 = (unsigned int*)((MUINTPTR)ctlEn1);
                tdriMgrInfo[i].pTopCtlEn2 = (unsigned int*)((MUINTPTR)ctlEn2);
                tdriMgrInfo[i].pTopCtlDma = (unsigned int*)((MUINTPTR)ctlDma);
                //
            ...
            LOG_INF("i(%d) pVirIspDrv(0x%lx) pVirtIspReg(0x%lx) pDescriptorArray(0x%lx) pDesriptorNum(0x%lx) pTopCtlEn1(0x%lx) pTopCtlEn2(0x%lx) pTopCtlDma(0x%lx)\n",
                    i,(unsigned long)tdriMgrInfo[i].pVirIspDrv,(unsigned long)tdriMgrInfo[i].pVirtIspReg,(unsigned long)tdriMgrInfo[i].pDescriptorArray,(unsigned long)tdriMgrInfo[i].pDesriptorNum,
                    (unsigned long)tdriMgrInfo[i].pDesriptorNum,(unsigned long)tdriMgrInfo[i].pTopCtlEn2,(unsigned long)tdriMgrInfo[i].pTopCtlDma);
...
MBOOL  TdriMgrImp::applySetting(ISP_DRV_CQ_ENUM ispCq, TDRI_MGR_FUNC_ENUM tmgFunc)
{
    ...
    //
    if(tdriMgrCqMap[ispCq].tdriMgrCQ == TPIPE_DRV_CQ01) {
        LOG_DBG("tdriMgrInfo_CQ1 0x%lx, %d/%d. %d/%d, %d/%d",(unsigned long)((MUINTPTR)tdriMgrInfo[TPIPE_DRV_CQ01].pDescriptorArray),tdriMgrFuncMap[tmgFunc].cqFuncGrp1,\
            tdriMgrInfo[TPIPE_DRV_CQ01].pDescriptorArray[tdriMgrFuncMap[tmgFunc].cqFuncGrp1],tdriMgrFuncMap[tmgFunc].cqFuncGrp2,\
            tdriMgrInfo[TPIPE_DRV_CQ01].pDescriptorArray[tdriMgrFuncMap[tmgFunc].cqFuncGrp2],tdriMgrFuncMap[tmgFunc].cqFuncGrp3,\
            tdriMgrInfo[TPIPE_DRV_CQ01].pDescriptorArray[tdriMgrFuncMap[tmgFunc].cqFuncGrp3]);
        ...
        LOG_DBG("tdriMgrInfo_CQ2 0x%lx, %d/%d. %d/%d, %d/%d",(unsigned long)((MUINTPTR)tdriMgrInfo[TPIPE_DRV_CQ02].pDescriptorArray),tdriMgrFuncMap[tmgFunc].cqFuncGrp1,\
            tdriMgrInfo[TPIPE_DRV_CQ02].pDescriptorArray[tdriMgrFuncMap[tmgFunc].cqFuncGrp1],tdriMgrFuncMap[tmgFunc].cqFuncGrp2,\
            tdriMgrInfo[TPIPE_DRV_CQ02].pDescriptorArray[tdriMgrFuncMap[tmgFunc].cqFuncGrp2],tdriMgrFuncMap[tmgFunc].cqFuncGrp3,\
            tdriMgrInfo[TPIPE_DRV_CQ02].pDescriptorArray[tdriMgrFuncMap[tmgFunc].cqFuncGrp3]);
