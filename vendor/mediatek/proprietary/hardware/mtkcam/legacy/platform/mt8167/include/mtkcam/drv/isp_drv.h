...
#define ISP_WRITE_BITS(RegBase, RegName, FieldName, Value)              \
    do {                                                                \
        ...
        {                                                               \
            TEMP_LOG_DBG("[%s, %s, line%04d] WARNING: Addr 0x%lx is enable bit, please use ISP_WRITE_ENABLE_BITS().", __FILE__, __func__, __LINE__, (unsigned long)(&(RegBase->RegName.Raw)) - (unsigned long)RegBase);  \
        }                                                               \
        ...
        {                                                               \
            TEMP_LOG_DBG("[%s, %s, line%04d] WARNING: Addr 0x%lx is seninf register, please use SENINF_WRITE_BITS().", __FILE__, __func__, __LINE__, (unsigned long)(&(RegBase->RegName.Raw)) - (unsigned long)RegBase);  \
        }                                                               \
    } while (0)
...
#define ISP_WRITE_REG(RegBase, RegName, Value)                          \
    do {                                                                \
        ...
        {                                                               \
            TEMP_LOG_DBG("[%s, %s, line%04d] WARNING: Addr 0x%lx is enable bit, please use ISP_WRITE_ENABLE_REG().", __FILE__, __func__, __LINE__, (unsigned long)(&(RegBase->RegName.Raw)) - (unsigned long)RegBase);  \
        }                                                               \
        if( regAddr < 0x00008000 )                                      \
        {                                                               \
        ...
        {                                                               \
            TEMP_LOG_DBG("[%s, %s, line%04d] WARNING: Addr 0x%lx is seninf register, please use SENINF_WRITE_REG().", __FILE__, __func__, __LINE__, (unsigned long)(&(RegBase->RegName.Raw)) - (unsigned long)RegBase);  \
        }                                                               \
    } while (0)
...
{\
    ...
    {\
        TEMP_LOG_DBG("[%s, %s, line%04d] WARNING: Addr 0x%lx is enable bit, please use ISP_WRITE_ENABLE_REG/BITS() or ISP_IOCTL_WRITE_ENABLE_REG/BITS().", __FILE__, __func__, __LINE__, (unsigned long)(&(RegBase->RegName.Raw)) - (unsigned long)RegBase); \
    }\
}
...
//        virtual MBOOL   IsGdmaMode() = 0;
        ...
        MUINT32 getTpipeMgrVaCq1(unsigned long *pDescArray, unsigned long *pDescNum, unsigned long *pCtlEn1, unsigned long *pCtlEn2, unsigned long *pCtlDma);
        MUINT32 getTpipeMgrVaCq2(unsigned long *pDescArray, unsigned long *pDescNum, unsigned long *pCtlEn1, unsigned long *pCtlEn2, unsigned long *pCtlDma);
