...
)
{
    ...
    IMetadata::IEntry entryFdMode = pInpMetadataRequest->entryFor(MTK_STATISTICS_FACE_DETECT_MODE);
    if(!entryFdMode.isEmpty())
        pOutMetadataResult->update(MTK_STATISTICS_FACE_DETECT_MODE, entryFdMode);
