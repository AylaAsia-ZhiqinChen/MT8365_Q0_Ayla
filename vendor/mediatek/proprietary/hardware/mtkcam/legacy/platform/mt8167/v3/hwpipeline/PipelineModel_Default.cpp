...
#undef CASE_ORDER
        ...
        //
        //mIsYuvSensor = MTRUE;
        rCfgProfile.mResizedSize = MSize(0, 0); // disable resize img2o
        mConfigProfile.mbConfigP2VSS = MFALSE; //p2node, p2nodevss can't run simultaneously with imgo
    }
    //
    return OK;
}
...
)
{
    ...
    if ( mConfigProfile.mbConfigJpeg )
    {
        //Hal:Image:YUY2 for jpeg
        {
            ...
            MINT const format = (mConfigProfile.mbConfigP2VSS || mIsYuvSensor) ? eImgFmt_YV12 : eImgFmt_YUY2;
            MUINT const usage = eBUFFER_USAGE_SW_READ_OFTEN |
                eBUFFER_USAGE_HW_CAMERA_READWRITE
                ;
            sp<ImageStreamInfo>
