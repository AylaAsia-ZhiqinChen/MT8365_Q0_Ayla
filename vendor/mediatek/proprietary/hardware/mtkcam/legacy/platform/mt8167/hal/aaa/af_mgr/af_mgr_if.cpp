...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MRESULT IAfMgr::retriggerAFWithFlashOn(MINT32 i4SensorDev, MINT32 i4isTurnOn)
{
    if (i4SensorDev & ESensorDev_Main)
        return AfMgr::getInstance(ESensorDev_Main).retriggerAFWithFlashOn(i4isTurnOn);
    if (i4SensorDev & ESensorDev_Sub)
        return AfMgr::getInstance(ESensorDev_Sub).retriggerAFWithFlashOn(i4isTurnOn);
    if (i4SensorDev & ESensorDev_MainSecond)
        return AfMgr::getInstance(ESensorDev_MainSecond).retriggerAFWithFlashOn(i4isTurnOn);
