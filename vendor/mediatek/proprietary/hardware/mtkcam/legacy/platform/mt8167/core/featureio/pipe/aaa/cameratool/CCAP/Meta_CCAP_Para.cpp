...
BOOL Set_SubCamera()
{
    ...
    ret = CctIF_Init(srcDev);
    ACDK_LOGD("CctIF_Init(srcDev) = %d\n", ret);
...
void META_CCAP_ADB_OP()
{
    ...
    const char end_filename[] = "/data/cct/CCTend";
#else
//    const char input_filename[] = "/sdcard/CCTinput";
//    const char output_filename[] = "/sdcard/CCToutput";
//    const char end_filename[] = "/sdcard/CCTend";

    const char input_filename[] = META_CCAP_PATH_CCT_INPUT;
    const char output_filename[] = META_CCAP_PATH_CCT_OUTPUT;
    const char end_filename[] = META_CCAP_PATH_CCT_END;
#endif
