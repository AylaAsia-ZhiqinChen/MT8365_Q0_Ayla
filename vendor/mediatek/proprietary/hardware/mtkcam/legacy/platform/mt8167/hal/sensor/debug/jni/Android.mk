...
LOCAL_SRC_FILES := jni_imgsensor.cpp
...
LOCAL_C_INCLUDES += \
    ...
    $(TOP)/$(MTK_PATH_SOURCE)/custom/common/kernel/imgsensor/inc/ \
    $(TOP)/$(MTK_PATH_SOURCE)/custom/mt8167/hal/
