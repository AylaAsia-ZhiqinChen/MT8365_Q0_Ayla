...
#undef LOG_TAG
#define LOG_TAG "Featureio/EISHal"
...
MINT32 EisHal::init()
{
    ...
    {
        char value[PROPERTY_VALUE_MAX] = {'\0'};
        bool sensor_en = MFALSE;
        property_get("vendor.debug.eis.AccEn", value, "0");
        mAccEnable = atoi(value);

        property_get("vendor.debug.eis.GyroEn", value, "0");
        mGyroEnable = atoi(value);
    }
