                 ...
                 NVRAM_CAMERA_ISP_PARAM_STRUCT& rIspNvram)
{
    ...
    case ESensorDev_Main:       //  Main Sensor
        ...
        LSC_LOG_END("RTO ESensorDev_Main(0x%08lx), i4SensorIdx(%d)", (unsigned long)pLscMgrRto, i4SensorIdx);
        break;
    case ESensorDev_MainSecond: //  Main Second Sensor
        ...
        LSC_LOG_END("RTO ESensorDev_MainSecond(0x%08lx), i4SensorIdx(%d)", (unsigned long)pLscMgrRto, i4SensorIdx);
        break;
    case ESensorDev_Sub:        //  Sub Sensor
        static LscMgr2Rto singleton_sub(ESensorDev_Sub, i4SensorIdx, rIspNvram);
        pLscMgrRto = &singleton_sub;
        LSC_LOG_END("RTO ESensorDev_Sub(0x%08lx), i4SensorIdx(%d)", (unsigned long)pLscMgrRto, i4SensorIdx);
        break;
    }
                 ...
                 NVRAM_CAMERA_ISP_PARAM_STRUCT& rIspNvram)
{
    ...
    case ESensorDev_Main:       //  Main Sensor
        ...
        pLscMgrRto = &singleton_main;
        LSC_LOG_END("RTOCycle ESensorDev_Main(0x%08lx), i4SensorIdx(%d)", (unsigned long)pLscMgrRto, i4SensorIdx);
        break;
    case ESensorDev_MainSecond: //  Main Second Sensor
        static LscMgr2RtoCycle singleton_mainsecond(ESensorDev_MainSecond, i4SensorIdx, rIspNvram);
        pLscMgrRto = &singleton_mainsecond;
        LSC_LOG_END("RTOCycle ESensorDev_MainSecond(0x%08lx), i4SensorIdx(%d)", (unsigned long)pLscMgrRto, i4SensorIdx);
        break;
    case ESensorDev_Sub:        //  Sub Sensor
        static LscMgr2RtoCycle singleton_sub(ESensorDev_Sub, i4SensorIdx, rIspNvram);
        pLscMgrRto = &singleton_sub;
        LSC_LOG_END("RTOCycle ESensorDev_Sub(0x%08lx), i4SensorIdx(%d)", (unsigned long)pLscMgrRto, i4SensorIdx);
        break;
    }
