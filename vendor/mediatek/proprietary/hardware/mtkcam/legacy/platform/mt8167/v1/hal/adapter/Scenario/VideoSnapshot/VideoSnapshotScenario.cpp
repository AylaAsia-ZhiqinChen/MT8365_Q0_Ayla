...
init(
    ...
    MUINT sensorType,
    MUINT sensorFormatOrder,
    MUINT rawSensorBit)
{
    MBOOL result = MTRUE;
    MUINT32 i;
    MUINT32 sensorDevIdx = 0;
    ...
    if(pHalSensorList != NULL)
    {
        ...
        MY_LOGD("---- sensorId = %d", sensorId);
        sensorDevIdx = pHalSensorList->querySensorDevIdx((MUINT)sensorId);
        MY_LOGD("---- sensorDevIdx = %d", sensorDevIdx);
    ...
    mSensorStaticInfo.sensorType = sensorType;
    mSensorStaticInfo.rawSensorBit = rawSensorBit;
    mSensorStaticInfo.sensorFormatOrder = sensorFormatOrder;
