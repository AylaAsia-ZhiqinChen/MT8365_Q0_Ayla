...
#define MAIN_CSI_AUTO_DESKEW_THRESHOLD 1000*1000000		// 1000*1000000
    ...
    if((currSensorDev & SENSOR_DEV_MAIN)
        ...
        &&(sensorPara[0].MIPI_OPHY_TYPE != 1)){
            ...
            if(((((sensorPara[0].cropWidth * sensorPara[0].cropHeight)/1000) * (sensorPara[0].frameRate/10)*bpp)/(sensorPara[0].u1MIPILaneNum+1))
                ...
                pSeninfDrv->autoDeskewCalibrationSeninf1(sensorPara[0].u1MIPILaneNum+1, SENSOR_DEV_MAIN);
            }
        ...
        &&(sensorPara[1].MIPI_OPHY_TYPE != 1)){
            ...
            if(((((sensorPara[1].cropWidth * sensorPara[1].cropHeight)/1000) * (sensorPara[1].frameRate/10)*bpp)/(sensorPara[1].u1MIPILaneNum+1))
                > (SUB_CSI_AUTO_DESKEW_THRESHOLD/CSI_BLANKING_RATIO)){
                SeninfDrv *const pSeninfDrv = SeninfDrv::createInstance();
                pSeninfDrv->autoDeskewCalibrationSeninf1(sensorPara[1].u1MIPILaneNum+1, SENSOR_DEV_SUB);
            }
    }
#endif
        ...
        switch(meSensorDev) {
            case SENSOR_DEV_MAIN:
                ...
                if (sensorPara[0].inSrcTypeSel >= VIRTUAL_CHANNEL_1) {
                    if(sensorPara[0].mipiPad == 0) { /* ePort_1 */
                    ...
                    if(sensorPara[0].mipiPad == 0) { /* Main @ePort_1 */
                    ...
                    else if(sensorPara[0].mipiPad == 1) { /* Main @ePort_2 */
                        if(sensorPara[0].MIPI_OPHY_TYPE == 1) // CSI2
                        {
                    ...
                    else if(sensorPara[0].mipiPad == 2) { /* Main @ePort_3 */
                        if(sensorPara[0].MIPI_OPHY_TYPE == 1) // CSI2
                        {
            ...
            case SENSOR_DEV_SUB:
                ...
                if (sensorPara[1].inSrcTypeSel >= MIPI_SENSOR) {
                    if(sensorPara[1].mipiPad == 2) { /* sub @ePort_3 */
                    ...
                    else if(sensorPara[1].mipiPad == 1) { /* sub @ePort_2 */
                        if(sensorPara[1].MIPI_OPHY_TYPE == 1) // CSI2
                        {
                    ...
                    else if(sensorPara[1].mipiPad == 0) { /* sub @ePort_1 */
                        if(sensorPara[1].MIPI_OPHY_TYPE == 1) // CSI2
                        {
