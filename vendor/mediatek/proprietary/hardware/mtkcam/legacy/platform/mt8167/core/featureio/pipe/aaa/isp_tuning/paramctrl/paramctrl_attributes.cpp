...
{
    MY_LOG_IF(m_bDebugEnable, "[%s] (ctrl, arg1, arg2) = (%d, %ld, %ld)", __FUNCTION__, ctrl, (unsigned long)arg1, (unsigned long)arg2);
    ...
    default:
        MY_ERR("%s: ctrl not supported (ctrl, arg1, arg2) = (%d, %ld, %ld)", __FUNCTION__, ctrl, (unsigned long)arg1, (unsigned long)arg2);
        break;
    }
}
