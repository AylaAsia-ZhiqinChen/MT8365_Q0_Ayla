...
private:
    ...
    MBOOL     encode(ImgBufInfo const rSrcBufInfo, ImgBufInfo const rDstBufInfo, MUINT32 const u4Quality, MUINT32 const u4IsSOI, MUINT32 const eCodecType, MUINT32 &u4EncSize);
    //
