...
update3AExif(CamExif *pCamExif)
{
    ...
    if (! mJpegParam.ms8GpsLatitude.isEmpty() && !mJpegParam.ms8GpsLongitude.isEmpty())
    {
        ...
        if (mJpegParam.ms8GpsTimestamp.length() <= 32) 
        ...
        if (mJpegParam.ms8GpsMethod.length() <= 64) 
