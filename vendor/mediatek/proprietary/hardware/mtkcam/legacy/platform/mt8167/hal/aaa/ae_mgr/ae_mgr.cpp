...
//        MY_LOG("No AE Metering area cnt: %d\n", sAEMeteringArea->u4Count);
    ...
    for (i=0; i<u4AreaCnt; i++)
    {
        ...
        int counter = 0;
        if (sAEMeteringArea->rAreas[i].i4Left   <= -1000)
        {
            sAEMeteringArea->rAreas[i].i4Left   = -1000;
            counter++;
        }
        if (sAEMeteringArea->rAreas[i].i4Right  <= -1000)
        {
            sAEMeteringArea->rAreas[i].i4Right  = -1000;
            counter++;
        }
        if (sAEMeteringArea->rAreas[i].i4Top    <= -1000)
        {
            sAEMeteringArea->rAreas[i].i4Top    = -1000;
            counter++;
        }
        if (sAEMeteringArea->rAreas[i].i4Bottom <= -1000)
        {
            sAEMeteringArea->rAreas[i].i4Bottom = -1000;
            counter++;
        }
...
MRESULT AeMgr::setAEEVCompIndex(MINT32 i4NewEVIndex, MFLOAT fStep)
{
    ...
    if (m_i4EVIndex != i4NewEVIndex)
    {
        ...
        if (i4EVValue < -350)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_n40;
        }
        else if (i4EVValue < -300)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_n35;
        }
        else if (i4EVValue < -250)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_n30;
        }
        else if (i4EVValue < -200)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_n25;
        }
        else if (i4EVValue < -170)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_n20;
        }
        else if (i4EVValue < -160)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_n17;
        }
        else if (i4EVValue < -140)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_n15;
        }
        else if (i4EVValue < -120)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_n13;
        }
        else if (i4EVValue < -90)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_n10;
        }
        else if (i4EVValue < -60)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_n07;
        }
        else if (i4EVValue < -40)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_n05;
        }
        else if (i4EVValue < -10)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_n03;
        }
        else if (i4EVValue == 0)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_00;
        ...
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_03;
        }
        else if (i4EVValue < 60)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_05;
        }
        else if (i4EVValue < 90)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_07;
        }
        else if (i4EVValue < 110)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_10;
        }
        else if (i4EVValue < 140)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_13;
        }
        else if (i4EVValue < 160)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_15;
        }
        else if (i4EVValue < 180)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_17;
        }
        else if (i4EVValue < 210)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_20;
        }
        else if (i4EVValue < 260)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_25;
        }
        else if (i4EVValue < 310)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_30;
        }
        else if (i4EVValue < 360)
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_35;
        }
        else
        {
            m_eAEEVcomp = LIB3A_AE_EV_COMP_40;
        }
...
MINT32 AeMgr::getEVCompensateIndex()
{
    ...
    switch (m_eAEEVcomp)
    {
    case LIB3A_AE_EV_COMP_03:
    {
        iEVIndex = 3;
        break;
    }
    case LIB3A_AE_EV_COMP_05:
    {
        iEVIndex = 5;
        break;
    }
    case LIB3A_AE_EV_COMP_07:
    {
        iEVIndex = 7;
        break;
    }
    case LIB3A_AE_EV_COMP_10:
    {
        iEVIndex = 10;
        break;
    }
    case LIB3A_AE_EV_COMP_13:
    {
        iEVIndex = 13;
        break;
    }
    case LIB3A_AE_EV_COMP_15:
    {
        iEVIndex = 15;
        break;
    }
    case LIB3A_AE_EV_COMP_17:
    {
        iEVIndex = 17;
        break;
    }
    case LIB3A_AE_EV_COMP_20:
    {
        iEVIndex = 20;
        break;
    }
    case LIB3A_AE_EV_COMP_25:
    {
        iEVIndex = 25;
        break;
    }
    case LIB3A_AE_EV_COMP_30:
    {
        iEVIndex = 30;
        break;
    }
    case LIB3A_AE_EV_COMP_35:
    {
        iEVIndex = 35;
        break;
    }
    case LIB3A_AE_EV_COMP_40:
    {
        iEVIndex = 40;
        break;
    }
    case LIB3A_AE_EV_COMP_n03:
    {
        iEVIndex = -3;
        break;
    }
    case LIB3A_AE_EV_COMP_n05:
    {
        iEVIndex = -5;
        break;
    }
    case LIB3A_AE_EV_COMP_n07:
    {
        iEVIndex = -7;
        break;
    }
    case LIB3A_AE_EV_COMP_n10:
    {
        iEVIndex = -10;
        break;
    }
    case LIB3A_AE_EV_COMP_n13:
    {
        iEVIndex = -13;
        break;
    }
    case LIB3A_AE_EV_COMP_n15:
    {
        iEVIndex = -15;
        break;
    }
    case LIB3A_AE_EV_COMP_n17:
    {
        iEVIndex = -17;
        break;
    }
    case LIB3A_AE_EV_COMP_n20:
    {
        iEVIndex = -20;
        break;
    }
    case LIB3A_AE_EV_COMP_n25:
    {
        iEVIndex = -25;
        break;
    }
    case LIB3A_AE_EV_COMP_n30:
    {
        iEVIndex = -30;
        break;
    }
    case LIB3A_AE_EV_COMP_n35:
    {
        iEVIndex = -35;
        break;
    }
    case LIB3A_AE_EV_COMP_n40:
    {
        iEVIndex = -40;
        break;
    }
...
MRESULT AeMgr::setAEMinMaxFrameRate(MINT32 i4NewAEMinFps, MINT32 i4NewAEMaxFps)
{
    ...
    if ((m_i4AEMinFps != i4NewMinFPS) || (m_i4AEMaxFps != i4NewMaxFPS))
    {
        ...
        ALOGD("m_i4AEMinFps: %d m_i4AEMaxFps:%d\n", m_i4AEMinFps, m_i4AEMaxFps);
        if (m_pIAeAlgo != NULL)
        {
...
//          localTimer.End();
            ...
            if ((m_bIsAutoFlare == MTRUE) && m_eAEMode != LIB3A_AE_MODE_OFF)
            {
...
MRESULT AeMgr::getAEMeteringYvalue(AEMeterArea_T rWinSize, MUINT8 *uYvalue)
{
    ...
    if (sAEMeteringArea.i4Left   < -1000)
    {
        sAEMeteringArea.i4Left   = -1000;
    }
    if (sAEMeteringArea.i4Right  < -1000)
    {
        sAEMeteringArea.i4Right  = -1000;
    }
    if (sAEMeteringArea.i4Top    < -1000)
    {
        sAEMeteringArea.i4Top    = -1000;
    }
    if (sAEMeteringArea.i4Bottom < -1000)
    {
        sAEMeteringArea.i4Bottom = -1000;
    }
...
//                        m_rAEOutput.rPreviewMode.u4IspGain);
        ...
        if (u2FrameRate != 0)
        {
            ...
            if (m_rSensorCurrentInfo.u8FrameDuration < (MINT64)mPreviewMode.u4Eposuretime*1000UL)
            {
                m_rSensorCurrentInfo.u8FrameDuration = (MINT64)mPreviewMode.u4Eposuretime*1000UL;
            }
        }
        else
        {
