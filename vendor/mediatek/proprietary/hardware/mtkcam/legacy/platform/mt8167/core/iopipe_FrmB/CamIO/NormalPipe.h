...
class NormalPipe : virtual public IHalCamIO, public INormalPipe
{
public:
...
public:
    ...
    virtual MBOOL   configPipe(QInitParam const& vInPorts, NSImageio::NSIspio::EScenarioID const eSWScenarioID) = 0;
