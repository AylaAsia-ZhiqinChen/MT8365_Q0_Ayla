...
#define LOG_TAG "MtkCam/PrvCQT_Default"
...
public:
    ...
    bool init(uint32_t scenarioId)
    {
        ...
        {
            MY_LOGD("---- gInfo.openId = %d", gInfo.openId);
            meSensorDev = pHalSensorList->querySensorDevIdx(gInfo.openId);
            MY_LOGD("---- meSensorDev = %d", meSensorDev);
...
start()
{
    ...
    ERawPxlID bitorder = ERawPxlID_B;
...
startRecording()
{
    ...
    {
        MY_LOGD("---- gInfo.openId = %d", gInfo.openId);
        MY_LOGD("---- Sensor:Type(%d),BitDepth(%d),Order(%d)",
            mSensorInfo.mSensorStaticInfo.sensorType,
            mSensorInfo.mSensorStaticInfo.rawSensorBit,
            mSensorInfo.mSensorStaticInfo.sensorFormatOrder);
