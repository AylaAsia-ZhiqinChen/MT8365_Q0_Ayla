...
do_CroppedPostviewResize(void)
{
	...
	MY_DBG("---- mPostviewFormat= 0x%x ",mPostviewFormat);	
	if (mPostviewFormat == eImgFmt_UNKNOWN)
	{
	    MY_DBG("[do_CroppedPostviewResize] mPostviewFormat:eImgFmt_UNKNOWN -> eImgFmt_YV12 ");  
		mPostviewFormat = eImgFmt_YV12;
	}    
