...
*/    //
    ...
    public:     //// constructors.
        CamPathPass2Parameter(
          ...
          isEsfkoStatusFixed(0),isFlkiStatusFixed(0),
          isLcsoStatusFixed(0),isEn1AaaGropStatusFixed(0),isApplyTurn(0),isShareDmaCtlByTurn(0),
          bypass_ispRawPipe(0),bypass_ispRgbPipe(0),bypass_ispYuvPipe(0),bypass_ispCdpPipe(0),
          pix_id(0)
        {
