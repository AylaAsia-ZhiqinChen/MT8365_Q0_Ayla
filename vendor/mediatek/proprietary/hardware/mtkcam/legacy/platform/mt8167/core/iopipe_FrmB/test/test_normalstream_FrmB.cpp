...
static MVOID* onThreadLoop(MVOID *arg)
{
    ...
    if(multiThread_case==6)
    {
        switch(multiThread_type)
        {
            case 0:
                {
                    //object init
                    pCCStream= NSCam::NSIoPipe::NSPostProc_FrmB::INormalStream::createInstance("onThreadLoop", NSCam::NSIoPipe::ENormalStreamTag_Stream,0xFFFF, isV3);
                    pCCStream->init();
                    //////////////////////////
            ...
            case 1:
                {
                    pIPStream= NSCam::NSIoPipe::NSPostProc_FrmB::INormalStream::createInstance("onThreadLoop", NSCam::NSIoPipe::ENormalStreamTag_IPRaw,0xFFFF, isV3);
                    pIPStream->init();
                    //////////////////////////
                    //prepare dma data, imgi
                    MUINT32 bufStridesInBytes[3] = {1280, 0, 0};
    ...
    {    // temp use 960x640, TO DO 2560x1440 later
        ...
        switch (multiThread_type)
        {
            default:
            case 0:
                pStreamObj= NSCam::NSIoPipe::NSPostProc_FrmB::INormalStream::createInstance("onThreadLoop", NSCam::NSIoPipe::ENormalStreamTag_Stream,0xFFFF, bTuning);
                break;
            case 1:
                pStreamObj= NSCam::NSIoPipe::NSPostProc_FrmB::INormalStream::createInstance("onThreadLoop", NSCam::NSIoPipe::ENormalStreamTag_Vss,0xFFFF, bTuning);
                break;
        }
        pStreamObj->init();
        //////////////////////////
...
*/                    
...

    {
        ...
        switch(casenum)
        {
            case 2:
            case 3:
                pStream= NSCam::NSIoPipe::NSPostProc_FrmB::INormalStream::createInstance(LOG_TAG, NSCam::NSIoPipe::ENormalStreamTag_IPRaw,0xFFFF, isV3);
                break;
            default:
                pStream= NSCam::NSIoPipe::NSPostProc_FrmB::INormalStream::createInstance(LOG_TAG, NSCam::NSIoPipe::ENormalStreamTag_Stream,0xFFFF, isV3);
                break;
        }
        pStream->init();
        IMemDrv* mpImemDrv=NULL;
    ...
    switch (casenum)
    {
        case 6:
            if(type==1)
            {
                ...
                NSCam::NSIoPipe::NSPostProc_FrmB::INormalStream* pCCStream;
                //object init
                pCCStream= NSCam::NSIoPipe::NSPostProc_FrmB::INormalStream::createInstance("pass2_loopTest", NSCam::NSIoPipe::ENormalStreamTag_Stream,0xFFFF, isV3);
                pCCStream->init();
                //////////////////////////
                //prepare dma data, imgi
                IMEM_BUF_INFO imgiBuf;
        ...
        case 7:
            if(type==1)
            {
                ...
                for(int i=0;i<10;i++)
                {
                    ...
                    pCCStream->deque(dequeParams);
                    ///////////////////////////
                    LOG_INF("dequemvOutsize(%lu)",dequeParams.mvOut.size());
                    //save image
                    char filename[256];
        ...
        case 8:
            {
                ...
                NSCam::NSIoPipe::NSPostProc_FrmB::INormalStream* pCCStream;
                //object init
                pCCStream= NSCam::NSIoPipe::NSPostProc_FrmB::INormalStream::createInstance("pass2_loopTest", NSCam::NSIoPipe::ENormalStreamTag_Stream,0xFFFF, bTuning);
                pCCStream->init();
                //////////////////////////
                //prepare dma data, imgi
                IMEM_BUF_INFO imgiBuf;
...
int pass2_multiEnqueTest(int casenum, int type)
{
    ...
    NSCam::NSIoPipe::NSPostProc_FrmB::INormalStream* pCCStream;
    //object init
    pCCStream= NSCam::NSIoPipe::NSPostProc_FrmB::INormalStream::createInstance("pass2_multiEnqueTest", NSCam::NSIoPipe::ENormalStreamTag_Stream,0, isV3);
    pCCStream->init();
...
void *Vss_Thread(void *data)
{
    ...
    NSCam::NSIoPipe::NSPostProc_FrmB::INormalStream* pStream = NSCam::NSIoPipe::NSPostProc_FrmB::INormalStream::createInstance(LOG_TAG,
        NSCam::NSIoPipe::ENormalStreamTag_Vss,0xFFFF, isV3);
...
#define P2_TUNINGQUE_NUM    10
    ...
    //objects
    NSCam::NSIoPipe::NSPostProc_FrmB::INormalStream* pStream = NSCam::NSIoPipe::NSPostProc_FrmB::INormalStream::createInstance(LOG_TAG,
        NSCam::NSIoPipe::ENormalStreamTag_Stream,0xFFFF, isV3);
    ...
    for(MUINT32 i=0;i<P2_TUNINGQUE_NUM;i++){
        ...
        LOG_INF("i(%d),size(0x%x),pTuningQueBuf(0x%lx)\n",i,size,(unsigned long)pTuningQueBuf[i]);
    }
    ...
    for(MUINT32 i=0;i<P2_TUNINGQUE_NUM;i++){
        LOG_INF("i(%d),pTuningQueBuf(0x%lx)\n",i,(unsigned long)pTuningQueBuf[i]);
