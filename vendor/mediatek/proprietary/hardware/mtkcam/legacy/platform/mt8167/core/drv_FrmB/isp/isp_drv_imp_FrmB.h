...
class IspDrvImp : public IspDrv
{
    ...
    public:
        ...
        //
        virtual MBOOL getIspCQModuleInfo(CAM_MODULE_ENUM eModule,ISP_DRV_CQ_MODULE_INFO_STRUCT &outInfo) {eModule;outInfo;return MFALSE;}//not support in phy
...
class IspDrvVirImp : public IspDrv
{
    ...
    public:
        ...
        virtual void    destroyInstance(void);
        virtual MBOOL   init(const char* userName=""){ /*LOG_ERR("Not support");*/userName;return MTRUE;}
        virtual MBOOL   uninit(const char* userName=""){/*LOG_ERR("Not support");*/userName;return MTRUE;}
        virtual MBOOL   waitIrq(ISP_DRV_WAIT_IRQ_STRUCT* pWaitIrq){/*LOG_ERR("Not support");*/pWaitIrq;return MTRUE;}
        virtual MINT32   registerIrq(const char* userName) {/*LOG_ERR("Not support");*/userName;return MTRUE;}
        virtual MBOOL   markIrq(ISP_DRV_WAIT_IRQ_STRUCT Irqinfo) {/*LOG_ERR("Not support");*/Irqinfo;return MTRUE;}
        virtual MBOOL   flushIrq(ISP_DRV_WAIT_IRQ_STRUCT Irqinfo) {/*LOG_ERR("Not support");*/Irqinfo;return MTRUE;}
        virtual MBOOL   queryirqtimeinfo(ISP_DRV_WAIT_IRQ_STRUCT* Irqinfo) {/*LOG_ERR("Not support");*/Irqinfo;return MTRUE;}
        virtual MBOOL   readIrq(ISP_DRV_READ_IRQ_STRUCT* pReadIrq){/*LOG_ERR("Not support");*/pReadIrq;return MTRUE;}
        virtual MBOOL   checkIrq(ISP_DRV_CHECK_IRQ_STRUCT CheckIrq){/*LOG_ERR("Not support");*/CheckIrq;return MTRUE;}
        virtual MBOOL   clearIrq(ISP_DRV_CLEAR_IRQ_STRUCT ClearIrq){/*LOG_ERR("Not support");*/ClearIrq;return MTRUE;}
        virtual MBOOL   reset(MINT32 rstpath);
        ...
        virtual MBOOL   writeReg(
            ...
            MINT32      userEnum=ISP_DRV_USER_OTHER,
            MINT32      caller=0);
        virtual MBOOL   holdReg(MBOOL En){/*LOG_ERR("Not support");*/En;return MTRUE;}
        virtual MBOOL   dumpReg(void){/*LOG_ERR("Not support");*/return MTRUE;}
        virtual MBOOL   checkTopReg(MUINT32 Addr) {return IspDrv::checkTopReg(Addr);}
        virtual isp_reg_t*   getCurHWRegValues() {return NULL;}
        virtual MBOOL   ISPWakeLockCtrl(MBOOL WakeLockEn) {WakeLockEn;return MTRUE;};
        //
        virtual MBOOL   rtBufCtrl(void *pBuf_ctrl){pBuf_ctrl;return MTRUE;}
        virtual MUINT32 pipeCountInc(EIspDrvPipePath ePipePath){ePipePath;return MTRUE;};
        virtual MUINT32 pipeCountDec(EIspDrvPipePath ePipePath){ePipePath;return MTRUE;};
        //
        virtual MBOOL loadInitSetting(void){return MTRUE;};
        // debug information
        virtual MBOOL dumpCQTable(ISP_DRV_CQ_ENUM cq,MINT32 burstQIdx=0,MUINT32 dupCqIdx=0, ISP_DRV_CQ_CMD_DESC_STRUCT* cqDesVa=0, MUINT32* cqVirVa=0){cq;burstQIdx;dupCqIdx;cqDesVa;cqVirVa;return MTRUE;};
        virtual MBOOL dumpDBGLog(MUINT32* P1,IspDumpDbgLogP2Package* pP2Package){P1;pP2Package;return MTRUE;};
        //
        // tuning
        virtual MBOOL   bypassTuningQue(ESoftwareScenario softScenario, MINT32 magicNum){softScenario;magicNum;return MFALSE;};
        virtual MBOOL   deTuningQue(ETuningQueAccessPath path, ESoftwareScenario softScenario, MINT32 magicNum){path;softScenario;magicNum;return MFALSE;};
        virtual MBOOL   enTuningQue(ETuningQueAccessPath path, ESoftwareScenario softScenario, MINT32 magicNum, EIspTuningMgrFunc updateFuncBit){path;softScenario;magicNum;updateFuncBit;return MFALSE;};
        virtual MBOOL   deTuningQueByCq(ETuningQueAccessPath path, ISP_DRV_CQ_ENUM eCq, MINT32 magicNum){path;eCq;magicNum;return MFALSE;};
        virtual MBOOL   enTuningQueByCq(ETuningQueAccessPath path, ISP_DRV_CQ_ENUM eCq, MINT32 magicNum, EIspTuningMgrFunc updateFuncBit){path;eCq;magicNum;updateFuncBit;return MFALSE;};
        virtual MBOOL setP2TuningStatus(ISP_DRV_CQ_ENUM cq, MBOOL en){cq;en;return MFALSE;};
        virtual MBOOL getP2TuningStatus(ISP_DRV_CQ_ENUM cq){cq;return MFALSE;};
        virtual MUINT32 getTuningUpdateFuncBit(ETuningQueAccessPath ePath, MINT32 cq, MUINT32 drvScenario=0, MBOOL isV3=MTRUE){ePath;cq;drvScenario;isV3;return eIspTuningMgrFunc_Null;};
        virtual MUINT32 getTuningTop(ETuningQueAccessPath ePath, ETuningTopEn top, MINT32 cq, MUINT32 magicNum=0){ePath;top;cq;magicNum;return -1;};
        virtual MUINT32* getTuningBuf(ETuningQueAccessPath ePath, MINT32 cq){ePath;cq;return NULL;};
        virtual MBOOL   getCqInfoFromScenario(ESoftwareScenario softScenario, ISP_DRV_CQ_ENUM &cq){softScenario;cq;return MFALSE;};
        virtual MBOOL   getP2cqInfoFromScenario(ESoftwareScenario softScenario, ISP_DRV_P2_CQ_ENUM &p2Cq){softScenario;p2Cq;return MFALSE;};
        virtual MBOOL   getTuningTpipeFiled(ISP_DRV_P2_CQ_ENUM p2Cq, stIspTuningTpipeFieldInf &pTuningField){p2Cq;pTuningField;return MFALSE;};
        virtual MBOOL   mapCqToP2Cq(ISP_DRV_CQ_ENUM cq, ISP_DRV_P2_CQ_ENUM &p2Cq){cq;p2Cq;return MFALSE;};
        //
        virtual MBOOL getCqModuleInf(CAM_MODULE_ENUM moduleId, MUINT32 &addrOffset, MUINT32 &moduleSize);
        // slow motion feature, support burst Queue control
        virtual MBOOL cqTableControl(ISP_DRV_CQTABLE_CTRL_ENUM cmd,int burstQnum) {cmd;burstQnum;return MFALSE;};
        virtual MINT32 cqNumInfoControl(ISP_DRV_CQNUMINFO_CTRL_ENUM cmd,int newValue=0) {cmd;newValue;return MFALSE;};
        //
        // dequeue mechanism in ihalpipewarpper
        virtual MBOOL   enqueP2Frame(MUINT32 callerID,MINT32 p2burstQIdx,MINT32 p2dupCQIdx) {callerID;p2burstQIdx;p2dupCQIdx;return MFALSE;};
        virtual MBOOL   waitP2Deque() {return MFALSE;};
        virtual MBOOL   dequeP2FrameSuccess(MUINT32 callerID,MINT32 p2dupCQIdx) {callerID;p2dupCQIdx;return MFALSE;};
        virtual MBOOL   dequeP2FrameFail(MUINT32 callerID,MINT32 p2dupCQIdx) {callerID;p2dupCQIdx;return MFALSE;};
        virtual MBOOL   waitP2Frame(MUINT32 callerID,MINT32 p2dupCQIdx,MINT32 timeoutUs) {callerID;p2dupCQIdx;timeoutUs;return MFALSE;};
        virtual MBOOL   wakeP2WaitedFrames() {return MFALSE;};
        virtual MBOOL   freeAllP2Frames() {return MFALSE;};
        //
        //update/query register Scenario
        virtual MBOOL   updateScenarioValue(MUINT32 value) {value;return MFALSE;};
        virtual MBOOL   queryScenarioValue(MUINT32& value) {value;return MFALSE;};
        //
        //
        //temp remove later
        ...
        virtual MBOOL SetFPS(MUINT32 _fps){_fps;return MFALSE;}
        virtual MBOOL updateCq0bRingBuf(void *pOBval){pOBval;return MTRUE;};
    protected:
        virtual MBOOL dumpP2DebugLog(IspDumpDbgLogP2Package* pP2Package){pP2Package;return MTRUE;};
        virtual MBOOL dumpP1DebugLog(MUINT32* P1){P1;return MTRUE;};
    public:
        isp_reg_t* mpIspVirRegMap;//for calculating offset in register read/write macro
    private:
        virtual MBOOL   searchTuningQue(ISP_DRV_P2_CQ_ENUM p2Cq, MINT32 magicNum, MINT32 &getQueIdx){p2Cq;magicNum;getQueIdx;return MFALSE;};
        virtual MBOOL   orderSearchTuningQue(ISP_DRV_P2_CQ_ENUM p2Cq, MINT32 magicNum, MUINT32 start, MUINT32 end, MINT32 &getQueIdx){p2Cq;magicNum;start;end;getQueIdx;return MFALSE;};
        virtual MUINT32* getRegAddr(void);
        mutable Mutex   mLock;
