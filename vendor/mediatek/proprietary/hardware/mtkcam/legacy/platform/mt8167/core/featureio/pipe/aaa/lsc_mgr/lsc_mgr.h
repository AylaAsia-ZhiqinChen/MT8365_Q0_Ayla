...
class LscMgr {
    ...
    public:
        ...
        MVOID*
        getPhyTBA() const {
            printf("[%s] LscScenario %d, CT %d, Addr 0x%08lx\n", __FUNCTION__,
                    m_eLscScenario,
                    m_u4CTIdx,
                    (unsigned long)(stRawLscInfo[m_eLscScenario].phyAddr+m_u4CTIdx*getPerLutSize(m_eLscScenario)));
        ...
        getVirTBA() const {
            printf("[%s] LscScenario %d, CT %d, Addr 0x%08lx\n", __FUNCTION__,
                    m_eLscScenario,
                    m_u4CTIdx,
                    (unsigned long)(stRawLscInfo[m_eLscScenario].virtAddr+m_u4CTIdx*getPerLutSize(m_eLscScenario)));
