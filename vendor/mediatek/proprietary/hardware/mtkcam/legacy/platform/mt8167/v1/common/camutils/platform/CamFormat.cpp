...
public:     ////            Attributes.
    ...
    virtual size_t          getWidthStride(size_t imgWidth,__attribute__((unused)) size_t planeIndex) const    { return imgWidth; }
    virtual size_t          getHeightStride(size_t imgHeight, size_t planeIndex) const
                            {
                                return  (0 == planeIndex)
                                    ?   (imgHeight)         //  Y
...
public:     ////            Attributes.
    virtual size_t          getImgBufferSize(size_t imgWidth, size_t imgHeight) const   { return (getBitsPerPixel() * getImgWidthStride(imgWidth, 0) * getImgHeightStride(imgHeight, 0)) >> 3; }
    virtual size_t          getWidthStride(size_t imgWidth,__attribute__((unused)) size_t planeIndex) const    { return imgWidth; }
    virtual size_t          getHeightStride(size_t imgHeight,__attribute__((unused)) size_t planeIndex) const  { return imgHeight; }
...
public:
   ...
   virtual size_t           getImgWidthStride(size_t imgWidth,__attribute__((unused)) size_t planeIndex) const
                            {
...
public:     ////            Attributes.
    virtual size_t          getImgBufferSize(__attribute__((unused))size_t imgWidth,__attribute__((unused)) size_t imgHeight) const   { return 0; }
    virtual size_t          getWidthStride(size_t imgWidth,__attribute__((unused)) size_t planeIndex) const    { return imgWidth; }
    virtual size_t          getHeightStride(size_t imgHeight,__attribute__((unused)) size_t planeIndex) const  { return imgHeight; }
...
queryPlaneCount(char const* szPixelFormat)
{
    ...
    if  ( CamFmtBase* p = getCamFmtMap().valueFor(String8(szPixelFormat)) )
    {
        ...
        MY_LOGV("[%s] Plane Count: %zu", szPixelFormat, PlaneCount);
        return  PlaneCount;
    }
    //
    MY_LOGW("Unsupported CameraParameters::PIXEL_FORMAT_xxx (%s)", szPixelFormat);
...
queryImgWidthStride(char const* szPixelFormat, size_t imgWidth, size_t planeIndex)
{
    ...
    if  ( CamFmtBase* p = getCamFmtMap().valueFor(String8(szPixelFormat)) )
    {
        ...
        MY_LOGV("[%s] %zuth-plane stride(%zu) for image width(%zu)", szPixelFormat, planeIndex, WidthStride, imgWidth);
        return  WidthStride;
    }
    //
    MY_LOGW("Unsupported CameraParameters::PIXEL_FORMAT_xxx (%s)", szPixelFormat);
...
queryImgHeightStride(char const* szPixelFormat, size_t imgHeight, size_t planeIndex)
{
    ...
    if  ( CamFmtBase* p = getCamFmtMap().valueFor(String8(szPixelFormat)) )
    {
        ...
        MY_LOGV("[%s] %zuth-plane stride(%zu) for image height(%zu)", szPixelFormat, planeIndex, HeightStride, imgHeight);
        return  HeightStride;
    }
    //
    MY_LOGW("Unsupported CameraParameters::PIXEL_FORMAT_xxx (%s)", szPixelFormat);
...
queryImgBufferSize(char const* szPixelFormat, size_t imgWidth, size_t imgHeight)
{
    ...
    if  ( CamFmtBase* p = getCamFmtMap().valueFor(String8(szPixelFormat)) )
    {
        ...
        MY_LOGD("[%s] %zux%zu image buffer size: %zu", szPixelFormat, imgWidth, imgHeight, bufsize);
        return  bufsize;
    }
    //
    MY_LOGW("Unsupported CameraParameters::PIXEL_FORMAT_xxx (%s)", szPixelFormat);
