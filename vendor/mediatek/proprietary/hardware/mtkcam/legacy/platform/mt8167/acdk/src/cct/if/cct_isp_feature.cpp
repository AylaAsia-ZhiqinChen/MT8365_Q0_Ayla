...
{
    u4ParaInLen;puParaOut;u4ParaOutLen;pu4RealParaOutLen;
...
{
    puParaOut;u4ParaOutLen;pu4RealParaOutLen;
...
{
    puParaIn;u4ParaInLen;puParaOut;u4ParaOutLen;pu4RealParaOutLen;
...
{
    puParaIn;u4ParaInLen;u4ParaOutLen;pu4RealParaOutLen;
    if  ( ! puParaOut )
        return  CCTIF_BAD_PARAM;
