...
using namespace NSCam::legacy::NSImageBufferHeap;
//
#include <dlfcn.h>
...
createImageBuffer(ImgBufCreator* /*pCreator*/)
{
    ...
    NSCam::legacy::NSImageBuffer::BaseImageBuffer* pImgBuffer = NULL;
    pImgBuffer = new NSCam::legacy::NSImageBuffer::BaseImageBuffer(this, getImgSize(), getImgFormat(), getBitstreamSize(), bufStridesInBytes);
    if  ( ! pImgBuffer )
    {
...
)
{
    ...
    NSCam::legacy::NSImageBuffer::BaseImageBuffer* pImgBuffer = NULL;
    pImgBuffer = new NSCam::legacy::NSImageBuffer::BaseImageBuffer(this, imgSize, getImgFormat(), getBitstreamSize(), bufStridesInBytes, offsetInBytes);
    //
    if  ( ! pImgBuffer )
    {
        CAM_LOGE("Fail to new");
...
)
{
    ...
    //
    NSCam::legacy::NSImageBuffer::BaseImageBuffer* pImgBuffer = NULL;
    pImgBuffer = new NSCam::legacy::NSImageBuffer::BaseImageBuffer(this, imgSize, imgFormat, getBitstreamSize(), bufStridesInBytes, offsetInBytes);
    //
    if  ( ! pImgBuffer )
    {
        CAM_LOGE("Fail to new");
...
createImageBuffer_SideBySide(MBOOL isRightSide)
{
    ...
    //
    NSCam::legacy::NSImageBuffer::BaseImageBuffer* pImgBuffer = NULL;
    pImgBuffer = new NSCam::legacy::NSImageBuffer::BaseImageBuffer(this, SBSImgSize, getImgFormat(), getBitstreamSize(), bufStridesInBytes, offset);
    if  ( ! pImgBuffer )
    {
        CAM_LOGE("Fail to new");
        return NULL;
...
{
    MY_LOGW("not support for legacy platform");
    return MFALSE;
}
