...
public:     ////                Operations: IMap
    ...
    virtual IUsersManager*      usersManagerAt(size_t index) const      {
            if (mMap.valueAt(index) == NULL) {
                CAM_LOGW("[usersManagerAt] mMap.valueAt(%d) == NULL", index);
                return NULL;
            }
            if (mMap.valueAt(index)->mUsersManager == NULL) {
                CAM_LOGW("[usersManagerAt] mMap.valueAt(%d)->mUsersManager == NULL", index);
                return NULL;
            }
...
public:     ////                    Configuration.
    ...
    virtual MERROR                  setIsP2HalYuvJpegSupport(MBOOL value);
...
public:     ////                    Attributes.
    ...
    virtual MBOOL                   getIsP2HalYuvJpegSupport() const {
                                        return mIsP2HalYuvJpegSupport;
                                    }
