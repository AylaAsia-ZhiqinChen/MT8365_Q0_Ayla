...
struct  evaluate_request::Imp
{
    ...
    operator()(Params& rParams, IEvaluator const* pEvaluator)
    {
        ...
        pFrame->setIsP2HalYuvJpegSupport(aEvaluateRequestPipelineParams.isP2HalYuvJpegSupport);
...
struct  evaluate_request_pipeline::Imp
{
    ...
    operator()(Params& rParams, IEvaluator const* pEvaluator) const
    {
        ...
        do
        {
            ...
            // Mark whether hal yul jpeg is support in P2Node.
            rParams.isP2HalYuvJpegSupport = nodeReq.isP2HalYuvJpegSupport;
