...
namespace android {
    namespace camera {
	    ...
	    int generatePrvSizeValues(int max_w, int max_h, char ***size_arr, int force_ratio);
            ...
            int addExtraPictureSizes( char const ** defaultSizes, int defaultSize, char const ** extraSizes, int extraSize);

            const char **getPrvSizes(char const *maxPrvSize, int * pCnt, int facing);
            int addExtraPreviewSizes( char const ** defaultSizes, int defaultSize, char const ** extraSizes, int extraSize);

	    const char **getVideoSizes(char const *maxPicSize, int * pCnt, int facing);
	    int addExtraVideoSizes( char const ** defaultSizes, int defaultSize, char const ** extraSizes, int extraSize);
        }
    }
}
//
