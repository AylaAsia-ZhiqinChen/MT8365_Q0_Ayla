...
/**
 * @file CamCfgSetter_Legacy.h
 *
 * Set advance camera config for legacy platform use
 *
 */

#ifndef _CAM_CFG_SETTER_H_
#define _CAM_CFG_SETTER_H_
...
protected:
        ...
        virtual ~CamCfgSetter() {};

}; // class CamCfgSetter end
