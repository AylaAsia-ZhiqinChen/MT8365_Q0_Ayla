...
LOCAL_BUILD_DEVICEMGR_RELATIVE_PATH ?= .
...
MTKCAM_HAVE_DEVMETAINFO         ?= '1'  # built-in if '1' ; otherwise not built-in

#-----------------------------------------------------------
LOCAL_SRC_FILES += $(LOCAL_BUILD_DEVICEMGR_RELATIVE_PATH)/instance.cpp
LOCAL_SRC_FILES += $(LOCAL_BUILD_DEVICEMGR_RELATIVE_PATH)/CameraDeviceManagerImpl.cpp
...
#$(warning "warning: FIXME: MTKCAM_HAVE_SENSOR_HAL=0")
endif
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
ifeq "'1'" "$(strip $(MTKCAM_HAVE_FLASH_HAL))"
LOCAL_SHARED_LIBRARIES += libcam.hal3a.v3
else
#$(warning "warning: FIXME: MTKCAM_HAVE_FLASH_HAL=0")
endif
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#$(warning "warning: FIXME: MTKCAM_HAVE_DEVMETAINFO=0")
endif
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
