...
#-----------------------------------------------------------
LOCAL_SRC_FILES += CameraProviderImpl.cpp
...
#
LOCAL_CFLAGS += -DLOG_TAG='"mtkcam-camprovider"'
#
...
LOCAL_SHARED_LIBRARIES += libladder libutils

#-----------------------------------------------------------
LOCAL_MODULE := android.hardware.camera.provider@2.4-impl-static
