...
#Only ADVCAM Support need to trigger build
ifeq ($(MTK_CAM_ADV_CAM_SUPPORT), yes)

#-----------------------------------------------------------
LOCAL_SRC_FILES += AdvCamControl.cpp

#-----------------------------------------------------------
# Need to search legacy/include first
...
#-----------------------------------------------------------
LOCAL_MODULE := vendor.mediatek.hardware.camera.advcam@1.0-impl
...
endif # ifneq ($(MTK_CAM_ADV_CAM_SUPPORT), yes) end
