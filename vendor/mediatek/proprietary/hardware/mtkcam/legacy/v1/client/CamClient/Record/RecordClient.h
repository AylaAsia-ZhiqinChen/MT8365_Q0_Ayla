...
protected:  ////
    ...
    volatile uint32_t               mVrBufCnt;
    volatile uint32_t               mExtraRecBufNum;
    volatile uint32_t               mAllocatedExtraRecBufNum;
