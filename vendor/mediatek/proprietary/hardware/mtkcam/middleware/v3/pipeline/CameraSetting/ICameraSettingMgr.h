...
#ifndef _MTKCAM_CAMEMRA_SETTING_MGR_H_
#define _MTKCAM_CAMEMRA_SETTING_MGR_H_

#include <utils/RefBase.h>
#include <mtkcam/def/common.h>
#include <mtkcam/feature/hdrDetection/Defs.h>
#include <mtkcam/drv/IHalSensor.h>
#include <mtkcam/middleware/v3/PipelineModel.typedef.h>
...
class CameraSettingMgr : public android::RefBase
{
public:
    ...
    static sp<CameraSettingMgr> getInstance(const MUINT32 sensorIdx);
     ...
     * @return : error code
     */
    virtual int generateCamSetting(PipeConfigParams const& rConfigParams, MyProcessedParams &CamConfig);
...
#endif // _MTKCAM_CAMEMRA_SETTING_MGR_H_
