...
/**
 * @file PostViewImageCallback.h
 * @brief PostViewImageCallback interface.
*/

#ifndef _MTK_LEGACYPIPELINE_STEREO_SHOT_POSTVIEW_IMETACALLBACK_H_
#define _MTK_LEGACYPIPELINE_STEREO_SHOT_POSTVIEW_IMETACALLBACK_H_
 ...
 */
class PostViewImageCallback : public IImageShotCallback
{
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Instantiation.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
// Constructor
    PostViewImageCallback() = delete;
    PostViewImageCallback(ImageCallbackParams params);

protected:
// Destructor
   virtual ~PostViewImageCallback();
...
public:
    ...
    CaptureRequestCB getCBType() override { return CaptureRequestCB::POSTVIEW; }
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
