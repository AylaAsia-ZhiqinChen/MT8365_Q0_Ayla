...
namespace p2
{
namespace DngCap_3rdParty_Async
{
static const struct MetaStreamManager::metadata_info_setting gStereoMetaTbl_P2DNGCap[] =
{
    ...
    //p2 - output
    {"App:Meta:P2Out",              eSTREAMID_META_APP_DYNAMIC_P2,          eSTREAMTYPE_META_OUT,    0, 0, eStreamType_META_APP},
    {"App:Meta:P2Out_01",           eSTREAMID_META_APP_DYNAMIC_P2_MAIN2,    eSTREAMTYPE_META_OUT,    0, 0, eStreamType_META_APP},
    {"Hal:Meta:P2Out",              eSTREAMID_META_HAL_DYNAMIC_P2,          eSTREAMTYPE_META_INOUT,   9, 9, eStreamType_META_HAL},
    {"Hal:Meta:P2Out_01",           eSTREAMID_META_HAL_DYNAMIC_P2_MAIN2,    eSTREAMTYPE_META_INOUT,   9, 9, eStreamType_META_HAL},
    // End
    {"", 0, 0, 0, 0},
};
//
static struct ImageStreamManager::image_stream_info_pool_setting gStereoImgStreamTbl_P2DNGCap[] =
{
    ...
    // p2 capture output
    {"Hal:Image:FullYuv",                  eSTREAMID_IMAGE_PIPE_THIRDPARTY_FULLSIZE_YUV_0, eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_YV12, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    {"Hal:Image:FullYuvMain2",             eSTREAMID_IMAGE_PIPE_THIRDPARTY_FULLSIZE_YUV_1, eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_YV12, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    {"Hal:Image:ResizeYuv",                eSTREAMID_IMAGE_PIPE_THIRDPARTY_RESIZE_YUV_0,   eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_YV12, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    {"Hal:Image:ResizeYuvMain2",           eSTREAMID_IMAGE_PIPE_THIRDPARTY_RESIZE_YUV_1,   eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_YV12, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
...
//
static struct ImageStreamManager::image_stream_info_pool_setting gStereoImgStreamTbl_P2DNGCap_wo_Main2_Full[] =
{
    // Hal
    // Dual3rdPartyNode - input/output
    {"Hal:Image:Pass2_FullRaw",            eSTREAMID_IMAGE_PIPE_RAW_OPAQUE,               eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READ,                              eImgFmt_YV12, MSize(4176, 3088), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL}, // temp run
