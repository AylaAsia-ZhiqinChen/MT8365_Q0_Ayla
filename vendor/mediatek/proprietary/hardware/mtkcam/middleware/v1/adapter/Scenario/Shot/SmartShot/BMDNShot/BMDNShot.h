...
#ifndef _MTK_CAMERA_CAMADAPTER_SCENARIO_SHOT_BMDNSHOT_H_
#define _MTK_CAMERA_CAMADAPTER_SCENARIO_SHOT_BMDNSHOT_H_
...
private:
    ...
    MBOOL           mForcePureZSD = MFALSE;

    MINT32          mMain1OpenId = -1;
    MINT32          mMain2OpenId = -1;

    std::set<MINT32>  mReqSet;
    mutable Mutex     mReqSetLock;
};
...
#endif  //  _MTK_CAMERA_CAMADAPTER_SCENARIO_SHOT_BMDNSHOT_H_
