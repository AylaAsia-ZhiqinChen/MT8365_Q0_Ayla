...
#ifndef _MTK_CAMERA_CAMADAPTER_SCENARIO_SHOT_VSSSHOT_H_
#define _MTK_CAMERA_CAMADAPTER_SCENARIO_SHOT_VSSSHOT_H_
...
#endif  //  _MTK_CAMERA_CAMADAPTER_SCENARIO_SHOT_VSSSHOT_H_
