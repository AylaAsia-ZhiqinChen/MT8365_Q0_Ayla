...
static struct ImageStreamManager::image_stream_info_pool_setting gStereoImgStreamTbl_P2Prv_Main2[] =
{
    ...
    {"App:Image:FD",                eSTREAMID_IMAGE_PIPE_DEPTHMAPNODE_FDYUV,           eSTREAMTYPE_IMAGE_OUT,   0, 0, eBUFFER_USAGE_SW_READ_OFTEN, eImgFmt_YUY2,        MSize(0, 0), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    {"App:Image:P2Tuning",          eSTREAMID_IMAGE_PIPE_STEREO_P2_TUNING,             eSTREAMTYPE_IMAGE_OUT,   0, 0, eBUFFER_USAGE_SW_READ_OFTEN, eImgFmt_STA_BYTE,    MSize(0, 0), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    // Bokeh - output
    {"App:Image:Preview",           eSTREAMID_IMAGE_PIPE_BOKEHNODE_PREVIEWYUV,         eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN, eImgFmt_YV12,        MSize(0, 0), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    {"App:Image:PreviewCB",         eSTREAMID_IMAGE_PIPE_YUV_01,                       eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN, eImgFmt_YV12,        MSize(0, 0), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    //End
    {"", 0, 0, 0, 0, 0, 0, MSize(), 0, 0, eStreamType(), 0},
};
//
