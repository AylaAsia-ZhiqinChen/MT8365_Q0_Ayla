...
/**
 * @file CollectCallback.h
 * @brief Collect callback
*/

#ifndef _MTK_LEGACYPIPELINE_STEREO_SHOT_COLLECT_CALLBACK_H_
#define _MTK_LEGACYPIPELINE_STEREO_SHOT_COLLECT_CALLBACK_H_
...
public:
// Constructor
    CollectCallback() = delete;
    CollectCallback(StreamId_T streamId, IMetadata metadata, MUINT32 type, MUINT32 slot);
...
public:
    ...
    CaptureRequestCB getCBType() override { return CaptureRequestCB::SHUTTER; }
};
