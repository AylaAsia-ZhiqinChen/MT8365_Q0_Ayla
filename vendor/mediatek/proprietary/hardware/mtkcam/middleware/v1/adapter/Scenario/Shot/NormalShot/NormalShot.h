...
protected:
    std::function<
        void(NSCamShot::ICamShot*)
    >                       // The deleter of NSCamShot::ICamShot
                            mpSingleShotDeleter;

    std::weak_ptr<
        NSCamShot::ICamShot
    >                       // The instance of NSCamShot::ICamShot
                            mpSingleShot;

    // The life extender of SingleShot instance. Since BackgroundService will
    // extend NormalShot instance life cycle, SingleShot instance life cycle
    // should be extended too.
    std::shared_ptr<
        NSCamShot::ICamShot
    >
                            mpSingleShotLifeExtender;
