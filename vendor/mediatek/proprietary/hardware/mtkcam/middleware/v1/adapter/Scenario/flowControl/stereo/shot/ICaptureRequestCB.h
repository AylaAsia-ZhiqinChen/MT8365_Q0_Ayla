...
#ifndef _MTK_LEGACYPIPELINE_STEREO_SHOT_CAPTURE_REQUEST_CB_H_
#define _MTK_LEGACYPIPELINE_STEREO_SHOT_CAPTURE_REQUEST_CB_H_
...
{
public:
    ICaptureRequestCB() = default;
    virtual ~ICaptureRequestCB(){}
    //
    virtual android::status_t onEvent(
                        MINT32  capNo,
