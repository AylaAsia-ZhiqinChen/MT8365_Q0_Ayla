...
static struct ImageStreamManager::image_stream_info_pool_setting gStereoImgStreamTbl_P2Cap_Main2[] =
{
    ...
    // DepthMapNode - output
    // Hal
    {"App:Image:MainImage_Cap",     eSTREAMID_IMAGE_PIPE_DEPTHMAPNODE_MAINIMAGE_CAPYUV,     eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN, eImgFmt_YV12,       MSize(0, 0), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    {"App:Image:HalDepthWrapper",   eSTREAMID_IMAGE_PIPE_DEPTHMAPNODE_HAL_DEPTHWAPPER,      eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN, eImgFmt_STA_BYTE,   MSize(1, 1), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    {"App:Image:LDCData",           eSTREAMID_IMAGE_PIPE_STEREO_DBG_LDC,                    eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN, eImgFmt_STA_BYTE,   MSize(0, 0), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    {"App:Image:ExtraData",         eSTREAMID_IMAGE_PIPE_STEREO_DBG,                        eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN, eImgFmt_STA_BYTE,   MSize(0, 0), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    {"App:Image:N3DDebug",          eSTREAMID_IMAGE_PIPE_STEREO_N3D_DEBUG,                  eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN, eImgFmt_STA_BYTE,   MSize(0, 0), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    // PostView
