...
/**
 * @file BgYuvImageCallback.h
 * @brief BgYuvImageCallback interface.
*/

#ifndef _MTK_LEGACYPIPELINE_STEREO_SHOT_BG_YUV_IMETACALLBACK_H_
#define _MTK_LEGACYPIPELINE_STEREO_SHOT_BG_YUV_IMETACALLBACK_H_
...
********************************************************************************/
/**
 * @class BgYuvImageCallback
 * @brief This callback will used for 3rd bg service
 */
class BgYuvImageCallback : public IImageShotCallback
{
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Instantiation.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
// Constructor
    BgYuvImageCallback() = delete;
    BgYuvImageCallback(ImageCallbackParams params);

protected:
// Destructor
   virtual ~BgYuvImageCallback();
...
public:
    ...
    CaptureRequestCB getCBType() override { return CaptureRequestCB::BGYUV; }
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
