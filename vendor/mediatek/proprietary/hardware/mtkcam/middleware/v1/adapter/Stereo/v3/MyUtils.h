...
#ifndef _MTK_HAL_CAMADAPTER_MTKSTEREO_INC_MYUTILS_H_
#define _MTK_HAL_CAMADAPTER_MTKSTEREO_INC_MYUTILS_H_
...
#endif  //_MTK_HAL_CAMADAPTER_MTKSTEREO_INC_MYUTILS_H_