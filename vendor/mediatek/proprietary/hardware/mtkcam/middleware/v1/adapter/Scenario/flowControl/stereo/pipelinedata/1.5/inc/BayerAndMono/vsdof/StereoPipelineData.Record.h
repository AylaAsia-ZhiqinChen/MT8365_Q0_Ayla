...
static struct ImageStreamManager::image_stream_info_pool_setting gStereoImgStreamTbl_VdoP1[] =
{
    ...
    { //LCSO. P1 output sizes will be updated later when constructing P1 pipelines
        "Hal:Image:LCSO", eSTREAMID_IMAGE_PIPE_RAW_LCSO, eSTREAMTYPE_IMAGE_INOUT, 13, 13,
        eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE,
        eImgFmt_BAYER10, MSize(0, 0), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL
    },
    //End
...
static struct ImageStreamManager::image_stream_info_pool_setting gStereoImgStreamTbl_VdoP1Main2_RRZO[] =
{
    ...
    { //LCSO. P1 output sizes will be updated later when constructing P1 pipelines
        "Hal:Image:LCSO_Main2", eSTREAMID_IMAGE_PIPE_RAW_LCSO_01, eSTREAMTYPE_IMAGE_INOUT, 13, 13,
        eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE,
        eImgFmt_BAYER10, MSize(0, 0), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL
    },
    //End
...
static struct ImageStreamManager::image_stream_info_pool_setting gStereoImgStreamTbl_P2VdoRec[] =
{
    ...
    {"Hal:Image:Pass2_Lcso",                eSTREAMID_IMAGE_PIPE_RAW_LCSO,                 eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READ,                              eImgFmt_STA_2BYTE, MSize(0, 0), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL}, // temp run
    {"Hal:Image:Pass2_Lcso_Main2",          eSTREAMID_IMAGE_PIPE_RAW_LCSO_01,              eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READ,                              eImgFmt_STA_2BYTE, MSize(0, 0), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL}, // temp run
    // DepthMapNode - output
    // Hal
    ...
    {"Hal:Image:P2Tuning",            eSTREAMID_IMAGE_PIPE_STEREO_P2_TUNING,              eSTREAMTYPE_IMAGE_INOUT,   9, 9, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_STA_BYTE, MSize(0, 0), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
