...
namespace p2
{
namespace BM_VSDOF_V2_DNG_CAPTURE
{
...
static struct ImageStreamManager::image_stream_info_pool_setting gStereoImgStreamTbl_P2DNGCap[] =
{
    ...
    // DepthMapNode - output
    // Hal
    {"App:Image:MainImage_Cap",     eSTREAMID_IMAGE_PIPE_DEPTHMAPNODE_MAINIMAGE_CAPYUV,     eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN, eImgFmt_YV12,       MSize(0, 0), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    ...
    {"App:Image:PostView",          eSTREAMID_IMAGE_PIPE_DUALYUVNODE_THUMBNAIL,           eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN,0, MSize(0, 0), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    //End
