...
#-----------------------------------------------------------
LOCAL_SRC_FILES += SmartShot.cpp
LOCAL_SRC_FILES += SmartShotEng.cpp
LOCAL_SRC_FILES += CollectShot.cpp
LOCAL_SRC_FILES += ZHDRShot.cpp

ifeq ($(MTK_CAM_STEREO_DENOISE_SUPPORT), yes)
LOCAL_SRC_FILES += BMDNShot/BMDNShot.cpp
endif

ifeq ($(MTK_CAM_DUAL_ZOOM_FUSION_SUPPORT), yes)
LOCAL_SRC_FILES += FusionShot/FusionShot.cpp
endif
...
LOCAL_SRC_FILES += DCMFShot/DCMFShot.cpp
LOCAL_SRC_FILES += DCMFShot/DCMFShot.callback.cpp
endif
endif
...
#-----------------------------------------------------------
LOCAL_MODULE := libcam.camadapter.scenario.shot.smartshot
