...
{
static const struct MetaStreamManager::metadata_info_setting gStereoMetaTbl_BM_PrvCap[] =
{
    // Hal
...
//
static struct ImageStreamManager::image_stream_info_pool_setting gStereoImgStreamTbl_BM_PrvCap[] =
{
    // Hal
    ...
    // DepthMapNode - output
    {"Hal:Image:Disparity_Left",           eSTREAMID_IMAGE_PIPE_DEPTHMAPNODE_DISPARITY_L, eSTREAMTYPE_IMAGE_INOUT, get_stereo_bmdenoise_capture_buffer_cnt(), 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_Y16, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    {"Hal:Image:Disparity_Right",          eSTREAMID_IMAGE_PIPE_DEPTHMAPNODE_DISPARITY_R, eSTREAMTYPE_IMAGE_INOUT, get_stereo_bmdenoise_capture_buffer_cnt(), 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_Y16, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    {"Hal:Image:WrappingMatrix",           eSTREAMID_IMAGE_PIPE_BMDENOISE_WAPING_MATRIX,    eSTREAMTYPE_IMAGE_INOUT, get_stereo_bmdenoise_capture_buffer_cnt(), 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_Y8, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    {"Hal:Image:SceneInfo",                eSTREAMID_IMAGE_PIPE_BMDENOISE_SCENE_INFO,       eSTREAMTYPE_IMAGE_INOUT, get_stereo_bmdenoise_capture_buffer_cnt(), 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_Y8, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
...
//
static const MINT32 gStereoP2ConnectSetting_BM_PrvCap[] =
{
