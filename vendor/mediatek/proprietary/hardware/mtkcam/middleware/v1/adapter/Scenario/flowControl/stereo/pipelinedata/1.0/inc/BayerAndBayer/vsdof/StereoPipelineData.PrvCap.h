...
static struct ImageStreamManager::image_stream_info_pool_setting gStereoImgStreamTbl_P2PrvCap[] =
{
    ...
    {"Hal:Image:DepthWrapper",      eSTREAMID_IMAGE_PIPE_STEREO_DEPTHWRAPPER,          eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_WRITE_OFTEN | eBUFFER_USAGE_SW_READ_OFTEN | eBUFFER_USAGE_HW_CAMERA_READWRITE, eImgFmt_STA_BYTE, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    // Bokeh - output
