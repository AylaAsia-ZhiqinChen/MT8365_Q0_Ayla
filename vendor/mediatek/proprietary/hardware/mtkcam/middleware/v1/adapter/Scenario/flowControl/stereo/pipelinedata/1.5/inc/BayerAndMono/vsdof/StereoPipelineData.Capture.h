...
static const struct MetaStreamManager::metadata_info_setting gStereoMetaTbl_P2Cap[] =
{
    ...
    {"App:Meta:Dual_Out",           eSTREAMID_META_APP_DYNAMIC_DUALIT,      eSTREAMTYPE_META_OUT,   0, 0, eStreamType_META_APP},
    ...
    {"App:Meta:JpgEnc_Bokeh",       eSTREAMID_META_APP_DYNAMIC_BOKEH_JPG,   eSTREAMTYPE_META_OUT,   0, 0, eStreamType_META_APP},
    // JpefEnc_CleanImageNode - output
    {"App:Meta:JpgEnc_Clean",       eSTREAMID_META_APP_DYNAMIC_JPEG,        eSTREAMTYPE_META_OUT,   0, 0, eStreamType_META_APP},
    // JpefEnc_JpsImageNode - output
    {"App:Meta:JpgEnc_JPS",         eSTREAMID_META_APP_DYNAMIC_JPS,         eSTREAMTYPE_META_OUT,   0, 0, eStreamType_META_APP},
    // End
    {"", 0, 0, 0, 0},
};
//
static struct ImageStreamManager::image_stream_info_pool_setting gStereoImgStreamTbl_P2Cap_Main2[] =
{
    ...
    // DepthMapNode - output
    // Hal
    {"Hal:Image:MainImage_Cap",     eSTREAMID_IMAGE_PIPE_DEPTHMAPNODE_MAINIMAGE_CAPYUV,     eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN, eImgFmt_YV12,       MSize(0, 0), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    ...
    {"App:Image:ExtraData",         eSTREAMID_IMAGE_PIPE_STEREO_APP_EXTRA_DATA,             eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN, eImgFmt_STA_BYTE, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    // JpegEnc_BokehNode
