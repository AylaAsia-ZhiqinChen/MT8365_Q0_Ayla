...
#define LOG_TAG "MtkCam/PostViewImageCallback"
//
#include <mtkcam/middleware/v1/IShot.h>
//
#include <mtkcam/utils/std/Log.h>
//
#include "PostViewImageCallback.h"
//
...
)
{
    ...
    {
        pShotCallback->onCB_PostviewClient(0, pBuffer.get());
        pShotCallback->onCB_P2done();
        ret = OK;
    }
