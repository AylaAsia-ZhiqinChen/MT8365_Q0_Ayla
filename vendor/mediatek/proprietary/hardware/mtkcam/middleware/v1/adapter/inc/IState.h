...
#ifndef _MTK_HAL_CAMADAPTER_INC_ISTATE_H_
#define _MTK_HAL_CAMADAPTER_INC_ISTATE_H_
//
...
public:     ////            Interfaces
    ...
    virtual status_t        onHandleNormalCapture()                         = 0;
    virtual status_t        onHandleZSLCapture()                            = 0;
...
public:     ////            State Enum.
                            enum ENState
                            {
                                eState_Idle                 = 0x00000001,
                                eState_Preview              = 0x00000001<<1,
                                eState_PreCapture           = 0x00000001<<2,
                                eState_NormalCapture        = 0x00000001<<3,
                                eState_ZSLCapture           = 0x00000001<<4,
                                eState_Recording            = 0x00000001<<5,
                                eState_VideoSnapshot        = 0x00000001<<6
                            };
...
public:     ////            Attributes.
    ...
    virtual ENState         getCurrentStateEnum() const                     = 0;
...
#endif // _MTK_HAL_CAMADAPTER_INC_ISTATE_H_
