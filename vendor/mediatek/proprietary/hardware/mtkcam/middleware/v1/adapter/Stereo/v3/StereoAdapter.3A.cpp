...
autoFocus()
{
    CAM_TRACE_NAME("StereoAdapter:autoFocus");
    MY_LOGD("+");
    status_t ret = OK;
    //
    ...
    // cache af area string for capture use.
    msFocusArea = mpParamsManagerV3->getParamsMgr()->getStr(CameraParameters::KEY_FOCUS_AREAS);
    miMaxFocusArea = mpParamsManagerV3->getParamsMgr()->getInt(CameraParameters::KEY_MAX_NUM_FOCUS_AREAS);
...
cancelAutoFocus()
{
    CAM_TRACE_NAME("StereoAdapter:cancelAutoFocus");
    MY_LOGD("+");
    status_t ret = OK;
