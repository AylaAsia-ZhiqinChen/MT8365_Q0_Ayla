...
public:     ////
    ...
    virtual bool                    createAsdImg(MUINT8 *dstAddr, MUINT8 *srcAddr, MUINT8 ucPlane, MINT32 srcWidth, MINT32 srcHeight);
    virtual bool                    getAsdImgSize(MUINT32 *width, MUINT32 *height);
...
private:
    bool                            setAsdImgSize(MUINT32 srcWidth, MUINT32 srcHeight);
