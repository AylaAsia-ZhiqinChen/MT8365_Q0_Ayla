...
public:     ////
    ...
    virtual bool                    createAsdImg(MUINT8 *dstAddr, MUINT8 *srcAddr, MUINT8 ucPlane, MINT32 srcWidth, MINT32 srcHeight) = 0;
    virtual bool                    getAsdImgSize(MUINT32 *width, MUINT32 *height) = 0;
