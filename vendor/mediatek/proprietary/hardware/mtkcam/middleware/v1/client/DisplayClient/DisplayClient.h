...
public:     ////
    ...
    virtual bool                    setWindow(
                                        ...
                                        int32_t const   iNativeWindowConsumerUsage = 0
                                    );
    /**
     *
     */
...
//    mutable Mutex                 mStreamOpsMtx;
    ...
    StreamBufList_t                 mOutOrderStreamBufList;
...
protected:  ////                    Buffer Operations.
    ...
    bool                            mFirstReturnFrame;
    //
    virtual void                    SetEnableAutoDecideBufferFormat(bool bEnable = true);
    bool                            mbEnableAutoDecideBufferFormat;
    //
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Duration Tool
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
protected:  ////                    dump
    ...
    sp<FrameController>             mpController;
    //
    int32_t                         mNativeWindowConsumerUsage;
    // buffer min diff time control
    bool                            mbApplyMinBufferDiffTimeControl;
    int32_t                         miBufferMinDiffTime;
    int64_t                         miLastEnqueTime;
    int64_t                         miCurrentEnqueTime;
};
