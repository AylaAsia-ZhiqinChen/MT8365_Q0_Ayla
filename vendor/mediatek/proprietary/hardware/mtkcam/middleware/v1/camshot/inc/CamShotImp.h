...
protected:  ////    Data Members.
    ...
    EPipelineMode       mePipelineMode;
    char const*const    mszCamShotName;
    MINT32              mi4ErrorCode;

public:     ////    Operations.
    virtual EShotMode     getShotMode() const          {return meShotMode; }
    virtual EPipelineMode getPipelineMode() const      {return mePipelineMode; }
...
public:     ////    Constructor/Destructor.
                    CamShotImp(
                        ...
                        EPipelineMode const ePipelineMode = ePipelineMode_Null
                    );
    virtual         ~CamShotImp()  {}
...
protected:
    ...
    MBOOL      handleDataCallback(MINT32 const i4Msg, MUINTPTR const ext1, MUINTPTR const ext2, IImageBuffer* pImgBuf); 
