 ...
 */
#define LOG_TAG "ContextBuilder/DualYUVNodeData"
//
...
//
#include "DualYUVNodeConfigData.h"
//
/******************************************************************************
 *
 ******************************************************************************/
...
//
typedef DualYUVNode          NodeT;
typedef NodeActor< NodeT >              MyNodeActorT;
//
DualYUVNodeConfigData::
DualYUVNodeConfigData(
    MINT32 openId,
    NodeId_T nodeId,
    char const* nodeName)
    ...
    PipelineContext* pipeContext)
{
    ...
    if(imageManager != NULL)
    {
        ...
        // output stream
        cfgParam.pOutHalImageMainImg = imageManager->getStreamInfoByStreamId(eSTREAMID_IMAGE_PIPE_YUV_00);
        addStream(  cfgParam.pOutHalImageMainImg, MFALSE);
        // preview cb
        ...
        //
        cfgParam.pOutHalImageFD = imageManager->getStreamInfoByStreamId(eSTREAMID_IMAGE_YUV_FD);
        addStream(  cfgParam.pOutHalImageFD, MFALSE);
        //
        cfgParam.pOutHalImageMainImg_Cap = imageManager->getStreamInfoByStreamId(eSTREAMID_IMAGE_PIPE_DUALYUVNODE_MAIN1YUV);
        addStream(  cfgParam.pOutHalImageMainImg_Cap, MFALSE);
        //
        cfgParam.pOutHalImageMain2Img_Cap = imageManager->getStreamInfoByStreamId(eSTREAMID_IMAGE_PIPE_DUALYUVNODE_MAIN2YUV);
        addStream(  cfgParam.pOutHalImageMain2Img_Cap, MFALSE);
        //
        cfgParam.pOutHalThumbnailImg_Cap = imageManager->getStreamInfoByStreamId(eSTREAMID_IMAGE_PIPE_DUALYUVNODE_THUMBNAIL);
...
destroy()
{
    ...
    cfgParam.pOutHalImageMainImg = nullptr;
    cfgParam.pOutHalImageFD = nullptr;
    cfgParam.pOutHalImageMainImg_Cap = nullptr;
    cfgParam.pOutHalImageMain2Img_Cap = nullptr;
