 ...
 */
#ifndef _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_STEREO_P2_NODE_MAIN2_CONFIG_DATA_H_
#define _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_STEREO_P2_NODE_MAIN2_CONFIG_DATA_H_
//
...
namespace v3
{
class StereoP2NodeMain2ConfigData: public INodeConfigBase
{
private:
...
public:
    StereoP2NodeMain2ConfigData(
                                ...
                                NodeId_T nodeId,
                                char const* nodeName);
    virtual ~StereoP2NodeMain2ConfigData();
    //
...
#endif //_MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_STEREO_P2_NODE_MAIN2_CONFIG_DATA_H_
