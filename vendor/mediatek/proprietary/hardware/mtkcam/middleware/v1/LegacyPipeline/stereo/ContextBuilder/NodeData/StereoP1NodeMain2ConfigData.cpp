...
#define DOUT    MFALSE
    ...
    if(imageManager != NULL)
    {
        ...
        if(spStrmInfo != NULL)
        {
            ...
            if( imageManager->getPoolTypeByStreamId(eSTREAMID_IMAGE_PIPE_RAW_LCSO_01) == eStreamType_IMG_HAL_POOL)
            {
                cfgParam.pStreamPool_lcso = pipeContext->queryImageStreamPool(eSTREAMID_IMAGE_PIPE_RAW_LCSO_01);
            }
        }
        else
        {
