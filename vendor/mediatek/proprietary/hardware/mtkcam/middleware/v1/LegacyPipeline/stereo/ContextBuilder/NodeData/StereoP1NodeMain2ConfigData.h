 ...
 */
#ifndef _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_STEREO_P1_NODE_MAIN2_CONFIG_DATA_H_
#define _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_STEREO_P1_NODE_MAIN2_CONFIG_DATA_H_
//
...
namespace v3
{
class StereoP1NodeMain2ConfigData: public INodeConfigBase
{
private:
...
public:
    StereoP1NodeMain2ConfigData(
                                ...
                                NodeId_T nodeId,
                                char const* nodeName);
    virtual ~StereoP1NodeMain2ConfigData();
    //
...
private:
    P1Node::InitParams initParam;
    P1Node::ConfigParams cfgParam;
};
};
};
#endif //_MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_STEREO_P1_NODE_MAIN2_CONFIG_DATA_H_
