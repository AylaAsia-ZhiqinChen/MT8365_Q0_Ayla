 ...
 */
#ifndef _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_STEREO_P1_NODE_CONFIG_DATA_H_
#define _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_STEREO_P1_NODE_CONFIG_DATA_H_
//
...
namespace v3
{
class StereoP1NodeConfigData: public INodeConfigBase
{
private:
...
public:
    StereoP1NodeConfigData(
                                ...
                                NodeId_T nodeId,
                                char const* nodeName);
    virtual ~StereoP1NodeConfigData();
    //
...
#endif //_MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_STEREO_P1_NODE_CONFIG_DATA_H_
