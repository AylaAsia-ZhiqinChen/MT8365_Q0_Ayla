 ...
 */
#ifndef _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_DEPTHMAP_NODE_CONFIG_DATA_H_
#define _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_DEPTHMAP_NODE_CONFIG_DATA_H_
//
    ...
    : public INodeConfigBase
{
    public:
        DepthMapNodeConfigData(
                                ...
                                NodeId_T nodeId,
                                char const* nodeName);
        virtual ~DepthMapNodeConfigData();
    ...
    private:
        DepthMapNode::InitParams initParam;
        DepthMapNode::ConfigParams cfgParam;
};
};
};
