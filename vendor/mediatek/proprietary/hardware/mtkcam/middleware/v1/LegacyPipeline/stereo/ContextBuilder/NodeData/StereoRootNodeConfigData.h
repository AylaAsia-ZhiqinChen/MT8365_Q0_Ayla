 ...
 */
#ifndef _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_STEREO_ROOT_NODE_CONFIG_DATA_H_
#define _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_STEREO_ROOT_NODE_CONFIG_DATA_H_
//
...
namespace v3
{
class StereoRootNodeConfigData
    : public INodeConfigBase
{
    public:
        StereoRootNodeConfigData(
                                    ...
                                    NodeId_T nodeId,
                                    char const* nodeName);
        virtual ~StereoRootNodeConfigData();
    ...
    private:
        StereoRootNode::InitParams initParam;
        StereoRootNode::ConfigParams cfgParam;
};
};
};
