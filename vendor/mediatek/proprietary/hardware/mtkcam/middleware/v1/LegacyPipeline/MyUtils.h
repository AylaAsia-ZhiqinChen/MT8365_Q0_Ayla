...
#ifndef _MTK_HARDWARE_MTKCAM_LEGACYPIPELINE_MYUTILS_H_
#define _MTK_HARDWARE_MTKCAM_LEGACYPIPELINE_MYUTILS_H_
//
...
#endif  //_MTK_HARDWARE_MTKCAM_LEGACYPIPELINE_MYUTILS_H_
