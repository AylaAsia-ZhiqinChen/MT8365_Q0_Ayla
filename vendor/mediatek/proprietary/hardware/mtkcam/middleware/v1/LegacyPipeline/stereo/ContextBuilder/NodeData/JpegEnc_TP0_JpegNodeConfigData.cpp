 ...
 */
#define LOG_TAG "ContextBuilder/JpgEncTP0JPGNodeData"
//
...
//
#include "JpegEnc_TP0_JpegNodeConfigData.h"
//
/******************************************************************************
 *
 ******************************************************************************/
...
//
JpegEnc_TP0_JpegNodeConfigData::
JpegEnc_TP0_JpegNodeConfigData(
    MINT32 openId,
    NodeId_T nodeId,
    char const* nodeName)
    ...
    PipelineContext* pipeContext)
{
    ...
    if(metaManager != NULL)
    {
        ...
        //
        cfgParam.pInHalMeta = metaManager->getStreamInfoByStreamId(eSTREAMID_META_HAL_DYNAMIC_TP);
        addStream(cfgParam.pInHalMeta, MTRUE);
        //
        cfgParam.pOutAppMeta = metaManager->getStreamInfoByStreamId(eSTREAMID_META_APP_DYNAMIC_TP_JPEG0);
    ...
    if(imageManager != NULL)
    {
        ...
        cfgParam.pInYuv_Main = imageManager->getStreamInfoByStreamId(eSTREAMID_IMAGE_PIPE_TP_OUT00);
        addStream(cfgParam.pInYuv_Main, MTRUE);

        cfgParam.pOutJpeg = imageManager->getStreamInfoByStreamId(eSTREAMID_IMAGE_PIPE_JPG_TP_OUT00);
