...
///////////////////////////////////////////////////////////////////////////
    ...
    #define BASE_LOG_VRB(fmt, arg...)       do { if (MTKCAM_LOGENABLE_DEFAULT) {CAM_LOGV(DBG_LOG_TAG "[%s] " fmt NEW_LINE_CHAR, __func__, ##arg); } } while(0)    // <Verbose>: Show more detail debug information. E.g. Entry/exit of private function; contain of local variable in function or code block; return value of system function/API...
...
#else   // Using LDVT.
    #include "../../../../../../ldvt/mt6885/include/uvvf.h"
...
#define DBG_LOG_CONFIG(GroupName, ModuleName)                       \
    do {                                                            \
        ...
        {                                                           \
            property_get("debuglog." #GroupName, acDbgLogLevel, "0");   \
        }                                                           \
        acDbgLogLevel[0] = 2;                                       \
