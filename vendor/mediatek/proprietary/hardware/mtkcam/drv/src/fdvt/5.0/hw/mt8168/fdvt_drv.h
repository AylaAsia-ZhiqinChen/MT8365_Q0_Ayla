...
typedef struct
{
	...
	MUINT64 *ATTRMODE_RS_Config_VA[10] = {NULL};
	MUINT64 *ATTRMODE_YUV2RGB_Config_VA[10] = {NULL};

	MUINT64 *POSEMODE_FD_Config_VA[10] = {NULL};
	MUINT64 *POSEMODE_RS_Config_VA[10] = {NULL};
	MUINT64 *POSEMODE_YUV2RGB_Config_VA[10] = {NULL};   
   
	MUINT64 *YUV2RGB_R_Result_VA = NULL;
	MUINT64 *YUV2RGB_G_Result_VA = NULL;
	MUINT64 *YUV2RGB_B_Result_VA = NULL;
	...
	MUINT32 *ATTRMODE_RS_Config_PA[10] = {NULL};
	MUINT32 *ATTRMODE_YUV2RGB_Config_PA[10] = {NULL};

	MUINT32 *POSEMODE_FD_Config_PA[10] = {NULL};
	MUINT32 *POSEMODE_RS_Config_PA[10] = {NULL};
	MUINT32 *POSEMODE_YUV2RGB_Config_PA[10] = {NULL};

	MUINT32 *YUV2RGB_R_Result_PA = NULL;
	MUINT32 *YUV2RGB_G_Result_PA = NULL;
	MUINT32 *YUV2RGB_B_Result_PA = NULL;
