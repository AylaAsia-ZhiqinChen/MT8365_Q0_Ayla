  ...
  ptr->writeReg(0x0a50, 0x1f01b0, CAM_B);       //CAM.CAM_B.AMX.CTL
  ptr->writeReg(0x0a54, 0x60d0016, CAM_B);      //CAM.CAM_B.AMX.CROP
  ptr->writeReg(0x0a58, 0xc8, CAM_B);           //CAM.CAM_B.AMX.VSIZE
  ...
  ptr->writeReg(0x0580, 0x1f00d8, CAM_B);       //CAM.CAM_B.BMX.CTL
  ptr->writeReg(0x0584, 0x60d0016, CAM_B);      //CAM.CAM_B.BMX.CROP
  ptr->writeReg(0x0588, 0xc8, CAM_B);           //CAM.CAM_B.BMX.VSIZE
...
//  ptr->writeReg(0x0228, 0x0, CAM_B);          //CAM.CAM_B.CQ.THR12_BASEADDR
  ...
  ptr->writeReg(0x0004, 0x1100f616, CAM_B);     //CAM.CAM_B.CTL.EN
  ptr->writeReg(0x0008, 0x5, CAM_B);            //CAM.CAM_B.CTL.DMA_EN
  ptr->writeReg(0x000c, 0xc10a1095, CAM_B);     //CAM.CAM_B.CTL.FMT_SEL
  ptr->writeReg(0x0010, 0x21091, CAM_B);        //CAM.CAM_B.CTL.SEL
  ptr->writeReg(0x0014, 0x10, CAM_B);           //CAM.CAM_B.CTL.MISC
  ptr->writeReg(0x0018, 0x6410000, CAM_B);      //CAM.CAM_B.CTL.EN2
  ...
  ptr->writeReg(0x0ac0, 0x9c0378, CAM_B);       //CAM.CAM_B.DBS.SIGMA
  ptr->writeReg(0x0ac4, 0x7864ba82, CAM_B);     //CAM.CAM_B.DBS.BSTBL_0
  ptr->writeReg(0x0ac8, 0xfc8f882, CAM_B);      //CAM.CAM_B.DBS.BSTBL_1
  ptr->writeReg(0x0acc, 0xf8a2357b, CAM_B);     //CAM.CAM_B.DBS.BSTBL_2
  ptr->writeReg(0x0ad0, 0x23f230, CAM_B);       //CAM.CAM_B.DBS.BSTBL_3
  ptr->writeReg(0x0ad4, 0xba8fa14, CAM_B);      //CAM.CAM_B.DBS.CTL
  ptr->writeReg(0x0ad8, 0xa2b, CAM_B);          //CAM.CAM_B.DBS.CTL_2
  ptr->writeReg(0x0adc, 0x5829f8fb, CAM_B);     //CAM.CAM_B.DBS.SIGMA_2
  ptr->writeReg(0x0ae0, 0x181c2b19, CAM_B);     //CAM.CAM_B.DBS.YGN
  ptr->writeReg(0x0ae4, 0x3e300ab, CAM_B);      //CAM.CAM_B.DBS.SL_Y12
  ptr->writeReg(0x0ae8, 0x5503e3, CAM_B);       //CAM.CAM_B.DBS.SL_Y34
  ptr->writeReg(0x0aec, 0x3030171, CAM_B);      //CAM.CAM_B.DBS.SL_G12
  ptr->writeReg(0x0af0, 0x319005e, CAM_B);      //CAM.CAM_B.DBS.SL_G34
  ...
  ptr->writeReg(0x1020, 0x50488200, CAM_B);     //CAM.CAM_B.DMA.IMGO_BASE_ADDR
  ptr->writeReg(0x1028, 0x776, CAM_B);          //CAM.CAM_B.DMA.IMGO_OFST_ADDR
  ptr->writeReg(0x102c, 0x1000100, CAM_B);      //CAM.CAM_B.DMA.IMGO_DRS
  ptr->writeReg(0x1030, 0x775, CAM_B);          //CAM.CAM_B.DMA.IMGO_XSIZE
  ptr->writeReg(0x1034, 0xc7, CAM_B);           //CAM.CAM_B.DMA.IMGO_YSIZE
  ptr->writeReg(0x1038, 0x810f30, CAM_B);       //CAM.CAM_B.DMA.IMGO_STRIDE
  ptr->writeReg(0x103c, 0x4000017c, CAM_B);     //CAM.CAM_B.DMA.IMGO_CON
  ptr->writeReg(0x1040, 0xaf001a, CAM_B);       //CAM.CAM_B.DMA.IMGO_CON2
  ptr->writeReg(0x1044, 0xe0003, CAM_B);        //CAM.CAM_B.DMA.IMGO_CON3
  ptr->writeReg(0x1048, 0x0, CAM_B);            //CAM.CAM_B.DMA.IMGO_CROP
  ptr->writeReg(0x104c, 0xc000bb, CAM_B);       //CAM.CAM_B.DMA.IMGO_CON4
  ptr->writeReg(0x1050, 0x508ad400, CAM_B);     //CAM.CAM_B.DMA.RRZO_BASE_ADDR
  ptr->writeReg(0x1058, 0x438, CAM_B);          //CAM.CAM_B.DMA.RRZO_OFST_ADDR
  ptr->writeReg(0x105c, 0x1000100, CAM_B);      //CAM.CAM_B.DMA.RRZO_DRS
  ptr->writeReg(0x1060, 0x3e7, CAM_B);          //CAM.CAM_B.DMA.RRZO_XSIZE
  ptr->writeReg(0x1064, 0x7d, CAM_B);           //CAM.CAM_B.DMA.RRZO_YSIZE
  ptr->writeReg(0x1068, 0x830820, CAM_B);       //CAM.CAM_B.DMA.RRZO_STRIDE
  ptr->writeReg(0x106c, 0x10000174, CAM_B);     //CAM.CAM_B.DMA.RRZO_CON
  ptr->writeReg(0x1070, 0x167014b, CAM_B);      //CAM.CAM_B.DMA.RRZO_CON2
  ptr->writeReg(0x1074, 0x1740174, CAM_B);      //CAM.CAM_B.DMA.RRZO_CON3
  ptr->writeReg(0x1078, 0x0, CAM_B);            //CAM.CAM_B.DMA.RRZO_CROP
  ptr->writeReg(0x107c, 0x80800010, CAM_B);     //CAM.CAM_B.DMA.RRZO_CON4
  ...
  ptr->writeReg(0x1098, 0x24, CAM_B);           //CAM.CAM_B.DMA.AAO_STRIDE
  ...
  ptr->writeReg(0x10f8, 0x16, CAM_B);           //CAM.CAM_B.DMA.LCSO_STRIDE
  ...
  ptr->writeReg(0x1188, 0x12003a, CAM_B);       //CAM.CAM_B.DMA.BPCI_STRIDE
  ptr->writeReg(0x118c, 0x2000001d, CAM_B);     //CAM.CAM_B.DMA.BPCI_CON
  ptr->writeReg(0x1190, 0x170017, CAM_B);       //CAM.CAM_B.DMA.BPCI_CON2
  ptr->writeReg(0x1194, 0x50002, CAM_B);        //CAM.CAM_B.DMA.BPCI_CON3
  ptr->writeReg(0x119c, 0x90003, CAM_B);        //CAM.CAM_B.DMA.BPCI_CON4
  ...
  ptr->writeReg(0x11e8, 0x12003f, CAM_B);       //CAM.CAM_B.DMA.LSCI_STRIDE
  ptr->writeReg(0x11ec, 0x80000020, CAM_B);     //CAM.CAM_B.DMA.LSCI_CON
  ptr->writeReg(0x11f0, 0x1e0003, CAM_B);       //CAM.CAM_B.DMA.LSCI_CON2
  ptr->writeReg(0x11f4, 0x1f001b, CAM_B);       //CAM.CAM_B.DMA.LSCI_CON3
  ptr->writeReg(0x11fc, 0x8014000b, CAM_B);     //CAM.CAM_B.DMA.LSCI_CON4
  ...
  ptr->writeReg(0x1278, 0xe4, CAM_B);           //CAM.CAM_B.DMA.PSO_STRIDE
  ...
  ptr->writeReg(0x0334, 0xbef05e2, CAM_B);      //CAM.CAM_B.DMX.CROP
  ptr->writeReg(0x0338, 0xc8, CAM_B);           //CAM.CAM_B.DMX.VSIZE
  ...
  ptr->writeReg(0x0ab0, 0x60d0016, CAM_B);      //CAM.CAM_B.RCP3.CROP_CON1
  ptr->writeReg(0x0ab4, 0xc70000, CAM_B);       //CAM.CAM_B.RCP3.CROP_CON2
  ...
  ptr->writeReg(0x0390, 0xfa1b0881, CAM_B);     //CAM.CAM_B.RMM.OSC
  ptr->writeReg(0x0394, 0x1a1841, CAM_B);       //CAM.CAM_B.RMM.MC
  ptr->writeReg(0x0398, 0x2670327, CAM_B);      //CAM.CAM_B.RMM.REVG_1
  ptr->writeReg(0x039c, 0x1b0013f, CAM_B);      //CAM.CAM_B.RMM.REVG_2
  ptr->writeReg(0x03a0, 0x52d, CAM_B);          //CAM.CAM_B.RMM.LEOS
  ptr->writeReg(0x03a4, 0x10a19, CAM_B);        //CAM.CAM_B.RMM.MC2
  ptr->writeReg(0x03a8, 0x6a1, CAM_B);          //CAM.CAM_B.RMM.DIFF_LB
  ptr->writeReg(0x03ac, 0x10c9019, CAM_B);      //CAM.CAM_B.RMM.MA
  ptr->writeReg(0x03b0, 0x2a8e0011, CAM_B);     //CAM.CAM_B.RMM.TUNE
  ptr->writeReg(0x0540, 0x1f0130, CAM_B);       //CAM.CAM_B.RMX.CTL
  ptr->writeReg(0x0544, 0x2130000, CAM_B);      //CAM.CAM_B.RMX.CROP
  ptr->writeReg(0x0548, 0x7e, CAM_B);           //CAM.CAM_B.RMX.VSIZE
  ...
  ptr->writeReg(0x04e0, 0x13090003, CAM_B);     //CAM.CAM_B.RRZ.CTL
  ptr->writeReg(0x04e4, 0xc8060e, CAM_B);       //CAM.CAM_B.RRZ.IN_IMG
  ptr->writeReg(0x04e8, 0x7e0214, CAM_B);       //CAM.CAM_B.RRZ.OUT_IMG
  ptr->writeReg(0x04ec, 0x15d14, CAM_B);        //CAM.CAM_B.RRZ.HORI_STEP
  ptr->writeReg(0x04f0, 0x8a3d, CAM_B);         //CAM.CAM_B.RRZ.VERT_STEP
  ptr->writeReg(0x04f4, 0x50, CAM_B);           //CAM.CAM_B.RRZ.HORI_INT_OFST
  ptr->writeReg(0x04f8, 0x2af1, CAM_B);         //CAM.CAM_B.RRZ.HORI_SUB_OFST
  ptr->writeReg(0x04fc, 0x6, CAM_B);            //CAM.CAM_B.RRZ.VERT_INT_OFST
  ptr->writeReg(0x0500, 0x2a68, CAM_B);         //CAM.CAM_B.RRZ.VERT_SUB_OFST
  ptr->writeReg(0x0504, 0xd6cbb38c, CAM_B);     //CAM.CAM_B.RRZ.MODE_TH
  ptr->writeReg(0x0508, 0xe074, CAM_B);         //CAM.CAM_B.RRZ.MODE_CTL
  ptr->writeReg(0x050c, 0x1de8, CAM_B);         //CAM.CAM_B.RRZ.RLB_AOFST
  ptr->writeReg(0x0510, 0x100be, CAM_B);        //CAM.CAM_B.RRZ.LBLD_CFG
  ptr->writeReg(0x0514, 0x3022, CAM_B);         //CAM.CAM_B.RRZ.NNIR_TBL_SEL
  ...
  ptr->writeReg(0x0b00, 0x6405f8, CAM_B);       //CAM.CAM_B.SL2F.CEN
  ptr->writeReg(0x0b04, 0x280014, CAM_B);       //CAM.CAM_B.SL2F.RR_CON0
  ptr->writeReg(0x0b08, 0x4000003c, CAM_B);     //CAM.CAM_B.SL2F.RR_CON1
  ptr->writeReg(0x0b0c, 0xffc380, CAM_B);       //CAM.CAM_B.SL2F.GAIN
  ptr->writeReg(0x0b10, 0x8000800, CAM_B);      //CAM.CAM_B.SL2F.RZ
  ptr->writeReg(0x0b14, 0x2f1000, CAM_B);       //CAM.CAM_B.SL2F.XOFF
  ptr->writeReg(0x0b18, 0x0, CAM_B);            //CAM.CAM_B.SL2F.YOFF
  ptr->writeReg(0x0b1c, 0x333, CAM_B);          //CAM.CAM_B.SL2F.SLP_CON0
  ptr->writeReg(0x0b20, 0x333, CAM_B);          //CAM.CAM_B.SL2F.SLP_CON1
  ptr->writeReg(0x0b24, 0x100, CAM_B);          //CAM.CAM_B.SL2F.SLP_CON2
  ptr->writeReg(0x0b28, 0x100, CAM_B);          //CAM.CAM_B.SL2F.SLP_CON3
  ptr->writeReg(0x0b2c, 0xc8060e, CAM_B);       //CAM.CAM_B.SL2F.SIZE
