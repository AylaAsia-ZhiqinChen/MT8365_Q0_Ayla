...
typedef struct _tCAM_rst{
    ...
    MUINT32 xsize_byte;             //xsize, uint:byte
    ...
    MUINT32 Sen_Num;                //force twin off and return TG number
...
typedef enum{
    ...
    E_CAM_BS_Max_size   = 0x100,
    E_CAM_BS_Alignment  = 0x200,
...
#if 1    //special case of drv to query dynamic twin is truned on or off.  only exit in Bianxx(23) & Vinxxx(58)
    class D_TWIN_CFG{
    public:
        D_TWIN_CFG(){
            m_DTwin = MFALSE;
