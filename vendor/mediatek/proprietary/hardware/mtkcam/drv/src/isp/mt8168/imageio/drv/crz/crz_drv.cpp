 ...
 *                         G L O B A L    D A T A                         *
 **************************************************************************/
//static IspDrv* m_pPhyIspDrv; //not used
...
{
    LOG_VRB("- E. pIspReg: 0x%lx.", (unsigned long)pIspReg);
...
{
    LOG_VRB("- E. pPhyIspDrv: 0x%lx.", (unsigned long)pPhyIspDrv);
...
)
{
    ...
    //MUINT32 u4SizeToBeChecked_H = 0; //not used
    //MUINT32 u4SizeToBeChecked_V = 0; //not used
