  ...
  ptr->writeReg(0x0110 ,0x1800075,UNI_A);  			//CAM.CAM_UNI.DMA.SPECIAL_FUN_EN 
  ptr->writeReg(0x0138 ,0x4002a,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_STRIDE 
  ...
  ptr->writeReg(0x010c ,0x0,UNI_A);  			//CAM.CAM_UNI.DMA.LAST_ULTRA_EN 
  ptr->writeReg(0x0114 ,0xbf2,UNI_A);  			//CAM.CAM_UNI.DMA.SPECIAL_FUN2_EN 
  ptr->writeReg(0x0120 ,0x0,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_BASE_ADDR 
  ptr->writeReg(0x0128 ,0x0,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_OFST_ADDR 
  ptr->writeReg(0x012c ,0x8120a61,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_DRS 
  ptr->writeReg(0x0130 ,0x0,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_XSIZE 
  ptr->writeReg(0x0134 ,0x0,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_YSIZE 
  ptr->writeReg(0x013c ,0x80000022,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_CON 
  ptr->writeReg(0x0140 ,0xf000c,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_CON2 
  ptr->writeReg(0x0144 ,0xf000a,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_CON3 
  ptr->writeReg(0x014c ,0x5c40270,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_CON4 
  ptr->writeReg(0x0150 ,0x0,UNI_A);  			//CAM.CAM_UNI.DMA.ERR_CTRL 
  ptr->writeReg(0x0154 ,0x85b30000,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_ERR_STAT 
  ptr->writeReg(0x0158 ,0x672982d5,UNI_A);  			//CAM.CAM_UNI.DMA.DEBUG_ADDR 
  ptr->writeReg(0x015c ,0x19c4e6a9,UNI_A);  			//CAM.CAM_UNI.DMA.RSV1 
  ptr->writeReg(0x0160 ,0xea1bf7c0,UNI_A);  			//CAM.CAM_UNI.DMA.RSV2 
  ptr->writeReg(0x0164 ,0x18f43b1d,UNI_A);  			//CAM.CAM_UNI.DMA.RSV3 
  ptr->writeReg(0x0168 ,0xf1f0f40a,UNI_A);  			//CAM.CAM_UNI.DMA.RSV4 
  ptr->writeReg(0x016c ,0xdef0a699,UNI_A);  			//CAM.CAM_UNI.DMA.RSV5 
  ptr->writeReg(0x0170 ,0xf60eb2c6,UNI_A);  			//CAM.CAM_UNI.DMA.RSV6 
  ptr->writeReg(0x0174 ,0x772105,UNI_A);  			//CAM.CAM_UNI.DMA.DEBUG_SEL 
  ptr->writeReg(0x0040 ,0x30000021,UNI_A);  			//CAM.CAM_UNI.TOP.MOD_DCM_DIS 
  ptr->writeReg(0x0000 ,0xb00,UNI_A);  			//CAM.CAM_UNI.TOP.CTL 
  ptr->writeReg(0x0004 ,0x0,UNI_A);  			//CAM.CAM_UNI.TOP.MISC 
  ...
  ptr->writeReg(0x001c ,0x8000020f,UNI_A);  			//CAM.CAM_UNI.TOP.FMT_SEL 
  ...
  ptr->writeReg(0x002c ,0x6743,UNI_A);  			//CAM.CAM_UNI.TOP.DBG_SET 
  ptr->writeReg(0x0030 ,0x0,UNI_A);  			//CAM.CAM_UNI.TOP.DBG_PORT 
  ptr->writeReg(0x0034 ,0x80000000,UNI_A);  			//CAM.CAM_UNI.TOP.DMA_CCU_INT_EN 
