   ...
   ptr->writeReg(0x0a50, 0xf02a0, CAM_B);       //CAM.CAM_B.AMX.CTL
   ptr->writeReg(0x0a54, 0x3fff0000, CAM_B);    //CAM.CAM_B.AMX.CROP
   ptr->writeReg(0x0a58, 0x3fff, CAM_B);        //CAM.CAM_B.AMX.VSIZE
   ...
   ptr->writeReg(0x0584, 0x3fff0000, CAM_B);    //CAM.CAM_B.BMX.CROP
   ptr->writeReg(0x0588, 0x3fff, CAM_B);        //CAM.CAM_B.BMX.VSIZE
...
//   ptr->writeReg(0x0228, 0x0, CAM_B);             //CAM.CAM_B.CQ.THR12_BASEADDR
   ...
   ptr->writeReg(0x0004, 0x0, CAM_B);           //CAM.CAM_B.CTL.EN
   ptr->writeReg(0x0008, 0x0, CAM_B);           //CAM.CAM_B.CTL.DMA_EN
   ptr->writeReg(0x000c, 0xc0000000, CAM_B);    //CAM.CAM_B.CTL.FMT_SEL
   ptr->writeReg(0x0010, 0x10000, CAM_B);       //CAM.CAM_B.CTL.SEL
   ptr->writeReg(0x0014, 0x10, CAM_B);          //CAM.CAM_B.CTL.MISC
   ptr->writeReg(0x0018, 0x0, CAM_B);           //CAM.CAM_B.CTL.EN2
   ...
   ptr->writeReg(0x1018, 0x0, CAM_B);           //CAM.CAM_B.DMA.SPECIAL_FUN_EN
   ptr->writeReg(0x1020, 0x0, CAM_B);           //CAM.CAM_B.DMA.IMGO_BASE_ADDR
   ptr->writeReg(0x1028, 0x0, CAM_B);           //CAM.CAM_B.DMA.IMGO_OFST_ADDR
   ptr->writeReg(0x102c, 0x1000100, CAM_B);     //CAM.CAM_B.DMA.IMGO_DRS
   ptr->writeReg(0x1030, 0x0, CAM_B);           //CAM.CAM_B.DMA.IMGO_XSIZE
   ptr->writeReg(0x1034, 0x0, CAM_B);           //CAM.CAM_B.DMA.IMGO_YSIZE
   ptr->writeReg(0x1038, 0x0, CAM_B);           //CAM.CAM_B.DMA.IMGO_STRIDE
   ptr->writeReg(0x103c, 0x80000100, CAM_B);    //CAM.CAM_B.DMA.IMGO_CON
   ptr->writeReg(0x1040, 0x1000100, CAM_B);     //CAM.CAM_B.DMA.IMGO_CON2
   ptr->writeReg(0x1044, 0x1000100, CAM_B);     //CAM.CAM_B.DMA.IMGO_CON3
   ptr->writeReg(0x1048, 0x0, CAM_B);           //CAM.CAM_B.DMA.IMGO_CROP
   ptr->writeReg(0x104c, 0x1000100, CAM_B);     //CAM.CAM_B.DMA.IMGO_CON4
   ptr->writeReg(0x1050, 0x0, CAM_B);           //CAM.CAM_B.DMA.RRZO_BASE_ADDR
   ptr->writeReg(0x1058, 0x0, CAM_B);           //CAM.CAM_B.DMA.RRZO_OFST_ADDR
   ptr->writeReg(0x105c, 0x1000100, CAM_B);     //CAM.CAM_B.DMA.RRZO_DRS
   ptr->writeReg(0x1060, 0x0, CAM_B);           //CAM.CAM_B.DMA.RRZO_XSIZE
   ptr->writeReg(0x1064, 0x0, CAM_B);           //CAM.CAM_B.DMA.RRZO_YSIZE
   ptr->writeReg(0x1068, 0x0, CAM_B);           //CAM.CAM_B.DMA.RRZO_STRIDE
   ptr->writeReg(0x106c, 0x80000100, CAM_B);    //CAM.CAM_B.DMA.RRZO_CON
   ptr->writeReg(0x1070, 0x1000100, CAM_B);     //CAM.CAM_B.DMA.RRZO_CON2
   ptr->writeReg(0x1074, 0x1000100, CAM_B);     //CAM.CAM_B.DMA.RRZO_CON3
   ptr->writeReg(0x1078, 0x0, CAM_B);           //CAM.CAM_B.DMA.RRZO_CROP
   ptr->writeReg(0x107c, 0x1000100, CAM_B);     //CAM.CAM_B.DMA.RRZO_CON4
   ...
   ptr->writeReg(0x1098, 0x0, CAM_B);           //CAM.CAM_B.DMA.AAO_STRIDE
   ...
   ptr->writeReg(0x10f8, 0x0, CAM_B);           //CAM.CAM_B.DMA.LCSO_STRIDE
   ...
   ptr->writeReg(0x1128, 0x0, CAM_B);           //CAM.CAM_B.DMA.UFEO_STRIDE
   ...
   ptr->writeReg(0x1188, 0x0, CAM_B);           //CAM.CAM_B.DMA.BPCI_STRIDE
   ptr->writeReg(0x118c, 0x80000020, CAM_B);    //CAM.CAM_B.DMA.BPCI_CON
   ptr->writeReg(0x1190, 0x200020, CAM_B);      //CAM.CAM_B.DMA.BPCI_CON2
   ptr->writeReg(0x1194, 0x200020, CAM_B);      //CAM.CAM_B.DMA.BPCI_CON3
   ptr->writeReg(0x119c, 0x200020, CAM_B);      //CAM.CAM_B.DMA.BPCI_CON4
   ...
   ptr->writeReg(0x11e8, 0x0, CAM_B);           //CAM.CAM_B.DMA.LSCI_STRIDE
   ptr->writeReg(0x11ec, 0x80000020, CAM_B);    //CAM.CAM_B.DMA.LSCI_CON
   ptr->writeReg(0x11f0, 0x200020, CAM_B);      //CAM.CAM_B.DMA.LSCI_CON2
   ptr->writeReg(0x11f4, 0x200020, CAM_B);      //CAM.CAM_B.DMA.LSCI_CON3
   ptr->writeReg(0x11fc, 0x200020, CAM_B);      //CAM.CAM_B.DMA.LSCI_CON4
   ...
   ptr->writeReg(0x1278, 0x0, CAM_B);           //CAM.CAM_B.DMA.PSO_STRIDE
   ...
   ptr->writeReg(0x1308, 0x0, CAM_B);           //CAM.CAM_B.DMA.RSSO_A_STRIDE
   ...
   ptr->writeReg(0x1338, 0x0, CAM_B);           //CAM.CAM_B.DMA.UFGO_STRIDE
   ...
   ptr->writeReg(0x1400, 0xfff, CAM_B);         //CAM.CAM_B.DMA.FRAME_HEADER_EN
   ...
   ptr->writeReg(0x0540, 0xf0138, CAM_B);       //CAM.CAM_B.RMX.CTL
   ptr->writeReg(0x0544, 0x3fff0000, CAM_B);    //CAM.CAM_B.RMX.CROP
   ptr->writeReg(0x0548, 0x3fff, CAM_B);        //CAM.CAM_B.RMX.VSIZE
   ...
   ptr->writeReg(0x04e0, 0x80, CAM_B);          //CAM.CAM_B.RRZ.CTL
   ptr->writeReg(0x04e4, 0x0, CAM_B);           //CAM.CAM_B.RRZ.IN_IMG
   ptr->writeReg(0x04e8, 0x0, CAM_B);           //CAM.CAM_B.RRZ.OUT_IMG
   ptr->writeReg(0x04ec, 0x8000, CAM_B);        //CAM.CAM_B.RRZ.HORI_STEP
   ptr->writeReg(0x04f0, 0x8000, CAM_B);        //CAM.CAM_B.RRZ.VERT_STEP
   ptr->writeReg(0x04f4, 0x0, CAM_B);           //CAM.CAM_B.RRZ.HORI_INT_OFST
   ptr->writeReg(0x04f8, 0x0, CAM_B);           //CAM.CAM_B.RRZ.HORI_SUB_OFST
   ptr->writeReg(0x04fc, 0x0, CAM_B);           //CAM.CAM_B.RRZ.VERT_INT_OFST
   ptr->writeReg(0x0500, 0x0, CAM_B);           //CAM.CAM_B.RRZ.VERT_SUB_OFST
   ptr->writeReg(0x0504, 0x50502850, CAM_B);    //CAM.CAM_B.RRZ.MODE_TH
   ptr->writeReg(0x0508, 0x18000, CAM_B);       //CAM.CAM_B.RRZ.MODE_CTL
   ptr->writeReg(0x050c, 0x0, CAM_B);           //CAM.CAM_B.RRZ.RLB_AOFST
   ptr->writeReg(0x0510, 0x100258, CAM_B);      //CAM.CAM_B.RRZ.LBLD_CFG
   ptr->writeReg(0x0514, 0x2020, CAM_B);        //CAM.CAM_B.RRZ.NNIR_TBL_SEL
