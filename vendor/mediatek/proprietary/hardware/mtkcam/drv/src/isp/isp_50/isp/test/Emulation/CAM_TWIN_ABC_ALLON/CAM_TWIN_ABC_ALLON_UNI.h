  ...
  ptr->writeReg(0x0110, 0x18000d2, UNI_A);      //CAM.CAM_UNI.DMA.SPECIAL_FUN_EN
  ptr->writeReg(0x0138, 0x320043, UNI_A);       //CAM.CAM_UNI.DMA.RAWI_STRIDE
  ptr->writeReg(0x0174, 0xbdd4ec, UNI_A);       //CAM.CAM_UNI.DMA.DEBUG_SEL
  ptr->writeReg(0x012c, 0x815c0e14, UNI_A);     //CAM.CAM_UNI.DMA.RAWI_DRS
  ...
  ptr->writeReg(0x0114, 0x438e, UNI_A);         //CAM.CAM_UNI.DMA.SPECIAL_FUN2_EN
  ...
  ptr->writeReg(0x013c, 0x40000031, UNI_A);     //CAM.CAM_UNI.DMA.RAWI_CON
  ptr->writeReg(0x0140, 0x1c0011, UNI_A);       //CAM.CAM_UNI.DMA.RAWI_CON2
  ptr->writeReg(0x0144, 0x2c0003, UNI_A);       //CAM.CAM_UNI.DMA.RAWI_CON3
  ptr->writeReg(0x014c, 0xd310312, UNI_A);      //CAM.CAM_UNI.DMA.RAWI_CON4
  ptr->writeReg(0x0150, 0x80000000, UNI_A);     //CAM.CAM_UNI.DMA.ERR_CTRL
  ptr->writeReg(0x0154, 0xc2270000, UNI_A);     //CAM.CAM_UNI.DMA.RAWI_ERR_STAT
  ptr->writeReg(0x0158, 0xf144f0de, UNI_A);     //CAM.CAM_UNI.DMA.DEBUG_ADDR
  ptr->writeReg(0x015c, 0xc444a6a8, UNI_A);     //CAM.CAM_UNI.DMA.RSV1
  ptr->writeReg(0x0160, 0xdbbfce90, UNI_A);     //CAM.CAM_UNI.DMA.RSV2
  ptr->writeReg(0x0164, 0x87352944, UNI_A);     //CAM.CAM_UNI.DMA.RSV3
  ptr->writeReg(0x0168, 0x30eab600, UNI_A);     //CAM.CAM_UNI.DMA.RSV4
  ptr->writeReg(0x016c, 0x31dde8ad, UNI_A);     //CAM.CAM_UNI.DMA.RSV5
  ptr->writeReg(0x0170, 0x9667ad10, UNI_A);     //CAM.CAM_UNI.DMA.RSV6
  ptr->writeReg(0x0000, 0x700, UNI_A);          //CAM.CAM_UNI.TOP.CTL
  ptr->writeReg(0x0040, 0x121, UNI_A);          //CAM.CAM_UNI.TOP.MOD_DCM_DIS
  ...
  ptr->writeReg(0x001c, 0x8000000f, UNI_A);     //CAM.CAM_UNI.TOP.FMT_SEL
  ptr->writeReg(0x0020, 0x0, UNI_A);            //CAM.CAM_UNI.TOP.DMA_INT_EN
  ...
  ptr->writeReg(0x002c, 0xa8c9, UNI_A);         //CAM.CAM_UNI.TOP.DBG_SET
  ptr->writeReg(0x0030, 0x0, UNI_A);            //CAM.CAM_UNI.TOP.DBG_PORT
  ptr->writeReg(0x0034, 0x1, UNI_A);            //CAM.CAM_UNI.TOP.DMA_CCU_INT_EN
