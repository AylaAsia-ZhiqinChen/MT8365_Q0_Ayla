  ...
  ptr->writeReg(0x0110, 0x1800044,UNI_A);  			//CAM.CAM_UNI.DMA.SPECIAL_FUN_EN 
  ptr->writeReg(0x0138, 0x3f005e,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_STRIDE 
  ...
  ptr->writeReg(0x0114, 0xabc3,UNI_A);  			//CAM.CAM_UNI.DMA.SPECIAL_FUN2_EN 
  ptr->writeReg(0x0120, 0x0,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_BASE_ADDR 
  ptr->writeReg(0x0128, 0x0,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_OFST_ADDR 
  ptr->writeReg(0x012c, 0xb590c76,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_DRS 
  ptr->writeReg(0x0130, 0x0,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_XSIZE 
  ptr->writeReg(0x0134, 0x0,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_YSIZE 
  ptr->writeReg(0x013c, 0x20000028,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_CON 
  ptr->writeReg(0x0140, 0x100004,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_CON2 
  ptr->writeReg(0x0144, 0xd0006,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_CON3 
  ptr->writeReg(0x014c, 0x6500e20,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_CON4 
  ptr->writeReg(0x0150, 0x0,UNI_A);  			//CAM.CAM_UNI.DMA.ERR_CTRL 
  ptr->writeReg(0x0154, 0x46140000,UNI_A);  			//CAM.CAM_UNI.DMA.RAWI_ERR_STAT 
  ptr->writeReg(0x0158, 0xea4377fd,UNI_A);  			//CAM.CAM_UNI.DMA.DEBUG_ADDR 
  ptr->writeReg(0x015c, 0xd9b89507,UNI_A);  			//CAM.CAM_UNI.DMA.RSV1 
  ptr->writeReg(0x0160, 0xf1d1e66,UNI_A);  			//CAM.CAM_UNI.DMA.RSV2 
  ptr->writeReg(0x0164, 0x42dea61e,UNI_A);  			//CAM.CAM_UNI.DMA.RSV3 
  ptr->writeReg(0x0168, 0xdd76cc59,UNI_A);  			//CAM.CAM_UNI.DMA.RSV4 
  ptr->writeReg(0x016c, 0x61952fdb,UNI_A);  			//CAM.CAM_UNI.DMA.RSV5 
  ptr->writeReg(0x0170, 0x297f228f,UNI_A);  			//CAM.CAM_UNI.DMA.RSV6 
  ptr->writeReg(0x0174, 0x7e1e98,UNI_A);  			//CAM.CAM_UNI.DMA.DEBUG_SEL 
  ptr->writeReg(0x0040, 0x30000002,UNI_A);  			//CAM.CAM_UNI.TOP.MOD_DCM_DIS 
  ...
  ptr->writeReg(0x002c, 0xf68c,UNI_A);  			//CAM.CAM_UNI.TOP.DBG_SET 
