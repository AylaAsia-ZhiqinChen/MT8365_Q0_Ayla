  ...
  ptr->writeReg(0x0000, 0x800, UNI_A);          //CAM.CAM_UNI.TOP.CTL
  ptr->writeReg(0x0040, 0x30000123, UNI_A);     //CAM.CAM_UNI.TOP.MOD_DCM_DIS
  ...
  ptr->writeReg(0x0020, 0xa0000000, UNI_A);     //CAM.CAM_UNI.TOP.DMA_INT_EN
  ...
  ptr->writeReg(0x002c, 0x7ca9, UNI_A);         //CAM.CAM_UNI.TOP.DBG_SET
