...
public:     ////    Operations.
    ...
    inline MVOID    enableNotifyMsg(MINT32 const i4MsgTypes)            { int err_ret = ::android_atomic_or(i4MsgTypes, &mi4NotifyMsgSet);UNUSED(err_ret);}
    inline MVOID    disableNotifyMsg(MINT32 const i4MsgTypes)           { int err_ret = ::android_atomic_and(~i4MsgTypes, &mi4NotifyMsgSet);UNUSED(err_ret);}
    //
    //  data callback
    inline MBOOL    isDataMsgEnabled(MINT32 const i4MsgTypes) const     { return (i4MsgTypes & mi4DataMsgSet); }
    inline MVOID    enableDataMsg(MINT32 const i4MsgTypes)              { int err_ret = ::android_atomic_or(i4MsgTypes, &mi4DataMsgSet);
                                                                            UNUSED(err_ret);}
    inline MVOID    disableDataMsg(MINT32 const i4MsgTypes)             { int err_ret = ::android_atomic_and(~i4MsgTypes, &mi4DataMsgSet);
                                                                            UNUSED(err_ret);}
