...
#define TILE_LOSS_BNR (4)
#define TILE_LOSS_RRZ (8+4) /* cover DMX x4 & RRZ out not x4 */
#define TILE_LOSS_RRZ_L (6) /* cover DMX x4 but RRZ out not x4 */
#define TILE_LOSS_RRZ_TAP (5) /* 6 tp: 4, 8 tp: 5 */
#define TILE_LOSS_RRZ_TAP_L (3) /* 6 tp: 2, 8 tp: 3 */
#define DUAL_RRZ_WD_ALL ((2304) + (64)) /* +64 for single crop */
...
#define DUAL_HW_LUT(CMD, a, b, c, d, e, f) \
    ...
    CMD(a, b, c, d, e, f, int, DBS_MUL_B, 0x4, CAM_DBS_SIGMA_2.DBS_MUL_B, R, CAM_DBS_SIGMA_2, DBS_MUL_B)\
    CMD(a, b, c, d, e, f, int, DBS_MUL_GB, 0x4, CAM_DBS_SIGMA_2.DBS_MUL_GB, R, CAM_DBS_SIGMA_2, DBS_MUL_GB)\
    CMD(a, b, c, d, e, f, int, DBS_MUL_GR, 0x4, CAM_DBS_SIGMA_2.DBS_MUL_GR, R, CAM_DBS_SIGMA_2, DBS_MUL_GR)\
    CMD(a, b, c, d, e, f, int, DBS_MUL_R, 0x4, CAM_DBS_SIGMA_2.DBS_MUL_R, R, CAM_DBS_SIGMA_2, DBS_MUL_R)\
    ...
    CMD(a, b, c, d, e, f, int, DBS_BIAS_Y13, 0x4, CAM_DBS_BSTBL_3.DBS_BIAS_Y13, R, CAM_DBS_BSTBL_3, DBS_BIAS_Y13)\
    CMD(a, b, c, d, e, f, int, DBS_BIAS_Y14, 0x4, CAM_DBS_BSTBL_3.DBS_BIAS_Y14, R, CAM_DBS_BSTBL_3, DBS_BIAS_Y14)\
    CMD(a, b, c, d, e, f, int, DBS_HDR_GNP, 0x4, CAM_DBS_CTL.DBS_HDR_GNP, R, CAM_DBS_CTL, DBS_HDR_GNP)\
    CMD(a, b, c, d, e, f, int, DBS_SL_EN, 0x4, CAM_DBS_CTL.DBS_SL_EN, R, CAM_DBS_CTL, DBS_SL_EN)\
    CMD(a, b, c, d, e, f, int, DBS_LE_INV_CTL, 0x4, CAM_DBS_CTL.DBS_LE_INV_CTL, R, CAM_DBS_CTL, DBS_LE_INV_CTL)\
    CMD(a, b, c, d, e, f, int, DBS_EDGE, 0x4, CAM_DBS_CTL.DBS_EDGE, R, CAM_DBS_CTL, DBS_EDGE)\
    ...
    CMD(a, b, c, d, e, f, int, DBS_HDR_OSCTH, 0x4, CAM_DBS_CTL_2.DBS_HDR_OSCTH, R, CAM_DBS_CTL_2, DBS_HDR_OSCTH)\
    CMD(a, b, c, d, e, f, int, DBS_YGN_B, 0x4, CAM_DBS_YGN.DBS_YGN_B, R, CAM_DBS_YGN, DBS_YGN_B)\
    CMD(a, b, c, d, e, f, int, DBS_YGN_GB, 0x4, CAM_DBS_YGN.DBS_YGN_GB, R, CAM_DBS_YGN, DBS_YGN_GB)\
    CMD(a, b, c, d, e, f, int, DBS_YGN_GR, 0x4, CAM_DBS_YGN.DBS_YGN_GR, R, CAM_DBS_YGN, DBS_YGN_GR)\
    CMD(a, b, c, d, e, f, int, DBS_YGN_R, 0x4, CAM_DBS_YGN.DBS_YGN_R, R, CAM_DBS_YGN, DBS_YGN_R)\
	/* DBS_D */\
    CMD(a, b, c, d, e, f, int, DBS_D_EN, 0x4, CAM_CTL_EN_P1_D.DBS_D_EN, W, CAM_CTL_EN_P1_D, DBS_D_EN)\
    CMD(a, b, c, d, e, f, int, DBS_D_OFST, 0x4, CAM_DBS_D_SIGMA.DBS_OFST, W, CAM_DBS_D_SIGMA, DBS_OFST)\
    CMD(a, b, c, d, e, f, int, DBS_D_SL, 0x4, CAM_DBS_D_SIGMA.DBS_SL, W, CAM_DBS_D_SIGMA, DBS_SL)\
    CMD(a, b, c, d, e, f, int, DBS_D_MUL_B, 0x4, CAM_DBS_D_SIGMA_2.DBS_MUL_B, W, CAM_DBS_D_SIGMA_2, DBS_MUL_B)\
    CMD(a, b, c, d, e, f, int, DBS_D_MUL_GB, 0x4, CAM_DBS_D_SIGMA_2.DBS_MUL_GB, W, CAM_DBS_D_SIGMA_2, DBS_MUL_GB)\
    CMD(a, b, c, d, e, f, int, DBS_D_MUL_GR, 0x4, CAM_DBS_D_SIGMA_2.DBS_MUL_GR, W, CAM_DBS_D_SIGMA_2, DBS_MUL_GR)\
    CMD(a, b, c, d, e, f, int, DBS_D_MUL_R, 0x4, CAM_DBS_D_SIGMA_2.DBS_MUL_R, W, CAM_DBS_D_SIGMA_2, DBS_MUL_R)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y0, 0x4, CAM_DBS_D_BSTBL_0.DBS_BIAS_Y0, W, CAM_DBS_D_BSTBL_0, DBS_BIAS_Y0)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y1, 0x4, CAM_DBS_D_BSTBL_0.DBS_BIAS_Y1, W, CAM_DBS_D_BSTBL_0, DBS_BIAS_Y1)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y2, 0x4, CAM_DBS_D_BSTBL_0.DBS_BIAS_Y2, W, CAM_DBS_D_BSTBL_0, DBS_BIAS_Y2)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y3, 0x4, CAM_DBS_D_BSTBL_0.DBS_BIAS_Y3, W, CAM_DBS_D_BSTBL_0, DBS_BIAS_Y3)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y4, 0x4, CAM_DBS_D_BSTBL_1.DBS_BIAS_Y4, W, CAM_DBS_D_BSTBL_1, DBS_BIAS_Y4)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y5, 0x4, CAM_DBS_D_BSTBL_1.DBS_BIAS_Y5, W, CAM_DBS_D_BSTBL_1, DBS_BIAS_Y5)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y6, 0x4, CAM_DBS_D_BSTBL_1.DBS_BIAS_Y6, W, CAM_DBS_D_BSTBL_1, DBS_BIAS_Y6)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y7, 0x4, CAM_DBS_D_BSTBL_1.DBS_BIAS_Y7, W, CAM_DBS_D_BSTBL_1, DBS_BIAS_Y7)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y8, 0x4, CAM_DBS_D_BSTBL_2.DBS_BIAS_Y8, W, CAM_DBS_D_BSTBL_2, DBS_BIAS_Y8)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y9, 0x4, CAM_DBS_D_BSTBL_2.DBS_BIAS_Y9, W, CAM_DBS_D_BSTBL_2, DBS_BIAS_Y9)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y10, 0x4, CAM_DBS_D_BSTBL_2.DBS_BIAS_Y10, W, CAM_DBS_D_BSTBL_2, DBS_BIAS_Y10)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y11, 0x4, CAM_DBS_D_BSTBL_2.DBS_BIAS_Y11, W, CAM_DBS_D_BSTBL_2, DBS_BIAS_Y11)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y12, 0x4, CAM_DBS_D_BSTBL_3.DBS_BIAS_Y12, W, CAM_DBS_D_BSTBL_3, DBS_BIAS_Y12)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y13, 0x4, CAM_DBS_D_BSTBL_3.DBS_BIAS_Y13, W, CAM_DBS_D_BSTBL_3, DBS_BIAS_Y13)\
    CMD(a, b, c, d, e, f, int, DBS_D_BIAS_Y14, 0x4, CAM_DBS_D_BSTBL_3.DBS_BIAS_Y14, W, CAM_DBS_D_BSTBL_3, DBS_BIAS_Y14)\
    CMD(a, b, c, d, e, f, int, DBS_D_HDR_GNP, 0x4, CAM_DBS_D_CTL.DBS_HDR_GNP, W, CAM_DBS_D_CTL, DBS_HDR_GNP)\
    CMD(a, b, c, d, e, f, int, DBS_D_SL_EN, 0x4, CAM_DBS_D_CTL.DBS_SL_EN, W, CAM_DBS_D_CTL, DBS_SL_EN)\
    CMD(a, b, c, d, e, f, int, DBS_D_LE_INV_CTL, 0x4, CAM_DBS_D_CTL.DBS_LE_INV_CTL, W, CAM_DBS_D_CTL, DBS_LE_INV_CTL)\
    CMD(a, b, c, d, e, f, int, DBS_D_EDGE, 0x4, CAM_DBS_D_CTL.DBS_EDGE, W, CAM_DBS_D_CTL, DBS_EDGE)\
    CMD(a, b, c, d, e, f, int, DBS_D_HDR_GAIN, 0x4, CAM_DBS_D_CTL.DBS_HDR_GAIN, W, CAM_DBS_D_CTL, DBS_HDR_GAIN)\
    CMD(a, b, c, d, e, f, int, DBS_D_HDR_GAIN2, 0x4, CAM_DBS_D_CTL.DBS_HDR_GAIN2, W, CAM_DBS_D_CTL, DBS_HDR_GAIN2)\
    CMD(a, b, c, d, e, f, int, DBS_D_HDR_OSCTH, 0x4, CAM_DBS_D_CTL_2.DBS_HDR_OSCTH, W, CAM_DBS_D_CTL_2, DBS_HDR_OSCTH)\
    CMD(a, b, c, d, e, f, int, DBS_D_YGN_B, 0x4, CAM_DBS_D_YGN.DBS_YGN_B, W, CAM_DBS_D_YGN, DBS_YGN_B)\
    CMD(a, b, c, d, e, f, int, DBS_D_YGN_GB, 0x4, CAM_DBS_D_YGN.DBS_YGN_GB, W, CAM_DBS_D_YGN, DBS_YGN_GB)\
    CMD(a, b, c, d, e, f, int, DBS_D_YGN_GR, 0x4, CAM_DBS_D_YGN.DBS_YGN_GR, W, CAM_DBS_D_YGN, DBS_YGN_GR)\
    CMD(a, b, c, d, e, f, int, DBS_D_YGN_R, 0x4, CAM_DBS_D_YGN.DBS_YGN_R, W, CAM_DBS_D_YGN, DBS_YGN_R)\
	/* OBC */\
	...
	CMD(a, b, c, d, e, f, int, PDC_XCENTER, 0x4, CAM_BNR_PDC_POS.PDC_XCENTER, W, CAM_BNR_PDC_POS, PDC_XCENTER)\
	CMD(a, b, c, d, e, f, int, PDC_YCENTER, 0x4, CAM_BNR_PDC_POS.PDC_YCENTER, W, CAM_BNR_PDC_POS, PDC_YCENTER)\
	/* BNR_D */\
    ...
    CMD(a, b, c, d, e, f, int, RRZ_RLB_AOFST, 0x4, CAM_RRZ_RLB_AOFST.RRZ_RLB_AOFST, W, CAM_RRZ_RLB_AOFST, RRZ_RLB_AOFST)\
	/* RRZ_D */\
    ...
    CMD(a, b, c, d, e, f, int, RRZ_D_RLB_AOFST, 0x4, CAM_RRZ_D_RLB_AOFST.RRZ_RLB_AOFST, W, CAM_RRZ_D_RLB_AOFST, RRZ_RLB_AOFST)\
	/* RMX */\
...
#define DUAL_WRITE_FILE_CHECK_W(a, b, c, d, e, f, g, h, i, j, k, l, m,...) \
	...
	{\
		fprintf(a, "%s%s0x%X(%d) //%s\n", #j, SPACE_EQUAL_SYMBOL_STR, (b)->h, (b)->h, #h);\
	}\
