...
MBOOL DpeDrvImp::waitDPEFrameDone(unsigned int Status, MINT32 timeoutMs)
{
    (void)Status;
    (void)timeoutMs;
    LOG_ERR("waitDPEFrameDone Error!!, This is DPE Dummy Driver!!");
...
{
    (void)pDveCfg;
    LOG_ERR("checkDVESetting Error!!, This is DPE Dummy Driver!!");
...
{
    (void)DveConfigVec;
    LOG_ERR("enqueDVE Error!!, This is DPE Dummy Driver!!");
...
{
    (void)DveConfigVec;
    LOG_ERR("dequeDVE Error!!, This is DPE Dummy Driver!!");
...
{
    (void)pWmfeCtrl;
    LOG_ERR("checkWMFESetting Error!!, This is DPE Dummy Driver!!");
...
{
    (void)WmfeConfigVec;
    LOG_ERR("enqueWMFE Error!!, This is DPE Dummy Driver!!");
...
{
    (void)WmfeConfigVec;
    LOG_ERR("dequeWMFE Error!!, This is DPE Dummy Driver!!");
...
MBOOL DpeDrvImp::writeReg(MUINT32 Addr,unsigned long Data,MINT32 caller)
{
    ...
    (void)Data;
    (void)caller;
    LOG_ERR("writeReg Error!!, This is DPE Dummy Driver!!");
    //
    return MTRUE;
}
...
MBOOL DpeDrvImp::writeRegs(DPE_DRV_REG_IO_STRUCT*  pRegIo,MUINT32 Count,MINT32 caller)
{
    ...
    (void)Count;
    (void)caller;
    LOG_ERR("writeRegs Error!!, This is DPE Dummy Driver!!");
    return MTRUE;
