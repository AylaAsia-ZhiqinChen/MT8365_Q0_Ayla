...
class DpeDrv
{
    ...
    public:
        ...
        virtual MBOOL   enqueDVE(vector<NSCam::NSIoPipe::DVEConfig>& DveConfigVec) = 0;
        virtual MBOOL   enqueWMFE(vector<NSCam::NSIoPipe::WMFEConfig>& WmfeConfigVec) = 0;

        virtual MBOOL   dequeDVE(vector<NSCam::NSIoPipe::DVEConfig>& DveConfigVec) = 0;
...
class DpeDrvImp : public DpeDrv
{
    ...
    public:
        ...
        virtual MBOOL   checkDVESetting(NSCam::NSIoPipe::DVEConfig* pDveCfg);
        ...
        virtual MBOOL   enqueDVE(vector<NSCam::NSIoPipe::DVEConfig>& DveConfigVec);
        virtual MBOOL   enqueWMFE(vector<NSCam::NSIoPipe::WMFEConfig>& WmfeConfigVec);

        virtual MBOOL   dequeDVE(vector<NSCam::NSIoPipe::DVEConfig>& DveConfigVec);
