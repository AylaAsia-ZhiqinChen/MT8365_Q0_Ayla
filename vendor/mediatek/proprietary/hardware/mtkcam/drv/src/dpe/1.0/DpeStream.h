...
#ifndef _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_DPE_DpeStream_H_
#define _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_DPE_DpeStream_H_
//
 ...
 *
 ******************************************************************************/
class DpeStream : public IDpeStream
{
    friend  class IDpeStream;
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  IPipe Interface.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
private:
    ...
    MVOID releaseLock();
    MINT32 getUs();
    MBOOL saveToFile(char const* filepath, DPEBufInfo* buffer);
...
private:
    ...
    static sem_t               mSemDpeThread;
    static Mutex      mDpeCmdLock;
    static Condition  mCmdListCond;

    //static mutable  Mutex      mDpeCmdLock;
    //static mutable  Condition  mCmdListCond;
    MBOOL m_DpeStreamInit;
    int m_iDveEnqueReq;
    int m_iWmfeEnqueReq;
    int m_bSaveReqToFile;

    //Block Deque Used.
    mutable  Condition  mDveDequeCond;
...
#endif  //_MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_DPE_DpeStream_H_
