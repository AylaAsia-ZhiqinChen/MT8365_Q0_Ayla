...
#LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/drv/src/isp/dip/5.0/inc
...
ifneq (, $(findstring $(strip $(TARGET_BOARD_PLATFORM)), mt6779))
LOCAL_CFLAGS += -DNEW_M4U_PORT_DEF
else
endif
