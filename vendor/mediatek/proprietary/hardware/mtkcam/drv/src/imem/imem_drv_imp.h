...
//-----------------------------------------------------------------------------
class StdIMemDrvImp : public StdIMemDrv
{
    public:
        StdIMemDrvImp();
        ~StdIMemDrvImp();
    //
    public:
        static StdIMemDrv*  getInstance(void);
        ...
        virtual MINT32  doIonCacheFlush(MINT32 memID,eIONCacheFlushType flushtype,MUINT32 memSize=0);
