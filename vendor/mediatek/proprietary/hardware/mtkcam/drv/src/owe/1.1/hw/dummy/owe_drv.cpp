...
MBOOL OweDrvImp::checkWMFESetting(NSCam::NSIoPipe::WMFECtrl* pWmfeCtrl)
{
    (void)pWmfeCtrl;
...
MBOOL OweDrvImp::enqueWMFE(vector<NSCam::NSIoPipe::WMFEConfig>& WmfeConfigVec)
{
    (void)WmfeConfigVec;
...
MBOOL OweDrvImp::dequeWMFE(vector<NSCam::NSIoPipe::WMFEConfig>& WmfeConfigVec)
{
    (void)WmfeConfigVec;
