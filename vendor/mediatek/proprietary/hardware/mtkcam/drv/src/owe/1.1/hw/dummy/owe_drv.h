...
class OweDrv
{
    ...
    public:
        ...
        virtual MBOOL   enqueWMFE(vector<NSCam::NSIoPipe::WMFEConfig>& WmfeConfigVec) = 0;

        virtual MBOOL   dequeOCC(vector<NSCam::NSIoPipe::OCCConfig>& OccConfigVec) = 0;
        virtual MBOOL   dequeWMFE(vector<NSCam::NSIoPipe::WMFEConfig>& WmfeConfigVec) = 0;
...
class OweDrvImp : public OweDrv
{
    ...
    public:
        ...
        virtual MBOOL   checkWMFESetting(NSCam::NSIoPipe::WMFECtrl* pWmfeCtrl);
        ...
        virtual MBOOL   enqueWMFE(vector<NSCam::NSIoPipe::WMFEConfig>& WmfeConfigVec);

        virtual MBOOL   dequeOCC(vector<NSCam::NSIoPipe::OCCConfig>& OccConfigVec);
        virtual MBOOL   dequeWMFE(vector<NSCam::NSIoPipe::WMFEConfig>& WmfeConfigVec);
