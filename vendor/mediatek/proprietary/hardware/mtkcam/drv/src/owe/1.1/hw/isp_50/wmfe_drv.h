 ...
 */
const ENGINE_CTRL wmfe_ctl[eENGINE_MAX] =
{
    {
      .id = eOCC,
      .cmd    = ECmd_ENQUE,
...
*/
class WmfeDrvImp : public EngineDrv<OWMFEConfig>
{
    public:
                        ~WmfeDrvImp(void){}
                        WmfeDrvImp(void);
    ...
    public:
        ...
        static EngineDrv<OWMFEConfig>*  getInstance();
        ...
        virtual MBOOL   enque(vector<NSCam::NSIoPipe::OWMFEConfig>& WmfeConfigVec);

        virtual MBOOL   deque(vector<NSCam::NSIoPipe::OWMFEConfig>& WmfeConfigVec);
