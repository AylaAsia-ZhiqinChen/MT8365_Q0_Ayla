...
#define MFB_BITS(RegBase, RegName, FieldName)  (RegBase->RegName.Bits.FieldName)
#define MFB_REG(RegBase, RegName) (RegBase->RegName.Raw)

/**
    REG size for each module is 0x1000
*/
#define MFB_BASE_RANGE (0x1000)
