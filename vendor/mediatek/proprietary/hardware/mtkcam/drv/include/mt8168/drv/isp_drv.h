...
//TH    CAM_TOP_IMGSYS  = 0,// 65   15000000~15000104
    ...
    CAM_DMA_IMGI,        // 8    15007230~1500724C
    CAM_DMA_IMGI_SECURE, // 7    15007234~1500724C	// Baseaddress is updated by secure cmdq
    ...
    CAM_DMA_IMG2O_SECURE,// 7    15007444~1500745C  // Baseaddress is updated by secure cmdq
...
typedef struct
{
	...
	MUINT32 CAM_CTL_FMT_SEL_P1;
	MUINT32 CAM_CTL_FMT_SEL_P1_D;
	MUINT32 CAM_CTL_SEL_P1;
	MUINT32 CAM_CTL_SEL_P1_D;
	MUINT32 CAM_CTL_SEL_GLOBAL;
}ISP_DRV_DAPC_REG_STRUCT;
...
/* this data structure must be equal to ISP_ED_BUFQUE_STRUCT in camera_isp.h */
typedef struct
{
...
class IspDrv
{
    ...
    virtual MBOOL   checkCQBufAllocated(void) = 0;
        ...
        virtual MUINT32* getCQVirBufPhyAddr(MINT32 cq,MINT32 burstQIdx,MINT32 dupCqIdx);
        ...
        virtual MBOOL setDapcReg(vector<MUINT32> reg_list) = 0;
        virtual MBOOL setDapcRegVal(ISP_DRV_DAPC_REG_STRUCT* DapcReg) = 0;
