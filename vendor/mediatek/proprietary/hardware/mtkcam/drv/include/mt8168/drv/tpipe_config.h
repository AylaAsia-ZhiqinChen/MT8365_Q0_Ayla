...
{
	uint64_t DesCqPa;
	uint64_t DesCqVa; // for debugging
	...
	uint64_t VirtRegPa;
	uint64_t VirtRegVa;
	uint64_t CQDescSecBufHdl;
	uint32_t CQDescSecBufSize;
	uint64_t CQVirtSecBufHdl;
	uint32_t CQVirtSecBufSize;
	uint64_t tpipeTableSecHdl;
	uint32_t tpipeTableSecSize;
	uint32_t dip_ctl_yuv_en;
	uint32_t dip_ctl_rgb_en;
	uint32_t dip_ctl_dma_en;
	uint32_t dip_ctl_fmt_sel;
	uint32_t dip_ctl_path_sel;
	uint32_t dip_ctl_misc_sel;
	uint32_t dip_img2o_base_addr;
	uint32_t dip_imgi_base_addr;
