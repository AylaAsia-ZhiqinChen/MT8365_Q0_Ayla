...
public class Op01SystemUICustomizationFactory extends OpSystemUICustomizationFactoryBase {
    private Context mContext;

    public Op01SystemUICustomizationFactory(Context context) {
        super();
        mContext = context;
    }
    ...
    public IQuickSettingsPlugin makeQuickSettings(Context context) {
        return new OP01QuickSettingsPlugin(mContext);
    }

    @Override
    public ISystemUIStatusBarExt makeSystemUIStatusBar(Context context) {
        return new Op01SystemUIStatusBarExt(mContext);
    }
}