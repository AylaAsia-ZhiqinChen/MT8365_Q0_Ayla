...
public class Op01KeyguardCustomizationFactory extends OpKeyguardCustomizationFactoryBase {
    private Context mContext;

    public Op01KeyguardCustomizationFactory(Context context) {
        super();
        mContext = context;
    }
    ...
    @Override
	  public ICarrierTextExt makeCarrierText() {
        return new OP01CarrierTextExt();
    }

    @Override
    public IEmergencyButtonExt makeEmergencyButton() {
        return new OP01EmergencyButtonExt();
    }

    @Override
    public IKeyguardUtilExt makeKeyguardUtil() {
        return new OP01KeyguardUtilExt(mContext);
    }
}