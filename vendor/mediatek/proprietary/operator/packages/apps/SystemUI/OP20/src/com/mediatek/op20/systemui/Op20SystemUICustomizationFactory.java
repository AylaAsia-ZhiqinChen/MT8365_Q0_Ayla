...
public class Op20SystemUICustomizationFactory extends OpSystemUICustomizationFactoryBase {

    private Context mContext;

    public Op20SystemUICustomizationFactory(Context context) {
        mContext = context;
    }

    @Override
    public ISystemUIStatusBarExt makeSystemUIStatusBar(Context context) {
        return new Op20SystemUIStatusBarExt(mContext);
    }
}
