...
public class Op02SystemUICustomizationFactory extends OpSystemUICustomizationFactoryBase {
    private Context mContext;

    public Op02SystemUICustomizationFactory(Context context) {
        super();
        mContext = context;
    }
    ...
    public IQuickSettingsPlugin makeQuickSettings(Context context) {
        return new OP02QuickSettingsPlugin(mContext);
    }

    @Override
    public ISystemUIStatusBarExt makeSystemUIStatusBar(Context context) {
        return new Op02SystemUIStatusBarExt(mContext);
    }
}