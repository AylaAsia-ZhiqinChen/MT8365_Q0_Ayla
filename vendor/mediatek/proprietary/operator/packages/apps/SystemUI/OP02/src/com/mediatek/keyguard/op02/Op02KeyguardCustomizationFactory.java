...
public class Op02KeyguardCustomizationFactory extends OpKeyguardCustomizationFactoryBase {
    private Context mContext;

    public Op02KeyguardCustomizationFactory(Context context) {
        super();
        mContext = context;
    }
    ...
    @Override
	  public ICarrierTextExt makeCarrierText() {
        return new OP02CarrierTextExt();
    }

    @Override
    public IEmergencyButtonExt makeEmergencyButton() {
        return new OP02EmergencyButtonExt();
    }

    @Override
    public IKeyguardUtilExt makeKeyguardUtil() {
        return new OP02KeyguardUtilExt(mContext);
    }
}