...
public class OP07SystemUICustomizationFactory extends OpSystemUICustomizationFactoryBase {
    @Override
    public IStatusBarPlmnPlugin makeStatusBarPlmn(Context context) {
        return new Op07StatusBarPlmnPluginExt(context);
    }

    @Override
    public ISystemUIStatusBarExt makeSystemUIStatusBar(Context context) {
        return new Op07SystemUIStatusBarExt(context);
    }
}