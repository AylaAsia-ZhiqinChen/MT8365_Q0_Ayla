...
/**
 * M: Op18 PhoneState Listener Controller.
 */
public class PhoneStateListenerController {
    private static final String TAG = "OP18-PhoneStateListenerController";
    ...
    /**
     * The constructor for phone state.
     * @param context the context.
     */
    public PhoneStateListenerController(Context context) {
        Log.v(TAG, "OP18 PhoneStateListenerService onCreate");
