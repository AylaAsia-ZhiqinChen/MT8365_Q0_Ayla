...
public class Op18SystemUICustomizationFactory extends OpSystemUICustomizationFactoryBase {

    private Context mContext;

    public Op18SystemUICustomizationFactory(Context context) {
        mContext = context;
    }

    @Override
    public ISystemUIStatusBarExt makeSystemUIStatusBar(Context context) {
        return new Op18SystemUIStatusBarExt(mContext);
    }

    @Override
    public IQuickSettingsPlugin makeQuickSettings(Context context) {
        return new OP18QuickSettingsExt(mContext);
    }
}