...
public class Op09SystemUICustomizationFactory extends OpSystemUICustomizationFactoryBase {
    private Context mContext;

    public Op09SystemUICustomizationFactory(Context context) {
        super();
        mContext = context;
    }
    ...
    public ISystemUIStatusBarExt makeSystemUIStatusBar(Context context) {
        return new Op09SystemUIStatusBarExt(mContext);
    }
}