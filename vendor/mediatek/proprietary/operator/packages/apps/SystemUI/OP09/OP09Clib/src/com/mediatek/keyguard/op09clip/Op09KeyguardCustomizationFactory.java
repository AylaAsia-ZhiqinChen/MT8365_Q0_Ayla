...
public class Op09KeyguardCustomizationFactory extends OpKeyguardCustomizationFactoryBase {
    private Context mContext;

    public Op09KeyguardCustomizationFactory(Context context) {
        super();
        mContext = context;
    }
    ...
    @Override
	  public ICarrierTextExt makeCarrierText() {
        return new OP09CarrierTextExt(mContext);
    }

    @Override
    public IEmergencyButtonExt makeEmergencyButton() {
        return new OP09EmergencyButtonExt();
    }
}