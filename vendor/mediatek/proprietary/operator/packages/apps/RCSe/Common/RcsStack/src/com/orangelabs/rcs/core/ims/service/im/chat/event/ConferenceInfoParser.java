   ...
   */
    ...
    public void startElement(String namespaceURL, String localName,    String qname, Attributes attr) {
        ...
        if (localName.equals("user")) {
            String entity = attr.getValue("entity").trim();
            String userState = attr.getValue("state");
            if(userState != null){
            ...
            user = new User(entity, me, userState);
        }
    }
    ...
    public void endElement(String namespaceURL, String localName, String qname) {
        ...
        if (localName.equals("displayname")) {
            if (user != null) {
                ...
                try {
                    displayName = URLDecoder.decode(accumulator.toString().trim(), "UTF-8");
                } catch (Exception e) {
                }
        ...
        if (localName.equals("entry")) {
            if (user != null) {
                user.setRole(accumulator.toString().trim());
            }
        } else
        ...
        if (localName.equals("subject")) {
            conference.setSubject(accumulator.toString().trim());
            if (logger.isActivated()) {
                logger.debug("Conference-Info subject is "+ conference.getSubject());
            }
        } else
        if (localName.equals("displayname")) {
                conference.setDisplayName(accumulator.toString().trim());
                if (logger.isActivated()) {
                    logger.debug("Conference-Info display name is "+ conference.getDisplayName());
                }
        } else
        ...
        if (localName.equals("user-count")) {
            ...
            conference.setUserCount(Integer.parseInt(count));
        } else
        if (localName.equals("etype")) {
            if (user != null) {
                user.setEtype(accumulator.toString().trim());
            }
        } else
        if (localName.equals("conference-info")) {
            if (logger.isActivated()) {
