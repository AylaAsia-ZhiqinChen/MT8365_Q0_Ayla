...
import com.gsma.services.rcs.IJoynServiceRegistrationListener; //to be removed
...
public class MultimediaSessionServiceImpl extends IMultimediaSessionService.Stub {
    ...
    public void receiveSipMsrpSessionInvitation(GenericSipMsrpSession session) {
        ContactId remote = session.getRemoteContactId();
    ...
    public void addEventListener(IJoynServiceRegistrationListener s){
    }
    public void removeEventListener(IJoynServiceRegistrationListener d){
    }
}
