 ...
 */
public class UnregGroupMessageProvider extends ContentProvider {
    /**
     * The Constant TAG.
     */
    private static final String TAG = "UnregGroupMessageProvider";
    // Content Uri
    /**
     * The Constant CONTENT_URI.
     */
    public static final Uri CONTENT_URI = Uri
            .parse("content://com.mediatek.rcse.unreg_group_messages");
    // UregMessageHelper instance
    /**
     * The m msg helper.
     */
    private UregGroupMessageHelper mMsgHelper = null;
    // Database version
    /**
    ...
    /**
     * The Constant KEY_MESSAGE_ID.
     */
    public static final String KEY_MESSAGE_ID = "msg_id"; 
    /**
     * The Constant KEY_CHAT_ID.
     */
    public static final String KEY_CHAT_ID = "chat_id";
    /**
     * The Constant KEY_TIMESTAMP.
     */
    public static final String KEY_TIMESTAMP = "msg_timestamp";
    // Database name
    /**
     * The Constant DATABASE_NAME.
     */
    private static final String DATABASE_NAME = "groupmessages.db";
    // SQliteDatabase instance
    /**
     * The group messaging db.
     */
    ...
    public boolean onCreate() {
        mMsgHelper = new UregGroupMessageHelper(getContext());
    ...
    */
     ...
     */
    public static class UregGroupMessageHelper extends SQLiteOpenHelper {
         ...
         */
        public UregGroupMessageHelper(Context context) {
        ...
        public void onCreate(SQLiteDatabase db) {
            try {
                Logger.i(TAG, "Create Table groupmessages");
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVer,
                int newVer) {
            try {
                Logger.i(TAG, "Upgrade Groupmessage DB oldVer: " + oldVer + ", newver: " + newVer);
                mDbVersion = newVer;
