...
public class AnonymousFetchRequestTask {
    ...
    private SipRequest createSubscribe() throws SipException, CoreException {
        ...
        subscribe = SipMessageFactory.createPresenceSubscribe(dialogPath, 3600, xml);
        
        } else if (contacts != null && contacts.size() == 1){
            contact = contacts.get(0);
            subscribe = SipMessageFactory.createIndividualPresenceSubscribe(dialogPath, 3600, contacts.get(0));

        } else if(contact != null) {
            subscribe = SipMessageFactory.createIndividualPresenceSubscribe(dialogPath, 3600, contact);
        }
