...
public class GroupDeliveryInfoLog implements IGroupDeliveryInfoLog {
    ...
    private final ContentResolver mLocalContentResolver;

    /**
     * Constructor
     * 
     * @param  Local content resolver
     */
    /* package private */GroupDeliveryInfoLog(Context ctx) {
        mLocalContentResolver = ctx.getContentResolver();
    }
    ...
    public boolean setGroupChatDeliveryInfoStatusAndReasonCode(String chatId, String contact,
        ...
        ContentValues values = new ContentValues();
        values.put(GroupDeliveryInfoData.KEY_STATUS, status);
