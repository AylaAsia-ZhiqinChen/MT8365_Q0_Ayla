 ...
 */
public class PluginMultiChatActivity extends ChatScreenActivity implements
        PhotoLoaderManager.OnPhotoChangedListener {
    /**
     * The Constant TAG.
     */
    public static final String TAG = "PluginMultiChatActivity";
    /**
     * The Constant ACTION.
     */
    public static final String ACTION = "com.mediatek.rcse.action.PLUGIN_MULTI_CHAT";
    /**
     * The m key.
     */
    ...
    protected void handleIntentAction(Intent intent) {
        Logger.d(TAG, "handleIntentAction() Multi entry with the intent is " + intent);
        Bundle data = intent.getExtras();
        Logger.d(TAG, "handleIntentAction() Multi ,the data is " + data);
    ...
    public void addMultiChatUi(MultiChatFragment chatFragment,
        ...
        super.addMultiChatUi(chatFragment, clickListener);
