...
public class ParticipantInfo implements Parcelable {
    ...
    /**
     * @param mChatID Chat Id of group.
     */
    ...
    public ParticipantInfo(Participant participant, String state) {
        if (null == participant) {
            Logger.w(TAG,
                    "ParticipantInfo#ParticipantAppInfo() participant is null");
        }
    ...
    public void setState(String state){
    	Logger.d(TAG, "ParticipantInfo setState state=" + state + "contact="+ mParticipant);
    	mState = state;
    }
     ...
     * Parcelable creator.
     */
    public static final Parcelable.Creator<ParticipantInfo> CREATOR = new
    Parcelable.Creator<ParticipantInfo>() {
