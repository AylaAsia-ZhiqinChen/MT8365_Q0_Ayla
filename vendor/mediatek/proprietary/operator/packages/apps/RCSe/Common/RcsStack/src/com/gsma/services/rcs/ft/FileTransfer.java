...
public class FileTransfer {
    ...
    public enum State {
        ...
        /**
         * File transfer has been initiated for HTTP FT
         */
        INITIATED(12),
    ...
    public enum ReasonCode {
        ...
        /**
         * File transfer failed.Fallback to MMS.
         */
        FAILED_FALLBACK_MMS(21),

        /**
         * File transfer not allowed to be sent.
         */
        FAILED_NOT_ALLOWED_TO_SEND(22),

        /**
         * File transfer need to be resumed.
         */
        FAILED_NEED_TO_RESUME(23),

        /**
         * FALLABCK TO LARGE MODE.
         */
        FALLBACK_LARGE_MODE(23),
     ...
     */
    private IFileTransfer mTransferInf;
    ...
    public FileTransfer(IFileTransfer transferIntf) {
        this.mTransferInf = transferIntf;
    }
    ...
    public void resendTransfer() throws RcsPermissionDeniedException, RcsGenericException {
        try {
            Logger.i(TAG, "resendTransfer entry");
