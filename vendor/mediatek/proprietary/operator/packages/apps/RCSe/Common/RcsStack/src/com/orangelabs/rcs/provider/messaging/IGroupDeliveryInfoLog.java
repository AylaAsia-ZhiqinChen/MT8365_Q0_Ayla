...
public interface IGroupDeliveryInfoLog {
     ...
     */
    Uri addGroupChatDeliveryInfoEntry(String chatId, String contact, String msgId,
     ...
     */
    boolean setGroupChatDeliveryInfoStatusAndReasonCode(String chatId, String contact,
     ...
     * @return True if an entry was updated, otherwise false
     */
    boolean setGroupChatDeliveryInfoDelivered(String chatId, String contact, String msgId,
     ...
     * @return True if an entry was updated, otherwise false
     */
    boolean setGroupChatDeliveryInfoDisplayed(String chatId, String contact, String msgId,
