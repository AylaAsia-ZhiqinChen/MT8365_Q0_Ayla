 ...
 */
public class OneOneChatWindow extends ChatScreenWindow implements
        ChatView.IOne2OneChatWindow {
    private One2OneChatFragment mOneOneChatFragment = null;

    /**
     * @return one2onechatFragment
     */
    ...
    private boolean shouldLoadData() {
        synchronized (sLock) {
            ...
            if (mTag != null && mTag.equals(instance.getCurrentTag())) {
                Logger.v(TAG, "shouldLoadData return true");
                return true;
            } else if (mParticipant == null) {
                Logger.v(TAG,
                        "shouldLoadData return false, with mParticipant is null");
                return false;
            } else {
    ...
    public One2OneChatFragment getFragment() {
        ...
        if (mOneOneChatFragment == null) {
            Logger.v(TAG, "getFragment create fragment " + mTag);
            ...
            arguments.putParcelableArrayList(Utils.CHAT_PARTICIPANTS,
                    participantList);
    ...
    public void pause() {
        ...
        Logger.d(TAG, "pause entry: mTag = " + mTag + ", controller = "
                + controller);
        if (null != controller) {
    ...
    public void resume() {
        ControllerImpl controller = ControllerImpl.getInstance();
        Logger.d(TAG, "resume entry: mTag = " + mTag + ", controller = "
                + controller + ", mOneOneChatFragment = " + mOneOneChatFragment);
        if (null != controller) {
            Message controllerMessage = controller.obtainMessage(
    ...
    public IReceivedChatMessage addReceivedMessage(ChatMessage message,
        ...
        Logger.d(
                TAG,
                "addReceivedMessage entry: mTag = " + mTag
        ...
        if (shouldLoadData()) {
            if (mOneOneChatFragment != null) {
                iReceivedChatMessage = mOneOneChatFragment.addReceivedMessage(
                        message, isRead);
            }
        }
    ...
    public ISentChatMessage addSentMessage(ChatMessage message, int messageTag) {
        Logger.d(
                TAG,
                "addSentMessage entry: mTag = " + mTag
                        + ", mOneOneChatFragment = " + mOneOneChatFragment
                        + ", message = "
                        + ((message == null) ? null : message.getContent()));
        ...
        if (shouldLoadData()) {
            if (mOneOneChatFragment != null) {
                iSentChatMessage = mOneOneChatFragment.addSentMessage(message,
                        messageTag);
            }
        }
    ...
    public void removeAllMessages() {
        Logger.d(TAG, "removeAllMessages entry: mTag = " + mTag
                + ", mOneOneChatFragment = " + mOneOneChatFragment);
        if (mOneOneChatFragment != null) {
    ...
    public IChatWindowMessage getSentChatMessage(String messageId) {
        Logger.d(TAG, "getSentChatMessage entry: mTag = " + mTag
                + ", mOneOneChatFragment = " + mOneOneChatFragment);
        IChatWindowMessage iChatWindowMessage = null;

        if (mOneOneChatFragment != null) {
            iChatWindowMessage = mOneOneChatFragment
    ...
    public void setFileTransferEnable(int reason) {
        ...
        if (!shouldLoadData()) {
            Logger.v(TAG,
                    "setFileTransferEnable this window is not focused, the tag is: "
                            + mTag);
            return;
        }
        if (mOneOneChatFragment != null) {
            ...
            Logger.v(TAG, "setFileTransferEnable mOneOneChatFragment is null");
        }
    }
    ...
    public void setIsComposing(boolean isComposing) {
        ...
        if (!shouldLoadData()) {
            Logger.v(TAG,
                    "setIsComposing this window is not focused, the tag is: "
                            + mTag);
            return;
        }
        if (mOneOneChatFragment != null) {
            ...
            Logger.v(TAG, "setIsComposing mOneOneChatFragment is null");
        }
    }
    ...
    public void setRemoteOfflineReminder(boolean isOffline) {
        Logger.d(TAG,
                "setRemoteOfflineReminder() entry, isOffline status is : "
                        + isOffline);
        if (!shouldLoadData()) {
            Logger.v(TAG,
                    "setRemoteOfflineReminder(), this window is not focused, the tag is: "
                            + mTag);
            return;
        }
        if (mOneOneChatFragment != null) {
            ...
            Logger.v(TAG,
                    "setRemoteOfflineReminder() mOneOneChatFragment is null");
        }
    }
    ...
    public IFileTransfer addReceivedFileTransfer(FileStruct file,
        ...
        Logger.d(TAG, "addReceivedFileTransfer entry: mTag = " + mTag
                + ", mOneOneChatFragment = " + mOneOneChatFragment);
        IFileTransfer iFileTransfer = null;

        if (shouldLoadData()) {
            if (mOneOneChatFragment != null) {
                iFileTransfer = mOneOneChatFragment.addReceivedFileTransfer(
                        file, isAutoAccept);
            }
        }
        return iFileTransfer;
    ...
    public void addUnreadMessage(ChatMessage message) {
        Logger.d(TAG, "addUnreadMessage entry, notice null check is in outer, "
                + ", mTag =  " + mTag + ", mOneOneChatFragment = "
                + mOneOneChatFragment + ", message = " + message.getContent());
    ...
    public void addContacts() {
        Logger.d(TAG, "addContacts entry, mOneOneChatFragment = "
                + mOneOneChatFragment);
        if (mOneOneChatFragment != null) {
    ...
    public void removeContacts() {
        Logger.d(TAG, "removeContacts entry, mOneOneChatFragment = "
                + mOneOneChatFragment);
    }

    @Override
    public void removeChatUi() {
        Logger.d(TAG, "removeChatUi entry: mOneOneChatFragment = "
                + mOneOneChatFragment);
    ...
    public boolean clearHistory() {
        Logger.d(TAG, "clearHistory entry: mOneOneChatFragment = "
                + mOneOneChatFragment);
    ...
    public void updateAllMsgAsRead() {
        ...
        if (mOneOneChatFragment != null) {
            ...
            Logger.v(TAG, "updateAllMsgAsRead() mOneOneChatFragment is null");
            return;
        }
    }
