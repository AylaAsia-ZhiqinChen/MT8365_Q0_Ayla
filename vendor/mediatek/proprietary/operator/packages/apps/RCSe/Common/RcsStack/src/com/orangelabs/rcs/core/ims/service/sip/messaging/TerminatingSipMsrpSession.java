...
public class TerminatingSipMsrpSession extends GenericSipMsrpSession {
    ...
    public TerminatingSipMsrpSession(SipService parent, SipRequest invite, ImsModule imsModule,
        ...
        super(parent, contact,null /*GenericSipSession.getIariFeatureTag(invite.getFeatureTags())*/);
    ...
    /*        for (ImsSessionListener listener : listeners) {
            ...
            InvitationStatus answer = waitInvitationAnswerExt();
            switch (answer) {
                ...
                case INVITATION_REJECTED_BUSY_HERE:
                  ...
                  //  sendErrorResponse(dialogPath.getInvite(), answer);
                    removeSession();
           ...
           // SipUtils.assertContentIsNotNull(remoteSdp, invite);
            ...
            SipTransactionContext ctx = null;//sipManager.sendSipMessage(resp);
