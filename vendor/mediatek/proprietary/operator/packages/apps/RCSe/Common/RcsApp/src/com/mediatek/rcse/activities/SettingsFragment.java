...
public class SettingsFragment extends PreferenceFragment implements
    ...
    private CheckBoxPreference mRequestReadReceiptCheckBox = null;
    private CheckBoxPreference mGroupMessagingCheckBox = null;
    private static final String PREF_COMPRESS_LIST = "rcse_compress_image_size";
    private ListPreference mCompressImageListPref;
    ...
    public static final String RCS_REQUEST_READ_RECEIPT = "rcse_request_read_receipt";
    public static final String RCS_GROUP_MESSAGING_TOGGLE = "rcse_group_messaging";
    ...
    private static final String RCSE_COMPRESS_VIDEO = "rcse_compress_video";
    ...
    private ConfirmDialogOfClearhistory mDialog = new ConfirmDialogOfClearhistory(this);
    public static final AtomicBoolean IS_NOTIFICATION_CHECKED = new AtomicBoolean(
            true);
            ...
            if (msg.what == CLEAR_HISTORY_MESSAGE_ID) {
                if (mClearHistoryTask != null && mClearHistoryProgress != null
                    ...
                    if (null != activity) {
                        ...
                        Logger.e(TAG,
                                "mHandler->handleMessage() activity is null");
                    }
                } else {
    ...
    private CheckBoxPreference mCompressVideoCheckBox = null;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (null != bundle) {
            if (EXTRA_VALUE_FROM_MMS.equals(bundle
                    .getString(EXTRA_KEY_FROM_MMS))) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSettings = getActivity().getSharedPreferences(SETTINGS_PREFERENCES,
        ...
        mDisableJoyn
                .setOnPreferenceClickListener(new OnPreferenceClickListener() {
                    ...
                    public boolean onPreferenceClick(Preference preference) {
                        ...
                        if (preference == null) {
                            Logger.d(TAG,
                                    "onPreferenceClick()-preference is null");
                        } else {
                            ...
                            if (key == null) {
                                ...
                                if (RCS_DISABLE_JOYN.equals(key)) {
                                    if (mDisableJoyn != null) {
                                        boolean isChecked = mDisableJoyn
                                                .isChecked();
                                        Logger.d(TAG,
                                        ...
                                        mSettings
                                                .edit()
                                                .putBoolean(RCS_DISABLE_JOYN,
                                                        isChecked).apply();
                                        AppSettings
                                                .getInstance()
                                                .setJoynMessagingDisabledFullyIntegrated(
                                                        isChecked);
                                        retValue = true;
        ...
        if (PluginUtils.getMessagingMode() == 0) {
            Logger.d(TAG, "Converged mode remove Disbale joyn Messaging");
        ...
        if (!RcsSettings.getInstance().isFileTransferAutoAccepted()) {// if
                                                                      // ftAuto
                                                                      // disable
                                                                      // should
                                                                      // hide
            ...
            ftAutoPreRoaming
                    .setOnPreferenceClickListener(new OnPreferenceClickListener() {
                        @Override
                        public boolean onPreferenceClick(Preference preference) {
                            final boolean checked = ftAutoPreRoaming
                                    .isChecked();
                            RcsSettings.getInstance()
                                    .setEnableFtAutoAcceptWhenRoaming(checked);
                            return true;
                        }
                    });
            ftAutoPreNonRoaming
                    .setOnPreferenceClickListener(new OnPreferenceClickListener() {
                        @Override
                        public boolean onPreferenceClick(Preference preference) {
                            final boolean checked = ftAutoPreNonRoaming
                                    .isChecked();
                            RcsSettings
                                    .getInstance()
                                    .setEnableFtAutoAcceptWhenNoRoaming(checked);
                            return true;
                        }
                    });
        }
                            ...
                            if (key == null) {
                                ...
                                if (RCS_SEND_READ_RECEIPT.equals(key)) {
                                    if (mSendReadReceiptCheckBox != null) {
                                        boolean isChecked = mSendReadReceiptCheckBox
                                                .isChecked();
                                        Logger.d(TAG,
                                                "onPreferenceClick(), the status of mSendReadReceiptCheckBox is "
                                                        + isChecked);
                                        RcsSettings.getInstance().setImDisplayedNotificationActivated(isChecked);
                                        mSettings
                                                .edit()
                                                .putBoolean(
                                                        RCS_SEND_READ_RECEIPT,
                                                        isChecked).apply();
                                        retValue = true;
                                    } else {
                                        Logger.d(TAG,
        ...
        mGroupMessagingCheckBox = (CheckBoxPreference) findPreference(RCS_GROUP_MESSAGING_TOGGLE);
        mGroupMessagingCheckBox.setChecked(RcsSettings.getInstance()
                .isGroupMessagingActivated());
        mGroupMessagingCheckBox
                .setOnPreferenceClickListener(new OnPreferenceClickListener() {
                    @Override
                    public boolean onPreferenceClick(Preference preference) {
                        boolean retValue = false;
                        if (preference == null) {
                            ...
                            if (key == null) {
                                ...
                                if (RCS_GROUP_MESSAGING_TOGGLE.equals(key)) {
                                    if (mGroupMessagingCheckBox != null) {
                                        boolean isChecked = mGroupMessagingCheckBox
                                                .isChecked();
                                        Logger.d(TAG,
                                                "onPreferenceClick(), the status of mGroupMessagingCheckBox is "
                                                        + isChecked);
                                        RcsSettings.getInstance().setGroupMessagingToggle(isChecked);
                                        mSettings
                                                .edit()
                                                .putBoolean(
                                                        RCS_GROUP_MESSAGING_TOGGLE,
                                                        isChecked).apply();
                                        retValue = true;
                                    } else {
                                        Logger.d(TAG,
                                                "onPreferenceClick(),mGroupMessagingCheckBox is null");
                                    }
                                } else {
                                    Logger.d(TAG,
                                            "onPreferenceClick()-key is not equal RCS_GROUP_MESSAGING_TOGGLE");
                                }
                            }
                        }
                        return retValue;
        ...
        Preference testPreference = getPreferenceManager().findPreference(
                    PREFERENCE_TEST_TOOL);
        getPreferenceScreen().removePreference(testPreference);

        /**
         * @}
         */
        boolean isSendReadReceiptChecked = RcsSettings.getInstance().isImDisplayedNotificationActivated();
        mSendReadReceiptCheckBox.setChecked(isSendReadReceiptChecked);
        SharedPreferences prefs = mNotificationRingtone.getPreferenceManager()
                .getSharedPreferences();
        prefs.edit()
                .putString(RCS_RINGTONE,
                        AppSettings.getInstance().getChatInvitationRingtone())
                .apply();
        ...
        mNotificationRingtone
                .setOnPreferenceClickListener(new OnPreferenceClickListener() {
                    @Override
                    public boolean onPreferenceClick(Preference preference) {
                        Logger.d(TAG, "onPreferenceClick()-preference is "
                                + preference);
                        boolean retValue = false;
                        if (preference != null) {
                            String key = preference.getKey();
                            ...
                            if (RCS_RINGTONE.equals(key)) {
                                ...
                                SharedPreferences prefs = mNotificationRingtone
                                        .getPreferenceManager()
                                        .getSharedPreferences();
                                String uri = prefs.getString(RCS_RINGTONE, "");
                                AppSettings.getInstance()
                                        .setChatInvitationRingtone(uri);
                                retValue = true;
                            }
                        }
                        return retValue;
        ...
        if (!vibrator.hasVibrator()) {
            Logger.d(TAG,
                    "There is not a vibrator at present. So remove the preference.");
            PreferenceCategory notificationsCategory = (PreferenceCategory) findPreference(RCS_NOTIFY);
                    ...
                    public boolean onPreferenceClick(Preference preference) {
                        ...
                        if (preference != null) {
                            ...
                            if (RCSE_COMPRESS_IMAGE.equals(key)) {
                                final boolean isChecked = mCompressImageCheckBox
                                        .isChecked();
                                Logger.d(TAG,
                                        "onPreferenceClick(), the status of mSendReadReceiptCheckBox is "
                                                + isChecked);
                                ...
                                AsyncTask.execute(new Runnable() {
                                    @Override
                                    public void run() {
                                        boolean isEnableCompressedPrev = AppSettings
                                                .getInstance()
                                                .isEnabledCompressingImageFromDB();
                                        AppSettings.getInstance()
                                                .setCompressingImage(isChecked);
                                        Logger.d(
                                                TAG,
                                                "onPreferenceClick():isChecked "
                                                        + isChecked
                                                        + ",isEnableCompressedPrev = "
                                                        + isEnableCompressedPrev);
                                        if (isEnableCompressedPrev == true
                                                && isChecked != isEnableCompressedPrev) {
                                            AppSettings.getInstance()
                                                    .saveRemindCompressFlag(
                                                            false);
                                        }
                                    }
                                });
        ...
        mCompressVideoCheckBox = (CheckBoxPreference) findPreference(RCSE_COMPRESS_VIDEO);
        mCompressVideoCheckBox.setChecked(AppSettings.getInstance()
                .isEnabledCompressingVideoFromDB());
        mCompressVideoCheckBox
                .setOnPreferenceClickListener(new OnPreferenceClickListener() {
                    @Override
                    public boolean onPreferenceClick(Preference preference) {
                        Logger.d(TAG, "onPreferenceClick()-preference is "
                        ...
                        if (preference != null) {
                            String key = preference.getKey();
                            Logger.d(TAG, "onPreferenceClick()-key is " + key);
                            if (RCSE_COMPRESS_VIDEO.equals(key)) {
                                final boolean isChecked = mCompressVideoCheckBox
                                        .isChecked();
                                Logger.d(TAG,
                                        "onPreferenceClick(), the status of mCompressVideoCheckBox is "
                                                + isChecked);
                                retValue = true;
                                AsyncTask.execute(new Runnable() {
                                    @Override
        ...
        mCompressImageListPref = (ListPreference) findPreference(PREF_COMPRESS_LIST);
        String compressSizevalue = AppSettings.getInstance().getImageCompressSize();
        if (RcsSettings.getInstance().isSupportOP08()) {
            Logger.d(TAG, "mCompressImageListPref entry() compressSizevalue=" + compressSizevalue);
            if(compressSizevalue != null) {
                mCompressImageListPref.setSummary(compressSizevalue.replace("%", "%%"));
                mCompressImageListPref.setDefaultValue(compressSizevalue);
            }
            mCompressImageListPref.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {

                @Override
                public boolean onPreferenceChange(Preference preference,
                        Object newValue) {
                    mCompressImageListPref.setDefaultValue(newValue);
                    Logger.d(TAG, "mCompressImageListPref change() newValue=" + newValue);
                    AppSettings.getInstance().setImageCompressSize((String) newValue);
                    mCompressImageListPref.setSummary(((String) newValue).replace("%", "%%"));
                    return false;
                }
            });
        } else {
            getPreferenceScreen().removePreference(mCompressImageListPref);
        }
        ...
        if (preference == mClearHistoryItem) {
            if (mClearHistoryItem != null) {
                mDialog.show(getFragmentManager(),
                        ConfirmDialogOfClearhistory.TAG);
            } else {
    ...
    private class GetCompressStatusTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            boolean satus = AppSettings.getInstance()
                    .isEnabledCompressingImageFromDB();
            return satus;
        }
        ...
        protected void onPostExecute(Boolean result) {
            ...
            Logger.d(TAG, "RCS-e isEnabledCompressingImage: " + result
                    + ",isChecked: " + isChecked);
            if (isChecked != result) {
        ...
        private void registerObserver(final Uri uri) {
            ...
            try {
                cursor = resolver
                        .query(uri,
                                new String[] { RcsSettingsData.KEY_ID },
                                RcsSettingsData.KEY_KEY + "=?",
                                new String[] { AppSettingsData.RCSE_COMPRESSING_IMAGE },
                                null);
                ...
                if (id == INVALID_VALUE) {
                    ...
                    resolver.registerContentObserver(
                            ContentUris.withAppendedId(uri, id), false,
                            mRcseSettingContentObserver);
                }
            } finally {
                if (cursor != null) {
    ...
    private class ChangeCompressStatusTask extends
    ...
    private class GetBlockNum extends AsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            ...
            if (activity != null) {
                ...
                /*if (contactsManager != null) {
                    ...
                    ContactsManager.createInstance(activity
                ...
                try {
                    mBlocked = (ArrayList<String>) ApiManager.getInstance()
                            .getContactsApi().getImBlockedContacts();
                    mBlockNum = mBlocked.size();
                } catch (Exception e) {
                    // TODO: handle exception

                }
                Logger.i(TAG, "doInBackground mBlockNum =" + mBlockNum
                        + "mBlocked");
            } else {
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (activity != null) {
                ...
                String temp = r.getString(R.string.text_block_contact,
    ...
    public static class ConfirmDialogOfClearhistory extends DialogFragment implements
            DialogInterface.OnClickListener {

        private static final String TAG = "ClearhistoryConfirmDialog";
        private SettingsFragment mFragment = null;

        public ConfirmDialogOfClearhistory(SettingsFragment fragment) {
            mFragment = fragment;
        }
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            return new AlertDialog.Builder(getActivity(),
                    ...
                    .setTitle(R.string.rcse_clear_chat_history_confirm_title)
                    .setMessage(
                            getString(R.string.rcse_clear_chat_history_confirm_message))
                    .setPositiveButton(
                            getString(R.string.rcs_settings_label_clear), this)
                    .setNegativeButton(
        ...
        public void onClick(DialogInterface dialog, int which) {
            if (which == DialogInterface.BUTTON_POSITIVE && mFragment != null) {
                mFragment.comfirmDialogNewInstance();
                mFragment.mClearHistoryProgress.show(getFragmentManager(), TAG);
                mFragment.mClearHistoryTask.execute();
            }
            dismissAllowingStateLoss();
        }
    }

    public void comfirmDialogNewInstance() {
        mClearHistoryProgress = new ClearHistoryProgress(this);
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
        ...
        if (RCS_NOTIFICATION.equals(key)) {
            if (mNotificationCheckBox != null) {
                ...
                Logger.d(TAG,
                        "onSharedPreferenceChanged(), mNotificationCheckBox is null");
            }
        }
        if (RCS_VIBRATE.equals(key)) {
            if (mVibrateCheckBox != null) {
                ...
                Logger.d(TAG,
                        "onSharedPreferenceChanged(), the status of mVibrateCheckBox is "
                                + isChecked);
                AppSettings.getInstance().setPhoneVibrateForChatInvitation(
                        isChecked);
            } else {
                Logger.d(TAG,
                        "onSharedPreferenceChanged(),mVibrateCheckBox is null");
            }
        }
     ...
     */
    public static class ClearHistoryProgress extends DialogFragment {

        private static final String TAG = "ClearHistoryProgress";
        private SettingsFragment mFragment = null;

        public ClearHistoryProgress(SettingsFragment fragment) {
            mFragment = fragment;
        }
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            if (activity == null) {
                ...
                dialog.setTitle(activity
                        .getText(R.string.rcse_clear_history_title));
                dialog.setMessage(activity
                        .getText(R.string.rcse_clear_chat_history_clearing));
        ...
        public void onCancel(DialogInterface dialog) {
            super.onCancel(dialog);
            if (mFragment != null && mFragment.mClearHistoryTask != null) {
                mFragment.mClearHistoryTask.cancel(true);
            } else {
