...
import com.orangelabs.rcs.provisioning.https.HttpsProvisioningUserMessageDialogue;
                ...
                if (accept_btn && reject_btn) {
                    builder.setPositiveButton(R.string.rcs_core_terms_accept,
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    if (logger.isActivated()) {
                                        logger.info("OnAccept Button Terms");
                                    }
                                    // Set terms and conditions accepted
                                    RcsSettings.createInstance(getApplicationContext());
                                    RcsSettings.getInstance().setProvisioningTermsAccepted(true);
                                    HttpsProvisioningUserMessageDialogue.getInstance().responseReceived(true);                 
                                    finish();
                                }
                            });
                    ...
                    builder.setNegativeButton(R.string.rcs_core_terms_decline,
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    if (logger.isActivated()) {
                                        logger.info("OnNegative Button Terms");
                                    }
                                    ...
                                    HttpsProvisioningUserMessageDialogue.getInstance().responseReceived(false); 
                                    finish();
                                }
                            });
                } else {
                    builder.setNeutralButton(R.string.rcs_core_terms_ok,
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    if (logger.isActivated()) {
                                        logger.info("OnNeutral Button Terms");
                                    }
                                    // Set terms and conditions accepted
                                    RcsSettings.createInstance(getApplicationContext());
                                    RcsSettings.getInstance().setProvisioningTermsAccepted(true);
