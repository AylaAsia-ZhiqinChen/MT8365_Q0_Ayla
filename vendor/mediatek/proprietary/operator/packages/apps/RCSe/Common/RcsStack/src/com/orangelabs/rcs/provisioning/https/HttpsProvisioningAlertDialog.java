...
public class HttpsProvisioningAlertDialog extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isSecondaryDevice = getIntent().getBooleanExtra("isSecondaryDevice",false);
    ...
    if(isSecondaryDevice){
        //in case secondary device show user that currenty your accout is unauthorized. 
        //try to connect again after reboot.
        alert.setMessage(R.string.label_msisdn_error_dialog_secondary);
    }else{
...
private void showAlertDialog(String number){
        ...
        String appendedMessage = getResources().getString(R.string.label_msisdn_confirm_dialog);
        msg += appendedMessage ;
        // Setting Dialog Message
