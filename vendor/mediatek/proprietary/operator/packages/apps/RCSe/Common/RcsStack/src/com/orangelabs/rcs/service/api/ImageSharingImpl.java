...
import com.orangelabs.rcs.provider.sharing.ImageSharingPersistedStorageAccessor;
...
public class ImageSharingImpl extends IImageSharing.Stub implements ImageTransferSessionListener {
    ...
    public void handleSessionStarted() {
        ...
        synchronized (mLock) {
        	try{
            setStateAndReasonCode(getRemoteContact(), ImageSharing.State.STARTED, ReasonCode.UNSPECIFIED);
        	}catch(Exception e){
        ...
        synchronized (mLock) {
            ...
            switch (reason) {
                ...
                case ImsServiceSession.TERMINATION_BY_CONNECTION_LOST:
                    setStateAndReasonCode(getRemoteContact(), State.FAILED, ReasonCode.FAILED_SHARING);
                    break;
                case ImsServiceSession.TERMINATION_BY_USER:
                    ...
                    break;
             /*   case ImsServiceSession.TerminationReason.TERMINATION_BY_REMOTE:
