...
import com.orangelabs.rcs.core.ims.protocol.sip.RSTException;
...
public class SipManager {
     ...
     */
    public static int TIMEOUT = RcsSettings.getInstance().getSipTransactionTimeout();
     ...
     * @throws SipException
     */
    public synchronized void initStack(String localAddr, int localPort, String proxyAddr,
            int proxyPort, String protocol, int networkType) throws SipException {
        // Close the stack if necessary
        closeStack();

        // Create the SIP stack
        sipstack = new SipInterface(localAddr, localPort, proxyAddr, proxyPort, protocol, networkType);
    }
    ...
    public SipTransactionContext sendSipMessageAndWait(SipMessage message, int timeout) throws SipException {
        if (sipstack != null) {
            ...
            if (    message instanceof SipRequest
                ...
                if ((ctx.getStatusCode() == 403) && (warn == null) && !(RcsSettings.getInstance().isSupportOP08() || RcsSettings.getInstance().isSupportOP07())) {
