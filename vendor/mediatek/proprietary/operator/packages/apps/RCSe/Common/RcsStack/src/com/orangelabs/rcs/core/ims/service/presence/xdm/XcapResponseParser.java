...
public class XcapResponseParser extends DefaultHandler {
    ...
    private List<XDMContact> xdmContactList = new ArrayList<XDMContact>();
    private HashMap<String, XDMContact> xdmContactMap = new HashMap<String, XDMContact>();
    private XDMContact contact= null;
    /**
     * The logger
     */
    ...
    public void endElement(String namespaceURL, String localName, String qname) {
        if (localName.equals("entry")) {
            if(contact!=null){
                //ADD TO HASHMAP
                xdmContactMap.put(contact.getContact(), contact);
                contact = null;
            }else  if (localName.equals("display-name")) {
                if(contact!=null){
                    contact.setDisplayName(accumulator.toString().trim());
                }
            }
        }
    }
    ...
    public HashMap<String, XDMContact> getXDMContactMap(){
        return xdmContactMap;
    }
}
