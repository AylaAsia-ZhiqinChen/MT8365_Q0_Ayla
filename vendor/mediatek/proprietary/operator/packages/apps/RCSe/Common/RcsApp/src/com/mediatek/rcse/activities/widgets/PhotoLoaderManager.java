...
public class PhotoLoaderManager implements OnLoadCompleteListener<Cursor> {
    ...
    static final String[] PROJECTION = { Data._ID, Data.MIMETYPE, Data.DATA1,
            Data.DATA2, Data.DISPLAY_NAME, Contacts.SORT_KEY_PRIMARY };
    ...
    public static void addListener(OnPhotoChangedListener listener) {
        ...
        Logger.d(TAG, "addListener() exit LISTENER_LIST is " + LISTENER_LIST
                + "size is " + LISTENER_LIST.size());
    }
    ...
    public static void removeListener(OnPhotoChangedListener listener) {
        ...
        Logger.d(TAG, "removeListener() entry LISTENER_LIST is "
                + LISTENER_LIST);
    }
    ...
    /**
     * Instantiates a new photo loader manager.
     *
     * @param context the context
     */
    private PhotoLoaderManager(Context context) {
        mLoader = new CursorLoader(context, Data.CONTENT_URI, PROJECTION, null,
                null, null);
    ...
    /**
     * The listener interface for receiving onPhotoChanged events.
     * The class that is interested in processing a onPhotoChanged
     * event implements this interface, and the object created
     * with that class is registered with a component using the
     * component's addOnPhotoChangedListener method. When
     * the onPhotoChanged event occurs, that object's appropriate
     * method is invoked.
     *
     * @see OnPhotoChangedEvent
     */
