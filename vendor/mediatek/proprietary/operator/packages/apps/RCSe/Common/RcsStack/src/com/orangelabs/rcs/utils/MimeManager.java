...
public class MimeManager {
     ...
     */
    private static HashMap<String, String> extensionToMimeTypeMap;
     ...
     * The logger
     */
    private static Logger logger = Logger.getLogger(MimeManager.class.getName());
    ...
    public static MimeManager getInstance() {
        ...
        synchronized (MimeManager.class) {
            if (sInstance == null) {
                ...
                sInstance.loadMap("vcs", "text/vcalendar");
    ...
    private static String getMimeTypeFromMap(String extension) {
    ...
    public String getMimeType(String extension) {
        ...
        mimeType = getMimeTypeFromMap(extension);
        if (mimeType != null) {
            return mimeType;
        }
