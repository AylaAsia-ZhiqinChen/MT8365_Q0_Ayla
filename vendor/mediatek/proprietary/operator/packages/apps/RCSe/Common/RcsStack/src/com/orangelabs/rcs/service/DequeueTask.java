...
public abstract class DequeueTask implements Runnable {
    ...
    protected final RichMessagingHistory mMessagingLog;
    ...
    public DequeueTask(Context ctx, Core core, ContactsManager contactManager,
            RichMessagingHistory messagingLog, RcsSettings rcsSettings, ChatServiceImpl chatService,
     ...
     * @return boolean
     */
    protected boolean isAllowedToDequeueOneToOneFileTransfer(String contact,
            FileTransferServiceImpl fileTransferService) {
     ...
     * @return boolean
     */
    protected boolean isAllowedToDequeueOneToOneChatMessage(String contact) {
     ...
     * @return boolean
     */
    protected boolean isPossibleToDequeueOneToOneChatMessage(String contact) {
        Capabilities remoteCapabilities = mContactManager.getContactCapabilities(contact);
    ...
    protected boolean isPossibleToDequeueGroupChatMessagesAndGroupFileTransfers(String chatId) {
        ...
        final GroupChatSession groupChatSession = (GroupChatSession)mImService.getSession(chatId);
     ...
     * @return boolean
     */
    protected boolean isPossibleToDequeueOneToOneFileTransfer(String contact, Uri file, long size) {
        Capabilities remoteCapabilities = mContactManager.getContactCapabilities(contact);
        if (remoteCapabilities == null) {
            if (mLogger.isActivated()) {
                mLogger.debug(new StringBuilder(
     ...
     */
    protected void setOneToOneChatMessageAsFailedDequeue(String contact, String msgId,
            String mimeType) {
     ...
     */
    protected void setOneToOneFileTransferAsFailedDequeue(String contact, String fileTransferId) {
    ...
    protected boolean isShuttingDownOrStopped() {
        return mCore.isCoreStarted()/*mCore.isStopping() || !mCore.isStarted()*/;
    }
