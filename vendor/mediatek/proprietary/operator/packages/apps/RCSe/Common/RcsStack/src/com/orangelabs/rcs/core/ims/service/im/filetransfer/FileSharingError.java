...
public class FileSharingError extends ImsSessionBasedServiceError {
    ...
    /**
     * Media file failed and should be resumed
     */
    public final static int MEDIA_RESUME_FAILED = FT_ERROR_CODES + 8;
    
    /**
     * Transfer failed, Fallback to MMS
     */
    public final static int MEDIA_FALLBACK_MMS = FT_ERROR_CODES + 9;
    
    /**
     * Transfer failed, Auto Resend
     */
    public final static int FT_AUTO_RESEND = FT_ERROR_CODES + 10;
