 ...
 */
public class ReceivedChatMessage extends BaseChatMessage implements
        IReceivedChatMessage {
    public static final String TAG = "ReceivedChatMessage";
    private boolean mIsRead = true;

    /**
     * Instantiates a new received chat message.
     *
    ...
    public void onAddChatWindow(IChatWindow chatWindow) {
        ...
        if (null != chatWindow) {
            IReceivedChatMessage receivedChatMessage = chatWindow
                    .addReceivedMessage(mMessage, mIsRead);
