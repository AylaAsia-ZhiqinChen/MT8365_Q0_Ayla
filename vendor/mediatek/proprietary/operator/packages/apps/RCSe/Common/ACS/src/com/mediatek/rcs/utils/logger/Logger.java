...
package com.mediatek.rcs.utils.logger;
...
public class Logger {
    ...
    private static final boolean sActivationInternalFlag =
        SystemProperties.get("ro.build.type").equals("user") ? TRACE_OFF : TRACE_ON;
    ...
    public static final String sLogNumPattern = "(?<=[\\d]{2})\\d(?=[\\d]{4})";
     ...
     * @return boolean
     */
    public boolean isActivatedDebug() {
        return (sActivationInternalFlag == TRACE_ON) && isActivated();
    }
