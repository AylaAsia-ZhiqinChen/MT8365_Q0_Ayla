    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL("CREATE TABLE IF NOT EXISTS " + TABLE + '(' 
                    + FileTransferData.KEY_FT_ID + " TEXT NOT NULL PRIMARY KEY,"
                    ...
                    + FileTransferData.KEY_HASH + " TEXT,"
                    + FileTransferData.KEY_DURATION + " INTEGER,"
                    + FileTransferData.KEY_SESSION_TYPE + " integer  DEFAULT 0,"
                    + FileTransferData.KEY_MSG_ID + " TEXT,"
                    + FileTransferData.KEY_FILE_ID + " TEXT,"
