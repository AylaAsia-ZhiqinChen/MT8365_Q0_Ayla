...
public class CapabilityServiceImpl extends ICapabilityService.Stub {
    ...
    public Capabilities getMyCapabilities(int slotId) {
        com.orangelabs.rcs.core.ims.service.capability.Capabilities capabilities =
                RcsSettings.getInstance().getMyCapabilities();
        Set<String> exts = new HashSet<String>(capabilities.getSupportedExtensions());
        Capabilities c= new Capabilities(capabilities.isImageSharingSupported(),
    ...
    public Capabilities getContactCapabilities(ContactId contact){
        if (logger.isActivated()) {
            logger.info("Get capabilities for contactId " + contact);
        }
        return getContactCapabilities(contact.toString());
    }
    ...
    public void requestContactCapabilities(ContactId contact) throws ServerApiException {
        if (logger.isActivated()) {
            logger.info("Request capabilities for contactId " + contact);
        }
        requestContactCapabilities(contact.toString());
    }
    ...
    public void addContactCapabilitiesListener(ContactId contact, ICapabilitiesListener listener){
        addContactCapabilitiesListener(contact.toString(), listener);
    }
    ...
    public void removeContactCapabilitiesListener(ContactId contact, ICapabilitiesListener listener){
        removeContactCapabilitiesListener(contact.toString(), listener);
    }
     ...
     */
    public void requestContactsCapabilities(List<ContactId> contacts) {
        try {
    ...
    public void forceRequestContactCapabilities(ContactId contact) {
    }

    public void requestContactAvailability(final ContactId contactId) {
    }

    public boolean publishMyCap(int slotId, boolean isModify, Capabilities caps) {
        return false;
    }
}
