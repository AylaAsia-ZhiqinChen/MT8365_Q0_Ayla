...
public class ChatListFragment extends Fragment implements
        OnSelectedItemListener, IChatWindowManager, GroupInviteChangedListener {
    ...
    public static ArrayList<ChatListProvider> sChatListHistoryFromDatabase;

    /**
     * Gets the chat list history from database.
     *
     * @return the chat list history from database
     */
    public static ArrayList<ChatListProvider> getChatListHistoryFromDatabase() {
        return sChatListHistoryFromDatabase;
    }

    /**
     * Sets the chat list history from database.
     *
     * @param chatListHistoryFromDatabase the new chat list history from database
     */
    public static void setChatListHistoryFromDatabase(
            ArrayList<ChatListProvider> chatListHistoryFromDatabase) {
        ChatListFragment.sChatListHistoryFromDatabase = chatListHistoryFromDatabase;
    }

    /**
     * Instantiates a new chat list fragment.
     */
    ...
    public void onStop() {
        ...
        if (instance != null) {
            ...
            Logger.w(TAG,
                    "onStop(), The RcsNotification.getInstance() is null!");
        }
    }
        ...
        if (obj instanceof ChatsStruct) {
            ...
            if (!chat.isGroupChat()) {
                ...
                displayName = ContactsListManager.getInstance()
                        .getDisplayNameByPhoneNumber(participant.getContact());
                // handle 1-2-1 close menu.
                MenuItem closeItem = menu.add(ONEONECHAT_MENU_GROUP,
                        CONTEXT_MENU_DELETE, 0, R.string.text_close_chat);
                closeItem
                        .setOnMenuItemClickListener(new OnMenuItemClickListener() {
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                ...
                                arguments.putParcelable(Utils.CHAT_TAG,
                                        (Parcelable) tag);
                ...
                MenuItem blockItem = menu.add(ONEONECHAT_MENU_GROUP,
                        CONTEXT_MENU_BLOCK, 0, R.string.text_block);
                blockItem
                        .setOnMenuItemClickListener(new OnMenuItemClickListener() {
                            @Override
                            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (groupChat != null) {
                    ...
                    if (numberList instanceof List) {
                        ...
                        Logger.d(TAG,
                                "onCreateContextMenu() the display name is "
                                        + displayName);
                        groupChat.put(SUBJECT, displayName);
                        final Object tag = groupChat.getTag();
                        // handle group chat delete.
                        MenuItem deleteItem = menu.add(GROUPCHAT_MENU_GROUP,
                                CONTEXT_MENU_DELETE, 0,
                                R.string.text_close_chat);
                        deleteItem
                                .setOnMenuItemClickListener(new OnMenuItemClickListener() {
                                    @Override
                                    public boolean onMenuItemClick(MenuItem item) {
                                        ConfirmGroupDeleteDialog dialog =
                                                new ConfirmGroupDeleteDialog();
                                        Bundle arguments = new Bundle();
                                        arguments.putParcelable(Utils.CHAT_TAG,
                                                (Parcelable) tag);
                                        dialog.setArguments(arguments);
                                        dialog.show(getFragmentManager(),
                                                ConfirmGroupDeleteDialog.TAG);
                                        return true;
                                    }
                                });
                    } else {
                    ...
                    Logger.e(TAG,
                            "onCreateContextMenu the groupchatmap is null");
                }
            }
    ...
    public static class ConfirmOneOneCloseDialog extends DialogFragment {
        ...
        /**
         * Instantiates a new confirm one one close dialog.
         */
                            ...
                            new OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog,
                                    ...
                                    if (null != controller) {
                                        ...
                                        Logger.d(TAG,
                                                "ConfirmOneOneCloseDialog controller is null");
                                    }
                                    dismiss();
                                }
                            })
    ...
    /**
     * ConfirmOneOneBlockDialog.
     *
     */
    public static class ConfirmOneOneBlockDialog extends DialogFragment {
        private static final String TAG = "ConfirmOneOneBlockDialog";

        /**
         * Instantiates a new confirm one one block dialog.
         */
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            final Object tag = getArguments().getParcelable(Utils.CHAT_TAG);
            final Participant participant = getArguments().getParcelable(
                    Utils.CHAT_PARTICIPANT);
            String displayName = ContactsListManager.getInstance()
                    .getDisplayNameByPhoneNumber(participant.getContact());
            return new AlertDialog.Builder(getActivity())
                    .setIconAttribute(android.R.attr.alertDialogIcon)
                    .setTitle(
                            getString(R.string.oneonechat_block_title,
                                    displayName))
                    .setMessage(
                            getString(R.string.oneonechat_block_message,
                                    displayName))
                    .setPositiveButton(
                            getString(R.string.rcs_dialog_positive_button),
                            new OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog,
                                    ...
                                    new AsyncTask<Object, Void, Object>() {
                                        ...
                                        protected Object doInBackground(
                                            ...
                                            if (contactNum != null) {
                                                ...
                                                Logger.e(TAG,
                                                        "context_menu_item_to_block the" +
                                                        " block number is null");
                                            }
                                    ...
                                    if (null != controller) {
                                        ...
                                        Logger.d(TAG,
                                                "ConfirmOneOneBlockDialog controller is null");
                                    }
                                    dismiss();
                                }
                            })
     ...
     *
     */
    public static class ConfirmGroupDeleteDialog extends DialogFragment {
        private static final String TAG = "ConfirmGroupDeleteDialog";

        /**
         * Instantiates a new confirm group delete dialog.
         */
                            ...
                            new OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog,
                                    ...
                                    if (null != controller) {
                                        ...
                                        Message controllerMessage = controller
                                                .obtainMessage(
                                                        ChatController.EVENT_CLEAR_CHAT_HISTORY,
                                                        tag, null);
                                        controllerMessage.sendToTarget();
                                        ...
                                        Logger.d(TAG,
                                                "ConfirmGroupDeleteDialog controller is null");
                                    }
                                    dismiss();
                                }
                            })
     ...
     */
    private OneToOneChat getChatSession(String sessionId) {
        ...
        OneToOneChat chatSession = null;
        try {
            chatSession = chatApi.getOneToOneChat(ContactIdUtils.createContactIdFromTrustedData(sessionId));
            return chatSession;
        } catch (Exception e) {
    ...
    @Override
    public void onAddedGroupInvite(final GroupChat chatSession,
            final Intent intent) {
            ...
            public void run() {
                if (null == chatSession || null == intent) {
                    Logger.d(TAG, "Illegal state: IChatSession is "
                            + (null == chatSession ? "null" : "not null")
                            + "Intent is "
                ...
                if (mActivity == null || mChatListView == null) {
                    Logger.d(TAG,
                            "The mActivity is null or mChatListView is null");
                    return;
                }
                ...
                message = null;
                // String info = (String)
                // intent.getExtra(RcsNotification.NOTIFY_INFORMATION);
                String info = null;
                if (message != null) {
                ...
                InvitationStruct invite = new InvitationStruct(drawable, date,
                        info, intent);
    ...
    /**
     * Adds the group chat window by infos.
     *
     * @param tag the tag
    ...
    public IGroupChatWindow addGroupChatWindow(Object tag,
        ...
        return addGroupChatWindowByInfos(tag, participants, participantList
                .get(0).getmChatID());
    }
    ...
    /**
     * Adds the map to chat list.
     *
     * @param chatMap the chat map
     */
    private void addMapToChatList(final ChatMap chatMap) {
        ...
        Runnable worker = new Runnable() {
            ...
            public void run() {
                ...
                ArrayList<ChatListProvider> chatListFromDatabase =
                        new ArrayList<ChatListProvider>();
     ...
     *
     */
    abstract static class ChatMap extends HashMap<String, Object> implements
            IChatWindow {
        ...
        /**
         * Gets the m participant list.
         *
         * @return the m participant list
         */
        ...
        /**
         * Gets the m participant.
         *
         * @return the m participant
         */
    ...
    public class One2OneChatMap extends ChatMap implements IOne2OneChatWindow {
        ...
        /**
         * Instantiates a new one2 one chat map.
         *
         * @param tag the tag
        ...
        public IReceivedChatMessage addReceivedMessage(
                final ChatMessage message, final boolean isRead) {
            Logger.d(TAG, "ABCG addReceivedMessage() entry the message is "
                    + message + "display: " + message.getDisplayName());
            if (message != null /* && !message.getIsHistory() */) {
                ...
                Logger.d(TAG,
                        "addReceivedMessage the message is from load history ");
            }
            return null;
        }

        @Override
        public ISentChatMessage addSentMessage(final ChatMessage message,
                int messageTag) {
            ...
            if (message != null /* && !message.getIsHistory() */) {
                ...
                Logger.d(TAG,
                        "addSentMessage the message is from load history ");
            }
            return null;
        }
         ...
         * On date updated.
         *
         * @param currentDateUpdater the current date updater
         * @param isRead the is read
         */
        private void onDateUpdated(ChatDateUpdater currentDateUpdater,
                boolean isRead) {
            Logger.d(TAG, "onDateUpdated() currentDateUpdater: "
                    + currentDateUpdater + ", isRead is " + isRead);
        ...
        private class ActiveFileTransferRecord implements IFileTransfer {
            ...
            /**
             * Handle file transfer state chaged.
             *
             * @param status the status
             */
            private synchronized void handleFileTransferStateChaged(
                    Status status) {
                Logger.d(TAG, "handleFileTransferStateChaged, status = "
                        + status);
                ...
                case TRANSFERING:
                    if (!mIsActive) {
                        ...
                        Logger.d(
                                TAG,
                                "handleFileTransferStateChaged, The status changed," +
                                "so change the count, count = "
                                        + mFileTransferCount);
                    } else {
                        Logger.d(TAG,
                                "handleFileTransferStateChaged, The same status change!");
                    }
                    break;
                case FAILED:
                case CANCEL:
                ...
                if (null != mChatListView) {
                    ...
                    Logger.w(TAG,
                            "handleFileTransferStateChaged, mChatListView is null!");
                }
            }
        ...
        /**
         * This class is used to update ChatListView when the latest message
         * date is modified.
         */
        private class ChatDateUpdater implements ISentChatMessage,
                IReceivedChatMessage, Comparable<ChatDateUpdater> {
            ...
            /**
             * Instantiates a new chat date updater.
             *
             * @param message the message
             */
            public ChatDateUpdater(ChatMessage message) {
                mMessage = message;
                mDate = message.getReceiptDate();
            }
            ...
            public void updateDate(final Date date) {
                Logger.d(TAG, "updateDate() update date for messageId: "
                        + getId() + ", date: " + date);
                mUiHandler.post(new Runnable() {
                    @Override
                    public void run() {
                        ...
                        Logger.d(TAG, "updateDate()->run() mMessageList: "
                                + mMessageList);
    ...
    private class GroupChatMap extends ChatMap implements IGroupChatWindow {
        ...
        /**
         * Instantiates a new group chat map.
         *
         * @param tag the tag
         * @param participantList the participant list
         */
        ...
        /**
         * Convert participants to numbers.
         *
         * @param participantList the participant list
         * @return the list
         */
        private List<String> convertParticipantsToNumbers(
                List<Participant> participantList) {
            Logger.d(TAG,
                    "convertParticipantsToNumbers() entry, participantList is "
                            + participantList);
            if (null != participantList) {
                ...
                Logger.e(TAG,
                        "convertParticipantsToNumbers() participantList is null");
                return null;
            }
        }
        ...
        public void updateParticipants(List<ParticipantInfo> participantList) {
            Logger.d(TAG,
                    "updateParticipants() entry, current participant in chat "
                            + mTag + " is " + participantList);
            if (null != participantList) {
                ...
                if (mSubject.equals("")) {
                    put(SUBJECT,
                            ChatFragment.getParticipantsName(participants
        ...
        public IReceivedChatMessage addReceivedMessage(
                final ChatMessage message, final boolean isRead) {
            Logger.d(TAG, "addReceivedMessage() entry the message is "
                    + message);
            if (message != null /* && !message.getIsHistory() */) {
                mUiHandler.post(new Runnable() {
                    @Override
