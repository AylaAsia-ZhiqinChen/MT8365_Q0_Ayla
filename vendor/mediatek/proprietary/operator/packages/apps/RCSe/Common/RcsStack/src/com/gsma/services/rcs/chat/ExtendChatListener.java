 ...
 */
public abstract class ExtendChatListener {
    /**
     ...
     */
    public abstract void onMessageStatusChanged(String chatId,ContactId contact, String mimeType,
     ...
     * @see ChatMessage
     */
    //public abstract void onNewMessage(IChatMessage message);
