...
public class TCPMessageChannel extends MessageChannel implements SIPMessageListener, Runnable,
    ...
    protected TCPMessageChannel(SIPTransactionStack sipStack) {
        System.out.println("TCPMessageChannel by stack");
    ...
    protected TCPMessageChannel(Socket sock, SIPTransactionStack sipStack,
        ...
        if (UaServiceManager.getInstance().serviceConnected()) {
            if (UaServiceManager.getInstance().getSipChannel() == null) {
                UaServiceManager.getInstance().openChannel(new SipChannelCallback());
            }
        }
        ...
        System.out.println("creating new TCPMessageChannel");
    ...
    protected TCPMessageChannel(InetAddress inetAddr, int port, SIPTransactionStack sipStack,
        ...
        System.out.println("TCPMessageChannel");
    ...
    class SipChannelCallback extends SipChannel.EventCallback {
        @Override
