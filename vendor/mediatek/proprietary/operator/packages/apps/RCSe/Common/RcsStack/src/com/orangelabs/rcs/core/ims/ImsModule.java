...
public class ImsModule implements SipEventListener {
    ...
    public ImsModule(Core core) throws CoreException {
        ...
        /* Due to RichcallService didn't implement stop() well,
           it will cause memeory leak for multiple 6 HandlerThread(s).
           MTK RCS Stack doesn't need RichcallService, remove it temporarily. */
