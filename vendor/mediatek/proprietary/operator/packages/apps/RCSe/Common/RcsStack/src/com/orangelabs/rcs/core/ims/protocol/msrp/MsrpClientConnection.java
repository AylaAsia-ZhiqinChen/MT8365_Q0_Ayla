...
public class MsrpClientConnection extends MsrpConnection {
     ...
     * @param remotePort Remote port number
     */
    public MsrpClientConnection(MsrpSession session, String remoteAddress, int remotePort ,String localAddress,int localPort) {
        super(session);
    ...
    public SocketConnection getSocketConnection() throws IOException {
        ...
        socket.open1(remoteAddress, remotePort,localAddress,localPort);
        if (logger.isActivated()) {
