...
import com.orangelabs.rcs.provider.sharing.VideoSharingPersistedStorageAccessor;
...
public class VideoSharingImpl extends IVideoSharing.Stub implements VideoStreamingSessionListener {
    ...
    private ContactId mContact = null;
    /**
    ...
    public void handleSessionStarted() {
        ...
        synchronized (mLock) {
            setStateAndReasonCode(mContact, State.STARTED, ReasonCode.UNSPECIFIED);
        }
    }
        ...
        synchronized (mLock) {
            ...
            switch (reason) {
                ...
                case ImsServiceSession.TERMINATION_BY_TIMEOUT:
                    setStateAndReasonCode(mContact, State.ABORTED, ReasonCode.ABORTED_BY_SYSTEM);
                    break;
                case ImsServiceSession.TERMINATION_BY_CONNECTION_LOST:
                    setStateAndReasonCode(mContact, State.FAILED, ReasonCode.FAILED_SHARING);
                    break;
                case ImsServiceSession.TERMINATION_BY_USER:
                    setStateAndReasonCode(mContact, State.ABORTED, ReasonCode.ABORTED_BY_USER);
                    break;
                case ImsServiceSession.TERMINATION_BY_REMOTE:
                    setStateAndReasonCode(mContact, State.ABORTED, ReasonCode.ABORTED_BY_REMOTE);
                    break;
                default:
