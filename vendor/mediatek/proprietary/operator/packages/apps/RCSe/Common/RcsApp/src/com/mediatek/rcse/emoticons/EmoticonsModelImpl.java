...
public class EmoticonsModelImpl {
    ...
    private HashMap<String, Integer> buildSmileyToRes() {
        ...
        for (int i = 0; i < length; i++) {
            Integer resourceId = Integer
                    .valueOf(resIdArray.getResourceId(i, 0));
    ...
    private Pattern buildPattern() {
        ...
        StringBuilder patternString = new StringBuilder(mSmileyTexts.length
                * EMTION_LENGTH_AVG);
    ...
    private CharSequence addSmileySpans(CharSequence text) {
        ...
        while (matcher.find()) {
            ...
            int bound = mContext.getResources().getDimensionPixelOffset(
                    R.dimen.emoticon_bound_size);
