...
public class ProfileProvisioning extends Activity {
    ...
    private static final String[] MOBILE_IMS_AUTHENT = {
        RcsSettingsData.GIBA_AUTHENT, RcsSettingsData.DIGEST_AUTHENT,RcsSettingsData.AKA_AUTHENT
    };
    ...
    private static final String[] WIFI_IMS_AUTHENT = {
        RcsSettingsData.DIGEST_AUTHENT,RcsSettingsData.AKA_AUTHENT
    };
    ...
    protected void onResume() {
        ...
        } else if (RcsSettings.getInstance().getImsAuhtenticationProcedureForMobile().equals(MOBILE_IMS_AUTHENT[1])){
        ...
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinner.setAdapter(adapter);
        if (RcsSettings.getInstance().getImsAuhtenticationProcedureForMobile().equals(WIFI_IMS_AUTHENT[1])) {
            spinner.setSelection(1);
        } else {
            spinner.setSelection(0);
        }
        ...
        txt = (EditText)this.findViewById(R.id.Im1toMultiUri);
        txt.setText(RcsSettings.getInstance().readParameter(RcsSettingsData.IM_MULTI_CONF_URI));
    ...
    private void save() {
        ...
        txt = (EditText)this.findViewById(R.id.Im1toMultiUri);
        RcsSettings.getInstance().writeParameter(RcsSettingsData.IM_MULTI_CONF_URI, txt.getText().toString());
    ...
    private void genProfile() {    
        ...
        final String[] platforms = {
                ...
                "RCS", "Kamailio1", "MargauxIPv6", "Hu", "Capgemini", "JibeNet", "JibeOrange", 
                "OP01(Experimental)", "OP01(Commercial)" 
        };
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this)
            ...
            .setPositiveButton(R.string.label_ok, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int whichButton) {
                    ...
                    txt.setText(confUri);
                    txt = (EditText)ProfileProvisioning.this.findViewById(R.id.Im1toMultiUri);
                    txt.setText(multiUri);
