...
public class PublishManager extends PeriodicRefresher {
    ...
    */
    ...
    private SipDialogPath createDialogPath() {
        ...
        if (logger.isActivated()) {
            logger.debug("temp_username:" +temp_username);
        }

        
        String target = temp_username;//ImsModule.IMS_USER_PROFILE.getPublicUri();

        // Set local party
        String localParty = temp_username;//ImsModule.IMS_USER_PROFILE.getPublicUri();

        // Set remote party
        String remoteParty = temp_username;//ImsModule.IMS_USER_PROFILE.getPublicUri();
