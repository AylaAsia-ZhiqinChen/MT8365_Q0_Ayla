...
public class ServiceProvisioning extends Activity {
    ...
    protected void onResume() {
        ...
        txt = (EditText)this.findViewById(R.id.MaxSubscriptionList);
        txt.setText(RcsSettings.getInstance().readParameter(RcsSettingsData.MAX_SUBSCRIPTION_PRESENCE_LIST));
    ...
    private void save() {
        ...
        txt = (EditText)this.findViewById(R.id.MaxSubscriptionList);
        RcsSettings.getInstance().writeParameter(RcsSettingsData.MAX_SUBSCRIPTION_PRESENCE_LIST, txt.getText().toString());
