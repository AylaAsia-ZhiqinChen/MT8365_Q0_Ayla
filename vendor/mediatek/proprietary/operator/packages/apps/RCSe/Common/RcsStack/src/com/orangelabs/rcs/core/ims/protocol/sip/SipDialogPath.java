...
public class SipDialogPath {
    ...
    public synchronized void sessionEstablished() {
        ...
        //    RcsProxySessionHandler.getProxySessionHandler(AndroidFactory.getApplicationContext()).incrementInstanceCount();
        //}
    }
    ...
    public synchronized void sessionTerminated() {
        ...
        // TODO: OP07 WFC sync RCS session
        //if(RcsSettings.getInstance().isSupportOP07()){
        //    RcsProxySessionHandler.getProxySessionHandler(AndroidFactory.getApplicationContext()).decrementInstanceCount();
        //}
    }
