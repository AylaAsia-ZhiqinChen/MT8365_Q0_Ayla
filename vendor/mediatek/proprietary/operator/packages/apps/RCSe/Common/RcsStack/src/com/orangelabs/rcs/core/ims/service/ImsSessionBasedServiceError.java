...
public class ImsSessionBasedServiceError extends ImsServiceError {
    ...
    /**
     * Session initiation has error(e.g. 400, 408, 413, 421, 604, 606)
     */
    public final static int SESSION_INITIATION_ERROR = SESSION_ERROR_CODES + 4;
    
    /**
     * Session initiation has error(e.g. 403)
     */
    public final static int SESSION_FORBIDDEN_ERROR = SESSION_ERROR_CODES + 5;
    
    /**
     * Session initiation fallback for ATT(e.g. 480, 404, 503)
     */
    public final static int SESSION_INITIATION_FALLBACK = SESSION_ERROR_CODES + 6;
    
    /**
     * Session initiation fallback for ATT(e.g. 480, 404, 503)
     */
    public final static int SESSION_INITIATION_FALLBACK_MMS = SESSION_ERROR_CODES + 7;
    
    public final static int SESSION_INITIATION_FALLBACK_MULTI_MMS = SESSION_ERROR_CODES + 8;
        /**
     * Sending response to an accepted chat session failed (e.g. Failed sending empty packet or
     * 200OK/ACK responses)
     */
    public final static int SEND_RESPONSE_FAILED = SESSION_ERROR_CODES + 7;
