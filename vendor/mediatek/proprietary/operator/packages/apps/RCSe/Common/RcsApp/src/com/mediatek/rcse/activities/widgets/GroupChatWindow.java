 ...
 */
public class GroupChatWindow extends ChatScreenWindow implements
        ChatView.IGroupChatWindow {
     ...
     */
    public GroupChatWindow(Object tag,
    ...
    public IFileTransfer addSentFileTransfer(FileStruct file) {
        Logger.d(TAG, "addSentFileTransfer entry: mTag = " + mTag
                + ", mOneOneChatFragment = " + mGroupChatFragment);
    ...
    public IReceivedChatMessage addReceivedMessage(ChatMessage message,
        ...
        Logger.d(
                TAG,
                "addReceivedMessage entry, the tag is: " + mTag
                        + " message is: "
                        + ((message == null) ? null : message.getContent()));
        if (!shouldLoadData()) {
            Logger.d(TAG,
                    "addReceivedMessage this window is not focused, the tag is: "
                            + mTag);
            return null;
        }
        if (mGroupChatFragment != null) {
    ...
    public ISentChatMessage addSentMessage(ChatMessage message, int messageTag) {
        ...
        if (mGroupChatFragment != null) {
            msg = (SentMessage) mGroupChatFragment.addSentMessage(message,
                    messageTag);
        } else {
    ...
    public void removeAllMessages() {
        Logger.d(TAG, "removeAllMessages entry, the tag is: " + mTag
                + " ,mGroupChatFragment is :" + mGroupChatFragment);
        if (mGroupChatFragment != null) {
    ...
    public void addContacts() {
        Logger.d(TAG, "addContacts mGroupChatFragment is: "
                + mGroupChatFragment);
        if (mGroupChatFragment != null) {
    ...
    public void removeContacts() {
        Logger.d(TAG, "removeContacts mGroupChatFragment is: "
                + mGroupChatFragment);
        if (mGroupChatFragment != null) {
            mGroupChatFragment.removeContacts();
        }
    }

    @Override
    public void removeChatUi() {
        Logger.d(TAG, "removeChatUi mGroupChatFragment is : "
                + mGroupChatFragment);
        if (mGroupChatFragment != null) {
    ...
    public IChatEventInformation addChatEventInformation(
        ...
        if (!shouldLoadData()) {
            Logger.d(TAG,
                    "addChatEventInformation this window is not focused, the tag is: "
                            + mTag);
            return null;
        }
        if (mGroupChatFragment != null) {
    ...
    public void updateChatStatus(int status) {
        Logger.d(TAG, "updateChatStatus() entry, the tag is: " + mTag
                + " status: " + status);
        if (!shouldLoadData()) {
            Logger.d(TAG,
                    "updateChatStatus() this window is not focused, the tag is: "
                            + mTag);
            return;
        }
        if (mGroupChatFragment != null) {
	...
	public void setClosedGroupType(boolean type) {
    	if (mGroupChatFragment != null) {
            mGroupChatFragment.setClosedGroupType(type);
        } else {
            Logger.d(TAG, "setClosedGroupType() mGroupChatFragment is null");
        }
