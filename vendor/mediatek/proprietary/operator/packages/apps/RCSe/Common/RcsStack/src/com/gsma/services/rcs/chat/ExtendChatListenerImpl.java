 ...
 * @hide
 */
public class ExtendChatListenerImpl extends IExtendChatListener.Stub {

    private final ExtendChatListener mListener;

    private final static String LOG_TAG = ExtendChatListenerImpl.class.getSimpleName();

    ExtendChatListenerImpl(ExtendChatListener listener) {
        mListener = listener;
    }

    @Override
    public void onMessageStatusChanged(String chatId,ContactId contact, String mimeType,
        ...
        mListener.onMessageStatusChanged(chatId,contact, mimeType, msgId, rcsStatus, rcsReasonCode);
    }
