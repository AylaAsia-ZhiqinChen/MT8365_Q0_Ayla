...
public class PluginIpVideoMessage extends IpVideoMessage {
    ...
    public PluginIpVideoMessage(FileStructForBinder fileStruct, String remote) {
        ...
        setmMessageId(fileStruct.mFileTransferTag);
        analysisAttribute();
    }
    /**
     * Analysis attribute.
    ...
    private void analysisAttribute() {
        try {
        long videoId = -1;
        String whereClause = MediaStore.Video.Media.DISPLAY_NAME + "='"
                + mFileName + "'";
        ...
        if (videoId != -1) {
            whereClause = android.provider.MediaStore.Video.Thumbnails.VIDEO_ID
                    + "='" + videoId + "'";
            try {
                cursor = cr
                ...
                if (cursor != null && cursor.getCount() != 0) {
                    ...
                    String thumbnailPath = cursor
                            .getString(cursor.getColumnIndex(android.provider.
