...
ifeq ($(strip $(cxp_support)),yes)
    ...
    ifdef OPTR_SPEC_SEG_DEF
        ifneq ($(OPTR_SPEC_SEG_DEF),NONE)
            ...
            OPTR_DIR := $(TMP_LOCAL_PATH)/$(OPTR)
            ifneq ($(wildcard $(OPTR_DIR)), )
                ifneq ($(wildcard $(OPTR_DIR)/Android.mk), )
                   include $(OPTR_DIR)/Android.mk
                else
