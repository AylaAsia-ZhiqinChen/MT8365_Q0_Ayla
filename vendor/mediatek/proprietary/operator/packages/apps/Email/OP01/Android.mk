...
# for Emai host app AOSP modification guidelines
ifeq ($(strip $(MTK_BSP_PACKAGE)), yes)
    LOCAL_JAVA_LIBRARIES += com.android.emailcommon.mtk
else
...
# move plugin app to product partition
