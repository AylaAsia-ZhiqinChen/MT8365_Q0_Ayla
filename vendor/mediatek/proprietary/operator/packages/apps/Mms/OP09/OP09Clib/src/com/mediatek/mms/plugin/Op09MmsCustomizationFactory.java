...
/** Factory class to make default plugin objects.
  */
public class Op09MmsCustomizationFactory extends OpMmsCustomizationFactoryBase {
    protected Context mContext;

    public Op09MmsCustomizationFactory(Context context) {
    	mContext = context;
    }


    public IOpMessagePluginExt makeOpMessagePluginExt() {
        return new Op09MessagePluginExt(mContext);
    }
}
