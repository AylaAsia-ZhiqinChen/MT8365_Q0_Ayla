...
public class ResultDialog {
    ...
    public static ResultDialogAdapter createResultAdapter
    (final Context context, final Bundle args) {
        List<Map<String, Object>> dataMapList = new ArrayList<Map<String, Object>>();
        List<ResultEntity> list = args.getParcelableArrayList(Constants.RESULT_KEY);
        if (list == null) {
            MyLogger.logE(CLASS_TAG, "ResultDialogAdapter: error: list is null");
            return null;
        }
    ...
    /*public static ResultDialogAdapter createAppResultAdapter
    (final List<AppSnippet> appSnippetList,
      final Context context, final Bundle args, final int resultType) {
        List<Map<String, Object>> dataMapList = new ArrayList<Map<String, Object>>();
        List<ResultEntity> list = args.getParcelableArrayList(Constants.RESULT_KEY);
        if (list == null) {
            MyLogger.logE(CLASS_TAG, "createAppResultAdapter: error: list is null");
            return null;
        }
        for (ResultEntity item : list) {
            Map<String, Object> map = new HashMap<String, Object>();
    ...
    public static class ResultEntity implements Parcelable {
        ...
        public static final Parcelable.Creator<ResultEntity> CREATOR
         = new Parcelable.Creator<ResultEntity>() {
