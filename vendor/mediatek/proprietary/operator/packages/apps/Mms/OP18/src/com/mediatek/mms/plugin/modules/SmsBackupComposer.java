...
public class SmsBackupComposer extends Composer {
    ...
    public boolean implementComposeOneEntity() {
        ...
        for (int i = 0; i < mSmsCursorArray.length; ++i) {
            if (mSmsCursorArray[i] != null && !mSmsCursorArray[i].isAfterLast()) {
                ...
                try {
                    if (mWriter != null) {
                        mWriter.write(combineVmsg(timeStamp, sentTime, readByte,
                         boxType, mSlotid, locked,
     ...
     * @return String.
     */
    public static String combineVmsg(String timeStamp, String sentTime,
     String readByte, String boxType,
