...
//import com.mediatek.mms.plugin.modules.BookmarkRestoreComposer;
//import com.mediatek.mms.plugin.modules.CalendarRestoreComposer;
import com.mediatek.op18.mms.modules.Composer;
//import com.mediatek.mms.plugin.modules.ContactRestoreComposer;
import com.mediatek.op18.mms.modules.MessageRestoreComposer;
//import com.mediatek.mms.plugin.modules.MusicRestoreComposer;
//import com.mediatek.mms.plugin.modules.NoteBookRestoreComposer;
//import com.mediatek.mms.plugin.modules.PictureRestoreComposer;
...
public class BackupFilePreview {
    ...
    private boolean addCurrentSN(List<RecordXmlInfo> recordList, String path) {
        ...
        MyLogger.logD(CLASS_TAG, "addCurrentSN() success : " + success);
        return success;
    }
    ...
    private int peekBackupModules(Context context) {
        ...
        MyLogger.logD(CLASS_TAG, "parseItemTypes: mTypes =  " + mTypes);
        return mTypes;
    }
