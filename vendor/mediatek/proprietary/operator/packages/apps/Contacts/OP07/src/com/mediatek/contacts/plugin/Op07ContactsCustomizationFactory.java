...
public class Op07ContactsCustomizationFactory extends ContactsCustomizationFactoryBase {

    private static String TAG = "Op07ContactsCustomizationFactory";
    ...
    public IContactsCommonPresenceExtension makeContactsCommonPresenceExt(Context context) {
        ...
        return new Op07ContactsCommonPresenceExt(context);
    }
}
