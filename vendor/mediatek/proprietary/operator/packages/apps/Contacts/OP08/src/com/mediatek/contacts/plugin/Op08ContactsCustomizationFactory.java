...
public class Op08ContactsCustomizationFactory extends ContactsCustomizationFactoryBase {

    private static String TAG = "Op08ContactsCustomizationFactory";

    public IContactsCommonPresenceExtension makeContactsCommonPresenceExt(Context context) {
        Log.d(TAG, "Context=" + context.getApplicationInfo());
        return new Op08ContactsCommonPresenceExt(context);
    }
}
