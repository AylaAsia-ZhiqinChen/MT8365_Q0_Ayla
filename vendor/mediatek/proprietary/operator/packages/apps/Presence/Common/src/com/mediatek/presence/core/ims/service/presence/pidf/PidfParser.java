...
package com.mediatek.presence.core.ims.service.presence.pidf;
...
import com.mediatek.presence.core.ims.service.presence.pidf.geoloc.Geopriv;
...
public class PidfParser extends DefaultHandler {
    ...
    private ServiceCapability serviceCap = null;
    private CapabilityDetails capabilityDetails = null;
    
    //video capab chnages
    private boolean duplexFlag = false;
    private String duplexValue = null;
     ...
     * @throws Exception
     */
    public PidfParser(int slotId, InputSource inputSource) throws Exception {
    ...
    public void startElement(String namespaceURL, String localName,    String qname, Attributes attr) {
        ...
        if (localName.equals("presence") 
            || localName.equals("pidf-full")  //added as server send xml doc with pidf-full and not presence 
            ) {
            String entity = attr.getValue("entity").trim();
            presence = new PidfDocument(mSlotId, entity);
        } else
        ...
        if (localName.equals("servcaps")) {
            serviceCap = new ServiceCapability();
        }
        else 
        if (localName.equals("duplex")) {
            if(serviceCap != null){
                duplexFlag = true;
        }
    }
    ...
    public void endElement(String namespaceURL, String localName, String qname) {
        ...
        if (localName.equals("servcaps")) {
            tuple.setServiceCapability(serviceCap);
            serviceCap = null;
        }else
            if (localName.equals("audio")) {
                capabilityDetails = new CapabilityDetails(localName, accumulator.toString().trim());
                if (serviceCap != null) {
                    serviceCap.addCapability(capabilityDetails);
                }
        ...
        if (localName.equals("duplex")) {
            if(duplexFlag){
                if(duplexValue!=null)
                {
                    capabilityDetails = new CapabilityDetails(localName, duplexValue);
                    if (serviceCap != null) {
                        serviceCap.addCapability(capabilityDetails);
                    }
                    capabilityDetails = null;    
                    ...
                    capabilityDetails = new CapabilityDetails(localName, "single");
                }*/
            }
            duplexValue = null;    
            duplexFlag = false;
        ...
        if (localName.equals("presence")
            || localName.equals("pidf-full")  //added as server send xml doc with p:pidf-full and not presence 
                ) {
            if (logger.isActivated()) {
