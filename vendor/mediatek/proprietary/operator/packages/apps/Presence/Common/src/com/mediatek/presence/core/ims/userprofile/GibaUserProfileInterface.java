...
public class GibaUserProfileInterface extends UserProfileInterface {
     ...
     * Constructor
     */
    public GibaUserProfileInterface(int slotId) {
        super(slotId);    
    }
    ...
    public UserProfile read() {
        ...
        String xdmPassword = RcsSettingsManager.getRcsSettingsInstance(mSlotId).getUserProfileImsPassword();        
        String confUri = RcsSettingsManager.getRcsSettingsInstance(mSlotId).getImConferenceUri();
