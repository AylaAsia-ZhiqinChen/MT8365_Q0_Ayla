...
package com.mediatek.presence.platform.registry;
...
public class AndroidRegistryFactory extends RegistryFactory {
    ...
    public static final String RCS_PREFS_NAME_ACC = "RCSACC";
    
    /*
     * Preference specific to IMS-RCS services are stored in this file.
     */
    public static final String RCS_PREFS_IMS_SERVICES = "RCSServices";
