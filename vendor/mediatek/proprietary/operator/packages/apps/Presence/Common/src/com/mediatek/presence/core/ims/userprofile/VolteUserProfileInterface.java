...
public class VolteUserProfileInterface extends UserProfileInterface {
     ...
     * Constructor
     */
    public VolteUserProfileInterface(int slotId) {
        super(slotId);
    }
    ...
    public UserProfile read() {
        ...
        String username_full = RcsSettingsManager.getRcsSettingsInstance(mSlotId).getUserProfileImsUserName_full();// @add for full public user identity but not only number part 
