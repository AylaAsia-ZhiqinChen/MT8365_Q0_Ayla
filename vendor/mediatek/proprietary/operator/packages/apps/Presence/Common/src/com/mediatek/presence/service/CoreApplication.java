...
import com.mediatek.presence.utils.AppUtils;
...
public class CoreApplication extends Application {
    private static Logger logger = Logger.getLogger(CoreApplication.class.getSimpleName());
    ...
    public void onCreate() {
        ...
        LauncherUtils.registerRcsServciceListener(getApplicationContext());
        //LauncherUtils.registerCXPListener(getApplicationContext());
        LauncherUtils.launchRcsService(getApplicationContext(), true, false);

        MtkUceService mtkUceService = new MtkUceService(getApplicationContext());
        ServiceManager.addService(UCE_SERVICE, mtkUceService.getBinder());
        notifyAospUceServiceStatus(ImsUceManager.ACTION_UCE_SERVICE_UP);
    }

    private void notifyAospUceServiceStatus(String action) {
