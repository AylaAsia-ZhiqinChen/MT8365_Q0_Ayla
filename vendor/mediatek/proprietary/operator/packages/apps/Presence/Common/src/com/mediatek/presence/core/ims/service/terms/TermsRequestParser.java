...
public class TermsRequestParser extends DefaultHandler {
     ...
     * @throws Exception
     */
    public TermsRequestParser(int slotId, InputSource inputSource, String requestedLanguage) throws Exception {
        ...
        if (localName.equals("EndUserConfirmationRequest")) {
            ...
            if (type.equalsIgnoreCase("Volatile")) {
                try {
                    ...
                    RcsSettings rcsSettings = RcsSettingsManager.getRcsSettingsInstance(mSlotId);
                    if (rcsSettings != null) {
