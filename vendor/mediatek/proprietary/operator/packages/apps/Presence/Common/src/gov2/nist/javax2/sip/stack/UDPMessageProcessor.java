...
public class UDPMessageProcessor extends MessageProcessor {
     ...
     */
    protected UDPMessageProcessor(int slotId, InetAddress ipAddress,
    ...
    public void run() {
        ...
        if (sipStack.threadPoolSize != -1) {
            for (int i = 0; i < sipStack.threadPoolSize; i++) {
                UDPMessageChannel channel = new UDPMessageChannel(mSlotId, sipStack,
                        this);
            ...
            try {
             ...
             if ( this.messageQueue.size() >= HIGHWAT) {
                ...
                if (sipStack.threadPoolSize != -1) {
                    ...
                    new UDPMessageChannel(mSlotId, sipStack, this, packet);
                }
    ...
    public MessageChannel createMessageChannel(HostPort targetHostPort)
        ...
        return new UDPMessageChannel(mSlotId, targetHostPort.getInetAddress(),
                targetHostPort.getPort(), sipStack, this);
    }

    public MessageChannel createMessageChannel(InetAddress host, int port)
            throws IOException {
        return new UDPMessageChannel(mSlotId, host, port, sipStack, this);
    }
