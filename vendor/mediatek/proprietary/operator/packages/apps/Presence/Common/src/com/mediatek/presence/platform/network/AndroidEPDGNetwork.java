...
package com.mediatek.presence.platform.network;
...
import com.mediatek.presence.provisioning.https.NameResolver;
 ...
 */
public class AndroidEPDGNetwork implements NameResolver {
   ...
   private static final String TAG = "AndroidEPDGNetwork";
    ...
    public AndroidEPDGNetwork(Context context) {
        mContext = context;
    ...
    private void newRequest(long subId) {
        ...
        mNetworkCallback = new ConnectivityManager.NetworkCallback() {
            ...
            public void onAvailable(Network network) {
                ...
                synchronized (AndroidEPDGNetwork.this) {
                    mNetwork = network;
                   ...
                   synchronized(AndroidEPDGNetwork.this){
                       ...
                       AndroidEPDGNetwork.this.notifyAll();
                   }
