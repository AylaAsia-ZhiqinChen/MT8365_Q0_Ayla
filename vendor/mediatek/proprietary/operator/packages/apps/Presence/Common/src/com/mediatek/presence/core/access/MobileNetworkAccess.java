...
package com.mediatek.presence.core.access;
...
public class MobileNetworkAccess extends NetworkAccess {
     ...
     */
    public MobileNetworkAccess(int slotId) throws CoreException {
        super();
        mSlotId = slotId;
        logger = Logger.getLogger(mSlotId, "MobileNetworkAccess");
    ...
    public String getType() {
        ...
        if (subIds == null) {
            logger.debug("getType fail. subIds is null");
            return "";
        }
        int type = telephonyManager.getNetworkType(subIds[0]);
        switch(type) {
    ...
    public String getNetworkName() {
        int[] subIds = SubscriptionManager.getSubId(mSlotId);
        if (subIds == null) {
            logger.debug("getNetworkName fail. subIds is null");
            return "";
        }
        int type = telephonyManager.getNetworkType(subIds[0]);
        switch(type) {
