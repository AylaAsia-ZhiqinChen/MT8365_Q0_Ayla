...
public abstract class SubscribeManager extends PeriodicRefresher {
    ...
    public void terminate() {
        ...
        if ((imsModule.getCurrentNetworkInterface() != null) &&
            ...
            if(RcsSettingsManager.getRcsSettingsInstance(mSlotId) != null
    ...
    public synchronized boolean subscribe() {
        ...
        try {
            ...
            if (dialogPath == null) {
                ...
                // Set local party
                String localParty = temp_username;//ImsModule.IMS_USER_PROFILE.getPublicUri();

                // Set remote party
                String remoteParty = temp_username;// getPresentity();
            ...
            // Create a SUBSCRIBE request
            SipRequest subscribe =  createSubscribe(dialogPath, expirePeriod);//createSubscribe(dialogPath, expirePeriod);
   ...
   /* public synchronized boolean RegisterSubscribe() {
        if (logger.isActivated()) {
            logger.info("RegisterSubscribe to " + getPresentity());
        }
        ...
        try {
            ...
            if (dialogPath == null) {
                ...
                // Set target
                String target = temp_username;//getPresentity();
            ...
            // Create a SUBSCRIBE request
            SipRequest subscribe =  createRegisterSubscribe(dialogPath, expirePeriod);//createSubscribe(dialogPath, expirePeriod);
