...
public class OptionsRequestTask implements Runnable {
     ...
     */
    public OptionsRequestTask(ImsModule parent, String contact,
            List<String> featureTags, int requestId) {
        this.imsModule = parent;
        this.contact = contact;
        this.featureTags = featureTags;
        this.authenticationAgent = new SessionAuthenticationAgent(imsModule);
    ...
    private void sendOptions() {
        ...
        try {
            ...
            SipRequest options = SipMessageFactory.createOptions(slotId, dialogPath, featureTags);
    ...
    private void sendOptions(SipRequest options) throws Exception {
        ...
        if (mRequestId != -1) {
            ...
            OptionsServiceImpl.receiveSipResponse(mRequestId, ctx.getSipResponse());
        }
