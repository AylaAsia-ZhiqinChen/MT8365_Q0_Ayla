 ...
 */
public class OP18SettingsCustomizationFactory extends OpSettingsCustomizationFactoryBase {

    private Context mContext;
    /** Constructor.
     * @param context context
     */
    public OP18SettingsCustomizationFactory(Context context) {
        super(context);
        mContext = context;
    }
    ...
    public IApnSettingsExt makeApnSettingsExt(Context context) {
        return new OP18ApnSettingsExt(mContext);
    }
