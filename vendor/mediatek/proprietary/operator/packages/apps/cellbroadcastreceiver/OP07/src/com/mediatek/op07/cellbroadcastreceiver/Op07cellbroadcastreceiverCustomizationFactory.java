...
public class Op07cellbroadcastreceiverCustomizationFactory extends OpCmasCustomizationFactoryBase {

    public Context mContext;

    public Op07cellbroadcastreceiverCustomizationFactory(Context context) {
        mContext = context;
    }

    @Override
    public ICmasMainSettingsExt makeCmasMainSettings(Context context) {
        return new OP07CmasMainSettingsExt(mContext);
    }

    @Override
    public ICmasMessageInitiationExt makeCmasMessageInitiation(Context context) {
        return new OP07CmasMessageInitiationExt(context);
    }

    @Override
    public ICmasSimSwapExt makeCmasSimSwap(Context context) {
        return new OP07CmasSimSwapExt(context);
    }
}