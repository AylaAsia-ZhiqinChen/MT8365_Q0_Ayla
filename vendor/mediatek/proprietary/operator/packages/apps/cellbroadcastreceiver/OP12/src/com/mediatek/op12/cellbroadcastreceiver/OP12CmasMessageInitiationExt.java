 ...
 */
public class OP12CmasMessageInitiationExt extends DefaultCmasMessageInitiationExt {
    private static final String TAG = "OP12CmasMessageInitiationExt";


    public OP12CmasMessageInitiationExt(Context context) {
        super(context);
    }
