...
public class Op12CellbroadcastReceiverCustomizationFactory extends OpCmasCustomizationFactoryBase {
    public Context mContext;

    public Op12CellbroadcastReceiverCustomizationFactory(Context context) {
        mContext = context;
    }

    @Override
    public ICmasMainSettingsExt makeCmasMainSettings(Context context) {
        return new OP12CmasMainSettingsExt(mContext);
    }

    @Override
    public ICmasMessageInitiationExt makeCmasMessageInitiation(Context context) {
        return new OP12CmasMessageInitiationExt(context);
    }
