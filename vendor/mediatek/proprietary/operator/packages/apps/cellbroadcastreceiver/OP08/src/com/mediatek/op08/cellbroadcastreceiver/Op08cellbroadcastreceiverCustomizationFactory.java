...
public class Op08cellbroadcastreceiverCustomizationFactory extends OpCmasCustomizationFactoryBase {
    public Context mContext;

    public Op08cellbroadcastreceiverCustomizationFactory(Context context) {
        mContext = context;
    }

    @Override
    public ICmasMainSettingsExt makeCmasMainSettings(Context context) {
        return new OP08CmasMainSettingsExt(mContext);
    }

    @Override
    public ICmasMessageInitiationExt makeCmasMessageInitiation(Context context) {
        return new OP08CmasMessageInitiationExt(context);
    }

    @Override
    public ICmasDuplicateMessageExt makeCmasDuplicateMessage(Context context) {
        return new OP08CmasDuplicateMessageExt(context);
    }
}