 ...
 */
public class OP236CmasMessageInitiationExt extends DefaultCmasMessageInitiationExt {
    private static final String TAG = "OP236CmasMessageInitiationExt";
    private static final int PRESIDENT_ALERT_ID = 4370;
    private Context mContext;
    private WindowManager mWindowManager;

    public OP236CmasMessageInitiationExt(Context context) {
        super(context);
        mContext = context;
    }
    ...
    @Override
    public WindowManager.LayoutParams updateViewLpToTouchable(WindowManager.LayoutParams lp,
                                        boolean bTouchable) {
