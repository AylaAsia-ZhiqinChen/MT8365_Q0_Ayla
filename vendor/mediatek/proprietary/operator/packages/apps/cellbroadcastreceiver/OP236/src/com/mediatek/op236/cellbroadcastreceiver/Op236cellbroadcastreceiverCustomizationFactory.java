...
public class Op236cellbroadcastreceiverCustomizationFactory extends OpCmasCustomizationFactoryBase {
    public Context mContext;

    public Op236cellbroadcastreceiverCustomizationFactory(Context context) {
        mContext = context;
    }

    @Override
    public ICmasMainSettingsExt makeCmasMainSettings(Context context) {
        return new OP236CmasMainSettingsExt(mContext);
    }

    @Override
    public ICmasMessageInitiationExt makeCmasMessageInitiation(Context context) {
        return new OP236CmasMessageInitiationExt(context);
    }
}