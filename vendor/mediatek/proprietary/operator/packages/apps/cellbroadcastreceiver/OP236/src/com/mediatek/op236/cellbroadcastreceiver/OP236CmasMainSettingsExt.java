...
package com.mediatek.op236.cellbroadcastreceiver;
...
public class OP236CmasMainSettingsExt extends DefaultCmasMainSettingsExt {

    private static final int PRESIDENT_ALERT_ID = 4370;
    private static final String TAG = "CellBroadcastReceiver/OP236CmasMainSettingsExt";
    ...
    public OP236CmasMainSettingsExt(Context context) {
        super(context);
        mContext = context;
    }
    ...
    public boolean needToaddAlertSoundVolumeAndVibration() {
        Log.d(TAG, "OP236 NeedToaddAlertSoundVolumeAndVibration");
        return true;
    }
    ...
    public void addNewChannelAlertsSetting(PreferenceFragment fragment,
        ...
        Log.i(TAG, "public Safty alert checkbox added isPublicSaftyEnable = " +
                                       isPublicSaftyEnable);
