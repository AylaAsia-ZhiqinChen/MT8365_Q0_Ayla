 ...
 */
public class OP08CallCardExt extends DefaultCallCardExt {
    private static final String TAG = "OP08CallCardExt";
    ...
    public OP08CallCardExt(Context context) {
        super();
        Log.d(TAG, "OP08CallCardExt");
        mContext = context;
    }
