...
public class Op02CallLogExt extends DefaultCallLogExt {
    private static final String TAG = "Op02CallLogExt";

    public static Context mPluginContext;
    public Op02CallLogExt(Context context) {
    ...
    public ICallLogFragmentExt getCallLogFragmentExt(
      ...
      if (isCallLogActivity) {
          Log.d(TAG, "Op02CallLogFragmentExt");
          ...
          return super.getCallLogFragmentExt(fragment, isCallLogActivity,
                  callTypeFilter, forceFresh);
      }
    }
