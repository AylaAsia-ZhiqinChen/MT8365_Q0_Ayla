...
public class Op01CallDetailsExtension extends DefaultCallDetailsExtension {
    private static final String TAG = "Op01CallDetailsExtension";
    public static Context mPluginContext;
    public Op01CallDetailsExtension(Context context) {
        Log.d(TAG, "Op01CallDetailsExtension");
    ...
    public ICallDetailsActivityExt getCallDetailsActivityExt(Context context,
        ...
        return new Op01CallDetailsActivityExt(context, adapter, number);
    }
    ...
    public ICallDetailsHeaderViewHolderExt getCallDetailsHeaderViewHolderExt(
        ...
        return new Op01CallDetailsHeaderViewHolderExt(context, viewHolder);
    }
}
