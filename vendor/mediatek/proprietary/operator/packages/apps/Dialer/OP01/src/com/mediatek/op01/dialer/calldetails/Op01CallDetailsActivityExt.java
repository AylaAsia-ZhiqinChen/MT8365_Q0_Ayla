...
public class Op01CallDetailsActivityExt extends DefaultCallDetailsActivityExt
       implements PhoneStateUtils.OnChangedListener {
    private static final String TAG = "Op01CallDetailsActivityExt ";
    private Context mHostContext;
    private RecyclerView.Adapter mAdapter;
    private String mNumber;

    Op01CallDetailsActivityExt(Context context, RecyclerView.Adapter adapter, String number) {
