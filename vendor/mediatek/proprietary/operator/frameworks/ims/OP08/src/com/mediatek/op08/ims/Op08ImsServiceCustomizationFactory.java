...
/** Factory class to make OP08 Ims service plugin objects.
  */
public class Op08ImsServiceCustomizationFactory extends OpImsServiceCustomizationFactoryBase {

    private Context mPluginContext;

    public Op08ImsServiceCustomizationFactory(Context context) {
        mPluginContext = context;
    }

    @Override
    public IImsServiceExt makeImsServiceExt(Context context) {
        return new Op08ImsServiceExt(mPluginContext);
    }

    @Override
    public ImsVTUsageManager makeImsVTUsageManager() {
        return new Op08ImsVTUsageManager();
    }
    ...
    public OpImsCallSessionProxy makeOpImsCallSessionProxy() {
        return new OpImsCallSessionProxyImpl(mPluginContext);
    }
}
