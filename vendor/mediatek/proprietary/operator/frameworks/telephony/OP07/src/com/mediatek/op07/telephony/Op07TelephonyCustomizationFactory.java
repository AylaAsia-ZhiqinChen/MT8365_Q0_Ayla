...
public class Op07TelephonyCustomizationFactory extends OpTelephonyCustomizationFactoryBase {
    @Override
    public IDataConnectionExt makeDataConnectionExt(Context context) {
        return new Op07DataConnectionExt(context);
    }

    @Override
    public IServiceStateTrackerExt makeServiceStateTrackerExt(Context context) {
        return new Op07ServiceStateExt(context);
    }
}