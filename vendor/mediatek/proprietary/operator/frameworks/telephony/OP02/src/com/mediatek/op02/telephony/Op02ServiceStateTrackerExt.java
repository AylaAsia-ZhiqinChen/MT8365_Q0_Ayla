 ...
 * @return
 */
public class Op02ServiceStateTrackerExt extends ServiceStateTrackerExt {
    ...
    public Op02ServiceStateTrackerExt() {
    }

    public Op02ServiceStateTrackerExt(Context context) {
    }
