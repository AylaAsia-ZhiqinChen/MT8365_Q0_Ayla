...
public class Op02TelephonyCustomizationFactory extends OpTelephonyCustomizationFactoryBase {
    ...
    public IServiceStateTrackerExt makeServiceStateTrackerExt(Context context) {
        return new Op02ServiceStateTrackerExt(context);
    }

    @Override
    public IDataConnectionExt makeDataConnectionExt(Context context) {
        if (sDataConnectionExt == null) {
            synchronized (Op02DataConnectionExt.class) {
                if (sDataConnectionExt == null) {
                    sDataConnectionExt = new Op02DataConnectionExt(context);
                }
            }
        }
