...
public class SaOp12PersistDataHelper extends SaPersistDataHelper {
    ...
    public static String toString(Context context, int phoneId) {
        ...
        s.append(" " + DATA_KEY_ICCID + " = " +
                getStringData(context, phoneId, DATA_KEY_ICCID, ""));
        s.append(" " + DATA_KEY_PCO + " = " +
                getIntData(context, phoneId, DATA_KEY_PCO,
                           SelfActivationPcoBasedSm.PCO_VALUE_INVALID));
