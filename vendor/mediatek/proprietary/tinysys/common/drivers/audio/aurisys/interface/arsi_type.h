...
typedef struct arsi_task_config_t {
	...
	uint16_t output_flags;              /* audio_output_flags_t */

	uint32_t input_source;              /* audio_source_t, for record only */
	uint16_t input_flags;               /* audio_input_flags_t */

	uint16_t enhancement_feature_mask;  /* enhancement_feature_mask_t */
} arsi_task_config_t; /* sizeof(): 72 bytes */
