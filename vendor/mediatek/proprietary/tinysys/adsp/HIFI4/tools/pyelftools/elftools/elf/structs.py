...
class ELFStructs(object):
    ...
    def _create_structs(self):
        ...
        self._create_note()
        self._create_do_header()


    def _create_do_header(self):
        self.dynamic_object_header_t = Struct('dynamic_object_header_t',
            self.Elf_word('do_magic_0'),
            self.Elf_word('do_magic_1'),
            self.Elf_word('do_magic_2'),
            self.Elf_word('do_magic_3'),
            self.Elf_addr('do_features_start'),
            self.Elf_addr('do_features_end'),
            self.Elf_addr('do_exidx_start'),
            self.Elf_addr('do_exidx_end'),
            self.Elf_addr('do_bss_start'),
            self.Elf_addr('do_bss_end'),
            self.Elf_word('do_reserved_0'),
            self.Elf_word('do_reserved_1'),
        )
