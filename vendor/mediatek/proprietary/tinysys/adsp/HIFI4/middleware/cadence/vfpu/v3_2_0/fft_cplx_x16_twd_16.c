...
/*
  NatureDSP_Signal library. FFT part
    16-bit twiddle factor table for 16-point complex-valued fwd/inv FFT
  IntegrIT, 2006-2014
*/
...
static const fft_cplx_x16_descr_t fft_cplx_x16_16_descr = { 16, fft_cplx_x16_twd_16 };

const fft_handle_t h_fft_cplx_x16_16  = (fft_handle_t)&fft_cplx_x16_16_descr;
const fft_handle_t h_ifft_cplx_x16_16 = (fft_handle_t)&fft_cplx_x16_16_descr;

// N = 16;
// tw = reshape(exp(-2j*pi*[1;2;3]*(0:N/4-1)/N),1,3*N/4);
const int16_t ALIGN(8) fft_cplx_x16_twd_16[16*3/4*2] =
{
