...
float32_t scl_lognf( float32_t x )
{
  ...
  XT_MADDN_SX2( cf1, cf0, fr0 ); cf0 = cf1;
  XT_MADDN_SX2( cf3, cf2, fr0 ); cf1 = cf3;
  XT_MADDN_SX2( cf5, cf4, fr0 ); cf2 = cf5;
  XT_MADDN_SX2( cf7, cf6, fr0 ); cf3 = cf7;

  XT_MADDN_SX2( cf1, cf0, fr1 ); cf0 = cf1;
  XT_MADDN_SX2( cf3, cf2, fr1 ); cf1 = cf3;

  XT_MADDN_SX2( cf1, cf0, fr2 ); g = cf1;
