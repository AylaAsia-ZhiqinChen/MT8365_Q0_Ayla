...
/*
  NatureDSP_Signal library. FFT part
    32-bit twiddle factor table for 128-point complex-valued fwd/inv FFT
  IntegrIT, 2006-2014
*/
...
static const fft_cplx_x32_descr_t fft_cplx_x32_128_descr = { 128, fft_cplx_x32_twd_128 };

const fft_handle_t h_fft_cplx_x32_128  = (fft_handle_t)&fft_cplx_x32_128_descr;
const fft_handle_t h_ifft_cplx_x32_128 = (fft_handle_t)&fft_cplx_x32_128_descr;

// N = 128;
// tw = reshape(exp(-2j*pi*[1;2;3]*(0:N/4-1)/N),1,3*N/4);
const int32_t ALIGN(8) fft_cplx_x32_twd_128[128*3/4*2] =
{
