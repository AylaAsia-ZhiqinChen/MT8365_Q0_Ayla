...
int ifft_cplx16x16( int16_t * restrict y,
                    int16_t * restrict x,
                    int bexp, fft_handle_t h )
{
...

  {
    ...
    for ( n=0; n<N/(4*2); n++ )
    {
      ...
      AE_L16X4_RIP( a0, X0, +2*4 );
      AE_L16X4_RIP( a1, X1, +2*4 );
      AE_L16X4_RIP( a2, X2, +2*4 );
      AE_L16X4_RIP( a3, X3, +2*4 );

      a00 = AE_MULFC32X16RAS_L( scl, a0 );
      a10 = AE_MULFC32X16RAS_H( scl, a0 );
      a01 = AE_MULFC32X16RAS_L( scl, a1 );
      a11 = AE_MULFC32X16RAS_H( scl, a1 );
      a02 = AE_MULFC32X16RAS_L( scl, a2 );
      a12 = AE_MULFC32X16RAS_H( scl, a2 );
      a03 = AE_MULFC32X16RAS_L( scl, a3 );
      a13 = AE_MULFC32X16RAS_H( scl, a3 );
...

  {
    ...
    if ( !( logN & 1 ) )
    {
      ...
      for ( n=0; n<N/(4*2); n++ )
      {
        ...
        AE_MULF16X4SS( a00, a01, a0, scl );
        AE_MULF16X4SS( a02, a03, a1, scl );
        AE_MULF16X4SS( a10, a11, a2, scl );
        AE_MULF16X4SS( a12, a13, a3, scl );

        //
        // Butterfly 0
        //

        b00 = AE_ADD32( a00, a02 );
        b01 = AE_ADD32( a01, a03 );
        b02 = AE_SUB32( a00, a02 );
        b03 = AE_SUB32( a01, a03 );
        ...
        b10 = AE_ADD32( a10, a12 );
        b11 = AE_ADD32( a11, a13 );
        b12 = AE_SUB32( a10, a12 );
        b13 = AE_SUB32( a11, a13 );
        ...
        a0 = AE_ROUND16X4F32SASYM( a10, a00 );
        a1 = AE_ROUND16X4F32SASYM( a11, a01 );
        a2 = AE_ROUND16X4F32SASYM( a12, a02 );
        a3 = AE_ROUND16X4F32SASYM( a13, a03 );

        c0 = AE_MOVINT64_FROMINT16X4( a0 );
        c1 = AE_MOVINT64_FROMINT16X4( a1 );
        c2 = AE_MOVINT64_FROMINT16X4( a2 );
        c3 = AE_MOVINT64_FROMINT16X4( a3 );

        AE_S64_X( c0, (ae_int64*)Y0, ix );
        AE_S64_X( c1, (ae_int64*)Y1, ix );
        AE_S64_X( c2, (ae_int64*)Y2, ix );
        AE_S64_X( c3, (ae_int64*)Y3, ix );
    ...
    else
    {
      ...
      for ( n=0; n<N/(2*2); n++ )
      {
        ...
        a0 = AE_ROUND16X4F32SASYM( b10, b00 );
        a1 = AE_ROUND16X4F32SASYM( b11, b01 );
