                                               ...
                                               int16_t         gain )
{
  ...
  for ( m=0; m<M; m++ )
  {
    ...
    sectCoef[16*m+0] = S_neg_s( a2 ); 
    sectCoef[16*m+1] = S_neg_s( a1 );
    sectCoef[16*m+2] = 0;
    sectCoef[16*m+3] = ( m&1 ? g : S_round_l( (int32_t)g << 15 ) ); // Q15/Q14

    sectCoef[16*m+4] = S_neg_s( a2 );
    sectCoef[16*m+5] = S_neg_s( a1 );
    sectCoef[16*m+6] = ( m&1 ? g : S_round_l( (int32_t)g << 15 ) ); // Q15/Q14
    sectCoef[16*m+7] = 0;
