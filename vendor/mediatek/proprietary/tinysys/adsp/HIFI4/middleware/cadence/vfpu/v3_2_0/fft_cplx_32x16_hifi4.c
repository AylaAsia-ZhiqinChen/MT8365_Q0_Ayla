...
int fft_cplx32x16( int32_t * restrict y,
                   int32_t * restrict x,
                   int bexp, fft_handle_t h )
{
...

  {
    ...
    ae_int32x2 a20, a21, a22, a23;
    ae_int32x2 a30, a31, a32, a33;
    ae_int32x2 b00, b01, b02, b03;
    ae_int32x2 b10, b11, b12, b13;
    ae_int32x2 b20, b21, b22, b23;
    ae_int32x2 b30, b31, b32, b33;

    ae_f16x4 tw_12, tw_34, tw_56;
    ae_f16x4 tw_78, tw_9a, tw_bc;
    ...
    for ( n=0; n<N/(4*4); n++ )
    {
      ...
      tw_78 = ae_f16x4_loadi( TWD, 3*8 );
      tw_9a = ae_f16x4_loadi( TWD, 4*8 );
      tw_bc = ae_f16x4_loadi( TWD, 5*8 );

      ae_f16x4_loadip( tw_12, TWD, +6*8 );
      ...
      AE_L32X2_IP( a20, X0, +8 );
      AE_L32X2_IP( a21, X1, +8 );
      AE_L32X2_IP( a22, X2, +8 );
      AE_L32X2_IP( a23, X3, +8 );

      AE_L32X2_IP( a30, X0, +8 );
      AE_L32X2_IP( a31, X1, +8 );
      AE_L32X2_IP( a32, X2, +8 );
      AE_L32X2_IP( a33, X3, +8 );
      ...
      AE_ADDANDSUBRNG32( b20, b22, a20, a22 );
      AE_ADDANDSUBRNG32( b21, b23, a23, a21 );

      b23 = AE_MUL32JS( b23 );

      AE_ADDANDSUBRNG32( a20, a22, b20, b21 );
      AE_ADDANDSUBRNG32( a21, a23, b22, b23 );

      a21 = AE_MULFC32X16RAS_H( a21, tw_78 );
      a22 = AE_MULFC32X16RAS_L( a22, tw_78 );
      a23 = AE_MULFC32X16RAS_H( a23, tw_9a );

      //
      // Butterfly 3
      //

      AE_ADDANDSUBRNG32( b30, b32, a30, a32 );
      AE_ADDANDSUBRNG32( b31, b33, a33, a31 );

      b33 = AE_MUL32JS( b33 );

      AE_ADDANDSUBRNG32( a30, a32, b30, b31 );
      AE_ADDANDSUBRNG32( a31, a33, b32, b33 );

      a31 = AE_MULFC32X16RAS_L( a31, tw_9a );
      a32 = AE_MULFC32X16RAS_H( a32, tw_bc );
      a33 = AE_MULFC32X16RAS_L( a33, tw_bc );
      ...
      AE_S32X2RNG_IP( a20, Y0, +8 );
      AE_S32X2RNG_IP( a22, Y1, +8 );
      AE_S32X2RNG_IP( a21, Y2, +8 );
      AE_S32X2RNG_IP( a23, Y3, +8 );
                           
      AE_S32X2RNG_IP( a30, Y0, +8 );
      AE_S32X2RNG_IP( a32, Y1, +8 );
      AE_S32X2RNG_IP( a31, Y2, +8 );
      AE_S32X2RNG_IP( a33, Y3, +8 );
    }
