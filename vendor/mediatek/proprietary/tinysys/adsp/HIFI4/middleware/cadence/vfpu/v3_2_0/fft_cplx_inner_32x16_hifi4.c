                    ...
                    int * bexp, int N )
{
...

  {
    ...
    for ( stride=N/16, step=4; stride>4; stride/=4, step*=4 )
    {
      ...
      for ( m=0; m*(4*4*stride)<N; m++ )
      {
        ...
        for ( n=0; n<stride; n++ )
        {
          tw_3_ = ae_f16x4_loadi( TWD,       2*4 );
          ae_f16x4_loadxp( tw_12, TWD, +3*step*4 );
...

  {
    ...
    TWD = (const ae_f16x4*)( (uintptr_t)twd + 3*step*4 );
    ...
    if ( stride == 4 )
    {
      ...
      tw12 = ae_f16x4_loadi( TWD,       2*4 );
      ae_f16x4_loadxp( tw11, TWD, +3*step*4 );

      tw22 = ae_f16x4_loadi( TWD,       2*4 );
      ae_f16x4_loadxp( tw21, TWD, +3*step*4 );

      tw32 = ae_f16x4_loadi( TWD,       2*4 );
      ae_f16x4_loadxp( tw31, TWD, +3*step*4 );
    ...
    else if ( stride == 2 )
    {
      ...
      tw1 = ae_f16x4_loadi( TWD, 0*4 );
      tw2 = ae_f16x4_loadi( TWD, 2*4 );
