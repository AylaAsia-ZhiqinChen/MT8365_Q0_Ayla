...
/*
  NatureDSP_Signal library. FFT part
    16-bit twiddle factor table for 32-point real-valued fwd/inv FFT
  IntegrIT, 2006-2014
*/
...
static const int16_t fft_real_x16_spc[32*1/4*2] =
{
  (int16_t)0x0000,(int16_t)0x8000,(int16_t)0xe707,(int16_t)0x8276,
...
{ 
  32, fft_cplx_x16_twd_16, fft_real_x16_spc
};

const fft_handle_t h_fft_real_x16_32  = (fft_handle_t)&fft_real_x16_descr;
const fft_handle_t h_ifft_real_x16_32 = (fft_handle_t)&fft_real_x16_descr;
