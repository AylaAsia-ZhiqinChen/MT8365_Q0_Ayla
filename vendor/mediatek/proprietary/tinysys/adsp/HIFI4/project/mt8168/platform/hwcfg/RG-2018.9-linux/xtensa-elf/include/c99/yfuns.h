...
_CRTIMP2 _NO_RETURN(_CDECL _Exit(int));
...
_CRTIMP2 int _CDECL _Close(int);
_CRTIMP2 long _CDECL _Lseek(int, long, int);
_CRTIMP2 int _CDECL _Read(int, unsigned char *, int);
_CRTIMP2 int _CDECL _Write(int, const unsigned char *, int);
