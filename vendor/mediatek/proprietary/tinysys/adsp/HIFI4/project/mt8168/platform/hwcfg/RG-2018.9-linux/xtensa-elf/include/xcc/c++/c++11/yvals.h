...
#if !defined(_CLANG) || (__cplusplus > 0 && __cplusplus < 201103)
#define _HAS_CPP0X 0
#define _HAS_CPP1X 0
#define _HAS_CPP17 0
#define _HAS_STATIC_ASSERT 0
#define _HAS_VARIADIC_TEMPLATES 0
#define static_assert(test,msg) _STATIC_ASSERT2(test,msg)
#else
#define _HAS_CPP0X 1
#define _HAS_CPP1X 1
#define _HAS_CPP17 0
...
//  #define _NO_MT
    ...
    #define _C99
  #endif
#if defined(__clang) && (__CPLUSPLUS >= 201103)
  #define _HAS_TR1	1
#endif
