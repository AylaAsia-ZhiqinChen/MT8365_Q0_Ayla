...
#ifndef _MT8168_AFE_REG_H_
#define _MT8168_AFE_REG_H_
...
#define AFE_INTERNAL_SRAM_VIR_BASE	(0x11221000)

#define AFE_INTERNAL_SRAM_SIZE		(0xA000)
...
#define DMIC_TOP_CON_DMIC_CH2_TURN_ON			BIT(22)
#define DMIC_TOP_CON_DMIC_CH1_TURN_ON			BIT(21)
...
#define DMIC_TOP_CON_DMIC_INPUT_MODE(x)			((x) << 7)
#define DMIC_TOP_CON_DMIC_IIR_MODE(x)			((x) << 4)
#define DMIC_TOP_CON_DMIC_SDM3_LEVEL_MODE		BIT(1)
#define DMIC_TOP_CON_DMIC_SRC_ON			BIT(0)
#define DMIC_TOP_CON_CONFIG_MASK			(0x3f8ec022)
...
#define CM_AFE_CM2_TDM_SEL_CM2_OUTPUT	(0 << 12)
#define CM_AFE_CM2_TDM_SEL_TDM			(1 << 12)
