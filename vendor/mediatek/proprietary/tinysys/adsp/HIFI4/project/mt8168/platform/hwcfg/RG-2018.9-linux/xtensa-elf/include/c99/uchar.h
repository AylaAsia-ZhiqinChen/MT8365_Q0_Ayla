...
typedef _Sizet size_t;
		...
		/* declarations */
_CRTIMP2 size_t _CDECL mbrtoc16(char16_t *_Restrict, const char *_Restrict,
	size_t, mbstate_t *_Restrict);
_CRTIMP2 size_t _CDECL c16rtomb(char *_Restrict, char16_t,
	mbstate_t *_Restrict);

_CRTIMP2 size_t _CDECL mbrtoc32(char32_t *_Restrict, const char *_Restrict,
	size_t, mbstate_t *_Restrict);
_CRTIMP2 size_t _CDECL c32rtomb(char *_Restrict, char32_t,
	mbstate_t *_Restrict);
_END_C_LIB_DECL
_C_STD_END
#endif /* _UCHAR */
