...
static float _Tg_overload _Tg_fabs(float _Complex _Left)
	{return (cabsf(_Left));}
static double _Tg_overload _Tg_fabs(double _Complex _Left)
	{return (cabs(_Left));}
static long double _Tg_overload _Tg_fabs(long double _Complex _Left)
	{return (cabsl(_Left));}
#else
_Tg_cabs
#endif
...
_Tg_r2(pow)
#if defined(TENSILICA) || 1
static float _Complex _Tg_overload _Tg_pow(float _Complex _Left, float _Complex _Right)
        {return (cpowf(_Left, _Right));}
static double _Complex _Tg_overload _Tg_pow(double _Complex _Left, double _Complex _Right)
        {return (cpow(_Left, _Right));}
static long double _Complex _Tg_overload _Tg_pow(long double _Complex _Left, long double _Complex _Right)
