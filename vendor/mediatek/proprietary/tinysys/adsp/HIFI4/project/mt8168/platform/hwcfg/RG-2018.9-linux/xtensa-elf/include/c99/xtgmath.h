...
extern "C" CRTTYPE double _CDECL FUN(double); \
...
extern "C" CRTTYPE double _CDECL FUN(double, ARG2); \
template<class _Ty> inline \
	typename _STD enable_if< _STD is_integral<_Ty>::value, double>::type \
...
extern "C" CRTTYPE double _CDECL FUN(double, double); \
template<class _Ty1, \
	class _Ty2> inline \
...
extern "C" CRTTYPE RET _CDECL FUN(double); \
template<class _Ty> inline \
