...
placed in the public domain without restrictions.  Just don't claim you wrote it or prevent anyone
else from using it; if distributing source, leave this notice in the source files.
...
/* While getopt.h is a posix extension, the following are newlib extensions.
 * They are optionally included via the __need_getopt_newlib flag.  */
  ...
  extern int __getopt_r (int __argc, char *const __argv[], const char *__optstring,
			 struct getopt_data * __data);

  extern int __getopt_long_r (int __argc, char *const __argv[], const char *__shortopts,
			      const struct option * __longopts, int *__longind,
			      struct getopt_data * __data);

  extern int __getopt_long_only_r (int __argc, char *const __argv[], const char *__shortopts,
				   const struct option * __longopts, int *__longind,
				   struct getopt_data * __data);
