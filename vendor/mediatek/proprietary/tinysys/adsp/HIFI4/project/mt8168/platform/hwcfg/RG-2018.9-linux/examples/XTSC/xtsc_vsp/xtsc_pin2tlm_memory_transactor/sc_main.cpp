...
int sc_main(int argc, char *argv[]) {
  ...
  try {
    ...
    xtsc_memory_parms core0_dram0_parms(core0.get_xtsc_core(), "dram0");
    ...
    xtsc_master_parms master_parms("../../xtsc_pin2tlm_memory_transactor/master.vec");
    master_parms.extract_parms(argc, argv, "master");
    xtsc_master master("master", master_parms);

    // Configure and construct tlm2pin
    xtsc_tlm2pin_memory_transactor_parms tlm2pin_parms(core0.get_xtsc_core(), "pif");
    ...
    xtsc_pin2tlm_memory_transactor_parms pin2tlm_parms(core0.get_xtsc_core(), "pif");
