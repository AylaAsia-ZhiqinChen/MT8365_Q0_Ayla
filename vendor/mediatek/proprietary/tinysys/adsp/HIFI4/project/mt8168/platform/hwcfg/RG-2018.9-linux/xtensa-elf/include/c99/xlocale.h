...
typedef struct _Linfo
	...
	_Tinfo _Times;
		...
		/* declarations */
_C_LIB_DECL
const char *_CDECL _Defloc(int);
_Linfo *_CDECL _Findloc(const char *, size_t);
void _CDECL _Freeloc(_Linfo *);
_Linfo *_CDECL _Getloc(const char *, const char *);
const char *_CDECL _Locsum(const char *, unsigned long *);
int _CDECL _Locterm(const char **, unsigned long *);
int _CDECL _Locvar(char, unsigned long);
int _CDECL _Makeloc(FILE *, char *, _Linfo *);
int _CDECL _Makestab(_Linfo *, const _Locitem *, const char *);
int _CDECL _Makewct(_Linfo *, const _Locitem *, const char *);
const _Locitem *_CDECL _Readloc(FILE *, char *, const char **);
_Linfo *_CDECL _Setloc(size_t, _Linfo *);
const char *_CDECL _Skip(const char *);
