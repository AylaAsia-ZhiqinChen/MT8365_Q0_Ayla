...
int sc_main(int argc, char *argv[]) {
  ...
  try {
    ...
    xtsc_memory_parms pif_parms(core0.get_xtsc_core(), "pif");
    ...
    xtsc_master_tlm2_parms master_tlm2_parms("../../xtsc_tlm22xttlm_transactor/master_tlm2.vec", core_parms.get_u32("PIFByteWidth"));
    ...
    tlm22xttlm_parms.set("allow_transport_dbg", false);   // Prevent peeking 4GB at 256 byte intervals when -scmemdebug option is used
    ...
    // Load program
    core0.get_xtsc_core().load_program("target/hello.out");
