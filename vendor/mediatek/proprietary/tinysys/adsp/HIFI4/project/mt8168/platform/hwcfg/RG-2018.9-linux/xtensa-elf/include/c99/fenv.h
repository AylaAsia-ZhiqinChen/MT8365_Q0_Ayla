...
typedef unsigned long fenv_t;
  ...
  #define _FE_EXCEPT_OFF   7
  #define _FE_EXMASK_OFF   2	
  #define _FE_RND_OFF	   0	
...
_CRTIMP2 unsigned int _CDECL _controlfp(unsigned int,unsigned int);
_CRTIMP2 unsigned int _CDECL _statusfp(void);
_CRTIMP2 unsigned int _CDECL _clearfp(void);
...
_CRTIMP2 int _CDECL feclearexcept(int);
_CRTIMP2 int _CDECL fegetexceptflag(fexcept_t *, int);
_CRTIMP2 int _CDECL feraiseexcept(int);
_CRTIMP2 int _CDECL fesetexceptflag(const fexcept_t *, int);
_CRTIMP2 int _CDECL fetestexcept(int);
_CRTIMP2 int _CDECL fegetround(void);
_CRTIMP2 int _CDECL fesetround(int);
_CRTIMP2 int _CDECL fegetenv(fenv_t *);
_CRTIMP2 int _CDECL feholdexcept(fenv_t *);
_CRTIMP2 int _CDECL fesetenv(const fenv_t *);
_CRTIMP2 int _CDECL feupdateenv(const fenv_t *);

 #if _ADDED_C_LIB
_CRTIMP2 fexcept_t _CDECL fegettrapenable(void);
_CRTIMP2 int _CDECL fesettrapenable(fexcept_t);
 #endif /* _ADDED_C_LIB */

double _CDECL _Force_raise(int except);
