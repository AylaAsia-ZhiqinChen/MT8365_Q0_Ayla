...
int sc_main(int argc, char *argv[]) {
  ...
  try {
    ...
    // Create core core0
    // Next line internally calls extract_parms
    core0 = new xtsc_core_vsp("core0", core0_parms);
    ...
    core0_router_parms.set("routing_table", "../../xtsc_dma_engine/core0_router.tab");
    ...
    dma_router_parms.set("routing_table", "../../xtsc_dma_engine/dma_router.tab");
    ...
    mmio_parms.set("definition_file", "../../xtsc_dma_engine/mmio.def");
    ...
    xtsc_memory_parms pifmem_parms(core0->get_xtsc_core(), "pif");
    pifmem_parms.set("check_alignment", true);
    pifmem_parms.set("initial_value_file", "../../xtsc_dma_engine/pifmem.dat");
    ...
    xtsc_memory_parms dram0_parms(core0->get_xtsc_core(), "dram0");
    ...
    // Load program
    core0->get_xtsc_core().load_program("target/main.out");
