 ...
 */
#ifndef _HW_RES_MGR_H_
#define _HW_RES_MGR_H_
#include "hw_res_mgr_implement.h"

typedef int (*dsp_hw_res_set)(int value);

int dsp_hw_res_init(void);
int dsp_hw_res_uninit(void);
int dsp_hw_res_register_ops(int type, dsp_hw_res_set ops);
