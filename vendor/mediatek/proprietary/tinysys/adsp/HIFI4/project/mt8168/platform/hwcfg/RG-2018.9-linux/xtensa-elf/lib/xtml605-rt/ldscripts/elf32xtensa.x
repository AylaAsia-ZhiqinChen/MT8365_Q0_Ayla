/* This linker script generated from xt-genldscripts.tpp for LSP xtml605-rt */
...
MEMORY
{
  ...
  sram7_seg :                         	org = 0x4002061C, len = 0xFFFF9E4
}
...
_memmap_mem_sram_end   = 0x50020000;
...
_memmap_seg_sram7_max   = 0x50020000;

_rom_store_table = 0;
PROVIDE(_memmap_vecbase_reset = 0x40020400);
PROVIDE(_memmap_reset_vector = 0x40000640);
/* Various memory-map dependent cache attribute settings: */
_memmap_cacheattr_wb_base = 0x00041104;
_memmap_cacheattr_wt_base = 0x00043304;
_memmap_cacheattr_bp_base = 0x00044404;
_memmap_cacheattr_unused_mask = 0xFFF000F0;
_memmap_cacheattr_wb_trapnull = 0x44441144;
_memmap_cacheattr_wba_trapnull = 0x44441144;
_memmap_cacheattr_wbna_trapnull = 0x44442244;
_memmap_cacheattr_wt_trapnull = 0x44443344;
_memmap_cacheattr_bp_trapnull = 0x44444444;
_memmap_cacheattr_wb_strict = 0x00041104;
_memmap_cacheattr_wt_strict = 0x00043304;
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0x50020000);
  _heap_sentry = 0x50020000;
  .debug  0 :  { *(.debug) }
  .line  0 :  { *(.line) }
