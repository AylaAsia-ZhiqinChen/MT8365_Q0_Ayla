...
MEMORY
{
  ...
  sram7_seg :                         	org = 0x4002061C, len = 0x3FFF9E4
}
...
_memmap_mem_sram_end   = 0x44020000;
...
_memmap_seg_sram7_max   = 0x44020000;
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0x44020000);
  _heap_sentry = 0x44020000;
  .debug  0 :  { *(.debug) }
  .line  0 :  { *(.line) }
