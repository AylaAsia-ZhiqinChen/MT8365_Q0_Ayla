...
int sc_main(int argc, char *argv[]) {
  ...
  try {
    ...
    init_parms.set("turbo", false);   // May not work under TurboXim
    ...
    xtsc_router_parms router_parms(2, true, "../../xtsc_mmio/routing.tab", 0);
    ...
    xtsc_mmio_parms mmio_parms("../../xtsc_mmio/mmio.txt", 8, false);
    ...
    // Connect the "BInterrupt06" sc_port of mmio to the same-named 
    // sc_export of core1
    xtsc_connect(core1, "BInterrupt06", "BInterrupt06", mmio);
