...
-set_make_parm=verilog_files=$(XTSC_SCRIPT_FILE_PATH)/Testbench.v,$(XTSC_SCRIPT_FILE_PATH)/../../verilog.sources/lookup.v
...
-set_core_parm=SimTargetProgram=$(XTSC_SCRIPT_FILE_PATH)/target/lookup_test.out
-set_core_parm=SimTargetOutput=core0_output.log
-set_core_parm=SimPinLevelInterfaces=lut
-create_core=core0

-connect=core0,lut,,Xtensa0
