 ...
 */
#ifndef _AEC_DUMMY_H_
#define _AEC_DUMMY_H_

//#define AEC_DUMMY_MCPS      200000000
//TODO for FPGA TEST
#define AEC_DUMMY_MCPS      200000000

#define AEC_DUMMY_BEAMFORMINT 0x1234

struct aec_dummy_setting {
    int in_chnum;
    int out_chnum;
    int bitwidth;
    int rate;
...
typedef void aec_dummy_handle_t;
