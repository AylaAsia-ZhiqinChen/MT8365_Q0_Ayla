...
#ifndef _VAD_DUMMY_H_
#define _VAD_DUMMY_H_

//#define VAD_DUMMY_MCPS      13000000
//TODO for FPGA test
#define VAD_DUMMY_MCPS      1000000

#define VAD_DUMMY_FORCE_NG     0
#define VAD_DUMMY_FORCE_OK     1

typedef void vad_dummy_handle_t;
