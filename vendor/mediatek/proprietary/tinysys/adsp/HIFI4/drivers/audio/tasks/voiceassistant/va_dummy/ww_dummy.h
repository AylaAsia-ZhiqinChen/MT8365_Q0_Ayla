...
//#define WW_DUMMY_MCPS      13000000
//TODO for FPGA test
#define WW_DUMMY_MCPS      20000000

#define WW_DUMMY_FORCE_NG     0
#define WW_DUMMY_FORCE_OK     1

typedef void ww_dummy_handle_t;

typedef int (*ww_dummy_cb_t)(void *data, int confidence, long long start, long long stop, const char *wakeword);
