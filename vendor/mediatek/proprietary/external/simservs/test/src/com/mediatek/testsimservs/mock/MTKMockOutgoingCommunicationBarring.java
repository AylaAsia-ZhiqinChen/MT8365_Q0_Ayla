...
import org.w3c.dom.*;
public class MTKMockOutgoingCommunicationBarring extends OutgoingCommunicationBarring{
    String xmlContent = "";
    MtkMockLoader mLoader = new MtkMockLoader();
    public MTKMockOutgoingCommunicationBarring(XcapUri documentUri, String parentUri, String intendedId)
