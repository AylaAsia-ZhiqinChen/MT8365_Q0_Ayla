...
// TODO: hybrid VENC
#define TZCMD_VENC_AVC_HYBRID_INIT       8
#define TZCMD_VENC_AVC_HYBRID_ENCODE     9
#define TZCMD_VENC_AVC_HYBRID_ENCODE_NS     10
#define TZCMD_VENC_AVC_HYBRID_DEINIT      11
#define TZCMD_VENC_FILL_SECMEM      12
