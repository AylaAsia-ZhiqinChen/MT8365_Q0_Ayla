...
CLI_EXEC_T _arPowerTestCmdTbl [] =
{
	...
	{ (CHAR*)"lpm" , (CHAR*)"lpm" , _PowerDefault , NULL, (CHAR*)"config U2 LPM", CLI_GUEST },			
	{ (CHAR*)"swlpm" , (CHAR*)"swlpm" , _PowerDefault , NULL, (CHAR*)"set SW LPM to enter L1", CLI_GUEST },				
	{ (CHAR*)"rdnreg" , (CHAR*)"rdnreg" , _PowerDefault , NULL, (CHAR*)"random access registers in low power state", CLI_GUEST }, 			
