...
#ifndef __LOCAL_EVENTS_SUBSCRIBER_H__
#define __LOCAL_EVENTS_SUBSCRIBER_H__

#include "EventsSubscriber.h"

class LocalEventsSubscriber: public EventsSubscriber
{
public:
    LocalEventsSubscriber(
