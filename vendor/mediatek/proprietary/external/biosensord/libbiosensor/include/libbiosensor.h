...
#ifndef __LIBBIOSENSOR_H__
#define __LIBBIOSENSOR_H__
/*---------------------------------------------------------------------------*/
#include <math.h>

#define BIOMETRIC_NAME                  "/dev/biometric"
/*---------------------------------------------------------------------------*/
struct BioData {
    float pga6;
    float ambdac5_5;
...
struct BioThreshold {
    float ppg_ir_threshold;
    float ppg_r_threshold;
    float ekg_threshold;
};
/*---------------------------------------------------------------------------*/
int biosensor_calibration(int fd, struct BioData *cali);
