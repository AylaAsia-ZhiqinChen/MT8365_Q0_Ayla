...
#define SPM_FLAG_DDREN2_STATE_LSB             (1U << 22)
#define SPM_FLAG_DVS_FLAG_LSB                 (1U << 23)
#define SPM_FLAG_DVFS_STATE_LSB               (1U << 24)
#define SPM_FLAG_DIS_IMPED_WORK_AROUND        (1U << 25)
...
#define SPM_FLAG1_EFUSE_NO_0P7V_3200          (1U << 5)
...
#define SPM_FLAG1_DISABLE_VCORE_SRAM_CONTROL  (1U << 25)
#define SPM_FLAG1_RESERVED_BIT26              (1U << 26)
#define SPM_FLAG1_DIS_SCP_VOLT_REQ            (1U << 27)
#define SPM_FLAG1_FAKE_26M_FLAG               (1U << 28)
#define SPM_FLAG1_VAD_VCORE_DVFS_0P65         (1U << 29)
#define SPM_FLAG1_VAD_VCORE_DVFS_0P7          (1U << 30)
#define SPM_FLAG1_VAD_VCORE_DVFS_0P8          (1U << 31)
/* --- SPM DEBUG Define --- */
