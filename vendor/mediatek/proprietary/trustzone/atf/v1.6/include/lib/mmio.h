...
static inline uint16_t mmio_read_16(uintptr_t addr)
{
	...
	readVal = *(volatile uint16_t*)addr;
	dsb();
	return readVal;
}

static inline void mmio_write_32_relax(uintptr_t addr, uint32_t value)
{
...
static inline uint32_t mmio_read_32_relax(uintptr_t addr)
{
	return *(volatile uint32_t*)addr;
}

static inline void mmio_write_64_relax(uintptr_t addr, uint64_t value)
{
...
static inline uint64_t mmio_read_64_relax(uintptr_t addr)
{
...
static inline uint64_t mmio_read_64(uintptr_t addr)
{
	...
	readVal = *(volatile uint64_t*)addr;
	dsb();
	return readVal;
}
