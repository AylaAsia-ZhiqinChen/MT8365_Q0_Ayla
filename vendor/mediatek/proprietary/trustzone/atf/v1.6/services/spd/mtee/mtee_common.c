				 ...
				 struct mtee_context *mtee_ctx)
{
	 ...
	 * disabled and exception endianness is set to be the same as EL3
	 */
 ...
 ******************************************************************************/
uint64_t mtee_synchronous_sp_entry(struct mtee_context *mtee_ctx)
{
	uint64_t rc;
 ...
 ******************************************************************************/
void mtee_synchronous_sp_exit(struct mtee_context *mtee_ctx, uint64_t ret)
{
