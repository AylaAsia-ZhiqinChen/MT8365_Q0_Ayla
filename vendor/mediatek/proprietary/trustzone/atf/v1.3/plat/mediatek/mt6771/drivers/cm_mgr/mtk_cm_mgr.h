...
#define CPUTOP_NON_WFX_COUNTER_CTRL	(MCUSYS_MP1 + 0x770)
#define CPUTOP_NON_WFX_COUNTER	(MCUSYS_MP1 + 0x774)
#define CPU_AVG_STALL_RATIO	(MCUSYS_MP1 + 0x7C0)
#define CPU0_AVG_STALL_RATIO_CTRL	(MCUSYS_MP1 + 0x7C4)
#define CPU1_AVG_STALL_RATIO_CTRL	(MCUSYS_MP1 + 0x7C8)
#define CPU2_AVG_STALL_RATIO_CTRL	(MCUSYS_MP1 + 0x7CC)
#define CPU3_AVG_STALL_RATIO_CTRL	(MCUSYS_MP1 + 0x7D0)
#define AVG_STALL_RATIO_STATUS	(MCUSYS_MP1 + 0x7D4)
#define CPU0_STALL_COUNTER	(MCUSYS_MP1 + 0x7D8)
#define CPU1_STALL_COUNTER	(MCUSYS_MP1 + 0x7DC)
#define CPU2_STALL_COUNTER	(MCUSYS_MP1 + 0x7E0)
#define CPU3_STALL_COUNTER	(MCUSYS_MP1 + 0x7E4)
#define CPU0_NON_WFX_COUNTER	(MCUSYS_MP1 + 0x7E8)
#define CPU1_NON_WFX_COUNTER	(MCUSYS_MP1 + 0x7EC)
#define CPU2_NON_WFX_COUNTER	(MCUSYS_MP1 + 0x7F0)
#define CPU3_NON_WFX_COUNTER	(MCUSYS_MP1 + 0x7F4)
#define CPU_STALL_AVG_SPECIAL_REG	(MCUSYS_MP1 + 0x7F8)
