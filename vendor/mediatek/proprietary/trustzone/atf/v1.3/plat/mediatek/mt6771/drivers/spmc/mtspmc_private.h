...
#define MP0_CPUTOP_PROT_STEP1_0_MASK      ((1 << 10)|(1 << 12)|(1 << 13)|(1 << 26))
#define MP1_CPUTOP_PROT_STEP1_0_MASK      ((1 << 11)|(1 << 14)|(1 << 15)|(1 << 27))

/* bit-fields of INFRA_TOPAXI_PROTECTEN_STA1_1 */
#define MP0_CPUTOP_PROT_STEP1_0_ACK_MASK  ((1 << 10)|(1 << 12)|(1 << 13)|(1 << 26))
#define MP1_CPUTOP_PROT_STEP1_0_ACK_MASK  ((1 << 11)|(1 << 14)|(1 << 15)|(1 << 27))
