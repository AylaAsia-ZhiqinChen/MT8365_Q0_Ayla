...
/*******************************************************************************
 * The PSCI compatibility helper for plat_pm_ops_t 'pwr_domain_pwr_down_wfi' hook.
 ******************************************************************************/
extern unsigned int psci_find_max_off_lvl(const psci_power_state_t *state_info);
extern void psci_do_pwrdown_cache_maintenance(unsigned int pwr_level);
static void __dead2 pwr_domain_pwr_down_wfi_compat(const psci_power_state_t *target_state)
{
	unsigned int max_off_lvl = psci_find_max_off_lvl(target_state);
...
#if HW_ASSISTED_COHERENCY
	compat_psci_ops.pwr_domain_pwr_down_wfi = pwr_domain_pwr_down_wfi_compat;
#endif
