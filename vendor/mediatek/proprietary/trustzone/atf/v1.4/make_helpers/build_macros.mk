...
$(1): $(2) | bl$(3)_dirs
	@echo "  PP      $$<"
	$$(Q)$$(CPP) $$(CPPFLAGS) -P -D__ASSEMBLY__ -DDRAM_EXTENSION_SOURCE_LIST="$(DRAM_OBJS)" -DSRAM_DATA_SOURCE_LIST="$(SRAM_OBJS_DATA)" -DSRAM_BSS_SOURCE_LIST="$(SRAM_OBJS_BSS)" -D__LINKER__ $(MAKE_DEP) -o $$@ $$<
...
ifdef MAKE_BUILD_STRINGS
	...
	$$(Q)$$(LD) -o $$@ $$(TF_LDFLAGS) $$(LDFLAGS) -Map=$(MAPFILE) \
		--script $(LINKERFILE) $(BUILD_DIR)/build_message.o $(OBJS) $(LDLIBS) $(STATIC_LIBS)
