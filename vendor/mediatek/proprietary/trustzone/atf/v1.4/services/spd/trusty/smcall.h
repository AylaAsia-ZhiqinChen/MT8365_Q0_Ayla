...
#define SMC_YC_LOCKED_NOP	SMC_YIELDCALL_NR(SMC_ENTITY_SECURE_MONITOR, 1)
/**
 ...
 */
#define SMC_YC_RESTART_FIQ	SMC_YIELDCALL_NR(SMC_ENTITY_SECURE_MONITOR, 2)
 ...
 */
#define SMC_YC_NOP		SMC_YIELDCALL_NR(SMC_ENTITY_SECURE_MONITOR, 3)
