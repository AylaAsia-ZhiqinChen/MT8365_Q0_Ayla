...
#ifndef TRUSTKERNEL_GATEKEEPER_H
#define TRUSTKERNEL_GATEKEEPER_H
...
class TrustKernelGateKeeperDevice {
    public:

    TrustKernelGateKeeperDevice(const hw_module_t* module);
    ~TrustKernelGateKeeperDevice();
    ...
    // Static methods interfacing the HAL API with the TrustKernelGateKeeper device
