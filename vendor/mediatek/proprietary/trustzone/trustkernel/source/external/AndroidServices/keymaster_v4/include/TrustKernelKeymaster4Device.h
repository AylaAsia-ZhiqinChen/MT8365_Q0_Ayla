...
#ifndef HIDL_android_hardware_keymaster_V4_0_TrustKernelKeymaster4Device_H_
#define HIDL_android_hardware_keymaster_V4_0_TrustKernelKeymaster4Device_H_

#include <android/hardware/keymaster/4.0/IKeymasterDevice.h>

#include <hidl/Status.h>
#include <TrustKernelKeymasterImplementation.h>
...
class TrustKernelKeymaster4Device : public IKeymasterDevice {
  public:
    TrustKernelKeymaster4Device();
    virtual ~TrustKernelKeymaster4Device();
  ...
  private:
    std::unique_ptr<::trustkernel::TrustKernelKeymasterImplementation> impl_;
...
#endif  // HIDL_android_hardware_keymaster_V4_0_TrustKernelKeymaster4Device_H_
