...
TEEC_Result TEEC_InstallTA(TEEC_Context *context, void *ta_binary, uint32_t ta_size, uint32_t *response_len);
TEEC_Result TEEC_DeleteTA(TEEC_Context *context, TEEC_UUID *uuid);
