...
def _BuildBootableImage(sourcedir, fs_config_file, info_dict=None,
  ...
  if (partition_name == "recovery") or ((partition_name == "boot_debug") and (info_dict.get("recovery_as_boot") == "true")):
  ...
  if partition_name == "boot_debug":
    pass
  elif (info_dict.get("boot_signer") == "true" and
  ...
  if info_dict.get("avb_enable") == "true" and info_dict.get("avb_main_vbmeta_in_boot") != "true":
    if partition_name == "boot_debug":
      avb_partition_name = "boot"
    else:
      avb_partition_name = partition_name
    avbtool = info_dict["avb_avbtool"]
    part_size = info_dict[avb_partition_name + "_size"]
