...
# Enable COPY GZ/TEE shmem to Linux/GZ shmem support
GLOBAL_DEFINES += SC_DEBUG=0
...
# GZ version control
GLOBAL_DEFINES += VERSION_MAJOR=1
GLOBAL_DEFINES += VERSION_MINOR=1
GLOBAL_DEFINES += VERSION_DEV=00b
...
# GZ VFP registers backup/restore support
GLOBAL_DEFINES += WITH_GZ_VFP_REGS_RECOVERY_SUPPORT=1

# support RPMB parition for RPMB-share with TEE
GLOBAL_DEFINES += MTK_TEE_GP_SUPPORT

# support log level from build parameter
GLOBAL_DEFINES += GZ_LOG_LVL=$(GZ_LOG_LVL)
