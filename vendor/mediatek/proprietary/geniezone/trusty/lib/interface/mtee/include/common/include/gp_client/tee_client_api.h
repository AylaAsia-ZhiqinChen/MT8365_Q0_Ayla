...
struct teec_temp_memory_reference {
	u64    buffer;  // FIXME!! linux kernel use void *
	u64    size;    // FIXME!! linux kernel use size_t
};

struct teec_registered_memory_reference {
	u64               parent; // FIXME!! linux kernel use struct teec_shared_memory *
	u64			      size;   // FIXME!! linux kernel use size_t
	u64			      offset; // FIXME!! linux kernel use size_t
};
