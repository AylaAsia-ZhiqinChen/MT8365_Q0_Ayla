...
#define SECURITY_AO		(IO_PHYS + 0x1A000)
#define SRAMROM_SEC_CTRL        (SECURITY_AO + 0x10)
#define SRAMROM_SEC_CTRL2	(SECURITY_AO + 0x18)
#define SRAMROM_SEC_CTRL5	(SECURITY_AO + 0x24)
#define SRAMROM_SEC_CTRL6	(SECURITY_AO + 0x28)
#define SRAMROM_SEC_ADDR        (SECURITY_AO + 0x50)
#define SRAMROM_SEC_ADDR1	(SECURITY_AO + 0x54)
#define SRAMROM_SEC_ADDR2	(SECURITY_AO + 0x58)
...
#define SRAMROM_SEC_SEC1_EN          (0x1 << 30)
#define SRAMROM_SW_ROM_PD            (0x1 << 31)

#define SRAMROM_REG_1_ADDR	0x130000
#define SRAMROM_REG_2_ADDR	0x138000

#define SRAMROM_REG_0_EN	(1 << 28)
#define SRAMROM_REG_1_EN	(1 << 29)
#define SRAMROM_REG_2_EN	(1 << 30)
#define SRAMROM_REG_3_EN	(1 << 31)
