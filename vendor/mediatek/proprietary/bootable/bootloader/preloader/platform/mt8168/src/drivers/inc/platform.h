...
/* plat dbg info */
#define BOOT_TAG_PLAT_DBG_INFO      0x88610015
...
#define BOOT_TAG_EMMC_INFO      0x88610019
struct boot_tag_emmc_info {
    u32 emmc_ocr;
    u32 emmc_cid[4];
    u32 emmc_raw_csd[4];
};
...
typedef struct {
    ...
    union {
        ...
        struct boot_tag_emmc_info emmc_info;
...
extern u32 g_emmc_ocr;
extern u32 g_emmc_cid[4];
extern u32 g_emmc_raw_csd[4];
