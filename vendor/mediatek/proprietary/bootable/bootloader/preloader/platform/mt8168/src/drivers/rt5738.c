...
/* VDD2 */
#define RT5738_CHIP_NAME_0		"mt6691_vdd2"
#define RT5738_I2C_CHANNEL_REG0		I2C0
...
/* VDDQ */
#define RT5738_CHIP_NAME_1		"mt6691_vddq"
#define RT5738_I2C_CHANNEL_REG1		I2C0
...
/* VDD */
#define RT5738_CHIP_NAME_2		"ma5748_vdd"
#define RT5738_I2C_CHANNEL_REG2		I2C0
#define RT5738_SLAVE_ADDR_REG2		0x54
#define RT5738_BUCK_CTRL_REG2		(RT5738_VSEL0)
#define RT5738_MODE_SHIFT_REG2		(0)
#define RT5738_EN_SHIFT_REG2		(0)
...
void rt5738_hw_component_detect(struct rt5738_chip *chip)
{
	...
	rt5738_print("[%s] ret %d, PGOOD 0x%x\n", __func__, ret, PGOOD);

	if (chip->id == MT6691_VDD2)
		chip_id = MT6691_VDD2_ID;
	else if (chip->chip_id == MT6691_VDDQ)
		chip_id = MT6691_VDDQ_ID;
	else if (chip->chip_id == MA5748_VDD)
		chip_id = MA5748_VDD_ID;
	...
	rt5738_print("[%s] %s(%d) exist = %d, Chip ID = %x\n"
