...
#define vfe28_vol_reg         PMIC_RG_VFE28_VOSEL_ADDR
#define vfe28_enable_reg      PMIC_RG_LDO_VFE28_EN_ADDR
#define vfe28_mode_reg        0
#define vfe28_trim_reg        PMIC_RG_VFE28_VOTRIM_ADDR
#define vfe28_trim_mask       PMIC_RG_VFE28_VOTRIM_MASK
#define vfe28_trim_shift      PMIC_RG_VFE28_VOTRIM_SHIFT
#define vfe28_min_uV          2500000
#define vfe28_max_uV          2800000
#define vfe28_vol_mask_pos    VMPOS_TWO
#define vfe28_vol_shift_pos   VSPOS_TWO
#define vfe28_enable_bit_pos  EPOS_ONE
#define vfe28_mode_bit_pos    MPOS_NONE
#define vfe28_step_uV_type    NON_STEP_VOLT
#define vfe28_volt_type       NON_REGULAR_VOLTAGE
#define vfe28_stb             3300
