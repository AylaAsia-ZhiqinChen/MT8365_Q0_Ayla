...
/* USB download w/o VBAT mode enable/disable bit. This bit would lock keypad,so it should be disable after power-on*/
	pmic_config_interface(MT6392_STRUP_CON3, 0x0, MT6392_PMIC_RG_USBDL_EN_MASK, MT6392_PMIC_RG_USBDL_EN_SHIFT);
...
#ifndef MTK_PMIC_RST_KEY
	/* Disable pull-up resistor for HOMEKEY pin for dropping power consumption*/
	//pmic_config_interface(0x6024, 0x1, 0x1, 0x0);
	pmic_config_interface(MT6392_STRUP_CON3, 0x0, MT6392_PMIC_RG_FCHR_PU_EN_MASK, MT6392_PMIC_RG_FCHR_PU_EN_SHIFT);
#else
  /* Enable pull-up resistor for HOMEKEY pin */
	pmic_config_interface(MT6392_STRUP_CON3, 0x1, MT6392_PMIC_RG_FCHR_PU_EN_MASK, MT6392_PMIC_RG_FCHR_PU_EN_SHIFT);
#endif
