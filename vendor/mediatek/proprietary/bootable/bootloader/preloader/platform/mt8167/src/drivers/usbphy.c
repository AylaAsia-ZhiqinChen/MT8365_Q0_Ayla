...
#if 0 /* support for USB30*/
	USBPHY_I2C_WRITE8(0xFF, 0x00);
	USBPHY_I2C_WRITE8(0x05, 0x55);
	USBPHY_I2C_WRITE8(0x18, 0x84);
	USBPHY_I2C_WRITE8(0xFF, 0x10);
	USBPHY_I2C_WRITE8(0x0A, 0x84);
	USBPHY_I2C_WRITE8(0xFF, 0x40);
	USBPHY_I2C_WRITE8(0x38, 0x46);
	USBPHY_I2C_WRITE8(0x42, 0x40);
	USBPHY_I2C_WRITE8(0x08, 0xAB);
	USBPHY_I2C_WRITE8(0x09, 0x0C);
	USBPHY_I2C_WRITE8(0x0C, 0x71);
	USBPHY_I2C_WRITE8(0x0E, 0x4F);
	USBPHY_I2C_WRITE8(0x10, 0xE1);
	USBPHY_I2C_WRITE8(0x14, 0x5F);
	USBPHY_I2C_WRITE8(0xFF, 0x60);
	USBPHY_I2C_WRITE8(0x14, 0x03);
	USBPHY_I2C_WRITE8(0xFF, 0x00); 
	USBPHY_I2C_WRITE8(0x6A, 0x04);
	USBPHY_I2C_WRITE8(0x68, 0x08);
#else
	USBPHY_I2C_WRITE8(0xff, 0x00);
...
void mt_usb11_phy_savecurrent(void)
{
	...
	/*apply port1 avdd18 setting for low power case on non-port1 case(demo board)*/	
	print("[Preloader]:mt_usb11_phy_savecurrent\n");
