...
extern int mmc_rpmb_get_wc(u32 *wc);
extern u32 mmc_rpmb_get_size();
extern int mmc_rpmb_block0_read(u8 data[256]);
extern int mmc_rpmb_block0_write(u8 data[256], u32 wc);
