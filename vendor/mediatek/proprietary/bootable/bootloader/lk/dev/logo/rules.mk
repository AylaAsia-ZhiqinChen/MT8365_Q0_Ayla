...
BMP_TO_RAW := $(GET_LOCAL_DIR)/tool/bmp_to_raw
ZPIPE := $(GET_LOCAL_DIR)/tool/zpipe
MKIMG := $(GET_LOCAL_DIR)/../../scripts/mkimage
#&&}}
endif
#Yuntian:longyao add
#IMG_HDR_CFG := $(LOCAL_DIR)/img_hdr_logo.cfg
IMG_HDR_CFG := $(GET_LOCAL_DIR)/img_hdr_logo.cfg
#&&}}
...
ifeq ($(strip $(MTK_DUAL_DISPLAY_SUPPORT)), 2)
RESOURCE_OBJ_LIST +=   \
            $(BOOT_LOGO_DIR)/$(BASE_LOGO)/$(BASE_LOGO)_uboot_dual.raw
endif
