...
typedef struct{
    ...
    uint32  intr        :1;
    uint32  rsv1        :7;
    uint32  nxtgpdh4b   :4; /* !!!MT8590 Add*/
    uint32  nxtbdh4b    :4; /* !!!MT8590 Add*/

    void   *next;

    void   *ptr;

    uint32  buflen      :24;  /* bitwidth 16 -> 24 !!!MT8590 Change*/
    uint32  extlen      :8;   /* bit start   8 -> 24 !!!MT8590 Change*/
    //uint32  rsv2      :8;     /* bit start  24 -> 31 !!!MT8590 removed*/
...
typedef struct{
    ...
    uint32  buflen      :24; /* bitwidth 16 -> 24 !!!MT8590 Change*/
    uint32  rsv3        : 8; /* bitwidth 16 -> 8 !!!MT8590 Change*/
}bd_t;
struct scatterlist {
    u32 addr;
    u32 len;
