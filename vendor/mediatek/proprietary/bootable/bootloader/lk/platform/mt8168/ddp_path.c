...
#ifndef MTK_ONLY_SINGLE_DISPLAY
int module_list_scenario[DDP_SCENARIO_MAX][DDP_ENING_NUM] = {
	...
	/* DDP_SCENARIO_SECONDARY_RDMA1_DISP */
	{
...
static sel_t sel_in_map[] = {
	...
	{DISP_MODULE_DPI, {DISP_MODULE_RDMA1,
	 DISP_MODULE_DITHER0, DISP_MODULE_RSZ0_VIRTUAL1, -1},
	 0, 0},
};
...
static module_map_t module_mutex_map[DISP_MODULE_NUM] = {
	...
	{DISP_MODULE_RSZ, 19, 0},
	{DISP_MODULE_RSZ0_VIRTUAL0, -1, 0},
	{DISP_MODULE_RSZ0_VIRTUAL1, -1, 0},
	{DISP_MODULE_RDMA0, 9, 0},
	{DISP_MODULE_RDMA1, 10, 0},
	{DISP_MODULE_WDMA0, 11, 0},
	{DISP_MODULE_WDMA_VITUAL0, -1, 0},
	{DISP_MODULE_WDMA_VITUAL1, -1, 0},
	{DISP_MODULE_COLOR0, 12, 0},
	{DISP_MODULE_CCORR0, 13, 0},
	{DISP_MODULE_AAL0, 14, 0},
	{DISP_MODULE_GAMMA0, 15, 0},
	{DISP_MODULE_DITHER0, 16, 0},
	{DISP_MODULE_SPLIT0, -1, 0},
	{DISP_MODULE_DSI0, 17, 0},
	{DISP_MODULE_DSI1, -1, 0},
	{DISP_MODULE_DSIDUAL, -1, 0},
	{DISP_MODULE_PWM0, 20, 0},
...
char *ddp_get_scenario_name(DDP_SCENARIO_ENUM scenario)
{
	...
	case DDP_SCENARIO_PRIMARY_ALL:
		return "primary_all";
	case DDP_SCENARIO_SECONDARY_RDMA1_DISP:
...
int ddp_path_m4u_off(void)
{
	...
	*/
	...
	/*
		...
		M4U_PORT_DISP_WDMA0,
	*/
	// 0x380->smi port0(ovl0), 0x384->port1(ovl0_2l), 0x388->port2(rdma0), 0x38c->port3(wdma0), 0x390->port4(disp_rdma1)
	for (i=0; i<5; i++)
