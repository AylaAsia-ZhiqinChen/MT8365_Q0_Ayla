...
#define DISP_REG_CONFIG_MMSYS_CG_CLR0			(DISPSYS_CONFIG_BASE + 0x108)
	...
	#define FLD_CG0_DPI								REG_FLD(1, 20)
...
#define FLD_CG1_DPI_MM_CK 						REG_FLD(1, 1)
#define FLD_CG1_LVDS_PIXEL_CK 					REG_FLD(1, 2)
#define FLD_CG1_LVDS_CTS_CK 					REG_FLD(1, 3)
...
#define DISP_REG_CONFIG_DISP_RDMA1_SOUT_SEL (DISPSYS_CONFIG_BASE + 0xFD0)
#define DISP_REG_CONFIG_DPI0_SEL_IN (DISPSYS_CONFIG_BASE + 0xFD8)
