...
static const char* ddp_signal[2][32] = {
	{
		...
		"disp_rdma0_rsz0_in_sout_out0__to__disp_rdma0_rsz0_sel_in0",
		"disp_rdma0_rsz0_in_sout_out1__to__disp_rsz0_sel_in2",
		...
		"disp_rdma0_sout_out3__to__dpi0_sel_in2",
		"disp_rdma1__to__disp_rdma1_sout",
		"disp_rdma1_sout_out0__to__dsi0_sel_in2",
		"disp_rdma1_sout_out1__to__dpi0_sel_in0",
	...
	},
	{
		...
		"dither0_mout_out2__to__dpi0_sel_in1",
		"dpi0_sel__to__dpi0",
		"dsi0_sel__to__dsi0",
	},
...
static char *ddp_get_mutex_module0_name(unsigned int bit)
{
	...
	case 4:  return "mdp_wrot1";
	case 5:  return "mdp_wrot0";
	case 6:  return "mdp_tdshp0";
	case 7:  return "disp_ovl0";
	case 8:  return "disp_ovl0_2l";
	case 9:  return "disp_rdma0";
	case 10: return "disp_rdma1";
	case 11: return "disp_wdma0";
	case 12: return "disp_color0";
	case 13: return "disp_ccorr0";
	case 14: return "disp_aal0";
	case 15: return "disp_gamma0";
	case 16: return "disp_dither0";
	case 17: return "disp_dsi0";
	case 18: return "img_dl_ready";
	case 19: return "disp_rsz0";
	case 20: return "disp_pwm0";
	case 21: return "mdp_rdma1";
	case 22: return "disp_dpi0";
...
static void mmsys_config_dump_reg(void)
{
	...
	DDPDUMP("MMSYS_CONFIG: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x\n",
