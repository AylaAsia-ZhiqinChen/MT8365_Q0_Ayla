...
#define MT6392_TOP_CKCON1_CLR     (PMIC_REG_BASE+0x012A)
#define MT6392_TOP_CKCON1         (PMIC_REG_BASE+0x0126)
#define MT6392_DEW_BASE           (0x018A)

#define MT6392_DEW_DIO_EN         (PMIC_REG_BASE+0x018A)
#define MT6392_DEW_READ_TEST      (PMIC_REG_BASE+0x018C)
#define MT6392_DEW_WRITE_TEST     (PMIC_REG_BASE+0x018E)
#define MT6392_DEW_CRC_SWRST      (PMIC_REG_BASE+0x0190)
#define MT6392_DEW_CRC_EN         (PMIC_REG_BASE+0x0192)
#define MT6392_DEW_CRC_VAL        (PMIC_REG_BASE+0x0194)
#define MT6392_DEW_DBG_MON_SEL    (PMIC_REG_BASE+0x0196)
#define MT6392_DEW_CIPHER_KEY_SEL (PMIC_REG_BASE+0x0198)
#define MT6392_DEW_CIPHER_IV_SEL  (PMIC_REG_BASE+0x019A)
#define MT6392_DEW_CIPHER_EN      (PMIC_REG_BASE+0x019C)
#define MT6392_DEW_CIPHER_RDY     (PMIC_REG_BASE+0x019E)
#define MT6392_DEW_CIPHER_MODE    (PMIC_REG_BASE+0x01A0)
#define MT6392_DEW_CIPHER_SWRST   (PMIC_REG_BASE+0x01A2)
#define MT6392_DEW_RDDMY_NO       (PMIC_REG_BASE+0x01A4)
#define MT6392_DEW_RDATA_DLY_SEL  (PMIC_REG_BASE+0x01A6)

#define MT6392_AUXADC_CON21       (PMIC_REG_BASE+0x076C)
#define MT6392_AUXADC_ADC12       (PMIC_REG_BASE+0x072C)
#define MT6392_AUXADC_ADC13       (PMIC_REG_BASE+0x072E)
#define MT6392_AUXADC_ADC14       (PMIC_REG_BASE+0x0730)

//-----PMIC_WRAP INT register for PMIC -------------------------------------------------
///////////////////////////////////////////////////////////////////////////////////////////

//-----macro for dewrapper defaule value-------------------------------------------------------
#define MT6392_DEFAULT_VALUE_READ_TEST      0x5aa5
#define MT6392_WRITE_TEST_VALUE       		0xa55a
