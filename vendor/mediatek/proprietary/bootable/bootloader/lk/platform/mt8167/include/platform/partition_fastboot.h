...
struct part_name_map g_part_name_map[] = {
	...
	{"boot_a",	"boot_a",	"raw data",	8,	1,	1},
	{"boot_b",	"boot_b",	"raw data",	9,	1,	1},
#else
...
#ifdef MTK_AB_OTA_UPDATER
	{"system_a",	"system_a",	"ext4",	18,	1,	1},
	{"system_b",	"system_b",	"ext4",	19,	1,	1},
	{"vendor_a",	"vendor_a",	"ext4",	23,	1,	1},
	{"vendor_b",	"vendor_b",	"ext4",	24,	1,	1},
#else
	{"system",	"system",	"ext4",	18,	1,	1},
	{"cache",	"cache",	"ext4",	19,	1,	1},
#endif
	{"userdata",	"userdata",	USERDATA_FS_TYPE,	20,	1,	1},
	{"intsd",	"intsd",	"fat",	21,	0,	0},
	{"frp",		"frp",		"raw data",	22,	0,	0},
	{"odmdtbo",	"odmdtbo",	"raw data",	23,	1,	1},
};
