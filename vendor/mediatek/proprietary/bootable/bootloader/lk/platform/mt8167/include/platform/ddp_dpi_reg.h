...
typedef struct {
	...
	unsigned rsv_26:6;
} DPI_REG_BLANK_CODE_SET, *PDPI_REG_BLANK_CODE_SET;
...
typedef struct {
	...
	unsigned rsv_29:3;
} DPI_REG_MATRIX_COEF_00, *PDPI_REG_MATRIX_COEF_00;
...
typedef struct {
	...
	unsigned rsv_29:3;
} DPI_REG_MATRIX_COEF_02, *PDPI_REG_MATRIX_COEF_02;
...
typedef struct {
	...
	unsigned rsv_29:3;
} DPI_REG_MATRIX_COEF_11, *PDPI_REG_MATRIX_COEF_11;
...
typedef struct {
	...
	unsigned rsv_29:3;
} DPI_REG_MATRIX_COEF_20, *PDPI_REG_MATRIX_COEF_20;

typedef struct {
	unsigned MATRIX_COEF_22:13;
	unsigned rsv_13:19;
} DPI_REG_MATRIX_COEF_22, *PDPI_REG_MATRIX_COEF_22;
...
typedef struct {
	...
	unsigned rsv_25:7;
} DPI_REG_MATRIX_IN_OFFSET_0, *PDPI_REG_MATRIX_IN_OFFSET_0;

typedef struct {
	unsigned MATRIX_IN_OFFSET_2:9;
	unsigned rsv_9:23;
} DPI_REG_MATRIX_IN_OFFSET_2, *PDPI_REG_MATRIX_IN_OFFSET_2;
...
typedef struct {
	...
	unsigned rsv_25:7;
} DPI_REG_MATRIX_OUT_OFFSET_0, *PDPI_REG_MATRIX_OUT_OFFSET_0;

typedef struct {
	unsigned MATRIX_IN_OFFSET_2:9;
	unsigned rsv_9:23;
} DPI_REG_MATRIX_OUT_OFFSET_2, *PDPI_REG_MATRIX_OUT_OFFSET_2;
...
typedef struct {
	...
	DPI_REG_BLANK_CODE_SET BLANK_CODE_SET;  /* 00b0*/
	DPI_REG_MATRIX_SET MATRIX_SET;  /* 00b4*/
	DPI_REG_MATRIX_COEF_00 MATRIX_COEF_00;  /* 00b8*/
	DPI_REG_MATRIX_COEF_02 MATRIX_COEF_02;  /* 00bc*/
	DPI_REG_MATRIX_COEF_11 MATRIX_COEF_11;  /* 00c0*/
	DPI_REG_MATRIX_COEF_20 MATRIX_COEF_20;  /* 00c4*/
	DPI_REG_MATRIX_COEF_22 MATRIX_COEF_22;  /* 00c8*/
	DPI_REG_MATRIX_IN_OFFSET_0 MATRIX_IN_OFFSET_0;  /* 00cc*/
	DPI_REG_MATRIX_IN_OFFSET_2 MATRIX_IN_OFFSET_2;  /* 00d0*/
	DPI_REG_MATRIX_OUT_OFFSET_0 MATRIX_OUT_OFFSET_0;    /* 00d4*/
	DPI_REG_MATRIX_OUT_OFFSET_2 MATRIX_OUT_OFFSET_2;    /* 00d8*/
	uint32_t rsv_dc;
...
typedef struct {
	...
	unsigned rsv_4: 28;
} LVDS_VPLL_REG_CTL3, *PLVDS_VPLL_REG_CTL3;
...
typedef struct {
	...
	LVDS_VPLL_REG_CTL3          VPLL_REG_CTL3;
