...
int ddp_enable_module_clock(DISP_MODULE_ENUM module)
{
	switch(module)
	{
		...
		case DISP_MODULE_PWM0:
			...
			break;
		case DISP_MODULE_DPI0:
			DISP_REG_SET_FIELD(NULL,MMSYS_CG_FLD_CG1_DPI0_PIX,DISP_REG_CONFIG_MMSYS_CG_CLR1,1);
			DISP_REG_SET_FIELD(NULL,MMSYS_CG_FLD_CG1_DPI0_ENG,DISP_REG_CONFIG_MMSYS_CG_CLR1,1);
			...
			break;
		case DISP_MODULE_DPI1:
			DISP_REG_SET_FIELD(NULL,MMSYS_CG_FLD_CG1_DPI1_PIX,DISP_REG_CONFIG_MMSYS_CG_CLR1,1);
			DISP_REG_SET_FIELD(NULL,MMSYS_CG_FLD_CG1_DPI1_ENG,DISP_REG_CONFIG_MMSYS_CG_CLR1,1);
			break;
...
int ddp_disable_module_clock(DISP_MODULE_ENUM module)
{
	switch(module)
	{
		...
		case DISP_MODULE_PWM0:
			...
			break;
		case DISP_MODULE_DPI0:
			DISP_REG_SET_FIELD(NULL,MMSYS_CG_FLD_CG1_DPI0_PIX,DISP_REG_CONFIG_MMSYS_CG_SET1,1);
			DISP_REG_SET_FIELD(NULL,MMSYS_CG_FLD_CG1_DPI0_ENG,DISP_REG_CONFIG_MMSYS_CG_SET1,1);
			break;
		case DISP_MODULE_DPI1:
			DISP_REG_SET_FIELD(NULL,MMSYS_CG_FLD_CG1_DPI1_PIX,DISP_REG_CONFIG_MMSYS_CG_SET1,1);
			DISP_REG_SET_FIELD(NULL,MMSYS_CG_FLD_CG1_DPI1_ENG,DISP_REG_CONFIG_MMSYS_CG_SET1,1);
			break;
		case DISP_MODULE_MUTEX:
			// no CG
			break;
