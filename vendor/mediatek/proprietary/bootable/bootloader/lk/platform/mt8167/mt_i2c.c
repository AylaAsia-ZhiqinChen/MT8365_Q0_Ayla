...
static void mt_i2c_clock_enable(mt_i2c *i2c)
{
  mt_reg_sync_writel((DRV_Reg32(0x10001080) & (~(0x7 << 1))), 0x10001080);

  switch(i2c->id)
  {
    case 0:
      mt_reg_sync_writel((0x1 << 3), 0x10000084);
      break;
    case 1:
      mt_reg_sync_writel((0x1 << 4), 0x10000084);
      break;
    case 2:
      mt_reg_sync_writel((0x1 << 16), 0x10000084);
      break;
    default:
      I2CERR("enable i2c clk, invalid para: i2c->id=%d\n",i2c->id);
      break;
  }
}
...
static void mt_i2c_clock_disable(mt_i2c *i2c)
{
  ...
  {
    case 0:
      mt_reg_sync_writel((0x1 << 3), 0x10000054);
      break;
    case 1:
      mt_reg_sync_writel((0x1 << 4), 0x10000054);
      break;
    case 2:
      mt_reg_sync_writel((0x1 << 16), 0x10000054);
      break;
    default:
      I2CERR("disable i2c clk, invalid para: i2c->id=%d\n",i2c->id);
      break;
  }
}
...
void _i2c_dump_info(mt_i2c *i2c)
{
  ...
  I2CERR("I2C structure:\n"
    I2CTAG"Clk=%d,Clock_div=%d,Id=%d,Mode=%x,St_rs=%x,Dma_en=%x,Op=%x,Poll_en=%x,Irq_stat=%x\n"
    I2CTAG"Trans_len=%x,Trans_num=%x,Trans_auxlen=%x,Data_size=%x,speed=%d\n",
    //,Trans_stop=%u,Trans_comp=%u,Trans_error=%u\n"
    i2c->clk,i2c->clock_div,i2c->id,i2c->mode,i2c->st_rs,i2c->dma_en,i2c->op,i2c->poll_en,i2c->irq_stat,
