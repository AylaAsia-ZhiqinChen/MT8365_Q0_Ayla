...
public class CallerInfoLookupHelper {
    ...
    public void startLookup(final Uri handle, OnQueryCompleteListener listener) {
        /// M: for compliance
        startLookup(handle, listener, SubscriptionManager.INVALID_SUBSCRIPTION_ID);
    }

    /**
     * M: [Voicemail] need a subId to query whether a number is the voicemail number
     * of the calling SIM. Otherwise the Non-default SIM's voicemail number can't
     * be queried out correctly.
     */
