...
public class StatusBarNotifier extends CallsManagerListenerBase {
     ...
     * Check whether mute icon is showing in status bar.
     * @return true if mute icon is showing in status bar.
     */
    public boolean isStatusBarShowingMute() {
        return mIsShowingMute;
    }

    /**
     * M: ALPS03972502, fix issue speaker icon is not shown in status bar. @{
     * Check whether speaker icon is showing in status bar.
     * @return true if speaker icon is showing in status bar.
     */
    public boolean isStatusBarShowingSpeaker() {
        return mIsShowingSpeakerphone;
    }
