...
public class TelecomService extends Service implements TelecomSystem.Component {
    ...
    public IBinder onBind(Intent intent) {
        Log.d(this, "onBind");
        /// M: Create MtkTelecomGlobals instance.
        MtkTelecomGlobals.createInstance(getApplicationContext());
        initializeTelecomSystem(this);
        /// M: Create MtkTelecomServiceImpl. @{
        new MtkTelecomServiceImpl(getApplicationContext(),
                getTelecomSystem().getCallsManager(),
                getTelecomSystem().getPhoneAccountRegistrar(),
                (TelecomSystem.SyncRoot) getTelecomSystem().getLock());
        /// M: @}
                            ...
                            new CallerInfoAsyncQueryFactory() {
                                ...
                                public CallerInfoAsyncQuery startQuery(
                                    ...
                                    Log.i(TelecomSystem.getInstance(),
                                            "CallerInfoAsyncQuery.startQuery number=%s cookie=%s" +
                                                    " subId=%s",
                                            Log.pii(number), cookie, subId);
                                    return MtkCallerInfoAsyncQuery.startQuery(
