...
class InCallAdapter extends IInCallAdapter.Stub {
    ...
    /// M: Implementation of ICommandProcessor interface. @{
    private final MtkTelecomHelper.MtkInCallAdapterHelper.ICommandProcessor mCommandProcessor =
        ...
        // DSDA mode, hangup active call and answer waiting call.
        @Override
        ...
        // DSDA mode, Set forground incoming call.
        @Override
        ...
        // Reject call with special cause.
        @Override
        public void rejectWithCause(String callId, int cause) {
            try {
                Log.startSession("ICA.rWC");
                long token = Binder.clearCallingIdentity();
                try {
                    synchronized (mLock) {
                        Call call = mCallIdMapper.getCall(callId);
                        call.rejectWithCause(call, cause);
                    }
                } finally {
                    Binder.restoreCallingIdentity(token);
                }
