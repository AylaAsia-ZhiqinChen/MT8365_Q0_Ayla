...
public class ProximitySensorManager extends CallsManagerListenerBase {
    ...
    public void onCallRemoved(Call call) {
        ...
        if (mCallsManager.getCalls().isEmpty()) {
            ...
            /// M: for ALPS1873375, ALPS1873517. InCallUI app would not turn on
            // screen while covering up proximity sensor after hanging up the calls. For
            // reach to a consistent behavior, it is sensible to make Telecom same as
            // InCallUI. google code:turnOff(true);
            turnOff(false);
        }
