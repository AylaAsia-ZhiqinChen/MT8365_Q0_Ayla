...
public class BluetoothRouteManager extends StateMachine {
    ...
    /**
     * M: ALPS04650690, for HFP, get active device from BluetoothHeadset directly.
     *
    ...
    public String getCurrentActiveDeviceAddress() {
        ...
        if (bluetoothHeadset != null) {
            ...
            if (hfpActiveDevice != null) {
                Log.i(this, "getCurrentActiveDeviceAddress : %s", hfpActiveDevice.getAddress());
                return hfpActiveDevice.getAddress();
            }
        }
