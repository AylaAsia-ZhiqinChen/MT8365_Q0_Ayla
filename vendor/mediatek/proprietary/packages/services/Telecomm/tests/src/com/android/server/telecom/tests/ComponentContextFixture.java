...
public class ComponentContextFixture implements TestFixture<Context> {
    ...
    public class FakeApplicationContext extends MockContext {
        /// M: Add for CallRecorderManagerTest to bind/unbind real callRecorderService. @{
        private ServiceConnection mConnectionByRecorderService;
        /// @}
        /// M: Fit for add call recorder confirm dialog feature. Mock related preference
        // then start voice record will not be blocked.@{
        ...
        public boolean bindServiceAsUser(
            ...
            /// M: Bind real callRecorderService for CallRecorderManagerTest. @{
            if (serviceIntent.getComponent().equals(new ComponentName(
                    "com.mediatek.callrecorder",
                    "com.mediatek.callrecorder.CallRecorderService"))) {
                mConnectionByRecorderService = connection;
                return mAppContext.bindServiceAsUser(serviceIntent, connection, flags, userHandle);
            }
            /// @}
        ...
        public void unbindService(
                ServiceConnection connection) {
            /// M: Unbind real callRecorderService for CallRecorderManagerTest. @{
            if (connection == mConnectionByRecorderService) {
        ...
        public Object getSystemService(String name) {
            switch (name) {
                ...
                case Context.ROLE_SERVICE:
                    return mRoleManager;
                /*
                 * M: Fix auto test JE casued by Toast.show.
                 * CallLogManager will show call duration toast when disconnect call, and
                 * Toast.show() will get a null pointer exception when getting LayoutInfalter.
                 */
        ...
        /// M: Fix auto test JE casued by Toast.show.
        // CallLogManager will show call duration toast when disconnect call, and Toast.show()
        // will exception when call context.getDisplayId().
        @Override
        public int getDisplayId() {
            return mAppContext.getDisplayId();
        }
        /// @}
        ...
        /// M: Add for MTK performance enhancement ALPS03855709 @{
        @Override
        public void sendBroadcastAsUser(Intent intent, UserHandle userHandle,
                String receiverPermission) {
            // TODO -- do we need to ensure this is captured?
        }
        /// @}

        /// M: Fit for add call recorder confirm dialog feature.
        // Mock sharedPreferences which will be used in start recording show alert dialog. @{
        @Override
    ...
    /// M: Save real context, fix show Toast JE. @{
