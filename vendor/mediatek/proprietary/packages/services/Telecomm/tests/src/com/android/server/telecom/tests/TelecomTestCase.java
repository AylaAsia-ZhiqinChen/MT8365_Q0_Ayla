...
public abstract class TelecomTestCase {
    ...
    public void setUp() throws Exception {
        ...
        /// M: Initialize MtkTelecomGlobals before test.
        MtkTelecomGlobals.createInstance(InstrumentationRegistry.getContext());
        /// M: Save real context, fix show Toast JE.
        mComponentContextFixture.setAppContext(InstrumentationRegistry.getContext());
