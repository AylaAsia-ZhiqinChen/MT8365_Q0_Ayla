...
public class ImsCallPluginImpl extends ImsCallPluginBase {
    ...
    public int setImsFwkRequest(int request) {
        ...
        return (request | MtkImsPhoneCallTracker.IMS_SESSION_MODIFY_OPERATION_FLAG);
    }
    ...
    public boolean isImsFwkRequest(int request) {
        ...
        if ((request & MtkImsPhoneCallTracker.IMS_SESSION_MODIFY_OPERATION_FLAG) == MtkImsPhoneCallTracker.IMS_SESSION_MODIFY_OPERATION_FLAG) {
            return true;
        } else {
            return false;
        }
    ...
    public int getUpgradeCancelFlag() {
        return MtkVideoProfile.STATE_CANCEL_UPGRADE;
    }
