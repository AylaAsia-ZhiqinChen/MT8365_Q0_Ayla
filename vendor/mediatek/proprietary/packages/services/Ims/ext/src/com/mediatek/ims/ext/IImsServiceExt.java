...
/** Interface for ImsService plugin.
 */
public interface IImsServiceExt {
     ...
     */
    void notifyImsServiceEvent(int phoneId, Context context, Message msg);

    /**
     * Notify registrationStateChange.
     *
     * @param ran ims RAN type
     * @param handler ImsService main handler
     * @param imsRILAdapter ImsRILAdapter instance
     * @return
     */
    void notifyRegistrationStateChange(int ran, Handler handler, Object imsRILAdapter);
