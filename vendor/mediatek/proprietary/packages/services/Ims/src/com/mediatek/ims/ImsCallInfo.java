...
public class ImsCallInfo {
    ...
    //***** Constructors
    public ImsCallInfo(String callId, String callNum, boolean isConference, boolean isConferenceHost,
                       boolean isVideo, boolean isEcc, State state, ImsCallSessionProxy callSession) {
