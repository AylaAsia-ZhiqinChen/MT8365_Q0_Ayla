...
/**
 * This interface of IMS Plugin for OEM/Customer logic
 */
public class LegacyComponentFactoryBase implements LegacyComponentFactory {

    /**
     * Make a instance of ImsUtImpl object
     * @return Instance of ImsUtImplBase
     */
    @Override
    public ImsUtImplBase makeImsUt(Context context,
                                   int phoneId,
     ...
     */
    @Override
    public MtkImsUtImplBase makeMtkImsUt(Context context,
                                   int phoneId,
                                   ImsService imsService) {
        return null;
    }
