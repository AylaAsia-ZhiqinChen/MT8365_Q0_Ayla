    ...
    */
    ...
    private static int toTelecomDisconnectCauseCode(int telephonyDisconnectCause) {
        switch (telephonyDisconnectCause) {
            ...
            ///M: WFC @{
            case mediatek.telephony.MtkDisconnectCause.WFC_WIFI_SIGNAL_LOST:
            case mediatek.telephony.MtkDisconnectCause.WFC_ISP_PROBLEM:
            case mediatek.telephony.MtkDisconnectCause.WFC_HANDOVER_WIFI_FAIL:
            case mediatek.telephony.MtkDisconnectCause.WFC_HANDOVER_LTE_FAIL:
            case mediatek.telephony.MtkDisconnectCause.WFC_UNAVAILABLE_IN_CURRENT_LOCATION:
            case mediatek.telephony.MtkDisconnectCause.ECC_OVER_WIFI_UNSUPPORTED:
            case mediatek.telephony.MtkDisconnectCause.WFC_CALL_DROP_BACKHAUL_CONGESTION:
            case mediatek.telephony.MtkDisconnectCause.WFC_CALL_DROP_BAD_RSSI:
                  return mediatek.telecom.MtkDisconnectCause.WFC_CALL_ERROR;
            /// @}
            ...
            case mediatek.telephony.MtkDisconnectCause.VOLTE_SS_DATA_OFF:
                return DisconnectCause.ERROR;
            /// @}
    ...
    private static CharSequence getLabelFromDisconnectCause(
        ...
        switch (telephonyDisconnectCause) {
            ...
            case mediatek.telephony.MtkDisconnectCause.WFC_HANDOVER_LTE_FAIL:
                ...
                break;
            case mediatek.telephony.MtkDisconnectCause.WFC_CALL_DROP_BAD_RSSI:
                resourceId = R.string.wfc_wifi_call_drop_bad_rssi;
                break;
            case mediatek.telephony.MtkDisconnectCause.WFC_CALL_DROP_BACKHAUL_CONGESTION:
                resourceId = R.string.wfc_wifi_call_drop_backhaul_congestion;
            /// @}
        ...
        switch (telephonyDisconnectCause) {
            ...
            case android.telephony.DisconnectCause.POWER_OFF:
                ...
                if (ImsUtil.shouldPromoteWfc(context, phoneId)) {
                    ...
                    /// M: CC: Modem reset related handling [ALPS01808788] @{
            ...
            case mediatek.telephony.MtkDisconnectCause.WFC_HANDOVER_LTE_FAIL:
                ...
                break;
            case mediatek.telephony.MtkDisconnectCause.WFC_UNAVAILABLE_IN_CURRENT_LOCATION:
                resourceId = R.string.wfc_wifi_call_drop_unavailable_in_current_location;
                break;
            case mediatek.telephony.MtkDisconnectCause.ECC_OVER_WIFI_UNSUPPORTED:
                resourceId = R.string.wfc_wifi_call_drop_ecc_over_wifi_unsupported;
                break;
            case mediatek.telephony.MtkDisconnectCause.WFC_CALL_DROP_BAD_RSSI:
                resourceId = R.string.wfc_wifi_call_drop_bad_rssi;
                break;
