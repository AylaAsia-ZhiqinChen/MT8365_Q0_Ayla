...
public class OtaspSimStateReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(CarrierConfigManager.ACTION_CARRIER_CONFIG_CHANGED.equals(intent.getAction())) {
            ...
            /// M: Debug info @{
            final Phone phone = PhoneGlobals.getPhone();
            boolean isIccRecordLoaded = phone.getIccRecordsLoaded();
            logd("getIccRecordsLoaded: " + isIccRecordLoaded + " for phone: " + phone.getPhoneId());
            if (isIccRecordLoaded && isCarrierSupported()) {
                logd("Listen Otasp for sudId: " + phone.getSubId());
            /// @}
