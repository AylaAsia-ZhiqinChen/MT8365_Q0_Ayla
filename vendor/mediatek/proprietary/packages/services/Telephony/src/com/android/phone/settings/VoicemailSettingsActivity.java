...
public class VoicemailSettingsActivity extends PreferenceActivity
    ...
    protected void onCreate(Bundle icicle) {
        ...
        /// M: Get the subscription ID. @{
        log("onCreate subId: " + mSubscriptionInfoHelper.getSubId());
        /// @}
        ...
        /// M: Get list entry value before dialog onPrepareDialogBuilder called. @{
    ...
    protected void onResume() {
        ...
        final Dialog dialog = ((PreferenceScreen) mVoicemailSettings).
        getDialog();
        if (dialog != null) {
    ...
    private void saveVoiceMailAndForwardingNumber(
        ...
        /// M: Print voiceNumber @{
        CallSettingUtils.sensitiveLog(LOG_TAG, "saveVoiceMailAndForwardingNumber: ",
    ...
    private void setVoicemailNumberWithCarrier() {
        ...
        /// M: Print voiceNumber @{
        CallSettingUtils.sensitiveLog(LOG_TAG, "save voicemail #: ", mNewVMNumber);
        /// }@
    ...
    private void updateVoiceNumberField() {
        ...
        /// M: Print voiceNumber @{
        CallSettingUtils.sensitiveLog(LOG_TAG, "updateVoiceNumberField(), mOldVmNumber = ",
                mOldVmNumber);
        /// }@
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        log("onConfigurationChanged: shouldDismissDialog=" + shouldDismissDialog +
                ", mForeground=" + mForeground);
        if (shouldDismissDialog && !mForeground) {
            Dialog dialog = mSubMenuVoicemailSettings.getDialog();
            if (dialog != null && dialog.isShowing()) {
                log("onConfigurationChanged: showPhoneNumberDialog");
                dialog.dismiss();
