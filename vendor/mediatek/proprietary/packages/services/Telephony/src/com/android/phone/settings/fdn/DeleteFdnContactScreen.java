...
public class DeleteFdnContactScreen extends Activity {
    ...
    /// M: ALPS03617694. @{
    private static final String PIN2_REQUEST_STATE = "state";
    /// @}
    ...
    protected void onCreate(Bundle icicle) {
        ...
        resolveIntent();
        /// M: ALPS03617694. If it has shown the Pin2 dialog, do not show the dialog again.  @{
        boolean hasShownPin2Dialog = ((icicle != null) &&
                (true == icicle.getBoolean(PIN2_REQUEST_STATE)));
        if (!hasShownPin2Dialog) {
            authenticatePin2();
        }
        // authenticatePin2();
        /// @}
    ...
    private void resolveIntent() {
        ...
        /** M: Removed for ALPS01775203
         * When the contact's number is null will not be deleted successfully. @{
    ...
    /// M: ALPS03617694. Implement to support onSaveInstanceState. @{
    /**
     * To retrieve per-instance state from an activity.
     *
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean(PIN2_REQUEST_STATE, mHasShownPin2Dialog);
    }
    /// @}
