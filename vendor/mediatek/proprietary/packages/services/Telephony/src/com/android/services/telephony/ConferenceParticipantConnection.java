...
public class ConferenceParticipantConnection extends Connection {
    ...
    public ConferenceParticipantConnection(
        ...
        /// it checks if VOLTE property is changed to know SRVCC happened. (For Legacy MD only)
        ...
        properties |= MtkConnection.PROPERTY_VOLTE;
        /// Append PROPERTY_CONFERENCE_PARTICIPANT for conference participant
        properties |= MtkConnection.PROPERTY_CONFERENCE_PARTICIPANT;
