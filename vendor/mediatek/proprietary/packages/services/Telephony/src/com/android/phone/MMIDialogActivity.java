    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mPhone == null) {
            Log.w(TAG, "onCreate: invalid subscription id (" + subId + ") lead to null"
                    + " Phone.");
            finish();
            /// M: ALPS03857421. Fix null pointer exception.@{
            //  Cannot get valid phone in some special case.
            //  Call mPhone.getState() occur NullPointerException when mPhone equls null.
            return;
            /// @}
        }
