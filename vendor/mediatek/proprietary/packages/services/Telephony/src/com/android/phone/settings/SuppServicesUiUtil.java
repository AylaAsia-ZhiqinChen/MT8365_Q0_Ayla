...
public class SuppServicesUiUtil {
    ...
    public static boolean isSsOverUtPrecautions(Context context, Phone phone) {
        ...
        if (phone == null || context == null || MtkImsManager.isSupportMims()) {
        /// @}
            return false;
        }
    ...
    /**
     * Check SS over Ut precautions in condition which is
     * "support multiple ims".
     * "mobile data button is off".
     * "The subId is not the default data subId".
     *
     * @param context The context.
     * @param phone   The Phone object.
     * @return true if all the conditions are satisfied.
     */
    public static boolean isSsOverUtPrecautionsExt(Context context, Phone phone) {
        boolean result = false;
        if (phone == null || context == null || !MtkImsManager.isSupportMims()) {
            return result;
        }
        if (isMobileDataOff(context, phone)) {
            Log.d(LOG_TAG, "Mobile data off");
            result = true;
            return result;
        }
        int defaultDataSubId = SubscriptionManager.getDefaultDataSubscriptionId();
        int subId = phone.getSubId();
        Log.d(LOG_TAG, "The defaultDataSubId: " + defaultDataSubId + ", subId: " + subId);
     ...
     * Check SS over Ut precautions in condition which is
     * "support multiple ims".
     * "Roaming button is off during roaming".
     * "The subId is not the default data subId".
     *
     * @param context The context.
     * @param phone   The Phone object.
     * @return true if all the conditions are satisfied.
     */
    public static boolean isSsOverUtPrecautionsRoaming(Context context, Phone phone) {
        boolean result = false;
        if (phone == null || context == null || !MtkImsManager.isSupportMims()) {
            return result;
        }
        if (isDataRoamingOffUnderRoaming(context, phone)) {
            Log.d(LOG_TAG, "Mobile data roaming off");
            result = true;
        }
        return result;
    }
