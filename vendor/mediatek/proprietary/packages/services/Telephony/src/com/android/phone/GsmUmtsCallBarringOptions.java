...
public class GsmUmtsCallBarringOptions extends TimeConsumingPreferenceActivity
        implements EditPinPreference.OnPinEnteredListener, PhoneGlobals.SubInfoUpdateListener {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        /// M: Add call barring title with sim label @{
        ...
        /// M: Enable disable all and password items by default for CSFB case.
        /// And those two items can't refresh when ims service state is changed. @{
