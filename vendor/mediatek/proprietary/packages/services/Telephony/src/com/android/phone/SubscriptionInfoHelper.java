...
public class SubscriptionInfoHelper {
    ...
    public SubscriptionInfoHelper(Context context, Intent intent) {
        ...
        ///M: Get label from SubscriptionInfo for system language changed.
        getSubLabel();
        log("SubscriptionInfoHelper: mSubId = " + mSubId
                + "; mSubLabel = " + mSubLabel);
    }
    ...
    ///--------------------MTK---------------------
    public static final int NO_SUB_ID = SubscriptionManager.INVALID_SUBSCRIPTION_ID;
