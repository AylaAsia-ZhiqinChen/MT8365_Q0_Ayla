...
public class TimeConsumingPreferenceActivity extends PreferenceActivity
    ...
    protected Dialog onCreateDialog(int id) {
        /// M: Do not create dialog in background according to AOSP design. @{
    ...
    public void onResume() {
        super.onResume();
        mIsForeground = true;
        /// M: Show dialog if activity has pending dialog in background. @{
        Log.d(LOG_TAG, "onResume mPendingDialogId:" + mPendingDialogId);
        if (mPendingDialogId != INVALID_DIALOG) {
            showDialog(mPendingDialogId);
            mPendingDialogId = INVALID_DIALOG;
        }
        /// @}
    }
    ...
    private int mPendingDialogId = INVALID_DIALOG;
