...
public class CdmaVoicePrivacySwitchPreference extends SwitchPreference {
    ...
    private class MyHandler extends Handler {
        ...
        private void handleSetVPResponse(Message msg) {
            ...
            if (ar.exception != null) {
                ...
                ///M: Set original check state if there is exception
    ...
    // -------------------------------MTK--------------------------
    /**
     * Set the right cdma phone instance.
     * @param phone The right phone instance
     */
    public void setPhone(Phone phone) {
        this.phone = phone;
        (this.phone).getEnhancedVoicePrivacy(mHandler.obtainMessage(MyHandler.MESSAGE_GET_VP));
    }
}
