...
public class AtciIntentReceiver extends BroadcastReceiver {
    ...
    static final String ATCI_AUTO_START = "persist.vendor.service.atci.autostart";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(BOOTUP)) {
            if (buildType.equals("eng") || isAutoStart.equals("1")) {
                Log.d(LOG_TAG, "Start AtciService on bootComplete");
                context.startForegroundService(new Intent(context, AtciService.class));
            } else {
                // For low RAM project. Ensure process terminated.
                Log.d(LOG_TAG, "Exit process");
                System.exit(0);
            }
        } else {
