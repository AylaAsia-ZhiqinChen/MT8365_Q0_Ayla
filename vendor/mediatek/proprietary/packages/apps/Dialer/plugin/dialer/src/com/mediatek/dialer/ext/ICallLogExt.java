...
public interface ICallLogExt {
  ICallLogActivityExt getCallLogActivityExt(Activity activity);
  ICallLogAdapterExt getCallLogAdapterExt(Activity activity, RecyclerView.Adapter adapter);
  ICallLogFragmentExt getCallLogFragmentExt(
          Fragment fragment, boolean isCallLogActivity,
          int callTypeFilter, Consumer<Boolean> forceFresh);
  ICallLogQueryHandlerExt getCallLogQueryHandlerExt(Context context);
  ICallLogListItemViewHolderExt getCallLogListItemViewHolderExt(
