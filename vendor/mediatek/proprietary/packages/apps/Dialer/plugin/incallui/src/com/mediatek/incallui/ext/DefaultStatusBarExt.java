...
/**
 * Default implementation for IStatusBarExt.
 */
public class DefaultStatusBarExt implements IStatusBarExt {
   ...
   */
  @Override
  public void customizeNotification(Builder builder, Bitmap icon) {
    // do nothing
  }
   ...
   */
  @Override
  public String getContentTitle(Object obj, String contentTitle) {
    return contentTitle;
  }
}