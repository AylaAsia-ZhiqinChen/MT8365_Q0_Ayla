...
public class InCallCameraManager {
  ...
  private String FAKE_FRONT_FACING_CAMERA_ID = "1";
  private String FAKE_REAR_FACING_CAMERA_ID = "0";
  /// @}
  ...
  private void maybeInitializeCameraList(Context context) {
    ...
    if (InCallUtils.MTK_NO_CAMERA_MODE) {
      Log.v(this, "initializeCameraList, set fake camera id in no camera mode.");
