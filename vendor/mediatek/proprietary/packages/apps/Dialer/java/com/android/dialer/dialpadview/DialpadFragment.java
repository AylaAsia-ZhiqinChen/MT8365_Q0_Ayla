...
public class DialpadFragment extends Fragment
  ...
  public void onCreate(Bundle state) {
    ...
    LogUtil.i("DialpadFragment.onCreate()", "start ...");
    ...
    initPhoneNumberFormattingTextWatcherExecutor =
        DialerExecutorComponent.get(getContext())
            ...
            .build();
    Trace.endSection();
    LogUtil.i("DialpadFragment.onCreate()", "end ...");
  }

  /**
   * M: for op01 speed dial plug-in, init customer view.
   */
  @Override
  public void onViewCreated(View view, Bundle savedInstanceState) {
      Trace.beginSection(TAG + " onViewCreated init plugin");
      LogUtil.i("DialpadFragment.onViewCreated()", "start ...");
      ExtensionManager.getDialPadExtension().onViewCreated(getActivity(), view);
      Trace.endSection();
      LogUtil.i("DialpadFragment.onViewCreated()", "end ...");
  }

  @Override
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedState) {
    LogUtil.i("DialpadFragment.onCreateView()", "start ...");
    ...
    SpecialCharSequenceMgr.updateTextFieldView(digits);

    Trace.endSection();
    Trace.endSection();
    LogUtil.i("DialpadFragment.onCreateView()", "end ...");
    return fragmentView;
  }
  ...
  public void onStart() {
    ...
    Trace.endSection();
    LogUtil.i("DialpadFragment.onStart", "end ...");
  }

  @Override
  public void onResume() {
    LogUtil.enterBlock("DialpadFragment.onResume");
    LogUtil.i("DialpadFragment.onResume", "start ...");
    ...
    firstLaunch = false;
    Trace.endSection();
    LogUtil.i("DialpadFragment.onResume", "end ...");
  }
  ...
  public void onPressed(View view, boolean pressed) {
    ///M: add for ALPS03759479, if the dialpad is slding, it shouldn't
    ///do anything when press keyboard @{
    //if (!((DialtactsActivity) getActivity()).isDialpadShown()) {
    //    LogUtil.i("DialpadFragment.onPressed", "isDialpadSliding or not shown, return");
    //    return;
    //}
    /// @}
    if (pressed) {
      LogUtil.i("DialpadFragment.onPressed", "pressed = " + pressed);
      ...
      if (pressedDialpadKeys.isEmpty()) {
        LogUtil.i("DialpadFragment.onPressed", "stopTone()");
        stopTone();
      }
    }
  }
  ...
  public void onClick(View view) {
    ...
    if (resId == R.id.dialpad_floating_action_button) {
      ...
      /// M: for plug-in @{   ///Remove OP03
     //ExtensionManager.getDialPadExtension().constructPopupMenu(
     //               overflowPopupMenu, overflowMenuButton, overflowPopupMenu.getMenu());
    /// @}
  ...
  private void playTone(int tone, int durationMs) {
    ...
    synchronized (toneGeneratorLock) {
      ...
      LogUtil.i("DialpadFragment.playTone", "toneGenerator.startTone ");
  ...
  public void onHiddenChanged(boolean hidden) {
    ...
    if (!hidden && !isDialpadChooserVisible()) {
      ...
      ///M: need to clearup ADN query when dialpadFragment is hidden.
      SpecialCharSequenceMgr.cleanup();
    }
  }
  ...
  public void slideDown(boolean animate, AnimationListener listener) {
    ...
    floatingActionButtonController.scaleOut();
    LogUtil.i(TAG, "dialpad slideDown and fab scaleOut");
  }
    ...
    slideUp.setAnimationListener(
        new AnimationListener() {
          ...
          public void onAnimationEnd(Animation animation) {
            floatingActionButtonController.scaleIn();
            LogUtil.i(TAG, "dialpad slideup and fab scaleIn");
          }
  ...
  private ContentObserver mCallLogObserver = new ContentObserver(new Handler()) {
    public void onChange(boolean selfChange) {
      if (DialpadFragment.this.isAdded()) {
        LogUtil.i(TAG, "Observered the CallLog changes. queryLastOutgoingCall");
        queryLastOutgoingCall();
      }
    };
  };
  ...
  private void updateWfcUI() {
    if (floatingActionButtonController != null && DialerCompatEx.isWfcCompat()) {
      //default iconId
      int iconId = R.drawable.quantum_ic_call_vd_theme_24;
      ...
      if (defaultAccountHandle != null) {
        ...
        if (phoneAccount != null) {
          ...
          if (wfcCapability) {
            iconId = R.drawable.mtk_fab_ic_wfc;
            LogUtil.d(TAG, "[WFC] Dial Icon is changed to WFC dial icon");
          }
        }
      }
      floatingActionButtonController.changeIcon(
          getContext(), iconId, getResources().getString(R.string.description_dial_button));
    }
  }
