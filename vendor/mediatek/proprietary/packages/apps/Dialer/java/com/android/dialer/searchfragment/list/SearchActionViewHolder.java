...
final class SearchActionViewHolder extends RecyclerView.ViewHolder implements OnClickListener {
  ...
  ///M: Plug-in for op07,op08,op12 vedio call customzition
  ...
  SearchActionViewHolder(View view, RowClickListener listener) {
    ...
    ///M: Plug-in  for op07,op08,op12 vedio call customzition
    searchActionViewHolderExt = ExtensionManager.getDialerSearchExtension()
        .getSearchActionViewHolderExt(context);
    /// @}
  }
  ...
  void setAction(@Action int action, int position, String query) {
    ...
    switch (action) {
      case Action.ADD_TO_CONTACT:
        ...
        actionImage.setImageResource(R.drawable.quantum_ic_person_vd_theme_24);
        break;
      ...
      case Action.MAKE_VOICE_CALL:
        ...
        break;
      /// M: RTT @{
      case Action.MAKE_RTT_CALL:
        actionText.setText(context.getString(R.string.search_shortcut_make_rtt_call, query));
        actionImage.setImageResource(R.drawable.quantum_ic_rtt_vd_theme_24);
        break;
      /// @}
      case Action.INVALID:
      default:
    ...
    ///M: Plug-in  for op07,op08,op12 vedio call customzition
    searchActionViewHolderExt.setAction(actionImage, actionText, query, action);
  }
  ...
  public void onClick(View v) {
    switch (action) {
      ...
      /// M: RTT @{
      case Action.MAKE_RTT_CALL:
       LogUtil.i("SearchActionViewHolder", "placeRTTCall");
       listener.placeRTTCall(query, position);
        break;
      /// @}
      case Action.INVALID:
      default:
