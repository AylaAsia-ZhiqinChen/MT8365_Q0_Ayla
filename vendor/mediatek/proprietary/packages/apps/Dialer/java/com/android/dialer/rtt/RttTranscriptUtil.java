...
public final class RttTranscriptUtil {
  ...
  @WorkerThread
  public static int deleteRttTranscript(Context context, ImmutableSet<String> transcriptIds) {
    RttTranscriptDatabaseHelper databaseHelper = new RttTranscriptDatabaseHelper(context);
  ...
  public static int clearAllRttTranscript(Context context) {
    ...
    int count = deleteRttTranscript(context, builder.build());
    LogUtil.i("RttTranscriptUtil.clearAllRttTranscript ",  "deleted count :" + count);
    return count;
  }
  /// @}
}
