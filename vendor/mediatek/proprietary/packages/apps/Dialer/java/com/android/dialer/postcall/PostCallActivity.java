...
public class PostCallActivity extends AppCompatActivity implements MessageFragment.Listener {
  ...
  public static final String KEY_SUB_ID = "sub_id";//M:add
  ...
  public static Intent newIntent(
    ...
    intent.putExtra(KEY_SUB_ID, subId);//M:add
    return intent;
  }
  ...
  public void onMessageFragmentSendMessage(@NonNull String message) {
    ...
    int subId = getIntent().getIntExtra(KEY_SUB_ID, -1);///M:add
    Assert.checkArgument(subId > 0);///M:add
