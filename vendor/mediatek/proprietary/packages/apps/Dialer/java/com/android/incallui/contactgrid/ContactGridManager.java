  ...
  private void updateBottomRow() {
    ...
    if (hdIconImageView.getVisibility() == View.GONE) {
      if (info.isHdAttemptingIconVisible) {
        ...
        LogUtil.d("ContactGridManager.updateBottomRow", "Start to show hd icon.");
        /// M: ALPS04023087, There is the case the activated status of imageview is wrong after
        /// answer incoming conference call. It show circular image view instead of rectangle view.
        /// Just use the hd drawable to show. @{
        /// Google code: hdIconImageView.setImageResource(R.drawable.asd_hd_icon);
    ...
    /// M: ALPS03416255 Show connect time only when primaryCallState.connectTimeMillis > 0 @{
