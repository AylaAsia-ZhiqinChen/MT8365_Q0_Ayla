...
public class CallLogCache {
  ...
  private final Map<PhoneAccountHandle, String> phoneAccountVoiceMailNumber = new ArrayMap<>();
  ...
  public synchronized void reset() {
    ...
    phoneAccountVoiceMailNumber.clear();
  ...
  public /*synchronized*/  boolean isVoicemailNumber(
    ...
    if (phoneAccountVoiceMailNumber.containsKey(accountHandle)) {
        voiceNumber = phoneAccountVoiceMailNumber.get(accountHandle);
    } else {
        synchronized(this) {
            voiceNumber = TelecomUtil.getVoicemailNumber(context, accountHandle);
            phoneAccountVoiceMailNumber.put(accountHandle, voiceNumber);
        }
    }
