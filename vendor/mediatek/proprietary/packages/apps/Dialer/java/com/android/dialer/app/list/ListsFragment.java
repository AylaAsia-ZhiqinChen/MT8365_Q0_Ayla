...
public class ListsFragment extends Fragment
  ...
  public void onCreate(Bundle savedInstanceState) {
    LogUtil.i("ListsFragment.onCreate", "start ...");
    ...
    LogUtil.i("ListsFragment.onCreate", "end ...");
  }

  @Override
  public void onResume() {
    LogUtil.enterBlock("ListsFragment.onResume");
    LogUtil.i("ListsFragment.onResume", "start ...");
    ...
    LogUtil.i("ListsFragment.onResume", "end ...");
  }
  ...
  public View onCreateView(
    ...
    Trace.traceBegin(Trace.TRACE_TAG_VIEW, "ListsFragment.onCreateView");
    ...
    Trace.endSection();
    Trace.endSection();
    LogUtil.i("ListsFragment.onCreateView", "end ...");
    Trace.traceEnd(Trace.TRACE_TAG_VIEW);
    return parentView;
  }
