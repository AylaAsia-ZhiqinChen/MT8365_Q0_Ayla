...
abstract class CallDetailsActivityCommon extends AppCompatActivity {
  ...
  /// M: check all permission about phone
  private static final String[] READ_CALL_LOG = PermissionsUtil.PHONE_FULL_GROUP;

  /// M:for op01/op07/op08/op12 video call customization.
  public ICallDetailsActivityExt callDetailsActivityExt;
  /**
  ...
  protected void onResume() {
    ...
    /// M:for op01/op07/op08/op12 video call customization.
    callDetailsActivityExt.onResume();
  }
  ...
  protected void onPause() {
    ...
    /// M:for op01/op07/op08/op12 video call customization.
    callDetailsActivityExt.onPause();
  }
  ...
  private void setupRecyclerViewForEntries() {
    ...
    /// M:for op01/op07/op08/op12 video call customization.
    callDetailsActivityExt = ExtensionManager.getCallDetailsExt()
        .getCallDetailsActivityExt(this, adapter, getNumber());
  }
