...
public class SelectPhoneAccountDialogFragment extends DialogFragment {
    ...
    final DialogInterface.OnClickListener selectionListener =
        new DialogInterface.OnClickListener() {
          ...
          public void onClick(DialogInterface dialog, int which) {
            isSelected = true;
            /// M: for ALPS04424558 guest mode can't get userhandle. @{
            ...
            PhoneAccountHandle selectedAccountHandle =
                SelectPhoneAccountDialogOptionsUtil.getPhoneAccountHandleEx(
                    options.getEntriesList().get(which));
            /// @}
  ...
  /// M: ALPS03416249 when stop, dimiss the dialog @{
  @Override
  public void onStop() {
    ...
    if (activity != null
        && activity instanceof InCallActivity) {
      boolean isChanging = false;
      isChanging = activity.isChangingConfigurations();
      LogUtil.d("SelectPhoneAccountDialogFragment.onStop", "isChanging: " + isChanging);
      if (!isSelected && listener != null && !isChanging) {
        Bundle result = new Bundle();
        result.putString(SelectPhoneAccountListener.EXTRA_CALL_ID, getCallId());
        listener.onReceiveResult(SelectPhoneAccountListener.RESULT_DISMISSED, result);
  ...
  static class SelectAccountListAdapter
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      PhoneAccountHandle accountHandle =
          SelectPhoneAccountDialogOptionsUtil.getPhoneAccountHandleEx(entry);
      /// @}
