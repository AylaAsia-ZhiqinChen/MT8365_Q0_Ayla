...
public class CallLogAdapter extends GroupingListAdapter
  ...
  ///M: Plug-in for op07/op08/op09
  public ICallLogAdapterExt callLogAdapterExt;
  ...
  public CallLogAdapter(
    ...
    if (!PermissionsUtil.hasContactsReadPermissions(activity)) {
      this.contactInfoCache.disableRequestProcessing(true);
    }
    ...
    ///M: Plug-in for op07/op08/op09
    callLogAdapterExt = ExtensionManager.getCallLogExt().getCallLogAdapterExt(activity, this);
  }
  ...
  public void onResume() {
    ...
    if (PermissionsUtil.hasPermission(activity, android.Manifest.permission.READ_CONTACTS)) {
      ...
      contactInfoCache.disableRequestProcessing(false);
  ...
  public void onViewAttachedToWindow(ViewHolder viewHolder) {
    if (viewHolder.getItemViewType() == VIEW_TYPE_CALLLOG) {
      ...
      /// M: add for op07/op08/op12 video call button customization.@{
      callLogAdapterExt.onViewAttachedToWindow(
          ((CallLogListItemViewHolder) viewHolder).mCallLogListItemViewHolderExt);
      /// @}
    }
  }
  ...
  public void onViewDetachedFromWindow(ViewHolder viewHolder) {
    if (viewHolder.getItemViewType() == VIEW_TYPE_CALLLOG) {
      ...
      /// M: add for op07/op08/op12 video call button customization.@{
      callLogAdapterExt.onViewDetachedFromWindow(
          ((CallLogListItemViewHolder) viewHolder).mCallLogListItemViewHolderExt);
      /// @}
    }
  }
   ...
   */
  protected/*M*/ void bindCallLogListViewHolder(final ViewHolder viewHolder, final int position) {
  ...
  private void loadAndRender(
    ...
    loadData(viewHolder, rowId, details);
    ...
    final AsyncTask<Void, Void, Boolean> loadDataTask =
        new AsyncTask<Void, Void, Boolean>() {
          ...
          protected void onPostExecute(Boolean success) {
            ...
            if (success) {
              /// M: ALPS04033922 show primary action button.
             ...
             /*int currentDayGroup = getDayGroup(viewHolder.rowId);
              ...
              if (currentlyExpandedRowId == viewHolder.rowId) {
                LogUtil.d("CallLogAdapter.loadAndRender",  "onPostExecute", "viewHolder.showActions TRUE");
                currentlyExpandedPosition = viewHolder.getAdapterPosition();
                viewHolder.showActions(true);
              } else {
                viewHolder.showActions(false);
  ...
  private /*static M*/ String getNumberType(Resources res, PhoneCallDetails details) {
    ...
    return (String)PhoneCompat.getTypeLabel(activity, details.numberType, details.numberLabel);
  }
  ...
  private void render(CallLogListItemViewHolder views, PhoneCallDetails details, long rowId) {
    ...
    /// M: ALPS03446184  call log load perfemance showAction in method of onPostExecute
    /*if (currentlyExpandedRowId == views.rowId) {
  ...
  void disableRequestProcessingForTest() {
    ...
    contactInfoCache.disableRequestProcessing(true);
  }
