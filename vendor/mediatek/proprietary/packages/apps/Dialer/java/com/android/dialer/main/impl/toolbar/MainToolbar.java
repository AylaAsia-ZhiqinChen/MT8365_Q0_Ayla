...
public final class MainToolbar extends Toolbar implements PopupMenu.OnMenuItemClickListener {
  ...
  protected void onFinishInflate() {
    ...
    /// M: for op01 speed dial entry @{
    final Menu menu = overflowMenu.getMenu();
    ExtensionManager.getDialPadExtension().buildOptionsMenu(getContext(), menu);
    /// @}
  ...
  public void slideUp(boolean animate, View container) {
    ...
    LogUtil.i("MainToolbar.slideUp", "enter");

    if (getHeight() == 0) {
      LogUtil.i("MainToolbar.slideUp", "getHeight() == 0");
