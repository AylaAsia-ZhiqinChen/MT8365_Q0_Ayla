...
/// M: add mtk new outgoing call intent.
...
public class UndemoteOutgoingCallReceiver extends BroadcastReceiver {
  ...
  public void onReceive(final Context context, Intent intent) {
    ...
    /// M: use mtk new outgoing call intent instead aosp. @{
    if (intent != null
            && MtkTelecomManager.ACTION_NEW_OUTGOING_CALL_UNDEMOTE.equals(intent.getAction())) {
    /// @}
