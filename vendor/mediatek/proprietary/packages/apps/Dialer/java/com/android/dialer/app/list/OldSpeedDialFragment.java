...
public class OldSpeedDialFragment extends Fragment
  ...
  public void onCreate(Bundle savedState) {
    ...
    Trace.traceBegin(Trace.TRACE_TAG_VIEW, "oldspeed-onCreate");
  ...
  public void onResume() {
    ...
    Trace.traceBegin(Trace.TRACE_TAG_VIEW, "oldspeed-onResume");
    super.onResume();
  ...
  public View onCreateView(
    ...
    Trace.traceBegin(Trace.TRACE_TAG_VIEW, "oldspeed-onCreateView");
  ...
  public void onRequestPermissionsResult(
    ...
    if (requestCode == READ_CONTACTS_PERMISSION_REQUEST_CODE) {
      ...
      if (PermissionsUtil.hasPermission(getContext(), READ_CONTACTS)) {
          PermissionsUtil.notifyPermissionGranted(getContext(), READ_CONTACTS);
      }
      ///@}
    }
