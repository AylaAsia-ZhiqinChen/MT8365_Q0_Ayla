...
class ButtonChooserFactory {
  ...
  private static ButtonChooser newImsAndWiFiButtonChooser() {
    ...
    /// M: [One way video] One way video call button. @{
    mapping.put(InCallButtonIds.BUTTON_ONE_WAY_VIDEO,
  ...
  /**
   * M: [Button Extension] Extend the button mapping.
   * @param mapping
   */
