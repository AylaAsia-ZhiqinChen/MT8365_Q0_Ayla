...
public class ManageConferenceActivity extends AppCompatActivity {
  ...
  protected void onDestroy() {
    ...
    if (isFinishing()) {
      ...
      InCallPresenter.getInstance().setManageConferenceActivityAsNull(this);
      /// @}
    }
  }
  ...
  /**
   * M: [VoLTE Conference] Override finish fuction that clear task when do finish.
   * Fix ALPS03657512 and ALPS03693586.the rootcause is ContactSelectionActivity don't destory
