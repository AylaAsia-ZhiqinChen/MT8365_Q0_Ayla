...
public class CallLogActivity extends TransactionSafeActivity
  ...
  /// M:for op02 op09 multi tab feature. @{
  private ICallLogActivityExt callLogActivityExt;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    /// M:for op02 op09 multi tab feature.@{
    callLogActivityExt = ExtensionManager.getCallLogExt().getCallLogActivityExt(this);
    /// @}
    ...
    tabTitles = new CharSequence[callLogActivityExt.getTabIndexCount(TAB_INDEX_COUNT)];
    /// @}
    ...
    /// M: for op02 op09 Plug-in. @{
    callLogActivityExt.initCallLogTab(tabTitles, viewPager);
    /// @}
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    /// M:for op02 op09 multi tab feature. @{
    callLogActivityExt.createCallLogMenu(menu, viewPagerTabs);
    /// @}
    return true;
  }
  ...
  public boolean onPrepareOptionsMenu(Menu menu) {
    ...
    /// M: for op02 op09 multi tab feature. @{
    callLogActivityExt.prepareCallLogMenu(menu);
    ///@}
    return true;
  }
  ...
  private void updateMissedCalls(int position) {
    ...
    /// M: for op02 op09 multi tab feature.@{
    if (callLogActivityExt.updateMissedCalls(getRtlPosition(position))) {
      return;
    }
    /// @}
  ...
  public class ViewPagerAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
      ...
      if ((fragment = callLogActivityExt.getCallLogFragmentItem(
        getRtlPosition(position))) != null) {
        return fragment;
      }
      ///@}
    ...
    public Object instantiateItem(ViewGroup container, int position) {
      ...
      /// M: for op02 op09 multi tab feature.@{
      boolean hasInstantiateByOp =
          callLogActivityExt.instantiateItemByOp(getRtlPosition(position), fragment);
      if (hasInstantiateByOp) {
        return fragment;
      }
      ///@}
      switch (getRtlPosition(position)) {
    ...
    public int getCount() {
      ...
      return callLogActivityExt.getTabIndexCount(TAB_INDEX_COUNT);
      ///@}
    }
  }
  ...
  protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    /// M: for op02 op09 multi tab feature. @{
    callLogActivityExt.onActivityResult(requestCode, resultCode, data);
    /// @}
