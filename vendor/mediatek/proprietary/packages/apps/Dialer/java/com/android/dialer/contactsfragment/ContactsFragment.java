...
public class ContactsFragment extends Fragment
  ...
  public View onCreateView(
    ...
    LogUtil.i("ContactsFragment.onCreateView", "start ...");
    ...
    LogUtil.i("ContactsFragment.onCreateView", "end ...");
    return view;
  }
  ...
  public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
    ...
    LogUtil.i("ContactsFragment.onLoadFinished", "end ...");
  }

  @Override
  public void onLoaderReset(Loader<Cursor> loader) {
     LogUtil.i("ContactsFragment.onLoaderReset", "start ...");
