...
public class CallContactActivity extends TransactionSafeActivity
    implements PhoneNumberInteraction.DisambigDialogDismissedListener,
        ...
        PhoneNumberInteraction.StartCallListener{
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    LogUtil.i("CallContactActivity","onCreate()");
  ...
  public void onDisambigDialogDismissed() {
    LogUtil.i("CallContactActivity","onDisambigDialogDismissed");
    finish();
  }
 ...
 ///M: Add this method for ALPS04414094 @{
  ...
  public void onStartCall() {
    LogUtil.i("CallContactActivity","onStartCall, finish this activity");
    finish();
  }
  /// @}
