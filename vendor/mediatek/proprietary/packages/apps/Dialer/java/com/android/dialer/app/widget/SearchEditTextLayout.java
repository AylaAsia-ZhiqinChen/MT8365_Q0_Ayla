...
public class SearchEditTextLayout extends FrameLayout {
  ...
  protected void onFinishInflate() {
    ...
    collapsed.setOnTouchListener(
        (v, event) -> {
          LogUtil.i("SearchEditTextLayout", "collapsed.setOnTouchListener");
    ...
    searchView.setOnFocusChangeListener(
        new OnFocusChangeListener() {
          ...
          public void onFocusChange(View v, boolean hasFocus) {
            LogUtil.i("SearchEditTextLayout", "collapsed.setOnTouchListener, hasFocus = " + hasFocus);
            if (hasFocus) {
    ...
    searchView.setOnClickListener(
        new View.OnClickListener() {
          ...
          public void onClick(View v) {
            if (callback != null) {
              LogUtil.i("SearchEditTextLayout", "searchView.setOnClickListener onClick");
