...
public class CallLogFragment extends Fragment
  ...
  public ICallLogFragmentExt mFragmentExt;
  ...
  public void onCreate(Bundle state) {
    ...
    Trace.traceBegin(Trace.TRACE_TAG_VIEW, "CalllogFragment-onCreate");
    ...
    /// M:for op02 op09 multi tab feature.@{
    mFragmentExt = ExtensionManager.getCallLogExt().getCallLogFragmentExt(
            this, isCallLogActivity, callTypeFilter, (isUpdate) -> refreshDataRequired = isUpdate);
    /// @}
  ...
  public boolean onCallsFetched(Cursor cursor) {
    ...
    if (cursor != null && cursor.getCount() > 0 && adapter.getItemCount() > 0/*M*/) {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedState) {
    Trace.traceBegin(Trace.TRACE_TAG_VIEW, "CalllogFragment-onCreateView");
  ...
  public void onViewCreated(View view, Bundle savedInstanceState) {
    ...
    /// M:for op02 op09 multi tab feature.@{
    mFragmentExt.onViewCreated(view);
    /// @}
  }
  ...
  public void onResume() {
    ...
    /// M:for op01, op02, op09@{
    mFragmentExt.onResume();
    /// @}
  }
  ...
  public void onDestroy() {
    ...
    adapter.callLogAdapterExt.onDestroy();
    /// M:for op02 op09 multi tab feature.@{
    mFragmentExt.onDestroy();
    /// @}
  }
  ...
  private void updateEmptyMessage(int filterType) {
    ...
    /// M:for op02 op09 multi tab feature.@{
    if (mFragmentExt.updateEmptyMessage(filterType)) {
      return;
    }
    /// @}
  ...
  private void refreshData() {
    ...
    if (refreshDataRequired) {
      ...
      fetchCalls();
      /// M:Do nothing on callback, so no need query here  @{
  ...
  public /*public modify op02,op09 plugin M:*/void markMissedCallsAsReadAndRemoveNotifications() {
