...
public class RttOverflowMenu extends PopupWindow implements OnCheckedChangeListener {
  ...
  private final RttCheckableButton holdCallButton;
  /// @}
  ...
  RttOverflowMenu(
    ...
    downgradeCallButton.setOnClickListener(v -> this.inCallButtonUiDelegate.downgradeRttClicked());
    holdCallButton = view.findViewById(R.id.menu_hold_call);
  ...
  public void onCheckedChanged(RttCheckableButton button, boolean isChecked) {
    ...
    /// M: handle click hold button for RTT feature. @{
  ...
  /// M: Enable downgrade and hold button for RTT feature. @{
  void enableDowngradeRttButton(boolean enabled) {
    downgradeCallButton.setEnabled(enabled);
    downgradeCallButton.setVisibility(enabled ? View.VISIBLE : View.GONE);
  }
  void enableHoldButton(boolean enabled) {
    holdCallButton.setEnabled(enabled);
    holdCallButton.setVisibility(enabled ? View.VISIBLE : View.GONE);
  }
  /// @}
}
