...
public class TopRow {
  ...
  private static CharSequence getLabelForIncoming(Context context, PrimaryCallState state) {
    if (state.isVideoCall()) {
      ...
      /// M: ALPS04393353, do not use colored sim label, because the background color of
      /// AnswerFragment is the color of the phone account which receive the incoming call. @{
      /// Google code:
