...
public abstract class DialerApplication extends Application implements HasRootComponent {
  ...
  public void onCreate() {
    ...
    Trace.traceBegin(Trace.TRACE_TAG_VIEW, "dialerapp-onCreate");
    LogUtil.i("DialerApplication.onCreate", "start ...");
    ///M: For Call pull feature
    sContext = this;
    StrictModeComponent.get(this).getDialerStrictMode().onApplicationCreate(this);
    LogUtil.i("DialerApplication.onCreate", "after StrictModeComponent");
    super.onCreate();
    /// M: For plug-in @{
    ExtensionManager.init(this);
    LogUtil.i("DialerApplication.onCreate", "after ExtensionManager");
    new BlockedNumbersAutoMigrator(
        ...
        .asyncAutoMigrate();
    LogUtil.i("DialerApplication.onCreate", "after BlockedNumbersAutoMigrator");
