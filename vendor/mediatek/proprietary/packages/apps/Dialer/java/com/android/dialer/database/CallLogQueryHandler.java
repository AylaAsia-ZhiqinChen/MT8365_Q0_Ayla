...
public class CallLogQueryHandler extends NoNullCursorAsyncQueryHandler {
  ...
  /// M: For op02,op09 multi tab feature and show call log according to sims.
  public ICallLogQueryHandlerExt mQueryHandlerExt;
  ...
  public CallLogQueryHandler(
    ...
    /// M: For op02,op09 multi tab feature and show call log according to sims.
    mQueryHandlerExt = ExtensionManager.getCallLogExt().getCallLogQueryHandlerExt(context);
  }
  ...
  private void fetchCalls(int token, int callType, boolean newOnly, long newerThan) {
    ...
    /// M: For op02,op09 multi tab feature and show call log according to sims.@{
    mQueryHandlerExt.appendQuerySelection(callType, where, selectionArgs);
    /// @}
