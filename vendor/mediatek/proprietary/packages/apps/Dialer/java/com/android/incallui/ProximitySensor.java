...
public class ProximitySensor
  ...
  public void onStateChange(InCallState oldState, InCallState newState, CallList callList) {
    ...
    boolean isOffhook =
        /// M: ALPS04034082, Remove pending_outgoing state to follow android O.
        /// Or else will turn off screen when dialing from contact with sensor covered even
        /// the sim account dialog popup. @{
