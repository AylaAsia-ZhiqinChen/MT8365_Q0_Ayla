...
public class PostCharDialogFragment extends DialogFragment {
    ...
    builder.setPositiveButton(
        ...
        new DialogInterface.OnClickListener() {
          ...
          public void onClick(DialogInterface dialog, int whichButton) {
            ...
            /// M: ALPS04500109, just exit postCharDialogActivity after user click the dialog.
            exitPostCharDialogActivity();
          }
        });
  ...
  /// M: ALPS04500109, just exit postCharDialogActivity after user click the dialog. @{
  private void exitPostCharDialogActivity() {
    Activity activity = getActivity();
    if (activity != null
        && activity instanceof PostCharDialogActivity) {
      activity.finish();
    }
  }
  /// @}
