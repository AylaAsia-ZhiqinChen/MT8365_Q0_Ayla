...
/// @}
/// M: Add for wifionly, don't show IMEI. @{
...
public class ImeiInfoPreferenceController extends BasePreferenceController
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        /// M: Add for wifionly, don't show IMEI. @{
        if (mTelephonyManager != null && !mTelephonyManager.isVoiceCapable() && !mTelephonyManager.isSmsCapable()
                && cm != null && !cm.isNetworkSupported(ConnectivityManager.TYPE_MOBILE)) {
            return;
        }
        /// @}
    ...
    private int getPhoneType(int slotIndex) {
        /// M: Revise for getting phone type for slot directly.
