...
public class TimeoutPreferenceController extends AbstractPreferenceController implements
    ...
    private void updateTimeoutPreferenceDescription(TimeoutListPreference preference,
        ...
        if (preference.isDisabledByAdmin()) {
            ...
            //yuntian longyao add永不休眠
            if (android.os.SystemProperties.getBoolean("persist.sys.screen.never.sleeps", false)) {
                if (null != timeoutDescription && entries[0].toString().equals(timeoutDescription.toString())) {
