...
import com.android.settings.ethernet.EthernetPreferenceController;
...
public class NetworkDashboardFragment extends DashboardFragment implements
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(Context context,
        ...
        //yuntian longyao add Ethernet settings
        final EthernetPreferenceController ethernetPreferenceController =
                new EthernetPreferenceController(context);
        //yuntian longyao end Ethernet settings
        if (lifecycle != null) {
