...
public class FeatureFlagPersistent {
    ...
    public static boolean isEnabled(Context context, String feature) {
        /// M: Disable the feature flag NETWORK_INTERNET_V2 and MOBILE_NETWORK_V2. @{
        if (feature != null) {
            if (feature.equals(FeatureFlags.NETWORK_INTERNET_V2)) {
                return false;
            } else if (feature.equals(FeatureFlags.MOBILE_NETWORK_V2)) {
                return true;
            }
        }
        /// @}
