...
import static com.mediatek.settings.wfd.WfdChangeResolution.DEVICE_RESOLUTION_LIST;
...
public final class WfdChangeResolutionFragment extends DialogFragment
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        int resolutionIndex = DEVICE_RESOLUTION_LIST.indexOf(mCurrentResolution);
    ...
    public void onClick(DialogInterface dialog, int which) {
        if (which == DialogInterface.BUTTON_POSITIVE) {
            int userChoice = DEVICE_RESOLUTION_LIST.get(mWhichIndex);
    ...
    public void onResume() {
        super.onResume();
        if (!DEVICE_RESOLUTION_LIST.contains(mCurrentResolution)) {
            dismiss();
        }
    }
}
