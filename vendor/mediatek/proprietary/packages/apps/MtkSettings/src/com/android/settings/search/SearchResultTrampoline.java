...
public class SearchResultTrampoline extends Activity {
    ...
    private static final String LOG_TAG = "SearchResultTrampoline";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        /// M: finish this activity when getCallingActivity returns null {
        if (getCallingActivity() == null) {
            Log.d(LOG_TAG, "finishing because call to getCallingActivity() is null");
            finish();
            return;
        }
        /// @ }
