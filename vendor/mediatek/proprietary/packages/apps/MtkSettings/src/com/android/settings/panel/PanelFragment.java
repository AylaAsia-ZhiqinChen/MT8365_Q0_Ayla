...
public class PanelFragment extends Fragment {
    ...
    private void createPanelContent() {
        ...
        /*M: modifications to return when SettingsPanelActivity is destroyed*/
        if(activity == null) {
            Log.d(TAG, "SettingsPanelActivity, is null, returning");
            return;
        }
                ...
                if (slice == null || metadata.isErrorSlice()) {
                    ...
                    handler.postDelayed(() -> {
                      if(getActivity() != null) {
                        ...
                        Log.d(TAG, "SettingsPanelActivity is null, skip executing delayed handler");
                      }
