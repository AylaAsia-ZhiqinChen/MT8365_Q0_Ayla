...
public class WifiDppUtils {
    public static final String TAG = "WifiDppUtils";
    /**
    ...
    /** The data is from {@code com.android.mtksettingslib.wifi.AccessPoint.securityToString} */
    ...
    public static void showLockScreen(Context context, Runnable successRunnable) {
        ...
        if (keyguardManager.isKeyguardSecure()) {
            final BiometricPrompt.AuthenticationCallback authenticationCallback =
                    new BiometricPrompt.AuthenticationCallback() {
                        ...
                        public void onAuthenticationError(int errorCode, CharSequence errString) {
                            Log.d(TAG, "authentication fail: " + errorCode + " " + errString);
                            if (errorCode == BiometricConstants.BIOMETRIC_ERROR_HW_NOT_PRESENT ||
                                    errorCode ==
            ...
            Log.d(TAG, "Keyguard not secure, run dpp qr code");
            successRunnable.run();
        }
    }
