...
public class BillingCycleSettings extends DataUsageBaseFragment implements
    ...
    public static class ConfirmLimitFragment extends InstrumentedDialogFragment implements
        ...
        public static void show(BillingCycleSettings parent) {
            if (!parent.isAdded()) {
                Log.d(TAG, "BillingCycleSettings is not added to its activity.");
                return;
            }
            ...
            if (policy == null) {
                Log.d(TAG, "NetworkPolicy is null.");
                return;
            }
            ...
            Log.d(TAG, "show ConfirmLimitFragment, limitBytes=" + limitBytes);
        }
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(context)
                    ...
                    /// M: Add for ALPS02818840, reset preference when the dialog is cancelled.
