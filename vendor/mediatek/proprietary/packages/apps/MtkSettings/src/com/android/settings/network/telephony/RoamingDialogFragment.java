...
public class RoamingDialogFragment extends InstrumentedDialogFragment implements OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String customizeSummary = UtilsExt.getMobileNetworkSettingsExt(
                getContext()).customizaRoamingPreferenceDialogSummary(
                        getResources().getString(message), mSubId);
        builder.setMessage(customizeSummary)
                .setTitle(title)
