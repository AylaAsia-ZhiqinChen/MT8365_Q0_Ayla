...
/**
 * For operator requirements: add default implement.
 * operator like China Mobile, China Telecom, China Unicom, etc.
 */
public class DefaultNetworkSettingExt implements INetworkSettingExt {
    ...
    @Override
    public void customizeNetworkSelectKey(Object object) {
        ListPreference pref = (ListPreference) object;
        pref.setValue(String.valueOf(-1));
    }
}
