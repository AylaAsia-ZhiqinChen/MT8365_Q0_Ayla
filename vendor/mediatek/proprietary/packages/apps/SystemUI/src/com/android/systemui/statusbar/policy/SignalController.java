...
public abstract class SignalController<T extends SignalController.State,
    ...
    protected static final boolean DEBUG = FeatureOptions.LOG_ENABLE ||
                                        NetworkControllerImpl.DEBUG;
    protected static final boolean CHATTY = FeatureOptions.LOG_ENABLE ||
    ...
    public boolean isDirty() {
        if (!mLastState.equals(mCurrentState)) {
            if (DEBUG) {
                Log.d(mTag, "[" + this + "]\n"
                        + "Change in state from: " + mLastState + "\n"
                        + "                  to: " + mCurrentState);
            }
            return true;
        }
    ...
    static class State {
        ...
        protected void toString(StringBuilder builder) {
            builder.append("this=").append(this.hashCode()).append(',')
