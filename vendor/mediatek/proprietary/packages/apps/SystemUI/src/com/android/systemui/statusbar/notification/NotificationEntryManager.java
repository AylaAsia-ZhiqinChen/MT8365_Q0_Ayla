...
*/
    ...
    private void extendLifetime(NotificationEntry entry, NotificationLifetimeExtender extender) {
        for (Map.Entry<NotificationEntry, NotificationLifetimeExtender> e :
            mRetainedNotifications.entrySet()){
            if(entry.key.equals(e.getKey() == null ? "" : e.getKey().key)){
                NotificationLifetimeExtender activeExtender =
                    mRetainedNotifications.remove(e.getKey());
