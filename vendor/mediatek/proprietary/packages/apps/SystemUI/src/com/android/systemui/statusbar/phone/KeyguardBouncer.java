...
public class KeyguardBouncer {
    ...
    public void show(boolean resetSecuritySelection, boolean isScrimmed) {
        show(resetSecuritySelection, false, isScrimmed);
    }

    public void show(boolean resetSecuritySelection, boolean authenticated, boolean isScrimmed) {
    ...
    private void onFullyShown() {
        ...
        if (mKeyguardView == null) {
            /// Use error log instead of exception here.
