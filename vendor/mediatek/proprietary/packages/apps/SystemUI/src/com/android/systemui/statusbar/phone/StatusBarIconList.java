...
public class StatusBarIconList {
    private static final String TAG = "StatusBarIconList";
    ...
    public static class Slot {
        ...
        /// M: show sim icons in order of slots @{
        Comparator c = new Comparator<StatusBarIconHolder>() {
            @Override
            public int compare(StatusBarIconHolder h1, StatusBarIconHolder h2) {
                if (h1.getType() != StatusBarIconHolder.TYPE_MOBILE ||
                        h2.getType() != StatusBarIconHolder.TYPE_MOBILE) {
                    return 0;
                } else if (h1.getMobileState().phoneId < h2.getMobileState().phoneId) {
                    return 1;
                } else {
                    return -1;
                }
