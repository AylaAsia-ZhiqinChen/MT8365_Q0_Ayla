...
public class QSCarrier extends LinearLayout {
    ...
    public void updateState(QSCarrierGroup.CellSignalState state) {
        ...
        if (state.visible) {
            ...
            /// M: use common signal strength res id. @{
            int signalId = mStatusBarExt.getCommonSignalIconId(state.subId,
                    state.mobileSignalIconId);
            mMobileSignal.setImageLevel(signalId);
            /// @}
