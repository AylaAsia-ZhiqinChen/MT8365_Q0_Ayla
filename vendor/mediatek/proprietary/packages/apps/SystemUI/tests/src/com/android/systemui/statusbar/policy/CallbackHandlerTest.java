...
public class CallbackHandlerTest extends SysuiTestCase {
    ...
    public void testSignalCallback_setMobileDataIndicators() {
        ...
        mHandler.setMobileDataIndicators(status, qs, type, networkType, volteType, qsType, in, out,
            typeDescription, description, wide, subId, roaming, isDefaultData, customizedState);
        waitForCallbacks();
        ...
        ArgumentCaptor<Boolean> isDefaultDataArg = ArgumentCaptor.forClass(Boolean.class);
        ArgumentCaptor<Integer> customizedStateArg = ArgumentCaptor.forClass(Integer.class);
       /// @}
        ...
        Mockito.verify(mSignalCallback).setMobileDataIndicators(statusArg.capture(),
                ...
                subIdArg.capture(), eq(roaming), isDefaultDataArg.capture(),
                customizedStateArg.capture());
        assertEquals(status, statusArg.getValue());
        assertEquals(qs, qsArg.getValue());
        ...
        assertEquals(isDefaultData, (boolean) isDefaultDataArg.getValue());
        assertEquals(customizedState, (int) customizedStateArg.getValue());
        /// @}
