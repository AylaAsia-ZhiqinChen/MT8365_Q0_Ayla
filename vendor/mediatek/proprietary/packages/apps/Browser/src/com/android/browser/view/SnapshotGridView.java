...
public class SnapshotGridView extends GridView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int originWidth = widthMeasureSpec;
        ...
        if (originWidth != widthMeasureSpec){
            setPaddingRelative((originWidth - widthMeasureSpec) / 2, 0, 0, 0);
        }
        super.onMeasure(originWidth, heightMeasureSpec);
    }
