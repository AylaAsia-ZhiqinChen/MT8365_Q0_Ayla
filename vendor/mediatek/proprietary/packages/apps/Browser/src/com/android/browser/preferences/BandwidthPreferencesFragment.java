...
public class BandwidthPreferencesFragment extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /// M: Remove search result preloading due to the function is phase out
        getPreferenceScreen().removePreference(findPreference(PreferenceKeys.PREF_DATA_PRELOAD));
        /// @}
    }
