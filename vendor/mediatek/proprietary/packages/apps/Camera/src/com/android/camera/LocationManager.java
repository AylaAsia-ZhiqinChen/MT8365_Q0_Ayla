...
public class LocationManager {
    ...
    public Location getCurrentLocation() {
        ...
        if (FeatureSwitcher.isGpsLocationSupported() && mRecordLocation) {
            // go in best to worst order
            location = mLocationListener.current();
        }
        Log.d(TAG, "getCurrentLocation() mRecordLocation=" + mRecordLocation + ", return "
                + location);
        return location;
    }
    ...
    public void recordLocation(boolean recordLocation) {
        ...
        if (FeatureSwitcher.isGpsLocationSupported()
    ...
    private void startReceivingLocationUpdates() {
        ...
        if (mLocationManager != null) {
            try {
                android.location.LocationRequest request = android.location.LocationRequest
                        .create();
    ...
    private class LocationListener implements android.location.LocationListener {
        ...
        public void onLocationChanged(Location newLocation) {
            Log.d(TAG, "onLocationChanged(" + newLocation + ") mRecordLocation=" + mRecordLocation
        ...
        public void onStatusChanged(String provider, int status, Bundle extras) {
            Log.d(TAG, "onStatusChanged(" + provider + ", " + status + ") mRecordLocation="
