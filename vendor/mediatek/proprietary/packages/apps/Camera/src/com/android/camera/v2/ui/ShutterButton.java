...
public class ShutterButton extends RotateImageView implements View.OnLongClickListener {
    private static final Tag TAG = new Tag(ShutterButton.class.getSimpleName());
    ...
    protected void drawableStateChanged() {
        ...
        LogHelper.i(TAG, "drawableStateChanged() pressed = " + pressed);
    ...
    /**
     * Add an {@link Shutteristener} to a set of listeners.
     */
    public void setShutterListener(Shutteristener listener) {
        mListener = listener;
    }
