...
public class ModePickerScrollView extends ScrollView implements ModePickerScrollable {
    private static final Tag TAG = new Tag(ModePickerScrollView.class.getSimpleName());
    ...
    private Runnable mHideRunnable = new Runnable() {
        ...
        @Override
        public void run() {
            LogHelper.d(TAG, "mHideRunnable.run()");
            if (mBackground != null) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        LogHelper.d(TAG, "onInterceptTouchEvent(" + ev + ")");
        showBackground();
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        LogHelper.d(TAG, "onTouchEvent(" + ev + ")");
        showBackground();
    ...
    public void setBackgroundView(View view) {
        LogHelper.d(TAG, "setBackgroundView(" + view + ")");
        mBackground = view;
    }
}