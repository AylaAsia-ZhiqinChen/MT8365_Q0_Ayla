...
public class AnimationRect {
    ...
    private float getMaxScaleValue() {
        ...
        Log.d(TAG, "getMaxScaleValue maxScaleValue = " + maxScaleValue + " mCurrentScaleValue = "
                + mCurrentScaleValue);
    ...
    public void scale(float scale, boolean checkScale) {
        Log.d(TAG, "Before setScale scale = " + scale + " getMaxScaleValue = " + getMaxScaleValue()
        ...
        Log.d(TAG, "setScale mCurrentScaleValue = " + mCurrentScaleValue);
        mAnimationMatrix.reset();
        ...
        mOriginalDistance = (float) Math.sqrt((centerX() - rightBottom[0])
                * (centerX() - rightBottom[0]) + (centerY() - rightBottom[1])
                * (centerY() - rightBottom[1]));
        Log.d(TAG, "After setScale scale = " + scale);
    }

    public void scaleToTranslateY(float scaleY) {
        Log.d(TAG, "setScaleToTranslateY");
    ...
    public static void dumpVertex(AnimationRect rect) {
        Log.d(TAG, "Dump Vertex Animation Rect begin");
        Log.d(TAG, "(" + rect.getLeftTop()[0] + " , " + rect.getLeftTop()[1] + ")" + " , " + "("
                + rect.getRightTop()[0] + " , " + rect.getRightTop()[1] + ")");
        Log.d(TAG, "(" + rect.getLeftBottom()[0] + " , " + rect.getLeftBottom()[1] + ")" + " , "
                + "(" + rect.getRightBottom()[0] + " , " + rect.getRightBottom()[1] + ")");
        Log.d(TAG, "Dump Vertex Animation Rect end");
        Log.d(TAG, "(centerX , centerY) = " + "(" + rect.centerX() + " , " + rect.centerY() + ")");
    }
