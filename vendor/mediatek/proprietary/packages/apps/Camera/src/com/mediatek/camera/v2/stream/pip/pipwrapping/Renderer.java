...
public class Renderer {
    ...
    protected int initBitmapTexture(int resourceId, boolean needCropSmallBox) throws IOException {
        ...
        LogHelper.d(TAG, "Renderer initBitmapTexture glGenTextures num = " + 1);
        ...
        try {
            ...
            if (needCropSmallBox) {
                ...
                LogHelper.v(TAG, "read cousume " + (System.currentTimeMillis() - begin)
    ...
    protected void releaseBitmapTexture(int textureId) {
        ...
        LogHelper.d(TAG, "Renderer releaseBitmapTexture glDeleteTextures num = " + 1);
    }
     ...
     * @param tag used to as frame rate log's tag.
     *
     */
    public void debugFrameRate(Tag tag) {
        ...
        if (mDrawFrameCount % INTERVALS == 0) {
            ...
            LogHelper.d(tag, "[Wrapping-->" + tag + "]" + "[Preview] Drawing frame, fps = "
