...
public class RotateImageView extends TwoStateImageView implements Rotatable {
    private static final Tag TAG = new Tag(RotateImageView.class.getSimpleName());
    ...
    public void setOrientation(int degree, boolean animation) {
        LogHelper.d(TAG, "setOrientation(" + degree + ", " + animation + ") mOrientation="
                + mTargetDegree);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawable == null) {
            LogHelper.e(TAG, "drawable == null, return");
            return;
        }
        ...
        if (w == 0 || h == 0) {
            LogHelper.e(TAG, "w == 0 || h == 0, return");
