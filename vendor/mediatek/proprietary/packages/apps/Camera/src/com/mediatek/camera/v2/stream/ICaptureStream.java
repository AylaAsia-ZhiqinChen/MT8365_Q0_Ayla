...
public interface ICaptureStream {
    public static String CAPUTRE_SURFACE_KEY = "CaptureStream.Surface";
    /**
     * A capture callback.
     */
    ...
    /**
     * Update capture size and format
     * @param pictureSize capture picture size
     * @param format      capture picture format
     * @return true capture surface changed, false capture surface not changed
     */
