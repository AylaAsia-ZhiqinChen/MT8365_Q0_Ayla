...
public final class EglCore {
    ...
    public EglCore(EGLContext sharedContext, int flags) {
        ...
        mEGLConfig = PipEGLConfigWrapper.getInstance().
                getEGLConfigChooser().
                    chooseConfigEGL14(mEGLDisplay, (flags & FLAG_RECORDABLE) != 0);
        mEGLContext = null;
        if ((flags & FLAG_TRY_GLES3) != 0) {
            ...
            if (EGL14.eglGetError() != EGL14.EGL_SUCCESS) {
                LogHelper.d(TAG, "GLES 3.x not available");
                mEGLContext = null;
            }
        }
        if (mEGLContext == null) {
    ...
    public void makeCurrent(EGLSurface eglSurface) {
        if (mEGLDisplay == EGL14.EGL_NO_DISPLAY) {
            ...
            LogHelper.d(TAG, "NOTE: makeCurrent w/o display");
        }
    ...
    /**
     * Writes the current display, context, and surface to the LogHelper.
     */
    public static void logCurrent(String msg) {
        ...
        LogHelper.d(TAG, "Current EGL (" + msg + "): display=" + display + ", context=" + context
                + ", surface=" + surface);
    }
}
