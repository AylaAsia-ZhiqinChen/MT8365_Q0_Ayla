...
class LongExposureDeviceAction {
    ...
    static final int ABORT_CAPTURE = 7;
    static final int UPDATE_G_SENSOR_ORIENTATION = 8;
    static final int CLOSE_CAMERA = 9;
    static final int GET_PREVIEW_SIZE = 10;
    static final int SET_PREVIEW_SIZE_READY_CALLBACK = 11;
    static final int SET_PICTURE_SIZE = 12;
    static final int REQUEST_CHANGE_SETTING_VALUE = 13;
    static final int REQUEST_CHANGE_COMMAND = 14;
    static final int REQUEST_CHANGE_COMMAND_IMMEDIATELY = 15;
    static final int IS_READY_FOR_CAPTURE = 16;
    static final int DESTROY_DEVICE_CONTROLLER = 17;
    static final int REQUEST_CHANGE_SETTING_VALUE_JUST_SELF = 18;
