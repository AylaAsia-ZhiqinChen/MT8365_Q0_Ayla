...
public class FaceBeautyModeEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(FaceBeautyModeEntry.class
            .getSimpleName());
