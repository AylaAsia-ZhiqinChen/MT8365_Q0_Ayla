 ...
 */
public class MatrixModeRotateLayout extends ViewGroup implements Rotatable {
    private final static LogUtil.Tag TAG =
            new LogUtil.Tag(MatrixModeRotateLayout.class.getSimpleName());
     ...
     */
    public MatrixModeRotateLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
