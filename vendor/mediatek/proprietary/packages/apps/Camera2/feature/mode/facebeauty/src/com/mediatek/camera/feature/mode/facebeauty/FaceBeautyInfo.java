...
public class FaceBeautyInfo {
    static final LogUtil.Tag TAG = new LogUtil.Tag(FaceBeautyInfo.class.getSimpleName());
    private View mView;
     ...
     */
    public FaceBeautyInfo(Context context, IApp app) {
    ...
    private int calcualteDefualtMargin() {
        ...
        LogHelper.d(TAG, "[calcualteDefualtMargin] defaultMargin = "
                + defaultMargin + ",mWidthPixel = "
