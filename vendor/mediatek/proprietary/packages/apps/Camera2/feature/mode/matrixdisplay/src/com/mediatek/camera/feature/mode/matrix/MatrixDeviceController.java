...
public interface MatrixDeviceController {
    /**
    ...
    interface MatrixAvailableCallback {
        void onMatrixAvailable();
    }
     ...
     */
    void openCamera(MatrixDeviceInfo info);
    ...
    void setSurfaceInfo(Surface[] surface, int weight, int height);

    interface sessionCallback2PostAlgo {
