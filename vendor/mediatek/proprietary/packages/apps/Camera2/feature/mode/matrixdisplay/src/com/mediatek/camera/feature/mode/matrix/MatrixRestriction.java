...
public class MatrixRestriction {

    private static RelationGroup sRelationGroup = new RelationGroup();

    static {
        sRelationGroup.setHeaderKey("com.mediatek.camera.feature.mode.matrix.MatrixMode");
        ...
        sRelationGroup.addRelation(
                new Relation.Builder("com.mediatek.camera.feature.mode.matrix.MatrixMode", "on")
