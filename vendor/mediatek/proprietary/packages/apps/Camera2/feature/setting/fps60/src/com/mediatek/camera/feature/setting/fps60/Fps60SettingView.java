...
public class Fps60SettingView implements ICameraSettingView {
    ...
    public void loadView(PreferenceFragment fragment) {
        fragment.addPreferencesFromResource(R.xml.fps60_preference);
        mPref = (SwitchPreference) fragment.findPreference(KEY_FPS60);
        mPref.setRootPreference(fragment.getPreferenceScreen());
        mPref.setId(R.id.fps60_setting);
        mPref.setContentDescription(fragment.getActivity().getResources()
                .getString(R.string.fps60_content_description));
     ...
     */
    public void setFps60ViewListener(OnFps60ViewListener viewListener) {
