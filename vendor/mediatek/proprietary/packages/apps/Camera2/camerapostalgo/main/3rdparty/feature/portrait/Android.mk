...
LOCAL_SHARED_LIBRARIES += libaw_portrait_bokeh_opengl
LOCAL_SHARED_LIBRARIES += libaw_portrait_mask
LOCAL_SHARED_LIBRARIES += libaw_portrait_bokeh
LOCAL_SHARED_LIBRARIES += libpostalgo_metadata
#---------------------------------------------------------------------------------------------------
LOCAL_MODULE := libpostalgo.plugin.portrait
