...
LOCAL_HEADER_LIBRARIES += mtkhdrfeature_headers
LOCAL_HEADER_LIBRARIES += feature_utils_headers
LOCAL_HEADER_LIBRARIES += libmtkhdr_headers
LOCAL_HEADER_LIBRARIES += mtkhdrhal_headers
...
LOCAL_SHARED_LIBRARIES += libcamalgo_sys.hdr
#-----------------------------------------------------------
LOCAL_CFLAGS += -DGL_GLEXT_PROTOTYPES -DEGL_EGLEXT_PROTOTYPES
#-----------------------------------------------------------
LOCAL_MODULE := libpostalgo.plugin.hdr
