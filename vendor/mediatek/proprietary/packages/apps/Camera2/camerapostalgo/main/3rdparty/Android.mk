...
#LOCAL_SRC_FILES += EvDecision.cpp
################################################################################
LOCAL_SHARED_LIBRARIES += libpostalgo_3rdparty.core
LOCAL_SHARED_LIBRARIES += libpostalgo_3rdparty.mtk
LOCAL_SHARED_LIBRARIES += libpostalgo_3rdparty.customer
LOCAL_SHARED_LIBRARIES += libpostalgo_3rdparty.plugin.features
################################################################################
...
################################################################################
LOCAL_MODULE := libpostalgo_3rdparty
