...
public class StreamInfo implements Parcelable {
    final static String TAG = "StreamInfo";
    public static final Parcelable.Creator<StreamInfo> CREATOR =
            new Parcelable.Creator<StreamInfo>() {
    ...
    public void addInfo(int mWidth, int mHeight, int mFormat, int mOrientation) {
        this.mWidth = mWidth;
