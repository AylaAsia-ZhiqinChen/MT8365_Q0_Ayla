...
/**
 * Camera postalgo stream implement.
 */
public class Stream implements Parcelable {
     ...
     * @param sf  The stream surface.
     */
    public Stream(int type, Surface sf) {
        mStreamType = type;
        mSurface = sf;
    }

    public static final Parcelable.Creator<Stream> CREATOR =
            new Parcelable.Creator<Stream>() {
    ...
    public void readFromParcel(Parcel in) {
        ...
        mSurface = in. readParcelable(Surface.class.getClassLoader());
    }

    /**
     * Get stream surface.
     * @return The Surface of stream.
     */
