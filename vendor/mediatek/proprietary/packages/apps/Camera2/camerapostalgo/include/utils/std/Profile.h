...
{
protected:  ////        Data Members.
    const char*         mLogTag = nullptr;
    const char*         mPrefix = nullptr;
    mutable int32_t     mIdx = 0;
    int64_t const       mStartTimeNS = 0;
    mutable int64_t     mLastTimeNS = 0;
...
public:     ////        Interfaces.
    ...
    /**
     * print: Print to logcat
     * print_overtime: Print to logcat if overtime.
     *
     * @param[in] logLevel: the log level (e.g. 'V', 'D', 'I', 'W', 'E')
     *      'V' : Verbose logging.
     *      'D' : Debug logging.
     *      'I' : Informational logging.
     *      'W' : Warning logging.
     *      'E' : Error logging.
     *      'F' : Fatal logging.
     *
     * @param[in] nsecs: the overtime duration, in nanosecond.
     */
    void                print(
                            char logLevel,
                            char const*const fmt = "",
