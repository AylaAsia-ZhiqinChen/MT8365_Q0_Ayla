...
create(char const* /*szTimelineName*/)
{
    ...
    MY_LOGE("sw_sync_timeline_create is no longer available ");
    return 0;
}
...
inc(size_t /*count*/)
{
    ...
    return  OK;*/
    MY_LOGE("sw_sync_timeline_inc is no longer available ");
    return -1;
}
...
)
{
    ...
    return  fd;*/
    MY_LOGE("sw_sync_fence_create is no longer available ");
    return -1;
}
