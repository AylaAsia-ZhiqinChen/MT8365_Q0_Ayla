...
/**
 * To get memory info from MemInfoReader.
 */
public class MemoryInfoManager {
    private MemInfoReader mInfoReader;
    private long[] mInfos;
    ...
    public void readMemInfo() {
        mInfoReader.readMemInfo();
        mInfos = mInfoReader.getRawInfo();
    }
    ...
    /**
     * For access the ActivityManager MemoryInfo.
     */
    public static class MemoryDetailInfo extends ActivityManager.MemoryInfo {
        /**
         * get forground app threshold.
         * @return the foreground app threshold.
         */
        public long getForgroundAppThreshold() {
            return foregroundAppThreshold;
        }
    }
}