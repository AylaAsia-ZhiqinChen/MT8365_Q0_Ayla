...
/**
 * Checker used to check whether hdr indicator is shown or hidden.
 */
@CoverPoint(pointList = {"Check hdr_indicator icon is shown or hidden"})
public class HdrIndicatorChecker extends IndicatorChecker {
    @Override
    protected String getIndicatorIconResourceId() {
        return "com.mediatek.camera:id/hdr_indicator";
    }
