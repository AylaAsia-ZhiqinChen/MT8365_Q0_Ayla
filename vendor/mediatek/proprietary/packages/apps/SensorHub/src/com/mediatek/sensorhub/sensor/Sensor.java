...
public class Sensor extends Activity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(getString(R.string.sensor_calibration_light));
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        if (0 == arg2) {
            ...
            intent.setClass(this, SensorCalibrationNew.class);
            intent.putExtra(SensorCalibrationNew.CALIBRAION_TYPE, SensorCalibrationNew.GSENSOR);
            this.startActivity(intent);
        } else if (3 == arg2) {
            intent.setClass(this, SensorCalibrationNew.class);
            intent.putExtra(SensorCalibrationNew.CALIBRAION_TYPE, SensorCalibrationNew.GYROSCOPE);
            this.startActivity(intent);
        } else if (4 == arg2) {
            intent.setClass(this, SensorCalibrationNew.class);
            intent.putExtra(SensorCalibrationNew.CALIBRAION_TYPE, SensorCalibrationNew.LIGHT);
            this.startActivity(intent);
        }
    }
}
