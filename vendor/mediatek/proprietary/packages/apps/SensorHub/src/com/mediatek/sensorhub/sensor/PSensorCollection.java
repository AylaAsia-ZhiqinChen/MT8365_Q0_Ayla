...
public class PSensorCollection extends Activity {
    public static final String TAG = "SH/PSensorCollectionLog";
   ...
   private final Button.OnClickListener mClickListener = new Button.OnClickListener() {
        ...
        public void onClick(View arg0) {
            Log.v(TAG, "onClick button view is "
                    + ((Button) arg0).getText());
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int[] tx_id = {R.id.tx_1, R.id.tx_2, R.id.tx_3, R.id.tx_4, R.id.tx_5, R.id.tx_6, R.id.tx_7,
                R.id.tx_8, R.id.tx_9, R.id.tx_10, R.id.tx_11, R.id.tx_12, R.id.tx_13, R.id.tx_14,
                R.id.tx_15, R.id.tx_16, R.id.tx_17, R.id.tx_18, R.id.tx_19, R.id.tx_20, R.id.tx_21,
                R.id.tx_22};
        int[] data_tx_id = {R.id.data_tx_1, R.id.data_tx_2, R.id.data_tx_3, R.id.data_tx_4,
                R.id.data_tx_5, R.id.data_tx_6, R.id.data_tx_7, R.id.data_tx_8, R.id.data_tx_9,
                R.id.data_tx_10, R.id.data_tx_11, R.id.data_tx_12, R.id.data_tx_13, R.id.data_tx_14,
                R.id.data_tx_15, R.id.data_tx_16, R.id.data_tx_17, R.id.data_tx_18, R.id.data_tx_19,
                R.id.data_tx_20, R.id.data_tx_21, R.id.data_tx_22};
    ...
    private void getData() {
        ...
        Log.v(TAG, "Get " + mCurrentIndex + " data :" + Integer.toString(dis[mCurrentIndex]));
