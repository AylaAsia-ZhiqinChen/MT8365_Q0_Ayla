...
/**
 * pip video quality selector preference.
 */
public class QualitySelectorPreference extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getActivity().getResources().getString(R.string.sdof_video_quality_title));
        addPreferencesFromResource(R.xml.sdof_video_quality_selector_preference);
