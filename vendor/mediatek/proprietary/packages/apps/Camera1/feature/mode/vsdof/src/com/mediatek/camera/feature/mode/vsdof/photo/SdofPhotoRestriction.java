...
/**
 * This class is photo mode restriction.
 */
...
public class SdofPhotoRestriction {
    ...
    private static final String KEY_DUAL_CAMERA_ZOOM = "key_dual_zoom";
    ...
    static {
        ...
        sRelation.setBodyKeys(KEY_CSHOT + "," + KEY_FLASH + "," +
                ...
                KEY_CAMERA_ZOOM+ "," + KEY_DUAL_CAMERA_ZOOM + "," +
                KEY_ANTI_FLICKER);
        sRelation.addRelation(
                new Relation.Builder(PHOTO_MODE_KEY, "on")
                        ...
                        .addBody(KEY_DUAL_CAMERA_ZOOM, "off", "off")
