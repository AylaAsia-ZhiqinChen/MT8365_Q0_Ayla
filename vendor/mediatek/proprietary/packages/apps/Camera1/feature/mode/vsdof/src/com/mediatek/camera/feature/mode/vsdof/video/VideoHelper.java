...
public class VideoHelper {
    ...
    public static final String MICROPHONE_KEY = "key_microphone";
    ...
    private ISdofDeviceController mCameraDevice;
     ...
     */
    public VideoHelper(ICameraContext context, IApp app, ISdofDeviceController cameraDevice) {
     ...
     */
    public ISdofDeviceController.PreviewCallback getPreviewFrameCallback() {
     ...
     * @return the result.
     */
    public IRecorder.RecorderSpec configRecorderSpec(CamcorderProfile profile,
                                                     String cameraId,
    ...
    public boolean isPDAFSupported(CameraDeviceManagerFactory.CameraApi api) {
        if (CameraDeviceManagerFactory.CameraApi.API2 == api) {
            LogHelper.i(TAG, "[isPdafSupported] api2 don't support");
            return false;
        }
    ...
    private ISdofDeviceController.PreviewCallback mPreviewCallback = new
                                       ISdofDeviceController.PreviewCallback() {
        @Override
        public void onPreviewCallback(byte[] data, int format, String previewCameraId) {
            if (mCameraPreviewData == null) {
                ...
                mCameraDevice.onFirstFrameAvailable();
            }
    ...
    private class SurfaceChangeListener implements IAppUiListener.ISurfaceStatusListener {
        ...
        public void surfaceAvailable(Object surfaceObject, int width, int height) {
            LogHelper.i(TAG, "[surfaceAvailable] holder = " + surfaceObject + " width = " + width +
                    " height = " + height + " mSwitchTask == null ");
