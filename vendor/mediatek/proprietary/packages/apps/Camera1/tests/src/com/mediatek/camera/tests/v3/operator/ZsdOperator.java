...
public class ZsdOperator extends SettingSwitchButtonOperator {
    ...
    public boolean isSupported(int index) {
        // ZsdOperator is used in customer regression test, so when isFeatureSupported return null,
        // we should get support status in parameters
        if (Utils.isFeatureSupported("com.mediatek.camera.at.zsd", null) == null) {
            ...
            return Utils.isFeatureSupported("com.mediatek.camera.at.zsd");
        }
    }
}
