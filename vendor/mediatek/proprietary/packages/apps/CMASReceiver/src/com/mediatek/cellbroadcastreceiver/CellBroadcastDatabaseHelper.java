...
public class CellBroadcastDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String TAG = "[CMAS]CellBroadcastDatabaseHelper";
     ...
     * Database version 12: remove SIM ID and add SUB ID parameter
     */
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + TABLE_NAME + " ("
                ...
                + MtkTelephony.MtkCellBroadcasts.SUBSCRIPTION_ID + " INTEGER,"
                //timer
                + MtkTelephony.MtkCellBroadcasts.WAC + " TEXT,"
                + "location_timer" + " INTEGER,"
                + "message_dispalyed" + " INTEGER);");//1 is show.2 is not show
    ...
    private void createSubIDIndex(SQLiteDatabase db) {
        db.execSQL("CREATE INDEX IF NOT EXISTS subIdIndex ON " + TABLE_NAME
                + " (" + MtkTelephony.MtkCellBroadcasts.SUBSCRIPTION_ID + ");");
    }
    ...
    private static final int COLUMN_V1_SUB_ID               = 8;
    ...
    private void upgradeDatabaseToVersion13(SQLiteDatabase db) {
        // Add 'areacoordinate' column to broadcasts table.
        db.execSQL("ALTER TABLE broadcasts ADD COLUMN " +
                 MtkTelephony.MtkCellBroadcasts.WAC + " TEXT");

        db.execSQL("ALTER TABLE broadcasts ADD COLUMN " + "location_timer" + " INTEGER DEFAULT 0");

        // Add 'dispalyed' column to broadcasts table.
        db.execSQL("ALTER TABLE broadcasts ADD COLUMN " +
                 "message_dispalyed" + " INTEGER DEFAULT 0");
    }
