...
final class AlarmNotifications {
    ...
    /// M: [ALPS03269543] [Power off Alarm] register NextAlarm @ {
    ...
    static synchronized void showLowPriorityNotification(Context context,
        ...
        /// M: [ALPS03410273] [Notification Channel] Set channel type as DEFAULT_NOTIFICATION @{
    ...
    static synchronized void showHighPriorityNotification(Context context,
        ...
        /// M: [ALPS03417583][ALPS03410273][Channel] Set channel as DEFAULT_NOTIFICATION @{
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context,
                Channel.DEFAULT_NOTIFICATION)
                .setShowWhen(false)
    ...
    private static void updateUpcomingAlarmGroupNotification(Context context,
        ...
        if (summary == null
            ...
            /// M: [ALPS03417583][ALPS03410273][Channel] Set channel as DEFAULT_NOTIFICATION @{
            summary = new NotificationCompat.Builder(context, Channel.DEFAULT_NOTIFICATION)
                    .setShowWhen(false)
    ...
    static synchronized void showAlarmNotification(Service service, AlarmInstance instance) {
        ...
        /// M: [ALPS03410273] [Notification Channel] Set channel type as EVENT_EXPIRED @{
        ...
        /// M: [ALPS03410273] [Notification Channel] Set channel type as EVENT_EXPIRED @{
        // TO DO: check service can be used and this method is required here
