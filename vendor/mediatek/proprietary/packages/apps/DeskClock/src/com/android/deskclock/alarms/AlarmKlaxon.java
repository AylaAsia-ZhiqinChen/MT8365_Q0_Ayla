...
final class AlarmKlaxon {
    ...
    public static void start(Context context, AlarmInstance instance) {
        ...
        if (!AlarmInstance.NO_RINGTONE_URI.equals(instance.mRingtone)) {
            ...
            /// M: [ALPS03584569] Check FBE lock and Play systm default alarm sound in this case @{
            if (UserManager.get(context.getApplicationContext()).isUserUnlocked()) {
                ...
                getAsyncRingtonePlayer(context).play(RingtoneManager
                        .getDefaultUri(RingtoneManager.TYPE_ALARM), crescendoDuration);
            }
            ///@}
        }
