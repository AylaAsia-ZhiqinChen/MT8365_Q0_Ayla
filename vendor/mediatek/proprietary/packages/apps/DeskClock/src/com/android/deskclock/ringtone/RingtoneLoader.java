...
class RingtoneLoader extends AsyncTaskLoader<List<ItemAdapter.ItemHolder<Uri>>> {
    ...
    public List<ItemAdapter.ItemHolder<Uri>> loadInBackground() {
        ...
        /// M: [ALPS03513886] Access and add mCustomRingtones only if it is not null@{
        final int itemCount = systemRingtoneCount + 3
                + (mCustomRingtones == null ? 0 : mCustomRingtones.size());
        ///@}
