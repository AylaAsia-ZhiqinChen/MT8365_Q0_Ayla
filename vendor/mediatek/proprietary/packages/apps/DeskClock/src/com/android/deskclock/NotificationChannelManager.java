 ...
 */
/// M: [ALPS03410273] [Notification Channel] This Class is to create and handle channel @{
...
public class NotificationChannelManager {
    ...
    @StringDef({ Channel.EVENT_EXPIRED, Channel.DEFAULT_NOTIFICATION })
    ...
    private static final String[] allChannels = new String[] {
            Channel.EVENT_EXPIRED, Channel.DEFAULT_NOTIFICATION };
