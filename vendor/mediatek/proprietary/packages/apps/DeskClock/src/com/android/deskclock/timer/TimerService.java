...
public final class TimerService extends Service {
    ...
    /// M: [ALPS02814395] [Porting from N] adds an extra minute to the unexpired timer @ {
        ...
        try {
            ...
            switch (action) {
                case ACTION_SHOW_TIMER: {
                    ...
                    break;
                /// M: [ALPS02814395] [Porting from N] Added handling for Add minute action
                /// for unepired timer @ {
                } case ACTION_ADD_MINUTE_TIMER_UNEXPIRED:
