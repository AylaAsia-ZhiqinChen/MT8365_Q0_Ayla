...
/**
 * AssistRadioResponse, handle RILrequest response.
...
public class AssistRadioResponse extends IAssistRadioResponse.Stub {
    ...
    public AssistRadioResponse(AssistRIL ril) {
        mAssistRIL = ril;
    }
    ...
    private void responseVoid(RadioResponseInfo responseInfo) {
        RILRequest rr = mAssistRIL.processResponse(responseInfo);
        if (rr != null) {
            if (responseInfo.error == RadioError.NONE) {
                sendMessageResponse(rr.mResult, null);
            }
            mAssistRIL.processResponseDone(rr, responseInfo, null);
        }
    }
}
