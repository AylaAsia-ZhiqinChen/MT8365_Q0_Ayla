...
public class OmacpReceiverService extends Service {
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            String NOTIFICATION_CHANNEL_ID = "omacp_notification_channel";
            ...
            int NOTIFICATION_ID = 126;

            startForeground(NOTIFICATION_ID,
                        new Notification.Builder(this, NOTIFICATION_CHANNEL_ID)
                            .setSmallIcon(R.drawable.status_notify) // any icon is fine
                            .build());
    ...
    private void handleOmacpReceived(Intent intent, int error) {
        ...
        try {
            ...
            if (uri != null) {
                ...
                SharedPreferences sh = this.getSharedPreferences("omacp", this.MODE_PRIVATE);
    ...
    private boolean handlePinVerify(Intent intent, byte[] intentData, NetWorkPinData pinData) {
        ...
        if (sec != null && (sec.equalsIgnoreCase("") || sec.equalsIgnoreCase("0")) && mac != null && !mac.equalsIgnoreCase("")) {
            ...
            String imsi = OmacpMessageSettingsDetail.getSimImsi(this, subId);
    ...
    private void parseOmacpMessage(Intent intent, byte[] intentData, ContentValues value, NetWorkPinData pinData) {
        ...
        if (((apList == null || apList.isEmpty()) && (napList == null || napList.isEmpty())
                ...
                && (imsParam == null || imsParam.mAppid == null)) {
            MTKlog.e(TAG, "OmacpReceiverService handleOmacpReceived parser error.");
            return;
        }

        int currentTime = (int) (System.currentTimeMillis() / 1000);
        String summary = getSavedSummary(apList, napList, imsParam);
        ...
        if (MTKlog.MORE_LOGS_ENABLE) {
            MTKlog.d(TAG, "OmacpReceiverService handleOmacpReceived from : " + sender + " "
                    + "service center is : " + serviceCenter + " " + "subId is : " + subId);
        }
        ...
        if (MTKlog.MORE_LOGS_ENABLE) {
            MTKlog.d(TAG, "parseOmacpMessage MAC is : " + mac + " " + "SEC is : " + sec +
                " MIMIE = " + intent.getType());
        }
    ...
    private String getSavedSummary(ArrayList<ApplicationClass> apList,
            ArrayList<NapdefClass> napList, ImsClass imsParam) {
        ...
        if (imsParam != null && imsParam.mAppid != null) {
            list.add("Ims");
        }
