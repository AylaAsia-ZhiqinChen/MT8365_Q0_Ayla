...
public class OmacpReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (intent != null) {
            ...
            if (action != null && (action.equals("android.intent.action.BOOT_COMPLETED") ||
                ...
                MTKlog.d(TAG, "OmacpReceiver onReceive : " + intent);
    ...
    public static void beginStartingService(Context context, Intent intent) {
        synchronized (STARTINGSERVICESYNC) {
            ...
            MTKlog.d(TAG, "OmacpReceiver starting service, sdk version = " + Build.VERSION.SDK_INT);
            if (Build.VERSION.SDK_INT >= 26) {
                MTKlog.d(TAG, "OmacpReceiver start ForegroundService[latest_code]");
