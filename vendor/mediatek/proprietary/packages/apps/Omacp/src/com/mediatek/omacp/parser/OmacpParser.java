...
public class OmacpParser {
    ...
    public void parse(byte[] data) {
        ...
        try {
            ...
            MTKlog.d(TAG, "OmacpParser parse eventType = " + eventType);
    ...
    private void getEndTagData(OmacpParserData omacpParserData) {
        ...
        if (omacpParserData.mName.equalsIgnoreCase("CHARACTERISTIC")) {
            ...
            MTKlog.d(TAG, "OmacpParser omacpParserData.mType = " + omacpParserData.mType);
            MTKlog.d(TAG, "OmacpParser omacpParserData.mListType = " + omacpParserData.mListType);
    ...
    private int getEventType() {
        ...
        MTKlog.d(TAG, "OmacpParser getEventType = " + eventType);
        return eventType;
    }
    ...
    private void getParserName(OmacpParserData omacpParserData) {
        ...
        MTKlog.d(TAG, "OmacpParser getParserName = " + omacpParserData.mName);
    }
    ...
    private void getCharacteristicParams(OmacpParserData omacpParserData) {
        ...
        if (omacpParserData.mType.equalsIgnoreCase("PXLOGICAL")) {
            ...
            omacpParserData.mListType = omacpParserData.mType;
        } else if (omacpParserData.mType.equalsIgnoreCase("Vodafone VoWiFi")) {
            // TODO: can add plugin to get string to be compared with mType
            if (mImsParam == null) {
                mImsParam = new ImsClass();
            }
            //mImsList.add(omacpParserData.mImsClass);
            //omacpParserData.mListType = omacpParserData.mType;
        } else {
    ...
    private void getParserUriAndType(OmacpParserData omacpParserData) {
        ...
        if (MTKlog.MORE_LOGS_ENABLE) {
            MTKlog.d(TAG, "OmacpParser getParserUriAndType = " + omacpParserData.mType);
        }
    }
    ...
    private void getAttributeParams(OmacpParserData omacpParserData) {
        ...
        // TODO: can add plugin api to get string to be compared with mType
        if (omacpParserData.mType != null
                && omacpParserData.mType.equalsIgnoreCase("Vodafone VoWiFi")) {
            OmacpParserUtils.handleImsParameters(omacpParserData.mType, omacpParserData.mParmName,
                    omacpParserData.mParmValue, mImsParam);
        }
    }
