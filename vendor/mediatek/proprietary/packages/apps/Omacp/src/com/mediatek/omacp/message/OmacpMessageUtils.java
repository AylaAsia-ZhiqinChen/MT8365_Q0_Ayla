...
public class OmacpMessageUtils {
    ...
    static final String IMS_APPID = "ims";
    ...
    public static ArrayList<String> getValidApplicationNameSet(Context context,
            ArrayList<ApplicationClass> apList, ArrayList<NapdefClass> napList, ImsClass imsApp) {
        ...
        if (imsApp != null && imsApp.mAppid != null) {
            list.add(context.getString(R.string.ims_app_name));
        }
    ...
    public static String getAppName(Context context, String appId) {
        ...
        } else if (appId.equalsIgnoreCase(IMS_APPID)) {
            name = context.getString(R.string.ims_app_name);
        } else {
    ...
    public static String getSummary(Context context, String savedSummary) {
        MTKlog.d(TAG, "OmacpMessageUtils savedSummary is : " + savedSummary);
        ...
        MTKlog.d(TAG, "OmacpMessageUtils getSummary is : " + summary);
        return summary;
    }
    ...
    public static SpannableStringBuilder getSettingsDetailInfo(Context context,
            ...
            ArrayList<ProxyClass> pxList, ImsClass imsApp) {
        ...
        if (apList != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                MTKlog.d(TAG, "OmacpMessageUtils getSettingsDetailInfo application is : "
                            + application);
        ...
        if (imsApp != null) { //IMS
            SpannableStringBuilder imsInfo = getImsSettingInfo(context, imsApp);
            if (imsInfo != null) {
                if (spannableDetailInfo.length() > 0) {
                    spannableDetailInfo.append("\n");
                }
                spannableDetailInfo.append(imsInfo);
            }
        }
    ...
    private static String getElement(Context context, String label, boolean capability, String value) {
        ...
        MTKlog.d(TAG, "OmacpMessageUtils getElement element = " + element);
        return element;
    }
    ...
    private static String getEmailSettingInfo(Context context, ApplicationClass application) {
        ...
        if (MTKlog.MORE_LOGS_ENABLE) {
            MTKlog.d(TAG, "OmacpMessageUtils getEmailSettingInfo = " + emailInfo.toString());
        }
    ...
    private static void appendEmailServerInfo(Context context, ApplicationClass application,
        ...
        if (application.mAppaddr.size() != 0 && application.mAppaddr.get(0).mPort.size() != 0
    ...
    private static String getEmailElement(Context context, String label, boolean outCapability,
        ...
        if (MTKlog.MORE_LOGS_ENABLE) {
            MTKlog.d(TAG, "OmacpMessageUtils getEmailElement = " + element);
        }
        return element;
    }
    ...
    private static SpannableStringBuilder getImsSettingInfo(Context context, ImsClass imsApp) {
        SpannableStringBuilder imsInfo = new SpannableStringBuilder();
        StringBuilder imsSettings = new StringBuilder();
        addApplicationLabel(context, imsInfo, IMS_APPID);

        if (imsApp.mFqdn != null) {
            imsSettings.append("\n");
            imsSettings.append(context.getString(R.string.ims_epdg_fqdn_label));
            imsSettings.append(imsApp.mFqdn);
        }
        imsInfo.append(imsSettings.toString());
        return imsInfo;
    }
    ...
    public static String getAPNType(ArrayList<ApplicationClass> apList) {
        ...
        if (MTKlog.MORE_LOGS_ENABLE) {
            MTKlog.d(TAG, "OmacpMessageUtils getAPNType apnType = " + apnType);
        }
        return apnType;
    }
