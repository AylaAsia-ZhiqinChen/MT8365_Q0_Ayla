...
public class Folder implements Parcelable, Comparable<Folder> {
    ...
    public static ObjectCursorLoader<Folder> forSearchResults(Account account, String query,
            /*M: add search field for remote search*/String field, String queryIdentifier, Context context) {
    ...
    /**
     * M: Returns true if this folder is syncable.(outbox should be syncable in current designing concept)
     * return false, Draft and Virtual mailbox.
     */
    public boolean isSyncable() {
        return !isDraft() &&
                !supportsCapability(FolderCapabilities.IS_VIRTUAL);
    }
