...
final class TwoPaneLayout extends FrameLayout implements ModeChangeListener,
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        /**
        * M: In portrait mode and the current conversation isn't null,also re-compute the overall layout@{
        */
        if (changed || (mController.getCurrentConversation() != null && !mShouldShowPreviewPanel)) {
            ...
            if ((mTranslatedMode != mCurrentMode || mController.getCurrentConversation() != null) && !mShouldShowPreviewPanel) {
