...
public class QuotedTextView extends LinearLayout implements OnClickListener {
    ...
    protected static final String BLOCKQUOTE_END = "</blockquote>";
    protected static final String QUOTE_END = "</div>";
    ...
    protected CharSequence mQuotedText;
    protected WebView mQuotedTextWebView;
    ...
    protected Button mRespondInlineButton;
    protected RespondInlineListener mRespondInlineListener;
    ...
    public interface RespondInlineListener {
        ...
        /* M: sanity check to truncated quoted text if needed.*/
        ...
        if (action == ComposeActivity.REPLY || action == ComposeActivity.REPLY_ALL) {
            ...
            quotedText
                    .append(String.format(
                            ...
                            Utils.cleanUpString(
                                    ...
                                    Address.fromHeaderToString(refMessage.getFrom()), true)));
            ...
            quotedText
                    .append(String.format(resources.getString(R.string.forward_attribution), Utils
                            .cleanUpString(Address.fromHeaderToString(refMessage.getFrom()),
                            ...
                            .cleanUpString(refMessage.subject,
                                    false /* don't remove empty quotes */), Utils.cleanUpString(
                                            Address.fromHeaderToString(refMessage.getTo()), true)));
            /** M: Unpack packed Address Strings for better human readable if cc is not empty */
            String ccAddresses = Address.fromHeaderToString(refMessage.getCc());
