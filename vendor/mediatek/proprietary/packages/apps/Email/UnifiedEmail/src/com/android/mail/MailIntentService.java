...
public class MailIntentService extends IntentService {
    ...
    protected void onHandleIntent(final Intent intent) {
        ...
        LogUtils.d(LOG_TAG, "Handling mail intent %s", intent);

        final String action = intent.getAction();
        EmailApplication.checkAndStartForeground(this, 8, "MailIntentService, onHandleIntent");
        ...
        EmailApplication.checkAndStopForeground(this, "MailIntentService, onHandleIntent");
    }
    ...
    public static void broadcastBackupDataChanged(final Context context) {
        ...
        EmailApplication.checkAndStartForegroundService(context, intent, "broadcastBackupDataChanged");
    }
