...
public class NotificationActionUtils {
    ...
    public static class NotificationAction implements Parcelable {
        ...
        public NotificationAction(final NotificationActionType notificationActionType,
                ...
                final long localMessageId, final long when, final int source, final int notificationId) {
    ...
    public static Notification createUndoNotification(final Context context,
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context, NOTIFICATION_CHANNEL_UNDO);
    ...
    public static void resendNotifications(final Context context, final Account account,
        ...
        EmailApplication.checkAndStartForegroundService(context, intent, "resendNotifications");
    }
    ...
    // Notification Channel implementation for FG services, VIP and Undo notifications  
    public static final String FOREGROUND_SERVICE_CHANNEL_ID = "foreground_service_notif_channel";
    public static final String NOTIFICATION_CHANNEL_VIP= "email_notification_channel_vip";
    public static final String NOTIFICATION_CHANNEL_UNDO= "email_notification_channel_undo";

    public static void initNotificationChannels(Context context) {
        LogUtils.e(LOG_TAG, "initNotificationGroup");
        NotificationManager notificationManager =
            (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
        
        // FG Service Notification Channel
        CharSequence name = "Email Services";
        NotificationChannel mChannelFG = new NotificationChannel(
                            FOREGROUND_SERVICE_CHANNEL_ID,
                            name,
                            NotificationManager.IMPORTANCE_LOW);
        
        // VIP Notification Channel
        name = "VIP Notifications";
        NotificationChannel mChannelVip = new NotificationChannel(
                            NOTIFICATION_CHANNEL_VIP,
                            name,
                            NotificationManager.IMPORTANCE_DEFAULT);

        // Undo Notification Channel
        name = "Mute Notifications";
        NotificationChannel mUndoChannel = new NotificationChannel(
                            NOTIFICATION_CHANNEL_UNDO,
                            name,
                            NotificationManager.IMPORTANCE_LOW);

        notificationManager.createNotificationChannel(mChannelFG);
        notificationManager.createNotificationChannel(mChannelVip);
        notificationManager.createNotificationChannel(mUndoChannel);
    }
    
    public static void initEmailNotificationChannel(Context context, String id, String name) {
    ...
    public static void deleteEmailNotificationChannel(Context context, String channelId) {
        NotificationManager notificationManager = (NotificationManager) context.
                                getSystemService(Context.NOTIFICATION_SERVICE);
    ...
    public static Notification getForegroundServiceNotification(Context context) {
        String title = "Email Service";
        String content = "Email syncing mails";
        LogUtils.e(LOG_TAG, "getForegroundServiceNotification, title = " + title +
                                "content = " + content);
        Notification notice = new Notification.Builder(context, FOREGROUND_SERVICE_CHANNEL_ID)
