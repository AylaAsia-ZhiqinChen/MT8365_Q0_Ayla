...
public class Attachment implements Parcelable {
    ...
    public Attachment(JSONObject srcJson) {
        ...
        /// M: Keep the String as it is. eg, original is null, return null; or "xxx", return "xxx";
        providerData = srcJson.optString(AttachmentColumns.PROVIDER_DATA , null);
    ...
    public Attachment(Context context, Part part, Uri emlFileUri, String messageId, String cid,
        ...
        try {
            ...
            /** @} */
            /**
             * M: For inline attachment in eml,we must get the correct cid with the webView may use
             * it.Fortunately,the mimeMessage with the eml is encoded with base64codes,and it has
             * the full attachment info so that we can use. @{
             */
            String contentId = part.getContentId();
            if (!TextUtils.isEmpty(contentId)) {
                cid = contentId;
                LogUtils.i(LOG_TAG, "Found the inline attachment in EML,and its ContentId: %s",
                        contentId);
            }
            /** @} */
        ...
        try {
            ...
            if (providerData != null) {
                try {
                    ...
                    LogUtils.e(LOG_TAG, "JSONException when adding provider data");
                }
            }
