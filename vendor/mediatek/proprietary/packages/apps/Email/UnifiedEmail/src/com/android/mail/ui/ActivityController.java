...
public interface ActivityController extends LayoutListener,
    ...
    /**
     * M: Returns the current conversation list context.
     */
    ...
    void updatePermissionGrantState(boolean granted);
    boolean getPermissionGrantState();
    void addToFragmentList(Fragment fragment);
    boolean isControllerFinishing();
}
