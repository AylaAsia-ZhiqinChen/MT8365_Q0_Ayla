...
public class ConversationViewAdapter extends BaseAdapter {
    ...
    public class ConversationHeaderItem extends ConversationOverlayItem {
        private Conversation mConversation; /// M: make invisible
        ...
        public View createView(Context context, LayoutInflater inflater, ViewGroup parent) {
            ...
            /// M: Align with other places, ie. {@link ConversationViewHeader#onConversationUpdated}
        ...
        /**
         * M: Set converstaion for this item
         * @param c
         */
        ...
        /**
         * M: Get conversation for this item
         * @return
         */
    ...
    public static class MessageFooterItem extends ConversationOverlayItem {
        ...
        public void bindView(View v, boolean measureOnly) {
            ...
            /** M: Modified for partial download function. @{ */
            final ConversationMessage message = mHeaderItem.getMessage();
            attachmentsView.bind(mHeaderItem, measureOnly, message.hasAttachments);
            /** @} */
            mRootView = v;
        }
    ...
    public View getView(ConversationOverlayItem item, View convertView, ViewGroup parent,
        ...
        /// M: Set parent view for the item here to do future pre-draw measure @{
        item.mParentView = parent;
        /// @}
