...
public class MailboxSelectionActivity extends AppCompatActivity implements OnClickListener,
    ...
    public void onCreate(Bundle icicle) {
        ...
        /// M: Init loader and show wait fragment if we are waiting for account sync.
    ...
    private void updateAccountList(final Cursor accounts) {
        ...
        if (displayAccountList) {
            /// M: when we have finished adding account action and loading account,
            //  mWaitingForAddAccountResult should restore to false.
