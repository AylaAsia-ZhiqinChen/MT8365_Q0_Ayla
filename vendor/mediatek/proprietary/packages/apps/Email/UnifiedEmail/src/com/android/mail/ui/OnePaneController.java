...
public class OnePaneController extends AbstractActivityController {
    ...
    protected void showConversationList(ConversationListContext listContext) {
        ...
        if (mActivity.isDestroyed()) {
            LogUtils.d(LOG_TAG, "activity(%s) is destroyed, do nothing", mActivity);
            return;
        }
        /** @} */
        enableCabMode();
    ...
    public boolean handleBackPress() {
        ...
        if (mode == ViewMode.SEARCH_RESULTS_LIST) {
            mActivity.finish();
                ...
                && /*M: and the inbox must be existed*/
                !Settings.getDefaultInboxUri(mAccount.settings).equals(Uri.EMPTY)) {
    ...
    public boolean shouldShowSearchBarByDefault(int viewMode) {
        ...
        return /*viewMode == ViewMode.SEARCH_RESULTS_LIST*/ false;
    }
