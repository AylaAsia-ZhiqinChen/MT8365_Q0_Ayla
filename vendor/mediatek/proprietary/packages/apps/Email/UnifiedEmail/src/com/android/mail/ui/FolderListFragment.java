...
public class FolderListFragment extends ListFragment implements
    ...
    public void onActivityCreated(Bundle savedState) {
        ...
        if (mVipMemberObserver == null) {
            ...
            mVipMemberObserver.register(VipMember.UIPROVIDER_VIPMESSAGES_NOTIFIER);
        }
        /** @} */
    ...
    public Loader<ObjectCursor<Folder>> onCreateLoader(int id, Bundle args) {
        ...
        LogUtils.d(LOG_TAG, "onCreateLoader Loader Uri [%s]", folderListUri);
    ...
    private interface FolderListFragmentCursorAdapter extends ListAdapter {
        ...
        /** M: add for saving message count of vip folder*/
    ...
    private class FolderAdapter extends BaseAdapter implements FolderListFragmentCursorAdapter {
        ...
        /// M: add for saving messages count of vip folder.
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            /** M: VIP folder item view, special way to update vip number.@{ */
            if (item.getType() == DrawerItem.VIEW_FOLDER && item.mFolder.isType(UIProvider.FolderType.VIP)) {
        ...
        private List<DrawerItem> recalculateListFolders() {
            ...
            LogUtils.d(LOG_TAG,
                    "recalculateListFolders current size [%s], cursor.size [%s] ",
                    itemList.size(), mCursor.getCount());
            if (mIsDivided) {
        ...
        private List<DrawerItem> recalculateDividedListFolders(List<DrawerItem> itemList) {
            ...
            LogUtils.d(LOG_TAG, "Add inboxes heads, inbox size [%d]", inboxFolders.size());
            ...
            LogUtils.d(LOG_TAG, "Add remaining heads, folder size [%d]", allFoldersList.size());
    ...
    private class HierarchicalFolderListAdapter extends ArrayAdapter<Folder>
        ...
        /* M: (non-Javadoc)
         * @see com.android.mail.ui.FolderListFragment.FolderListFragmentCursorAdapter#setVipFolderCount(int)
         */
        @Override
        public void setVipFolderCount(int count) {
            // do nothing.
    ...
    private void setSelectedFolder(Folder folder) {
        ...
        LogUtils.d(LOG_TAG, "FolderListFragment.setSelectedFolder(folder) called!, %s", folder.toString());
