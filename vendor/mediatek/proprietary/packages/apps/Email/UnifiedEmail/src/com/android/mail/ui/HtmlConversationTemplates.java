...
//        return sb.toString();
    ...
    public String endConversation(int convFooterPx, String docBaseUri, String conversationBaseUri,
        ...
        ///M:[ALPS02694147] Move this to script.js
        ...
        ///M:[ALPS02694147] remove className object as it removed from HTML
        append(sConversationLower, convFooterPx,
        ...
        LogUtils.d(TAG, "rendered conversation of %d bytes, buffer capacity=%d, docBaseUri %s",
                mBuilder.length() << 1, mBuilder.capacity() << 1, docBaseUri);
