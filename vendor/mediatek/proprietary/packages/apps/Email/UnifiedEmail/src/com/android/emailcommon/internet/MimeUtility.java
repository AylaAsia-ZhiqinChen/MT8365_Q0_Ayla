...
public class MimeUtility {
     ...
     */
    public static final int FETCH_BODY_SIZE_LIMIT = EmailFeatureOptions.LAEGE_BODY_ENHANCEMENT ?
                                                5 * 1024 * 1024 : (1 * 1024 * 1024 + 512 * 1024);
    ...
    /// M: MIME-TYPE for special text/calendar to be better recognized
        ...
        try {
            if (part != null && part.getBody() != null) {
                ...
                if (mimeType != null && MimeUtility.mimeTypeMatches(mimeType, "text/*")) {
                    ...
                    /// M: ALPS02069299, there's a case that charset might be "" and then will
                     // unexpectly get MS950_HKSCS from the charset map
    ...
    public static void collectParts(Part part, ArrayList<Part> viewables,
        ...
        } else if (inline && (mimeType.startsWith("text/plain") || mimeType.startsWith("text/html")
                || (mimeType.startsWith("image")
                        /// M: treat images w/o content id as common attachments
                        && !TextUtils.isEmpty(part.getContentId())))) {
            // We'll treat text and images as viewables
            /// M: don't treat all text/* as viewables, such as text/calendar.
            viewables.add(part);
        } else {
