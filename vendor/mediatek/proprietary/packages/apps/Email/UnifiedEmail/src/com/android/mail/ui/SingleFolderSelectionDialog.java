...
public class SingleFolderSelectionDialog extends FolderSelectionDialog {
    ...
    /// M: Avoid confusion with other loader's id which cause
    /// the wrong loader is used and wrong data is returned.
    private static final int FOLDER_LOADER_ID = 100;
    ...
    protected void onListItemClick(int position) {
        ...
        if (item instanceof FolderRow) {
            ...
            ConversationUpdater cu = getConversationUpdater();
            /// M: add null checking here.
            if (cu != null) {
                cu.assignFolder(ops, mTarget, mBatch, true /* showUndo */, true /* isMoveTo */);
                dismiss();
            }
        }
    }
