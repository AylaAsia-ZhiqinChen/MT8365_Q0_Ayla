...
public class SelectedConversationsActionMenu implements ActionMode.Callback,
    ...
    public void onDestroyActionMode(ActionMode mode) {
        ...
        if (mActivated) {
            ...
            /// M: Refresh conversation list when exit action mode
            mUpdater.refreshConversationList();
        }
    }
    ...
    private void destroy() {
        ...
        clearChecked();
        /** M: not refresh conversation list here. */
        //mUpdater.refreshConversationList();
    ...
    /**
     * M:Update action menu(extract from updateSelection). not refresh conversation
     * list here. The refresh will notify data change to list view, that will
     * effect AbsListView handle touch event(e.g call onListItemClick after
     * onItemLongClick when long press list item ).
     */
