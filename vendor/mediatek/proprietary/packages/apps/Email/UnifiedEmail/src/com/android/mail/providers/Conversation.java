...
public class Conversation implements Parcelable {
    ...
    /**
     * M: Before to do compare the two conversation URI, it should remove the
     * conversation provider authority "com.android.email.conversation.provider"
     * firstly, otherwise it would be got a error result.
     *
     * @{
     */
    @Override
    public boolean equals(Object o) {
        if (o instanceof Conversation) {
            ...
            Uri self = ConversationCursor.uriFromCachingUri(uri);
            Uri in = ConversationCursor.uriFromCachingUri(conv.uri);
            return in.equals(self);
        }
        return false;
    }
    // @}
