...
public class EmailConversationCursor extends CursorWrapper implements
    ...
    /// M: Clear unseen message selection
    public static final String CLEAR_UNSEEN_SELECTION = EmailContent.MessageColumns.MAILBOX_KEY
            + " = ? AND " + EmailContent.MessageColumns.FLAG_SEEN + " != ?";
    ...
    public EmailConversationCursor(final Context context, final Cursor cursor,
        ...
        if (mailbox != null) {
            ...
            /** M: Recoder the value. @{ */
            if ((mailbox.mFlags & Mailbox.FLAG_ALL_MESSAGES_DOWNLOADED)
                    == Mailbox.FLAG_ALL_MESSAGES_DOWNLOADED) {
            ...
            LogUtils.d(LogUtils.TAG,
                    " EmailConversationCursor : mailbox.mUiSyncStatus : %d," +
                    " System.currentTimeMillis() - mailbox.mSyncTime : %s," +
                    " mailbox.mSyncInterval: %d, mailbox.mUiLastSyncResult: %d," +
                    "mailbox.mServerId : %s",
                    mailbox.mUiSyncStatus, (System.currentTimeMillis() - mailbox.mSyncTime),
                    mailbox.mSyncInterval, mailbox.mUiLastSyncResult, mailbox.mServerId);
            if (mailbox.mUiSyncStatus == EmailContent.SYNC_STATUS_BACKGROUND
                ...
                /**
                 * M: Note the code. The code just let UI display loading
    ...
    public void markContentsSeen() {
        ...
        /// M: Clear unseen message selection
        resolver.update(uri, contentValues, CLEAR_UNSEEN_SELECTION, selectionArgs);
    }
