...
public class EmailBroadcastProcessorService extends IntentService {
    ...
    public static void processBroadcastIntent(Context context, Intent broadcastIntent) {
        ...
        EmailApplication.checkAndStartForegroundService(context, i, "processBroadcastIntent");
    }
    ...
    public static void processUpgradeBroadcastIntent(final Context context) {
        ...
        //context.startService(i);
        EmailApplication.checkAndStartForegroundService(context, i, "processUpgradeBroadcastIntent");
    }
    ...
    public static void processDevicePolicyMessage(Context context, int message) {
        ...
        //context.startService(i);
        EmailApplication.checkAndStartForegroundService(context, i, "processDevicePolicyMessage");
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        EmailApplication.checkAndStartForeground(this, 14, "onHandleIntent");
        if (ACTION_BROADCAST.equals(action)) {
            ...
            if (Intent.ACTION_BOOT_COMPLETED.equals(broadcastAction)) {
                ...
                EmailApplication.checkAndStartForegroundService(this, broadcastIntent, "onHandleIntent");
            /** M: The number of unread Email is also displayed after you clear data. @{*/
        ...
        EmailApplication.checkAndStopForeground(this, "EmailBroadcastProcessorService, onHandleIntent");
    }
    ...
    private void onBootCompleted() {
        ...
        EmailNotificationController.notifyEmailUnreadNumber(this, unreadCount);
        /**@}*/
    }
    ...
    private void onSettingsPackageClearData() {
        LogUtils.d(Logging.LOG_TAG,
                "!!!onSettingsPackageClearData: Do nothing unread count support removed !! " );

        /// M: ReconcileAccounts after receiving the action of
        // "com.mediatek.intent.action.SETTINGS_PACKAGE_DATA_CLEARED"

        // Since L version email will backup account to system account,
        // remove system account to make sure email account will be cleared.
        List<android.accounts.Account> amAccounts = AccountReconciler
                .getAllAmAccounts(this);
        for (android.accounts.Account amAccount : amAccounts) {
            // Delete the account
            AccountManagerFuture<Boolean> blockingResult = AccountManager.get(
                    this).removeAccount(amAccount, null, null);
            try {
