...
public class WidgetProvider extends BaseWidgetProvider {
    ...
    public static WidgetProvider registerReceivers(Context context) {
        WidgetProvider receiver = new WidgetProvider();
        LogUtils.e(LOG_TAG, "registerReceivers");
        IntentFilter intentFilter = new IntentFilter();
        intentFilter.addAction(BaseWidgetProvider.ACTION_UPDATE_WIDGET);
        intentFilter.addAction(Intent.ACTION_DATE_CHANGED);
        intentFilter.addAction(Intent.ACTION_TIME_CHANGED);
        intentFilter.addAction(Utils.ACTION_NOTIFY_DATASET_CHANGED);
        intentFilter.addAction(BaseWidgetProvider.ACTION_VALIDATE_ALL_WIDGETS);
        intentFilter.addAction(AppWidgetManager.ACTION_APPWIDGET_UPDATE);
        try {
        intentFilter.addDataType(context.getString(R.string.application_mime_type));
        } catch (MalformedMimeTypeException e) {
            LogUtils.wtf(LOG_TAG, "Malformed mimetype: %s", context.getString(R.string.application_mime_type));
        }
