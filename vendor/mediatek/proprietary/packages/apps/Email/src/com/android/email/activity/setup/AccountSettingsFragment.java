...
public class AccountSettingsFragment extends MailAccountPrefsFragment
    ...
    private void loadSettings() {
        ...
        if (mInboxFolderPreferences != null) {
            ...
            */
          /* M: Notification channel Changes start for Ringtone -> Ringtone -Notification category
           *
           */
            mInboxRingtone.setOnPreferenceChangeListener(this);
            mInboxRingtone.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(final Preference preference) {
                     ...
                     //LogUtils.d(LogUtils.TAG, "Go to system notification setting, packages=" + packageName + ", id = " + id);

                     Intent intent = new Intent(Settings.ACTION_CHANNEL_NOTIFICATION_SETTINGS);
                     intent.putExtra(Settings.EXTRA_APP_PACKAGE, packageName);
                     intent.putExtra(Settings.EXTRA_CHANNEL_ID, mAccount.getEmailAddress());
                     startActivity(intent);  // Lanch the Notification category for Email
                     return true;
                }
            });
          /* END */
            ...
            /* Notification channel Changes start for Ringtone -> Ringtone -Notification category
             * Start 
             */
