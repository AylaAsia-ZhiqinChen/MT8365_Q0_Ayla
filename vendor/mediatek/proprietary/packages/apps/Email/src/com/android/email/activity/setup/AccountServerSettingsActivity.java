...
public class AccountServerSettingsActivity extends AccountSetupActivity implements
    ...
    public void onBackPressed() {
        ...
        /** M: add oof features @{ */
            ...
            long accountId = mSetupData.getAccount() != null ? mSetupData.getAccount().mId : -1;
            if (accountId > 0) {
                final EmailServiceProxy proxy = EmailServiceUtils
                        .getServiceForAccount(this, accountId);
                try {
                    ...
                    .setPositiveButton(
                            ...
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    /**M: Check the activiyt state to avoid call onBackPressed
                                     * after onSaveInstanceState cause IllegalArgumentException @{*/
                                    if (activity.isResumed()) {
                                        activity.forceBack();
                                    } else {
                                        LogUtils.d(TAG,
                                                "onClick is called after onPause,just ignore");
                                    }
