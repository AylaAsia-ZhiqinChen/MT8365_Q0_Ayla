...
public class SmartPushService extends Service implements Runnable {
    ...
    private static void startSmartPushService(Context context) {
        ...
        context.startService(new Intent(context, SmartPushService.class));
                ...
                Logging.d(TAG, "startSmartPushService killed, unable to start service due to illegal state");
                return;
            }
    }
    ...
    public void run() {
        ...
        try {
            while (!sStop) {
                Logging.d(TAG, "SmartPushService loop one time");
                runAwake();
...
try {
            startService(new Intent(this, SmartPushService.class));
                ...
                Logging.d(TAG, "smartpush run killed, unable to start service due to illegal state");
                return;
            }
            //startService(new Intent(this, SmartPushService.class));
        } finally {
    ...
    private long shouldRunSmartPushService() {
        ...
        Logging.d(TAG, "Today start time: " + sTodayStartTime);
        mAccountMap.clear();
...
//        }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (Utility.mayLowStorage() ||
            ...
            Logging.d(TAG, "Stops service in the low storage mode");
            stopSelf();
    ...
    public void onCreate() {
        ...
        EmailAsyncTask.runAsyncParallel(new Runnable() {
            ...
            try {
                ...
                Logging.d(TAG, "smartpush onCreate killed, unable to start service due to illegal state");
                return;
            }
                    //startService(new Intent(SmartPushService.this, SmartPushService.class));
                    if (sStop) {
