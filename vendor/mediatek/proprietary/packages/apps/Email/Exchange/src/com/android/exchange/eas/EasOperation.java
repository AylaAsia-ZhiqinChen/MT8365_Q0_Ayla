...
public abstract class EasOperation {
    ...
    /** M: Error code indicating sync operation await failed, only skip it not notify others */
    public static final int RESULT_SYNC_INTERRUPT = -110;
     ...
     * @return
     */
    protected boolean tryProvision() {
        final EasProvision provisionOperation = new EasProvision(this);
        return provisionOperation.provision();
    }
