...
public abstract class Recycler {
    ...
    private static final String TAG = "AppServiceRecycler";
    ...
    public void deleteOldMessagesByThreadId(Context context, final long threadId) {
        ...
        if (!MmsConfig.isAutoDeleteEnabled()) {
            return;
        }
        sExecutor.execute(new Runnable() {
            @Override
            public void run() {
                deleteMessagesForThread(context, threadId, getMessageLimit());
            }
        });
    }

    abstract public int getMessageLimit();
    ...
    public static class SmsRecycler extends Recycler {
        ...
        public int getMessageLimit() {
            return MmsConfig.getSmsLimitPerThread();
        }
        ...
        protected void deleteMessagesForThread(Context context, long threadId, int keep) {
            ...
            try {
                ...
                if (LOCAL_DEBUG) {
                    Log.v(TAG, "SMS: deleteMessagesForThread count: " + count +
    ...
    public static class MmsRecycler extends Recycler {
        ...
        public int getMessageLimit() {
            return MmsConfig.getMmsLimitPerThread();
        }
    ...
    public static class WapPushRecycler extends Recycler {
        ...
        public int getMessageLimit() {
            return getSmsRecycler().getMessageLimit();
        }
        ...
        public void deleteOldMessages(Context context) {
            ...
            if (!sAutoDeleteRun) {
                ...
                try {
                    final int limit = getMessageLimit();
