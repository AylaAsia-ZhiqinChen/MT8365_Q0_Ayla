...
import static com.mediatek.pushparser.si.SiMessage.ACTION_DELETE;
import static com.mediatek.pushparser.si.SiMessage.ACTION_HIGH;
import static com.mediatek.pushparser.si.SiMessage.ACTION_LOW;
import static com.mediatek.pushparser.si.SiMessage.ACTION_MEDIUM;
import static com.mediatek.pushparser.si.SiMessage.ACTION_NONE;
import static com.mediatek.pushparser.si.SiTextParser.INDICATION;
import static com.mediatek.pushparser.si.SiTextParser.SI;
                    ...
                    case XmlPullParser.START_TAG:
                        ...
                        if (SI.equalsIgnoreCase(name)) {
                            ...
                            if (siMsg != null) {
                                ...
                                siMsg.create = SiDateDecoderUtil.WbXmlDateDecoder(
                                        parser.getAttributeValue(uri, "created"));
                                siMsg.expiration = SiDateDecoderUtil.WbXmlDateDecoder(
                                        parser.getAttributeValue(uri, "si-expires"));
