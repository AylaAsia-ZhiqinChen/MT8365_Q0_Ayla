...
public class VCardAttachment {
    ...
    public String getTextVCardString(long[] contactsIds, String textVCard) {
        ...
        MmsLog.ipi(TAG, "contactsIds.length() = " + contactsIds.length
    ...
    public String getVCardString(Cursor cursor, String textVCard) {
        ...
        MmsLog.ipi(TAG, "textVCard= " + textVCard);
        return textVCard;
    }

    public String getVCardFileNameByContactsId(long[] contactsIds) {
        MmsLog.dpi(TAG, "getVCardFileNameByContactsId(): contactsIds = " + contactsIds);
        ...
        try {
            ...
            try {
                ...
                while (!composer.isAfterLast()) {
                    builder.append(composer.createOneEntry());
                }
