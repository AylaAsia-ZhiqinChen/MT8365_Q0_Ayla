...
public class TransactionBundle {
     ...
     */
//mem slim    private static final String PUSH_DATA = "mms-push-data";

    /**
     * Key of the MMSC server URL.
     */
//mem slim    private static final String MMSC_URL = "mmsc-url";

    /**
     * Key of the HTTP Proxy address.
     */
//mem slim    private static final String PROXY_ADDRESS = "proxy-address";

    /**
     * Key of the HTTP Proxy port.
     */
//mem slim    private static final String PROXY_PORT = "proxy-port";
     ...
     * startService.
     */
//mem slim    private final Bundle mBundle;
