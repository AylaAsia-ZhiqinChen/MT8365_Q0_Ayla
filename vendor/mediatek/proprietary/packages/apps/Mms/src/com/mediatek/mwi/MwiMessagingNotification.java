...
public class MwiMessagingNotification {
    ...
    private static final String[] MWI_STATUS_PROJECTION = new String[] {
            MtkMwi._ID, MtkMwi.MSG_DATE, MtkMwi.SUBJECT, MtkMwi.FROM};
...
//        sNotificationSet.clear();
    ...
    private static void addMwiNotificationInfos(
        ...
        try {
            while (cursor.moveToNext()) {
                ...
                MmsLog.dpi(TAG, "addMwiNotificationInfos info = " + info);
    ...
    private static void updateNotification(
        ...
        MmsLog.dpi(TAG, "updateNotification notify notification = " + notification);
