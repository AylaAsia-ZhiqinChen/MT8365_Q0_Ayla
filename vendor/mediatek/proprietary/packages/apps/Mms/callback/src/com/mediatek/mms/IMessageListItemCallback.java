...
public interface IMessageListItemCallback {

    /**
     * callback setSubDateView
     * @param subName: subName
     */
    public void setSubDateView(String subName);

    /**
     * callback setTextMessage
     * @param body: body
     */
    public void setTextMessage(String body);

    /**
     * callback updateMessageItemState
     * @param msgId: msgId
     */
    ...
    void hideFileAttachmentViewIfNeededCallback();
    ...
    String buildTimestampLineCallback(String time);
}
