...
public class CalendarAppWidgetService extends RemoteViewsService {
    ...
    public static class CalendarFactory extends BroadcastReceiver implements
        ...
        public static final String CALENDAR_PROVIDER_CUSTOM_INTENT = "CalendarProvider2.intent.action.PROVIDER_CHANGED";
        ...
        public void onCreate() {
            ...
            intentFilter = new IntentFilter(CALENDAR_PROVIDER_CUSTOM_INTENT);
            calendarFactory = new CalendarFactory();
            mContext.getApplicationContext().registerReceiver(calendarFactory, intentFilter);
