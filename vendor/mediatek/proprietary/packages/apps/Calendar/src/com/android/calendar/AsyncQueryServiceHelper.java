...
public class AsyncQueryServiceHelper extends JobIntentService {
    ...
    static public void queueOperation(Context context, OperationInfo args) {
        ...
        JobIntentService.enqueueWork(context, AsyncQueryServiceHelper.class, JOB_ID,
                                     new Intent(context, AsyncQueryServiceHelper.class));
    }
                ...
                case Operation.EVENT_ARG_QUERY:
                    ...
                    try {
                        ...
                        if (cursor != null) {
                            ...
                            LogUtil.oi(TAG, "the query count=" + count);
                        } else {
                            LogUtil.oi(TAG, "the query result cursor is null");
                        }
                    } catch (Exception e) {
