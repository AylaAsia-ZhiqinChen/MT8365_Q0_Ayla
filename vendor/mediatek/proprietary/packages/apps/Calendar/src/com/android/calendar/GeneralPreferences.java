...
public class GeneralPreferences extends PreferenceFragment implements
    ...
    public static final String KEY_ALERTS_NOTIFICATION_CHANNEL = "preferences_notification_channel";
...
//        }
        ...
        mNotificationChannel = (Preference) findPreference(KEY_ALERTS_NOTIFICATION_CHANNEL);
        mNotificationChannel.setSummary(R.string.notification_channel_settings_summary);
      ...
      mNotificationChannel.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {

                    String packageName = getActivity().getPackageName();
                    String id = AlertService.DEFAULT_CHANNEL_ID;
                    Log.d(TAG, "OnPreferenceClickListener package=" + packageName + ", id = " + id);
    ...
    private void setPreferenceListeners(OnPreferenceChangeListener listener) {
        ...
        mNotificationChannel.setOnPreferenceChangeListener(listener);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mUseHomeTZ) {
            ...
            mDefaultReminder.setSummary(mDefaultReminder.getEntry());
        } else if (preference == mNotificationChannel) {
            Log.d(TAG, "onPreferenceChange mNotificationChannel");
            }
        else {
            return true;
        }
    ...
    private void updateChildPreferences() {
        if (mAlert.isChecked()) {
            ...
            mPopup.setEnabled(true);
            mNotificationChannel.setEnabled(true);
        } else {
            //mVibrate.setEnabled(false);
            //mRingtone.setEnabled(false);
            mPopup.setEnabled(false);
            mNotificationChannel.setEnabled(false);
        }
    }
    ...
    public void onTimeZoneSet(TimeZoneInfo tzi) {
        if (!checkPermissions()) {
            Intent myIntent = new Intent(getActivity(), PermissionDeniedActivity.class);
            myIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(myIntent);
            return;
        }
