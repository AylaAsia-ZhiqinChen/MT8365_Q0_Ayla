...
public class EditEventView implements View.OnClickListener, DialogInterface.OnCancelListener,
        ...
        public void onClick(View v) {
            ...
            if (dialog != null && !dialog.isAdded()) {
                try {
                    ...
                    LogUtil.d(TAG, "FRAG_TAG_TIME_PICKER status= ");
                }
            }
        }
    }
    ...
    private class DateListener implements OnDateSetListener,
        ...
        private void onDateSetImpl(int year, int month, int monthDay) {
            ...
            // reset
            updateHomeTime();
            //user has done with datetime so make picker null & mshowdatepicker as false
            mShowDatePicker = false;
            mDatePickerDialog = null;
            Log.d(TAG, "onDateSet: exit making datepicker null & false as user selected done");
        }
        ...
        public void onCancelDialog() {
            ...
            mShowDatePicker = false;
            mDatePickerDialog = null;
            Log.d(TAG, "onCancelDialog: exit making datepicker null & false as dialog");
        }
    }
    ...
    private void showTimezoneDialog() {
        ...
        try {
            ...
            LogUtil.d(TAG, "FRAG_TAG_TIME_ZONE_PICKER status= ");
        }
    }
    ...
    private class DateClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            /// dialog window jump caused by IME window resize.
            hideInputMethod();
            createDatePickerDialog(listener, mTime.year, mTime.month, mTime.monthDay);        }
    }
    ...
    Log.d(TAG, "[Calendar] prepareForSave() of EditEventView");
    ...
    public void onClick(View view) {
        if (view == mRruleButton) {
            ...
            Time startTime = new Time(mStartTime);
            Time endTime = new Time(mEndTime);
            startTime.hour = 0;
            startTime.minute = 0;
            startTime.second = 0;
            endTime.hour = 0;
            ...
            b.putLong(RecurrencePickerDialog.BUNDLE_START_TIME_MILLIS,
                ...
                */
            b.putLong(RecurrencePickerDialog.BUNDLE_EVENT_TIME_DURATION,
               (endTime.toMillis(false) - startTime.toMillis(false) + DateUtils.DAY_IN_MILLIS));
            }
    ...
    private boolean fillModelFromUI() {
        ...
        Log.d(TAG, "[Calendar] fillModelFromUI() of EditEventView");
    ...
    public EditEventView(Activity activity, View view, EditDoneRunnable done,
        ...
        ///M: #extension# @{
        mEditEventViewExt = OpCalendarCustomizationFactoryBase.getOpFactory(activity)
                .makeEditEventCalendar(activity);
        ///@}
        ...
        mLocationTextView.setOnEditorActionListener(new OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_DONE) {
                    ...
                    LogUtil.v(TAG, "click IME_ACTION_DONE in LocationTextView " +
...
//            mDatePickerDialog.setOnDateSetListener(new DateListener(v));
    ...
    private void setDate(TextView view, long millis) {
        ...
        synchronized (TimeZone.class) {
            ...
            dateString = mEditEventViewExt.getDateStringFromMillis(mActivity, millis);
            ///@}
...
///M: MTK code below
    ...
    private void setExtUI(CalendarEventModel model) {
        ...
        Log.d(TAG, "setExtUI radioGroup = " + radioGroup + "mExt = " + mEditEventViewExt);
        mEditEventViewExt.setDatePickerSwitchUi(mActivity, mModel, mStartDateButton, mEndDateButton,
                mTimezone,mStartTime, mEndTime);
        ///@}
    ...
    private void restoreDatePickerDialog() {
        ...
        if(isScreenOn()){
            Log.d(TAG, "[Calendar] isScreenOn() is true: ");
        mShowDatePicker = false;
        }else
        {
            Log.d(TAG, "[Calendar] isScreenOn() is false: ");
        }
    }
    ...
    public void createDatePickerDialog(DateListener listener, int year, int month, int monthDay) {
        if (mActivity.isResumed()) {
            mDatePickerDialog = mEditEventViewExt.createDatePickerDialog(mActivity, listener, year,
            month, monthDay);
            Log.d(TAG, " createDatePickerDialog() mDatePickerDialog: " + mDatePickerDialog);
    ...
    private static String getDefaultRruleByFrequecy(int frq, int weekDay) {
        ...
        case EventRecurrence.WEEKLY:
            return (DEFAULT_REPEAT_RULE_WEEKLY + weekday2String(weekDay));
        case EventRecurrence.MONTHLY:
    ...
    int mSelectedDate[] = {1971, 1, 1};        // which day is selected in DatePickerDialog

    public void dismissDatePickerDialog() {
        boolean checkstatus = mActivity.isResumed();
        LogUtil.oi(TAG, "dismissDatePickerDialog status= "+checkstatus);
        if (mDatePickerDialog != null) {
            LogUtil.oi(TAG, "do dismiss DatePickerDialog." + mDatePickerDialog);
    ...
    public boolean isScreenOn() {
        ...
        if (!pm.isScreenOn()) {
          Log.d(TAG, "[Calendar] get powerManager service pm.isScreenOn() false: ");
            return false;
        }
        if (!mActivity.isResumed()) {
          Log.d(TAG, "[Calendar] get powerManager service mActivity.isResumed  false: ");
            return false;
        }
        Log.d(TAG, "[Calendar], returning true from isScreenOn() ");
        return true;
    }
}
