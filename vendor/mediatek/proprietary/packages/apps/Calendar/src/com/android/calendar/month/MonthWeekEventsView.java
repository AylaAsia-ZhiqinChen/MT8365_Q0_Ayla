...
public class MonthWeekEventsView extends SimpleWeekView {
    ...
    protected void drawWeekNums(Canvas canvas) {
        ...
        for (; i < numCount; i++) {
            ...
            lunarCalendar = OpCalendarCustomizationFactoryBase.getOpFactory(mContext)
                    .makeLunarCalendar(mContext);
            lunarCalendar.drawLunarString(mContext, canvas, mMonthNumPaint,
