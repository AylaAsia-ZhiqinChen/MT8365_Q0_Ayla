...
public class Utils {
    ...
    **/
    ...
    public static String getRingTonePreference(Context context) {
        ...
        if (ringtone == null) {
        ...
        } else if (false/*!RingtoneManager.isRingtoneExist(context, Uri.parse(ringtone))*/) {
            ...
            setRingTonePreference(context, GeneralPreferences.DEFAULT_RINGTONE);
            /**@}*/
        }
    ...
    private static void addNewSegment(LinkedList<DNASegment> segments, Event event,
        ...
        if (event.startDay > event.endDay) {
            if (DEBUG) {
                Log.d(TAG, "Event starts after it ends: " + event.toString());
            }
        }
