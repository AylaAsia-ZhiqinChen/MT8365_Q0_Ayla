...
public class AlertReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        if (!checkPermissions(context)) {
            if (MAP_ACTION.equals(intent.getAction()) || CALL_ACTION.equals(intent.getAction()) ||
                    MAIL_ACTION.equals(intent.getAction())) {
                Log.d(TAG, "onReceive permission failed");
                closeNotificationShade(context);
                Toast.makeText(context, R.string.denied_required_permission,
        ...
        if (MAP_ACTION.equals(intent.getAction())) {
           ...
           JobIntentService.enqueueWork(context, AlertService.class, JOB_ID, intent);
   ...
   /**
    ...
    private static Notification buildBasicNotification(Notification.Builder notificationBuilder,
        ...
        if (AlertService.isEventAlreadyFired) {
            notificationBuilder.setChannelId(AlertService.EXPIRED_UNREAD_EVENTS_CHANNEL_ID);
        }
        else {
            notificationBuilder.setChannelId(AlertService.DEFAULT_CHANNEL_ID);
        }
    ...
    protected static boolean hasRequiredPermission(String[] permissions, Context context) {
