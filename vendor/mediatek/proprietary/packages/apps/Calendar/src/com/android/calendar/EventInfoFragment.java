...
public class EventInfoFragment extends DialogFragment implements OnCheckedChangeListener,
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
            ...
            case TOKEN_QUERY_REMINDERS:
                ...
                if (mRemindersCursor == null) {
                     Log.d(TAG, "mRemindersCursor is null");
                } else {
    ...
    private void updateEvent(View view) {
        ...
        ILunarExt lunarCalendar;
        lunarCalendar = OpCalendarCustomizationFactoryBase.getOpFactory(context)
                .makeLunarCalendar(context);
        displayedDatetime += lunarCalendar.getLunarDisplayedDate(localTimezone, mStartMillis,
                mEndMillis, mAllDay);
        /**@}*/
