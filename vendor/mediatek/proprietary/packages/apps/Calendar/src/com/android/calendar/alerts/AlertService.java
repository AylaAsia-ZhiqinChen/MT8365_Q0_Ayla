...
public class AlertService extends JobIntentService {
    ...
    public static final String DEFAULT_CHANNEL_ID = "calendar_notif_channel_default";
    public static final String EXPIRED_UNREAD_EVENTS_CHANNEL_ID =
      "calendar_notif_channel_of_fired_notification";
    ...
    public static class NotificationMgrWrapper extends NotificationMgr {
        ...
        private static NotificationChannel mChannelDefault;
        ...
        static {
            ...
            mChannelDefault = new NotificationChannel(id, name, importance);
            mChannelDefault.enableLights(true);

            //Channel for unread expired notification
            String idFiredEvents = EXPIRED_UNREAD_EVENTS_CHANNEL_ID;
            CharSequence nameFiredEvent = "Mute channel";
            mChannelOfUnreadExpiredEvents =
              new NotificationChannel(idFiredEvents, nameFiredEvent,
        ...
        public NotificationMgrWrapper(NotificationManager nm) {
            ...
            nm.createNotificationChannel(mChannelDefault);
            nm.createNotificationChannel(mChannelOfUnreadExpiredEvents);
        }
    ...
    protected void onHandleWork(Intent intent) {
       ...
       //  }
        ...
        if (providerReminder ||
            ...
            //startService(intent);
             ComponentName serviceComponent = new ComponentName(this, InitAlarmsService.class);
             ...
             intentFilter.addAction(ACTION_EVENT_REMINDER);
             //intentFilter.addAction(EVENT_REMINDER_APP_ACTION);
             AlertReceiver  alertReceiver = new AlertReceiver();
             this.getApplicationContext().registerReceiver(alertReceiver, intentFilter);
...
//                    cr.update(alertUri, values, null, null);
    ...
    private static void postNotification(NotificationInfo info, String summaryText,
        ...
        Log.d(TAG, "eventId: " + info.eventId + "isEventAlreadyFired: " + isEventAlreadyFired);
