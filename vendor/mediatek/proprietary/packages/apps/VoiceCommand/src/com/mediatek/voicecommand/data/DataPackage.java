...
public class DataPackage {
    ...
    public static Bundle packageResultInfo(int resultid, int extrainfo,
        ...
        bundle.putInt(VoiceCommandListener.ACTION_EXTRA_RESULT_INFO1,
                extrainfo1);
        bundle.putInt(VoiceCommandListener.ACTION_EXTRA_RESULT_INFO2,
                extrainfo2);
    ...
    public static Bundle packageErrorResult(int errorid, int parameter) {
        return packageResultInfo(
                VoiceCommandListener.ACTION_EXTRA_RESULT_ERROR, parameter, errorid);
    }
    ...
    public static Bundle packageSuccessResult(int parameter) {
        return packageResultInfo(
                VoiceCommandListener.ACTION_EXTRA_RESULT_SUCCESS, parameter, 0);
    }

    /**
     * Package the send info.
     *
     * @param sendinfo
     *            string refer to VoiceCommandListener.ACTION_EXTRA_SEND_INFO
     * @param sendinfo1
     *            string refer to VoiceCommandListener.ACTION_EXTRA_SEND_INFO
     * @return Bundle data
     */
     ...
     *
     * @param sendinfo
     *            sendinfo string refer to
     *            VoiceCommandListener.ACTION_EXTRA_SEND_INFO
     * @param sendinfo1
     *            sendinfo string refer to
     *            VoiceCommandListener.ACTION_EXTRA_SEND_INFO1
     * @param sendinfo2
     *            sendinfo string refer to
     *            VoiceCommandListener.ACTION_EXTRA_SEND_INFO2
     * @return Bundle data
     */
     ...
     * @param sendinfo3
     *            sendinfo string refer to
     *            VoiceCommandListener.ACTION_EXTRA_SEND_INFO3
     * @return Bundle data
     */
    public static Bundle packageSendInfo(int sendinfo, int sendinfo1,
            int sendinfo2, int sendinfo3) {
        Bundle bundle = new Bundle();
        bundle.putInt(VoiceCommandListener.ACTION_EXTRA_SEND_INFO, sendinfo);
        bundle.putInt(VoiceCommandListener.ACTION_EXTRA_SEND_INFO1, sendinfo1);
        bundle.putInt(VoiceCommandListener.ACTION_EXTRA_SEND_INFO2, sendinfo2);
        bundle.putInt(VoiceCommandListener.ACTION_EXTRA_SEND_INFO3, sendinfo3);
        return bundle;
    }
