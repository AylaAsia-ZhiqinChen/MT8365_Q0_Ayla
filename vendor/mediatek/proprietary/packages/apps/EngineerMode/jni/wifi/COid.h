...
public:
    CAdapter(const char *AdapterName, const char *Desc, COID *oid, const char* wrapperName, const UINT_32 chipId);
	...
	UINT_32 GetChipID() {return m_ChipID;}
	void SetChipID(UINT_32 chipID) {m_ChipID = chipID;}
...
// Added by mtk54046 @ 2012-01-05 for get support channel list
    ...
    INT_32 getFwManifestVersion(char *manifest);
...
//[MP]==For each chip implement=================================================
    ...
    virtual INT_32 getPacketRxStatus(INT_32 * rxOk_p, INT_32 * rxCrcErr_p, INT_32 *rxRssi_p) = 0;
	...
	virtual INT_32 setDPDFromFile(TCHAR* fileName);
	virtual INT_32 getDPDLength (INT_32* dpdLength);
	virtual INT_32 readDPD32 (UINT_32 offset, UINT_32 * value);
	virtual INT_32 writeDPD32 (UINT_32 offset, UINT_32 value);
	virtual INT_32 getXtalTrimToCr (UINT_32 *pu4Value);
...
public:
    ...
    virtual INT_32 isWifiLogUiEnable(INT_32 module)=0;
    virtual INT_32 getWifiLogLevel(INT_32 module)=0;
    virtual INT_32 setWifiLogLevel(INT_32 module, INT_32 level)=0;
    virtual INT_32 isAntSwapSupport()=0;
};
