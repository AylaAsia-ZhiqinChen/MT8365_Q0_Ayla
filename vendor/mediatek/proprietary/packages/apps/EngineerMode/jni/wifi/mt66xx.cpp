    ...
    )
{
		...
		DEBUGFUNC("CMT66xx::getPacketRxStatus");
		...
		*rxCrcErr_p = m_AT_cmd.funcData;
        m_AT_cmd.funcIndex = 46;    //received packet crc error count
        m_AT_cmd.funcData = 0;  //clear before read
        ...
        if (!m_OID->queryOID(this,
            ...
            ERRORLOG("getPacketRxRssi failed");
            return ERROR_RFTEST_NDIS_OID_FAILURE;
        }
        *rxRssi_p = m_AT_cmd.funcData;
		return ERROR_RFTEST_SUCCESS;		
...
**__________________________________________________________________________*/
INT_32
CMT66xx::readMCR32 (UINT_32 offset, UINT_32 * value)
{

	IPC_MCR_RW_STRUC_V2 m_sMACREG_RW;
	UINT_32 BytesRead;

	DEBUGFUNC("CMT66xx::readMCR32");
...
**__________________________________________________________________________*/
INT_32
CMT66xx::writeMCR32 (UINT_32 offset, UINT_32 value)
{
	IPC_MCR_RW_STRUC_V2 m_sMACREG_RW;

	DEBUGFUNC("CMT66xx::writeMCR32");
...
**__________________________________________________________________________*/
INT_32
CMT66xx::readBBCR8 (UINT_32 offset, UINT_32* value)
{

	DEBUGFUNC("CMT66xx::readBBCR8:omitted");
    UNUSED(offset, value);
	return ERROR_RFTEST_SUCCESS;
}
...
**__________________________________________________________________________*/
INT_32
CMT66xx::writeBBCR8 (UINT_32 offset, UINT_32 value)
{
	DEBUGFUNC("CMT66xx::writeBBCR8:omitted");
    UNUSED(offset, value);
	return ERROR_RFTEST_SUCCESS;
}
...
**__________________________________________________________________________*/
INT_32
CMT66xx::readEEPRom16 (UINT_32 offset, UINT_32 * value)
{
	IPC_EEPROM_RW_STRUC_V2 m_sEEPRom_RW;
	UINT_32 BytesRead;
	DEBUGFUNC("CMT66xx::readEEPRom16");
	INT_32 status;
	INT_32 i4EepromSize;	
...
**__________________________________________________________________________*/
INT_32
CMT66xx::readSpecEEPRom16 (UINT_32 offset, UINT_32 * value)
{
	IPC_EEPROM_RW_STRUC_V2 m_sEEPRom_RW;
	UINT_32 BytesRead;
	DEBUGFUNC("CMT66xx::readSpecEEPRom16");
	m_sEEPRom_RW.ucEEPROMMethod = EEPROM_METHOD_RW;
    m_sEEPRom_RW.eepromIndex = (UINT_8)offset;
    m_sEEPRom_RW.eepromData = 0;   //clear before read
...
**__________________________________________________________________________*/
INT_32
CMT66xx::writeEEPRom16 (UINT_32 offset, UINT_32 value)
{
	IPC_EEPROM_RW_STRUC_V2 m_sEEPRom_RW;
	DEBUGFUNC("CMT66xx::readEEPRom16");
    m_sEEPRom_RW.ucEEPROMMethod = EEPROM_METHOD_RW;
...
**__________________________________________________________________________*/
INT_32
CMT66xx::setTestMode(void)
{
    PARAM_RFTEST_INFO info;

    DEBUGFUNC("CMT66xx::setTestMode");
...
**__________________________________________________________________________*/
INT_32
CMT66xx::setNormalMode(void)
{
    DEBUGFUNC("CMT66xx::setNormalMode");
...
**__________________________________________________________________________*/
INT_32
CMT66xx::setOutputPower(
    INT_32 nTxRate,
    INT_32 txPower,
    INT_32 txAntenna
    )
{
	DEBUGFUNC("CMT66xx::setOutputPower:omitted");
    UNUSED(nTxRate, txPower, txAntenna);
/*	
...
**__________________________________________________________________________*/
INT_32
CMT66xx::setCarrierSuppression(
    INT_32 nModulationType,
    INT_32 txPower,
    INT_32 txAntenna
    )
{
	DEBUGFUNC("CMT66xx::setCarrierSuppression:omitted");
    UNUSED(nModulationType, txPower, txAntenna);
/*    
	UINT_32                     u4BBCR;
    UINT_32                     u4MCR;
    INT_32                      result;
    ...
    //MCR (0x0078): b1-b0 = CCK : 2b01 , OFDM :2b10
...
**__________________________________________________________________________*/
INT_32
CMT66xx::setLocalFrequecy(INT_32 txPower, INT_32 txAntenna)
{
	DEBUGFUNC("CMT66xx::setLocalFrequecy:omitted");
    UNUSED(txPower, txAntenna);
/*
    UINT_32 u4BBCR;
    UINT_32                     u4MCR;
    INT_32                      result;
...
CHAR *
CMT66xx::getRFICType(void)
{
	DEBUGFUNC("CMT66xx::getRFICType:omitted");
	return ERROR_RFTEST_SUCCESS;
}

INT_32
CMT66xx::readBBCRStatistic(
    UINT_16* ed,
    UINT_16* osd,
    UINT_16* sq1,
    UINT_16* sfd,
    UINT_16* fcs)
{
    UNUSED(ed, osd, sq1, sfd, fcs);
	DEBUGFUNC("CMT66xx::readBBCRStatistic:omitted");
	return ERROR_RFTEST_SUCCESS;
}

INT_32
CMT66xx::getRadarStatus(void)
{
	DEBUGFUNC("CMT66xx::getRadarStatus:omitted");
	return ERROR_RFTEST_SUCCESS;
}
...
**__________________________________________________________________________*/
INT_32
CMT66xx::setAlcInfoToEeprom (
    INT_32 b24gAvailable,
    INT_32 b5gAvailable)
{
    UNUSED(b24gAvailable, b5gAvailable);
	DEBUGFUNC("CMT66xx::setAlcInfoToEeprom:omitted");
	return ERROR_RFTEST_SUCCESS;
}
...
{
    UNUSED(b24gAvailable, b5gAvailable, bUseSlopeRate);
	DEBUGFUNC((char*)"CMT66xx::getAlcInfo:omitted");
	return ERROR_RFTEST_SUCCESS;
...
**__________________________________________________________________________*/
INT_32
CMT66xx::setAlcSlopeRatioToEeprom (
...
{
    UNUSED(slope1Divider, slope1Dividend, slope2Divider, slope2Dividend);
	DEBUGFUNC((char*)"CMT66xx::setAlcSlopeRatioToEeprom:omitted");
	return ERROR_RFTEST_SUCCESS;
}
...
{
    UNUSED(slope1Divider, slope1Dividend, slope2Divider, slope2Dividend);
	DEBUGFUNC((char*)"CMT66xx::getAlcSlopeRatio:omitted");
	return ERROR_RFTEST_SUCCESS;
...
**__________________________________________________________________________*/
INT_32
CMT66xx::setTXMaxPowerToEEProm(INT_32 channelFreg, INT_32 bCck, INT_32 nTxPwr)
{
    UNUSED(channelFreg, bCck, nTxPwr);
	DEBUGFUNC((char*)"CMT66xx::setTXMaxPowerToEEProm:omitted");
	return ERROR_RFTEST_SUCCESS;
...
**__________________________________________________________________________*/
INT_32
CMT66xx::setTXMaxPowerToEEPromEx(
	INT_32 channelFreq,
	INT_32 rate,
	INT_32 gainControl,
	INT_32 outputPower,
...
{
    UNUSED(channelFreq, rate, gainControl, outputPower, targetAlc);
	DEBUGFUNC((char*)"CMT66xx::setTXMaxPowerToEEPromEx:omitted");
	/*
    char    aucSzTmp[512]; 
...
{
    UNUSED(channelFreq, bCck, nTxPwr, ndBindex);
	DEBUGFUNC((char*)"CMT66xx::readTxPowerFromEEProm:omitted");
    return ERROR_RFTEST_SUCCESS;
}
...
**__________________________________________________________________________*/
INT_32
CMT66xx::readTxPowerFromEEPromEx(
    ...
    )
{
	...
	INT_32 result = 0x00;
	DEBUGFUNC("CMT66xx::readTxPowerFromEEPromEx");
...
{
    UNUSED(condition, nAntenna);
	DEBUGFUNC("CMT66xx::setPacketRx:omitted");
/*	
    UINT_32 u4Tmp;
...
**__________________________________________________________________________*/
INT_32
CMT66xx::setEEPromCKSUpdated (void)
{
    DEBUGFUNC("CMT66xx::setEEPromCKSUpdated: omitted");
/*
    UINT_8 checkSum;
    UINT_16 *pu2EEPRDat;
    ...
    )
{
	...
	UINT_32  status ;
	INT_32  iSize ;
	DEBUGFUNC("CMT66xx::setEEPRomSize");
	...
	)
{
    ...
    m_sEEPRom_RW.eepromData     = 0;   //clear before read
	DEBUGFUNC("CMT66xx::getEEPRomSize");
        ...
        if(CFG_SRC_TYPE_EEPROM == m_sEEPRom_RW.ucEEPROMMethod)
      	{
      		//EEPROM is used
      		isEepromUsed = true;
		DEBUGFUNC("CMT66xx::getEEPRomSize - EEPROM exist");
      	}
      	else if(CFG_SRC_TYPE_NVRAM == m_sEEPRom_RW.ucEEPROMMethod)
      	{
      		isEepromUsed = false;
		DEBUGFUNC("CMT66xx::getEEPRomSize - NVRAM exist");
    	}
    	else
    	{
    		//unknown
	...
	)
{
	...
	if(!m_OID->queryOID(this,
	        ...
	        ERRORLOG("CMT66xx::getSpecEEPRomSize failed");
	        return ERROR_RFTEST_NDIS_OID_FAILURE;
	    }
	    else {
			/*
	        ...
	        if(CFG_EEPROM_TYPE_NO == m_sEEPRom_RW.ucEEPROMMethod)
	      	{
				...
				DEBUGFUNC("CMT66xx::getSpecEEPRomSize - EEPROM type = no");
				*eepromSz = 0x00;
				return ERROR_RFTEST_SUCCESS;
	      	}
	      	else if(CFG_EEPROM_TYPE_YES == m_sEEPRom_RW.ucEEPROMMethod)
	      	{
	      		//EEPROM exist
	      		isEepromUsed = true;
				DEBUGFUNC("CMT66xx::getSpecEEPRomSize - EEPROM type = yes");	
	    	}
	    	else
	    	{
	    		//unknown
				DEBUGFUNC("CMT66xx::getSpecEEPRomSize - EEPROM type = unknown");	
	    		return ERROR_RFTEST_NDIS_OID_FAILURE;
	    	}
	    }
		m_sEEPRom_RW.ucEEPROMMethod = EEPROM_METHOD_SZ;
...
**__________________________________________________________________________*/
INT_32
CMT66xx::setMACAddrToEEProm (
    UINT_8* macAddr
    )
{
    UNUSED(macAddr);
    DEBUGFUNC("CMT66xx::setMACAddrToEEProm: omitted");
/*
...
**__________________________________________________________________________*/
INT_32
CMT66xx::getEEPRomVersion (
	INT_32* version
	)
{
    UNUSED(version);
    DEBUGFUNC("CMT66xx::getEEPRomVersion: omitted");
/*
	INT_32 ver;
...
**__________________________________________________________________________*/
INT_32
CMT66xx::setCountryToEEProm (
	UINT_8* country
	)
{
    UNUSED(country);
    DEBUGFUNC("CMT66xx::setCountryToEEProm: omitted");
/*
...
**__________________________________________________________________________*/
INT_32
CMT66xx::setPhyModeToEEProm (
    INT_32 mode
    )
{
    UNUSED(mode);
	DEBUGFUNC("CMT66xx::setPhyModeToEEProm: omitted");
	return ERROR_RFTEST_SUCCESS;

}

INT_32
CMT66xx::setDACOffsetToEEProm (
	UINT_16 dacOffset
	)
{
    UNUSED(dacOffset);
	DEBUGFUNC("CMT66xx::setDACOffsetToEEProm: omitted");
	return ERROR_RFTEST_SUCCESS;
}

INT_32
CMT66xx::getDACOffset (
	UINT_16* dacOffset
	)
{
    UNUSED(dacOffset);
	DEBUGFUNC("CMT66xx::getDACOffset: omitted");
	return ERROR_RFTEST_SUCCESS;
...
*******************************************************************************/
INT_32
CMT66xx::setOutputPin (
	INT_32 pinIndex,
	INT_32 outputLevel)
{
    UNUSED(pinIndex, outputLevel);
    DEBUGFUNC("CMT66xx::setOutputPin: omitted");
/*
...
{
    UNUSED(pinIndex, pi4InputLevel);
    INT_32 i4Status = ERROR_RFTEST_SUCCESS;
    DEBUGFUNC("CMT66xx::getInputPin: omitted");
/*
    UINT_32 u4Tmp;
...
*******************************************************************************/
INT_32
CMT66xx::testInputPin (
	INT_32 pinIndex,
	INT_32	inputLevel)
{
    UNUSED(pinIndex, inputLevel);
	DEBUGFUNC("CMT66xx::testInputPin: omitted");
	return ERROR_RFTEST_SUCCESS;
}
...
*******************************************************************************/
INT_32
CMT66xx::restoreIOPin (
    void
    )
{
	INT_32 result = ERROR_RFTEST_SUCCESS;
	DEBUGFUNC("CMT66xx::restoreIOPin: omitted");
	/*
    // Restore original IO register setting 
...
**__________________________________________________________________________*/
INT_32
CMT66xx::updateALCOffset(void)
{
	DEBUGFUNC("CMT66xx::updateALCOffset: omitted");
    return ERROR_RFTEST_SUCCESS;
}
...
**__________________________________________________________________________*/
INT_32
CMT66xx::findMaxPowerByteOffset(INT_32 nChannel, INT_32 bCck, INT_32 b24Gs)
{
    UNUSED(nChannel, bCck, b24Gs);
	DEBUGFUNC("CMT66xx::findMaxPowerByteOffset: omitted");
    return ERROR_RFTEST_SUCCESS;
}


INT_32
CMT66xx::setPPMCRAndSCR(void)
{
	DEBUGFUNC("CMT66xx::setPPMCRAndSCR: omitted");
    return ERROR_RFTEST_SUCCESS;
}

INT_32
CMT66xx::setBBTxPower(INT_32 txPower)
{
    UNUSED(txPower);
	DEBUGFUNC("CMT66xx::setBBTxPower: omitted");
    return ERROR_RFTEST_SUCCESS;
}

INT_32
CMT66xx::setTxAnt(INT_32 antenna)
{
    UNUSED(antenna);
	DEBUGFUNC("CMT66xx::setTxAnt: omitted");
    return ERROR_RFTEST_SUCCESS;
}

UINT_8
CMT66xx::getTxRate(INT_32 nTxRate, INT_32 nPreamble)
{
    UNUSED(nTxRate, nPreamble);
	DEBUGFUNC("CMT66xx::getTxRate: omitted");
	return ERROR_RFTEST_SUCCESS;
}

UINT_8
CMT66xx::nicCalculateChecksumByte(void * startingAddr_p,UINT_32 length)
{
    UNUSED(startingAddr_p, length);
    UINT_8 result = 0;
    DEBUGFUNC("CMT66xx::nicCalculateChecksumByte: omitted");
    /*
    UINT_32 i;
    UINT_8 * cp;
...
**__________________________________________________________________________*/
INT_32
CMT66xx::getEEPRomVersion_(void)
{
    DEBUGFUNC("CMT66xx::getEEPRomVersion_: omitted");
    /*
    UINT_32 value;
    UINT_32 eepValue;
...
**__________________________________________________________________________*/
INT_32
CMT66xx::SetATParam (UINT_32 offset, UINT_32 value)
{
	MTK_WIFI_TEST_STRUC_V2 m_AT_cmd;

	DEBUGFUNC("CMT66xx::SetATParam");
	em_error((char*)"CMT66xx::SetATParam(FunctionIndex = %d, FunctionData = %d)\n", offset, value);
	...
	offset == 19)
	{
		em_printf(MSG_DEBUG, (char*)"CMT66xx::SetATParam(FunctionIndex = %d, FunctionData = %d) - blocked.\n", offset, value);
		return ERROR_RFTEST_SUCCESS;
	}
	/*special for function index = 12 ends*/
    m_AT_cmd.funcIndex = offset;
    m_AT_cmd.funcData = value;
    m_AT_cmd.funcData2 = 0;
...
**__________________________________________________________________________*/
INT_32
CMT66xx::GetATParam (UINT_32 offset, UINT_32 * value)
{
	MTK_WIFI_TEST_STRUC_V2 m_AT_cmd;
	UINT_32 BytesRead;

	DEBUGFUNC("CMT66xx::GetATParam");
	if(offset == 5  || 
	offset == 8 || 
	offset == 10 || 
	offset == 11 || 
	...
	offset == 19)
	{
		em_printf(MSG_DEBUG, (char*)"CMT66xx::GetATParam(FunctionIndex = %d)- blocked.\n", offset);
		return ERROR_RFTEST_SUCCESS;
	}
    m_AT_cmd.funcIndex = offset;
    m_AT_cmd.funcData = 0;  //clear before read
    m_AT_cmd.funcData2 = 0;  //clear before read
    ...
    value[0] = m_AT_cmd.funcData;
    value[1] = m_AT_cmd.funcData2;
...
**__________________________________________________________________________*/
INT_32
CMT66xx::setChipType (UINT_32 u4InChipType) 
{
    UNUSED(u4InChipType);
	DEBUGFUNC("CMT66xx::setChipType:omitted");
/*
...
**__________________________________________________________________________*/
INT_32
CMT66xx::setEEPRomFromFile(TCHAR* fileName)
{
	INT_32 iSize, status;
	INT_32 i;
	UINT_16* usEEPRDat = NULL;
	DEBUGFUNC("CMT66xx::setEEPRomFromFile");
	status = getEEPRomSize(&iSize);
    if (status < 0) {
        return ERROR_RFTEST_GENERAL_ERROR;
    }
    ...
    memset(usEEPRDat, 0, iSize * sizeof(char));
...
**__________________________________________________________________________*/
INT_32
CMT66xx::setXtalFreqTrimToEEProm (
	INT_32 i4FreqTrim
	)
{
    char    aucSzTmp[3]; 
...
**__________________________________________________________________________*/
INT_32
CMT66xx::queryThermoInfo (
    INT_32 *  pi4Enable,
    UINT_32 * pu4RawVal
	)
{
    UNUSED(pi4Enable, pu4RawVal);
    DEBUGFUNC("CMT66xx::queryThermoInfo:omitted");
    /*
    UINT_32 u4ALCR;
    INT_32  i4Enable;
    UINT_32 u4RawVal;
...
{
    UNUSED(i4Enable);
    DEBUGFUNC("CMT66xx::setThermoEn:omitted");
/*
    UINT_32 u4ALCR;
...
**__________________________________________________________________________*/
INT_32
CMT66xx::setAnritsu8860bTestSupportEn (
    INT_32    i4Enable
	)
{
    UNUSED(i4Enable);
    DEBUGFUNC("CMT66xx::setAnritsu8860bTestSupportEn:omitted");
    /*
    UINT_32 u4RFCR;
    UINT_32 u4Enable;
    UINT_32 u4BytesRead;
...
**__________________________________________________________________________*/
INT_32
CMT66xx::getDPDLength (
	INT_32* dpdLength
	)
{
	UINT_32 BytesRead;
	MTK_WIFI_TEST_STRUC_V2 m_sDPDLength_R;
	DEBUGFUNC("CMT66xx::getDPDLength");
...
**__________________________________________________________________________*/
INT_32
CMT66xx::readDPD32 (UINT_32 offset, UINT_32 * value)
{

	MTK_WIFI_TEST_STRUC_V2 m_sDPD_Parameter;
	UINT_32 BytesRead;

	DEBUGFUNC("CMT66xx::readDPD32");
...
**__________________________________________________________________________*/
INT_32
CMT66xx::writeDPD32 (UINT_32 offset, UINT_32 value)
{
	MTK_WIFI_TEST_STRUC_V2 m_sDPD_Parameter;

	DEBUGFUNC("CMT66xx::writeDPD32");
...
INT_32 
CMT66xx::setDPDFromFile(TCHAR* fileName)
{
    ...
    memset(u4DPDDat, 0, (iSize + 3) / 4 * sizeof(UINT_32));
	...
	)
{
    ...
    */
	...
	DEBUGFUNC("CMT66xx::setPacketTxEx:omitted");
/*
	DEBUGFUNC("CMT66xx::setPacketTxEx");
	INITLOG((_T("\n")));
...
INT_32
CMT66xx::testLoopD4toD15 (
    UINT_32 u4TestInput,
    BOOL *pfgResult
    )
{
    UNUSED(u4TestInput, pfgResult);
    DEBUGFUNC("CMT66xx::testLoopD4toD15:omitted");
/*
...
/*
INT_32
CMT66xx::setTxPower(INT_32 txPower)
{
	MTK_WIFI_TEST_STRUC_V2 m_AT_cmd;
	...
	em_error("CMT66xx::setTxPower(txPower %d)\n", txPower);
...
INT_32
CMT66xx::setPacketLength(INT_32 pckLength)
{
	MTK_WIFI_TEST_STRUC_V2 m_AT_cmd;

	DEBUGFUNC("CMT66xx::setPacketLength");
	
	em_error("CMT66xx::setPacketLength(pckLength %d)\n", pckLength);
...
INT_32 CMT66xx::isWifiLogUiEnable(INT_32 module)
{
    PARAM_WIFI_LOG_LEVEL_UI cmd;
    UINT_32 BytesRead;

    cmd.ucVersion = 1;
    cmd.ucModule = module;
    cmd.ucEnable = 0; // reset before read

    em_printf(MSG_DEBUG, (char*) "isWifiLogUiEnable module: %d\n", module);

    if (!m_OID->queryOID(this, OID_IPC_WIFI_LOG_UI, (CHAR *) &cmd,
            sizeof(PARAM_WIFI_LOG_LEVEL_UI), &BytesRead)) {
        ERRORLOG("isWifiLogUiEnable queryOID failed\n");
        return -1; // failure case
    } else
        return cmd.ucEnable; // success case
}

INT_32 CMT66xx::getWifiLogLevel(INT_32 module)
{
    PARAM_WIFI_LOG_LEVEL cmd;
    UINT_32 BytesRead;

    cmd.ucVersion = 1;
    cmd.ucModule = module;
    cmd.ucLevel = 0; // clear before read

    em_printf(MSG_DEBUG, (char*) "getWifiLogLevel module: %d\n", module);

    if (!m_OID->queryOID(this, OID_IPC_WIFI_LOG_LEVEL, (CHAR *) &cmd,
            sizeof(PARAM_WIFI_LOG_LEVEL), &BytesRead)) {
        ERRORLOG("getWifiLogLevel queryOID failed\n");
        return -1; // failure case
    } else
        return cmd.ucLevel; // success case
}

INT_32 CMT66xx::setWifiLogLevel(INT_32 module, INT_32 level)
{
	PARAM_WIFI_LOG_LEVEL cmd;
	...
	em_printf(MSG_DEBUG, (char*) "setWifiLogLevel module: %d, level: %d\n", module, level);

	if (!m_OID->setOID(this, OID_IPC_WIFI_LOG_LEVEL, (CHAR *) &cmd,
		    sizeof(PARAM_WIFI_LOG_LEVEL))) {
		ERRORLOG("setWifiLogLevel setOID failed\n");
		return -1; // failure case
	} else
		return 0; // success case
}

INT_32 CMT66xx::isAntSwapSupport()
{
    UINT_32 u4BytesRead;
    UINT_32 u4Support;

    u4Support = 0; // reset before read

    em_printf(MSG_DEBUG, (char*) "isAntSwapSupport\n");

    if (!m_OID->queryOID(this, OID_CUSTOM_QUERY_ANT_SWAP_CAPABILITY,
            (CHAR *) &u4Support, sizeof(UINT_32), &u4BytesRead)) {
        ERRORLOG("isAntSwapSupport queryOID failed\n");
        return -1; // failure case
    } else {
        return u4Support; // success case
    }
}
