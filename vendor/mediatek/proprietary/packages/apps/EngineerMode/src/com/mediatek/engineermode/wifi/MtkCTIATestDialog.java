...
/**
 * Dialog class for Wifi CTIA settings.
 *
 */
public class MtkCTIATestDialog extends AlertDialog implements
    ...
    private void initLayout() {
        ...
        int positiveButtonResId = R.string.dialog_ok;
        ...
        public void onClick(View v) {
            ...
            if (v == mSetBtn) {
                try {
                    ...
                    Elog.i(TAG, "Set ret: " + ret + " ID: " + id + " VAL: "
                            + val);
                ...
                try {
                    ...
                    Elog.i(TAG, "Get ret: " + ret + " ID: " + id + " VAL: "
                            + value[0]);
    ...
    public void onClick(DialogInterface arg0, int arg1) {
        if (arg1 == POSITIVE_BUTTON) {
            ...
            if (mCheckbox.isChecked()) {
                Elog.i(TAG, "doCTIATestOn: " + EMWifi.doCtiaTestOn());
                ...
                WifiWatchService.enableService(mContext, true);
            } else {
                Elog.i(TAG, "doCTIATestOff: " + EMWifi.doCtiaTestOff());
                dismissCtiaEnabledNotify(getContext());
                Elog.i(TAG, "enableService false");
                WifiWatchService.enableService(mContext, false);
            }
            Elog.i(TAG, "doCTIATestRate: " + EMWifi.doCtiaTestRate(mRateVal));

            int id = 0;
            int val = 0;
            id = (int) Long.parseLong("10020000", 16);
            val = mDumpBeaconCheckbox.isChecked() ? 1 : 0;
            Elog.i(TAG, "doCTIATestSet: id: " + id + " val: " + val + " result: "
    ...
    static void initWifiCtiaOnEnabled(Context context) {
        ...
        Elog.i(TAG, "doCTIATestRate: " + EMWifi.doCtiaTestRate(rate));
    ...
    /**
     * Check if Wifi CTIA is enabled.
     * @param context The environment context
     * @return true for Wifi CTIA enabled
     */
    ...
    static void emitNotif(Context context, int id,
                          String title, String content, Class<? extends Activity> targetClass) {
