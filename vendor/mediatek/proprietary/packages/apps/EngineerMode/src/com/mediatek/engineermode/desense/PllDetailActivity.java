...
public class PllDetailActivity extends Activity {
    ...
    private static final String TAG = "Desense/PllDetail";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnSet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Elog.v(TAG, "editValue = " + editValue);
                ...
                if (m.find()) {
                    ...
                    Elog.w(TAG, "set button NumberFormatException");
                    Toast.makeText(PllDetailActivity.this,
    ...
    private static int pllSetClock(int id, String hexVal) {
        ...
        try {
            ...
            Elog.v(TAG, "pllSetClock IOException: " + e.getMessage());
        }
        return result;
    }
}
