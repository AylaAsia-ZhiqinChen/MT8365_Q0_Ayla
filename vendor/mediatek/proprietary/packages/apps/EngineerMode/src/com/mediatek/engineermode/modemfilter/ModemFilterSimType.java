...
public class ModemFilterSimType extends Activity implements OnItemClickListener {

    private static final String TAG = "ModemFilterSimType";
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
        ...
        case 0:
            intent.setClassName(this,
                    "com.mediatek.engineermode.modemfilter.ModemFilterActivity");
            simType = PhoneConstants.SIM_ID_1;
            Elog.d(TAG, "onItemClick SIM_ID_1 simType: " + simType);
        ...
        case 1:
            ...
            Elog.d(TAG, "onItemClick SIM_ID_2 simType: " + simType);
            intent.putExtra("mSimType", simType);
            break;
        default:
            break;
