    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDisableMoMs.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Elog.d(TAG, "mDisableMoMs is clicked, call setprop persist.sys.mtk.disable.moms 1");
                try {
                    EmUtils.getEmHidlService().setMoms(DISABLE_MOMS);
        ...
        mReenableMoMs.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Elog.d(TAG, "mReenableMoMs is clicked, " +
                    "call setprop persist.sys.mtk.disable.moms 0");
                try {
                    EmUtils.getEmHidlService().setMoms(REENABLE_MOMS);
                } catch (RemoteException e) {
                    e.printStackTrace();
                }
            }
