...
package com.mediatek.engineermode.modemresetdelay;
...
/**
 * Modem reset delay activity.
 */
public class ModemResetDelay extends Activity implements OnClickListener {
    private static final String TAG = "ModemResetDelay";
    private static final String KEY_MODEM_RESET = "vendor.mediatek.debug.md.reset.wait";
    ...
    private void onClickBtnDone() {
        try {
            ...
            EmUtils.getEmHidlService().setMdResetDelay( mEtResetTime.getText().toString());
            Elog.i(TAG, "Set modem debug delay time : " + mDelayTime);
