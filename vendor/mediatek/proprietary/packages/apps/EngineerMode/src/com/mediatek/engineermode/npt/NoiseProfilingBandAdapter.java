...
public class NoiseProfilingBandAdapter extends BaseAdapter {
    ...
    private List<RatSelectInfo> mRatList = null;
    private LayoutInflater mLayoutInflater = null;

    public NoiseProfilingBandAdapter(Context context, ArrayList<RatSelectInfo> list) {
        mContext = context;
        mRatList = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.noise_profiling_rat_list, null);
           ...
           // Elog.i(TAG, "send: position" + position);
    ...
    static class RatSelectInfo {
        ...
        public void setRatCheckState(Boolean ratCheckState) {
            RatCheckState = ratCheckState;
        }
