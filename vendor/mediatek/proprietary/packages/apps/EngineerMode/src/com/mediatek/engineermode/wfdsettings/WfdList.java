...
public class WfdList extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mModuleList.add(getString(R.string.wfd_iot_property));
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (mModuleList.get(position).equals(
                ...
                getString(R.string.wfd_iot_property))) {
                startActivity(new Intent(WfdList.this, WfdIotProperty.class));
        }
    }
}
