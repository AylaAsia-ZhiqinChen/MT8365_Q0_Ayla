...
public class ModemSwitch extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (mRadioWg.isChecked()) {
            Elog.d(TAG, "Set modem type: " + ModemSwitchHandler.MD_TYPE_WG);
            if (sProjectType == PROJ_TYPE_WORLD_PHONE) {
            ...
            Elog.d(TAG, "Set modem type: " + ModemSwitchHandler.MD_TYPE_TG);
            if (sProjectType == PROJ_TYPE_WORLD_PHONE) {
                sWorldPhone.setModemSelectionMode(IWorldPhone.SELECTION_MODE_MANUAL,
                    ModemSwitchHandler.MD_TYPE_TG);
            }
        } else if (mRadioLwg.isChecked()) {
            Elog.d(TAG, "Set modem type: " + ModemSwitchHandler.MD_TYPE_LWG);
            if (sProjectType == PROJ_TYPE_WORLD_PHONE) {
                sWorldPhone.setModemSelectionMode(IWorldPhone.SELECTION_MODE_MANUAL,
                    ModemSwitchHandler.MD_TYPE_LWG);
            }
        } else if (mRadioLtg.isChecked()) {
            Elog.d(TAG, "Set modem type: " + ModemSwitchHandler.MD_TYPE_LTG);
            if (sProjectType == PROJ_TYPE_WORLD_PHONE) {
                sWorldPhone.setModemSelectionMode(IWorldPhone.SELECTION_MODE_MANUAL,
