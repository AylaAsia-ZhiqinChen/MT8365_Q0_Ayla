...
public class CommandToolEdit extends Activity implements OnClickListener,
        ServiceConnection, CommandToolService.OnUpdateResultListener {
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        ...
        Elog.v(TAG, "onServiceConnected " + mService.isRunning());
        onUpdateResult();
    }
