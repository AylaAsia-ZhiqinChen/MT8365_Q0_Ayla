...
/**
 * Class for Wifi RFCR read/write.
 *
 */
public class WiFiRFCR extends WiFiTestActivity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wifi_rfcr);
        mEtAddr = (EditText) findViewById(R.id.WiFi_RFCR_Addr_Content);
        mEtValue = (EditText) findViewById(R.id.WiFi_RFCR_Value_Content);
        mBtnRead = (Button) findViewById(R.id.WiFi_RFCR_ReadBtn);
        mBtnWrite = (Button) findViewById(R.id.WiFi_RFCR_WriteBtn);

        mCbWF0 = (RadioButton) findViewById(R.id.wifi_rfcr_wfx_0);
        mCbWF0.setChecked(true);
    ...
    public void onClick(View arg0) {
        ...
        if (arg0.getId() == mBtnRead.getId()) {
            ...
            try {
                ...
                Toast.makeText(WiFiRFCR.this, "invalid input value", Toast.LENGTH_SHORT)
                        .show();
                return;
            }

            if (mCbWF0.isChecked()) {
                u4Addr = 0x9990 << 16 | u4Addr;
            } else {
                u4Addr = 0x9991 << 16 | u4Addr;
            }
