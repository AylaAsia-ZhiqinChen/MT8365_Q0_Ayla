 ...
 */
public class CustomContactListFilterActivity extends BaseEventHandlerActivity implements
            ...
            if (isInsert()) {
                ...
                if (mUngrouped) {
                    ...
                    Log.d(TAG, "[buildDiff] selection= " + selection + ",accountName= "
                            + Log.anonymize(accountName) +",accountType= "
    ...
    protected static class DisplayAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView,
            ...
            /// M: [ALPS00117690] should display SIM card's name@{
    ...
    private void confirmFinish() {
        ...
        if (hasUnsavedChanges()) {
            ///M:[Google Issue][ALPS03524216]Check transaction safe before show dialog @{
            if (isSafeToCommitTransactions()) {
            /// @}
                new ConfirmNavigationDialogFragment().show(getFragmentManager(),
                        "ConfirmNavigationDialog");
            ///M:[Google Issue][ALPS03524216] @{
            } else {
                Log.e(TAG, "ignore ConfirmNavigationDialog due to transaction not safe");
            }
            /// @}
        } else {
