...
public final class ErrorCause {
    ...
    public static final int SIM_ERROR_UNKNOWN =
            IccInternalInterface.ERROR_ICC_PROVIDER_UNKNOWN; //0
    public static final int SIM_NO_ERROR =
            IccInternalInterface.ERROR_ICC_PROVIDER_SUCCESS; //1
    public static final int SIM_NUMBER_TOO_LONG =
            IccInternalInterface.ERROR_ICC_PROVIDER_NUMBER_TOO_LONG; // -1
    public static final int SIM_NAME_TOO_LONG =
            IccInternalInterface.ERROR_ICC_PROVIDER_TEXT_TOO_LONG; // -2
    public static final int SIM_STORAGE_FULL =
            IccInternalInterface.ERROR_ICC_PROVIDER_STORAGE_FULL; // -3
    public static final int SIM_ICC_NOT_READY =
            IccInternalInterface.ERROR_ICC_PROVIDER_NOT_READY; // -4
    public static final int SIM_PASSWORD_ERROR =
            IccInternalInterface.ERROR_ICC_PROVIDER_PASSWORD_ERROR; // -5
    public static final int SIM_ANR_TOO_LONG =
            IccInternalInterface.ERROR_ICC_PROVIDER_ANR_TOO_LONG; // -6
    public static final int SIM_GENERIC_FAILURE =
            IccInternalInterface.ERROR_ICC_PROVIDER_GENERIC_FAILURE; // -10
    public static final int SIM_ADN_LIST_NOT_EXIT =
            IccInternalInterface.ERROR_ICC_PROVIDER_ADN_LIST_NOT_EXIST; // -11
    public static final int SIM_EMAIL_FULL =
            IccInternalInterface.ERROR_ICC_PROVIDER_EMAIL_FULL; //-12
    public static final int SIM_EMAIL_TOOLONG =
            IccInternalInterface.ERROR_ICC_PROVIDER_EMAIL_TOO_LONG; //-13
    public static final int SIM_ANR_SAVE_FAILURE =
            IccInternalInterface.ERROR_ICC_PROVIDER_ANR_SAVE_FAILURE; //-14
    public static final int SIM_WRONG_ADN_FORMAT =
            IccInternalInterface.ERROR_ICC_PROVIDER_WRONG_ADN_FORMAT; //-15
    public static final int SIM_WRONG_SNE_FULL =
            IccInternalInterface.ERROR_ICC_PROVIDER_SNE_FULL; //-16
    public static final int SIM_WRONG_SNE_TOO_LONG =
            IccInternalInterface.ERROR_ICC_PROVIDER_SNE_TOO_LONG; //-17
    /// @}
