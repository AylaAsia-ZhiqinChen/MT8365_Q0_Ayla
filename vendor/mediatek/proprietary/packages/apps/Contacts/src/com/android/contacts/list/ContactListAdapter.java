...
public abstract class ContactListAdapter extends MultiSelectEntryContactListAdapter {
    ...
    public static class ContactQuery {
        public static final String[] CONTACT_PROJECTION_PRIMARY_INTERNAL = new String[] {
            Contacts._ID,                           // 0
        ...
        static {
            ...
            if (ContactsPortableUtils.MTK_PHONE_BOOK_SUPPORT) {
                ...
                projectionList.add(MtkContactsContract.ContactsColumns.INDICATE_PHONE_SIM); //9
                projectionList.add(MtkContactsContract.ContactsColumns.INDEX_IN_SIM);       //10
       ...
       ///M: @}
        ...
        static {
            ...
            if (ContactsPortableUtils.MTK_PHONE_BOOK_SUPPORT) {
                ...
                projectionList.add(MtkContactsContract.ContactsColumns.INDEX_IN_SIM);         //11
    ...
    public void changeCursor(int partitionIndex, Cursor cursor) {
        ...
        if (shouldIncludeFavorites()) {
            ...
            ///M:[Google Issue][ALPS03421756]Not clear so favorite count always >0 @{
            } else {
