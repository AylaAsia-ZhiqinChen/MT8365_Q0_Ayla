...
public final class GroupUtil {
    ...
    public static Intent createSendToSelectionPickerIntent(Context context, long[] ids,
            long[] defaultSelection, String sendScheme, String title, int subId) {
        ...
        /// M: [Sim Group][ALPS04077821] add subId. 2/3 @{
        intent.putExtra(UiIntentActions.GROUP_ACCOUNT_SUBID, subId);
        /// @}
        return intent;
    }
    ...
    public static Intent createPickMemberIntent(Context context,
            GroupMetaData groupMetaData, ArrayList<String> memberContactIds, int subId) {
        final Intent intent = new Intent(context, ContactSelectionActivity.class);
