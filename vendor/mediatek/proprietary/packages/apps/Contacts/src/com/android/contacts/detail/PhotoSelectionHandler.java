...
public abstract class PhotoSelectionHandler implements OnClickListener {
        ...
        if (resultCode == Activity.RESULT_OK) {
            switch (requestCode) {
                ...
                case REQUEST_CODE_CAMERA_WITH_DATA:
                    ...
                    if (data != null && data.getData() != null) {
                        uri = data.getData();
                        /// M: [Google Issue][ALPS01258109][ALPS01273533] support drm. 2/2
                        /// if it is drm image, just return the inputUri to CropImage @{
    ...
    private void startPickFromGalleryActivity(Uri photoUri) {
        ...
        if (ContactsSystemProperties.MTK_DRM_SUPPORT) {
            ...
            // Drm file level, only FL can be used as wallpaper.
