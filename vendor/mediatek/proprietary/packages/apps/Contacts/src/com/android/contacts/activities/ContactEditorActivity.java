...
public class ContactEditorActivity extends AppCompatContactsActivity implements
        ...
        DialogManager.DialogShowingViewActivity ,SimEditProcessor.Listener {
    ...
    public interface ContactEditor {
        ...
        /// M: [Sim Contact Flow] insert sim card contacts completed @{
    ...
    private final ContactEditorFragment.Listener  mFragmentListener =
            new ContactEditorFragment.Listener() {
                ...
                public void onEditOtherRawContactRequested(
                    ...
                    Log.d(TAG, "[onEditOtherRawContactRequested]intent = " + intent);
                    ImplicitIntentsUtil.startActivityInApp(
    ...
    public void onCreate(Bundle savedState) {
        ...
        /// M: [Sim Contact Flow] ALPS00542175: can not add contact when
        /// in delete or import processing @{
    ...
    /// M: [Sim Contact Flow] Need to register a handler for
    /// sim edit processor if necessary. @{
    @Override
    public void onResume() {
        super.onResume();
        Log.w(TAG, "[onResume]");
        if (ContactsPortableUtils.MTK_PHONE_BOOK_SUPPORT) {
            // [ALPS03923484] get sim storage info every time when resume
