...
public class GroupMembersAdapter extends MultiSelectEntryContactListAdapter {
    ...
    public static class GroupMembersQuery {
        ...
        static {
            List<String> projectionList = Lists
                    .newArrayList(PROJECTION_PRIMARY_INTERNAL);
            if (ContactsPortableUtils.MTK_PHONE_BOOK_SUPPORT) {
                ...
                projectionList.add(MtkContactsContract.ContactsColumns.IS_SDN_CONTACT);
                /// @}
            }
        ...
        static {
            List<String> projectionList = Lists
                    .newArrayList(PROJECTION_ALTERNATIVE_INTERNAL);
            if (ContactsPortableUtils.MTK_PHONE_BOOK_SUPPORT) {
                /// M: Add some columns for Contacts extensions. @{
                projectionList.add(MtkContactsContract.ContactsColumns.INDICATE_PHONE_SIM);
                projectionList.add(MtkContactsContract.ContactsColumns.INDEX_IN_SIM);
    ...
    public long getGroupId() {
        Log.d("GroupMembersAdapter", "[getGroupId] mGroupId = " + mGroupId);
        return mGroupId;
    }
    /* @} */
