...
public abstract class DeviceLocalAccountLocator {
    ...
    public static DeviceLocalAccountLocator create(Context context,
        ...
        /// M: [Local Account Type] set Falgs to create Cp2DeviceLocalAccountLocator @{
        Flags.getInstance().setBoolean(Experiments.CP2_DEVICE_ACCOUNT_DETECTION_ENABLED, true);
        /// @}
    ...
    public static DeviceLocalAccountLocator create(Context context) {
        ...
        for (Account account : accountManager.getAccounts()) {
            Log.i("DeviceLocalAccountLocator", "knownTypes:" + Log.anonymize(account.name)
                + ", " + account.type);
