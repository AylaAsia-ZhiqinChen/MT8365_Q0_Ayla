...
public class PhoneNumberListAdapter extends ContactEntryListAdapter {
    ...
    public static class PhoneQuery {
        ...
        static {
            ...
            if (ContactsPortableUtils.MTK_PHONE_BOOK_SUPPORT) {
                /// M: [Sim Contact Flow] Add some columns for Contacts extensions. @{
                projectionList.add(MtkContactsContract.RawContactsColumns.INDICATE_PHONE_SIM); //9
                projectionList.add(MtkContactsContract.RawContactsColumns.IS_SDN_CONTACT); //10
                /// @}
            }
    ...
    protected void bindPhoneNumber(ContactListItemView view, Cursor cursor, boolean displayNumber,
        ...
        if (displayNumber &&  !cursor.isNull(PhoneQuery.PHONE_TYPE)) {
            ...
            /// M: [AAS] @{
            if (ContactsPortableUtils.MTK_PHONE_BOOK_SUPPORT) {
                label = GlobalEnv.getSimAasEditor().getTypeLabel(
    ...
    protected void bindPhoto(final ContactListItemView view, int partitionIndex, Cursor cursor) {
        ...
        if (photoId != 0) {
            ...
            if (photoUri == null) {
                ...
                /// M: [Sim Contact Flow] ImageRequest will need to pass subId also,
