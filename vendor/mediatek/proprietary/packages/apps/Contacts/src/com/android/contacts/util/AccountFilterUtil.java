...
public class AccountFilterUtil {
    ...
    public static class FilterLoader extends ListenableFutureLoader<List<ContactListFilter>> {
        ...
        private List<ContactListFilter> getFiltersForAccounts(List<AccountInfo> accounts) {
            ...
            for (AccountInfo accountInfo : accounts) {
                ...
                /// M: mark hasData() in local account due to Google issue.
                /// the account can't disappear after clear contacts. @{
    ...
    /// M: Description: for SIM name display @{
    public static String getAccountDisplayNameByAccount(String accountType, String accountName) {
        ...
        if (null == accountType || null == accountName) {
            Log.w(TAG, "[getAccountDisplayNameByAccount] accountType or accountName is null," +
                    " returned null.");
