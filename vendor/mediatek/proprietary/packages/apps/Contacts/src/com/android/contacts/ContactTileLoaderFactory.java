...
public final class ContactTileLoaderFactory {
    ...
    static {
        ...
        if (ContactsPortableUtils.MTK_PHONE_BOOK_SUPPORT) {
            ...
            projectionList.add(MtkContactsContract.ContactsColumns.INDICATE_PHONE_SIM);   //7
            projectionList.add(MtkContactsContract.ContactsColumns.IS_SDN_CONTACT); //8
            /// @}
        }
    ...
    static {
        ...
        if (ContactsPortableUtils.MTK_PHONE_BOOK_SUPPORT) {
            /// M: Add some columns for Contacts extensions. @{
            projectionList.add(MtkContactsContract.ContactsColumns.INDICATE_PHONE_SIM);   //12
            projectionList.add(MtkContactsContract.ContactsColumns.IS_SDN_CONTACT); //13
            /// @}
        }
