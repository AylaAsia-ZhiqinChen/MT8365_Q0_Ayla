...
public class MultiShrinkScroller extends FrameLayout {
    ...
    /// M:[Google Issue] 1/2 bug fix for ALPS01768247
    ...
    public void initialize(MultiShrinkScrollerListener listener, boolean isOpenContactSquare,
        ...
        SchedulingUtils.doOnPreDraw(this, /* drawNextFrame = */ false, new Runnable() {
            @Override
            public void run() {
                /** M: [Google Issue] Bug Fix for ALPS1747395 @{ */
                if (getContext() == null) {
                    return;
                }
                /** }@ */
                /// M: [Google Issue] 2/2, bug fix for ALPS01768247 @{
                mIsTwoPanel = getResources().getBoolean(R.bool.quickcontact_two_panel);
                /// @}
                if (!mIsTwoPanel) {
        ...
        .createJoynIconView((FrameLayout) findViewById(R.id.placeholder_container),
                mFullNameView, ((Activity) getContext()).getIntent().getData());
        ///@}
    ...
    private void updatePhotoTintAndDropShadow() {
        ...
        /* M: [Google Issue] ALPS03911566. Mark this code for we do not agree with
         * Google UX's opinion. We consider photo tinting necessary for below condition. @{
