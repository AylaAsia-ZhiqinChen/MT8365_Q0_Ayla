...
public class SimAccountType extends BaseAccountType {
    ...
    /// M: [Local Account Type] add default constructure for MTK sim account inherit @{
    ...
    ///M:[Local Account Type] fix sim icon display issue @{
    @Override
    ...
    /// M: [Local Account Type] add for mtk sim account name @{
    protected DataKind addDataKindStructuredName2(Context context)
    ...
    protected DataKind addDataKindName2(Context context) throws DefinitionException {
        DataKind kind = addKind(new DataKind(DataKind.PSEUDO_MIME_TYPE_NAME,
                R.string.nameLabelsGroup, -1, true));
        kind.typeOverallMax = 1;
