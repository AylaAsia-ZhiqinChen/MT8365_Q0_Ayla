...
public class JoinContactListAdapter extends ContactListAdapter {
    ...
    public void configureLoader(CursorLoader cursorLoader, long directoryId) {
        ...
        /* M: [Sim Contact Flow] ALPS00108644.
         * remove sim contact when do join. @{ */
        if (ContactsPortableUtils.MTK_PHONE_BOOK_SUPPORT) {
            loader.setSelection(Contacts._ID + "!=?" + " AND " +
                    MtkContactsContract.ContactsColumns.INDICATE_PHONE_SIM + "=-1");
        } else { /* @} */
