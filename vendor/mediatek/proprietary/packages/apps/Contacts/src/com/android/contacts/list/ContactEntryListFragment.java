 ...
 */
///M: change extend from Fragment to BaseEventHandlerFragment to handle PHB state change.
public abstract class ContactEntryListFragment<T extends ContactEntryListAdapter>
        extends BaseEventHandlerFragment /*Fragment*/
    ...
    protected void startLoading() {
        ...
        if (mAdapter == null) {
            ...
            Log.e(TAG, "[startLoading] mAdapter is null !!");
            return;
        }
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        if (id == DIRECTORY_LOADER_ID) {
            ...
            long directoryId = args != null && args.containsKey(DIRECTORY_ID_ARG_KEY)
                    ...
                    : Directory.DEFAULT;
            /// M: [SDN]Set the value whether show the sdn number. @{
    ...
    protected void onPartitionLoaded(int partitionIndex, Cursor data) {
        ...
        Log.d(TAG, "[onPartitionLoaded] index=" + partitionIndex + ", cursor=" + data);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /// M:[ALPS03438468]create list Adapter here for child class init the right status @{
        mAdapter = createListAdapter();
        /// @}
    ...
    /**
     * M: [ALPS00578162] in some case,restore the ListView last user will replace the new state.
    ...
    /**
     * M: [SDN]By default we show SDN Number in screen.
     */
