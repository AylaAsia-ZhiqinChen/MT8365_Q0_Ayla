...
class AvrcpControllerStateMachine extends StateMachine {
    ...
    synchronized void onBrowsingDisconnected() {
        ...
        if ((mService != null)
            && (mBrowseTree != null)
            && (mBrowseTree.mRootNode != null)
            && (mService.sBrowseTree != null)
            && (mService.sBrowseTree.mRootNode != null)) {
        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                case MESSAGE_PROCESS_SET_ABS_VOL_CMD:
                    /** M: Delete volume change extra count @{*/
                ...
                case MESSAGE_PROCESS_VOLUME_CHANGED_NOTIFICATION:
                    ...
                    } else if (mAbsVolNotificationRequested){
                        int percentageVol = getAbsVolume();
                        if (percentageVol != mPreviousPercentageVol) {
                            mService.sendRegisterAbsVolRspNative(
                                    mDeviceAddress,
    ...
    private void setAbsVolume(int absVol) {
        ...
        int reqLocalVolume = (int) Math.round((double) absVol * maxLocalVolume / ABS_VOL_BASE);
    ...
    private int getAbsVolume() {
        ...
        int newIndex = (int) Math.round((double)currIndex * ABS_VOL_BASE / maxVolume);
        if (newIndex > ABS_VOL_BASE)
            return ABS_VOL_BASE;
        return newIndex;
    }
