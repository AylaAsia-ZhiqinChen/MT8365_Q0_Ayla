...
public class ObexServerSockets {
    ...
    public static ObexServerSockets createInsecureWithFixedChannels(IObexConnectionHandler
        ...
        if(D) Log.d(STAG,"createInsecureWithFixedChannels" +
                    "(rfcomm = " +rfcommChannel + ", l2capPsm = " + l2capPsm +")");
        return create(validator, rfcommChannel, l2capPsm , false);
    }

    public static ObexServerSockets createWithFixedChannels(IObexConnectionHandler
            validator, int rfcommChannel, int l2capPsm) {
        if(D) Log.d(STAG,"createWithFixedChannels" +
                    "(rfcomm = " +rfcommChannel + ", l2capPsm = " + l2capPsm +")");
