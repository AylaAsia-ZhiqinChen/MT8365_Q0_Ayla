...
public class BluetoothTetheringNetworkFactory extends NetworkFactory {
    ...
    private final String mIfaceName = "bt-pan";
    ...
    protected void startNetwork() {
        ///M: ALPS03476153 will not startNetwork if there already has one @{
        if (mNetworkAgent != null) {
          log("Ignore startNetwork and still keep the current network agent " + mNetworkAgent);
          return;
        }
        /// @}
    ...
    private void performArpRequestForBt() {
        ...
        try {
            ...
            Slog.e(TAG, "performArpRequestForBt(): meet " + e);
        } finally {
            if (ap != null)    ap.close();
        }
    }
