...
public class AvrcpNativeInterface {
    ...
    /** M: Player app settings feature @{ */
    //PDU ID 0x11
    void getListPlayerAttributeRequest() {
        d("getListPlayerAttributeRequest");
        mAvrcpService.getListPlayerAttribute((a, b) ->
                getListPlayerAttributeResponse(a, b));
    }

    void getListPlayerAttributeResponse(byte attr, byte[] attrIds) {
        d("getListPlayerAttributeResponse attr");
        getListPlayerAttributeRspNative(attr, attrIds);
    }

    //PDU ID 0x12
    void getListPlayerAttributeValuesRequest(byte attr) {
        d("getListPlayerAttributeValuesRequest attr = " + attr);
        mAvrcpService.getListPlayerAttributeValues(attr, (a, b) ->
                getListPlayerAttributeValuesResponse(a, b));
    }

    void getListPlayerAttributeValuesResponse(byte numberAttr, byte[] values) {
        d("getListPlayerAttributeValuesResponse");
        getListPlayerAttributeValuesRspNative(numberAttr, values);
    }

    //PDU ID 0x13
    void getPlayerAttributeValueRequest(byte attr, int[] arr){
        d("getPlayerAttributeValueRequest");
        mAvrcpService.getPlayerAttributeValue(attr, arr, (a, b) ->
                getPlayerAttributeValueResponse(a, b));
    }

     void getPlayerAttributeValueResponse(byte numberAttr, byte[] attr) {
        d("getPlayerAttributeValueResponse");
        getPlayerAttributeValueRspNative(numberAttr, attr);
    }

    //PDU ID 0x14
    void setPlayerAppSettingRequest(byte num, byte [] attrId, byte [] attrVal){
        d("setPlayerAppSettingRequest");
        mAvrcpService.setPlayerAppSetting(num, attrId, attrVal, (a) ->
                setPlayerAppSettingResponse(a));
    }

     void setPlayerAppSettingResponse(int status) {
        d("setPlayerAppSettingResponse attr_status = " + status);
        setPlayerAppSettingRspNative(status);
    }

    //PDU ID 0x15
    void getPlayerAttributeTextRequest(byte attr, byte [] attrIds){
        d("getPlayerAttributeTextRequest");
        mAvrcpService.getPlayerAttributeText(attr, attrIds, (a, b, c, d) ->
                getPlayerAttributeTextResponse(a, b, c, d));
    }

    void getPlayerAttributeTextResponse(int numAttr, byte[] attr, int length, String[] text){
        d("getPlayerAttributeTextResponse");
        getPlayerAttributeTextRspNative(numAttr, attr, length, text);
    }

    //PDU ID 0x16
    void getPlayerAttributeValueTextRequest(byte attrId, byte numValue, byte [] value){
        d("getPlayerAttributeValueTextRequest");
        mAvrcpService.getPlayerAttributeTextValue(attrId, numValue, value, (a, b, c, d) ->
                getPlayerAttributeTextValueResponse(a, b, c, d));
    }

    void getPlayerAttributeTextValueResponse(int numAttr, byte[] attr, int length, String[] text){
        d("getPlayerAttributeTextValueResponse");
        getPlayerAttributeTextValueRspNative(numAttr, attr, length, text);
    }

    // Update player app settings changed
    void sendPlayerAppSettingsUpdate(boolean settingChanged) {
        d("sendPlayerAppSettingsUpdate playerSettings= " + settingChanged);
        sendPlayerAppSettingsUpdateNative(settingChanged);
    }

    // Get app setting change
    void getAppSettingChangeRequest(){
        d("getAppSettingChangeRequest");
        mAvrcpService.getAppSettingChange((a, b) ->
                getAppSettingChangeResponse(a, b));
    }

     void getAppSettingChangeResponse(byte numberAttr, byte[] attr) {
        d("getAppSettingChangeResponse");
        getAppSettingChangeRspNative(numberAttr, attr);
    }
    /** @} */
    ...
    /** M: Avrcp native interface for Player app settings feature @{ */
    private native void getListPlayerAttributeRspNative(byte attr, byte[] attrIds);
    private native void getListPlayerAttributeValuesRspNative(byte numberAttr, byte[]values);
    private native void getPlayerAttributeValueRspNative(byte numberAttr, byte[]attr);
    private native void setPlayerAppSettingRspNative(int status);
    private native void getPlayerAttributeTextRspNative(int numAttr, byte[] attr,
        int length, String[]text);
    private native void getPlayerAttributeTextValueRspNative(int numAttr, byte[] attr,
        int length, String[]text);
    private native void sendPlayerAppSettingsUpdateNative(boolean settingChanged);
    private native void getAppSettingChangeRspNative(byte numberAttr, byte[]attr);
    /** @} */
