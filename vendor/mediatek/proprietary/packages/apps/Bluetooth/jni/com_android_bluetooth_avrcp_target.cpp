...
/** M: Avrcp app settings callback interface @{ */
using GetListAttributeCb = MediaInterface::ListAttributesCallback;
static void getListPlayerAttribute(GetListAttributeCb cb);

using GetListAttributeValuesCb = MediaInterface::ListValuesCallback;
static void getListPlayerAttributeValues(
    uint8_t player_att,
    GetListAttributeValuesCb cb);

using GetAttributeValueCb = MediaInterface::GetValuesCallback;
static void getPlayerAttributeValue(
    std::vector<BtrcPlayerAttr> pAttrs, GetAttributeValueCb cb);

using SetPlayerAppSettingCb = MediaInterface::SetValuesCallback;
static void setPlayerAppSetting(BtrcPlayerSettings attr,
    SetPlayerAppSettingCb cb);

using GetAttributeTextCb = MediaInterface::GetAttrsTxtCallback;
static void getPlayerAttributeText(
    std::vector<BtrcPlayerAttr> att,
    GetAttributeTextCb cb);

using GetAttributeTextValueCb = MediaInterface::GetValuesTxtCallback;
static void getPlayerAttributeValueText(uint8_t attr_id,
    std::vector<uint8_t> value,
    GetAttributeTextValueCb cb);

using GetAppSettingChangeCb = MediaInterface::GetSettingChangeCallback;
static void getAppSettingChange(GetAppSettingChangeCb cb);
/** @} */
...
/** M: Avrcp player app settings jni callback function @{ */
static jmethodID method_getListPlayerAttributeRequest;
static jmethodID method_getListPlayerAttributeValuesRequest;
static jmethodID method_getPlayerAttributeValueRequest;
static jmethodID method_setPlayerAppSettingRequest;
static jmethodID method_getPlayerAttributeTextRequest;
static jmethodID method_getPlayerAttributeValueTextRequest;
static jmethodID method_getAppSettingChangeRequest;
/** @} */
...
static void classInitNative(JNIEnv* env, jclass clazz) {
  ...
  /** M: Player App Settings JNI callback functions @{ */
  // PDU ID 0x11
  method_getListPlayerAttributeRequest =
      env->GetMethodID(clazz, "getListPlayerAttributeRequest", "()V");

  // PDU ID 0x12
  method_getListPlayerAttributeValuesRequest =
      env->GetMethodID(clazz, "getListPlayerAttributeValuesRequest", "(B)V");

  // PDU ID 0x13
  method_getPlayerAttributeValueRequest =
      env->GetMethodID(clazz, "getPlayerAttributeValueRequest", "(B[I)V");

  // PDU ID 0x14
  method_setPlayerAppSettingRequest =
      env->GetMethodID(clazz, "setPlayerAppSettingRequest", "(B[B[B)V");

  // PDU ID 0x15
  method_getPlayerAttributeTextRequest =
      env->GetMethodID(clazz, "getPlayerAttributeTextRequest", "(B[B)V");

  // PDU ID 0x16
  method_getPlayerAttributeValueTextRequest =
      env->GetMethodID(clazz, "getPlayerAttributeValueTextRequest", "(BB[B)V");

  // Get app setting change
  method_getAppSettingChangeRequest =
      env->GetMethodID(clazz, "getAppSettingChangeRequest", "()V");
  /** @} */
...
static SongInfo getSongInfoFromJavaObj(JNIEnv* env, jobject metadata) {
  ...
  if (metadata == nullptr) {
    ALOGE("%s: Got a null metadata", __func__);
    return SongInfo();
  }
...
/** M: Player app settings JNI callback and Native funtion @{ */
//PDU ID 0x11
GetListAttributeCb get_list_attribute_cb;
static void getListPlayerAttribute(GetListAttributeCb cb) {
  ALOGD("%s", __func__);
  std::shared_lock<std::shared_timed_mutex> lock(callbacks_mutex);
  CallbackEnv sCallbackEnv(__func__);
  ...
  if (!mJavaInterface) {
    ALOGE("%s: mJavaInterface is null", __func__);
    return;
  }
  get_list_attribute_cb = cb;
  sCallbackEnv->CallVoidMethod(mJavaInterface,
                               method_getListPlayerAttributeRequest);
}

//PDU ID 0x12
GetListAttributeValuesCb get_list_attribute_value_cb;
static void getListPlayerAttributeValues(
    uint8_t player_att, GetListAttributeValuesCb cb) {
  ALOGD("%s", __func__);
  std::shared_lock<std::shared_timed_mutex> lock(callbacks_mutex);
  CallbackEnv sCallbackEnv(__func__);
  if (!sCallbackEnv.valid()) return;
  ...
  get_list_attribute_value_cb = cb;
  sCallbackEnv->CallVoidMethod(mJavaInterface,
                               method_getListPlayerAttributeValuesRequest,
                               (jbyte)player_att);
}
...
//PDU ID 0x13
GetAttributeValueCb get_attribute_value_cb;
static void getPlayerAttributeValue(std::vector<BtrcPlayerAttr> p_attrs,
    GetAttributeValueCb cb) {
  ALOGD("%s", __func__);
  std::shared_lock<std::shared_timed_mutex> lock(callbacks_mutex);
  CallbackEnv sCallbackEnv(__func__);
  if (!sCallbackEnv.valid()) return;
  ...
  jintArray attrs;
  jbyte num_attr = (jbyte) p_attrs.size();
  ...
  jint *attrs_value_pt = new jint[num_attr];
  if (!attrs_value_pt) {
    ALOGE("getPlayerAttributeValue: not have enough memeory");
    sCallbackEnv->DeleteLocalRef(attrs);
    return;
  }

  for (int i = 0; i < num_attr; ++i) {
    *(attrs_value_pt + i) = (jint)p_attrs[i];
  }

  sCallbackEnv->SetIntArrayRegion(attrs, 0, num_attr, attrs_value_pt);
  get_attribute_value_cb = cb;
  sCallbackEnv->CallVoidMethod(mJavaInterface,
                               method_getPlayerAttributeValueRequest,
                               (jbyte)num_attr, attrs);
  delete[] attrs_value_pt;
  sCallbackEnv->DeleteLocalRef(attrs);
}

//PDU ID 0x14
SetPlayerAppSettingCb set_player_app_setting_cb;
static void setPlayerAppSetting(BtrcPlayerSettings attr,
    SetPlayerAppSettingCb cb) {
  ALOGD("%s", __func__);
  std::shared_lock<std::shared_timed_mutex> lock(callbacks_mutex);
  ...
  if (!attrs_ids) {
    ALOGE("Fail to new jintArray for attrs_ids");
    return;
  }
  sCallbackEnv->SetByteArrayRegion(attrs_ids, 0, attr.num_attr,
                                        (jbyte *)attr.attr_ids);
  jbyteArray attrs_value = (jbyteArray)sCallbackEnv->NewByteArray(attr.num_attr);
  if (!attrs_value) {
    sCallbackEnv->DeleteLocalRef(attrs_ids);
    ALOGE("Fail to new jintArray for attrs_value");
    return;
  }
  sCallbackEnv->SetByteArrayRegion(attrs_value, 0, attr.num_attr,
                                       (jbyte *)attr.attr_values);
  set_player_app_setting_cb = cb;
  sCallbackEnv->CallVoidMethod(mJavaInterface,
                               method_setPlayerAppSettingRequest,
...
//PDU ID 0x15
GetAttributeTextCb get_attribute_text_cb;
static void getPlayerAttributeText(std::vector<BtrcPlayerAttr> att,
    GetAttributeTextCb cb) {
  ALOGD("%s", __func__);
  std::shared_lock<std::shared_timed_mutex> lock(callbacks_mutex);
  CallbackEnv sCallbackEnv(__func__);
  ...
  jbyte *attrs_value_pt = new jbyte[num];
  if (!attrs_value_pt) {
    ALOGE("getPlayerAttributeText: not have enough memeory");
    sCallbackEnv->DeleteLocalRef(attrs);
    return;
  }

  for (int i = 0; i < num; ++i) {
    *(attrs_value_pt + i) = (jbyte)att[i];
  }

  sCallbackEnv->SetByteArrayRegion(attrs, 0, num, attrs_value_pt);
  get_attribute_text_cb = cb;
  sCallbackEnv->CallVoidMethod(mJavaInterface,
                               method_getPlayerAttributeTextRequest,
                               (jbyte) num ,attrs);
  delete[] attrs_value_pt;
...
//PDU ID 0x16
GetAttributeTextValueCb get_attribute_text_value_cb;
static void getPlayerAttributeValueText(uint8_t attr_id,
    std::vector<uint8_t> value, GetAttributeTextValueCb cb) {
  ALOGD("%s", __func__);
  std::shared_lock<std::shared_timed_mutex> lock(callbacks_mutex);
  CallbackEnv sCallbackEnv(__func__);
  if (!sCallbackEnv.valid()) return;
  ...
  jbyte num_val =  (jbyte) value.size();
  ...
  jbyte *attr_value_pt = new jbyte[num_val];
  if (!attr_value_pt) {
    ALOGE("getPlayerAttributeValueText: not have enough memeory");
    sCallbackEnv->DeleteLocalRef(Attr_Value);
    return;
  }

  for (int i = 0; i < num_val; ++i) {
    *(attr_value_pt + i) = (jbyte)value[i];
  }

  sCallbackEnv->SetByteArrayRegion(Attr_Value, 0, num_val, attr_value_pt);
  sCallbackEnv->CallVoidMethod(mJavaInterface,
                               method_getPlayerAttributeValueTextRequest,
                               (jbyte) attr_id, num_val , Attr_Value);
  get_attribute_text_value_cb = cb;
  delete[] attr_value_pt;
  sCallbackEnv->DeleteLocalRef(Attr_Value);
}

//Get app setting change value
GetAppSettingChangeCb get_app_setting_change_cb;
static void getAppSettingChange(GetAppSettingChangeCb cb) {
  ALOGD("%s", __func__);
  std::shared_lock<std::shared_timed_mutex> lock(callbacks_mutex);
  CallbackEnv sCallbackEnv(__func__);
...
static void getListPlayerAttributeRspNative(JNIEnv *env,jobject object,
    jbyte numAttr, jbyteArray attrIds) {
  ALOGD("%s", __func__);
  ...
  std::vector<BtrcPlayerAttr> pAttrs;
  ...
  for (i = 0; i < numAttr; ++i) {
    pAttrs.push_back((BtrcPlayerAttr)attr[i]);
  }

  //Callback Methos to Respond PDU 0x11
  get_list_attribute_cb.Run(pAttrs);

  env->ReleaseByteArrayElements(attrIds, attr, 0);
}

//JNI Method called to Respond to PDU 0x12
static void getListPlayerAttributeValuesRspNative(JNIEnv *env, jobject object,
    jbyte numvalue, jbyteArray value) {
  ALOGD("%s", __func__);
  std::shared_lock<std::shared_timed_mutex> lock(interface_mutex);
  int i;
  jbyte *attr;
  ...
  for (i = 0; i < numvalue; ++i) {
    pAttrs.push_back((uint8_t)attr[i]);
  }

  //Callback Methos to Respond PDU 0x12
  get_list_attribute_value_cb.Run(pAttrs);

  env->ReleaseByteArrayElements(value, attr, 0);
}

//JNI Method called to Respond to PDU 0x13
static void getPlayerAttributeValueRspNative(JNIEnv *env, jobject object,
  ...
  if( numattr > BTRC_MAX_APP_ATTR_SIZE || numattr == 0) {
    ALOGE("SendPlayerValueRspNative: number of attributes exceed maximum");
    return;
  }

  BtrcPlayerSettings pAttrs;
  attr = env->GetByteArrayElements(value, NULL);
  if (!attr) {
    jniThrowIOException(env, EINVAL);
    env->ReleaseByteArrayElements(value, attr, 0);
  ...
  //Callback Methos to Respond PDU 0x13
  get_attribute_value_cb.Run(pAttrs);

  env->ReleaseByteArrayElements(value, attr, 0);
}

//JNI Method called to Respond to PDU 0x14
static void setPlayerAppSettingRspNative(JNIEnv *env, jobject object,
    jint attr_status) {
  ALOGD("%s", __func__);
  std::shared_lock<std::shared_timed_mutex> lock(interface_mutex);

  //Callback Methos to Respond PDU 0x14
  set_player_app_setting_cb.Run((BtrcStatus)attr_status);
}

//JNI Method Called to Respond to PDU 0x15
static void getPlayerAttributeTextRspNative(JNIEnv *env, jobject object,
    jint num_attr,jbyteArray attr, jint length, jobjectArray textArray) {
  ALOGD("%s", __func__);
  std::shared_lock<std::shared_timed_mutex> lock(interface_mutex);
  jbyte *arr ;

  if (num_attr > BTRC_MAX_APP_SETTINGS) {
    ALOGE("get_element_attr_rsp: number of attributes exceed maximum");
    return;
  }

  std::vector<BtrcPlayerSettingText> pAttrs;
  ...
  for (i = 0; i < num_attr ; ++i) {
    ...
    if (strlen(textStr) >= BTRC_MAX_ATTR_STR_LEN) {
        ...
        strncpy((char *)temp.text, textStr, BTRC_MAX_ATTR_STR_LEN-1);
        temp.text[BTRC_MAX_ATTR_STR_LEN-1] = 0;
    } else {
        strncpy((char *)temp.text, textStr, strlen(textStr)+1);
    }
    pAttrs.push_back(std::move(temp));
    //Check out if release need to be done in for loop
    env->ReleaseStringUTFChars(text, textStr);
    env->DeleteLocalRef(text);
  }
  //Callback Methos to Respond PDU 0x15
  get_attribute_text_cb.Run(pAttrs);

  env->ReleaseByteArrayElements(attr, arr, 0);
}

//JNI Method Called to respond to PDU 0x16
static void getPlayerAttributeTextValueRspNative(JNIEnv *env, jobject object,
    jint num_attr,jbyteArray attr, jint length, jobjectArray textArray) {
  ALOGD("%s", __func__);
  std::shared_lock<std::shared_timed_mutex> lock(interface_mutex);
  jbyte *arr ;
  ...
  get_attribute_text_value_cb.Run(pAttrs);

  env->ReleaseByteArrayElements(attr, arr, 0);
}

//JNI Method called to Respond get app setting change
static void getAppSettingChangeRspNative(JNIEnv *env, jobject object,
    jbyte numattr, jbyteArray value) {
  ALOGD("%s", __func__);
  std::shared_lock<std::shared_timed_mutex> lock(interface_mutex);
  int i;
  ...
  //Callback Methos to get app setting change
  get_app_setting_change_cb.Run(pAttrs);
...
static void sendPlayerAppSettingsUpdateNative(JNIEnv *env, jobject object,
    jboolean appSettings) {
  ALOGD("%s", __func__);
  std::unique_lock<std::shared_timed_mutex> interface_lock(interface_mutex);
  if (mServiceCallbacks == nullptr) {
    ALOGW("%s: Service not loaded.", __func__);
  ...
  mServiceCallbacks->SendAppSettingUpdate(appSettings == JNI_TRUE);
}
/** @} */
...
static JNINativeMethod sMethods[] = {
    ...
    {"sendVolumeChangedNative", "(I)V", (void*)sendVolumeChangedNative},
     /** M: Player App Settings Native functions @{ */
    {"getListPlayerAttributeRspNative", "(B[B)V",
                                      (void*)getListPlayerAttributeRspNative},
    {"getListPlayerAttributeValuesRspNative", "(B[B)V",
                                (void*)getListPlayerAttributeValuesRspNative},
    {"getPlayerAttributeValueRspNative", "(B[B)V",
                                     (void*)getPlayerAttributeValueRspNative},
    {"setPlayerAppSettingRspNative", "(I)V",
                                         (void*)setPlayerAppSettingRspNative},
    {"getPlayerAttributeTextRspNative", "(I[BI[Ljava/lang/String;)V",
                                      (void*)getPlayerAttributeTextRspNative},
    {"getPlayerAttributeTextValueRspNative" , "(I[BI[Ljava/lang/String;)V",
                                 (void*)getPlayerAttributeTextValueRspNative},
    {"sendPlayerAppSettingsUpdateNative", "(Z)V",
                                   (void*)sendPlayerAppSettingsUpdateNative},
    {"getAppSettingChangeRspNative", "(B[B)V",
                                     (void*)getAppSettingChangeRspNative},
    /** @} */
};
