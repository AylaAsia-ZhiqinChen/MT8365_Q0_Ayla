...
public class PackagesMonitor extends BroadcastReceiver {
    private static final String TAG = "Gallery2/PackagesMonitor";
    ...
    public void onReceive(final Context context, final Intent intent) {
        /// M: [BUG.MASK] Since Gallery do not support PicasaSource.
        // Do not start AsyncService in background due to background service limitation
        // of android O. @{
    ...
    private static void onReceiveAsync(Context context, Intent intent) {
        ...
        /// M: [BUG.ADD] avoid Nullpointer exception @{
        if (intent == null) {
            Log.d(TAG, "<onReceiveAsync> intent is null, return");
            return;
        }
        /// @}
