...
public class TileImageView extends GLView {
    ...
    public TileImageView(GalleryContext context) {
        ...
        for (int i = 0; i < TILE_DECODER_NUM; i++) {
            ...
            t.start();
            Log.d(TAG, "<TileImageView> create Thread-" + i + ", id = "
                    + t.getId());
        ...
        */
        if (mTileDecoderThread == null) {
            ...
            for (int i = 0; i < TILE_DECODER_NUM; i++) {
                ...
                t.setName("TileDecoder-" + i);
                t.start();
                Log.d(TAG, "<TileImageView> create Thread-" + i + ", id = " + t.getId());
                mTileDecoderThread.add(t);
            }
        }
        /// @}
    ...
    private class TileUploader implements GLRoot.OnGLIdleListener {
        ...
        public boolean onGLIdle(GLCanvas canvas, boolean renderRequested) {
            ...
            /// M: [DEBUG.ADD] @{
            Log.d(TAG, "<TileUploader.onGLIdle> end and return " + (tile != null));
            /// @}
            return tile != null;
        }
    }
    ...
    public void drawTile(GLCanvas canvas,
        ...
        if (tile != null) {
            ...
            /// add synchronized for mTileState change.
            synchronized (TileImageView.this) {
            /// @}
    ...
    private class Tile extends UploadedTexture {
        ...
        protected Bitmap onGetBitmap() {
            ...
            if (mTileState != STATE_DECODED) {
                Log.e(TAG, "<onGetBitmap>mTileState:" + mTileState);
            }
            /// @}
