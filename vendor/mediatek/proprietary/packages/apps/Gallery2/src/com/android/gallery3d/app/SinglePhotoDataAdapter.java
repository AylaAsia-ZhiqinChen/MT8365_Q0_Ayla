...
public class SinglePhotoDataAdapter extends TileImageViewAdapter
    ...
    public SinglePhotoDataAdapter(
        ...
        Log.d(TAG, "<SinglePhotoDataAdapter> hasFullImage " + mHasFullImage);
        ...
        mHandler = new SynchronizedHandler(activity.getGLRoot()) {
            ...
            public void handleMessage(Message message) {
                ...
                /// M: [BUG.MODIFY] while decoder == null in FutureListener,
                // should set mHasFullImage as false in sub-thread. Occur multi-thread issue @{
                /*if (mHasFullImage) {
    ...
    private FutureListener<BitmapRegionDecoder> mLargeListener =
        ...
        public void onFutureDone(Future<BitmapRegionDecoder> future) {
            ...
            /// M: [BUG.ADD] @{
            bitmap = com.mediatek.gallerybasic.util.BitmapUtils.replaceBackgroundColor(bitmap,
                    true);
            /// @}
