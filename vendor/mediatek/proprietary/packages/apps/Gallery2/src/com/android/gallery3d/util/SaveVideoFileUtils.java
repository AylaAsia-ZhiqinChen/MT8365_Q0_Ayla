...
public class SaveVideoFileUtils {
    ...
    public static SaveVideoFileInfo getDstMp4FileInfo(String fileNameFormat,
            ContentResolver contentResolver, Uri uri, File srcVideoParent,
            boolean isTrim, String defaultFolderName) {
    ...
    public static Uri insertContent(SaveVideoFileInfo mDstFileInfo,
        ...
        String[] projection = new String[] {
                ...
                VideoConstantUtils.get(VideoConstantUtils.ORIENTATION),
        };
        ...
        querySource(contentResolver, uri, projection,
                ...
                @Override
                    public void onCursorResult(Cursor cursor) {
                        ...
                        values.put(VideoConstantUtils.get(VideoConstantUtils.ORIENTATION),
                                cursor.getString(4));
