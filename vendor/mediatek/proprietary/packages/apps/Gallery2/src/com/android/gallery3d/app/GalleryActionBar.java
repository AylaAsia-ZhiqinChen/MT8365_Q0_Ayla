...
public class GalleryActionBar implements OnNavigationListener {
    ...
    public void setShareIntents(Intent sharePanoramaIntent, Intent shareIntent,
         ActivityChooserModelWrapper.OnChooseActivityListenerWrapper onChooseListener) {
    /// @}
        /// M: [BEHAVIOR.MARK] mask panorama share menu @{
        /*
    ...
    /**
     * Reset OnChooseActivityListener as null
     */
    public void resetOnChooseActivityListener() {
        if (mDataModel != null) {
            Log.d(TAG, "reset mDataModel#OnChooseActivityListener(null)");
            mDataModel.setOnChooseActivityListener(null);
        }
        mOnChooseActivityListener = null;
    }
    ...
    public void removeAlbumModeListener() {
        if (mActionBar != null) {
            mAlbumModeListener = null;
            Log.d(TAG, "<removeAlbumModeListener> removeAlbumModeListener to doCluster");
        }
    }
