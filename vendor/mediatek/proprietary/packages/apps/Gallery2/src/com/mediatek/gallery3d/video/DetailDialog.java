...
public class DetailDialog extends AlertDialog implements DialogInterface.OnClickListener {
    ...
    public DetailDialog(final Context context, final String title, final String author,
        ...
        Log.v(TAG, "DetailDialog() mTitle=" + mTitle
                + ", mAuthor=" + mAuthor + ", mCopyRight=" + mCopyright);
    }
