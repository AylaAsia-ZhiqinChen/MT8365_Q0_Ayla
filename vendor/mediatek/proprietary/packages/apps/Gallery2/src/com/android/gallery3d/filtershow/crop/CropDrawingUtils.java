...
public abstract class CropDrawingUtils {
    ...
    public static boolean setImageToScreenMatrix(Matrix dst, RectF image,
        ...
        /// M: [BUG.MODIFY] @{
        //  in o0, the mean of return value changed,
        //  if the matrix include rotate(although rotate 90 degree), it will return false.
        //if (!dst.mapRect(rotatedImage, image)) {
        //    return false; // fails for rotations that are not multiples of 90 degrees
        //}
