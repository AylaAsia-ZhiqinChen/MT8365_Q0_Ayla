...
public abstract class BaseFiltersManager implements FiltersManagerInterface {
    ...
    public void addEffects() {
        ...
        /// M: [BUG.MODIFY] Conditionally enable RenderScript effects @{
    ...
    // Platform apps can not access /data dir due to N latest SELinux rule, thus filtershow can not
    // access RenderScript lib in /data/data dir.
    // Additionally, some RenderScript operations were not ready on platforms before JB MR2.
    // Then we have to disable the effects which are implemented by RenderScript in these cases.
