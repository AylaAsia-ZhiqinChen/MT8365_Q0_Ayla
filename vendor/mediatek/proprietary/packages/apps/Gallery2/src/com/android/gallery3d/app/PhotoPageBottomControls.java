...
public class PhotoPageBottomControls implements OnClickListener {
    ...
    public void setup(Delegate delegate, Context context, ViewGroup layout) {
        /// @}
        mDelegate = delegate;
        ...
        /// M: [FEATURE.ADD] @{
        mContext = context;
        mDelegate.onBottomControlCreated();
        /// @}
    ...
    private float mDensity = 0.f;
    public int addButtonToContainer(Drawable image) {
        if (mLeftButtonId == -1) {
            mLeftButtonId = mContainer.findViewById(R.id
                    .photopage_bottom_control_edit).getId();
        }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            ...
            id = FeatureHelper.generateViewId();
        }
        button.setId(id);
        button.setImageDrawable(image);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            button.setBackground(mContext.getResources().getDrawable(R.drawable
                    .photopage_bottom_button_background, null));
        } else {
            button.setBackground(mContext.getResources().getDrawable(R.drawable
                    .photopage_bottom_button_background));
        }
        button.setPadding(dip2px(15), dip2px(5), dip2px(15), dip2px(5));
        ...
        params.addRule(RelativeLayout.RIGHT_OF, mLeftButtonId);
