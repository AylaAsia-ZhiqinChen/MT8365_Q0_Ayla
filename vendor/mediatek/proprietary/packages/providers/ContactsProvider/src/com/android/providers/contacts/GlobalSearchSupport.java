...
public class GlobalSearchSupport {
    ...
    public Cursor handleSearchSuggestionsQuery(SQLiteDatabase db, Uri uri, String[] projection,
        ...
        /// M: add log @{
        Log.d(TAG, "[handleSearchSuggestionsQuery]result cursor count:"
    ...
    public Cursor handleSearchShortcutRefresh(SQLiteDatabase db, String[] projection,
        ...
        return addSearchSuggestionsBasedOnFilter(cursor,
                ...
                cancellationSignal);
         * @{ */
        Log.d(TAG, "[handleSearchShortcutRefresh]contactId:" + contactId);
        filter = filter == null ? null : (filter.equals("null") ? null : filter);
        Cursor c = addSearchSuggestionsBasedOnFilter(cursor,
                db, projection, ContactsColumns.CONCRETE_ID + "=" + contactId, filter, null,
                cancellationSignal);
        Log.d(TAG, "[handleSearchShortcutRefresh]Result cursor count:"
    ...
    private Cursor addSearchSuggestionsBasedOnFilter(MatrixCursor cursor, SQLiteDatabase db,
        ...
        /// M: [Sim Contact Flow] @{
        sb.append(", " + MtkContactsContract.ContactsColumns.INDICATE_PHONE_SIM);
        sb.append(", " + MtkContactsContract.ContactsColumns.IS_SDN_CONTACT);
        ///@}
        sb.append(" FROM ");
