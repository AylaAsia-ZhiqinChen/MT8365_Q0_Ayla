...
import com.mediatek.provider.MtkContactsContract.CommonDataKinds.ImsCall;
...
public class ContactsDatabaseHelper extends SQLiteOpenHelper {
    ...
    public interface ContactsColumns {
        ...
        public static final String CONCRETE_SEND_TO_VOICEMAIL_VT = Tables.CONTACTS
                + "." + MtkContactsContract.ContactsColumns.SEND_TO_VOICEMAIL_VT;
        public static final String CONCRETE_SEND_TO_VOICEMAIL_SIP = Tables.CONTACTS
                + "." + MtkContactsContract.ContactsColumns.SEND_TO_VOICEMAIL_SIP;
        public static final String CONCRETE_FILTER = Tables.CONTACTS
                + "." + MtkContactsContract.ContactsColumns.FILTER;
        public static final String CONCRETE_IS_SDN_CONTACT = Tables.CONTACTS
    ...
    public interface RawContactsColumns {
        ...
        /// M: @{
        public static final String CONCRETE_TIMESTAMP = Tables.RAW_CONTACTS + "." 
                + MtkContactsContract.RawContacts.TIMESTAMP;
        public static final String INDICATE_PHONE_SIM = Tables.RAW_CONTACTS + "." 
                + MtkContactsContract.RawContactsColumns.INDICATE_PHONE_SIM;
        public static final String INDEX_IN_SIM = Tables.RAW_CONTACTS + "." 
                + MtkContactsContract.RawContactsColumns.INDEX_IN_SIM;
        public static final String IS_SDN_CONTACT = Tables.RAW_CONTACTS + "." 
                + MtkContactsContract.RawContactsColumns.IS_SDN_CONTACT;
        /// @}
    }
    ...
    public interface DataColumns {
        ...
        public static final String CONCRETE_IS_ADDITIONAL_NUMBER =
                Tables.DATA + "." + MtkContactsContract.DataColumns.IS_ADDITIONAL_NUMBER;
        /// @}
    }
    ...
    public void onOpen(SQLiteDatabase db) {
        ...
        /// M: pre-process to add missing columns and refresh trigger/view/stats @{
        preprocessToAddWhenOpen(db);
        /// @}
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + Tables.RAW_CONTACTS + " (" +
                ...
                /// M: add columns @{
                MtkContactsContract.RawContacts.TIMESTAMP + " INTEGER," +
                MtkContactsContract.RawContactsColumns.SEND_TO_VOICEMAIL_VT
                        + " INTEGER NOT NULL DEFAULT 0," +
                MtkContactsContract.RawContactsColumns.SEND_TO_VOICEMAIL_SIP
                        + " INTEGER NOT NULL DEFAULT 0," +
                MtkContactsContract.RawContactsColumns.INDICATE_PHONE_SIM
                        + " INTEGER NOT NULL DEFAULT -1," +
                MtkContactsContract.RawContactsColumns.INDEX_IN_SIM
...
//        ");");
    ...
    private void createContactsViews(SQLiteDatabase db) {
        ...
        String syncColumns =
                ...
                /// M: add a column @{
                + RawContactsColumns.CONCRETE_TIMESTAMP + " AS "
                        + MtkContactsContract.RawContacts.TIMESTAMP;
                /// @}
        ...
        String contactOptionColumns =
                ...
                + ContactsColumns.CONCRETE_PINNED
                        + " AS " + Contacts.PINNED + ","
                /// M: add columns @{
                + ContactsColumns.CONCRETE_SEND_TO_VOICEMAIL_VT + " AS " 
                        + MtkContactsContract.RawContactsColumns.SEND_TO_VOICEMAIL_VT + ","
                + ContactsColumns.CONCRETE_SEND_TO_VOICEMAIL_SIP + " AS " 
                        + MtkContactsContract.RawContactsColumns.SEND_TO_VOICEMAIL_SIP;
                /// @}
        ...
        String contactNameColumns =
                ...
                /// M: add columns @{
                + "name_raw_contact." + MtkContactsContract.RawContactsColumns.INDICATE_PHONE_SIM
                        + " AS " + MtkContactsContract.ContactsColumns.INDICATE_PHONE_SIM + ", "
                + "name_raw_contact." + MtkContactsContract.RawContactsColumns.INDEX_IN_SIM
                        + " AS " + MtkContactsContract.ContactsColumns.INDEX_IN_SIM
                + ", " + "name_raw_contact." + MtkContactsContract.RawContactsColumns.IS_SDN_CONTACT
                        + " AS " + MtkContactsContract.ContactsColumns.IS_SDN_CONTACT;
                /// @}
        ...
        String contactsColumns =
                ...
                + "0 AS " + Contacts.LR_TIMES_CONTACTED + ", "
                /// M: add columns @{
                + ContactsColumns.CONCRETE_FILTER
                        + " AS " + MtkContactsContract.ContactsColumns.FILTER + ", "
                + ContactsColumns.CONCRETE_SEND_TO_VOICEMAIL_VT
                        + " AS " + MtkContactsContract.ContactsColumns.SEND_TO_VOICEMAIL_VT + ", "
                + ContactsColumns.CONCRETE_SEND_TO_VOICEMAIL_SIP
                        + " AS " + MtkContactsContract.ContactsColumns.SEND_TO_VOICEMAIL_SIP;
                /// @}
        ...
        String rawEntitiesSelect = "SELECT "
                ...
                /// M: add columns @{
                + MtkContactsContract.RawContactsColumns.IS_SDN_CONTACT + ", "
                + RawContactsColumns.INDICATE_PHONE_SIM + " AS "
                        + MtkContactsContract.RawContactsColumns.INDICATE_PHONE_SIM
                + ", "
                + RawContactsColumns.INDEX_IN_SIM + " AS "
                        + MtkContactsContract.RawContactsColumns.INDEX_IN_SIM
                + ", " + RawContactsColumns.IS_SDN_CONTACT + " AS "
                        + MtkContactsContract.RawContactsColumns.IS_SDN_CONTACT
                /// @}
                + " FROM " + Tables.RAW_CONTACTS
                + " JOIN " + Tables.ACCOUNTS + " ON ("
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        /// M: add MTK customized columns, if need @{
        addMissingColumnsIfNeed(db);
        /// @}
    ...
    public long getMimeTypeIdForImsCall() {
        return lookupMimeTypeId(getWritableDatabase(), ImsCall.CONTENT_ITEM_TYPE);
    }
    /// @}
    ...
    /// M: Add customized column @{
    // Invoke in onOpen, add columns and refresh trigger, view and sql stats
    private void preprocessToAddWhenOpen(SQLiteDatabase db) {
        if (isNeededToAddColumns(db)) {
            addContactsColumns(db);
            addRawContactsColumns(db);
            addDataColumns(db);
    ...
    // Invoke in onUpgrade (add columns only)
    private void addMissingColumnsIfNeed(SQLiteDatabase db) {
        addContactsColumns(db);
        addRawContactsColumns(db);
        addDataColumns(db);
    }

    private boolean isNeededToAddColumns(SQLiteDatabase db) {
        String rawSql = "SELECT " + MtkContactsContract.ContactsColumns.IS_SDN_CONTACT +
                " FROM " + Tables.CONTACTS;
        try {
            db.rawQuery(rawSql, null);
        } catch (SQLiteException e) {
            e.printStackTrace();
            String pattern = "no such column";
    ...
    private void addMissingColumns(SQLiteDatabase db, String rawSql, ArrayList<String> sqlList) {
        try {
            db.rawQuery(rawSql, null);
        } catch (SQLiteException e) {
            e.printStackTrace();
            ...
            if (e.toString().contains(pattern)) {
                for (String sql: sqlList) {
                    try {
                        db.execSQL(sql);
                    } catch (SQLiteException insertException) {
    ...
    private void addContactsColumns(SQLiteDatabase db) {
        String rawSelect = "SELECT " + MtkContactsContract.ContactsColumns.IS_SDN_CONTACT +
                " FROM " + Tables.CONTACTS;

        ArrayList<String> list = new ArrayList<String>();
        String prefix = "ALTER TABLE " + Tables.CONTACTS + " ADD ";
        String integerAndDefault = " INTEGER NOT NULL DEFAULT";
        list.add(prefix + MtkContactsContract.ContactsColumns.SEND_TO_VOICEMAIL_VT +
                integerAndDefault + " 0");
        list.add(prefix + MtkContactsContract.ContactsColumns.SEND_TO_VOICEMAIL_SIP +
                integerAndDefault + " 0");
        list.add(prefix + MtkContactsContract.ContactsColumns.INDICATE_PHONE_SIM +
                integerAndDefault + " -1");
        list.add(prefix + MtkContactsContract.ContactsColumns.INDEX_IN_SIM +
                integerAndDefault + " -1");
        list.add(prefix + MtkContactsContract.ContactsColumns.FILTER +
                integerAndDefault + " 0");
        list.add(prefix + MtkContactsContract.ContactsColumns.IS_SDN_CONTACT +
                integerAndDefault + " 0");

        addMissingColumns(db, rawSelect, list);
    }

    private void addRawContactsColumns(SQLiteDatabase db) {
        String rawSelect = "SELECT " + MtkContactsContract.RawContacts.TIMESTAMP + " FROM " +
                Tables.RAW_CONTACTS;

        ArrayList<String> list = new ArrayList<String>();
        String prefix = "ALTER TABLE " + Tables.RAW_CONTACTS + " ADD ";
        String integerAndDefault = " INTEGER NOT NULL DEFAULT";
        list.add(prefix + MtkContactsContract.RawContacts.TIMESTAMP + " INTEGER");
        list.add(prefix + MtkContactsContract.RawContactsColumns.SEND_TO_VOICEMAIL_VT +
                integerAndDefault + " 0");
        list.add(prefix + MtkContactsContract.RawContactsColumns.SEND_TO_VOICEMAIL_SIP +
                integerAndDefault + " 0");
        list.add(prefix + MtkContactsContract.ContactsColumns.INDICATE_PHONE_SIM +
                integerAndDefault + " -1");
        list.add(prefix + MtkContactsContract.ContactsColumns.INDEX_IN_SIM +
    ...
    private void addDataColumns(SQLiteDatabase db) {
        String rawSelect = "SELECT " + MtkContactsContract.DataColumns.IS_ADDITIONAL_NUMBER +
                " FROM " + Tables.DATA;

        ArrayList<String> list = new ArrayList<String>();
        String prefix = "ALTER TABLE " + Tables.DATA + " ADD ";
        list.add(prefix + MtkContactsContract.DataColumns.IS_ADDITIONAL_NUMBER +
                " INTEGER NOT NULL DEFAULT 0");
