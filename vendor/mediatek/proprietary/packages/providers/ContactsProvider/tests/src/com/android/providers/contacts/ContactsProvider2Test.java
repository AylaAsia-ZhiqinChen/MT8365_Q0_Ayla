...
public class ContactsProvider2Test extends BaseContactsProvider2Test {
    ...
    public void testContactsProjection() {
        assertProjection(Contacts.CONTENT_URI, new String[]{
                ...
                MtkContactsContract.RawContactsColumns.INDICATE_PHONE_SIM,       //add by MTK
                MtkContactsContract.RawContactsColumns.INDEX_IN_SIM,             //add by MTK
                MtkContactsContract.RawContactsColumns.SEND_TO_VOICEMAIL_VT,     //add by MTK
                MtkContactsContract.RawContactsColumns.SEND_TO_VOICEMAIL_SIP,    //add by MTK
                MtkContactsContract.RawContactsColumns.IS_SDN_CONTACT            //add by MTK
        });
    }
    ...
    public void testRawContactsProjection() {
        assertProjection(RawContacts.CONTENT_URI, new String[]{
                ...
                MtkContactsContract.RawContactsColumns.SEND_TO_VOICEMAIL_SIP,    //add by MTK
                MtkContactsContract.RawContactsColumns.IS_SDN_CONTACT,           //add by MTK
                MtkContactsContract.RawContacts.TIMESTAMP                        //add by MTK
        });
    }
    ...
    public void testDataProjection() {
        assertProjection(Data.CONTENT_URI, new String[]{
                ...
                MtkContactsContract.RawContactsColumns.SEND_TO_VOICEMAIL_SIP,    //add by MTK
                MtkContactsContract.RawContactsColumns.IS_SDN_CONTACT,           //add by MTK
                MtkContactsContract.DataColumns.IS_ADDITIONAL_NUMBER,            //add by MTK
                MtkContactsContract.RawContacts.TIMESTAMP                        //add by MTK
        });
    }
    ...
    public void testPhoneLookupProjection() {
        assertProjection(PhoneLookup.CONTENT_FILTER_URI.buildUpon().appendPath("123").build(),
            new String[]{
                ...
                Data.PREFERRED_PHONE_ACCOUNT_COMPONENT_NAME,
                Data.PREFERRED_PHONE_ACCOUNT_ID,
                Data.RAW_CONTACT_ID,            //add by MTK
                Data.DATA4,                     //add by MTK
                Data.DATA3,                     //add by MTK
                Data.DATA1,                     //add by MTK
                Contacts.CONTACT_STATUS,        //add by MTK
                Contacts.CONTACT_PRESENCE,      //add by MTK
                MtkContactsContract.ContactsColumns.FILTER,                 //add by MTK
                MtkContactsContract.ContactsColumns.IS_SDN_CONTACT,         //add by MTK
                MtkContactsContract.ContactsColumns.INDICATE_PHONE_SIM,     //add by MTK
                MtkContactsContract.ContactsColumns.SEND_TO_VOICEMAIL_SIP,  //add by MTK
                MtkContactsContract.ContactsColumns.SEND_TO_VOICEMAIL_VT,   //add by MTK
                MtkContactsContract.RawContactsColumns.INDEX_IN_SIM,        //add by MTK
        });
    }
    ...
    public void testPhotoStoreCleanup() throws IOException {
        ...
        assertEquals(replacementPhotoFileId, (long) getStoredLongValue(
                ...
                Contacts.PHOTO_FILE_ID));
        ///M: disable this for it will fail as we fix a timing issue.
