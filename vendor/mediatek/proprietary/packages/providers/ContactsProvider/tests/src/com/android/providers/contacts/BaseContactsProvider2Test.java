...
public abstract class BaseContactsProvider2Test extends PhotoLoadingTestCase {
    ...
    /// M: change to public for using in other package
    public static final String ADD_VOICEMAIL_PERMISSION =
            "com.android.voicemail.permission.ADD_VOICEMAIL";
    /*
     * M: change to public for using in other package
     * Permission to allow querying voicemails
     */
    public static final String READ_VOICEMAIL_PERMISSION =
            "com.android.voicemail.permission.READ_VOICEMAIL";
    /*
     * M: change to public for using in other package
     * Permission to allow deleting and updating voicemails
     */
    public static final String WRITE_VOICEMAIL_PERMISSION =
