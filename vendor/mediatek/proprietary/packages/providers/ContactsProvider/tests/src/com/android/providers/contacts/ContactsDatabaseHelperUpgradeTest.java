...
public class ContactsDatabaseHelperUpgradeTest extends BaseDatabaseHelperUpgradeTest {
    ...
    private static final TableColumn[] CONTACTS_COLUMNS = new TableColumn[] {
            ...
            /// added by MTK @{
            new TableColumn(MtkContactsContract.ContactsColumns.SEND_TO_VOICEMAIL_VT, INTEGER, true, "0"),
            new TableColumn(MtkContactsContract.ContactsColumns.SEND_TO_VOICEMAIL_SIP, INTEGER, true, "0"),
            new TableColumn(MtkContactsContract.ContactsColumns.INDICATE_PHONE_SIM, INTEGER, true, "-1"),
            new TableColumn(MtkContactsContract.ContactsColumns.INDEX_IN_SIM, INTEGER, true, "-1"),
            new TableColumn(MtkContactsContract.ContactsColumns.FILTER, INTEGER, true, "0"),
            new TableColumn(MtkContactsContract.ContactsColumns.IS_SDN_CONTACT, INTEGER, true, "0"),
            /// @}
    };
    ...
    private static final TableColumn[] RAW_CONTACTS_COLUMNS = new TableColumn[] {
            ...
            /// added by MTK @{
            new TableColumn(MtkContactsContract.RawContacts.TIMESTAMP, INTEGER, false, null),
            new TableColumn(MtkContactsContract.ContactsColumns.SEND_TO_VOICEMAIL_VT, INTEGER, true, "0"),
            new TableColumn(MtkContactsContract.ContactsColumns.SEND_TO_VOICEMAIL_SIP, INTEGER, true, "0"),
            new TableColumn(MtkContactsContract.ContactsColumns.INDICATE_PHONE_SIM, INTEGER, true, "-1"),
            new TableColumn(MtkContactsContract.ContactsColumns.INDEX_IN_SIM, INTEGER, true, "-1"),
    ...
    private static final TableColumn[] DATA_COLUMNS = new TableColumn[] {
            ...
            /// added by MTK @{
            new TableColumn(MtkContactsContract.DataColumns.IS_ADDITIONAL_NUMBER, INTEGER, true, "0"),
            /// @}
    };
