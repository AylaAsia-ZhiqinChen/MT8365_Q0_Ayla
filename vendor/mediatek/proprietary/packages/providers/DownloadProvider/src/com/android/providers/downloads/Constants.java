...
public class Constants {
    ...
    public static final boolean MTK_DRM_ENABLED = SystemProperties.getBoolean("ro.vendor.mtk_oma_drm_support", false);
...
//      "com.android.providers.downloads.ui.OMADLOpenDownloadReceiver";
    ...
    public static final String ACTION_PS_STATE_RESUMED_BROADCAST =
     "com.mtk.ACTION_PS_STATE_RESUMED";
    /// @}

    /// M: network change broadcast, fix cr alps00641275 @{
    public static final String ACTION_EMMRRS_PS_RESUME_INDICATOR =
     "mediatek.intent.action.EMMRRS_PS_RESUME";
    /// @}
