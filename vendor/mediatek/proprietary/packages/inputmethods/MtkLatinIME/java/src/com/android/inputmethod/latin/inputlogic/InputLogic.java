...
public final class InputLogic {
    ...
    private void revertCommit(final InputTransaction inputTransaction,
        ...
        if (committedWord instanceof SpannableString) {
            final SpannableString committedWordWithSuggestionSpans =
            (SpannableString) committedWord;
    ...
    public int getCurrentAutoCapsState(final SettingsValues settingsValues) {
        ...
        //for indic keyboard return caps state as false because caps state has significance
        //only for upper and lower case keyboard switch scripts(latin/cyrillic)
        if (mLatinIME.isCurrentKeyboardIndic()) {
