...
public class ScriptUtils {
    ...
    public static final int SCRIPT_OLCHIKI = 18;
    public static final int SCRIPT_GURMUKHI = 19;
    public static final int SCRIPT_ORIYA = 20;
    public static final int SCRIPT_GUJARATI = 21;
    ...
    static {
        ...
        mLanguageCodeToScriptCode.put("sat", SCRIPT_OLCHIKI);
