...
input0 = {
    input:           [2., 3.],
    output_state_in: [ 0 for _ in range(n_batch * n_output) ],
...
input0 = {
    input:           [1., 1.],
    output_state_in: [-0.423122, -0.0121822, 0.24201, -0.0812458],
    cell_state_in:   [-0.978419, -0.139203, 0.338163, -0.0983904]
}
