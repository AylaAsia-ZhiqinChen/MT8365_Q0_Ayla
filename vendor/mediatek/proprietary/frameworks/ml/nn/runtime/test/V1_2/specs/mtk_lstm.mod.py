...
#######################################################################################
# LSTM Test 1: No Cifg, No Peephole, No Projection, and No Clipping.
model = Model()
...
input0 = {
    input:           [2., 3.],
    output_state_in: [0, 0, 0, 0],
    cell_state_in:   [0, 0, 0, 0],
}
...
#######################################################################################
# LSTM Test 2: No Cifg, No Peephole, No Projection, and No Clipping.
model = Model("state")
...
#######################################################################################
# LSTM Test3: No Cifg, No Peephole, No Projection, and No Clipping.
model = Model("state2")
...
input0 = {
    input:           [1., 1.],
    output_state_in: [-0.0371611, 0.125073, 0.411934, -0.208605],
    cell_state_in:   [-0.287121, 0.148115, 0.556837, -0.388276]
}
