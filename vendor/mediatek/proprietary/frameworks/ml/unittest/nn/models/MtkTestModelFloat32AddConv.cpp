...
#include "MtkTestModelFloat32AddConv.h"

MtkTestModelFloat32AddConv::MtkTestModelFloat32AddConv()
...
int MtkTestModelFloat32AddConv::createModelForTest() {
    ...
    SET_FP32_OPERAND_VALUE(mFilterMat, filterDim.size(), 1, mModel)
    SET_FP32_OPERAND_VALUE(mBiasMat, biasDim.size(), 2, mModel)
...
int MtkTestModelFloat32AddConv::createRequestForTest() {
    //
    // set buffer
    //
...
int MtkTestModelFloat32AddConv::CompareMatrices() {
    int errors = 0;
