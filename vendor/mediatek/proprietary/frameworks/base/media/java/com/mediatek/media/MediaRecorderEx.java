...
public class MediaRecorderEx {
    ...
    static {
        try {
            ...
            Log.e("@M_" + TAG, "NoSuchMethodException: " + METHOD_NAME);
        } catch (ClassNotFoundException e) {
            Log.e("@M_" + TAG, "ClassNotFoundException: " + CLASS_NAME);
        }
    }
    ...
    private static void setParameter(MediaRecorder recorder, String nameValuePair) {
        if (sSetParameter != null) {
            try {
                ...
                Log.e("@M_" + TAG, "IllegalAccessException!", ae);
            } catch (InvocationTargetException te) {
                Log.e("@M_" + TAG, "InvocationTargetException!", te);
            } catch (IllegalArgumentException ex) {
                Log.e("@M_" + TAG, "IllegalArgumentException!", ex);
            } catch (NullPointerException npe) {
                Log.e("@M_" + TAG, "NullPointerException!", npe);
            }
        } else {
            Log.e("@M_" + TAG, "setParameter: Null method!");
        }
    }
    ...
    public static void pause(MediaRecorder recorder) throws IllegalStateException {
        if (recorder == null) {
            Log.e("@M_" + TAG, "Null MediaRecorder!");
            return;
        }
    ...
    public static void setVideoBitOffSet(MediaRecorder recorder, int offset, boolean video) {
        if (video) {
            ...
            Log.v("@M_" + TAG, "setVideoBitOffSet is true,offset= " + offset);
        }
    }
    /**
     * Set live photo tag.
