...
/**
 * This class is used for parcel binder.
 */
public class BinderHolder implements Parcelable {
     ...
     * @param src the soruce of parcel.
     */
    ...
    /**
     * Use paraceable for parcel BinderHolder.
     */
     ...
     * @return the binder current have.
     */
    ...
    /**
     * Set a binder.
     * @param binder set a binder to current binder holder.
     */
    ...
    /**
     * Create a defalut binder holder instance.
     */
    public BinderHolder() {
    ...
    /**
     * Create a binder holder whit expected binder.
     * @param binder which binder will be used for the binder holder.
     */
