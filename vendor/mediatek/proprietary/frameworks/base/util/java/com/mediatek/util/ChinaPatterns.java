...
/**
 * Modified AOSP com.android.util.Patterns which enhanced for
 * recognizing url from string include Chinese characters.
 */
class ChinaPatterns {
    /**
    ...
    static final String IANA_TOP_LEVEL_DOMAINS =
        ...
        + "|credit|creditcard|creditunion|cricket|crown|crs|cruises|csc|cuisinella" +
        "|cymru|cyou|c[acdfghiklmnoruvwxyz])"
        ...
        + "|final|finance|financial|firmdale|fish|fishing|fit|fitness|flights|florist" +
        "|flowers|flsmidth"
        ...
        + "|glass|gle|global|globo|gmail|gmo|gmx|gold|goldpoint|golf|goo|goog|google|gop" +
        "|gov|grainger"
        ...
        "|hsbc|hyundai"
        + "|h[kmnrtu])"
        + "|(?:ibm|icbc|ice|icu|ifm|iinet|immo|immobilien|industries|infiniti|info|ing" +
        "|ink|institute"
        + "|insure|int|international|investments|ipiranga|irish|ist|istanbul|itau|iwc" +
        "|i[delmnoqrst])"
        ...
        + "|lixil|loan|loans|lol|london|lotte|lotto|love|ltd|ltda|lupin|luxe|luxury" +
        "|l[abcikrstuvy])"
        ...
        + "|photos|physio|piaget|pics|pictet|pictures|ping|pink|pizza|place|play" +
        "|playstation|plumbing"
        ...
        + "|repair|report|republican|rest|restaurant|review|reviews|rich|ricoh|rio|rip" +
        "|rocher|rocks"
        ...
        + "|top|toray|toshiba|tours|town|toyota|toys|trade|trading|training|travel" +
        "|trust|tui|t[cdfghjklmnortvwz])"
        ...
        + "|\u8c37\u6b4c|\u96c6\u56e2|\u98de\u5229\u6d66|\u9910\u5385|\u9999\u6e2f|\ub2f7\ub137"
        + "|\ub2f7\ucef4|\uc0bc\uc131|\ud55c\uad6d|xbox"
        + "|xerox|xin|xn\\-\\-11b4c3d|xn\\-\\-1qqw23a|xn\\-\\-30rr7y|xn\\-\\-3bst00m|xn\\-" +
        "\\-3ds443g"
        ...
        "|xn\\-\\-s9brj9c"
        + "|xn\\-\\-ses554g|xn\\-\\-t60b56a|xn\\-\\-tckwe|xn\\-\\-unup4y|xn\\-" +
        "\\-vermgensberater\\-ctb"
    ...
    static final Pattern CHINA_AUTOLINK_WEB_URL = Pattern.compile(
