...
/**
 * Use to support Dcf Decoder plugin.
 *
 * @hide
 */
public final class MTKDcfDecoderManagerImpl extends MTKDcfDecoderManager {
    ...
    @Override
    public  Bitmap decodeDrmImageIfNeededImpl(byte[] header, InputStream left, Options opts) {
        return DcfDecoder.decodeDrmImageIfNeeded(header, left, opts);
     }
    @Override
    public  Bitmap decodeDrmImageIfNeededImpl(FileDescriptor fd, Options opts) {
        return DcfDecoder.decodeDrmImageIfNeeded(fd, opts);
    }
    @Override
    public  Bitmap decodeDrmImageIfNeededImpl(byte[] data, Options opts) {
