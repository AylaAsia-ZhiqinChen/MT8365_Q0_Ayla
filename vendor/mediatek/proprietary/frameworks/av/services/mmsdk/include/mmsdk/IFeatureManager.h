...
#ifndef _MTKCAM_SDK_IFEATUREMANAGER_H_
#define _MTKCAM_SDK_IFEATUREMANAGER_H_
...
public:
    ...
    virtual status_t           getEffectFactory(sp<IInterface> & effectFactory) = 0;
};
...
public:
    ...
    status_t           getEffectFactory(sp<IInterface> & effectFactory);
...
#endif  //_MTKCAM_SDK_IFEATUREMANAGER_H_
