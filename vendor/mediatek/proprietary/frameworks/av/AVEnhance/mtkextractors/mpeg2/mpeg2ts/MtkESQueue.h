...
//#ifdef MTK_WFD_HDCP_RX_SUPPORT
    int mPayloadSize;
    bool getIsFromWFD() {return mFromWFD;};
    void setIsFromWFD(bool isFromWFD) {mFromWFD = isFromWFD;};
    void setSvpInf(bool IsSvpStream, uint32_t StreamCtr, uint64_t InputCtr);
//#endif
...
//#ifdef MTK_WFD_HDCP_RX_SUPPORT
    sp<ABuffer> dequeueAccessUnitH264forWFD(bool isWFD = true);
    sp<ABuffer> dequeueAccessUnitAACforWFD() ;
//#endif
