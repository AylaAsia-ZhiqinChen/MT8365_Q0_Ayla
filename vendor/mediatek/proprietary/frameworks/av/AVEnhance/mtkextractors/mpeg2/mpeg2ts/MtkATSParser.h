...
//#ifdef MTK_WFD_HDCP_RX_SUPPORT
    status_t feedTSPacketEx(
            const void *data, size_t size, SyncEvent *event = NULL,bool isFromWFD=false, bool isWiDi=false);
    bool getIsSourceFromWFD () {return isSourceFromWFD;}
    void setIsSourceFromWFD (bool isWFD) {isSourceFromWFD = isWFD;}
    bool getIsSourceFromWiDi() {return isSourceFromWiDi;}
    void setIsSourceFromWiDi (bool isWiDi) {isSourceFromWiDi = isWiDi;}
//#endif
