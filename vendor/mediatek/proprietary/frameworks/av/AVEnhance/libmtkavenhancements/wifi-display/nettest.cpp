...
struct TestHandler : public AHandler {
    TestHandler(const sp<MtkANetworkSession> &netSession);
...
TestHandler::TestHandler(const sp<MtkANetworkSession> &netSession)
...
int main(int argc, char **argv) {
    ...
    sp<MtkANetworkSession> netSession = new MtkANetworkSession;
    netSession->start();
