...
#include "tensorflow/lite/mtk/java/src/main/native/jni_utils.h"
...
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_getInputNames(JNIEnv* env,
                                                                jclass clazz,
                                                                jlong handle) {
...
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_allocateTensors(
...
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_getInputTensorIndex(
...
JNIEXPORT jint JNICALL
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_getOutputTensorIndex(
...
JNIEXPORT jint JNICALL
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_getInputCount(JNIEnv* env,
                                                                jclass clazz,
                                                                jlong handle) {
  tflite::Interpreter* interpreter = convertLongToInterpreter(env, handle);
  if (interpreter == nullptr) return 0;
...
JNIEXPORT jint JNICALL
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_getOutputCount(JNIEnv* env,
                                                                 jclass clazz,
                                                                 jlong handle) {
  tflite::Interpreter* interpreter = convertLongToInterpreter(env, handle);
  if (interpreter == nullptr) return 0;
...
JNIEXPORT jobjectArray JNICALL
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_getOutputNames(JNIEnv* env,
                                                                 jclass clazz,
                                                                 jlong handle) {
  tflite::Interpreter* interpreter = convertLongToInterpreter(env, handle);
  if (interpreter == nullptr) return nullptr;
...
JNIEXPORT void JNICALL
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_useNNAPI(JNIEnv* env,
                                                           jclass clazz,
                                                           jlong handle,
                                                           jboolean state) {
  tflite::Interpreter* interpreter = convertLongToInterpreter(env, handle);
...
JNIEXPORT void JNICALL
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_allowFp16PrecisionForFp32(
...
JNIEXPORT void JNICALL
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_allowBufferHandleOutput(
    JNIEnv* env, jclass clazz, jlong handle, jboolean allow) {
  tflite::Interpreter* interpreter = convertLongToInterpreter(env, handle);
  if (interpreter == nullptr) return;
...
JNIEXPORT void JNICALL
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_numThreads(JNIEnv* env,
                                                             jclass clazz,
                                                             jlong handle,
                                                             jint num_threads) {
  tflite::Interpreter* interpreter = convertLongToInterpreter(env, handle);
...
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_createErrorReporter(
...
JNIEXPORT jlong JNICALL
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_createModel(
...
JNIEXPORT jlong JNICALL
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_createModelWithBuffer(
...
JNIEXPORT jlong JNICALL
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_createInterpreter(
...
JNIEXPORT void JNICALL Java_com_mediatek_neuropilot_NativeInterpreterWrapper_run(
...
JNIEXPORT jint JNICALL
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_getOutputDataType(
...
JNIEXPORT jint JNICALL
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_getOutputQuantizationZeroPoint(
    JNIEnv* env, jclass clazz, jlong handle, jint output_idx) {
  tflite::Interpreter* interpreter = convertLongToInterpreter(env, handle);
  if (interpreter == nullptr) return 0;
  const int idx = static_cast<int>(output_idx);
...
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_getOutputQuantizationScale(
    JNIEnv* env, jclass clazz, jlong handle, jint output_idx) {
  tflite::Interpreter* interpreter = convertLongToInterpreter(env, handle);
...
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_resizeInput(
    JNIEnv* env, jclass clazz, jlong interpreter_handle, jlong error_handle,
...
JNIEXPORT void JNICALL
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_setEncryptionLevel(
    JNIEnv* env, jclass clazz, jlong interpreter_handle, jint encryption_level) {
  tflite::Interpreter* interpreter =
      convertLongToInterpreter(env, interpreter_handle);
  if (interpreter == nullptr) return;
  reinterpret_cast<tflite::MtkInterpreter*>(interpreter)->SetEncryptionLevel(
      static_cast<int>(encryption_level));
}

JNIEXPORT void JNICALL
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_setCacheDir(
    JNIEnv* env, jclass clazz, jlong interpreter_handle, jstring cache_dir) {
  tflite::Interpreter* interpreter =
      convertLongToInterpreter(env, interpreter_handle);
  if (interpreter == nullptr) return;
  const char* native_cache_dir = env->GetStringUTFChars(cache_dir, nullptr);
  reinterpret_cast<tflite::MtkInterpreter*>(interpreter)->SetCacheDir(native_cache_dir);
  env->ReleaseStringUTFChars(cache_dir, native_cache_dir);
}

JNIEXPORT void JNICALL
Java_com_mediatek_neuropilot_NativeInterpreterWrapper_applyDelegate(
    JNIEnv* env, jclass clazz, jlong interpreter_handle, jlong error_handle,
...
JNIEXPORT void JNICALL Java_com_mediatek_neuropilot_NativeInterpreterWrapper_delete(
