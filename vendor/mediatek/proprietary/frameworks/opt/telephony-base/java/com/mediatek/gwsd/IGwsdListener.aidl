...
interface IGwsdListener
{
     ...
     */
    void onAddListenered(int status, String reason);
     ...
     * @param reason: response of the request placed.
     */
    void onUserSelectionModeChanged(int status, String reason);
     ...
     * @param reason: response of the request placed.
     */
    void onAutoRejectModeChanged(int status, String reason);
     ...
     * @param reason: response of the request placed.
     */
    void onSyncGwsdInfoFinished(int status, String reason);
     ...
     * @param reason: response of the request placed.
     */
    void onCallValidTimerChanged(int status, String reason);
     ...
     * @param reason: response of the request placed.
     */
    void onIgnoreSameNumberIntervalChanged(int status, String reason);
}