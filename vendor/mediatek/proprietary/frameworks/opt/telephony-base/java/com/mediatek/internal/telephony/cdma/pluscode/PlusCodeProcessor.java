...
public class PlusCodeProcessor {
    ...
    private static final String PLUS_CODE_IMPL_PATH =
            "/system/vendor/framework/via-plugin.jar";
    ...
    private static IPlusCodeUtils makePlusCodeUtis() {
        sClassLoader = new PathClassLoader(PLUS_CODE_IMPL_PATH,
                ClassLoader.getSystemClassLoader());
        try {
            Class<?> policyClass = sClassLoader.loadClass(PLUS_CODE_IMPL_CLASS_NAME);
            Constructor<?> constructor = policyClass.getConstructor(new Class[] {});
            return (IPlusCodeUtils) constructor.newInstance();
        } catch (Exception ex) {
