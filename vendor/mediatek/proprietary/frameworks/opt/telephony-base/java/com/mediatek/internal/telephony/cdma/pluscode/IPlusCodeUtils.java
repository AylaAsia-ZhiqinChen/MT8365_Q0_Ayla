...
public interface IPlusCodeUtils {
    ...
    static final String PROPERTY_TIME_LTMOFFSET = "vendor.cdma.operator.ltmoffset";
    static final String PROPERTY_ICC_CDMA_OPERATOR_MCC = "vendor.cdma.icc.operator.mcc";
    ...
    /**
     * Whether the plus code in the call number can be formatted.
     * @return if can convert plus code to IddNdd.
     */
    boolean canFormatPlusToIddNdd();

    /**
     * Whether the plus code in the sms or mms sender number can be formatted.
     * @return if can format plus code for sms.
     */
    boolean canFormatPlusCodeForSms();

    /**
     * Replace the puls code with IDD or NDD for the call number.
    ...
    /**
     * Replace the puls code with IDD or NDD for the sms or mms sender number.
     * @param number the number value
     * @return the number after deal with plus code
     */
    ...
    /**
     * Remove the IDD or NDD and add plus code for the sms or mms sender number.
     * @param number the number value
     * @return the number after deal with plus code
     */
    ...
    /**
     * Remove the IDD or NDD and add plus code for the call number.
     * @param number the number value
     * @return the number after deal with plus code
     */
