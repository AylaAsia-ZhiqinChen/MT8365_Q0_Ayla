...
interface IMtkSub {
     ...
     */
    MtkSubscriptionInfo getSubInfo(String callingPackage, int subId);
     ...
     * @return SubscriptionInfo, maybe null if not found
     */
    MtkSubscriptionInfo getSubInfoForIccId(String callingPackage, String iccId);

    int getSubIdUsingPhoneId(int phoneId);

    void setDefaultFallbackSubId(int subId, int subscriptionType);
