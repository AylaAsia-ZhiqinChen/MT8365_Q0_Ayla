...
interface IGbaService {
    ...
    NafSessionKey getCachedKey(in String nafFqdn, in byte[] nafSecurProtocolId, in int subId);
    void updateCachedKey(in String nafFqdn, in byte[] nafSecurProtocolId, in int subId, in NafSessionKey nafSessionKey);
}
