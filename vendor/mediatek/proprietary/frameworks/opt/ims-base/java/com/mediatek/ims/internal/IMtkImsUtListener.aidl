...
interface IMtkImsUtListener {
    /**
     * Notifies the status of the call forwarding in a time slot supplementary service.
     */
    void utConfigurationCallForwardInTimeSlotQueried(in IMtkImsUt ut,
            int id, in MtkImsCallForwardInfo[] cfInfo);

    /**
     * Notifies the status of the call forwarding supplementary service.
     */
    void utConfigurationCallForwardQueried(in IMtkImsUt ut,
