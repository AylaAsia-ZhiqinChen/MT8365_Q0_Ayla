...
class GbaCipherSuite {
    ...
    */
    ...
    private static final HttpCipherSuite[] SUITES_BY_OKHTTP = {
        HttpCipherSuite.TLS_RSA_WITH_NULL_MD5,
        HttpCipherSuite.TLS_RSA_WITH_NULL_SHA,
        HttpCipherSuite.TLS_RSA_EXPORT_WITH_RC4_40_MD5,
        HttpCipherSuite.TLS_RSA_WITH_RC4_128_MD5,
        HttpCipherSuite.TLS_RSA_WITH_RC4_128_SHA,
        HttpCipherSuite.TLS_RSA_EXPORT_WITH_DES40_CBC_SHA,
        HttpCipherSuite.TLS_RSA_WITH_DES_CBC_SHA,
        HttpCipherSuite.TLS_RSA_WITH_3DES_EDE_CBC_SHA,
        HttpCipherSuite.TLS_DHE_DSS_EXPORT_WITH_DES40_CBC_SHA,
        HttpCipherSuite.TLS_DHE_DSS_WITH_DES_CBC_SHA,
        HttpCipherSuite.TLS_DHE_DSS_WITH_3DES_EDE_CBC_SHA,
        HttpCipherSuite.TLS_DHE_RSA_EXPORT_WITH_DES40_CBC_SHA,
        HttpCipherSuite.TLS_DHE_RSA_WITH_DES_CBC_SHA,
        HttpCipherSuite.TLS_DHE_RSA_WITH_3DES_EDE_CBC_SHA,
        HttpCipherSuite.TLS_DH_anon_EXPORT_WITH_RC4_40_MD5,
        HttpCipherSuite.TLS_DH_anon_WITH_RC4_128_MD5,
        HttpCipherSuite.TLS_DH_anon_EXPORT_WITH_DES40_CBC_SHA,
        HttpCipherSuite.TLS_DH_anon_WITH_DES_CBC_SHA,
        HttpCipherSuite.TLS_DH_anon_WITH_3DES_EDE_CBC_SHA,
        HttpCipherSuite.TLS_KRB5_WITH_DES_CBC_SHA,
        HttpCipherSuite.TLS_KRB5_WITH_3DES_EDE_CBC_SHA,
        HttpCipherSuite.TLS_KRB5_WITH_RC4_128_SHA,
        HttpCipherSuite.TLS_KRB5_WITH_DES_CBC_MD5,
        HttpCipherSuite.TLS_KRB5_WITH_3DES_EDE_CBC_MD5,
        HttpCipherSuite.TLS_KRB5_WITH_RC4_128_MD5,
        HttpCipherSuite.TLS_KRB5_EXPORT_WITH_DES_CBC_40_SHA,
        HttpCipherSuite.TLS_KRB5_EXPORT_WITH_RC4_40_SHA,
        HttpCipherSuite.TLS_KRB5_EXPORT_WITH_DES_CBC_40_MD5,
        HttpCipherSuite.TLS_KRB5_EXPORT_WITH_RC4_40_MD5,
        HttpCipherSuite.TLS_RSA_WITH_AES_128_CBC_SHA,
        HttpCipherSuite.TLS_DHE_DSS_WITH_AES_128_CBC_SHA,
        HttpCipherSuite.TLS_DHE_RSA_WITH_AES_128_CBC_SHA,
        HttpCipherSuite.TLS_DH_anon_WITH_AES_128_CBC_SHA,
        HttpCipherSuite.TLS_RSA_WITH_AES_256_CBC_SHA,
        HttpCipherSuite.TLS_DHE_DSS_WITH_AES_256_CBC_SHA,
        HttpCipherSuite.TLS_DHE_RSA_WITH_AES_256_CBC_SHA,
        HttpCipherSuite.TLS_DH_anon_WITH_AES_256_CBC_SHA,
        HttpCipherSuite.TLS_RSA_WITH_NULL_SHA256,
        HttpCipherSuite.TLS_RSA_WITH_AES_128_CBC_SHA256,
        HttpCipherSuite.TLS_RSA_WITH_AES_256_CBC_SHA256,
        HttpCipherSuite.TLS_DHE_DSS_WITH_AES_128_CBC_SHA256,
        HttpCipherSuite.TLS_DHE_RSA_WITH_AES_128_CBC_SHA256,
        HttpCipherSuite.TLS_DHE_DSS_WITH_AES_256_CBC_SHA256,
        HttpCipherSuite.TLS_DHE_RSA_WITH_AES_256_CBC_SHA256,
        HttpCipherSuite.TLS_DH_anon_WITH_AES_128_CBC_SHA256,
        HttpCipherSuite.TLS_DH_anon_WITH_AES_256_CBC_SHA256,
        HttpCipherSuite.TLS_RSA_WITH_AES_128_GCM_SHA256,
        HttpCipherSuite.TLS_RSA_WITH_AES_256_GCM_SHA384,
        HttpCipherSuite.TLS_DHE_RSA_WITH_AES_128_GCM_SHA256,
        HttpCipherSuite.TLS_DHE_DSS_WITH_AES_128_GCM_SHA256,
        HttpCipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384,
        HttpCipherSuite.TLS_DH_anon_WITH_AES_128_GCM_SHA256,
        HttpCipherSuite.TLS_DH_anon_WITH_AES_256_GCM_SHA384,
        HttpCipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV,
        HttpCipherSuite.TLS_ECDH_ECDSA_WITH_NULL_SHA,
        HttpCipherSuite.TLS_ECDH_ECDSA_WITH_RC4_128_SHA,
        HttpCipherSuite.TLS_ECDH_ECDSA_WITH_3DES_EDE_CBC_SHA,
        HttpCipherSuite.TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA,
        HttpCipherSuite.TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA,
        HttpCipherSuite.TLS_ECDHE_ECDSA_WITH_NULL_SHA,
        HttpCipherSuite.TLS_ECDHE_ECDSA_WITH_RC4_128_SHA,
        HttpCipherSuite.TLS_ECDHE_ECDSA_WITH_3DES_EDE_CBC_SHA,
        HttpCipherSuite.TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA,
        HttpCipherSuite.TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA,
        HttpCipherSuite.TLS_ECDH_RSA_WITH_NULL_SHA,
        HttpCipherSuite.TLS_ECDH_RSA_WITH_RC4_128_SHA,
        HttpCipherSuite.TLS_ECDH_RSA_WITH_3DES_EDE_CBC_SHA,
        HttpCipherSuite.TLS_ECDH_RSA_WITH_AES_128_CBC_SHA,
        HttpCipherSuite.TLS_ECDH_RSA_WITH_AES_256_CBC_SHA,
        HttpCipherSuite.TLS_ECDHE_RSA_WITH_NULL_SHA,
        HttpCipherSuite.TLS_ECDHE_RSA_WITH_RC4_128_SHA,
        HttpCipherSuite.TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA,
        HttpCipherSuite.TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA,
        HttpCipherSuite.TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA,
        HttpCipherSuite.TLS_ECDH_anon_WITH_NULL_SHA,
        HttpCipherSuite.TLS_ECDH_anon_WITH_RC4_128_SHA,
        HttpCipherSuite.TLS_ECDH_anon_WITH_3DES_EDE_CBC_SHA,
        HttpCipherSuite.TLS_ECDH_anon_WITH_AES_128_CBC_SHA,
        HttpCipherSuite.TLS_ECDH_anon_WITH_AES_256_CBC_SHA,
        HttpCipherSuite.TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256,
        HttpCipherSuite.TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384,
        HttpCipherSuite.TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA256,
        HttpCipherSuite.TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA384,
        HttpCipherSuite.TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256,
        HttpCipherSuite.TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384,
        HttpCipherSuite.TLS_ECDH_RSA_WITH_AES_128_CBC_SHA256,
        HttpCipherSuite.TLS_ECDH_RSA_WITH_AES_256_CBC_SHA384,
        HttpCipherSuite.TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256,
        HttpCipherSuite.TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384,
        HttpCipherSuite.TLS_ECDH_ECDSA_WITH_AES_128_GCM_SHA256,
        HttpCipherSuite.TLS_ECDH_ECDSA_WITH_AES_256_GCM_SHA384,
        HttpCipherSuite.TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,
        HttpCipherSuite.TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384,
        HttpCipherSuite.TLS_ECDH_RSA_WITH_AES_128_GCM_SHA256,
        HttpCipherSuite.TLS_ECDH_RSA_WITH_AES_256_GCM_SHA384
    };
    ...
    public static GbaCipherSuite getByName(String name) {
        ...
        if (suite == null) {
            for (HttpCipherSuite http : SUITES_BY_OKHTTP) {
