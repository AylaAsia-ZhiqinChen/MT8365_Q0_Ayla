...
/** @hide */
final class BootReceiverPolicy {
    private String TAG = "CTA_BootReceiverPolicy" ;
     ...
     */
    static BootReceiverPolicy getInstance(Context context) {
        if (sInstance == null) {
