...
public class VCardComposer {
    ...
    */
            ...
            while (entityIterator.hasNext()) {
                ...
                for (NamedContentValues namedContentValues : entity.getSubValues()) {
                    ...
                    if (key != null) {
                        ...
                        ///M:@{
                        setPhoneTypeToMobileByAas(entity, contentValues, key);
                        ///@}
    ...
    /**
     * M:AAS, set phone type to Mobile.
     * @param entity
     * @param contentValues
     * @param key
     */
    private void setPhoneTypeToMobileByAas(Entity entity, ContentValues contentValues, String key) {
        String accountType = entity.getEntityValues().getAsString(RawContacts.ACCOUNT_TYPE);
        if (Phone.CONTENT_ITEM_TYPE.equals(key) && isAasEnabled(accountType)) {
     ...
     * M
     * @param accountType
     * @return true if Aas enable for the account type,false else.
     */
    private boolean isAasEnabled(String accountType) {
        if ("USIM Account".equals(accountType)) {
            return true;
        }
        return false;
    }
