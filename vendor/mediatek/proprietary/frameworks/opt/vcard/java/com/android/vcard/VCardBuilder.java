        ...
        if (contentValuesList != null) {
            for (ContentValues contentValues : contentValuesList) {
                ...
                if (Im.PROTOCOL_CUSTOM == protocolAsObject) {
                    ...
                    appendLineWithCharsetAndQPDetection(tmep,
                            parameterList, contentValues.getAsString(Im.DATA));
                    continue;
                }
    ...
    public void appendEmailLine(final int type, final String label,
        ...
        switch (type) {
            case Email.TYPE_CUSTOM: {
                ...
                /* M:vCard 3.0 append custom email type.*/
                } else if (!TextUtils.isEmpty(label) && mIsV30OrV40) {
                    typeAsString = label;
