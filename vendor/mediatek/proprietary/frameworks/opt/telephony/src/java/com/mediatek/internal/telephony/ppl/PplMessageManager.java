...
public class PplMessageManager {
    ...
    public static class PendingMessage {
        ...
        public static final int PENDING_MESSAGE_LENGTH = PplControlData.TRUSTED_NUMBER_LENGTH
                + Long.SIZE / Byte.SIZE + Byte.SIZE / Byte.SIZE;
    ...
    public PplMessageManager(Context context) {
        ...
        mMessageTemplates = SMS_TEMPLATES;
