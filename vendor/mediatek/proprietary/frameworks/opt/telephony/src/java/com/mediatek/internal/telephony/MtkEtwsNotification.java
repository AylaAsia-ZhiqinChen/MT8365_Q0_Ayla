...
public class MtkEtwsNotification {
    ...
    public String toString() {
        return "MtkEtwsNotification: " + warningType + ", " + messageId + ", " + serialNumber
                + ", " + plmnId + ", " + securityInfo;
    }
    ...
    public byte[] getEtwsPdu() {
        ...
        byte[] serialNumberBytes = MtkEtwsUtils.intToBytes(serialNumber);
        System.arraycopy(serialNumberBytes, 2, etwsPdu, 0, 2);
        byte[] messageIdBytes = MtkEtwsUtils.intToBytes(messageId);
        System.arraycopy(messageIdBytes, 2, etwsPdu, 2, 2);
        byte[] warningTypeBytes = MtkEtwsUtils.intToBytes(warningType);
