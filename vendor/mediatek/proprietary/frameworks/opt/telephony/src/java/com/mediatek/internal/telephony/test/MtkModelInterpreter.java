...
public class MtkModelInterpreter
            implements Runnable, MtkSimulatedRadioControl
{
    ...
    public
    MtkModelInterpreter (InputStream in, OutputStream out)
    {
        mIn = in;
        mOut = out;
    ...
    public
    MtkModelInterpreter (InetSocketAddress sa) throws java.io.IOException
    {
    ...
    init()
    {
        new Thread(this, "MtkModelInterpreter").start();
        mHandlerThread = new HandlerThread("MtkModelInterpreter");
        mHandlerThread.start();
        Looper looper = mHandlerThread.getLooper();
        mSimulatedCallState = new MtkSimulatedGsmCallState(looper);
    }
...
***/
    ...
    static final String [][] sDefaultResponses = {
        ...
        {"+CRSM=178,28474,1,4,30",
                "+CRSM: 144,0,437573746f6d65722043617265ffffff07818100398799f7ffffffffffff\r"},
        {"+CRSM=178,28474,2,4,30",
                "+CRSM: 144,0,566f696365204d61696cffffffffffff07918150367742f3ffffffffffff\r"},
        {"+CRSM=178,28474,3,4,30",
                "+CRSM: 144,0,4164676a6dffffffffffffffffffffff0b918188551512c221436587ff01\r"},
        {"+CRSM=178,28474,4,4,30",
                "+CRSM: 144,0,810101c1ffffffffffffffffffffffff068114455245f8ffffffffffffff\r"},
        /* EF[EXT1] */
