...
public class MtkSimulatedCommandsBase extends BaseCommands
        implements CommandsInterface, MtkSimulatedRadioControl {
    private final static String LOG_TAG = "MtkSimulatedCommandsBase";
    ...
    //***** Constructor
    public
    MtkSimulatedCommandsBase() {
        super(null);  // Don't log statistics
        mHandlerThread = new HandlerThread("MtkSimulatedCommandsBase");
        mHandlerThread.start();
        Looper looper = mHandlerThread.getLooper();

        simulatedCallState = new MtkSimulatedGsmCallState(looper);
    ...
    public void dial(String address, boolean isEmergencyCall, EmergencyNumber emergencyNumberInfo,
        ...
        MtkSimulatedCommandsBaseVerifier.getInstance().dial(address, isEmergencyCall,
    ...
    public void setupDataCall(int accessNetworkType, DataProfile dataProfile, boolean isRoaming,
        ...
        MtkSimulatedCommandsBaseVerifier.getInstance().setupDataCall(accessNetworkType, dataProfile,
    ...
    public void acknowledgeLastIncomingGsmSms(boolean success, int cause, Message result) {
        unimplemented(result);
        MtkSimulatedCommandsBaseVerifier.getInstance().
    ...
    public void setCallForward(int action, int cfReason, int serviceClass,
        ...
        MtkSimulatedCommandsBaseVerifier.getInstance().setCallForward(action, cfReason,
                serviceClass, number, timeSeconds, result);
        resultSuccess(result, null);
    }
    ...
    public void queryCallForwardStatus(int cfReason, int serviceClass,
        ...
        MtkSimulatedCommandsBaseVerifier.getInstance().queryCallForwardStatus(cfReason,
                serviceClass, number, result);
        resultSuccess(result, null);
    }
    ...
    public void getBasebandVersion (Message result) {
        ...
        resultSuccess(result, "MtkSimulatedCommandsBase");
    }
    ...
    public void changeIccPinForApp(String oldPin, String newPin, String aidPtr, Message response) {
        MtkSimulatedCommandsBaseVerifier.getInstance().changeIccPinForApp(oldPin, newPin, aidPtr,
                response);
    ...
    public void sendImsCdmaSms(byte[] pdu, int retry, int messageRef,
            Message response){
        MtkSimulatedCommandsBaseVerifier.getInstance().sendImsCdmaSms(pdu, retry, messageRef,
                response);
    ...
    public void sendImsGsmSms(String smscPDU, String pdu,
        ...
        MtkSimulatedCommandsBaseVerifier.getInstance().sendImsGsmSms(smscPDU, pdu, retry,
                messageRef, response);
        resultSuccess(response, new SmsResponse(0 /*messageRef*/, null, 0));
    }
    ...
    public void iccTransmitApduLogicalChannel(int channel, int cla, int instruction,
                                              ...
                                              Message response) {
        MtkSimulatedCommandsBaseVerifier.getInstance().iccTransmitApduLogicalChannel(channel, cla,
    ...
    public void startLceService(int report_interval_ms, boolean pullMode, Message result) {
        MtkSimulatedCommandsBaseVerifier.getInstance().startLceService(report_interval_ms, pullMode,
                result);
    }
    ...
    public void registerForExitEmergencyCallbackMode(Handler h, int what, Object obj) {
        MtkSimulatedCommandsBaseVerifier.getInstance()
                .registerForExitEmergencyCallbackMode(h, what, obj);
    ...
    public void startNattKeepalive(
        ...
        MtkSimulatedCommandsBaseVerifier.getInstance().startNattKeepalive(
