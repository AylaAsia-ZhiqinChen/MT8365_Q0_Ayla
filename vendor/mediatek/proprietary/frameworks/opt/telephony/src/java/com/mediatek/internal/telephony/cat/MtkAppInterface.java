...
public interface MtkAppInterface extends AppInterface {
   ...
   /* Intent for send broadcast to MTK STK APP*/
    public static final String MTK_CAT_CMD_ACTION =
                                    "com.mediatek.internal.stk.command";

    /**
     * Callback function from app to telephony to pass a envelope to the SIM.
     * @internal
     */
    void onEventDownload(MtkCatResponseMessage resMsg);
