...
public class SaPersistDataHelper {
    ...
    public static String getStringData(Context context, int phoneId, String key,
            String defaultValue) {
    ...
    private static SharedPreferences getSharedPreference(Context context, int phoneId) {
        return context.getSharedPreferences(getDataName(phoneId), Context.MODE_PRIVATE);
    }
    ...
    public static String toString(Context context, int phoneId) {
        ...
        s.append(" " + DATA_KEY_SA_STATE + " = " +
                getIntData(context, phoneId, DATA_KEY_SA_STATE, ISelfActivation.STATE_UNKNOWN));
        s.append("}");
