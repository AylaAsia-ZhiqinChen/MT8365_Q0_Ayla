...
public class AlarmManagerPlus {
    ...
    public long getMaxTriggerTime(int type, long triggerElapsed, long windowLength, long interval,
        ...
        return mPowerSavingUtils.getMaxTriggerTime(type, triggerElapsed, windowLength, interval, operation, mAlarmMode, needGrouping);
    }

    public boolean isPowerSavingStart() {
        return mPowerSavingUtils.isPowerSavingStart();
    }
}
