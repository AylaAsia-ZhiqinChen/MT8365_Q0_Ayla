...
#define LOGATCI(lvl, f, ...) do { \
        if (lvl <= LOG_ERR) ALOGE("%d:%s(): " f, __LINE__, __FUNCTION__, ##__VA_ARGS__); \
        else if (lvl == LOG_WARNING) ALOGW("%d:%s(): " f, __LINE__, __FUNCTION__, ##__VA_ARGS__); \
        else if (lvl <= LOG_INFO) ALOGI("%d:%s(): " f, __LINE__, __FUNCTION__, ##__VA_ARGS__); \
        else if (lvl == LOG_DEBUG) ALOGD("%d:%s(): " f, __LINE__, __FUNCTION__, ##__VA_ARGS__); \
    } while (0)
