 ...
 *
 * @brief The header file defines both @c ConnectionHandlerInterface and @c SocketListener classes used to listen the domain sockets and dispatch incoming to connection handlers.
 *
 ...
 * @author mtk10567 (Roger Kuo)
 *
 * @brief The class is an abstract class defined the interfaces for @c SocketListener to call back.
 */
