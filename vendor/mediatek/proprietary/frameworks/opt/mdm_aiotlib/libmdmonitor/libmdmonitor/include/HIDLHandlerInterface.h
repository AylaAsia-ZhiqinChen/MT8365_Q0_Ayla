...
#ifndef __HIDL_HANDLER_INTERFACE_H__
#define __HIDL_HANDLER_INTERFACE_H__
#include "libmdmonitor.h"
#include "DataQueue.h"

namespace libmdmonitor {

class HIDLHandlerInterface 
{
public:
    /**
     * @brief Cleanup.
     */
    virtual ~HIDLHandlerInterface() {}
     ...
     *        false: Error.
     */
	virtual bool DataIn(const uint8_t* data, size_t dataLength, DataQueue & retBuf) = 0;
};
