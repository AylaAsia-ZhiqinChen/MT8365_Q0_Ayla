...
#include "../cfgfileinc/CFG_DcxoCap_File.h"
#include "../cfgdefault/CFG_DcxoCap_Default.h"
#include "../cfgfileinc/CFG_FG_File.h"
#include "../cfgdefault/CFG_FG_Default.h"
#include <stdio.h>
///Yuntian - Added a new LID from Yuntian Product Info partition to store data used for TEK by TR318 &&{{
#include "../cfgfileinc/CFG_YUNTIAN_PRO_INFO_File.h"
#include "../cfgdefault/CFG_YUNTIAN_PRO_INFO_Default.h"
///&&}}
#ifdef __cplusplus
extern "C"
{
    ...
    const TCFG_FILE g_akCFG_File_Custom[]=
    {
        ...
        {
            "/mnt/vendor/nvdata/APCFG/APRDEB/DCXOCAP",       VER(AP_CFG_CUSTOM_FILE_DCXOCAP_LID),              CFG_FILE_DCXOCAP_REC_SIZE,
            CFG_FILE_DCXOCAP_REC_TOTAL,                    SIGNLE_DEFUALT_REC,                                   (char *)&stDcxoCapDefault, DataReset , NULL
        },
        ...
        ///Yuntian - Added a new LID from Yuntian Product Info partition to store data used for TEK by yuntian8 &&{{
        {
            "/mnt/vendor/nvdata/APCFG/APRDEB/YUNTIAN_PRO_INFO",       VER(AP_CFG_REEB_YUNTIAN_PRO_INFO_LID),         CFG_FILE_YUNTIAN_PRO_INFO_SIZE,
            CFG_FILE_YUNTIAN_PRO_INFO_TOTAL,                   SIGNLE_DEFUALT_REC,                                   (char *)&stYUNTIAN_PRO_INFOConfigDefault,DataReset, NULL
        },
        ///&&}}
    };
    ...
    int iFileYUNTIAN_PRO_INFOLID=AP_CFG_REEB_YUNTIAN_PRO_INFO_LID;
    extern int iFileYUNTIAN_PRO_INFOLID;    
    ///&&}}
