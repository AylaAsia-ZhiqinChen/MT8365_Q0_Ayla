...
LID_BIT VER_LID(AP_CFG_CUSTOM_FILE_DCXOCAP_LID)
File_DcxoCap_Struct *CFG_FILE_DCXOCAP_REC_TOTAL
{
...
LID_BIT VER_LID(AP_CFG_REEB_YUNTIAN_PRO_INFO_LID)
YUNTIAN_PRO_INFO *CFG_FILE_YUNTIAN_PRO_INFO_TOTAL
{
