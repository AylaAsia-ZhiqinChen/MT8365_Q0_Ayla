...
const ISP_NVRAM_LCE_TUNING_PARAM_T hm1062mipimono_LCE_0008 = {
    .i4AutoHDREnable =
        0,
...
const ISP_NVRAM_GMA_STRUCT_T hm1062mipimono_GMA_0008 = {
  .GGM_Reg = {
        {.set={
...
const ISP_NVRAM_DCE_TUNING_PARAM_T hm1062mipimono_DCE_0008 = {
    .rDceParam=
    {
        30, // SmoothDCESpeed
