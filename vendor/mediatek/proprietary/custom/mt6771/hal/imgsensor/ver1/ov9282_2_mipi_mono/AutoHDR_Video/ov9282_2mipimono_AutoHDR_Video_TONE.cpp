...
#include "ov9282_2mipimono_AutoHDR_Video.h"

const ISP_NVRAM_LCE_TUNING_PARAM_T ov9282_2mipimono_LCE_0004 = {
    .i4AutoHDREnable =
        0,
...
const ISP_NVRAM_GMA_STRUCT_T ov9282_2mipimono_GMA_0004 = {
  .GGM_Reg = {
        {.set={
...
const ISP_NVRAM_DCE_TUNING_PARAM_T ov9282_2mipimono_DCE_0004 = {
    .rDceParam=
    {
        30, // SmoothDCESpeed
