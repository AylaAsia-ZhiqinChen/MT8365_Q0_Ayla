...
/******************************************************************************/
        // AWB gain of AWB light source
        {
            ...
            // HORIZON
            {
                 ...
                 600, // AWBGAIN_HORIZON_G
                1241  // AWBGAIN_HORIZON_B
            },
            // A
            {
                 512, // AWBGAIN_A_R
...
/******************************************************************************/
        // AWB light area
        {
            ...
            // TUNGSTEN
            {
                -145, // TUNGSTEN RightBound
                -676, // TUNGSTEN LeftBound
                -198, // TUNGSTEN UpperBound
                -323  // TUNGSTEN LowerBound
            },
            // WARM FLUORESCENT
            {
                -145, // WARM FLUORESCENT RightBound
                -676, // WARM FLUORESCENT LeftBound
                -323, // WARM FLUORESCENT UpperBound
                -483  // WARM FLUORESCENT LowerBound
            },
            // FLUORESCENT
            {
                  -36, // FLUORESCENT RightBound
                -145, // FLUORESCENT LeftBound
                -242, // FLUORESCENT UpperBound
                -370  // FLUORESCENT LowerBound
            },
            // CWF
            {
                  4, // CWF RightBound
            ...
            // DAYLIGHT
            {
                 127, // DAYLIGHT RightBound
                  -36, // DAYLIGHT LeftBound
                -242, // DAYLIGHT UpperBound
                -370  // DAYLIGHT LowerBound
            },
            // SHADE
            {
                 457, // SHADE RightBound
                 127, // SHADE LeftBound
                -242, // SHADE UpperBound
                -338  // SHADE LowerBound
            },
            // DF
            {
                 127, // DF RightBound
...
/******************************************************************************/
            ...
            {
                -373,  // RotatedXCoordinate0
                -301,  // RotatedXCoordinate1
                -202,  // RotatedXCoordinate2
                -100,  // RotatedXCoordinate3
