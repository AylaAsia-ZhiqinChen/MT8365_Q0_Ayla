...
//    { "cropRegion",                    TYPE_INT32  },
    ...
    CONFIG_METADATA_BEGIN(MTK_SCALER_AVAILABLE_JPEG_SIZES)//remove @ 3.2
        ...
        //CONFIG_ENTRY_VALUE(MSize(1920,  1152), MSize)
		CONFIG_ENTRY_VALUE(MSize(1800,  1080), MSize)
    CONFIG_METADATA_END()
    //==========================================================================
...
#endif
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT64)
                CONFIG_ENTRY_VALUE(1800, MINT64)
...
//------------------------------------------------------------------------------
    ...
    CONFIG_METADATA_BEGIN(MTK_JPEG_MAX_SIZE)//
        ...
        //CONFIG_ENTRY_VALUE(2654208, MINT32) //1920*1152*2*0.6
		CONFIG_ENTRY_VALUE(2332800, MINT32) //1800*1080*2*0.6
    CONFIG_METADATA_END()
    //==========================================================================
