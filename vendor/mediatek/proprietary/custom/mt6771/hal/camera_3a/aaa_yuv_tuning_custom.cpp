...
MUINT32 custom_GetFlashlightGain10X(MINT32 i4SensorDevId __unused)
{   
...
MUINT32 custom_BurstFlashlightGain10X(MINT32 i4SensorDevId __unused)
{
    return (MUINT32)FLASHLIGHT_CALI_LED_GAIN_PRV_TO_CAP_10X;
}
/*******************************************************************************
...
MDOUBLE custom_GetYuvFlashlightThreshold(MINT32 i4SensorDevId __unused)
{    
...
MINT32 custom_GetYuvFlashlightFrameCnt(MINT32 i4SensorDevId __unused)
{    
...
MINT32 custom_GetYuvFlashlightDuty(MINT32 i4SensorDevId __unused)
{    
...
MINT32 custom_GetYuvFlashlightHighCurrentDuty(MINT32 i4SensorDevId __unused)
{
...
MINT32 custom_GetYuvFlashlightHighCurrentTimeout(MINT32 i4SensorDevId __unused)
{
    // if FLASHLIGHT_CALI_LED_GAIN_PRV_TO_CAP_10X > 10 (high current mode),
    // it means capture flashlight is lighter than preflash light.
...
MINT32 custom_GetYuvFlashlightStep(MINT32 i4SensorDevId __unused)
{    
...
MINT32 custom_GetYuvAfLampSupport(MINT32 i4SensorDevId __unused)
{
...
MINT32 custom_GetYuvPreflashAF(MINT32 i4SensorDevId __unused)
{
