...
long long int getVsTimeOutLimit_ns(int normalizeM __unused, int fps/*x1000*/)
{
...
long long int getAEThreadVsTimeOutLimit_ns(int normalizeM __unused, int fps/*x1000*/)
{
    // you may define your own timeout limit for each fps and each M
    /*
    criterion: as long as possible, but it should satisfy: 
