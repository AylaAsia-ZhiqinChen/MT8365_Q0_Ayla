    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                // This is the max picture size, ratio is 5:3, which is the same to the max preview size ratio
            )
        ),
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                "1866x1120",    // This is the max preview size, ratio is nearly 1.666, which is the same to the max picture size ratio
            )
        ),
    )
#endif
