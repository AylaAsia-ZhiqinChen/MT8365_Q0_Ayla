#ifndef __SONY_IMX386_PDAF_LIBRARY_WRAPPER_H__
#define __SONY_IMX386_PDAF_LIBRARY_WRAPPER_H__
...
#define D_IMX386_ALL_PIXEL_SIZE_W (4032)
#define D_IMX386_ALL_PIXEL_SIZE_H (3016)

/* ============================================================
 * Define PD block number.
 * Please reference kernel driver setting of register of 0x31B0.
 * ============================================================ */
#define D_IMX386_PD_BLK_NUM_W (8)
#define D_IMX386_PD_BLK_NUM_H (6)
 ...
 * ============================================================ */
#define D_IMX386_DCC_IN_EEPROM_BLK_NUM_W (8)
#define D_IMX386_DCC_IN_EEPROM_BLK_NUM_H (6)
#define D_IMX386_DCC_IN_EEPROM_BLK_NUM_TOTAL (D_IMX386_DCC_IN_EEPROM_BLK_NUM_W*D_IMX386_DCC_IN_EEPROM_BLK_NUM_H)
 ...
 * ============================================================ */
#define D_IMX386_SLOPE_OFFSET_BLK_NUM_W (8)
#define D_IMX386_SLOPE_OFFSET_BLK_NUM_H (6)
#define D_IMX386_SLOPE_OFFSET_BLK_NUM_TOTAL (D_IMX386_SLOPE_OFFSET_BLK_NUM_W*D_IMX386_SLOPE_OFFSET_BLK_NUM_H)

#define D_IMX386_PD_AREA_OFFSET_X (64)
#define D_IMX386_PD_AREA_OFFSET_Y (16)
#define D_IMX386_PD_AREA_SIZE_X   (488)
#define D_IMX386_PD_AREA_SIZE_Y   (496)

/* ============================================================
 *  Define OK/NG knot number.
 *  Define threshold line in each knot.
 * ============================================================ */
#define D_IMX386_DEFOCUS_OKNG_THR_LINE_BLK_NUM_W (5)
#define D_IMX386_DEFOCUS_OKNG_THR_LINE_BLK_NUM_H (5)
#define D_IMX386_DEFOCUS_OKNG_THR_LINE_BLK_NUM_TOTAL (D_IMX386_DEFOCUS_OKNG_THR_LINE_BLK_NUM_W*D_IMX386_DEFOCUS_OKNG_THR_LINE_BLK_NUM_H)
#define D_IMX386_DEFOCUS_OKNG_THR_LINE_ONE_BLK_POINT_NUM (2)
 ...
 * ============================================================ */
#define D_IMX386_AF_MOTOR_DRV_CONT_CODE_RESOLUTION (10)
#define D_IMX386_EXTRA_SHIFT_BIT (10-D_IMX386_AF_MOTOR_DRV_CONT_CODE_RESOLUTION)

class SonyIMX386PdafLibraryWrapper
{
private :
    /* ============================================================
     *  Operations.
    ...
    SonyIMX386PdafLibraryWrapper( SonyIMX386PdafLibraryWrapper const&);

    // Copy-assignment operator is disallowed.
    SonyIMX386PdafLibraryWrapper& operator=( SonyIMX386PdafLibraryWrapper const&);
    ...
    signed long    m_aData_Slope[D_IMX386_SLOPE_OFFSET_BLK_NUM_TOTAL]; // DCC
    signed long    m_aData_Offset[D_IMX386_SLOPE_OFFSET_BLK_NUM_TOTAL];
    unsigned short m_aXAddress_Knot_Slope_Offset[D_IMX386_SLOPE_OFFSET_BLK_NUM_W];
    unsigned short m_aYAddress_Knot_Slope_Offset[D_IMX386_SLOPE_OFFSET_BLK_NUM_H];
    ...
    unsigned short m_aXAddress_Knot_DefocusOKNG[D_IMX386_DEFOCUS_OKNG_THR_LINE_BLK_NUM_W];
    unsigned short m_aYAddress_Knot_DefocusOKNG[D_IMX386_DEFOCUS_OKNG_THR_LINE_BLK_NUM_H];
...
#endif //__SONY_IMX386_PDAF_LIBRARY_WRAPPER_H__
