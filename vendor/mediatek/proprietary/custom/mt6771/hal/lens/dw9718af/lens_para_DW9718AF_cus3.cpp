...
#include "lens_para_DW9718AF.h"


template <>
NVRAM_LENS_DATA_PARA_STRUCT const&
GET_DW9718AF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_CUSTOM3>()
{
    static NVRAM_LENS_DATA_PARA_STRUCT DW9718AF_LENS_PARA_DEFAULT_VALUE =
    {
        // File Path
        {
            __FILE__
    ...
    return DW9718AF_LENS_PARA_DEFAULT_VALUE;
}
