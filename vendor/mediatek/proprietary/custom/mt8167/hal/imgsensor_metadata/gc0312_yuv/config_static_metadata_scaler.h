...
STATIC_METADATA2_BEGIN(DEVICE, SCALER, SENSOR_DRVNAME_GC0312_YUV)
//------------------------------------------------------------------------------
//  android.scaler
//------------------------------------------------------------------------------
    //==========================================================================
...
//    { "cropRegion",                    TYPE_INT32  },
    ...
    CONFIG_METADATA_BEGIN(MTK_SCALER_AVAILABLE_JPEG_SIZES)//remove @ 3.2
        ...
        //CONFIG_ENTRY_VALUE(MSize(176,  144), MSize)
...
//        CONFIG_ENTRY_VALUE(5898240, MINT32) //2560*1920*2*0.6
        CONFIG_ENTRY_VALUE(368640, MINT32) //640*480*2*0.6
    CONFIG_METADATA_END()
    //==========================================================================
