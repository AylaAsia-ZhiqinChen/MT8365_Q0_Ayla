...
//------------------------------------------------------------------------------
    //==========================================================================
#if 0    
    CONFIG_METADATA_BEGIN(MTK_LOGICALMULTICAMERA_PHYSICALIDS)
...
//------------------------------------------------------------------------------
    ...
    {
    case 0:
        MY_LOGD("---- case main camera device = %d", rInfo.getDeviceId());
        //======================================================================
...
//        CONFIG_METADATA_END()
    ...
    case 1:
        MY_LOGD("---- case sub camera device = %d", rInfo.getDeviceId());
        //======================================================================
//        CONFIG_METADATA_BEGIN(MTK_SENSOR_INFO_ORIENTATION)
