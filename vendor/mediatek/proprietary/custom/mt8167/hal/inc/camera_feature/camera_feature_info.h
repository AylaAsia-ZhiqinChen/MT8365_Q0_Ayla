...
public:     ////    Attributes.
    virtual MBOOL SetDefault(__attribute__((unused)) Feature_T const fValue)
    {
        return  MFALSE;
    }
...
public:     ////    Operations.
    virtual MBOOL ClearAll()
        { return MFALSE; }
    virtual MBOOL Copy(__attribute__((unused)) FInfoIF*const pFInfo)
        { return MFALSE; }
    virtual MBOOL SetToOne(__attribute__((unused)) Feature_T const fValue)
        { return MFALSE; }
    virtual MBOOL Remove(__attribute__((unused)) Feature_T const fValue)
        { return MFALSE; }
};
