...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        0,      // i4B_MIN
        {  // i4P00[9]
            5300000, -1642500, -1097500, -1192500, 4840000, -1082500, -447500, -1862500, 4870000
        },
        {  // i4P10[9]
            1945137, -2357752, 412614, -335788, -339687, 661876, -87269, 347239, -259971
        },
        {  // i4P01[9]
            1408600, -1551873, 143273, -574293, -9525, 577241, -215455, 9120, 206335
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AE NVRAM
    {
        // rDevicesInfo
        {
            ...
            29762,    // u4VideoExpUnit
            30,    // u4VideoMaxFrameRate
            1024,    // u4Video2PreRatio, 1024 base = 1x
            33875,    // u4CapExpUnit
            15,    // u4CapMaxFrameRate
            1024,    // u4Cap2PreRatio, 1024 base = 1x
            22523,    // u4Video1ExpUnit
            60,    // u4Video1MaxFrameRate
            1024,    // u4Video12PreRatio, 1024 base = 1x
            22523,    // u4Video2ExpUnit
        ...
        {
          {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    280,    // PCloudyRightBound
                    105,    // PCloudyLeftBound
                    -236,    // PCloudyUpperBound
                    -383    // PCloudyLowerBound
                },
                // Shade
                {
                    380,    // PShadeRightBound
                    105,    // PShadeLeftBound
                    -236,    // PShadeUpperBound
            ...
            // CCT estimation
            {
                ...
                {
                -374,    // i4RotatedXCoordinate[0]
                -296,    // i4RotatedXCoordinate[1]
                -200,    // i4RotatedXCoordinate[2]
            ...
            // Preference gain for each light source
            {
                ...
                {
                    {495, 512, 495}, {495, 512, 495}, {495, 512, 495}, {495, 512, 495}, {495, 512, 495}, {495, 512, 495}, {495, 512, 495}, {495, 512, 495}, {495, 512, 495}, {495, 512, 495}, 
                    {495, 512, 495}, {495, 512, 495}, {495, 512, 495}, {495, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
                }, // DAYLIGHT
                {
                    {525, 512, 512}, {525, 512, 512}, {525, 512, 512}, {525, 512, 512}, {525, 512, 512}, {525, 512, 512}, {525, 512, 512}, {525, 512, 512}, {525, 512, 512}, {525, 512, 512}, 
                    {525, 512, 512}, {525, 512, 512}, {525, 512, 512}, {525, 512, 512}, {525, 512, 512}, {525, 512, 512}, {525, 512, 512}, {525, 512, 512}, {525, 512, 512}
                }, // SHADE
                {
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, 
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
