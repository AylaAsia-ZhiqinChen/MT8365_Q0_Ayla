...
const NVRAM_LENS_PARA_STRUCT WV511AAF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 WV511AAF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &WV511AAF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pWV511AAF_getDefaultData = WV511AAF_getDefaultData;
