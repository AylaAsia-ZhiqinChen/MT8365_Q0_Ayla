 ...
 */
#ifndef _MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM12_H_
#define _MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM12_H_
#pragma once

#include "../dbg_exif_def.h"

//
// Debug Exif Version 12 - MT6768
//
namespace dbg_cam_mf_param_12 {

 // MF debug info
enum { MF_DEBUG_TAG_VERSION = 12 };
...
#endif//_MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM12_H_
