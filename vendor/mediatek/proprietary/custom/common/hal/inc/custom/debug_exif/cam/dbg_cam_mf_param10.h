 ...
 */
#ifndef _MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM10_H_
#define _MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM10_H_
#pragma once

#include "../dbg_exif_def.h"

//
// Debug Exif Version 10 - MT6765
//
namespace dbg_cam_mf_param_10 {

 // MF debug info
enum { MF_DEBUG_TAG_VERSION = 10 };
