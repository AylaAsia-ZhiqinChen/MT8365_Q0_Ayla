 ...
 */
#ifndef _MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM13_H_
#define _MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM13_H_
#pragma once

#include "../dbg_exif_def.h"

//
// Debug Exif Version 13 - MT6785
//
namespace dbg_cam_mf_param_13 {

 // MF debug info
enum { MF_DEBUG_TAG_VERSION = 13 };
