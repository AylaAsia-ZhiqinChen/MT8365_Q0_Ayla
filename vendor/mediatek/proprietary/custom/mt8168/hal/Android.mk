...
all_sensor_modules := $(addsuffix _tuning,$(notdir $(foreach f,$(CUSTOM_HAL_IMGSENSOR),$(wildcard vendor/mediatek/proprietary/custom/mt8168/hal/imgsensor/$(f)))))
all_sensor_idxMgr := $(addsuffix _IdxMgr,$(notdir $(foreach f,$(CUSTOM_HAL_IMGSENSOR),$(wildcard vendor/mediatek/proprietary/custom/mt8168/hal/imgsensor/$(f)))))
...
ifeq ($(strip $(TARGET_BOARD_PLATFORM)),mt6735m mt6737m)
#LOCAL_MULTILIB := 32
endif
#-----------------------------------------------------------
