...
#define D_IMX230_ALL_PIXEL_SIZE_W (5344)
#define D_IMX230_ALL_PIXEL_SIZE_H (4016)

/* ============================================================
 * Define PD block number.
 * Please reference kernel driver setting of register of 0x31B0.
 * ============================================================ */
#define D_IMX230_PD_BLK_NUM_W (8)
#define D_IMX230_PD_BLK_NUM_H (6)
 ...
 * ============================================================ */
#define D_IMX230_DCC_IN_EEPROM_BLK_NUM_W (8)
#define D_IMX230_DCC_IN_EEPROM_BLK_NUM_H (6)
#define D_IMX230_DCC_IN_EEPROM_BLK_NUM_TOTAL (D_IMX230_DCC_IN_EEPROM_BLK_NUM_W*D_IMX230_DCC_IN_EEPROM_BLK_NUM_H)
 ...
 * ============================================================ */
#define D_IMX230_SLOPE_OFFSET_BLK_NUM_W (8)
#define D_IMX230_SLOPE_OFFSET_BLK_NUM_H (6)
#define D_IMX230_SLOPE_OFFSET_BLK_NUM_TOTAL (D_IMX230_SLOPE_OFFSET_BLK_NUM_W*D_IMX230_SLOPE_OFFSET_BLK_NUM_H)

#define D_IMX230_PD_AREA_OFFSET_X (112)
#define D_IMX230_PD_AREA_OFFSET_Y (88)
#define D_IMX230_PD_AREA_SIZE_X   ((D_IMX230_ALL_PIXEL_SIZE_W-2*D_IMX230_PD_AREA_OFFSET_X)/D_IMX230_SLOPE_OFFSET_BLK_NUM_W)
#define D_IMX230_PD_AREA_SIZE_Y   ((D_IMX230_ALL_PIXEL_SIZE_H-2*D_IMX230_PD_AREA_OFFSET_Y)/D_IMX230_SLOPE_OFFSET_BLK_NUM_H)

/* ============================================================
 *  Define OK/NG knot number.
 *  Define threshold line in each knot.
 * ============================================================ */
#define D_IMX230_DEFOCUS_OKNG_THR_LINE_BLK_NUM_W (5)
#define D_IMX230_DEFOCUS_OKNG_THR_LINE_BLK_NUM_H (5)
#define D_IMX230_DEFOCUS_OKNG_THR_LINE_BLK_NUM_TOTAL (D_IMX230_DEFOCUS_OKNG_THR_LINE_BLK_NUM_W*D_IMX230_DEFOCUS_OKNG_THR_LINE_BLK_NUM_H)
#define D_IMX230_DEFOCUS_OKNG_THR_LINE_ONE_BLK_POINT_NUM (2)
 ...
 * ============================================================ */
#define D_IMX230_AF_MOTOR_DRV_CONT_CODE_RESOLUTION (10)
#define D_IMX230_EXTRA_SHIFT_BIT (10-D_IMX230_AF_MOTOR_DRV_CONT_CODE_RESOLUTION)
...
private :
    ...
    SonyIMX230PdafLibraryWrapper( SonyIMX230PdafLibraryWrapper const&);

    // Copy-assignment operator is disallowed.
    SonyIMX230PdafLibraryWrapper& operator=( SonyIMX230PdafLibraryWrapper const&);
    ...
    signed long    m_aData_Slope[D_IMX230_SLOPE_OFFSET_BLK_NUM_TOTAL]; // DCC
    signed long    m_aData_Offset[D_IMX230_SLOPE_OFFSET_BLK_NUM_TOTAL];
    unsigned short m_aXAddress_Knot_Slope_Offset[D_IMX230_SLOPE_OFFSET_BLK_NUM_W];
    unsigned short m_aYAddress_Knot_Slope_Offset[D_IMX230_SLOPE_OFFSET_BLK_NUM_H];
    ...
    unsigned short  m_aXAddress_Knot_DefocusOKNG[D_IMX230_DEFOCUS_OKNG_THR_LINE_BLK_NUM_W];
    unsigned short  m_aYAddress_Knot_DefocusOKNG[D_IMX230_DEFOCUS_OKNG_THR_LINE_BLK_NUM_H];
