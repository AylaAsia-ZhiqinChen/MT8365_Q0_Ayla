...
MVOID
IspTuningCustom::
refine_DBS(RAWIspCamInfo const& rCamInfo __attribute__((unused)), IspNvramRegMgr & rIspRegMgr __attribute__((unused)), ISP_NVRAM_DBS_T& rDBS __attribute__((unused)))
{
    #if 0
    MY_LOG("%s()\n", __FUNCTION__);
...
MVOID
IspTuningCustom::
refine_OBC(RAWIspCamInfo const& rCamInfo, IspNvramRegMgr & rIspRegMgr, ISP_NVRAM_OBC_T& rOBC __attribute__((unused)))
{
    #if 0
    MY_LOG("%s()\n", __FUNCTION__);
    // TODO: Add your code below...
...
MVOID
IspTuningCustom::
refine_SL2(RAWIspCamInfo const& rCamInfo __attribute__((unused)), IspNvramRegMgr & rIspRegMgr __attribute__((unused)), ISP_NVRAM_SL2_T& rSL2 __attribute__((unused)))
{
    #if 0
    MY_LOG("%s()\n", __FUNCTION__);
    // TODO: Add your code below...
...
MVOID
IspTuningCustom::
refine_PGN(RAWIspCamInfo const& rCamInfo __attribute__((unused)), IspNvramRegMgr & rIspRegMgr __attribute__((unused)), ISP_NVRAM_PGN_T& rPGN __attribute__((unused)))
{
    #if 0
    MY_LOG("%s()\n", __FUNCTION__);
    // TODO: Add your code below...
...
MVOID
IspTuningCustom::
refine_CFA(RAWIspCamInfo const& rCamInfo, IspNvramRegMgr & rIspRegMgr __attribute__((unused)), ISP_NVRAM_CFA_T& rCFA)
{
    if(TUNING_FOR_AIS) {
        if(IS_AIS) {
...
MVOID
IspTuningCustom::
refine_CCM(RAWIspCamInfo const& rCamInfo, IspNvramRegMgr & rIspRegMgr __attribute__((unused)), ISP_NVRAM_CCM_T& rCCM)
{
	/*
    #if 0
    MY_LOG("%s()\n", __FUNCTION__);
...
MVOID
IspTuningCustom::
refine_GGM(RAWIspCamInfo const& rCamInfo __attribute__((unused)), IspNvramRegMgr & rIspRegMgr __attribute__((unused)), ISP_NVRAM_GGM_T& rGGM __attribute__((unused)))
{
    #if 0
    MY_LOG("%s()\n", __FUNCTION__);
    // TODO: Add your code below...
...
MVOID
IspTuningCustom::
refine_CCR(RAWIspCamInfo const& rCamInfo, IspNvramRegMgr & rIspRegMgr __attribute__((unused)), ISP_NVRAM_CCR_T& rCCR)
{
    if (rCamInfo.eIspProfile == EIspProfile_VFB_PostProc) {
 ...
 if (0)
     {
        ...
        MINT32 const F_IDX_TH1 = 355;
        MINT32 const F_IDX_TH2 = 255;
        EIndex_CCM_T eIdx_CCM_new = rCamInfo.eIdx_CCM;
...
MBOOL
IspTuningCustom::
is_to_invoke_smooth_ccm_with_preference_gain(RAWIspCamInfo const& rCamInfo __attribute__((unused)))
{
    return MTRUE;
   // return MFALSE;
}
...
//                   THH2  TH2  THL2                   THH1  TH1  THL1
    ...
    switch  ((MUINT32)rCamInfo.eIdx_Shading_CCT)
    {
...
)
{
    ...
    */
    customRatioLog = propertyGet("vendor.debug.lsc_mgr.log", 0);
