...
STATIC_METADATA2_BEGIN(DEVICE, FEATURE, SENSOR_DRVNAME_GC02M1MIPI_RAW_CXT_REAR)
//------------------------------------------------------------------------------
//  android.control
//------------------------------------------------------------------------------
    //==========================================================================
...
//------------------------------------------------------------------------------
    //==========================================================================
      CONFIG_METADATA_BEGIN(MTK_CONTROL_CAPTURE_AVAILABLE_ZSL_MODES)
          CONFIG_ENTRY_VALUE(MTK_CONTROL_CAPTURE_ZSL_MODE_OFF, MUINT8)
          CONFIG_ENTRY_VALUE(MTK_CONTROL_CAPTURE_ZSL_MODE_ON, MUINT8)
      CONFIG_METADATA_END()
    //==========================================================================
      CONFIG_METADATA_BEGIN(MTK_CONTROL_CAPTURE_DEFAULT_ZSL_MODE)
          CONFIG_ENTRY_VALUE(MTK_CONTROL_CAPTURE_ZSL_MODE_ON, MUINT8)
      CONFIG_METADATA_END()
//------------------------------------------------------------------------------
STATIC_METADATA_END()
