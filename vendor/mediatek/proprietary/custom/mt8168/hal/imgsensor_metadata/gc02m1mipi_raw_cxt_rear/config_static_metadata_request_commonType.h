...
STATIC_METADATA2_BEGIN(DEVICE, REQUEST, SENSOR_DRVNAME_GC02M1MIPI_RAW_CXT_REAR)
//------------------------------------------------------------------------------
//  android.request
//------------------------------------------------------------------------------
    ...
    CONFIG_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_REQUEST_KEYS)//new hidden
        ...
        CONFIG_ENTRY_VALUE(MTK_HDR_FEATURE_HDR_MODE, MINT32)
    ...
    CONFIG_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_RESULT_KEYS)//new hidden
        ...
        CONFIG_ENTRY_VALUE(MTK_HDR_FEATURE_HDR_DETECTION_RESULT, MINT32)
    ...
    CONFIG_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_CHARACTERISTICS_KEYS)//new hidden
        ...
        CONFIG_ENTRY_VALUE(MTK_HDR_FEATURE_AVAILABLE_HDR_MODES_PHOTO, MINT32)
