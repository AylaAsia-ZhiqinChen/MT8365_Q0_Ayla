...
#include "camera_ae_tuning_para_gc02m1mipi_raw_cxt_rear.h"

template <>
AE_NVRAM_T const&
getAENVRAM_gc02m1mipi_raw_cxt_rear<CAM_SCENARIO_CUSTOM2>() // AUTO HDR
{
    // rDevicesInfo
    ...
    static AE_CCT_CFG_T  g_rCCTConfig =
    {
        ...
        2,                 // u4StrobeFlareThres // 0.5%
        150,                 // u4PrvMaxFlareThres //12 bit
        2,                 // u4PrvMinFlareThres
        150,                 // u4VideoMaxFlareThres // 12 bit
        ...
        //rMeteringSpec
        {
            ...
            //rNS_Spec
            {
                ...
                10, //5,    //u4Pcent
                72,//95, // 170,  //u4Thd
                31,//52,//76,   //72, u4FlatThd

				          180, //  200,  //u4BrightTonePcent
			            32,//58,//78,//80 //u4BrightToneThd
