...
#include "AE_Tuning_Para/camera_ae_tuning_para_sp2509mipiraw.h"
#include "AWB_Tuning_Para/camera_awb_tuning_para_sp2509mipiraw.h"
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AE NVRAM
    {
        getAENVRAM_sp2509mipiraw<CAM_SCENARIO_PREVIEW>(),
        getAENVRAM_sp2509mipiraw<CAM_SCENARIO_VIDEO>(),
        getAENVRAM_sp2509mipiraw<CAM_SCENARIO_CAPTURE>(),
        getAENVRAM_sp2509mipiraw<CAM_SCENARIO_CUSTOM1>(),
        getAENVRAM_sp2509mipiraw<CAM_SCENARIO_CUSTOM2>(),
        getAENVRAM_sp2509mipiraw<CAM_SCENARIO_CUSTOM3>(),
        getAENVRAM_sp2509mipiraw<CAM_SCENARIO_CUSTOM4>()
    },

    // AWB NVRAM
    AWB_NVRAM_START
    {
        getAWBNVRAM_sp2509mipiraw<CAM_SCENARIO_PREVIEW>(),
        getAWBNVRAM_sp2509mipiraw<CAM_SCENARIO_VIDEO>(),
        getAWBNVRAM_sp2509mipiraw<CAM_SCENARIO_CAPTURE>(),
        getAWBNVRAM_sp2509mipiraw<CAM_SCENARIO_CUSTOM1>(),
        getAWBNVRAM_sp2509mipiraw<CAM_SCENARIO_CUSTOM2>(),
        getAWBNVRAM_sp2509mipiraw<CAM_SCENARIO_CUSTOM3>(),
        getAWBNVRAM_sp2509mipiraw<CAM_SCENARIO_CUSTOM4>()
    },
