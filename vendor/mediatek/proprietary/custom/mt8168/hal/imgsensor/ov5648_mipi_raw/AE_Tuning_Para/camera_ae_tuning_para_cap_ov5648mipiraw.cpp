...
#include "camera_ae_tuning_para_ov5648mipiraw.h"

template <>
AE_NVRAM_T const&
getAENVRAM_ov5648mipiraw<CAM_SCENARIO_CAPTURE>() // CAPTURE
{
    // rDevicesInfo
    ...
    static AE_CCT_CFG_T  g_rCCTConfig =
    {
        ...
        145,                 // u4PrvMaxFlareThres //12 bit
        0,                 // u4PrvMinFlareThres
        140,                 // u4VideoMaxFlareThres // 12 bit
