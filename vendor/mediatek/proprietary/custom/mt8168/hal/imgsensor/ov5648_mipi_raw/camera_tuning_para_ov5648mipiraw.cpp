...
#include "AE_Tuning_Para/camera_ae_tuning_para_ov5648mipiraw.h"
#include "AWB_Tuning_Para/camera_awb_tuning_para_ov5648mipiraw.h"
...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    .ISPMulitCCM={
        ...
        {
            {.set={//CT_D65
                0x1C3404FF, 0x044400CD, 0x02C01FA3, 0x04441F9D, 0x1D060020, 0x044404DA
            }},
            {.set={//CT_TL84
                0x1E9C03EE, 0x04441F76, 0x02FF1F61, 0x04441FA0, 0x1DD91FBE, 0x04440469
            }},
            {.set={//CT_CWF
                0x1CA60514, 0x04440046, 0x03331EDD, 0x04441FF0, 0x1CC81F76, 0x044905C2
            }},
            {.set={//CT_A
                0x1E57038D, 0x0444001C, 0x03021F1D, 0x044C1FE1, 0x1C111F47, 0x044406A8
            }}
        },
        ...
        .CCM=
        {
            {//LV_00
                {.set={//CT_00
                    0x1DA903C1, 0x04430096, 0x02361F83, 0x04470047, 0x1C0F1FA1, 0x04430650
                }},
                {.set={//CT_01
                    0x1DA903C1, 0x04430096, 0x02361F83, 0x04470047, 0x1C0F1FA1, 0x04430650
                }},
                {.set={//CT_02
                    0x1DD20412, 0x0449001C, 0x02611F7F, 0x04430020, 0x1CE41FC5, 0x04460557
                }},
                {.set={//CT_03
                    0x1CBA0541, 0x04430005, 0x02B81F56, 0x04431FF2, 0x1D1F1FD1, 0x04430510
                }},
                {.set={//CT_04
                    0x1CF204E7, 0x04430027, 0x02D51FAC, 0x04431F7F, 0x1D7F0025, 0x0443045C
                }},
                {.set={//CT_05
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AE NVRAM
    {
        getAENVRAM_ov5648mipiraw<CAM_SCENARIO_PREVIEW>(),
        getAENVRAM_ov5648mipiraw<CAM_SCENARIO_VIDEO>(),
        getAENVRAM_ov5648mipiraw<CAM_SCENARIO_CAPTURE>(),
        getAENVRAM_ov5648mipiraw<CAM_SCENARIO_CUSTOM1>(),
        getAENVRAM_ov5648mipiraw<CAM_SCENARIO_CUSTOM2>(),
        getAENVRAM_ov5648mipiraw<CAM_SCENARIO_CUSTOM3>(),
        getAENVRAM_ov5648mipiraw<CAM_SCENARIO_CUSTOM4>()
    },

    // AWB NVRAM
    AWB_NVRAM_START
    {
        getAWBNVRAM_ov5648mipiraw<CAM_SCENARIO_PREVIEW>(),
        getAWBNVRAM_ov5648mipiraw<CAM_SCENARIO_VIDEO>(),
        getAWBNVRAM_ov5648mipiraw<CAM_SCENARIO_CAPTURE>(),
        getAWBNVRAM_ov5648mipiraw<CAM_SCENARIO_CUSTOM1>(),
        getAWBNVRAM_ov5648mipiraw<CAM_SCENARIO_CUSTOM2>(),
        getAWBNVRAM_ov5648mipiraw<CAM_SCENARIO_CUSTOM3>(),
        getAWBNVRAM_ov5648mipiraw<CAM_SCENARIO_CUSTOM4>()
    },
