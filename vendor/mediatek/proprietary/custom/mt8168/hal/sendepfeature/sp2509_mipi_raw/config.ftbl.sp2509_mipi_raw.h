 ...
 *
 ******************************************************************************/
FTABLE_DEFINITION(SENSOR_DRVNAME_SP2509_MIPI_RAW)
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
FTABLE_SCENE_INDEP()
    //==========================================================================
#if 1
...
//                MtkCameraParameters::SCENE_MODE_NORMAL,
				...
				//neostra chenlijun rm for bug 135656
...
*/
    ...
    //  ForCTS: the largest preview-size must have same aspect ratio (+-0.5) as the largest picture-size
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
    ...
    //==========================================================================
#if 1
if(facing == 1) /*front sensor     "720x480",      "1280x736",*/
{
    //  Video Size
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
...
else
{
    ...
    //==========================================================================
#if 1
//neostra chenlijun add for bug 135701 0801
...
#endif
    //==========================================================================
	//neostra chenlijun rm for bug 135658
#if 1
    //  White Balance.
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
