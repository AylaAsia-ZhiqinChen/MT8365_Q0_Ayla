...
FTABLE_SCENE_INDEP()
    //==========================================================================
#if 1		// sensor not support some scene modes now
    //  Scene Mode
    ...
    //  ForCTS: the largest preview-size must have same aspect ratio as the largest picture-size
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
