...
template <>
AF_NVRAM_T const&
GET_LC898212AF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>() // binning-size preview
{
    const static AF_NVRAM_T LC898212AF_LENS_PARA_DEFAULT_VALUE =
    {
...
//============================================================================================/
    ...
    return LC898212AF_LENS_PARA_DEFAULT_VALUE;
}
