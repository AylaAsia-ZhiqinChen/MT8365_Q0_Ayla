...
template <>
AF_NVRAM_T const&
GET_LC898217AF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_CAPTURE>() // CAPTURE
{
    const static AF_NVRAM_T LC898217AF_LENS_PARA_DEFAULT_VALUE =
    {
