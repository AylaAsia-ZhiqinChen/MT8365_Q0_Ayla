...
#include "lens_para_BU64745GWZAF.h"
...
const NVRAM_LENS_PARA_STRUCT BU64745GWZAF_LENS_PARA_DEFAULT_VALUE =
{
    ...
    // SCENARIO NVRAM
    {
        GET_BU64745GWZAF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>(),
        GET_BU64745GWZAF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_VIDEO>(),
        GET_BU64745GWZAF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_CAPTURE>(),
        GET_BU64745GWZAF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>(),
        GET_BU64745GWZAF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>(),
        GET_BU64745GWZAF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_CUSTOM3>(),
        GET_BU64745GWZAF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>()
    },
