...
#define AF_PARAM_REVISION 7231001
...
typedef struct AF_AREA_t
{
    ...
    AF_AREA_t()
        ...
        , i4Score(0)
    {
        memset(&sRect[0],            0, sizeof(AREA_T) * AF_WIN_NUM_SPOT);
        memset(&i4Id[0],             0, sizeof(MINT32) * AF_WIN_NUM_SPOT);
        memset(&i4Type[0],           0, sizeof(MINT32) * AF_WIN_NUM_SPOT);
        memset(&i4Motion[0][0],      0, sizeof(MINT32) * AF_WIN_NUM_SPOT * 2);
        memset(&i4Landmark[0][0][0], 0, sizeof(MINT32) * AF_WIN_NUM_SPOT * 3 * 4);
        memset(&i4LandmarkCV[0],     0, sizeof(MINT32) * AF_WIN_NUM_SPOT);
    }
} AF_AREA_T;
