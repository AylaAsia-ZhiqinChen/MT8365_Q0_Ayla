...
ifneq ($(wildcard $(sensor_driver_src_project)/$(my_ccu_sensor)),)
  my_ccu_src_path = $(sensor_driver_src_project)
else ifneq ($(wildcard $(sensor_driver_src_platform)/$(my_ccu_sensor)),)
  my_ccu_src_path = $(sensor_driver_src_platform)
else
  my_ccu_src_path = $(sensor_driver_src_common)
endif
