...
constexpr char kBluetoothSnoopAutoStart[] =
    "persist.vendor.bluetooth.btsnoopautostart";
constexpr char kBluetoothSnoopRootPath[] =
    "persist.vendor.bluetooth.btsnooprootpath";
...
class BTSnoop {
 ...
 private:
  ...
  std::unique_ptr<BtSnoopProxy> btsnoop_proxy_;
