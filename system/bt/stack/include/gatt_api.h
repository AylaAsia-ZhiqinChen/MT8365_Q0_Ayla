...
extern "C" uint16_t GATTS_AddService(tGATT_IF gatt_if, btgatt_db_element_t* service,
                                 int count);
#else
 ...
 ******************************************************************************/
#ifdef MTK_MESH_SUPPORT
extern "C" tGATT_STATUS GATTS_HandleValueNotification(uint16_t conn_id,
                                                  uint16_t attr_handle,
                                                  uint16_t val_len,
                                                  uint8_t* p_val);
#else
 ...
 ******************************************************************************/
#ifdef MTK_MESH_SUPPORT
extern "C" tGATT_STATUS GATTS_SendRsp(uint16_t conn_id, uint32_t trans_id,
 ...
 ******************************************************************************/
#ifdef MTK_MESH_SUPPORT
extern "C" tGATT_STATUS GATTC_ConfigureMTU(uint16_t conn_id, uint16_t mtu);
#else
 ...
 ******************************************************************************/
#ifdef MTK_MESH_SUPPORT
extern "C" tGATT_STATUS GATTC_Discover(uint16_t conn_id, tGATT_DISC_TYPE disc_type,
 ...
 ******************************************************************************/
#ifdef MTK_MESH_SUPPORT
extern "C" tGATT_STATUS GATTC_Write(uint16_t conn_id, tGATT_WRITE_TYPE type,
                                tGATT_VALUE* p_write);
#else
 ...
 ******************************************************************************/
#ifdef MTK_MESH_SUPPORT
extern "C" tGATT_IF GATT_Register(const bluetooth::Uuid& p_app_uuid128,
 ...
 ******************************************************************************/
#ifdef MTK_MESH_SUPPORT
extern "C" void GATT_Deregister(tGATT_IF gatt_if);
#else
 ...
 ******************************************************************************/
#ifdef MTK_MESH_SUPPORT
extern "C" bool GATT_Connect(tGATT_IF gatt_if, const RawAddress& bd_addr,
 ...
 ******************************************************************************/
#ifdef MTK_MESH_SUPPORT
extern "C" tGATT_STATUS GATT_Disconnect(uint16_t conn_id);
#else
...
extern "C" bluetooth::Uuid Mesh_UuidEmpty(void);
extern "C" bluetooth::Uuid Mesh_UuidFrom16Bit(uint16_t uuid16);
extern "C" bluetooth::Uuid Mesh_UuidFrom128BitLE(const uint8_t* uuid);
extern "C" void Mesh_UuidTo128BitLE(const bluetooth::Uuid& uuid, uint8_t uuid_dst[16]);
extern "C" void Mesh_UuidAs16Bit(const bluetooth::Uuid& uuid, uint8_t uuid_dst[16]);
extern "C" size_t Mesh_UuidGetShortestRepresentationSize(const bluetooth::Uuid& uuid);
#endif
