...
/* it is used to find an exist ACP scb */
#define AVCT_ACP_EXIST 5     /* ACCEPT */
#endif
...
typedef struct {
  tAVCT_CTRL_CBACK* p_ctrl_cback; /* Control callback avrc_ctrl_cback */
  tAVCT_MSG_CBACK* p_msg_cback;   /* Message callback avrc_msg_cback */
