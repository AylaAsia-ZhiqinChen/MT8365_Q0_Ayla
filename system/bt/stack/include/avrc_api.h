...
typedef struct {
  tAVRC_CTRL_CBACK ctrl_cback;    /* application control callback bta_av_rc_ctrl_cback */
  tAVRC_MSG_CBACK msg_cback;      /* application message callback bta_av_rc_msg_cback */
