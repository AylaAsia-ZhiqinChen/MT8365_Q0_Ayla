...
// Mediatek Android Patch Begin
  ...
  if ((osi_property_get("bluetooth.dump.data.enable", value, "off")) && (!strcmp(value, "on"))) {
    if (src_outputPcmSampleFile) {
      fwrite(a2dp_sbc_encoder_cb.pcmBuffer, 1, (size_t)nb_byte_read, src_outputPcmSampleFile);
    }
  }
#endif
// Mediatek Android Patch End
...
// Mediatek Android Patch Begin
  ...
  if ((osi_property_get("bluetooth.dump.data.enable", value, "off")) && (!strcmp(value, "on"))) {
    if (src_outputPcmSampleFile) {
      fwrite(read_buffer, 1, (size_t)nb_byte_read, src_outputPcmSampleFile);
    }
  }
#endif
// Mediatek Android Patch End
