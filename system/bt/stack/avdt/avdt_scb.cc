...
#if defined(MTK_PTS_AV_TEST) && (MTK_PTS_AV_TEST == TRUE)
/* state table for idle state---for pts */
const uint8_t avdt_scb_st_idle_pts[][AVDT_SCB_NUM_COLS] = {
    /* Event */
    ...
    {AVDT_SCB_IGNORE, AVDT_SCB_IGNORE, AVDT_SCB_IDLE_ST},
    /* API_SETCONFIG_RSP_EVT */    // pts test -- AVDTP/SNK/INT/SIG/SMG/BV-11-C
    {AVDT_SCB_SND_SETCONFIG_RSP, AVDT_SCB_SND_GETCONFIG_REQ, AVDT_SCB_CONF_ST},
...
#if defined(MTK_PTS_AV_TEST) && (MTK_PTS_AV_TEST == TRUE)
/* state table for opening state ---for pts*/
const uint8_t avdt_scb_st_opening_pts[][AVDT_SCB_NUM_COLS] = {
    /* Event */
    /* Action 1                       Action 2                    Next state */
    /* API_REMOVE_EVT */
    ...
    /* API_RECONFIG_RSP_EVT */  //  pts test for AVDTP/SNK/ACP/SIG/SMG/BV-14-C
    {AVDT_SCB_SND_RECONFIG_RSP, AVDT_SCB_IGNORE, AVDT_SCB_OPENING_ST},
    /* API_SECURITY_RSP_EVT */
    ...
    /* MSG_RECONFIG_CMD_EVT */  // pts test for AVDTP/SNK/ACP/SIG/SMG/ESR05/BV-14-C
    {AVDT_SCB_HDL_RECONFIG_CMD, AVDT_SCB_IGNORE, AVDT_SCB_OPENING_ST},
    /* MSG_SECURITY_CMD_EVT */
...
#if defined(MTK_PTS_AV_TEST) && (MTK_PTS_AV_TEST == TRUE)
const tAVDT_SCB_ST_TBL avdt_scb_st_tbl_pts[] = {
    avdt_scb_st_idle_pts, avdt_scb_st_conf,   avdt_scb_st_opening_pts,
    avdt_scb_st_open, avdt_scb_st_stream, avdt_scb_st_closing};
...
void avdt_scb_event(AvdtpScb* p_scb, uint8_t event, tAVDT_SCB_EVT* p_data) {
  ...
  state_table = avdt_scb_st_tbl_pts[p_scb->state];
  }
  else {
