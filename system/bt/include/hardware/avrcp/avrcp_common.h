...
enum class CommandPdu : uint8_t {
  ...
  LIST_APPLICATION_SETTING_VALUES = 0x12,
  GET_CUR_PLAYER_APPLICATION_VALUE = 0x13,
  SET_PLAYER_APPLICATION_SETTING_VALUE = 0x14,
  GET_PLAYER__APPLICATION_ATTRIBUTES_TEXT = 0x15,
  GET_PLAYER_APPLICATION_VALUE_TEXT = 0x16,
#endif
