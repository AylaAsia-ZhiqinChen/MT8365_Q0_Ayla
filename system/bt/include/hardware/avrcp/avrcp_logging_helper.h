...
inline std::string CommandPduText(const CommandPdu& pdu) {
  switch (pdu) {
    ...
    CASE_RETURN_TEXT(CommandPdu::LIST_APPLICATION_SETTING_VALUES);
    CASE_RETURN_TEXT(CommandPdu::GET_CUR_PLAYER_APPLICATION_VALUE);
    CASE_RETURN_TEXT(CommandPdu::SET_PLAYER_APPLICATION_SETTING_VALUE);
    CASE_RETURN_TEXT(CommandPdu::GET_PLAYER__APPLICATION_ATTRIBUTES_TEXT);
    CASE_RETURN_TEXT(CommandPdu::GET_PLAYER_APPLICATION_VALUE_TEXT);
#endif
