...
static const struct mtk_pin_spec_pupd_set_samereg mt8167_spec_pupd[] = {
	MTK_PIN_PUPD_SPEC_SR(14, 0xe50, 14, 13, 12, 0),
	MTK_PIN_PUPD_SPEC_SR(15, 0xe60, 2, 1, 0, 0),
	MTK_PIN_PUPD_SPEC_SR(16, 0xe60, 6, 5, 4, 0),
	MTK_PIN_PUPD_SPEC_SR(17, 0xe60, 10, 9, 8, 0),

	MTK_PIN_PUPD_SPEC_SR(21, 0xe60, 14, 13, 12, 0),
	MTK_PIN_PUPD_SPEC_SR(22, 0xe70, 2, 1, 0, 0),
	MTK_PIN_PUPD_SPEC_SR(23, 0xe70, 6, 5, 4, 0),

	MTK_PIN_PUPD_SPEC_SR(40, 0xe80, 2, 1, 0, 0),
	MTK_PIN_PUPD_SPEC_SR(41, 0xe80, 6, 5, 4, 0),
	MTK_PIN_PUPD_SPEC_SR(42, 0xe90, 2, 1, 0, 0),
	MTK_PIN_PUPD_SPEC_SR(43, 0xe90, 6, 5, 4, 0),

	MTK_PIN_PUPD_SPEC_SR(68, 0xe50, 10, 9, 8, 0),
	MTK_PIN_PUPD_SPEC_SR(69, 0xe50, 6, 5, 4, 0),
	MTK_PIN_PUPD_SPEC_SR(70, 0xe40, 6, 5, 4, 0),
	MTK_PIN_PUPD_SPEC_SR(71, 0xe40, 10, 9, 8, 0),
	MTK_PIN_PUPD_SPEC_SR(72, 0xe40, 14, 13, 12, 0),
	MTK_PIN_PUPD_SPEC_SR(73, 0xe50, 2, 1, 0, 0),

	MTK_PIN_PUPD_SPEC_SR(104, 0xe40, 2, 1, 0, 0),
	MTK_PIN_PUPD_SPEC_SR(105, 0xe30, 14, 13, 12, 0),
	MTK_PIN_PUPD_SPEC_SR(106, 0xe20, 14, 13, 12, 0),
	MTK_PIN_PUPD_SPEC_SR(107, 0xe30, 2, 1, 0, 0),
	MTK_PIN_PUPD_SPEC_SR(108, 0xe30, 6, 5, 4, 0),
	MTK_PIN_PUPD_SPEC_SR(109, 0xe30, 10, 9, 8, 0),
	MTK_PIN_PUPD_SPEC_SR(110, 0xe10, 14, 13, 12, 0),
	MTK_PIN_PUPD_SPEC_SR(111, 0xe10, 10, 9, 8, 0),
	MTK_PIN_PUPD_SPEC_SR(112, 0xe10, 6, 5, 4, 0),
	MTK_PIN_PUPD_SPEC_SR(113, 0xe10, 2, 1, 0, 0),
	MTK_PIN_PUPD_SPEC_SR(114, 0xe20, 10, 9, 8, 0),
	MTK_PIN_PUPD_SPEC_SR(115, 0xe20, 2, 1, 0, 0),
	MTK_PIN_PUPD_SPEC_SR(116, 0xe20, 6, 5, 4, 0),
	MTK_PIN_PUPD_SPEC_SR(117, 0xe00, 14, 13, 12, 0),
	MTK_PIN_PUPD_SPEC_SR(118, 0xe00, 10, 9, 8, 0),
	MTK_PIN_PUPD_SPEC_SR(119, 0xe00, 6, 5, 4, 0),
	MTK_PIN_PUPD_SPEC_SR(120, 0xe00, 2, 1, 0, 0),
};

static int mt8167_spec_pull_set(struct mtk_pinctrl *pctl,
			struct regmap *regmap, unsigned int pin,
			unsigned char align, bool isup, unsigned int r1r0)
{
	return mtk_pctrl_spec_pull_set_samereg(pctl, regmap,
						mt8167_spec_pupd,
						ARRAY_SIZE(mt8167_spec_pupd),
						pin, align, isup, r1r0);
}
...
static int mt8167_ies_smt_set(struct mtk_pinctrl *pctl,
			struct regmap *regmap, unsigned int pin,
			unsigned char align, int value,
			enum pin_config_param arg)
{
	if (arg == PIN_CONFIG_INPUT_ENABLE)
		return mtk_pconf_spec_set_ies_smt_range(regmap,
						mt8167_ies_set,
						ARRAY_SIZE(mt8167_ies_set),
						pin, align, value);
	else if (arg == PIN_CONFIG_INPUT_SCHMITT_ENABLE)
		return mtk_pconf_spec_set_ies_smt_range(regmap, mt8167_smt_set,
						ARRAY_SIZE(mt8167_smt_set),
						pin, align, value);
	return -EINVAL;
}

static int mtk_spec_get_ies_smt_range(struct regmap *regmap,
