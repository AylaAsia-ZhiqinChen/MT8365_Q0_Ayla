...
#define XUNHU_CAMERA_FRONT_BACK_CHANGE_BOTH_RAW
#if defined(XUNHU_CAMERA_FRONT_BACK_CHANGE_BOTH_RAW)
...
#if 0//defined(XUNHU_CAMERA_FRONT_BACK_CHANGE_BOTH_RAW)	
	sensor_resolution->SensorPreviewWidth = imgsensor_info.pre.grabwindow_width - 2;
	sensor_resolution->SensorPreviewHeight = imgsensor_info.pre.grabwindow_height - 2;
#else
