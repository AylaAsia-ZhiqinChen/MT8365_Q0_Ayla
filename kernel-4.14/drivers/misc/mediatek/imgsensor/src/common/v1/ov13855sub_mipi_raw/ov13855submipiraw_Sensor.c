...
#include "ov13855submipiraw_Sensor.h"

/***********************Modify Following Strings for Debug********************/
#define PFX "OV13855sub_camera_sensor"
#define LOG_1 cam_pr_debug("OV13855sub,MIPI 4LANE\n")
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV13855SUB_SENSOR_ID,
...
int capture_first_flagsub;
int pre_currefpssub;
static void capture_setting(kal_uint16 currefps)
{
	cam_pr_debug("E! currefps:%d\n", currefps);

	if (pre_currefpssub != currefps) {
		capture_first_flagsub = 0;
		pre_currefpssub = currefps;
	} else
		capture_first_flagsub = 1;
	if (capture_first_flagsub == 0) {
		write_cmos_sensor(0x0100, 0x00);
