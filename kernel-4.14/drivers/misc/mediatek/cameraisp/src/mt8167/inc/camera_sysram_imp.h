...
#define LOG_PR_WRN(fmt, arg...)    pr_warn(LOG_TAG "[%s]WRN(%5d):" fmt "\r\n", __func__, __LINE__, ##arg)
#define LOG_PR_ERR(fmt, arg...)    pr_err(LOG_TAG "[%s]ERR(%5d):" fmt "\r\n", __func__, __LINE__, ##arg)
#define LOG_PR_DMP(fmt, arg...)    pr_err(LOG_TAG ""              fmt,                                ##arg)
