...
#include <pseudo_m4u/pseudo_m4u.h>
#else
#include <m4u.h>
#endif
...
#define LOG_PR_WRN(format, args...)    pr_warn(MyTag "[%s, line%05d]Warning:" format "\n", __func__, __LINE__, ##args)
#define LOG_PR_ERR(format, args...)    pr_err(MyTag "[%s, line%05d]ERROR:" format "\n", __func__, __LINE__, ##args)
#define LOG_PR_AST(format, args...)    pr_alert(MyTag "[%s, line%05d]ASSERT:" format "\n", __func__, __LINE__, ##args)
...
#define RegDump(start, end) {\
	...
	for (i = start; i <= end; i += 0x4) {\
		LOG_PR_ERR("0x%08X %08X", (unsigned int)(ISP_TPIPE_ADDR + i), (unsigned int)ISP_RD32(ISP_ADDR + i));\
	} \
}
...
static void ISP_DumpBasicRegisters(void)
{
	...
	if (sensor_type != 1 && sensor_type != 3)
		LOG_PR_ERR("Sensor Type:%d(should be: 1: Raw, 3: YUV), Fatal Error!", sensor_type);
	...
	if (tg_from_seninf_width != sensor_width)
		LOG_PR_ERR("TG receive width(%u) from seninf != Sensor output width(%u)!",
			tg_from_seninf_width, sensor_width);
	if (tg_from_seninf_height != sensor_height)
		LOG_PR_ERR("TG receive height(%u) from seninf != Sensor output height(%u)!",
...
static MINT32 ISP_DumpReg(MVOID)
{
	...
	LOG_PR_ERR("start MT");
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x000, ISP_RD32((void *)(ISP_ADDR + 0x000)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x004, ISP_RD32((void *)(ISP_ADDR + 0x004)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x008, ISP_RD32((void *)(ISP_ADDR + 0x008)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x00C, ISP_RD32((void *)(ISP_ADDR + 0x00C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x010, ISP_RD32((void *)(ISP_ADDR + 0x010)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x018, ISP_RD32((void *)(ISP_ADDR + 0x018)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x01C, ISP_RD32((void *)(ISP_ADDR + 0x01C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x020, ISP_RD32((void *)(ISP_ADDR + 0x020)));

#if 1				/* it may touch ReadClear register */
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x024, ISP_RD32((void *)(ISP_ADDR + 0x024)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x028, ISP_RD32((void *)(ISP_ADDR + 0x028)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x02C, ISP_RD32((void *)(ISP_ADDR + 0x02C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x030, ISP_RD32((void *)(ISP_ADDR + 0x030)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x034, ISP_RD32((void *)(ISP_ADDR + 0x034)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x038, ISP_RD32((void *)(ISP_ADDR + 0x038)));
#else
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x024, 0);
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x028, 0);
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x02C, 0);
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x030, 0);
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x034, 0);
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x038, 0);
#endif

	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x050, ISP_RD32((void *)(ISP_ADDR + 0x050)));	/* Tile setting */
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x074, ISP_RD32((void *)(ISP_ADDR + 0x074)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x078, ISP_RD32((void *)(ISP_ADDR + 0x078)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x07C, ISP_RD32((void *)(ISP_ADDR + 0x07C)));
#if 0				/* WO */
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x080, ISP_RD32((void *)(ISP_ADDR + 0x080)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x084, ISP_RD32((void *)(ISP_ADDR + 0x084)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x088, ISP_RD32((void *)(ISP_ADDR + 0x088)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x08C, ISP_RD32((void *)(ISP_ADDR + 0x08C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x090, ISP_RD32((void *)(ISP_ADDR + 0x090)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x094, ISP_RD32((void *)(ISP_ADDR + 0x094)));
#endif
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x0A8, ISP_RD32((void *)(ISP_ADDR + 0x0A8)));	/* cq0 base */
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x0AC, ISP_RD32((void *)(ISP_ADDR + 0x0AC)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x0B0, ISP_RD32((void *)(ISP_ADDR + 0x0B0)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x0B4, ISP_RD32((void *)(ISP_ADDR + 0x0B4)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x0B8, ISP_RD32((void *)(ISP_ADDR + 0x0B8)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x0BC, ISP_RD32((void *)(ISP_ADDR + 0x0BC)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x0E8, ISP_RD32((void *)(ISP_ADDR + 0x0E8)));	/* cq0 cur base */
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x0F4, ISP_RD32((void *)(ISP_ADDR + 0x0F4)));	/* fbc imgo */
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x0F8, ISP_RD32((void *)(ISP_ADDR + 0x0F8)));	/* fbc img2o */
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x110, ISP_RD32((void *)(ISP_ADDR + 0x110)));	/* mdp crop x */
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x114, ISP_RD32((void *)(ISP_ADDR + 0x114)));	/* mdp crop y */
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x138, ISP_RD32((void *)(ISP_ADDR + 0x138)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x13C, ISP_RD32((void *)(ISP_ADDR + 0x13C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x144, ISP_RD32((void *)(ISP_ADDR + 0x144)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x148, ISP_RD32((void *)(ISP_ADDR + 0x148)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x14C, ISP_RD32((void *)(ISP_ADDR + 0x14C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x204, ISP_RD32((void *)(ISP_ADDR + 0x204)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x20C, ISP_RD32((void *)(ISP_ADDR + 0x20C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x22C, ISP_RD32((void *)(ISP_ADDR + 0x22C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x230, ISP_RD32((void *)(ISP_ADDR + 0x230)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x234, ISP_RD32((void *)(ISP_ADDR + 0x234)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x238, ISP_RD32((void *)(ISP_ADDR + 0x238)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x23C, ISP_RD32((void *)(ISP_ADDR + 0x23C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x240, ISP_RD32((void *)(ISP_ADDR + 0x240)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x244, ISP_RD32((void *)(ISP_ADDR + 0x244)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x258, ISP_RD32((void *)(ISP_ADDR + 0x258)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x260, ISP_RD32((void *)(ISP_ADDR + 0x260)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x26C, ISP_RD32((void *)(ISP_ADDR + 0x26C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x270, ISP_RD32((void *)(ISP_ADDR + 0x270)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x27C, ISP_RD32((void *)(ISP_ADDR + 0x27C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x298, ISP_RD32((void *)(ISP_ADDR + 0x298)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x2B4, ISP_RD32((void *)(ISP_ADDR + 0x2B4)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x2D0, ISP_RD32((void *)(ISP_ADDR + 0x2D0)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x2D4, ISP_RD32((void *)(ISP_ADDR + 0x2D4)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x2F0, ISP_RD32((void *)(ISP_ADDR + 0x2F0)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x2F4, ISP_RD32((void *)(ISP_ADDR + 0x2F4)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x300, ISP_RD32((void *)(ISP_ADDR + 0x300)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x304, ISP_RD32((void *)(ISP_ADDR + 0x304)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x308, ISP_RD32((void *)(ISP_ADDR + 0x308)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x30C, ISP_RD32((void *)(ISP_ADDR + 0x30C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x310, ISP_RD32((void *)(ISP_ADDR + 0x310)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x314, ISP_RD32((void *)(ISP_ADDR + 0x314)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x318, ISP_RD32((void *)(ISP_ADDR + 0x318)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x31C, ISP_RD32((void *)(ISP_ADDR + 0x31C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x320, ISP_RD32((void *)(ISP_ADDR + 0x320)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x324, ISP_RD32((void *)(ISP_ADDR + 0x324)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x328, ISP_RD32((void *)(ISP_ADDR + 0x328)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x32C, ISP_RD32((void *)(ISP_ADDR + 0x32C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x330, ISP_RD32((void *)(ISP_ADDR + 0x330)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x334, ISP_RD32((void *)(ISP_ADDR + 0x334)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x338, ISP_RD32((void *)(ISP_ADDR + 0x338)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x33C, ISP_RD32((void *)(ISP_ADDR + 0x33C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x350, ISP_RD32((void *)(ISP_ADDR + 0x350)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x37C, ISP_RD32((void *)(ISP_ADDR + 0x37C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x398, ISP_RD32((void *)(ISP_ADDR + 0x398)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x410, ISP_RD32((void *)(ISP_ADDR + 0x410)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x414, ISP_RD32((void *)(ISP_ADDR + 0x414)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x418, ISP_RD32((void *)(ISP_ADDR + 0x418)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x41C, ISP_RD32((void *)(ISP_ADDR + 0x41C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x420, ISP_RD32((void *)(ISP_ADDR + 0x420)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x448, ISP_RD32((void *)(ISP_ADDR + 0x448)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4B0, ISP_RD32((void *)(ISP_ADDR + 0x4B0)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4B4, ISP_RD32((void *)(ISP_ADDR + 0x4B4)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4B8, ISP_RD32((void *)(ISP_ADDR + 0x4B8)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4BC, ISP_RD32((void *)(ISP_ADDR + 0x4BC)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4E8, ISP_RD32((void *)(ISP_ADDR + 0x4E8)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x534, ISP_RD32((void *)(ISP_ADDR + 0x534)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x538, ISP_RD32((void *)(ISP_ADDR + 0x538)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x53C, ISP_RD32((void *)(ISP_ADDR + 0x53C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x580, ISP_RD32((void *)(ISP_ADDR + 0x580)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x584, ISP_RD32((void *)(ISP_ADDR + 0x584)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x800, ISP_RD32((void *)(ISP_ADDR + 0x800)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x880, ISP_RD32((void *)(ISP_ADDR + 0x880)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x884, ISP_RD32((void *)(ISP_ADDR + 0x884)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x888, ISP_RD32((void *)(ISP_ADDR + 0x888)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x8A0, ISP_RD32((void *)(ISP_ADDR + 0x8A0)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x920, ISP_RD32((void *)(ISP_ADDR + 0x920)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x924, ISP_RD32((void *)(ISP_ADDR + 0x924)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x928, ISP_RD32((void *)(ISP_ADDR + 0x928)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x92C, ISP_RD32((void *)(ISP_ADDR + 0x92C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x930, ISP_RD32((void *)(ISP_ADDR + 0x930)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x934, ISP_RD32((void *)(ISP_ADDR + 0x934)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x938, ISP_RD32((void *)(ISP_ADDR + 0x938)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x93C, ISP_RD32((void *)(ISP_ADDR + 0x93C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x948, ISP_RD32((void *)(ISP_ADDR + 0x948)));	/* unp offset */
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x960, ISP_RD32((void *)(ISP_ADDR + 0x960)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x9C4, ISP_RD32((void *)(ISP_ADDR + 0x9C4)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x9E4, ISP_RD32((void *)(ISP_ADDR + 0x9E4)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x9E8, ISP_RD32((void *)(ISP_ADDR + 0x9E8)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x9EC, ISP_RD32((void *)(ISP_ADDR + 0x9EC)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xA00, ISP_RD32((void *)(ISP_ADDR + 0xA00)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xA04, ISP_RD32((void *)(ISP_ADDR + 0xA04)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xA08, ISP_RD32((void *)(ISP_ADDR + 0xA08)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xA0C, ISP_RD32((void *)(ISP_ADDR + 0xA0C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xA10, ISP_RD32((void *)(ISP_ADDR + 0xA10)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xA14, ISP_RD32((void *)(ISP_ADDR + 0xA14)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xA20, ISP_RD32((void *)(ISP_ADDR + 0xA20)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xAA0, ISP_RD32((void *)(ISP_ADDR + 0xAA0)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xACC, ISP_RD32((void *)(ISP_ADDR + 0xACC)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xB00, ISP_RD32((void *)(ISP_ADDR + 0xB00)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xB04, ISP_RD32((void *)(ISP_ADDR + 0xB04)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xB08, ISP_RD32((void *)(ISP_ADDR + 0xB08)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xB0C, ISP_RD32((void *)(ISP_ADDR + 0xB0C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xB10, ISP_RD32((void *)(ISP_ADDR + 0xB10)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xB14, ISP_RD32((void *)(ISP_ADDR + 0xB14)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xB18, ISP_RD32((void *)(ISP_ADDR + 0xB18)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xB1C, ISP_RD32((void *)(ISP_ADDR + 0xB1C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xB20, ISP_RD32((void *)(ISP_ADDR + 0xB20)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xB44, ISP_RD32((void *)(ISP_ADDR + 0xB44)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xB48, ISP_RD32((void *)(ISP_ADDR + 0xB48)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xB4C, ISP_RD32((void *)(ISP_ADDR + 0xB4C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xB50, ISP_RD32((void *)(ISP_ADDR + 0xB50)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xB54, ISP_RD32((void *)(ISP_ADDR + 0xB54)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xB58, ISP_RD32((void *)(ISP_ADDR + 0xB58)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xB5C, ISP_RD32((void *)(ISP_ADDR + 0xB5C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xB60, ISP_RD32((void *)(ISP_ADDR + 0xB60)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xBA0, ISP_RD32((void *)(ISP_ADDR + 0xBA0)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xBA4, ISP_RD32((void *)(ISP_ADDR + 0xBA4)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xBA8, ISP_RD32((void *)(ISP_ADDR + 0xBA8)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xBAC, ISP_RD32((void *)(ISP_ADDR + 0xBAC)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xBB0, ISP_RD32((void *)(ISP_ADDR + 0xBB0)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xBB4, ISP_RD32((void *)(ISP_ADDR + 0xBB4)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xBB8, ISP_RD32((void *)(ISP_ADDR + 0xBB8)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xBBC, ISP_RD32((void *)(ISP_ADDR + 0xBBC)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xBC0, ISP_RD32((void *)(ISP_ADDR + 0xBC0)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xC20, ISP_RD32((void *)(ISP_ADDR + 0xC20)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xCC0, ISP_RD32((void *)(ISP_ADDR + 0xCC0)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xCE4, ISP_RD32((void *)(ISP_ADDR + 0xCE4)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xCE8, ISP_RD32((void *)(ISP_ADDR + 0xCE8)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xCEC, ISP_RD32((void *)(ISP_ADDR + 0xCEC)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xCF0, ISP_RD32((void *)(ISP_ADDR + 0xCF0)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xCF4, ISP_RD32((void *)(ISP_ADDR + 0xCF4)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xCF8, ISP_RD32((void *)(ISP_ADDR + 0xCF8)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xCFC, ISP_RD32((void *)(ISP_ADDR + 0xCFC)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xD24, ISP_RD32((void *)(ISP_ADDR + 0xD24)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xD28, ISP_RD32((void *)(ISP_ADDR + 0xD28)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xD2C, ISP_RD32((void *)(ISP_ADDR + 0xD2c)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xD40, ISP_RD32((void *)(ISP_ADDR + 0xD40)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xD64, ISP_RD32((void *)(ISP_ADDR + 0xD64)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xD68, ISP_RD32((void *)(ISP_ADDR + 0xD68)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xD6C, ISP_RD32((void *)(ISP_ADDR + 0xD6c)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xD70, ISP_RD32((void *)(ISP_ADDR + 0xD70)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xD74, ISP_RD32((void *)(ISP_ADDR + 0xD74)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xD78, ISP_RD32((void *)(ISP_ADDR + 0xD78)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xD7C, ISP_RD32((void *)(ISP_ADDR + 0xD7C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xDA4, ISP_RD32((void *)(ISP_ADDR + 0xDA4)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xDA8, ISP_RD32((void *)(ISP_ADDR + 0xDA8)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0xDAC, ISP_RD32((void *)(ISP_ADDR + 0xDAC)));
#if 0
	ISP_WR32((void *)(ISP_ADDR + 0x4618), 0x0000FFFF);
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4010, ISP_RD32((void *)(ISP_ADDR + 0x4010)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4014, ISP_RD32((void *)(ISP_ADDR + 0x4014)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4018, ISP_RD32((void *)(ISP_ADDR + 0x4018)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x401C, ISP_RD32((void *)(ISP_ADDR + 0x401C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4020, ISP_RD32((void *)(ISP_ADDR + 0x4020)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4024, ISP_RD32((void *)(ISP_ADDR + 0x4024)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4028, ISP_RD32((void *)(ISP_ADDR + 0x4028)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x402C, ISP_RD32((void *)(ISP_ADDR + 0x402C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4100, ISP_RD32((void *)(ISP_ADDR + 0x4100)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4104, ISP_RD32((void *)(ISP_ADDR + 0x4104)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4108, ISP_RD32((void *)(ISP_ADDR + 0x4108)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x410C, ISP_RD32((void *)(ISP_ADDR + 0x410C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4120, ISP_RD32((void *)(ISP_ADDR + 0x4120)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x412C, ISP_RD32((void *)(ISP_ADDR + 0x412C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x420C, ISP_RD32((void *)(ISP_ADDR + 0x420C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4234, ISP_RD32((void *)(ISP_ADDR + 0x4234)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4240, ISP_RD32((void *)(ISP_ADDR + 0x4240)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4300, ISP_RD32((void *)(ISP_ADDR + 0x4300)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4304, ISP_RD32((void *)(ISP_ADDR + 0x4304)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4600, ISP_RD32((void *)(ISP_ADDR + 0x4600)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4604, ISP_RD32((void *)(ISP_ADDR + 0x4604)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4608, ISP_RD32((void *)(ISP_ADDR + 0x4608)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x460C, ISP_RD32((void *)(ISP_ADDR + 0x460C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4610, ISP_RD32((void *)(ISP_ADDR + 0x4610)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4614, ISP_RD32((void *)(ISP_ADDR + 0x4614)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4618, ISP_RD32((void *)(ISP_ADDR + 0x4618)));
	ISP_WR32((void *)(ISP_ADDR + 0x461C), 0x10);
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x461C, ISP_RD32((void *)(ISP_ADDR + 0x461C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4620, ISP_RD32((void *)(ISP_ADDR + 0x4620)));
	...
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4618, ISP_RD32((void *)(ISP_ADDR + 0x4618)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4624, ISP_RD32((void *)(ISP_ADDR + 0x4624)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4628, ISP_RD32((void *)(ISP_ADDR + 0x4628)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x462C, ISP_RD32((void *)(ISP_ADDR + 0x462C)));
	LOG_PR_ERR("0x%08X %08X", ISP_TPIPE_ADDR + 0x4630, ISP_RD32((void *)(ISP_ADDR + 0x4630)));
#endif
	...
	for (i = 0x44; i <= 0x48; i += 4)
		LOG_PR_ERR("0x%08X %08X ", (unsigned int)(ISP_TPIPE_ADDR + i), ISP_RD32(ISP_ADDR + i));
	...
	LOG_PR_ERR("0x%08X %08X ", (unsigned int)(ISP_ADDR_CAMINF), ISP_RD32((void *)ISP_ADDR_CAMINF));
	...
	LOG_PR_ERR("0x%08X %08X ", ISP_ADDR + 0x160, ISP_RD32(ISP_ADDR + 0x160));
	LOG_PR_ERR("0x%08X %08X ", ISP_ADDR + 0x164, ISP_RD32(ISP_ADDR + 0x164));
...
static inline void Prepare_Enable_ccf_clock(void)
{
	...
	LOG_PR_WRN("[Houston]Clock driver is not ready, bypass Clock");
	return;
#endif
	...
	if (ret < 0)
		LOG_PR_ERR("cannot pm_runtime_get_sync(DISP)\n");

	ret = pm_runtime_get_sync(g_pmdev_isp);
	if (ret < 0)
		LOG_PR_ERR("cannot pm_runtime_get_sync(ISP)\n");
...
#ifdef CONFIG_MTK_IOMMU
	if (!g_dev_smilarb) {
		LOG_PR_ERR("camera smi larb device is null, can't turn on power\n");
		return;
	}
	ret = pm_runtime_get_sync(g_dev_smilarb);	/* 8167 change to controlled by iommu */
	if (ret < 0)
		LOG_PR_ERR("pm_runtime_get_sync(g_dev_smilarb) fail, ret = %d\n", ret);
#else
	ret = mtk_smi_larb_clock_on(1, true);	/* 8167 clock system is from ranier, change to LARB1 */
	if (ret != 0)
		LOG_PR_ERR("mtk_smi_larb_clock_on(Larb1, true) fail, ret = %d\n", ret);
#endif
	...
	for (i = 0; i < ARRAY_SIZE(ispclk); i++) {
		...
		if (ret)
			LOG_PR_ERR("cannot prepare_enable %s clock\n", ispclk[i].clkname);
	}
}
...
#ifdef CONFIG_MTK_IOMMU
	if (!g_dev_smilarb) {
		LOG_PR_ERR("camera smi larb device is null, can't turn off power\n");
		return;
	}
	pm_runtime_put_sync(g_dev_smilarb);	/* 8167 change to controlled by iommu */
#else
...
static MVOID ISP_EnableClock(MBOOL En, MUINT32 LogLevel)
{
	...
	if (En) {		/* enable clock. */
		...
		/*
		  ...
		  * LOG_PR_ERR("MTCMOS: DISP-Bit3(%d), ISP-Bit5(%d) is not opened !!",
...
static MINT32 ISP_ReadReg(ISP_REG_IO_STRUCT *pRegIo)
{
	...
	for (i = 0; i < pRegIo->Count; i++) {
		...
		if ((ISP_ADDR_CAMINF + reg.Addr >= ISP_ADDR)
			...
			LOG_PR_ERR("Wrong address(0x%x)", (unsigned int)(ISP_ADDR_CAMINF + reg.Addr));
			reg.Val = 0;
		}
		...
		if (ref_cnt_ctrl.id < ISP_REF_CNT_ID_MAX) {
			...
			if (copy_to_user
			    ((void __user *)ref_cnt_ctrl.data_ptr, &imem_ref_cnt,
			     sizeof(MINT32)) != 0) {
				LOG_PR_ERR("[GET]:copy_to_user failed");
				Ret = -EFAULT;
			}
		} else {
			LOG_PR_ERR("id(%d) exceed", ref_cnt_ctrl.id);
			Ret = -EFAULT;
		}
	} else {
		LOG_PR_ERR("copy_from_user failed");
...
static MINT32 ISP_RTBC_ENQUE(MINT32 dma)
{
	...
	if (g_pstRTBuf->ring_buf[rt_dma].total_count == ISP_RT_BUF_SIZE) {
		LOG_PR_ERR("[rtbc][ENQUE]:real time buffer number FULL:rt_dma(%d)", rt_dma);
		Ret = -EFAULT;
	}
	...
	if (buffer_exist) {
		...
		if (g_pstRTBuf->ring_buf[rt_dma].total_count == ISP_RT_BUF_SIZE) {
			LOG_PR_ERR("[rtbc][ENQUE]:buffer full(%d)",
...
static long ISP_Buf_CTRL_FUNC(unsigned long Param)
{
	...
	if (g_pstRTBuf == NULL) {
		LOG_PR_ERR("[rtbc]NULL g_pstRTBuf");
		return -EFAULT;
	}
		...
		case ISP_RT_BUF_CTRL_EXCHANGE_ENQUE:
			if (copy_from_user
				...
				if ((reg_val & 0x01) || (reg_val2 & 0x01)) {
					...
					if (Timeout == 0) {
						LOG_PR_ERR("[rtbc][ENQUE]:timeout(%d)", g_EnqBuf);
						Ret = -EFAULT;
					}
...
label_tstamp_zero:
				...
				if (Timeout == 0) {
					LOG_PR_ERR("[rtbc][DEQUE]:timeout(%d)", g_DeqBuf);
					LOG_PR_ERR("ISP_IRQ_TYPE_INT:IrqStatus(0x%08X)",
		...
		case ISP_RT_BUF_CTRL_MAX:	/* Add this to remove build warning */
			break;	/* Do nothing */
		default:
			LOG_PR_ERR("[rtbc] error ctrl(%d)", rt_buf_ctrl.ctrl);
			break;
		}
	} else {
...
static MINT32 ISP_SOF_Buf_Get(unsigned long long sec, unsigned long usec)
{
	...
	if (g_pstRTBuf->dropCnt == 0) {
		...
		if (g_pstRTBuf->ring_buf[_imgo_].total_count > ISP_RT_CQ0C_BUF_SIZE) {
			LOG_PR_ERR("[rtbc]buf cnt(%d)", g_pstRTBuf->ring_buf[_imgo_].total_count);
	...
	for (i = 0; i <= 1; i++) {
		...
		while (1) {
			...
			if (loopCount > g_pstRTBuf->ring_buf[i_dma].total_count) {
				LOG_PR_ERR("Can't find empty dma(%d) buf in total_count(%d)", i_dma,
					g_pstRTBuf->ring_buf[i_dma].total_count);
				break;
			}
		}
...
static MINT32 ISP_WaitIrq(ISP_WAIT_IRQ_STRUCT WaitIrq)
{
	...
	while (1) {
		...
		for (i = 0; i < ISP_IRQ_TYPE_AMOUNT; i++) {
			if (g_IspInfo.IrqInfo.ErrMask[i] & IrqStatus[i]) {
				/* LOG_PR_ERR("Error IRQ, Type(%d), Status(0x%08X)",
	...
	if (Timeout == 0) {
		...
		LOG_PR_ERR("start(%u.%06u),end(%u.%06u)", startTimeS, startTimeUS, endTimeS,
			endTimeUS);
		LOG_PR_ERR("Clear(%d),Type(%d),IrqStatus(0x%08X),WaitStatus(0x%08X),Timeout(%d)",
			WaitIrq.Clear, WaitIrq.Type, g_IspInfo.IrqInfo.Status[WaitIrq.Type],
	...
	if (WaitIrq.Status == ISP_IRQ_INT_STATUS_PASS2_DON_ST ||
		...
		if (ISP_RD32((void *)(CAMINF_BASE + 0x4160)) != ISP_REG_ADDR_CTL_DBG_SET_CQ_STS) {
			LOG_PR_WRN("0x4160 != 0x6000 !!!(0x%8x)",
...
static __tcmfunc irqreturn_t ISP_Irq(MINT32 Irq, MVOID *DeviceId)
{
	...
	if (!CAM_HAL_VER_IS3) {
		 ...
		 *
		 *  #if defined(_debug_dma_err_)
		 *  LOG_PR_ERR("[rtbc]StatusX(0x%08X), DMA_ERR",IrqStatus[ISP_IRQ_TYPE_INTX]);
		 *
		 *  //allan
		 *  DMAErrHandler();
		 *
		...
		/* LOG_PR_ERR("[rtbc]Status(0x%08X), TG_ERR",IrqStatus[ISP_IRQ_TYPE_INT]); */
		/* } */
		/*  */
		/* if (IrqStatus_fbc_int) { */
		/* LOG_PR_ERR("[rtbc]dropframe st(0x%08X),co(0x%08X),c2o(0x%08X)",IrqStatus_fbc_int, */
		/* ISP_RD32(ISP_REG_ADDR_IMGO_FBC),ISP_RD32(ISP_REG_ADDR_IMG2O_FBC)); */
		/* } */
...
static long ISP_ioctl(struct file *pFile, MUINT32 Cmd, unsigned long Param)
{
	...
	if (pFile->private_data == NULL) {
		LOG_PR_WRN("private_data is NULL,(process, pid, tgid)=(%s, %d, %d)", current->comm,
	...
	case ISP_WAIT_IRQ:
		{
			if (copy_from_user
				...
				if ((WaitIrq.Type >= ISP_IRQ_TYPE_AMOUNT) || (WaitIrq.Type < 0)) {
					Ret = -EFAULT;
					LOG_PR_ERR("invalid type(%d)", WaitIrq.Type);
					goto EXIT;
				}
				Ret = ISP_WaitIrq(WaitIrq);
			} else {
				LOG_PR_ERR("copy_from_user 1  failed");
				Ret = -EFAULT;
			}
			break;
		}
	...
	case ISP_SENSOR_FREQ_CTRL:
		{
			...
			if (copy_from_user(&senFreq, (void __user *)Param, sizeof(MUINT32)) == 0) {
				...
				LOG_PR_ERR("senFreq copy_from_user failed");
				Ret = -EFAULT;
			}
#endif
			break;
	...
	case ISP_WAIT_IRQ_FRMB:
		if (copy_from_user
			...
			if ((Irq_FrmB.UserInfo.Type >= ISP_IRQ_TYPE_AMOUNT_FRMB)
				...
				LOG_PR_ERR("invalid type(%d), max(%d)", Irq_FrmB.UserInfo.Type,
			...
			LOG_PR_ERR("copy_from_user 3 failed");
			Ret = -EFAULT;
		}
		break;
	...
	case ISP_MARK_IRQ_REQUEST:
		if (copy_from_user
			...
			if ((Irq_FrmB.UserInfo.UserKey >= IRQ_USER_NUM_MAX)
				...
				LOG_PR_ERR("invalid userKey(%d), max(%d)", Irq_FrmB.UserInfo.UserKey,
					IRQ_USER_NUM_MAX);
				Ret = -EFAULT;
				break;
			}
	...
	case ISP_DUMP_ISR_LOG_FRMB:
		if (copy_from_user(DebugFlag, (void __user *)Param, sizeof(MUINT32)) == 0) {
			...
			IRQ_LOG_PRINTER(DebugFlag[0], currentPPB, _LOG_PR_ERR);
	...
	default:
		{
			LOG_PR_ERR("Unknown Cmd(x%x)", Cmd);
			Ret = -EPERM;
			break;
		}
	}
...
static MINT32 mmap_kmem(struct file *filp, struct vm_area_struct *vma)
{
	...
	if (length > ISP_RTBUF_REG_RANGE) {
		LOG_PR_ERR("mmap range error! : length(0x%x),ISP_RTBUF_REG_RANGE(0x%x)!",
...
static MINT32 ISP_mmap(struct file *pFile, struct vm_area_struct *pVma)
{
	...
	case IMGSYS_BASE_ADDR:	/* imgsys */
		if (length > ISP_REG_RANGE) {
			LOG_PR_ERR("mmap range error : length(0x%x),ISP_REG_RANGE(0x%x)!",
	...
	case SENINF_BASE_ADDR:
		if (length > SENINF_REG_RANGE) {
			LOG_PR_ERR("mmap range error : length(0x%x),SENINF_REG_RANGE(0x%x)!",
	...
	case PLL_BASE_ADDR:
		if (length > PLL_RANGE) {
			LOG_PR_ERR("mmap range error : length(0x%x),PLL_RANGE(0x%x)!",
	...
	case GPIO_BASE_ADDR:
		if (length > GPIO_RANGE) {
			LOG_PR_ERR("mmap range error : length(0x%x),GPIO_RANGE(0x%x)!",
	...
	case EFUSE_BASE_ADDR:
		if (length > EFUSE_RANGE) {
			LOG_PR_ERR("mmap range error : length(0x%x),EFUSE_RANGE(0x%x)!",
...
static MINT32 ISP_probe(struct platform_device *pDev)
{
	...
	if (!larb_node)
		LOG_PR_ERR("can not find \"mediatek,smilarb\" in ispsys\n");
	else {
		plat_dev = of_find_device_by_node(larb_node);
		if (WARN_ON(!plat_dev))
			LOG_PR_ERR("g_dev_smilarb NULL");
		else {
...
/* [Houston] --- */
	...
	for (i = 0; i < ARRAY_SIZE(ispclk); i++) {
		...
		if (IS_ERR(ispclk[i].clock)) {
			LOG_PR_ERR("cannot get %s clock, return errno(%ld, EPROBE_DEFER(-517))\n",
...
/* if (request_irq(CAMERA_ISP_IRQ0_ID, (irq_handler_t)ISP_Irq, IRQF_TRIGGER_HIGH, "isp", NULL)) */
	{
		LOG_PR_ERR("MT_CAM_IRQ_LINE IRQ LINE NOT AVAILABLE!!");
		goto EXIT;
	}
...
static ssize_t ISP_RegDebug(struct file *pFile, const char *pBuffer, size_t Count, loff_t *pData)
{
	...
	if (copy_from_user(RegBuf, pBuffer, CopyBufSize)) {
		LOG_PR_ERR("copy_from_user() fail.");
		return -EFAULT;
	}
	...
	if (sscanf(RegBuf, "debugmask=%x", &Addr) == 1) {
		...
		if ((Addr >= 0) && (Addr <= 0xFFFF)) {
			...
			LOG_PR_ERR("invalid isp debug mask:%x", Addr);
		}
		...
		if ((ISP_ADDR_CAMINF + Addr >= ISP_ADDR) &&
			...
			LOG_PR_ERR("Wrong address out of range (0x%x)",
...
static MINT32 __init ISP_Init(MVOID)
{
	...
	proc_create("driver/isp_reg", 0444, NULL, &g_isp_reg_fops);
	proc_create("driver/camio_reg", 0444, NULL, &g_camio_reg_fops);
#else
	...
	if (pEntry) {
		...
		LOG_PR_ERR("add /proc/driver/isp_reg entry fail");
	}
	...
	if (pEntry) {
		...
		LOG_PR_ERR("add /proc/driver/camio_reg entry fail");
	}
#endif
...
static int disp_pm_probe(struct platform_device *pdev)
{
	...
	if (g_pmdev_disp->pm_domain == NULL)
		LOG_PR_ERR("g_pmdev_disp->pm_domain is NULL");
