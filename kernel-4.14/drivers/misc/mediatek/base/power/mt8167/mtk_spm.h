...
#define SPM_WAKE_SRC_LIST                                                      \
	{                                                                      \
		...
		, /* PCM timer, TWAM or CPU */                                 \
			SPM_WAKE_SRC(1, AUDIO_REQ), /* new */                  \
			SPM_WAKE_SRC(2, KP), SPM_WAKE_SRC(3, WDT),             \
			SPM_WAKE_SRC(4, GPT), SPM_WAKE_SRC(5, EINT),           \
			SPM_WAKE_SRC(6, CONN_WDT), SPM_WAKE_SRC(7, GCE),       \
			SPM_WAKE_SRC(9, LOW_BAT), SPM_WAKE_SRC(10, CONN2AP),   \
			SPM_WAKE_SRC(11, F26M_WAKE),                           \
			SPM_WAKE_SRC(12, F26M_SLEEP),                          \
			SPM_WAKE_SRC(13, PCM_WDT), SPM_WAKE_SRC(14, USB_CD),   \
			SPM_WAKE_SRC(15, USB_PDN), SPM_WAKE_SRC(16, ETH),      \
			SPM_WAKE_SRC(18, DBGSYS), SPM_WAKE_SRC(19, UART0),     \
			SPM_WAKE_SRC(20, AFE), SPM_WAKE_SRC(21, THERM),        \
			SPM_WAKE_SRC(22, CIRQ), SPM_WAKE_SRC(23, SEJ),         \
			SPM_WAKE_SRC(24, SYSPWREQ), SPM_WAKE_SRC(25, IRRX),    \
...
extern void
unmask_irq(struct irq_desc *desc); /* to replace mt_irq_unmask_for_sleep */
