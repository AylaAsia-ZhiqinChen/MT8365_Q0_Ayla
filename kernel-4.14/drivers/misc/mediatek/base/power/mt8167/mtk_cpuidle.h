...
#define DORMANT_ALL_OFF                                                        \
	(DORMANT_OUTER_OFF | DORMANT_INNER_OFF | DORMANT_CPUSYS_OFF |          \
	 DORMANT_LOUIS_OFF | DORMANT_GIC_OFF | DORMANT_SNOOP_OFF)
#define DORMANT_MODE_MASK (0x0ffff00)

#define CPU_SHUTDOWN_MODE (DORMANT_ALL_OFF)

#define CPU_MCDI_MODE (DORMANT_LOUIS_OFF)
#define CPU_SODI_MODE                                                          \
	(DORMANT_LOUIS_OFF | DORMANT_CPUSYS_OFF | DORMANT_GIC_OFF |            \
	 DORMANT_SNOOP_OFF)

#define CPU_DEEPIDLE_MODE                                                      \
	(DORMANT_LOUIS_OFF | DORMANT_CPUSYS_OFF | DORMANT_GIC_OFF |            \
	 DORMANT_SNOOP_OFF)
...
#define IS_DORMANT_BREAK_CHECK(a)                                              \
	(((a)&DORMANT_BREAK_CHECK) == DORMANT_BREAK_CHECK)
...
#define IS_DORMANT_CPUSYS_OFF(a)                                               \
	(((a)&DORMANT_CPUSYS_OFF) == DORMANT_CPUSYS_OFF)
#define IS_DORMANT_GIC_OFF(a) (((a)&DORMANT_GIC_OFF) == DORMANT_GIC_OFF)
#define IS_DORMANT_CCI400_CLOCK_SW(a)                                          \
	(((a)&DORMANT_CCI400_CLOCK_SW) == DORMANT_CCI400_CLOCK_SW)
 ...
 * MT_CPU_DORMANT_BREAK:  cpu dormant flow broken before by validating a SPM
 *interrupt.
