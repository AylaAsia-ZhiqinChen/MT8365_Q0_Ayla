...
/* mt8167 apmixedsys, bit#24 is FHCTL clock */
#define REG_AP_PLL_CON0     REG_APMIX_ADDR(0x0000)
...
/* /< FHCTL unsupport, VCODECPLL_CON0 is useless */
#define REG_LVDSPLL_CON0    REG_APMIX_ADDR(0x01E0)

/*CON1, DDS value */
#define REG_ARMCA7PLL_CON1  REG_APMIX_ADDR(0x0104)
#define REG_MAINPLL_CON1    REG_APMIX_ADDR(0x0124)
/* /< Bit[30:10] DDS,  Bit[31] Update DDS */
...
/* /< FHCTL unsupport, VCODECPLL_CON0 is useless */
#define REG_LVDSPLL_CON1    REG_APMIX_ADDR(0x01E4)
/* **************************************************** */
