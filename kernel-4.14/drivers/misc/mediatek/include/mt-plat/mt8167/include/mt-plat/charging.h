...
/* structure */
/* ============================================================ */
typedef signed int (*CHARGING_CONTROL)(enum CHARGING_CTRL_CMD cmd, void *data);
...
extern enum kal_bool chargin_hw_init_done;
extern unsigned int g_bcct_flag;

/* ============================================================ */
/* External function */
/* ============================================================ */
extern signed int chr_control_interface(enum CHARGING_CTRL_CMD, void *data);
...
extern enum kal_bool pmic_chrdet_status(void);
#else
enum kal_bool __attribute__((weak)) pmic_chrdet_status(void);
#endif
...
extern int mtk_chr_enable_discharge(enum kal_bool enable);
extern int mtk_chr_enable_hv_charging(enum kal_bool en);
extern enum kal_bool mtk_chr_is_hv_charging_enable(void);
extern int mtk_chr_enable_kpoc_shutdown(enum kal_bool en);
extern enum kal_bool mtk_chr_is_kpoc_shutdown_enable(void);
