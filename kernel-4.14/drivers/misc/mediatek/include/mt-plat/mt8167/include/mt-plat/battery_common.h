 ...
 ****************************************************************************/
enum batt_temp_state_enum { TEMP_POS_LOW = 0, TEMP_POS_NORMAL, TEMP_POS_HIGH };
...
struct pmu_chargerstruct {
	enum kal_bool bat_exist;
	enum kal_bool bat_full;
	signed int bat_charging_state;
	unsigned int bat_vol;
	enum kal_bool bat_in_recharging_state;
	unsigned int Vsense;
	enum kal_bool charger_exist;
...
extern enum kal_bool g_ftm_battery_flag;
extern int charging_level_data[1];
extern unsigned int g_call_state;
extern enum kal_bool g_charging_full_reset_bat_meter;
#if defined(CONFIG_MTK_PUMP_EXPRESS_SUPPORT)
extern enum kal_bool ta_check_chr_type;
extern enum kal_bool ta_cable_out_occur;
extern enum kal_bool is_ta_connect;
extern struct wake_lock TA_charger_suspend_lock;
#endif
extern enum kal_bool gDisableGM;
...
extern enum kal_bool bat_is_charger_exist(void);
extern enum kal_bool bat_is_charging_full(void);
...
extern int usb_charger_type_detect(void);
extern enum kal_bool mt_get_usb11_port_status(void);
#endif

#if (CONFIG_MTK_GAUGE_VERSION == 20)
extern struct timespec mt_battery_get_duration_time_act(int duration_type);
#endif
...
extern enum kal_bool bat_is_ext_power(void);
#endif
