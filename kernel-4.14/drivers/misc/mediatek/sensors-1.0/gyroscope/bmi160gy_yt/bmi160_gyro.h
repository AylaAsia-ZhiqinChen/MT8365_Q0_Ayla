/* BOSCH BMI160 GYROSCOPE Sensor Driver Header File
...
#define BMI160_FS_2000_LSB_X              158
#define BMI160_FS_2000_LSB_Y              170
#endif
/*
...
#define GYRO_PR_ERR(fmt, args...)    printk(KERN_ERR GYRO_TAG"%s %d : "fmt, __func__, __LINE__, ##args)
#define GYRO_LOG(fmt, args...)    printk(KERN_INFO GYRO_TAG fmt, ##args)
#define GYRO_INFO(fmt, args...)    printk(KERN_INFO GYRO_TAG fmt, ##args)
