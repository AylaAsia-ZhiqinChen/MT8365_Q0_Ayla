...
#define REG_FH_PLL7_CON0    REG_APMIX_ADDR(0x0374) /* LVDSPLL */
#define REG_FH_PLL8_CON0    REG_APMIX_ADDR(0x0390) /* DSPPLL */
#define REG_FH_PLL9_CON0    REG_APMIX_ADDR(0x03A0) /* APUPLL */
...
#define REG_FH_PLL7_CON1    REG_APMIX_ADDR(0x0378) /* LVDSPLL */
#define REG_FH_PLL8_CON1    REG_APMIX_ADDR(0x0394) /* DSPPLL */
#define REG_FH_PLL9_CON1    REG_APMIX_ADDR(0x03A4) /* APUPLL */
