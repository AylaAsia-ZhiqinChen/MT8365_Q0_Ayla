...
/* Notice: reference Table 11 ~ 14 of
 *"EDID Recommended Practive for EIA/CEA-861"
 */
...
struct HDMI_SINK_AV_CAP_T {
	...
	/* n: channel number index, value: each bit means sampling rate
	 *for this channel number (SINK_AUDIO_32k..)
	 */
	unsigned char ui1_sink_pcm_ch_sampling[7];
	/* n: channel number index, value:
	 *each bit means bit size for this channel number
	 */
