 ...
 * Display driver would fill the FB and output to panel directly
...
#define VIDEO_LAYER_COUNT \
	(HW_OVERLAY_COUNT - RESERVED_LAYER_COUNT)
 ...
 */
/* #define DISP_SESSION_TIMELINE_COUNT \
 *	(DISP_SESSION_PRESENT_TIMELINE_ID+1)
 */
 ...
 * Dynamice turn on/off WDMA path clock.
 * This feature is necessary in MultiPass for SODI.
 */
