...
/* --> */
	...
	struct DPI_REGS {
		...
		struct DPI_REG_TGEN_VWIDTH_LODD TGEN_VWIDTH_LODD;
		/* 0028 */
		struct DPI_REG_TGEN_VPORCH_LODD TGEN_VPORCH_LODD;
		/* 002C */
		...
		uint32_t DUMMY;	/* 0050 */
		uint32_t rsv_54[5];
		struct DPI_REG_TGEN_VWIDTH_LEVEN TGEN_VWIDTH_LEVEN;
		/* 0068 */
		struct DPI_REG_TGEN_VPORCH_LEVEN TGEN_VPORCH_LEVEN;
		/* 006C */
		struct DPI_REG_TGEN_VWIDTH_RODD TGEN_VWIDTH_RODD;
		/* 0070 */
		struct DPI_REG_TGEN_VPORCH_RODD TGEN_VPORCH_RODD;
		/* 0074 */
		struct DPI_REG_TGEN_VWIDTH_REVEN TGEN_VWIDTH_REVEN;
		/* 0078 */
		struct DPI_REG_TGEN_VPORCH_REVEN TGEN_VPORCH_REVEN;
		/* 007C */
		...
		struct DPI_REG_MATRIX_IN_OFFSET_0 MATRIX_IN_OFFSET_0;
		/* 00cc*/
		struct DPI_REG_MATRIX_IN_OFFSET_2 MATRIX_IN_OFFSET_2;
		/* 00d0*/
		struct DPI_REG_MATRIX_OUT_OFFSET_0 MATRIX_OUT_OFFSET_0;
		/* 00d4*/
		struct DPI_REG_MATRIX_OUT_OFFSET_2 MATRIX_OUT_OFFSET_2;
		/* 00d8*/
		uint32_t rsv_dc;
