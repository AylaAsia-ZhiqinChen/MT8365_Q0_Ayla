...
extern int mtk11_host_qmu_number_pkts;
...
struct musbfsh {
	...
	irqreturn_t (*isr)(int irq, void *__hci);
...
extern void
musbfsh_write_fifo(struct musbfsh_hw_ep *ep, u16 len, const u8 *src);
...
static inline void
musbfsh_platform_set_power(struct musbfsh *musbfsh, int action)
{
...
static inline void
musbfsh_platform_try_idle(struct musbfsh *musbfsh, unsigned long timeout)
{
