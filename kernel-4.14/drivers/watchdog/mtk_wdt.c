...
#elif defined(CONFIG_MTK_RTC) || defined(CONFIG_MT6358_MISC)
		rtc_mark_recovery();
#endif
...
#if (defined(CONFIG_MTK_RTC) || defined(CONFIG_MT6358_MISC)) && \
		defined(CONFIG_MTK_KERNEL_POWER_OFF_CHARGING)
		rtc_mark_kpoc();
#endif
