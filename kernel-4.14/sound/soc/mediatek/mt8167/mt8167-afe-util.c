...
int mt8167_afe_disable_top_cg(struct mtk_afe *afe,
...
int mt8167_afe_enable_apll_associated_cfg(struct mtk_afe *afe,
	unsigned int apll)
{
	if (apll == MT8167_AFE_APLL1) {
...
int mt8167_afe_disable_apll_associated_cfg(struct mtk_afe *afe,
	unsigned int apll)
{
	if (apll == MT8167_AFE_APLL1) {
#ifdef ENABLE_AFE_APLL_TUNER
