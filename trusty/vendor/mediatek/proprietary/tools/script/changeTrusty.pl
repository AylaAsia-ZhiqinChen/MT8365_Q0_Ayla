...
sub usage{
  warn << "__END_OF_USAGE";
Usage: perl changeTrusty.pl --config=ConfigFile --project=Project --kernel=Kernel_Version
...
Turn on trusty config options
  perl changeTrusty.pl --config=trustyArmv8_on.xml --project=k53v1_64 --kernel=kernel-3.18
  perl changeTrusty.pl --config=trustyArmv7_on.xml --project=k80hd --kernel=kernel-3.18

Turn off trusty config options
  perl changeTrusty.pl --config=trustyArmv8_off.xml --project=k53v1_64 --kernel=kernel-3.18
  perl changeTrusty.pl --config=trustyArmv7_off.xml --project=k80hd --kernel=kernel-3.18
