...
public class WifiP2pManager {
	...
	*/
    ...
    public static final int RESPONSE_DEVICE_INFO                    = BASE + 98;
	 ...
	 ///M:@{
	/** @hide */
	public static final int REQUEST_LINK_INFO						= BASE + 201;
	/** @hide */
	public static final int RESPONSE_LINK_INFO						= BASE + 202;
	
	/** @hide */
	public static final int SET_AUTO_CHANNEL_SELECT 				= BASE + 203;
	/** @hide */
	public static final int SET_AUTO_CHANNEL_SELECT_FAILED			= BASE + 204;
	/** @hide */
	public static final int SET_AUTO_CHANNEL_SELECT_SUCCEEDED		= BASE + 205;
	
	/** @hide */
	public static final int PEER_CONNECTION_USER_ACCEPT_FROM_OUTER	= BASE + 206;
	/** @hide */
	public static final int PEER_CONNECTION_USER_REJECT_FROM_OUTER	= BASE + 207;
	
	/** @hide */
	public static final int FREQ_CONFLICT_EX_RESULT 				= BASE + 208;
	
	/** @hide */
	public static final int REMOVE_CLIENT							= BASE + 209;
	/** @hide */
	public static final int REMOVE_CLIENT_FAILED					= BASE + 210;
	/** @hide */
	public static final int REMOVE_CLIENT_SUCCEEDED 				= BASE + 211;
	
	/** @hide */
	public static final int ADD_PERSISTENT_GROUP				 = BASE + 212;
	/** @hide */
	public static final int ADD_PERSISTENT_GROUP_FAILED 		 = BASE + 213;
	/** @hide */
	public static final int ADD_PERSISTENT_GROUP_SUCCEEDED	   = BASE + 214;
	/** @hide */
	public static final int RESPONSE_ADD_PERSISTENT_GROUP		= BASE + 215;
