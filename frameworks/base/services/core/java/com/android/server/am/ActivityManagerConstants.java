...
import static com.mediatek.server.am.AmsExt.DEFAULT_MAX_CACHED_PROCESSES_EX;
...
final class ActivityManagerConstants extends ContentObserver {
    ...
    private static final int DEFAULT_MAX_CACHED_PROCESSES = DEFAULT_MAX_CACHED_PROCESSES_EX;
