...
public final class DefaultPermissionGrantPolicy {
    ...
    private void grantDefaultSystemHandlerPermissions(int userId) {
        ...
        //yuntian longyao add
        //Description:内置的应用默认打开申请的权限
        String installPkg = "com.mydrawn.ARDF";
        grantSystemFixedPermissionsToSystemPackage(installPkg, userId,
            PHONE_PERMISSIONS, ALWAYS_LOCATION_PERMISSIONS, STORAGE_PERMISSIONS,
            CAMERA_PERMISSIONS, MICROPHONE_PERMISSIONS);
        AppOpsManager mAppOpsManager = (AppOpsManager) mContext.getSystemService(Context.APP_OPS_SERVICE);
        PackageInfo pkg = getSystemPackageInfo(installPkg);
        if (null != pkg) {
            ...
            mAppOpsManager.setMode(AppOpsManager.OP_SYSTEM_ALERT_WINDOW,
                    uid, installPkg, AppOpsManager.MODE_ALLOWED);
