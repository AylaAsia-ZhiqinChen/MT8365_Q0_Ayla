...
final class WifiDisplayAdapter extends DisplayAdapter {
    ...
    public boolean getIfSinkEnabledLocked() {
        ...
        if (mDisplayController != null) {
            return mDisplayController.getMtkController().getIfSinkEnabled();
        } else {
            return false;
        }
    ...
    public void requestEnableSinkLocked(final boolean enable) {
        ...
        getHandler().post(new Runnable() {
            ...
            public void run() {
                if (mDisplayController != null) {
                    mDisplayController.getMtkController().requestEnableSink(enable);
                }
            }
        });
    }
        ...
        getHandler().post(new Runnable() {
            ...
            public void run() {
                ...
                if (mSinkConnectRequest && mDisplayController != null) {
                    mDisplayController.getMtkController().requestWaitConnection(surface);
                }
            }
        });
    }
    ...
    public void requestSuspendDisplayLocked(final boolean suspend, final Surface surface) {
        ...
        getHandler().post(new Runnable() {
            ...
            public void run() {
                if (mDisplayController != null) {
                    mDisplayController.getMtkController().requestSuspendDisplay(suspend, surface);
                }
            }
        });
    }
    ...
    public void sendUibcInputEventLocked(String input) {
        ...
        mDisplayController.getMtkController().sendUibcInputEvent(input);
    }
    ///@}
