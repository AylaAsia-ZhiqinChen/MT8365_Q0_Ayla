...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_YT_FC_A = 289;
    public static final int KEYCODE_YT_FC_B = 290;
    public static final int KEYCODE_YT_FC_C = 291;
    public static final int KEYCODE_YT_FC_D = 292;
    public static final int KEYCODE_YT_FC_E = 293;
    public static final int KEYCODE_YT_FC_SOS = 299;
    /**
     * Integer value of the last KEYCODE. Increases as new keycodes are added to KeyEvent.
     * @hide
     */
    @TestApi
    public static final int LAST_KEYCODE = KEYCODE_YT_FC_SOS;
    ...
    public static final boolean isSystemKey(int keyCode) {
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_YT_FC_SOS:
                return true;
        }
