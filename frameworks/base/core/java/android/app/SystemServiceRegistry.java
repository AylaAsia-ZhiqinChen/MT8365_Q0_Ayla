...
public final class SystemServiceRegistry {
    ...
    static {
        ...
        final boolean hasOEMVendorLock =
                !SystemProperties.get(PERSISTENT_OEM_VENDOR_LOCK).equals("");
    ...
    private static Class<?> regMtkService() {
        ...
        try {
            ...
            String mtkSServerPackage = "system/framework/mediatek-framework.jar";
            PathClassLoader mtkSsLoader = new PathClassLoader(mtkSServerPackage,
                SystemServiceRegistry.class.getClassLoader());
        ...
        try {
            if (sMtkServiceRegistryClass != null) {
                Method method = sMtkServiceRegistryClass.getDeclaredMethod(
                    "setMtkSystemServiceName", ArrayMap.class, ArrayMap.class);
