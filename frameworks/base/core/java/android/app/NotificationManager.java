...
public class NotificationManager {
    ...
    public void factoryLedTestSetColor(int color) {
        INotificationManager service = getService();
        try {
            service.factoryLedTestSetColor(color);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }

    public void factoryLedTestTurnOff() {
        INotificationManager service = getService();
        try {
            service.factoryLedTestTurnOff();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }

    public void factoryLedTestSetFlashing(int color, int onMS, int offMS) {
        INotificationManager service = getService();
        try {
            service.factoryLedTestSetFlashing(color, onMS, offMS);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
