...
public class CtaManager {
    ...
    /**
     * set the CTA feature supporting status
     *
     * @param boolean enable ,True as supported , false as not supported
     */
    ...
    /**
     * To check whether the permission group is a CTA defined permission group
     *
     * @param group PermissionGroup
     * @return true indicates it's a CTA defined permission group
     */
    ...
    /**
     * Get the platform permissions of CTA add.
     * @return CTA added platform permissions
     * @hide
     */
     ...
     * to do the operation..parameter, it is used for application directly call.
     * @param context
     * @param keyWordType
     * @param functionName
     * @param actionType
     ...
     */
    @ProductApi
    public void printCtaInfor(Context context, KeywordType keyWordType, String functionName,
     ...
     * CTA required to print the preset application to print information like:
     * Time < application Chinese name >[keyword] [process name]:[function name]
     * to do the operation..parameter, it is used for framework API directly call by APP uid.
     * @param appUid
     * @param keyWordType
     * @param functionName
     * @param actionType
    ...
    /**
     * Enum app CTA keyword information.
     */
    ...
    /**
     * Enum app CTA action information.
     */
