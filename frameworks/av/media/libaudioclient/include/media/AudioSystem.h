...
private:
    ...
    public:
    static status_t startOutputSamplerate(audio_port_handle_t portId, int samplerate);
    static status_t stopOutputSamplerate(audio_port_handle_t portId, int samplerate);
};
