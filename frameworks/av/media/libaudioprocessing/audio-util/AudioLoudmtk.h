...
#ifndef AUDIO_LOUD_MTK_H
#define AUDIO_LOUD_MTK_H
...
/**
 * newMtkAudioCustParamCache()
 *    Using dlopen/dlsym to new MtkAudioCustParamCacheBase object
 */
MtkAudioCustParamCacheBase *newMtkAudioCustParamCache();

/**
* deleteMtkCustParamCache(MtkAudioCustParamCacheBase *pObject)
*    Using dlopen/dlsym to delete MtkAudioCustParamCacheBase object
*/
void deleteMtkCustParamCache(MtkAudioCustParamCacheBase *pObject);

/**
 * MtkAudioLoud_InitParser(void)
 *    Using dlopen/dlsym to MtkAudioLoud::InitParser
 */
