...
#ifndef ANDROID_MTK_AUDIO_RESAMPLER_DYN_H
#define ANDROID_MTK_AUDIO_RESAMPLER_DYN_H
...
class MtkAudioResamplerDyn: public AudioResampler {
public:
    MtkAudioResamplerDyn(int inChannelCount,
            int32_t sampleRate, src_quality quality);

    virtual ~MtkAudioResamplerDyn();

    virtual void init();

    virtual void reset(); //ALPS03916900: SRC leak sound
...
private:
    ...
    typedef size_t (MtkAudioResamplerDyn<TC, TI, TO>::*resample_ABP_t)(TO* out,
...
#endif /*ANDROID_MTK_AUDIO_RESAMPLER_DYN_H*/
