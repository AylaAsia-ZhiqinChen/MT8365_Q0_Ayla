...
public class EthernetNetworkFactory extends NetworkFactory {
    ...
    private final static int NETWORK_SCORE = 110;//70 //yuntian longyao add Ethernet settings默认以太网高于wifi、移动数据 110-40
    ...
    private static class NetworkInterfaceState {
        ...
        static {
            ...
            sTransports.put(NetworkCapabilities.TRANSPORT_ETHERNET,
                    new TransportInfo(ConnectivityManager.TYPE_ETHERNET, NETWORK_SCORE));//70 //yuntian longyao add Ethernet settings默认以太网高于wifi、移动数据 110-40
