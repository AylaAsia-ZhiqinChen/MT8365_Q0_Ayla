...
PRODUCT_NAME := full_aiot8365p1_64_bsp
PRODUCT_DEVICE := aiot8365p1_64_bsp
PRODUCT_MODEL := aiot8365p1_64_bsp
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= aiot8365p1_64_bsp_debug_defconfig
else
KERNEL_DEFCONFIG ?= aiot8365p1_64_bsp_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= aiot8365p1_64_bsp
LK_PROJECT ?= aiot8365p1_64_bsp
TRUSTY_PROJECT ?= aiot8365p1_64_bsp
