...
PRODUCT_NAME := full_m3520_pos
PRODUCT_DEVICE := $(strip $(MTK_BASE_PROJECT))
PRODUCT_MODEL := m3520_pos
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= m3520_pos_debug_defconfig
else
KERNEL_DEFCONFIG ?= m3520_pos_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= m3520_pos
LK_PROJECT ?= m3520_pos
TRUSTY_PROJECT ?= m3520_pos
