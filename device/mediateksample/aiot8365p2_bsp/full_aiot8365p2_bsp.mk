...
PRODUCT_NAME := full_aiot8365p2_bsp
PRODUCT_DEVICE := aiot8365p2_bsp
PRODUCT_MODEL := aiot8365p2_bsp
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps
TARGET_COPY_OUT_ODM := vendor/odm

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= aiot8365p2_bsp_debug_defconfig
else
KERNEL_DEFCONFIG ?= aiot8365p2_bsp_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= aiot8365p2_bsp
LK_PROJECT ?= aiot8365p2_bsp
TRUSTY_PROJECT ?= aiot8365p2_bsp
