...
PRODUCT_NAME := full_aiot8362am3_bsp
PRODUCT_DEVICE := aiot8362am3_bsp
PRODUCT_MODEL := aiot8362am3_bsp
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= aiot8362am3_bsp_debug_defconfig
else
KERNEL_DEFCONFIG ?= aiot8362am3_bsp_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= aiot8362am3_bsp
LK_PROJECT ?= aiot8362am3_bsp
TRUSTY_PROJECT ?= aiot8362am3_bsp

PRODUCT_CHARACTERISTICS := aiv
