...
PRODUCT_NAME := full_m3520b_bnkj
PRODUCT_DEVICE := $(strip $(MTK_BASE_PROJECT))
PRODUCT_MODEL := m3520b_bnkj
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= m3520b_bnkj_debug_defconfig
else
KERNEL_DEFCONFIG ?= m3520b_bnkj_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= m3520b_bnkj
LK_PROJECT ?= m3520b_bnkj
TRUSTY_PROJECT ?= m3520b_bnkj
