...
CUSTOM_HAL_IMGSENSOR =gc2355_raw ov8865_mipi_raw ov5648_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_IMGSENSOR = gc2355_raw
CUSTOM_HAL_MSENSORLIB = mmc3630x
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_IMGSENSOR = ov8865_mipi_raw ov5648_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = gc2355_raw ov8865_mipi_raw ov5648_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = ov8865_mipi_raw ov5648_mipi_raw
...
MTK_AEE_SUPPORT = yes
MTK_AGPS_APP = no
MTK_AIS_AUDIOHAL_PROCESS_SUPPORT = no
MTK_AIS_STHAL_PROCESS_SUPPORT = no
MTK_AIV_SUPPORT = no
...
MTK_BUILD_VERNO = alps-mp-q0.mp3
MTK_BWC_SUPPORT = yes
...
MTK_PRODUCT_LINE = aiot
MTK_PRODUCT_LINE_PLATFORM = MT8365
...
MTK_TDM_RECOGNITION_SUPPORT = yes
MTK_CAM_AUTORAMA_SUPPORT = no
MTK_BUILD_VERNO = m3520b_bnkj_v01
#作者:longyao
#功能:平台APP是否odex化，空间换时间，优化首次开机速度
#使用方法:yes/no,默认no
YUNTIAN_DEXPREOPT_PREBUILTS=yes
