...
WLAN_GEN4M_CHIPS := CONSYS_6765 CONSYS_6761 CONSYS_3967 CONSYS_6779 CONSYS_6768 CONSYS_6785 CONSYS_8168
...
ifeq ($(strip $(MTK_COMBO_CHIP)), MT6632)
    ...
    ifneq ($(strip $(WLAN_CHIP_ID)),)
        ...
        WLAN_CONNAC_SERIES := $(WLAN_6765_SERIES) 3967 6779 6768 6785 8168
