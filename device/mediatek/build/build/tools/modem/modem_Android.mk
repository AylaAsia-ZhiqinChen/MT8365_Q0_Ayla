...
MTK_MODEM_REMOVED_MODULES := $(filter-out $(MTK_MODEM_INSTALLED_MODULES),$(wildcard $(PRODUCT_OUT)/md1dsp.img $(TARGET_OUT_VENDOR)/firmware/modem*.img $(TARGET_OUT_VENDOR)/firmware/dsp_*.bin $(TARGET_OUT_VENDOR)/firmware/catcher_filter_*.bin $(TARGET_OUT_VENDOR)/firmware/em_filter_*.bin $(TARGET_OUT_VENDOR)/firmware/armv7_*.bin $(TARGET_OUT_VENDOR_ETC)/mddb/*))
