...
ifeq ($(strip $(MTK_RC_TO_VENDOR)), yes)
  ...
  PRODUCT_COPY_FILES += device/mediatek/mt8167/ueventd.mt8167.rc:$(TARGET_COPY_OUT_VENDOR)/ueventd.rc
else
  MTK_TARGET_VENDOR_RC = root
  PRODUCT_DEFAULT_PROPERTY_OVERRIDES += ro.vendor.rc=/
  PRODUCT_COPY_FILES += device/mediatek/mt8167/ueventd.mt8167.rc:root/ueventd.mt8167.rc
endif
...
PRODUCT_PACKAGES += audio.primary.mt8167
...
PRODUCT_PACKAGES += audio_policy.mt8167
...
PRODUCT_PACKAGES += audio.usb.mt8167
...
PRODUCT_PACKAGES += thermal.mt8167
...
PRODUCT_PACKAGES += sensors.mt8167
...
PRODUCT_PACKAGES += audio.r_submix.mt8167
PRODUCT_PACKAGES += libaudio.usb.default
...
PRODUCT_PACKAGES += camera.mt8167
...
ifeq ($(strip $(MTK_GPU_SUPPORT)), yes)
  ifeq ($(strip $(LINUX_KERNEL_VERSION)), kernel-4.14)
    PRODUCT_PACKAGES += rgx.fw.22.40.54.30
  else
    PRODUCT_PACKAGES += rgx.fw.signed.22.40.54.30
  endif
  PRODUCT_PACKAGES += libEGL_mtk
  PRODUCT_PACKAGES += libGLESv1_CM_mtk
  PRODUCT_PACKAGES += libGLESv2_mtk
  PRODUCT_PACKAGES += gralloc.mt8167
  ...
  ifeq ($(strip $(MTK_K64_SUPPORT)), yes)
    PRODUCT_PACKAGES += vulkan.mt8167
  ...
  PRODUCT_PACKAGES += memtrack.mt8167
...
PRODUCT_PACKAGES += libmnlp_mt8167
PRODUCT_PACKAGES += gps.mt8167
...
PRODUCT_PACKAGES += hwcomposer.mt8167
...
PRODUCT_PACKAGES += fstab.mt8167
PRODUCT_PACKAGES += fstab.mt8167.ramdisk
...
######################### /dev/dkb  ######################################
########################### 3 - 8167 EMMC ################################
######## /dev/block/platform/mtk-msdc.0/11120000.MSDC0/by-name/kb   ######
######## /dev/block/platform/mtk-msdc.0/11120000.MSDC0/by-name/dkb  ######
    ...
    ifeq ($(strip $(MTK_PLATFORM)), MT6571)
      ...
      ifeq ($(strip $(MTK_PLATFORM)), MT6752)
        PRODUCT_PACKAGES += WIFI_RAM_CODE_6752
          ...
          ifeq ($(strip $(MTK_PLATFORM)), MT8167)
            PRODUCT_PACKAGES += WIFI_RAM_CODE_8167
          else
...
#tablet repeatingburst mode for camera hal isp2.0
PRODUCT_DEFAULT_PROPERTY_OVERRIDES += vendor.mtkcamapp.cshot.version=2
...
ifeq ($(strip $(MTK_EMMC_SUPPORT)), yes)
PRODUCT_COPY_FILES += device/mediatek/mt8167/init.mt8167.rc:$(MTK_TARGET_VENDOR_RC)/init.mt8167.rc
PRODUCT_COPY_FILES += device/mediatek/mt8167/factory_init.rc:$(MTK_TARGET_VENDOR_RC)/factory_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt8167/meta_init.rc:$(MTK_TARGET_VENDOR_RC)/meta_init.rc
else
PRODUCT_COPY_FILES += device/mediatek/mt8167/init.mt8167.nand.rc:$(MTK_TARGET_VENDOR_RC)/init.mt8167.rc
PRODUCT_COPY_FILES += device/mediatek/mt8167/factory_init_nand.rc:$(MTK_TARGET_VENDOR_RC)/factory_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt8167/meta_init_nand.rc:$(MTK_TARGET_VENDOR_RC)/meta_init.rc
endif

PRODUCT_COPY_FILES += device/mediatek/mt8167/init.modem.rc:$(MTK_TARGET_VENDOR_RC)/init.modem.rc
PRODUCT_COPY_FILES += device/mediatek/mt8167/meta_init.modem.rc:$(MTK_TARGET_VENDOR_RC)/meta_init.modem.rc

ifeq ($(strip $(MTK_SENSORS_1_0)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt8167/init.sensor_1_0.rc:$(MTK_TARGET_VENDOR_RC)/init.sensor_1_0.rc
endif

PRODUCT_COPY_FILES += device/mediatek/mt8167/init.mt8167.usb.rc:$(MTK_TARGET_VENDOR_RC)/init.mt8167.usb.rc
...
PRODUCT_COPY_FILES += device/mediatek/mt8167/media_codecs.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs.xml:mtk
PRODUCT_COPY_FILES += device/mediatek/mt8167/media_codecs_performance.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_performance.xml:mtk
ifeq (yes,$(strip $(MTK_GMO_RAM_OPTIMIZE)))
    PRODUCT_COPY_FILES += device/mediatek/mt8167/media_codecs_mediatek_audio_gmo.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_audio.xml
else
    PRODUCT_COPY_FILES += device/mediatek/mt8167/media_codecs_mediatek_audio.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_audio.xml
endif
PRODUCT_COPY_FILES += device/mediatek/mt8167/media_codecs_google_video_gmo.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_google_video_le.xml
ifeq (yes,$(strip $(MTK_GMO_RAM_OPTIMIZE)))
    PRODUCT_COPY_FILES += device/mediatek/mt8167/media_codecs_c2_gmo.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_c2.xml:mtk
else
    PRODUCT_COPY_FILES += device/mediatek/mt8167/media_codecs_c2.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_c2.xml:mtk
endif
ifeq (yes,$(strip $(MTK_GMO_RAM_OPTIMIZE)))
    PRODUCT_COPY_FILES += device/mediatek/mt8167/media_codecs_google_audio_gmo.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_google_audio.xml
else
...
ifeq ($(strip $(MTK_WVDRM_L1_SUPPORT)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt8167/mtk_omx_core_wvl1.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
PRODUCT_COPY_FILES += device/mediatek/mt8167/media_codecs_mediatek_video_wvl1.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_video.xml:mtk
else
ifeq (yes,$(strip $(MTK_GMO_RAM_OPTIMIZE)))
    PRODUCT_COPY_FILES += device/mediatek/mt8167/mtk_omx_core_gmo.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
else
    PRODUCT_COPY_FILES += device/mediatek/mt8167/mtk_omx_core.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
endif
ifeq ($(strip $(LCM_HEIGHT)),1280)
PRODUCT_COPY_FILES += device/mediatek/mt8167/media_codecs_mediatek_video_HD.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_video.xml:mtk
else
PRODUCT_COPY_FILES += device/mediatek/mt8167/media_codecs_mediatek_video.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_video.xml:mtk
endif
endif
...
DEVICE_PACKAGE_OVERLAYS += device/mediatek/mt8167/overlay

#Audio config
PRODUCT_COPY_FILES += device/mediatek/mt8167/audio_device.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_device.xml:mtk

#Audio Tuning Tool config
ifneq ($(MTK_AUDIO_TUNING_TOOL_VERSION),)
  ifneq ($(strip $(MTK_AUDIO_TUNING_TOOL_VERSION)),V1)
    MTK_AUDIO_PARAM_DIR_LIST += device/mediatek/mt8167/audio_param
  endif
endif

PRODUCT_SYSTEM_DEFAULT_PROPERTIES += ro.mediatek.platform=MT8167
PRODUCT_PROPERTY_OVERRIDES += ro.vendor.mediatek.platform=MT8167
...
#PRODUCT_PACKAGES += keystore.mt8167
PRODUCT_PACKAGES += gatekeeper.mt8167
endif
...
ifeq ($(strip $(MTK_HDMI_SUPPORT)), yes)
    ...
    PRODUCT_PACKAGES += hdmimanager
    PRODUCT_BOOT_JARS += hdmimanager

    PRODUCT_PROPERTY_OVERRIDES += ro.vendor.mtk_tb_hdmi=internal
