 ...
 * 耳机测试
 */
public class TypeCDigitalHeadsetTest extends BaseActivity {

    private TextView mTypeCDigitalHeadsetTestTipTv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setContentView(R.layout.activity_typec_digital_headset_test);
        ...
        mTypeCDigitalHeadsetTestTipTv = (TextView) findViewById(R.id.headset_test_tip);
    ...
    protected void onResume() {
        ...
        if (mHeadsetPlugged) {
            mTypeCDigitalHeadsetTestTipTv.setText(R.string.headset_test_headset_plugged);
            mRecordOrPlayBt.setEnabled(true);
        } else {
            mTypeCDigitalHeadsetTestTipTv.setText(R.string.headset_test_headset_not_plugged);
    ...
    private BroadcastReceiver mHeadsetStateChangedReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.d(TypeCDigitalHeadsetTest.this, "onReceive=>state: " + state);
            if (state == 1 && getHeadsetState() == 2) {
